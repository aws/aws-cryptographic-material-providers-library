...
class default__:
    ...
    def Digest(input):
        ...
        d_28_valueOrError0_: Wrappers.Result = Wrappers.Result_Success.default(_dafny.Seq)()
        ...
        d_29_valueOrError1_: Wrappers.Outcome = Wrappers.Outcome_Pass.default()()
        d_29_valueOrError1_ = Wrappers.default__.Need((len(d_27_value_)) == (Digest.default__.Length(d_25_digestAlgorithm_)), software_amazon_cryptography_primitives_internaldafny_types.Error_AwsCryptographicPrimitivesError(_dafny.Seq("Incorrect length digest from ExternDigest.")))
