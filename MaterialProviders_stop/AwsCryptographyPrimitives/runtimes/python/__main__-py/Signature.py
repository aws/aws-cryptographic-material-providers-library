...
class default__:
    ...
    def KeyGen(input):
        ...
        d_68_sigKeyPair_: Signature.SignatureKeyPair
        d_69_valueOrError0_: Wrappers.Result = Wrappers.Result_Success.default(Signature.SignatureKeyPair.default())()
        ...
        d_70_valueOrError1_: Wrappers.Outcome = Wrappers.Outcome_Pass.default()()
        d_70_valueOrError1_ = Wrappers.default__.Need((len((d_68_sigKeyPair_).verificationKey)) == (Signature.default__.FieldSize((input).signatureAlgorithm)), software_amazon_cryptography_primitives_internaldafny_types.Error_AwsCryptographicPrimitivesError(_dafny.Seq("Incorrect verification-key length from ExternKeyGen.")))
