...
class default__:
    ...
    def KdfCounterMode(input):
        ...
        d_71_valueOrError0_: Wrappers.Outcome = Wrappers.Outcome_Pass.default()()
        ...
        d_75_okm_ = _dafny.Seq([])
        d_76_internalLength_: BoundedInts.uint32
        d_76_internalLength_ = ((4) + (len((KdfCtr.default__).SEPARATION__INDICATOR))) + (4)
        d_77_valueOrError1_: Wrappers.Outcome = Wrappers.Outcome_Pass.default()()
        d_77_valueOrError1_ = Wrappers.default__.Need((True) and ((((d_76_internalLength_) + (len(d_73_label___))) + (len(d_74_info_))) < ((StandardLibrary_mUInt.default__).INT32__MAX__LIMIT)), software_amazon_cryptography_primitives_internaldafny_types.Error_AwsCryptographicPrimitivesError(_dafny.Seq("Input Length exceeds INT32_MAX_LIMIT")))
        if (d_77_valueOrError1_).IsFailure():
            output = (d_77_valueOrError1_).PropagateFailure()
            return output
        d_78_lengthBits_: _dafny.Seq
        d_78_lengthBits_ = StandardLibrary_mUInt.default__.UInt32ToSeq(((input).expectedLength) * (8))
        d_79_explicitInfo_: _dafny.Seq
        d_79_explicitInfo_ = (((d_73_label___) + ((KdfCtr.default__).SEPARATION__INDICATOR)) + (d_74_info_)) + (d_78_lengthBits_)
        d_80_valueOrError2_: Wrappers.Outcome = Wrappers.Outcome_Pass.default()()
        d_80_valueOrError2_ = Wrappers.default__.Need(((4) + (len(d_79_explicitInfo_))) < ((StandardLibrary_mUInt.default__).INT32__MAX__LIMIT), software_amazon_cryptography_primitives_internaldafny_types.Error_AwsCryptographicPrimitivesError(_dafny.Seq("PRF input length exceeds INT32_MAX_LIMIT.")))
        if (d_80_valueOrError2_).IsFailure():
            output = (d_80_valueOrError2_).PropagateFailure()
            return output
        d_81_valueOrError3_: Wrappers.Result = Wrappers.Result_Success.default(_dafny.Seq)()
        out15_: Wrappers.Result
        out15_ = KdfCtr.default__.RawDerive(d_72_ikm_, d_79_explicitInfo_, (input).expectedLength, 0)
    ...
    def RawDerive(ikm, explicitInfo, length, offset):
        ...
        (d_83_hmac_).Init(ikm)
        d_85_macLengthBytes_: BoundedInts.int32
        d_85_macLengthBytes_ = Digest.default__.Length(d_82_derivationMac_)
        d_86_iterations_: BoundedInts.int32
        d_86_iterations_ = _dafny.euclidian_division(((length) + (d_85_macLengthBytes_)) - (1), d_85_macLengthBytes_)
        d_87_buffer_: _dafny.Seq
        d_87_buffer_ = _dafny.Seq([])
        d_88_i_: _dafny.Seq
        d_88_i_ = StandardLibrary_mUInt.default__.UInt32ToSeq((KdfCtr.default__).COUNTER__START__VALUE)
        hi0_: BoundedInts.int32 = (d_86_iterations_) + (1)
        for d_89_iteration_ in range(1, hi0_):
            ...
            d_91_valueOrError1_: Wrappers.Result = Wrappers.Result_Success.default(_dafny.Seq)()
            d_91_valueOrError1_ = KdfCtr.default__.Increment(d_88_i_)
            if (d_91_valueOrError1_).IsFailure():
                output = (d_91_valueOrError1_).PropagateFailure()
                return output
            d_88_i_ = (d_91_valueOrError1_).Extract()
        d_92_valueOrError2_: Wrappers.Outcome = Wrappers.Outcome_Pass.default()()
