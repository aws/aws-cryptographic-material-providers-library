...
class default__:
    ...
    def ExpectRFCTestVectors():
        hi2_: int = len((TestHKDF__Rfc5869TestVectors.default__).testVectors)
        for d_119_i_ in range(0, hi2_):
            TestHKDF__Rfc5869TestVectors.default__.ExpectTestVector(((TestHKDF__Rfc5869TestVectors.default__).testVectors)[d_119_i_])

    @staticmethod
    def ExpectTestVector(vector):
        let_tmp_rhs2_ = vector
        d_120_name_ = let_tmp_rhs2_.name
        d_121_hash_ = let_tmp_rhs2_.hash
        d_122_IKM_ = let_tmp_rhs2_.IKM
        d_123_salt_ = let_tmp_rhs2_.salt
        d_124_info_ = let_tmp_rhs2_.info
        d_125_L_ = let_tmp_rhs2_.L
        d_126_PRK_ = let_tmp_rhs2_.PRK
        d_127_OKM_ = let_tmp_rhs2_.OKM
        _dafny.print(_dafny.string_of((d_120_name_) + (_dafny.Seq("\n"))))
        TestAwsCryptographyPrimitivesHKDF.default__.BasicExtractTest(software_amazon_cryptography_primitives_internaldafny_types.HkdfExtractInput_HkdfExtractInput(d_121_hash_, (Wrappers.Option_Some(d_123_salt_) if (len(d_123_salt_)) > (0) else Wrappers.Option_None()), d_122_IKM_), d_126_PRK_)
        TestAwsCryptographyPrimitivesHKDF.default__.BasicExpandTest(software_amazon_cryptography_primitives_internaldafny_types.HkdfExpandInput_HkdfExpandInput(d_121_hash_, d_126_PRK_, d_124_info_, d_125_L_), d_127_OKM_)
        TestAwsCryptographyPrimitivesHKDF.default__.BasicHkdfTest(software_amazon_cryptography_primitives_internaldafny_types.HkdfInput_HkdfInput(d_121_hash_, (Wrappers.Option_Some(d_123_salt_) if (len(d_123_salt_)) > (0) else Wrappers.Option_None()), d_122_IKM_, d_124_info_, d_125_L_), d_127_OKM_)
