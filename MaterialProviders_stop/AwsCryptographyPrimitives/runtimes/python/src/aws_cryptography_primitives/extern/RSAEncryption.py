from aws_cryptography_primitives.internal_generated_dafny.RSAEncryption import *
import aws_cryptography_primitives.internal_generated_dafny.RSAEncryption
import _dafny
  ...
  class RSA:
    ...
    def EncryptExtern(padding_mode, public_key_der, plaintext):
      ...
      ct = public_key.encrypt(
          plaintext_bytes,
          RSAEncryption.RSA.GetPaddingForPaddingMode(padding_mode)
      )
...
aws_cryptography_primitives.internal_generated_dafny.RSAEncryption.RSAEncryption = RSAEncryption
