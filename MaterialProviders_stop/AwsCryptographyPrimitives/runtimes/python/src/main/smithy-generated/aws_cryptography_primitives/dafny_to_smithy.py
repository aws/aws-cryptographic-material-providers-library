...
import aws_cryptography_primitives.smithygenerated.config
...
def DafnyToSmithy_aws_cryptography_primitives_HMacInput(input):
    return aws_cryptography_primitives.smithygenerated.models.HMacInput(
...
def DafnyToSmithy_aws_cryptography_primitives_GenerateECDSASignatureKeyInput(input):
    return aws_cryptography_primitives.smithygenerated.models.GenerateECDSASignatureKeyInput(
        signature_algorithm=input.signatureAlgorithm,
    )

def DafnyToSmithy_aws_cryptography_primitives_GenerateRandomBytesInput(input):
    return aws_cryptography_primitives.smithygenerated.models.GenerateRandomBytesInput(
        length=input.length,
    )

def DafnyToSmithy_aws_cryptography_primitives_GenerateRSAKeyPairInput(input):
    return aws_cryptography_primitives.smithygenerated.models.GenerateRSAKeyPairInput(
        length_bits=input.lengthBits,
    )

def DafnyToSmithy_aws_cryptography_primitives_HkdfExpandInput(input):
    return aws_cryptography_primitives.smithygenerated.models.HkdfExpandInput(
        digest_algorithm=input.digestAlgorithm,
        prk=bytes(input.prk),
...
def DafnyToSmithy_aws_cryptography_primitives_HkdfInput(input):
    return aws_cryptography_primitives.smithygenerated.models.HkdfInput(
        digest_algorithm=input.digestAlgorithm,
...
def DafnyToSmithy_aws_cryptography_primitives_GetRSAKeyModulusLengthInput(input):
    return aws_cryptography_primitives.smithygenerated.models.GetRSAKeyModulusLengthInput(
        public_key=bytes(input.publicKey),
    )

def DafnyToSmithy_aws_cryptography_primitives_DigestInput(input):
    return aws_cryptography_primitives.smithygenerated.models.DigestInput(
        digest_algorithm=input.digestAlgorithm,
        message=bytes(input.message),
    )

def DafnyToSmithy_aws_cryptography_primitives_HkdfExtractInput(input):
    return aws_cryptography_primitives.smithygenerated.models.HkdfExtractInput(
        digest_algorithm=input.digestAlgorithm,
        salt=(bytes(input.salt.value)) if (input.salt.is_Some) else None,
        ikm=bytes(input.ikm),
    )
...
def DafnyToSmithy_aws_cryptography_primitives_AES_GCM(input):
    return aws_cryptography_primitives.smithygenerated.models.AES_GCM(
...
def DafnyToSmithy_aws_cryptography_primitives_AESDecryptInput(input):
    return aws_cryptography_primitives.smithygenerated.models.AESDecryptInput(
        enc_alg=aws_cryptography_primitives.smithygenerated.dafny_to_smithy.DafnyToSmithy_aws_cryptography_primitives_AES_GCM(input.encAlg),
        key=bytes(input.key),
...
def DafnyToSmithy_aws_cryptography_primitives_KdfCtrInput(input):
    return aws_cryptography_primitives.smithygenerated.models.KdfCtrInput(
        digest_algorithm=input.digestAlgorithm,
        ikm=bytes(input.ikm),
        expected_length=input.expectedLength,
...
def DafnyToSmithy_aws_cryptography_primitives_RSADecryptInput(input):
    return aws_cryptography_primitives.smithygenerated.models.RSADecryptInput(
...
def DafnyToSmithy_aws_cryptography_primitives_ECDSASignInput(input):
    return aws_cryptography_primitives.smithygenerated.models.ECDSASignInput(
        signature_algorithm=input.signatureAlgorithm,
...
def DafnyToSmithy_aws_cryptography_primitives_ECDSAVerifyInput(input):
    return aws_cryptography_primitives.smithygenerated.models.ECDSAVerifyInput(
        signature_algorithm=input.signatureAlgorithm,
...
def DafnyToSmithy_aws_cryptography_primitives_AESEncryptInput(input):
    return aws_cryptography_primitives.smithygenerated.models.AESEncryptInput(
        enc_alg=aws_cryptography_primitives.smithygenerated.dafny_to_smithy.DafnyToSmithy_aws_cryptography_primitives_AES_GCM(input.encAlg),
        iv=bytes(input.iv),
        key=bytes(input.key),
        msg=bytes(input.msg),
...
def DafnyToSmithy_aws_cryptography_primitives_RSAEncryptInput(input):
    return aws_cryptography_primitives.smithygenerated.models.RSAEncryptInput(
        padding=input.padding,
        public_key=bytes(input.publicKey),
...
def DafnyToSmithy_aws_cryptography_primitives_AesKdfCtrInput(input):
    return aws_cryptography_primitives.smithygenerated.models.AesKdfCtrInput(
        ikm=bytes(input.ikm),
        expected_length=input.expectedLength,
        nonce=(bytes(input.nonce.value)) if (input.nonce.is_Some) else None,
    )
...
def DafnyToSmithy_aws_cryptography_primitives_GenerateECDSASignatureKeyOutput(input):
    return aws_cryptography_primitives.smithygenerated.models.GenerateECDSASignatureKeyOutput(
        signature_algorithm=input.signatureAlgorithm,
        verification_key=bytes(input.verificationKey),
        signing_key=bytes(input.signingKey),
    )
...
def DafnyToSmithy_aws_cryptography_primitives_RSAPublicKey(input):
    return aws_cryptography_primitives.smithygenerated.models.RSAPublicKey(
        length_bits=input.lengthBits,
        pem=bytes(input.pem),
    )

def DafnyToSmithy_aws_cryptography_primitives_RSAPrivateKey(input):
    return aws_cryptography_primitives.smithygenerated.models.RSAPrivateKey(
        length_bits=input.lengthBits,
        pem=bytes(input.pem),
    )

def DafnyToSmithy_aws_cryptography_primitives_GenerateRSAKeyPairOutput(input):
    return aws_cryptography_primitives.smithygenerated.models.GenerateRSAKeyPairOutput(
        public_key=aws_cryptography_primitives.smithygenerated.dafny_to_smithy.DafnyToSmithy_aws_cryptography_primitives_RSAPublicKey(input.publicKey),
        private_key=aws_cryptography_primitives.smithygenerated.dafny_to_smithy.DafnyToSmithy_aws_cryptography_primitives_RSAPrivateKey(input.privateKey),
    )
...
def DafnyToSmithy_aws_cryptography_primitives_GetRSAKeyModulusLengthOutput(input):
    return aws_cryptography_primitives.smithygenerated.models.GetRSAKeyModulusLengthOutput(
        length=input.length,
    )
...
def DafnyToSmithy_aws_cryptography_primitives_AESEncryptOutput(input):
    return aws_cryptography_primitives.smithygenerated.models.AESEncryptOutput(
        cipher_text=bytes(input.cipherText),
        auth_tag=bytes(input.authTag),
    )
...
def DafnyToSmithy_aws_cryptography_primitives_CryptoConfig(input):
    return aws_cryptography_primitives.smithygenerated.config.CryptoConfig(
    )
