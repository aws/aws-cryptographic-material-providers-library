...
from aws_cryptography_materialproviders.smithygenerated.models import DiscoveryFilter
...
KeyDescription = Union[KeyDescriptionKms, KeyDescriptionKmsMrk, KeyDescriptionKmsMrkDiscovery, KeyDescriptionRSA, KeyDescriptionAES, KeyDescriptionStatic, KeyDescriptionKmsRsa, KeyDescriptionHierarchy, KeyDescriptionUnknown]
def _key_description_from_dict(d: Dict[str, Any]):
    if "Kms" in d:
