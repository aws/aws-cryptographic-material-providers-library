...
class default__:
    ...
    def ValidateCommitmentPolicyOnEncrypt(algorithm, commitmentPolicy):
        d_1062_suite_ = AlgorithmSuites.default__.GetSuite(algorithm)
        if ((commitmentPolicy) == (software_amazon_cryptography_materialproviders_internaldafny_types.CommitmentPolicy_ESDK(software_amazon_cryptography_materialproviders_internaldafny_types.ESDKCommitmentPolicy_FORBID__ENCRYPT__ALLOW__DECRYPT()))) and (not(((d_1062_suite_).commitment).is_None)):
    ...
    def ValidateCommitmentPolicyOnDecrypt(algorithm, commitmentPolicy):
        d_1063_suite_ = AlgorithmSuites.default__.GetSuite(algorithm)
        if ((True) and (((commitmentPolicy) == (software_amazon_cryptography_materialproviders_internaldafny_types.CommitmentPolicy_ESDK(software_amazon_cryptography_materialproviders_internaldafny_types.ESDKCommitmentPolicy_REQUIRE__ENCRYPT__REQUIRE__DECRYPT()))) or ((commitmentPolicy) == (software_amazon_cryptography_materialproviders_internaldafny_types.CommitmentPolicy_DBE(software_amazon_cryptography_materialproviders_internaldafny_types.DBECommitmentPolicy_REQUIRE__ENCRYPT__REQUIRE__DECRYPT()))))) and (((d_1063_suite_).commitment).is_None):
