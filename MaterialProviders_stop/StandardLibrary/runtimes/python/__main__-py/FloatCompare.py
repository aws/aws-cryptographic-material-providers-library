...
class default__:
    ...
    @staticmethod
    def StrToInt(s, acc):
        d_199_tmp_ = FloatCompare.default__.SkipLeadingSpace(s)
        if (len(d_199_tmp_)) == (0):
            return 0
        elif ((d_199_tmp_)[0]) == ('-'):
    ...
    @staticmethod
    def SplitExp(x):
        d_201_parts_ = FloatCompare.default__.SplitE(x)
        if (d_201_parts_).is_Some:
            return (((d_201_parts_).value)[0], FloatCompare.default__.StrToInt(((d_201_parts_).value)[1], 0))
        elif True:
            return (x, 0)
    ...
    def SplitDot(x):
        ...
        if (d_202_parts_).is_Some:
            return (FloatCompare.default__.SkipLeadingZeros(((d_202_parts_).value)[0]), FloatCompare.default__.SkipTrailingZeros(((d_202_parts_).value)[1]))
        elif True:
    ...
    def CompareFloatInner(x, y):
        d_204_xParts_ = FloatCompare.default__.SplitExp(x)
        d_205_yParts_ = FloatCompare.default__.SplitExp(y)
        d_206_xNum_ = FloatCompare.default__.SplitDot((d_204_xParts_)[0])
        d_207_yNum_ = FloatCompare.default__.SplitDot((d_205_yParts_)[0])
        d_208_xDigits_ = FloatCompare.default__.SkipLeadingZeros(((d_206_xNum_)[0]) + ((d_206_xNum_)[1]))
        d_209_yDigits_ = FloatCompare.default__.SkipLeadingZeros(((d_207_yNum_)[0]) + ((d_207_yNum_)[1]))
        ...
        if (d_212_logX_) > (d_213_logY_):
            ...
            return FloatCompare.default__.StrCmp(FloatCompare.default__.AppendZeros(d_208_xDigits_, len(d_209_yDigits_)), d_209_yDigits_)
        elif (len(d_209_yDigits_)) < (len(d_208_xDigits_)):
            return FloatCompare.default__.StrCmp(d_208_xDigits_, FloatCompare.default__.AppendZeros(d_209_yDigits_, len(d_208_xDigits_)))
        elif True:
            return FloatCompare.default__.StrCmp(d_208_xDigits_, d_209_yDigits_)
    ...
    def CompareFloat(x, y):
        d_214_x_ = FloatCompare.default__.CleanNumber(x)
        d_215_y_ = FloatCompare.default__.CleanNumber(y)
        if (FloatCompare.default__.IsNegative(d_214_x_)) and (FloatCompare.default__.IsNegative(d_215_y_)):
            return FloatCompare.default__.CompareFloatInner(_dafny.Seq((d_215_y_)[1::]), _dafny.Seq((d_214_x_)[1::]))
        elif FloatCompare.default__.IsNegative(d_214_x_):
            return -1
        elif FloatCompare.default__.IsNegative(d_215_y_):
            return 1
        elif True:
            return FloatCompare.default__.CompareFloatInner(d_214_x_, d_215_y_)
