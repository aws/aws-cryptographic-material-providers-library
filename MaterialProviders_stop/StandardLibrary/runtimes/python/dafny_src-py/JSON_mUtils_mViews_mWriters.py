...
assert "JSON_mUtils_mViews_mWriters" == __name__
JSON_mUtils_mViews_mWriters = sys.modules[__name__]
...
class Chain:
    ...
    def is_Empty(self) -> bool:
        return isinstance(self, JSON_mUtils_mViews_mWriters.Chain_Empty)
    @property
    def is_Chain(self) -> bool:
        return isinstance(self, JSON_mUtils_mViews_mWriters.Chain_Chain)
    def Length(self):
    ...
    def Append(self, v_k):
        if ((self).is_Chain) and (JSON_mUtils_mViews_mCore.default__.Adjacent((self).v, v_k)):
            return JSON_mUtils_mViews_mWriters.Chain_Chain((self).previous, JSON_mUtils_mViews_mCore.default__.Merge((self).v, v_k))
        elif True:
            return JSON_mUtils_mViews_mWriters.Chain_Chain(self, v_k)
...
class Chain_Empty(Chain, NamedTuple('Empty', [])):
    ...
    def __eq__(self, __o: object) -> bool:
        return isinstance(__o, JSON_mUtils_mViews_mWriters.Chain_Empty)
...
class Chain_Chain(Chain, NamedTuple('Chain', [('previous', Any), ('v', Any)])):
    ...
    def __eq__(self, __o: object) -> bool:
        return isinstance(__o, JSON_mUtils_mViews_mWriters.Chain_Chain) and self.previous == __o.previous and self.v == __o.v
    def __hash__(self) -> int:
        return super().__hash__()
...
class Writer:
    ...
    @staticmethod
    def default():
        return JSON_mUtils_mViews_mWriters.Writer___Writer(0, JSON_mUtils_mViews_mWriters.Chain_Empty())

class Writer__:
    @classmethod
    def default(cls, ):
        return lambda: Writer___Writer(int(0), JSON_mUtils_mViews_mWriters.Chain_Empty.default()())
    def __ne__(self, __o: object) -> bool:
        return not self.__eq__(__o)
    @property
    def is_Writer(self) -> bool:
        return isinstance(self, JSON_mUtils_mViews_mWriters.Writer___Writer)
    def Bytes(self):
    ...
    def Append(self, v_k):
        return JSON_mUtils_mViews_mWriters.Writer___Writer(JSON_mUtils_mViews_mWriters.Writer__.SaturatedAddU32((self).length, (v_k).Length()), ((self).chain).Append(v_k))
...
class Writer___Writer(Writer__, NamedTuple('Writer', [('length', Any), ('chain', Any)])):
    ...
    def __eq__(self, __o: object) -> bool:
        return isinstance(__o, JSON_mUtils_mViews_mWriters.Writer___Writer) and self.length == __o.length and self.chain == __o.chain
    def __hash__(self) -> int:
        return super().__hash__()
