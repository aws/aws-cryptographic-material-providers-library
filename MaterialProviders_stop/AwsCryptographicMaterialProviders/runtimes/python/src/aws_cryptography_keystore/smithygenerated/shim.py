...
class KeyStoreShim(software_amazon_cryptography_keystore_internaldafny_types.IKeyStoreClient):
    ...
    def CreateKeyStore(self, input: DafnyCreateKeyStoreInput):
    ...
    def CreateKey(self, input: DafnyCreateKeyInput):
    ...
    def VersionKey(self, input: DafnyVersionKeyInput):
    ...
    def GetActiveBranchKey(self, input: DafnyGetActiveBranchKeyInput):
    ...
    def GetBranchKeyVersion(self, input: DafnyGetBranchKeyVersionInput):
    ...
    def GetBeaconKey(self, input: DafnyGetBeaconKeyInput):
