...
def DafnyToSmithy_com_amazonaws_dynamodb_AttributeValue(input):
    ...
    if isinstance(input, AttributeValue_S):
        ...
        AttributeValue_union_value = {"M": {key.VerbatimString(False): DafnyToSmithy_com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in input.M.items }}
    elif isinstance(input, AttributeValue_L):
        AttributeValue_union_value = {"L": [DafnyToSmithy_com_amazonaws_dynamodb_AttributeValue(list_element) for list_element in input.L]}
