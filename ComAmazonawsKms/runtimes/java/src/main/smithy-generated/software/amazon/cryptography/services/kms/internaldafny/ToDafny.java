...
public class ToDafny {
  ...
  public static AliasListEntry AliasListEntry(
    ...
    aliasName = Objects.nonNull(nativeValue.aliasName()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.aliasName()))
    ...
    aliasArn = Objects.nonNull(nativeValue.aliasArn()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.aliasArn()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    Option<DafnySequence<? extends Character>> targetKeyId;
    targetKeyId = Objects.nonNull(nativeValue.targetKeyId()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.targetKeyId()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    Option<DafnySequence<? extends Character>> creationDate;
    creationDate = Objects.nonNull(nativeValue.creationDate()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.creationDate()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    Option<DafnySequence<? extends Character>> lastUpdatedDate;
    lastUpdatedDate = Objects.nonNull(nativeValue.lastUpdatedDate()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.lastUpdatedDate()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
  ...
  public static CancelKeyDeletionResponse CancelKeyDeletionResponse(
    ...
    keyId = Objects.nonNull(nativeValue.keyId()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.keyId()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
  ...
  public static CreateCustomKeyStoreResponse CreateCustomKeyStoreResponse(
    ...
    customKeyStoreId = Objects.nonNull(nativeValue.customKeyStoreId()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.customKeyStoreId()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
  ...
  public static CreateGrantRequest CreateGrantRequest(
    ...
    retiringPrincipal = Objects.nonNull(nativeValue.retiringPrincipal()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.retiringPrincipal()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    ...
    constraints = Objects.nonNull(nativeValue.constraints()) ?
        Option.create_Some(GrantConstraints._typeDescriptor(), ToDafny.GrantConstraints(nativeValue.constraints()))
    ...
    grantTokens = (Objects.nonNull(nativeValue.grantTokens()) && nativeValue.grantTokens().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR)), ToDafny.GrantTokenList(nativeValue.grantTokens()))
    ...
    name = Objects.nonNull(nativeValue.name()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.name()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
  ...
  public static CreateGrantResponse CreateGrantResponse(
    ...
    grantToken = Objects.nonNull(nativeValue.grantToken()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.grantToken()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    Option<DafnySequence<? extends Character>> grantId;
    grantId = Objects.nonNull(nativeValue.grantId()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.grantId()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
  ...
  public static CreateKeyRequest CreateKeyRequest(
    ...
    policy = Objects.nonNull(nativeValue.policy()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.policy()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    Option<DafnySequence<? extends Character>> description;
    description = Objects.nonNull(nativeValue.description()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.description()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    Option<KeyUsageType> keyUsage;
    keyUsage = Objects.nonNull(nativeValue.keyUsage()) ?
        Option.create_Some(KeyUsageType._typeDescriptor(), ToDafny.KeyUsageType(nativeValue.keyUsage()))
    ...
    customerMasterKeySpec = Objects.nonNull(nativeValue.customerMasterKeySpec()) ?
        Option.create_Some(CustomerMasterKeySpec._typeDescriptor(), ToDafny.CustomerMasterKeySpec(nativeValue.customerMasterKeySpec()))
    ...
    keySpec = Objects.nonNull(nativeValue.keySpec()) ?
        Option.create_Some(KeySpec._typeDescriptor(), ToDafny.KeySpec(nativeValue.keySpec()))
        : Option.create_None(KeySpec._typeDescriptor());
    Option<OriginType> origin;
    origin = Objects.nonNull(nativeValue.origin()) ?
        Option.create_Some(OriginType._typeDescriptor(), ToDafny.OriginType(nativeValue.origin()))
    ...
    bypassPolicyLockoutSafetyCheck = Objects.nonNull(nativeValue.bypassPolicyLockoutSafetyCheck()) ?
        Option.create_Some(TypeDescriptor.BOOLEAN, (nativeValue.bypassPolicyLockoutSafetyCheck()))
    ...
    multiRegion = Objects.nonNull(nativeValue.multiRegion()) ?
        Option.create_Some(TypeDescriptor.BOOLEAN, (nativeValue.multiRegion()))
        : Option.create_None(TypeDescriptor.BOOLEAN);
  ...
  public static CreateKeyResponse CreateKeyResponse(
    ...
    keyMetadata = Objects.nonNull(nativeValue.keyMetadata()) ?
        Option.create_Some(KeyMetadata._typeDescriptor(), ToDafny.KeyMetadata(nativeValue.keyMetadata()))
  ...
  public static CustomKeyStoresListEntry CustomKeyStoresListEntry(
    ...
    customKeyStoreName = Objects.nonNull(nativeValue.customKeyStoreName()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.customKeyStoreName()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    Option<DafnySequence<? extends Character>> cloudHsmClusterId;
    cloudHsmClusterId = Objects.nonNull(nativeValue.cloudHsmClusterId()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.cloudHsmClusterId()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    ...
    trustAnchorCertificate = Objects.nonNull(nativeValue.trustAnchorCertificate()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.trustAnchorCertificate()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    Option<ConnectionStateType> connectionState;
    connectionState = Objects.nonNull(nativeValue.connectionState()) ?
        Option.create_Some(ConnectionStateType._typeDescriptor(), ToDafny.ConnectionStateType(nativeValue.connectionState()))
    ...
    connectionErrorCode = Objects.nonNull(nativeValue.connectionErrorCode()) ?
        Option.create_Some(ConnectionErrorCodeType._typeDescriptor(), ToDafny.ConnectionErrorCodeType(nativeValue.connectionErrorCode()))
  ...
  public static DecryptRequest DecryptRequest(
    ...
    encryptionContext = (Objects.nonNull(nativeValue.encryptionContext()) && nativeValue.encryptionContext().size() > 0) ?
        Option.create_Some(DafnyMap._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), DafnySequence._typeDescriptor(TypeDescriptor.CHAR)), ToDafny.EncryptionContextType(nativeValue.encryptionContext()))
    ...
    encryptionAlgorithm = Objects.nonNull(nativeValue.encryptionAlgorithm()) ?
        Option.create_Some(EncryptionAlgorithmSpec._typeDescriptor(), ToDafny.EncryptionAlgorithmSpec(nativeValue.encryptionAlgorithm()))
  ...
  public static DecryptResponse DecryptResponse(
    ...
    plaintext = Objects.nonNull(nativeValue.plaintext()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.BYTE), software.amazon.smithy.dafny.conversion.ToDafny.Simple.ByteSequence(nativeValue.plaintext().asByteArray()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.BYTE));
    Option<EncryptionAlgorithmSpec> encryptionAlgorithm;
    encryptionAlgorithm = Objects.nonNull(nativeValue.encryptionAlgorithm()) ?
        Option.create_Some(EncryptionAlgorithmSpec._typeDescriptor(), ToDafny.EncryptionAlgorithmSpec(nativeValue.encryptionAlgorithm()))
        : Option.create_None(EncryptionAlgorithmSpec._typeDescriptor());
  ...
  public static DescribeCustomKeyStoresRequest DescribeCustomKeyStoresRequest(
    ...
    marker = Objects.nonNull(nativeValue.marker()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.marker()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
  ...
  public static DescribeCustomKeyStoresResponse DescribeCustomKeyStoresResponse(
    ...
    customKeyStores = (Objects.nonNull(nativeValue.customKeyStores()) && nativeValue.customKeyStores().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(CustomKeyStoresListEntry._typeDescriptor()), ToDafny.CustomKeyStoresList(nativeValue.customKeyStores()))
        : Option.create_None(DafnySequence._typeDescriptor(CustomKeyStoresListEntry._typeDescriptor()));
    Option<DafnySequence<? extends Character>> nextMarker;
    nextMarker = Objects.nonNull(nativeValue.nextMarker()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.nextMarker()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
  ...
  public static EncryptResponse EncryptResponse(
    ...
    ciphertextBlob = Objects.nonNull(nativeValue.ciphertextBlob()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.BYTE), software.amazon.smithy.dafny.conversion.ToDafny.Simple.ByteSequence(nativeValue.ciphertextBlob().asByteArray()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.BYTE));
    Option<DafnySequence<? extends Character>> keyId;
    keyId = Objects.nonNull(nativeValue.keyId()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.keyId()))
  ...
  public static GenerateDataKeyPairResponse GenerateDataKeyPairResponse(
    ...
    privateKeyCiphertextBlob = Objects.nonNull(nativeValue.privateKeyCiphertextBlob()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.BYTE), software.amazon.smithy.dafny.conversion.ToDafny.Simple.ByteSequence(nativeValue.privateKeyCiphertextBlob().asByteArray()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.BYTE));
    Option<DafnySequence<? extends Byte>> privateKeyPlaintext;
    privateKeyPlaintext = Objects.nonNull(nativeValue.privateKeyPlaintext()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.BYTE), software.amazon.smithy.dafny.conversion.ToDafny.Simple.ByteSequence(nativeValue.privateKeyPlaintext().asByteArray()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.BYTE));
    Option<DafnySequence<? extends Byte>> publicKey;
    publicKey = Objects.nonNull(nativeValue.publicKey()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.BYTE), software.amazon.smithy.dafny.conversion.ToDafny.Simple.ByteSequence(nativeValue.publicKey().asByteArray()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.BYTE));
    Option<DafnySequence<? extends Character>> keyId;
    keyId = Objects.nonNull(nativeValue.keyId()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.keyId()))
    ...
    keyPairSpec = Objects.nonNull(nativeValue.keyPairSpec()) ?
        Option.create_Some(DataKeyPairSpec._typeDescriptor(), ToDafny.DataKeyPairSpec(nativeValue.keyPairSpec()))
  ...
  public static GenerateDataKeyRequest GenerateDataKeyRequest(
    ...
    keySpec = Objects.nonNull(nativeValue.keySpec()) ?
        Option.create_Some(DataKeySpec._typeDescriptor(), ToDafny.DataKeySpec(nativeValue.keySpec()))
  ...
  public static GetKeyRotationStatusResponse GetKeyRotationStatusResponse(
    ...
    keyRotationEnabled = Objects.nonNull(nativeValue.keyRotationEnabled()) ?
        Option.create_Some(TypeDescriptor.BOOLEAN, (nativeValue.keyRotationEnabled()))
        : Option.create_None(TypeDescriptor.BOOLEAN);
  ...
  public static GetParametersForImportResponse GetParametersForImportResponse(
    ...
    importToken = Objects.nonNull(nativeValue.importToken()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.BYTE), software.amazon.smithy.dafny.conversion.ToDafny.Simple.ByteSequence(nativeValue.importToken().asByteArray()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.BYTE));
    Option<DafnySequence<? extends Byte>> publicKey;
    publicKey = Objects.nonNull(nativeValue.publicKey()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.BYTE), software.amazon.smithy.dafny.conversion.ToDafny.Simple.ByteSequence(nativeValue.publicKey().asByteArray()))
    ...
    parametersValidTo = Objects.nonNull(nativeValue.parametersValidTo()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.parametersValidTo()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
  ...
  public static GetPublicKeyResponse GetPublicKeyResponse(
    ...
    encryptionAlgorithms = (Objects.nonNull(nativeValue.encryptionAlgorithms()) && nativeValue.encryptionAlgorithms().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(EncryptionAlgorithmSpec._typeDescriptor()), ToDafny.EncryptionAlgorithmSpecList(nativeValue.encryptionAlgorithms()))
        : Option.create_None(DafnySequence._typeDescriptor(EncryptionAlgorithmSpec._typeDescriptor()));
    ...
    signingAlgorithms = (Objects.nonNull(nativeValue.signingAlgorithms()) && nativeValue.signingAlgorithms().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(SigningAlgorithmSpec._typeDescriptor()), ToDafny.SigningAlgorithmSpecList(nativeValue.signingAlgorithms()))
        : Option.create_None(DafnySequence._typeDescriptor(SigningAlgorithmSpec._typeDescriptor()));
  ...
  public static GrantConstraints GrantConstraints(
    ...
    encryptionContextSubset = (Objects.nonNull(nativeValue.encryptionContextSubset()) && nativeValue.encryptionContextSubset().size() > 0) ?
        Option.create_Some(DafnyMap._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), DafnySequence._typeDescriptor(TypeDescriptor.CHAR)), ToDafny.EncryptionContextType(nativeValue.encryptionContextSubset()))
        : Option.create_None(DafnyMap._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), DafnySequence._typeDescriptor(TypeDescriptor.CHAR)));
    ...
    encryptionContextEquals = (Objects.nonNull(nativeValue.encryptionContextEquals()) && nativeValue.encryptionContextEquals().size() > 0) ?
        Option.create_Some(DafnyMap._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), DafnySequence._typeDescriptor(TypeDescriptor.CHAR)), ToDafny.EncryptionContextType(nativeValue.encryptionContextEquals()))
        : Option.create_None(DafnyMap._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), DafnySequence._typeDescriptor(TypeDescriptor.CHAR)));
  ...
  public static GrantListEntry GrantListEntry(
    ...
    granteePrincipal = Objects.nonNull(nativeValue.granteePrincipal()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.granteePrincipal()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    Option<DafnySequence<? extends Character>> retiringPrincipal;
    retiringPrincipal = Objects.nonNull(nativeValue.retiringPrincipal()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.retiringPrincipal()))
    ...
    issuingAccount = Objects.nonNull(nativeValue.issuingAccount()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.issuingAccount()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    ...
    operations = (Objects.nonNull(nativeValue.operations()) && nativeValue.operations().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(GrantOperation._typeDescriptor()), ToDafny.GrantOperationList(nativeValue.operations()))
        : Option.create_None(DafnySequence._typeDescriptor(GrantOperation._typeDescriptor()));
    Option<GrantConstraints> constraints;
    constraints = Objects.nonNull(nativeValue.constraints()) ?
        Option.create_Some(GrantConstraints._typeDescriptor(), ToDafny.GrantConstraints(nativeValue.constraints()))
        : Option.create_None(GrantConstraints._typeDescriptor());
  ...
  public static ImportKeyMaterialRequest ImportKeyMaterialRequest(
    ...
    validTo = Objects.nonNull(nativeValue.validTo()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.validTo()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    Option<ExpirationModelType> expirationModel;
    expirationModel = Objects.nonNull(nativeValue.expirationModel()) ?
        Option.create_Some(ExpirationModelType._typeDescriptor(), ToDafny.ExpirationModelType(nativeValue.expirationModel()))
  ...
  public static KeyMetadata KeyMetadata(
    ...
    aWSAccountId = Objects.nonNull(nativeValue.awsAccountId()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.awsAccountId()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    DafnySequence<? extends Character> keyId;
    keyId = software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.keyId());
    Option<DafnySequence<? extends Character>> arn;
    arn = Objects.nonNull(nativeValue.arn()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.arn()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    Option<DafnySequence<? extends Character>> creationDate;
    creationDate = Objects.nonNull(nativeValue.creationDate()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.creationDate()))
    ...
    keyState = Objects.nonNull(nativeValue.keyState()) ?
        Option.create_Some(KeyState._typeDescriptor(), ToDafny.KeyState(nativeValue.keyState()))
    ...
    deletionDate = Objects.nonNull(nativeValue.deletionDate()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.deletionDate()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    Option<DafnySequence<? extends Character>> validTo;
    validTo = Objects.nonNull(nativeValue.validTo()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.validTo()))
    ...
    keyManager = Objects.nonNull(nativeValue.keyManager()) ?
        Option.create_Some(KeyManagerType._typeDescriptor(), ToDafny.KeyManagerType(nativeValue.keyManager()))
    ...
    multiRegionConfiguration = Objects.nonNull(nativeValue.multiRegionConfiguration()) ?
        Option.create_Some(MultiRegionConfiguration._typeDescriptor(), ToDafny.MultiRegionConfiguration(nativeValue.multiRegionConfiguration()))
    ...
    pendingDeletionWindowInDays = Objects.nonNull(nativeValue.pendingDeletionWindowInDays()) ?
        Option.create_Some(TypeDescriptor.INT, (nativeValue.pendingDeletionWindowInDays()))
        : Option.create_None(TypeDescriptor.INT);
  ...
  public static ListAliasesResponse ListAliasesResponse(
    ...
    aliases = (Objects.nonNull(nativeValue.aliases()) && nativeValue.aliases().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(AliasListEntry._typeDescriptor()), ToDafny.AliasList(nativeValue.aliases()))
        : Option.create_None(DafnySequence._typeDescriptor(AliasListEntry._typeDescriptor()));
    Option<DafnySequence<? extends Character>> nextMarker;
    nextMarker = Objects.nonNull(nativeValue.nextMarker()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.nextMarker()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
  ...
  public static ListGrantsResponse ListGrantsResponse(
    ...
    grants = (Objects.nonNull(nativeValue.grants()) && nativeValue.grants().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(GrantListEntry._typeDescriptor()), ToDafny.GrantList(nativeValue.grants()))
        : Option.create_None(DafnySequence._typeDescriptor(GrantListEntry._typeDescriptor()));
    Option<DafnySequence<? extends Character>> nextMarker;
    nextMarker = Objects.nonNull(nativeValue.nextMarker()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.nextMarker()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
  ...
  public static ListKeyPoliciesResponse ListKeyPoliciesResponse(
    ...
    policyNames = (Objects.nonNull(nativeValue.policyNames()) && nativeValue.policyNames().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR)), ToDafny.PolicyNameList(nativeValue.policyNames()))
        : Option.create_None(DafnySequence._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR)));
    Option<DafnySequence<? extends Character>> nextMarker;
    nextMarker = Objects.nonNull(nativeValue.nextMarker()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.nextMarker()))
  ...
  public static MultiRegionConfiguration MultiRegionConfiguration(
    ...
    multiRegionKeyType = Objects.nonNull(nativeValue.multiRegionKeyType()) ?
        Option.create_Some(MultiRegionKeyType._typeDescriptor(), ToDafny.MultiRegionKeyType(nativeValue.multiRegionKeyType()))
    ...
    replicaKeys = (Objects.nonNull(nativeValue.replicaKeys()) && nativeValue.replicaKeys().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(MultiRegionKey._typeDescriptor()), ToDafny.MultiRegionKeyList(nativeValue.replicaKeys()))
        : Option.create_None(DafnySequence._typeDescriptor(MultiRegionKey._typeDescriptor()));
  ...
  public static MultiRegionKey MultiRegionKey(
    ...
    region = Objects.nonNull(nativeValue.region()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.region()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
  ...
  public static ReEncryptRequest ReEncryptRequest(
    ...
    sourceEncryptionContext = (Objects.nonNull(nativeValue.sourceEncryptionContext()) && nativeValue.sourceEncryptionContext().size() > 0) ?
        Option.create_Some(DafnyMap._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), DafnySequence._typeDescriptor(TypeDescriptor.CHAR)), ToDafny.EncryptionContextType(nativeValue.sourceEncryptionContext()))
        : Option.create_None(DafnyMap._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), DafnySequence._typeDescriptor(TypeDescriptor.CHAR)));
    Option<DafnySequence<? extends Character>> sourceKeyId;
    sourceKeyId = Objects.nonNull(nativeValue.sourceKeyId()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.sourceKeyId()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    ...
    destinationEncryptionContext = (Objects.nonNull(nativeValue.destinationEncryptionContext()) && nativeValue.destinationEncryptionContext().size() > 0) ?
        Option.create_Some(DafnyMap._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), DafnySequence._typeDescriptor(TypeDescriptor.CHAR)), ToDafny.EncryptionContextType(nativeValue.destinationEncryptionContext()))
        : Option.create_None(DafnyMap._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), DafnySequence._typeDescriptor(TypeDescriptor.CHAR)));
    ...
    sourceEncryptionAlgorithm = Objects.nonNull(nativeValue.sourceEncryptionAlgorithm()) ?
        Option.create_Some(EncryptionAlgorithmSpec._typeDescriptor(), ToDafny.EncryptionAlgorithmSpec(nativeValue.sourceEncryptionAlgorithm()))
        : Option.create_None(EncryptionAlgorithmSpec._typeDescriptor());
    ...
    destinationEncryptionAlgorithm = Objects.nonNull(nativeValue.destinationEncryptionAlgorithm()) ?
        Option.create_Some(EncryptionAlgorithmSpec._typeDescriptor(), ToDafny.EncryptionAlgorithmSpec(nativeValue.destinationEncryptionAlgorithm()))
        : Option.create_None(EncryptionAlgorithmSpec._typeDescriptor());
    Option<DafnySequence<? extends DafnySequence<? extends Character>>> grantTokens;
    grantTokens = (Objects.nonNull(nativeValue.grantTokens()) && nativeValue.grantTokens().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR)), ToDafny.GrantTokenList(nativeValue.grantTokens()))
  ...
  public static ReplicateKeyResponse ReplicateKeyResponse(
    ...
    replicaKeyMetadata = Objects.nonNull(nativeValue.replicaKeyMetadata()) ?
        Option.create_Some(KeyMetadata._typeDescriptor(), ToDafny.KeyMetadata(nativeValue.replicaKeyMetadata()))
        : Option.create_None(KeyMetadata._typeDescriptor());
    Option<DafnySequence<? extends Character>> replicaPolicy;
    replicaPolicy = Objects.nonNull(nativeValue.replicaPolicy()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.replicaPolicy()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    ...
    replicaTags = (Objects.nonNull(nativeValue.replicaTags()) && nativeValue.replicaTags().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(Tag._typeDescriptor()), ToDafny.TagList(nativeValue.replicaTags()))
        : Option.create_None(DafnySequence._typeDescriptor(Tag._typeDescriptor()));
  ...
  public static SignRequest SignRequest(
    ...
    messageType = Objects.nonNull(nativeValue.messageType()) ?
        Option.create_Some(MessageType._typeDescriptor(), ToDafny.MessageType(nativeValue.messageType()))
  ...
  public static SignResponse SignResponse(
    ...
    signature = Objects.nonNull(nativeValue.signature()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.BYTE), software.amazon.smithy.dafny.conversion.ToDafny.Simple.ByteSequence(nativeValue.signature().asByteArray()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.BYTE));
    Option<SigningAlgorithmSpec> signingAlgorithm;
    signingAlgorithm = Objects.nonNull(nativeValue.signingAlgorithm()) ?
        Option.create_Some(SigningAlgorithmSpec._typeDescriptor(), ToDafny.SigningAlgorithmSpec(nativeValue.signingAlgorithm()))
  ...
  public static UpdateCustomKeyStoreRequest UpdateCustomKeyStoreRequest(
    ...
    newCustomKeyStoreName = Objects.nonNull(nativeValue.newCustomKeyStoreName()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.newCustomKeyStoreName()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    Option<DafnySequence<? extends Character>> keyStorePassword;
    keyStorePassword = Objects.nonNull(nativeValue.keyStorePassword()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.keyStorePassword()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    Option<DafnySequence<? extends Character>> cloudHsmClusterId;
    cloudHsmClusterId = Objects.nonNull(nativeValue.cloudHsmClusterId()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.cloudHsmClusterId()))
  ...
  public static VerifyResponse VerifyResponse(
    ...
    signatureValid = Objects.nonNull(nativeValue.signatureValid()) ?
        Option.create_Some(TypeDescriptor.BOOLEAN, (nativeValue.signatureValid()))
        : Option.create_None(TypeDescriptor.BOOLEAN);
    Option<SigningAlgorithmSpec> signingAlgorithm;
    signingAlgorithm = Objects.nonNull(nativeValue.signingAlgorithm()) ?
        Option.create_Some(SigningAlgorithmSpec._typeDescriptor(), ToDafny.SigningAlgorithmSpec(nativeValue.signingAlgorithm()))
