...
public class EnableKeyRotationRequest {
  ...
  private static final EnableKeyRotationRequest theDefault = software.amazon.cryptography.services.kms.internaldafny.types.EnableKeyRotationRequest.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR), Wrappers_Compile.Option.<java.lang.Integer>Default(RotationPeriodInDaysType._typeDescriptor()));
