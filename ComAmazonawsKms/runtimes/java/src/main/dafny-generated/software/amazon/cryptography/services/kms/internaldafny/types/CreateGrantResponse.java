...
public class CreateGrantResponse {
  ...
  private static final CreateGrantResponse theDefault = CreateGrantResponse.create(Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(GrantTokenType._typeDescriptor()), Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(GrantIdType._typeDescriptor()));
