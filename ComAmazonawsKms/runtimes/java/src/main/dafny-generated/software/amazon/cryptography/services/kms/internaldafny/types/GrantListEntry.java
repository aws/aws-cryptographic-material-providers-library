...
public class GrantListEntry {
  ...
  private static final GrantListEntry theDefault = GrantListEntry.create(Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(KeyIdType._typeDescriptor()), Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(GrantIdType._typeDescriptor()), Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(GrantNameType._typeDescriptor()), Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR)), Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(PrincipalIdType._typeDescriptor()), Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(PrincipalIdType._typeDescriptor()), Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(PrincipalIdType._typeDescriptor()), Wrappers_Compile.Option.<dafny.DafnySequence<? extends GrantOperation>>Default(dafny.DafnySequence.<GrantOperation>_typeDescriptor(GrantOperation._typeDescriptor())), Wrappers_Compile.Option.<GrantConstraints>Default(GrantConstraints._typeDescriptor()));
