...
public class GenerateDataKeyWithoutPlaintextResponse {
  ...
  private static final GenerateDataKeyWithoutPlaintextResponse theDefault = GenerateDataKeyWithoutPlaintextResponse.create(Wrappers_Compile.Option.<dafny.DafnySequence<? extends java.lang.Byte>>Default(CiphertextType._typeDescriptor()), Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(KeyIdType._typeDescriptor()));
