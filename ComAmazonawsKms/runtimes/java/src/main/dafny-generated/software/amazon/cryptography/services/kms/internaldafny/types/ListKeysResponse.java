...
public class ListKeysResponse {
  ...
  private static final ListKeysResponse theDefault = software.amazon.cryptography.services.kms.internaldafny.types.ListKeysResponse.create(Wrappers_Compile.Option.<dafny.DafnySequence<? extends KeyListEntry>>Default(dafny.DafnySequence.<KeyListEntry>_typeDescriptor(KeyListEntry._typeDescriptor())), Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(MarkerType._typeDescriptor()), Wrappers_Compile.Option.<Boolean>Default(dafny.TypeDescriptor.BOOLEAN));
