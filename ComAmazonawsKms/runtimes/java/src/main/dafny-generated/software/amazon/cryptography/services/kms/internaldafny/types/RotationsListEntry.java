...
public class RotationsListEntry {
  ...
  private static final RotationsListEntry theDefault = software.amazon.cryptography.services.kms.internaldafny.types.RotationsListEntry.create(Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(KeyIdType._typeDescriptor()), Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR)), Wrappers_Compile.Option.<RotationType>Default(RotationType._typeDescriptor()));
