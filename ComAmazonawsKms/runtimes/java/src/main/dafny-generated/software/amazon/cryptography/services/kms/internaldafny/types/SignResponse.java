...
public class SignResponse {
  ...
  private static final SignResponse theDefault = software.amazon.cryptography.services.kms.internaldafny.types.SignResponse.create(Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(KeyIdType._typeDescriptor()), Wrappers_Compile.Option.<dafny.DafnySequence<? extends java.lang.Byte>>Default(CiphertextType._typeDescriptor()), Wrappers_Compile.Option.<SigningAlgorithmSpec>Default(SigningAlgorithmSpec._typeDescriptor()));
