...
public class DeriveSharedSecretResponse {
  ...
  private static final DeriveSharedSecretResponse theDefault = software.amazon.cryptography.services.kms.internaldafny.types.DeriveSharedSecretResponse.create(Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(KeyIdType._typeDescriptor()), Wrappers_Compile.Option.<dafny.DafnySequence<? extends java.lang.Byte>>Default(PlaintextType._typeDescriptor()), Wrappers_Compile.Option.<dafny.DafnySequence<? extends java.lang.Byte>>Default(CiphertextType._typeDescriptor()), Wrappers_Compile.Option.<KeyAgreementAlgorithmSpec>Default(KeyAgreementAlgorithmSpec._typeDescriptor()), Wrappers_Compile.Option.<OriginType>Default(OriginType._typeDescriptor()));
