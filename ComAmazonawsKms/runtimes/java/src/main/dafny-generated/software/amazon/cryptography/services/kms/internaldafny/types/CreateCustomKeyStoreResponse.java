...
public class CreateCustomKeyStoreResponse {
  ...
  private static final CreateCustomKeyStoreResponse theDefault = CreateCustomKeyStoreResponse.create(Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(CustomKeyStoreIdType._typeDescriptor()));
