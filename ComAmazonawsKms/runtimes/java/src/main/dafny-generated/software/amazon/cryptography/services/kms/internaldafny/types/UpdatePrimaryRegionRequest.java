...
public class UpdatePrimaryRegionRequest {
  ...
  private static final UpdatePrimaryRegionRequest theDefault = UpdatePrimaryRegionRequest.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR), dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR));
