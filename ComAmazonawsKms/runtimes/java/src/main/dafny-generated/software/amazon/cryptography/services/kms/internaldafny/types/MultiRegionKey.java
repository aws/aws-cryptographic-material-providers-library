...
public class MultiRegionKey {
  ...
  private static final MultiRegionKey theDefault = software.amazon.cryptography.services.kms.internaldafny.types.MultiRegionKey.create(Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(ArnType._typeDescriptor()), Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(RegionType._typeDescriptor()));
