...
// Dafny class XksProxyVpcEndpointServiceNameType compiled into Java
package software.amazon.cryptography.services.kms.internaldafny.types;

@SuppressWarnings({"unchecked", "deprecation"})
public class XksProxyVpcEndpointServiceNameType {
  public XksProxyVpcEndpointServiceNameType() {
  }
  public static boolean _Is(dafny.DafnySequence<? extends Character> __source) {
    dafny.DafnySequence<? extends Character> _6_x = __source;
    return __default.IsValid__XksProxyVpcEndpointServiceNameType(_6_x);
  }
