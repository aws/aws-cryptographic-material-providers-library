...
public class GetKeyRotationStatusRequest {
  ...
  private static final GetKeyRotationStatusRequest theDefault = GetKeyRotationStatusRequest.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR));
