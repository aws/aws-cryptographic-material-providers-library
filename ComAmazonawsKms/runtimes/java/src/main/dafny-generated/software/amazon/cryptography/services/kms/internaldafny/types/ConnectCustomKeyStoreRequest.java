...
public class ConnectCustomKeyStoreRequest {
  ...
  private static final ConnectCustomKeyStoreRequest theDefault = ConnectCustomKeyStoreRequest.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR));
