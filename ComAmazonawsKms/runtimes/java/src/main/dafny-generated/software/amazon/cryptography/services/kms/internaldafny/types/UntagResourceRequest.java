...
public class UntagResourceRequest {
  ...
  private static final UntagResourceRequest theDefault = software.amazon.cryptography.services.kms.internaldafny.types.UntagResourceRequest.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR), dafny.DafnySequence.<dafny.DafnySequence<? extends Character>> empty(TagKeyType._typeDescriptor()));
