...
public class GetKeyPolicyResponse {
  ...
  private static final GetKeyPolicyResponse theDefault = GetKeyPolicyResponse.create(Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(PolicyType._typeDescriptor()), Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(PolicyNameType._typeDescriptor()));
