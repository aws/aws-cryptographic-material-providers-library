...
public class DisconnectCustomKeyStoreRequest {
  ...
  private static final DisconnectCustomKeyStoreRequest theDefault = software.amazon.cryptography.services.kms.internaldafny.types.DisconnectCustomKeyStoreRequest.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR));
