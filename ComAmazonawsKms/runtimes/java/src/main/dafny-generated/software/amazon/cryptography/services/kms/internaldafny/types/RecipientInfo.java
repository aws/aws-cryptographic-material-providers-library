...
public class RecipientInfo {
  ...
  private static final RecipientInfo theDefault = software.amazon.cryptography.services.kms.internaldafny.types.RecipientInfo.create(Wrappers_Compile.Option.<KeyEncryptionMechanism>Default(KeyEncryptionMechanism._typeDescriptor()), Wrappers_Compile.Option.<dafny.DafnySequence<? extends java.lang.Byte>>Default(AttestationDocumentType._typeDescriptor()));
