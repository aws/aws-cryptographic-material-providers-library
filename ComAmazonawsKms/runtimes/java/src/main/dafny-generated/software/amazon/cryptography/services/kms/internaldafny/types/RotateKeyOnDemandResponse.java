...
public class RotateKeyOnDemandResponse {
  ...
  private static final RotateKeyOnDemandResponse theDefault = software.amazon.cryptography.services.kms.internaldafny.types.RotateKeyOnDemandResponse.create(Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(KeyIdType._typeDescriptor()));
