...
public class DeleteImportedKeyMaterialRequest {
  ...
  private static final DeleteImportedKeyMaterialRequest theDefault = DeleteImportedKeyMaterialRequest.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR));
