...
// Dafny class TrustAnchorCertificateType compiled into Java
package software.amazon.cryptography.services.kms.internaldafny.types;

@SuppressWarnings({"unchecked", "deprecation"})
public class TrustAnchorCertificateType {
  public TrustAnchorCertificateType() {
  }
  public static boolean _Is(dafny.DafnySequence<? extends Character> __source) {
    ...
    return __default.IsValid__TrustAnchorCertificateType(_0_x);
  }
