...
// Dafny class CloudHsmClusterIdType compiled into Java
package software.amazon.cryptography.services.kms.internaldafny.types;


@SuppressWarnings({"unchecked", "deprecation"})
public class CloudHsmClusterIdType {
  public CloudHsmClusterIdType() {
  }
  public static boolean _Is(dafny.DafnySequence<? extends Character> __source) {
    ...
    return __default.IsValid__CloudHsmClusterIdType(_4_x);
  }
