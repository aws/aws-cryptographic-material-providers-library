...
public abstract class ExpirationModelType {
  ...
  private static final ExpirationModelType theDefault = software.amazon.cryptography.services.kms.internaldafny.types.ExpirationModelType.create_KEY__MATERIAL__EXPIRES();
