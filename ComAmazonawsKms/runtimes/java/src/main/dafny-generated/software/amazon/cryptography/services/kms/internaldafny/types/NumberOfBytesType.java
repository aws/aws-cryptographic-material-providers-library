...
// Dafny class NumberOfBytesType compiled into Java
package software.amazon.cryptography.services.kms.internaldafny.types;


@SuppressWarnings({"unchecked", "deprecation"})
public class NumberOfBytesType {
  public NumberOfBytesType() {
  }
  public static boolean _Is(int __source) {
    int _16_x = (__source);
    if (true) {
      return __default.IsValid__NumberOfBytesType(_16_x);
    }
    return false;
  }
