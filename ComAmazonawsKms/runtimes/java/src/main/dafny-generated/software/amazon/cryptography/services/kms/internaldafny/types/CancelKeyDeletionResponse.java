...
public class CancelKeyDeletionResponse {
  ...
  private static final CancelKeyDeletionResponse theDefault = software.amazon.cryptography.services.kms.internaldafny.types.CancelKeyDeletionResponse.create(Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(KeyIdType._typeDescriptor()));
