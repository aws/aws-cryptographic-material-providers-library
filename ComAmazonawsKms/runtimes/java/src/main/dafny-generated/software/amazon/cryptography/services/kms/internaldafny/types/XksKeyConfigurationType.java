...
public class XksKeyConfigurationType {
  ...
  private static final XksKeyConfigurationType theDefault = XksKeyConfigurationType.create(Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(XksKeyIdType._typeDescriptor()));
