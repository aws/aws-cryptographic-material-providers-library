...
public class TagResourceRequest {
  ...
  private static final TagResourceRequest theDefault = TagResourceRequest.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR), dafny.DafnySequence.<Tag> empty(Tag._typeDescriptor()));
