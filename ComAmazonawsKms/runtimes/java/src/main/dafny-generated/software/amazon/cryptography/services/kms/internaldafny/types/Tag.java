...
public class Tag {
  ...
  private static final Tag theDefault = software.amazon.cryptography.services.kms.internaldafny.types.Tag.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR), dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR));
