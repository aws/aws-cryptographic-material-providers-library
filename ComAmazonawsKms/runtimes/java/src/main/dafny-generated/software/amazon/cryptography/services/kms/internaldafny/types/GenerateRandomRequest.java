...
public class GenerateRandomRequest {
  ...
  private static final GenerateRandomRequest theDefault = GenerateRandomRequest.create(Wrappers_Compile.Option.<java.lang.Integer>Default(NumberOfBytesType._typeDescriptor()), Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(CustomKeyStoreIdType._typeDescriptor()), Wrappers_Compile.Option.<RecipientInfo>Default(RecipientInfo._typeDescriptor()));
