...
public class UpdateAliasRequest {
  ...
  private static final UpdateAliasRequest theDefault = UpdateAliasRequest.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR), dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR));
