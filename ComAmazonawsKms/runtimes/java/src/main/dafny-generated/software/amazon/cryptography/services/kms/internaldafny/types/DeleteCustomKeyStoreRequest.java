...
public class DeleteCustomKeyStoreRequest {
  ...
  private static final DeleteCustomKeyStoreRequest theDefault = software.amazon.cryptography.services.kms.internaldafny.types.DeleteCustomKeyStoreRequest.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR));
