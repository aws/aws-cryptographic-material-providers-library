...
public class ScheduleKeyDeletionRequest {
  ...
  private static final ScheduleKeyDeletionRequest theDefault = ScheduleKeyDeletionRequest.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR), Wrappers_Compile.Option.<java.lang.Integer>Default(PendingWindowInDaysType._typeDescriptor()));
