...
public class UpdateCustomKeyStoreRequest {
  ...
  private static final UpdateCustomKeyStoreRequest theDefault = software.amazon.cryptography.services.kms.internaldafny.types.UpdateCustomKeyStoreRequest.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR), Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(CustomKeyStoreNameType._typeDescriptor()), Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(KeyStorePasswordType._typeDescriptor()), Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(CloudHsmClusterIdType._typeDescriptor()), Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(XksProxyUriEndpointType._typeDescriptor()), Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(XksProxyUriPathType._typeDescriptor()), Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(XksProxyVpcEndpointServiceNameType._typeDescriptor()), Wrappers_Compile.Option.<XksProxyAuthenticationCredentialType>Default(XksProxyAuthenticationCredentialType._typeDescriptor()), Wrappers_Compile.Option.<XksProxyConnectivityType>Default(XksProxyConnectivityType._typeDescriptor()));
