...
public class DescribeKeyResponse {
  ...
  private static final DescribeKeyResponse theDefault = DescribeKeyResponse.create(Wrappers_Compile.Option.<KeyMetadata>Default(KeyMetadata._typeDescriptor()));
