...
public class VerifyMacResponse {
  ...
  private static final VerifyMacResponse theDefault = VerifyMacResponse.create(Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(KeyIdType._typeDescriptor()), Wrappers_Compile.Option.<Boolean>Default(dafny.TypeDescriptor.BOOLEAN), Wrappers_Compile.Option.<MacAlgorithmSpec>Default(MacAlgorithmSpec._typeDescriptor()));
