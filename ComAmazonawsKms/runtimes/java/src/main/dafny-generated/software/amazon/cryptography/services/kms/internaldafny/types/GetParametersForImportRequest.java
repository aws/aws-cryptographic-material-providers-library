...
public class GetParametersForImportRequest {
  ...
  private static final GetParametersForImportRequest theDefault = GetParametersForImportRequest.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR), AlgorithmSpec.Default(), WrappingKeySpec.Default());
