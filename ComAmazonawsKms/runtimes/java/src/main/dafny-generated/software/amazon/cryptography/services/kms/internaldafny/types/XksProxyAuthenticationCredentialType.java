...
public class XksProxyAuthenticationCredentialType {
  ...
  private static final XksProxyAuthenticationCredentialType theDefault = software.amazon.cryptography.services.kms.internaldafny.types.XksProxyAuthenticationCredentialType.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR), dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR));
