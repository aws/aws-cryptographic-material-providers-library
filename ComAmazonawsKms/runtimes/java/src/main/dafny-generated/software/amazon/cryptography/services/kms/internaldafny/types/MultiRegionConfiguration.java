...
public class MultiRegionConfiguration {
  ...
  private static final MultiRegionConfiguration theDefault = MultiRegionConfiguration.create(Wrappers_Compile.Option.<MultiRegionKeyType>Default(MultiRegionKeyType._typeDescriptor()), Wrappers_Compile.Option.<MultiRegionKey>Default(MultiRegionKey._typeDescriptor()), Wrappers_Compile.Option.<dafny.DafnySequence<? extends MultiRegionKey>>Default(dafny.DafnySequence.<MultiRegionKey>_typeDescriptor(MultiRegionKey._typeDescriptor())));
