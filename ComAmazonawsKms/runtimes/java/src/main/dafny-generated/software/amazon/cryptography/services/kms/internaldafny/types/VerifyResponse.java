...
public class VerifyResponse {
  ...
  private static final VerifyResponse theDefault = software.amazon.cryptography.services.kms.internaldafny.types.VerifyResponse.create(Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(KeyIdType._typeDescriptor()), Wrappers_Compile.Option.<Boolean>Default(dafny.TypeDescriptor.BOOLEAN), Wrappers_Compile.Option.<SigningAlgorithmSpec>Default(SigningAlgorithmSpec._typeDescriptor()));
