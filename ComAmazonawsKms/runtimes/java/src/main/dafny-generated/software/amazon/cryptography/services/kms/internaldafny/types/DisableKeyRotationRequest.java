...
public class DisableKeyRotationRequest {
  ...
  private static final DisableKeyRotationRequest theDefault = DisableKeyRotationRequest.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR));
