...
public class ReplicateKeyResponse {
  ...
  private static final ReplicateKeyResponse theDefault = ReplicateKeyResponse.create(Wrappers_Compile.Option.<KeyMetadata>Default(KeyMetadata._typeDescriptor()), Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(PolicyType._typeDescriptor()), Wrappers_Compile.Option.<dafny.DafnySequence<? extends Tag>>Default(dafny.DafnySequence.<Tag>_typeDescriptor(Tag._typeDescriptor())));
