...
public class CreateKeyResponse {
  ...
  private static final CreateKeyResponse theDefault = software.amazon.cryptography.services.kms.internaldafny.types.CreateKeyResponse.create(Wrappers_Compile.Option.<KeyMetadata>Default(KeyMetadata._typeDescriptor()));
