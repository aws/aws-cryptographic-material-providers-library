...
public class ScheduleKeyDeletionResponse {
  ...
  private static final ScheduleKeyDeletionResponse theDefault = software.amazon.cryptography.services.kms.internaldafny.types.ScheduleKeyDeletionResponse.create(Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(KeyIdType._typeDescriptor()), Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR)), Wrappers_Compile.Option.<KeyState>Default(KeyState._typeDescriptor()), Wrappers_Compile.Option.<java.lang.Integer>Default(PendingWindowInDaysType._typeDescriptor()));
