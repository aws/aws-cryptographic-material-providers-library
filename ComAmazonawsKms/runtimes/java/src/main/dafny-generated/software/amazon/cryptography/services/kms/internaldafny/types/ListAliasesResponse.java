...
public class ListAliasesResponse {
  ...
  private static final ListAliasesResponse theDefault = ListAliasesResponse.create(Wrappers_Compile.Option.<dafny.DafnySequence<? extends AliasListEntry>>Default(dafny.DafnySequence.<AliasListEntry>_typeDescriptor(AliasListEntry._typeDescriptor())), Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(MarkerType._typeDescriptor()), Wrappers_Compile.Option.<Boolean>Default(dafny.TypeDescriptor.BOOLEAN));
