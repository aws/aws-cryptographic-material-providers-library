...
public class UnwrapGenericKmsTests {
  ...
  public void noAccessUnwrappedFromOpaqueProperly() {
    ...
    final String failingKeyId = "arn:aws:kms:us-west-2:370957321024:key/e20ac7b8-3d95-46ee-b3d5-f5dca6393945";
    Assert.assertTrue(kmsClient.is_Success());
    IKMSClient ikmsClient = kmsClient.dtor_value();
    Result<GenerateDataKeyWithoutPlaintextResponse,Error> response = ikmsClient.GenerateDataKeyWithoutPlaintext(
