...
class KMSClientShim:
    ...
    def CancelKeyDeletion(self, input: DafnyCancelKeyDeletionRequest) -> DafnyCancelKeyDeletionResponse:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_kms_CancelKeyDeletionRequest(input)
        try:
    ...
    def ConnectCustomKeyStore(self, input: DafnyConnectCustomKeyStoreRequest) -> DafnyConnectCustomKeyStoreResponse:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_kms_ConnectCustomKeyStoreRequest(input)
        try:
    ...
    def CreateAlias(self, input: DafnyCreateAliasRequest) -> None:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_kms_CreateAliasRequest(input)
        try:
    ...
    def CreateCustomKeyStore(self, input: DafnyCreateCustomKeyStoreRequest) -> DafnyCreateCustomKeyStoreResponse:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_kms_CreateCustomKeyStoreRequest(input)
        try:
    ...
    def CreateGrant(self, input: DafnyCreateGrantRequest) -> DafnyCreateGrantResponse:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_kms_CreateGrantRequest(input)
        try:
    ...
    def CreateKey(self, input: DafnyCreateKeyRequest) -> DafnyCreateKeyResponse:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_kms_CreateKeyRequest(input)
        try:
    ...
    def Decrypt(self, input: DafnyDecryptRequest) -> DafnyDecryptResponse:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_kms_DecryptRequest(input)
        try:
    ...
    def DeleteAlias(self, input: DafnyDeleteAliasRequest) -> None:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_kms_DeleteAliasRequest(input)
        try:
    ...
    def DeleteCustomKeyStore(self, input: DafnyDeleteCustomKeyStoreRequest) -> DafnyDeleteCustomKeyStoreResponse:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_kms_DeleteCustomKeyStoreRequest(input)
        try:
    ...
    def DeleteImportedKeyMaterial(self, input: DafnyDeleteImportedKeyMaterialRequest) -> None:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_kms_DeleteImportedKeyMaterialRequest(input)
        try:
    ...
    def DescribeCustomKeyStores(self, input: DafnyDescribeCustomKeyStoresRequest) -> DafnyDescribeCustomKeyStoresResponse:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_kms_DescribeCustomKeyStoresRequest(input)
        try:
    ...
    def DescribeKey(self, input: DafnyDescribeKeyRequest) -> DafnyDescribeKeyResponse:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_kms_DescribeKeyRequest(input)
        try:
    ...
    def DisableKey(self, input: DafnyDisableKeyRequest) -> None:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_kms_DisableKeyRequest(input)
        try:
    ...
    def DisableKeyRotation(self, input: DafnyDisableKeyRotationRequest) -> None:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_kms_DisableKeyRotationRequest(input)
        try:
    ...
    def DisconnectCustomKeyStore(self, input: DafnyDisconnectCustomKeyStoreRequest) -> DafnyDisconnectCustomKeyStoreResponse:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_kms_DisconnectCustomKeyStoreRequest(input)
        try:
    ...
    def EnableKey(self, input: DafnyEnableKeyRequest) -> None:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_kms_EnableKeyRequest(input)
        try:
    ...
    def EnableKeyRotation(self, input: DafnyEnableKeyRotationRequest) -> None:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_kms_EnableKeyRotationRequest(input)
        try:
    ...
    def Encrypt(self, input: DafnyEncryptRequest) -> DafnyEncryptResponse:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_kms_EncryptRequest(input)
        try:
    ...
    def GenerateDataKey(self, input: DafnyGenerateDataKeyRequest) -> DafnyGenerateDataKeyResponse:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_kms_GenerateDataKeyRequest(input)
        try:
    ...
    def GenerateDataKeyPair(self, input: DafnyGenerateDataKeyPairRequest) -> DafnyGenerateDataKeyPairResponse:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_kms_GenerateDataKeyPairRequest(input)
        try:
    ...
    def GenerateDataKeyPairWithoutPlaintext(self, input: DafnyGenerateDataKeyPairWithoutPlaintextRequest) -> DafnyGenerateDataKeyPairWithoutPlaintextResponse:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_kms_GenerateDataKeyPairWithoutPlaintextRequest(input)
        try:
    ...
    def GenerateDataKeyWithoutPlaintext(self, input: DafnyGenerateDataKeyWithoutPlaintextRequest) -> DafnyGenerateDataKeyWithoutPlaintextResponse:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_kms_GenerateDataKeyWithoutPlaintextRequest(input)
        try:
    ...
    def GenerateRandom(self, input: DafnyGenerateRandomRequest) -> DafnyGenerateRandomResponse:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_kms_GenerateRandomRequest(input)
        try:
    ...
    def GetKeyPolicy(self, input: DafnyGetKeyPolicyRequest) -> DafnyGetKeyPolicyResponse:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_kms_GetKeyPolicyRequest(input)
        try:
    ...
    def GetKeyRotationStatus(self, input: DafnyGetKeyRotationStatusRequest) -> DafnyGetKeyRotationStatusResponse:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_kms_GetKeyRotationStatusRequest(input)
        try:
    ...
    def GetParametersForImport(self, input: DafnyGetParametersForImportRequest) -> DafnyGetParametersForImportResponse:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_kms_GetParametersForImportRequest(input)
        try:
    ...
    def GetPublicKey(self, input: DafnyGetPublicKeyRequest) -> DafnyGetPublicKeyResponse:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_kms_GetPublicKeyRequest(input)
        try:
    ...
    def ImportKeyMaterial(self, input: DafnyImportKeyMaterialRequest) -> DafnyImportKeyMaterialResponse:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_kms_ImportKeyMaterialRequest(input)
        try:
    ...
    def ListAliases(self, input: DafnyListAliasesRequest) -> DafnyListAliasesResponse:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_kms_ListAliasesRequest(input)
        try:
    ...
    def ListGrants(self, input: DafnyListGrantsRequest) -> DafnyListGrantsResponse:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_kms_ListGrantsRequest(input)
        try:
    ...
    def ListKeyPolicies(self, input: DafnyListKeyPoliciesRequest) -> DafnyListKeyPoliciesResponse:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_kms_ListKeyPoliciesRequest(input)
        try:
    ...
    def ListResourceTags(self, input: DafnyListResourceTagsRequest) -> DafnyListResourceTagsResponse:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_kms_ListResourceTagsRequest(input)
        try:
    ...
    def PutKeyPolicy(self, input: DafnyPutKeyPolicyRequest) -> None:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_kms_PutKeyPolicyRequest(input)
        try:
    ...
    def ReEncrypt(self, input: DafnyReEncryptRequest) -> DafnyReEncryptResponse:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_kms_ReEncryptRequest(input)
        try:
    ...
    def ReplicateKey(self, input: DafnyReplicateKeyRequest) -> DafnyReplicateKeyResponse:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_kms_ReplicateKeyRequest(input)
        try:
    ...
    def RetireGrant(self, input: DafnyRetireGrantRequest) -> None:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_kms_RetireGrantRequest(input)
        try:
    ...
    def RevokeGrant(self, input: DafnyRevokeGrantRequest) -> None:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_kms_RevokeGrantRequest(input)
        try:
    ...
    def ScheduleKeyDeletion(self, input: DafnyScheduleKeyDeletionRequest) -> DafnyScheduleKeyDeletionResponse:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_kms_ScheduleKeyDeletionRequest(input)
        try:
    ...
    def Sign(self, input: DafnySignRequest) -> DafnySignResponse:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_kms_SignRequest(input)
        try:
    ...
    def TagResource(self, input: DafnyTagResourceRequest) -> None:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_kms_TagResourceRequest(input)
        try:
    ...
    def UntagResource(self, input: DafnyUntagResourceRequest) -> None:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_kms_UntagResourceRequest(input)
        try:
    ...
    def UpdateAlias(self, input: DafnyUpdateAliasRequest) -> None:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_kms_UpdateAliasRequest(input)
        try:
    ...
    def UpdateCustomKeyStore(self, input: DafnyUpdateCustomKeyStoreRequest) -> DafnyUpdateCustomKeyStoreResponse:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_kms_UpdateCustomKeyStoreRequest(input)
        try:
    ...
    def UpdateKeyDescription(self, input: DafnyUpdateKeyDescriptionRequest) -> None:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_kms_UpdateKeyDescriptionRequest(input)
        try:
    ...
    def UpdatePrimaryRegion(self, input: DafnyUpdatePrimaryRegionRequest) -> None:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_kms_UpdatePrimaryRegionRequest(input)
        try:
    ...
    def Verify(self, input: DafnyVerifyRequest) -> DafnyVerifyResponse:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_kms_VerifyRequest(input)
        try:
