...
def _sdk_error_to_dafny_error(e: ClientError):
    ...
    if e.response['Error']['Code'] == 'AlreadyExistsException':
        return com_amazonaws_kms.smithygenerated.com_amazonaws_kms.aws_sdk_to_dafny.com_amazonaws_kms_AlreadyExistsException(e.response)

    elif e.response['Error']['Code'] == 'CloudHsmClusterInUseException':
        return com_amazonaws_kms.smithygenerated.com_amazonaws_kms.aws_sdk_to_dafny.com_amazonaws_kms_CloudHsmClusterInUseException(e.response)

    elif e.response['Error']['Code'] == 'CloudHsmClusterInvalidConfigurationException':
        return com_amazonaws_kms.smithygenerated.com_amazonaws_kms.aws_sdk_to_dafny.com_amazonaws_kms_CloudHsmClusterInvalidConfigurationException(e.response)

    elif e.response['Error']['Code'] == 'CloudHsmClusterNotActiveException':
        return com_amazonaws_kms.smithygenerated.com_amazonaws_kms.aws_sdk_to_dafny.com_amazonaws_kms_CloudHsmClusterNotActiveException(e.response)

    elif e.response['Error']['Code'] == 'CloudHsmClusterNotFoundException':
        return com_amazonaws_kms.smithygenerated.com_amazonaws_kms.aws_sdk_to_dafny.com_amazonaws_kms_CloudHsmClusterNotFoundException(e.response)
        ...
        return com_amazonaws_kms.smithygenerated.com_amazonaws_kms.aws_sdk_to_dafny.com_amazonaws_kms_CustomKeyStoreInvalidStateException(e.response)

    elif e.response['Error']['Code'] == 'CustomKeyStoreNameInUseException':
        return com_amazonaws_kms.smithygenerated.com_amazonaws_kms.aws_sdk_to_dafny.com_amazonaws_kms_CustomKeyStoreNameInUseException(e.response)

    elif e.response['Error']['Code'] == 'CustomKeyStoreNotFoundException':
        return com_amazonaws_kms.smithygenerated.com_amazonaws_kms.aws_sdk_to_dafny.com_amazonaws_kms_CustomKeyStoreNotFoundException(e.response)

    elif e.response['Error']['Code'] == 'DependencyTimeoutException':
        return com_amazonaws_kms.smithygenerated.com_amazonaws_kms.aws_sdk_to_dafny.com_amazonaws_kms_DependencyTimeoutException(e.response)
        ...
        return com_amazonaws_kms.smithygenerated.com_amazonaws_kms.aws_sdk_to_dafny.com_amazonaws_kms_IncorrectKeyException(e.response)

    elif e.response['Error']['Code'] == 'IncorrectKeyMaterialException':
        return com_amazonaws_kms.smithygenerated.com_amazonaws_kms.aws_sdk_to_dafny.com_amazonaws_kms_IncorrectKeyMaterialException(e.response)

    elif e.response['Error']['Code'] == 'IncorrectTrustAnchorException':
        return com_amazonaws_kms.smithygenerated.com_amazonaws_kms.aws_sdk_to_dafny.com_amazonaws_kms_IncorrectTrustAnchorException(e.response)

    elif e.response['Error']['Code'] == 'InvalidAliasNameException':
        return com_amazonaws_kms.smithygenerated.com_amazonaws_kms.aws_sdk_to_dafny.com_amazonaws_kms_InvalidAliasNameException(e.response)

    elif e.response['Error']['Code'] == 'InvalidArnException':
        return com_amazonaws_kms.smithygenerated.com_amazonaws_kms.aws_sdk_to_dafny.com_amazonaws_kms_InvalidArnException(e.response)

    elif e.response['Error']['Code'] == 'InvalidCiphertextException':
        return com_amazonaws_kms.smithygenerated.com_amazonaws_kms.aws_sdk_to_dafny.com_amazonaws_kms_InvalidCiphertextException(e.response)

    elif e.response['Error']['Code'] == 'InvalidGrantIdException':
        return com_amazonaws_kms.smithygenerated.com_amazonaws_kms.aws_sdk_to_dafny.com_amazonaws_kms_InvalidGrantIdException(e.response)

    elif e.response['Error']['Code'] == 'InvalidGrantTokenException':
        return com_amazonaws_kms.smithygenerated.com_amazonaws_kms.aws_sdk_to_dafny.com_amazonaws_kms_InvalidGrantTokenException(e.response)

    elif e.response['Error']['Code'] == 'InvalidImportTokenException':
        return com_amazonaws_kms.smithygenerated.com_amazonaws_kms.aws_sdk_to_dafny.com_amazonaws_kms_InvalidImportTokenException(e.response)

    elif e.response['Error']['Code'] == 'InvalidKeyUsageException':
        return com_amazonaws_kms.smithygenerated.com_amazonaws_kms.aws_sdk_to_dafny.com_amazonaws_kms_InvalidKeyUsageException(e.response)

    elif e.response['Error']['Code'] == 'InvalidMarkerException':
        return com_amazonaws_kms.smithygenerated.com_amazonaws_kms.aws_sdk_to_dafny.com_amazonaws_kms_InvalidMarkerException(e.response)

    elif e.response['Error']['Code'] == 'KeyUnavailableException':
        return com_amazonaws_kms.smithygenerated.com_amazonaws_kms.aws_sdk_to_dafny.com_amazonaws_kms_KeyUnavailableException(e.response)
        ...
        return com_amazonaws_kms.smithygenerated.com_amazonaws_kms.aws_sdk_to_dafny.com_amazonaws_kms_KMSInvalidStateException(e.response)

    elif e.response['Error']['Code'] == 'LimitExceededException':
        return com_amazonaws_kms.smithygenerated.com_amazonaws_kms.aws_sdk_to_dafny.com_amazonaws_kms_LimitExceededException(e.response)

    elif e.response['Error']['Code'] == 'MalformedPolicyDocumentException':
        return com_amazonaws_kms.smithygenerated.com_amazonaws_kms.aws_sdk_to_dafny.com_amazonaws_kms_MalformedPolicyDocumentException(e.response)

    elif e.response['Error']['Code'] == 'NotFoundException':
        return com_amazonaws_kms.smithygenerated.com_amazonaws_kms.aws_sdk_to_dafny.com_amazonaws_kms_NotFoundException(e.response)

    elif e.response['Error']['Code'] == 'TagException':
        return com_amazonaws_kms.smithygenerated.com_amazonaws_kms.aws_sdk_to_dafny.com_amazonaws_kms_TagException(e.response)
...
class KMSClientShim:
    ...
    def CancelKeyDeletion(self, input: DafnyCancelKeyDeletionRequest) -> DafnyCancelKeyDeletionResponse:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.com_amazonaws_kms_CancelKeyDeletionRequest(input)
        try:
        ...
        return Wrappers.Result_Success(com_amazonaws_kms.smithygenerated.com_amazonaws_kms.aws_sdk_to_dafny.com_amazonaws_kms_CancelKeyDeletionResponse(boto_response_dict))

    def ConnectCustomKeyStore(self, input: DafnyConnectCustomKeyStoreRequest) -> DafnyConnectCustomKeyStoreResponse:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.com_amazonaws_kms_ConnectCustomKeyStoreRequest(input)
        try:
            boto_response_dict = self._impl.connect_custom_key_store(**boto_request_dict)
        except ClientError as e:
            return Wrappers.Result_Failure(_sdk_error_to_dafny_error(e))

        return Wrappers.Result_Success(com_amazonaws_kms.smithygenerated.com_amazonaws_kms.aws_sdk_to_dafny.com_amazonaws_kms_ConnectCustomKeyStoreResponse(boto_response_dict))

    def CreateAlias(self, input: DafnyCreateAliasRequest) -> None:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.com_amazonaws_kms_CreateAliasRequest(input)
        try:
    ...
    def CreateCustomKeyStore(self, input: DafnyCreateCustomKeyStoreRequest) -> DafnyCreateCustomKeyStoreResponse:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.com_amazonaws_kms_CreateCustomKeyStoreRequest(input)
        try:
            boto_response_dict = self._impl.create_custom_key_store(**boto_request_dict)
        except ClientError as e:
            return Wrappers.Result_Failure(_sdk_error_to_dafny_error(e))

        return Wrappers.Result_Success(com_amazonaws_kms.smithygenerated.com_amazonaws_kms.aws_sdk_to_dafny.com_amazonaws_kms_CreateCustomKeyStoreResponse(boto_response_dict))

    def CreateGrant(self, input: DafnyCreateGrantRequest) -> DafnyCreateGrantResponse:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.com_amazonaws_kms_CreateGrantRequest(input)
        try:
            boto_response_dict = self._impl.create_grant(**boto_request_dict)
        except ClientError as e:
            return Wrappers.Result_Failure(_sdk_error_to_dafny_error(e))

        return Wrappers.Result_Success(com_amazonaws_kms.smithygenerated.com_amazonaws_kms.aws_sdk_to_dafny.com_amazonaws_kms_CreateGrantResponse(boto_response_dict))

    def CreateKey(self, input: DafnyCreateKeyRequest) -> DafnyCreateKeyResponse:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.com_amazonaws_kms_CreateKeyRequest(input)
        try:
            boto_response_dict = self._impl.create_key(**boto_request_dict)
        except ClientError as e:
            return Wrappers.Result_Failure(_sdk_error_to_dafny_error(e))

        return Wrappers.Result_Success(com_amazonaws_kms.smithygenerated.com_amazonaws_kms.aws_sdk_to_dafny.com_amazonaws_kms_CreateKeyResponse(boto_response_dict))

    def Decrypt(self, input: DafnyDecryptRequest) -> DafnyDecryptResponse:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.com_amazonaws_kms_DecryptRequest(input)
        try:
            boto_response_dict = self._impl.decrypt(**boto_request_dict)
        except ClientError as e:
            return Wrappers.Result_Failure(_sdk_error_to_dafny_error(e))

        return Wrappers.Result_Success(com_amazonaws_kms.smithygenerated.com_amazonaws_kms.aws_sdk_to_dafny.com_amazonaws_kms_DecryptResponse(boto_response_dict))

    def DeleteAlias(self, input: DafnyDeleteAliasRequest) -> None:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.com_amazonaws_kms_DeleteAliasRequest(input)
        try:
    ...
    def DeleteCustomKeyStore(self, input: DafnyDeleteCustomKeyStoreRequest) -> DafnyDeleteCustomKeyStoreResponse:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.com_amazonaws_kms_DeleteCustomKeyStoreRequest(input)
        try:
            boto_response_dict = self._impl.delete_custom_key_store(**boto_request_dict)
        except ClientError as e:
            return Wrappers.Result_Failure(_sdk_error_to_dafny_error(e))

        return Wrappers.Result_Success(com_amazonaws_kms.smithygenerated.com_amazonaws_kms.aws_sdk_to_dafny.com_amazonaws_kms_DeleteCustomKeyStoreResponse(boto_response_dict))

    def DeleteImportedKeyMaterial(self, input: DafnyDeleteImportedKeyMaterialRequest) -> None:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.com_amazonaws_kms_DeleteImportedKeyMaterialRequest(input)
        try:
    ...
    def DescribeCustomKeyStores(self, input: DafnyDescribeCustomKeyStoresRequest) -> DafnyDescribeCustomKeyStoresResponse:
        ...
        return Wrappers.Result_Success(com_amazonaws_kms.smithygenerated.com_amazonaws_kms.aws_sdk_to_dafny.com_amazonaws_kms_DescribeCustomKeyStoresResponse(boto_response_dict))

    def DescribeKey(self, input: DafnyDescribeKeyRequest) -> DafnyDescribeKeyResponse:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.com_amazonaws_kms_DescribeKeyRequest(input)
        try:
            boto_response_dict = self._impl.describe_key(**boto_request_dict)
        except ClientError as e:
            return Wrappers.Result_Failure(_sdk_error_to_dafny_error(e))

        return Wrappers.Result_Success(com_amazonaws_kms.smithygenerated.com_amazonaws_kms.aws_sdk_to_dafny.com_amazonaws_kms_DescribeKeyResponse(boto_response_dict))

    def DisableKey(self, input: DafnyDisableKeyRequest) -> None:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.com_amazonaws_kms_DisableKeyRequest(input)
        try:
    ...
    def DisableKeyRotation(self, input: DafnyDisableKeyRotationRequest) -> None:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.com_amazonaws_kms_DisableKeyRotationRequest(input)
        try:
    ...
    def DisconnectCustomKeyStore(self, input: DafnyDisconnectCustomKeyStoreRequest) -> DafnyDisconnectCustomKeyStoreResponse:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.com_amazonaws_kms_DisconnectCustomKeyStoreRequest(input)
        try:
            boto_response_dict = self._impl.disconnect_custom_key_store(**boto_request_dict)
        except ClientError as e:
            return Wrappers.Result_Failure(_sdk_error_to_dafny_error(e))

        return Wrappers.Result_Success(com_amazonaws_kms.smithygenerated.com_amazonaws_kms.aws_sdk_to_dafny.com_amazonaws_kms_DisconnectCustomKeyStoreResponse(boto_response_dict))

    def EnableKey(self, input: DafnyEnableKeyRequest) -> None:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.com_amazonaws_kms_EnableKeyRequest(input)
        try:
    ...
    def EnableKeyRotation(self, input: DafnyEnableKeyRotationRequest) -> None:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.com_amazonaws_kms_EnableKeyRotationRequest(input)
        try:
    ...
    def Encrypt(self, input: DafnyEncryptRequest) -> DafnyEncryptResponse:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.com_amazonaws_kms_EncryptRequest(input)
        try:
            boto_response_dict = self._impl.encrypt(**boto_request_dict)
        except ClientError as e:
            return Wrappers.Result_Failure(_sdk_error_to_dafny_error(e))

        return Wrappers.Result_Success(com_amazonaws_kms.smithygenerated.com_amazonaws_kms.aws_sdk_to_dafny.com_amazonaws_kms_EncryptResponse(boto_response_dict))

    def GenerateDataKey(self, input: DafnyGenerateDataKeyRequest) -> DafnyGenerateDataKeyResponse:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.com_amazonaws_kms_GenerateDataKeyRequest(input)
        try:
            boto_response_dict = self._impl.generate_data_key(**boto_request_dict)
        except ClientError as e:
            return Wrappers.Result_Failure(_sdk_error_to_dafny_error(e))

        return Wrappers.Result_Success(com_amazonaws_kms.smithygenerated.com_amazonaws_kms.aws_sdk_to_dafny.com_amazonaws_kms_GenerateDataKeyResponse(boto_response_dict))

    def GenerateDataKeyPair(self, input: DafnyGenerateDataKeyPairRequest) -> DafnyGenerateDataKeyPairResponse:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.com_amazonaws_kms_GenerateDataKeyPairRequest(input)
        try:
            boto_response_dict = self._impl.generate_data_key_pair(**boto_request_dict)
        except ClientError as e:
            return Wrappers.Result_Failure(_sdk_error_to_dafny_error(e))

        return Wrappers.Result_Success(com_amazonaws_kms.smithygenerated.com_amazonaws_kms.aws_sdk_to_dafny.com_amazonaws_kms_GenerateDataKeyPairResponse(boto_response_dict))
    ...
    def GenerateDataKeyPairWithoutPlaintext(self, input: DafnyGenerateDataKeyPairWithoutPlaintextRequest) -> DafnyGenerateDataKeyPairWithoutPlaintextResponse:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.com_amazonaws_kms_GenerateDataKeyPairWithoutPlaintextRequest(input)
        try:
            boto_response_dict = self._impl.generate_data_key_pair_without_plaintext(**boto_request_dict)
        except ClientError as e:
            return Wrappers.Result_Failure(_sdk_error_to_dafny_error(e))

        return Wrappers.Result_Success(com_amazonaws_kms.smithygenerated.com_amazonaws_kms.aws_sdk_to_dafny.com_amazonaws_kms_GenerateDataKeyPairWithoutPlaintextResponse(boto_response_dict))
    ...
    def GenerateDataKeyWithoutPlaintext(self, input: DafnyGenerateDataKeyWithoutPlaintextRequest) -> DafnyGenerateDataKeyWithoutPlaintextResponse:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.com_amazonaws_kms_GenerateDataKeyWithoutPlaintextRequest(input)
        try:
    ...
    def GenerateRandom(self, input: DafnyGenerateRandomRequest) -> DafnyGenerateRandomResponse:
        ...
        return Wrappers.Result_Success(com_amazonaws_kms.smithygenerated.com_amazonaws_kms.aws_sdk_to_dafny.com_amazonaws_kms_GenerateRandomResponse(boto_response_dict))

    def GetKeyPolicy(self, input: DafnyGetKeyPolicyRequest) -> DafnyGetKeyPolicyResponse:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.com_amazonaws_kms_GetKeyPolicyRequest(input)
        try:
            boto_response_dict = self._impl.get_key_policy(**boto_request_dict)
        except ClientError as e:
            return Wrappers.Result_Failure(_sdk_error_to_dafny_error(e))

        return Wrappers.Result_Success(com_amazonaws_kms.smithygenerated.com_amazonaws_kms.aws_sdk_to_dafny.com_amazonaws_kms_GetKeyPolicyResponse(boto_response_dict))

    def GetKeyRotationStatus(self, input: DafnyGetKeyRotationStatusRequest) -> DafnyGetKeyRotationStatusResponse:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.com_amazonaws_kms_GetKeyRotationStatusRequest(input)
        try:
            boto_response_dict = self._impl.get_key_rotation_status(**boto_request_dict)
        except ClientError as e:
            return Wrappers.Result_Failure(_sdk_error_to_dafny_error(e))

        return Wrappers.Result_Success(com_amazonaws_kms.smithygenerated.com_amazonaws_kms.aws_sdk_to_dafny.com_amazonaws_kms_GetKeyRotationStatusResponse(boto_response_dict))

    def GetParametersForImport(self, input: DafnyGetParametersForImportRequest) -> DafnyGetParametersForImportResponse:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.com_amazonaws_kms_GetParametersForImportRequest(input)
        try:
            boto_response_dict = self._impl.get_parameters_for_import(**boto_request_dict)
        except ClientError as e:
            return Wrappers.Result_Failure(_sdk_error_to_dafny_error(e))

        return Wrappers.Result_Success(com_amazonaws_kms.smithygenerated.com_amazonaws_kms.aws_sdk_to_dafny.com_amazonaws_kms_GetParametersForImportResponse(boto_response_dict))

    def GetPublicKey(self, input: DafnyGetPublicKeyRequest) -> DafnyGetPublicKeyResponse:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.com_amazonaws_kms_GetPublicKeyRequest(input)
        try:
            boto_response_dict = self._impl.get_public_key(**boto_request_dict)
        except ClientError as e:
            return Wrappers.Result_Failure(_sdk_error_to_dafny_error(e))

        return Wrappers.Result_Success(com_amazonaws_kms.smithygenerated.com_amazonaws_kms.aws_sdk_to_dafny.com_amazonaws_kms_GetPublicKeyResponse(boto_response_dict))

    def ImportKeyMaterial(self, input: DafnyImportKeyMaterialRequest) -> DafnyImportKeyMaterialResponse:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.com_amazonaws_kms_ImportKeyMaterialRequest(input)
        try:
            boto_response_dict = self._impl.import_key_material(**boto_request_dict)
        except ClientError as e:
            return Wrappers.Result_Failure(_sdk_error_to_dafny_error(e))

        return Wrappers.Result_Success(com_amazonaws_kms.smithygenerated.com_amazonaws_kms.aws_sdk_to_dafny.com_amazonaws_kms_ImportKeyMaterialResponse(boto_response_dict))

    def ListAliases(self, input: DafnyListAliasesRequest) -> DafnyListAliasesResponse:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.com_amazonaws_kms_ListAliasesRequest(input)
        try:
            boto_response_dict = self._impl.list_aliases(**boto_request_dict)
        except ClientError as e:
            return Wrappers.Result_Failure(_sdk_error_to_dafny_error(e))

        return Wrappers.Result_Success(com_amazonaws_kms.smithygenerated.com_amazonaws_kms.aws_sdk_to_dafny.com_amazonaws_kms_ListAliasesResponse(boto_response_dict))

    def ListGrants(self, input: DafnyListGrantsRequest) -> DafnyListGrantsResponse:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.com_amazonaws_kms_ListGrantsRequest(input)
        try:
            boto_response_dict = self._impl.list_grants(**boto_request_dict)
        except ClientError as e:
            return Wrappers.Result_Failure(_sdk_error_to_dafny_error(e))

        return Wrappers.Result_Success(com_amazonaws_kms.smithygenerated.com_amazonaws_kms.aws_sdk_to_dafny.com_amazonaws_kms_ListGrantsResponse(boto_response_dict))

    def ListKeyPolicies(self, input: DafnyListKeyPoliciesRequest) -> DafnyListKeyPoliciesResponse:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.com_amazonaws_kms_ListKeyPoliciesRequest(input)
        try:
    ...
    def ListResourceTags(self, input: DafnyListResourceTagsRequest) -> DafnyListResourceTagsResponse:
        ...
        return Wrappers.Result_Success(com_amazonaws_kms.smithygenerated.com_amazonaws_kms.aws_sdk_to_dafny.com_amazonaws_kms_ListResourceTagsResponse(boto_response_dict))

    def PutKeyPolicy(self, input: DafnyPutKeyPolicyRequest) -> None:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.com_amazonaws_kms_PutKeyPolicyRequest(input)
        try:
    ...
    def ReEncrypt(self, input: DafnyReEncryptRequest) -> DafnyReEncryptResponse:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.com_amazonaws_kms_ReEncryptRequest(input)
        try:
            boto_response_dict = self._impl.re_encrypt(**boto_request_dict)
        except ClientError as e:
            return Wrappers.Result_Failure(_sdk_error_to_dafny_error(e))

        return Wrappers.Result_Success(com_amazonaws_kms.smithygenerated.com_amazonaws_kms.aws_sdk_to_dafny.com_amazonaws_kms_ReEncryptResponse(boto_response_dict))

    def ReplicateKey(self, input: DafnyReplicateKeyRequest) -> DafnyReplicateKeyResponse:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.com_amazonaws_kms_ReplicateKeyRequest(input)
        try:
            boto_response_dict = self._impl.replicate_key(**boto_request_dict)
        except ClientError as e:
            return Wrappers.Result_Failure(_sdk_error_to_dafny_error(e))

        return Wrappers.Result_Success(com_amazonaws_kms.smithygenerated.com_amazonaws_kms.aws_sdk_to_dafny.com_amazonaws_kms_ReplicateKeyResponse(boto_response_dict))

    def RetireGrant(self, input: DafnyRetireGrantRequest) -> None:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.com_amazonaws_kms_RetireGrantRequest(input)
        try:
    ...
    def RevokeGrant(self, input: DafnyRevokeGrantRequest) -> None:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.com_amazonaws_kms_RevokeGrantRequest(input)
        try:
    ...
    def ScheduleKeyDeletion(self, input: DafnyScheduleKeyDeletionRequest) -> DafnyScheduleKeyDeletionResponse:
        ...
        return Wrappers.Result_Success(com_amazonaws_kms.smithygenerated.com_amazonaws_kms.aws_sdk_to_dafny.com_amazonaws_kms_ScheduleKeyDeletionResponse(boto_response_dict))

    def Sign(self, input: DafnySignRequest) -> DafnySignResponse:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.com_amazonaws_kms_SignRequest(input)
        try:
            boto_response_dict = self._impl.sign(**boto_request_dict)
        except ClientError as e:
            return Wrappers.Result_Failure(_sdk_error_to_dafny_error(e))

        return Wrappers.Result_Success(com_amazonaws_kms.smithygenerated.com_amazonaws_kms.aws_sdk_to_dafny.com_amazonaws_kms_SignResponse(boto_response_dict))

    def TagResource(self, input: DafnyTagResourceRequest) -> None:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.com_amazonaws_kms_TagResourceRequest(input)
        try:
    ...
    def UntagResource(self, input: DafnyUntagResourceRequest) -> None:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.com_amazonaws_kms_UntagResourceRequest(input)
        try:
    ...
    def UpdateAlias(self, input: DafnyUpdateAliasRequest) -> None:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.com_amazonaws_kms_UpdateAliasRequest(input)
        try:
    ...
    def UpdateCustomKeyStore(self, input: DafnyUpdateCustomKeyStoreRequest) -> DafnyUpdateCustomKeyStoreResponse:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.com_amazonaws_kms_UpdateCustomKeyStoreRequest(input)
        try:
            boto_response_dict = self._impl.update_custom_key_store(**boto_request_dict)
        except ClientError as e:
            return Wrappers.Result_Failure(_sdk_error_to_dafny_error(e))

        return Wrappers.Result_Success(com_amazonaws_kms.smithygenerated.com_amazonaws_kms.aws_sdk_to_dafny.com_amazonaws_kms_UpdateCustomKeyStoreResponse(boto_response_dict))

    def UpdateKeyDescription(self, input: DafnyUpdateKeyDescriptionRequest) -> None:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.com_amazonaws_kms_UpdateKeyDescriptionRequest(input)
        try:
    ...
    def UpdatePrimaryRegion(self, input: DafnyUpdatePrimaryRegionRequest) -> None:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.com_amazonaws_kms_UpdatePrimaryRegionRequest(input)
        try:
    ...
    def Verify(self, input: DafnyVerifyRequest) -> DafnyVerifyResponse:
        boto_request_dict = com_amazonaws_kms.smithygenerated.com_amazonaws_kms.dafny_to_aws_sdk.com_amazonaws_kms_VerifyRequest(input)
        try:
