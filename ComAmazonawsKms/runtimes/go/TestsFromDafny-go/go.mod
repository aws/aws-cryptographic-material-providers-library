module github.com/aws/aws-cryptographic-material-providers-library/releases/go/kms/test

go 1.23.0

replace github.com/aws/aws-cryptographic-material-providers-library/releases/go/kms => ../ImplementationFromDafny-go
