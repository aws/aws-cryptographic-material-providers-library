...
import (
	...
	m_TestComAmazonawsKms "github.com/aws/aws-cryptographic-material-providers-library/kms/test/TestComAmazonawsKms"
...
var _ m_TestComAmazonawsKms.Dummy__
...
func (_static *CompanionStruct_Default___) Test____Main____(__noArgsParameter _dafny.Sequence) {
	...
	func() {
		...
		{
			m_TestComAmazonawsKms.Companion_Default___.BasicDecryptTests()
			{
	...
	func() {
		...
		{
			m_TestComAmazonawsKms.Companion_Default___.BasicGenerateTests()
			{
				_dafny.Print((_dafny.SeqOfString("PASSED\n")).SetString())
			}
		}
	}()
	_dafny.Print((_dafny.SeqOfString("TestComAmazonawsKms.BasicGenerateWithoutPlaintextTests: ")).SetString())
	func() {
		defer func() {
			if r := recover(); r != nil {
		...
		{
			m_TestComAmazonawsKms.Companion_Default___.BasicGenerateWithoutPlaintextTests()
			{
				_dafny.Print((_dafny.SeqOfString("PASSED\n")).SetString())
			}
		}
	...
	func() {
		...
		{
			m_TestComAmazonawsKms.Companion_Default___.BasicEncryptTests()
			{
				_dafny.Print((_dafny.SeqOfString("PASSED\n")).SetString())
			}
		}
	}()
	_dafny.Print((_dafny.SeqOfString("TestComAmazonawsKms.BasicFailTests: ")).SetString())
	func() {
		defer func() {
			if r := recover(); r != nil {
		...
		{
			m_TestComAmazonawsKms.Companion_Default___.BasicFailTests()
			{
				_dafny.Print((_dafny.SeqOfString("PASSED\n")).SetString())
			}
		}
	...
	func() {
		...
		{
			m_TestComAmazonawsKms.Companion_Default___.RegionMatchTest()
			{
				_dafny.Print((_dafny.SeqOfString("PASSED\n")).SetString())
			}
		}
	}()
	_dafny.Print((_dafny.SeqOfString("TestComAmazonawsKms.EmptyStringIsDefaultRegion: ")).SetString())
	func() {
		defer func() {
			if r := recover(); r != nil {
		...
		{
			m_TestComAmazonawsKms.Companion_Default___.EmptyStringIsDefaultRegion()
			{
				_dafny.Print((_dafny.SeqOfString("PASSED\n")).SetString())
			}
		}
	}()
	_dafny.Print((_dafny.SeqOfString("TestComAmazonawsKms.DeriveSharedSecretTestSuccess: ")).SetString())
	func() {
		defer func() {
			if r := recover(); r != nil {
		...
		{
			m_TestComAmazonawsKms.Companion_Default___.DeriveSharedSecretTestSuccess()
			{
				_dafny.Print((_dafny.SeqOfString("PASSED\n")).SetString())
			}
		}
	}()
	_dafny.Print((_dafny.SeqOfString("TestComAmazonawsKms.DeriveSharedSecretTestFailure: ")).SetString())
	func() {
		defer func() {
			if r := recover(); r != nil {
		...
		{
			m_TestComAmazonawsKms.Companion_Default___.DeriveSharedSecretTestFailure()
			{
				_dafny.Print((_dafny.SeqOfString("PASSED\n")).SetString())
			}
		}
