...
func (_static *CompanionStruct_Default___) CreateSuccessOfClient(client m_ComAmazonawsKmsTypes.IKMSClient) m_Wrappers.Result {
	return m_Wrappers.Companion_Result_.Create_Success_(client)
}
func (_static *CompanionStruct_Default___) CreateFailureOfError(error_ m_ComAmazonawsKmsTypes.Error) m_Wrappers.Result {
