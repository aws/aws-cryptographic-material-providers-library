...
from aws_cryptography_primitives.internal_generated_dafny.Digest import *
...
aws_cryptography_primitives.internal_generated_dafny.Digest.default__ = default__