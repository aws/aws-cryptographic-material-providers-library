...
class default__:
    ...
    def Digest(input):
        ...
        if (d_30_valueOrError0_).IsFailure():
            ...
            d_31_valueOrError1_ = Wrappers.default__.Need((len((input).message)) < (StandardLibrary_mUInt.default__.INT32__MAX__LIMIT), software_amazon_cryptography_primitives_internaldafny_types.Error_AwsCryptographicPrimitivesError(_dafny.Seq("Message over INT32_MAX_LIMIT")))
