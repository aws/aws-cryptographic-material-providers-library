...
def _smithy_error_to_dafny_error(e: ServiceError):
    ...
    if isinstance(e, OpaqueError):
        return aws_cryptography_primitives.internaldafny.generated.AwsCryptographyPrimitivesTypes.Error_Opaque(obj=e.obj, alt__text=e.alt_text)

    else:
        return aws_cryptography_primitives.internaldafny.generated.AwsCryptographyPrimitivesTypes.Error_Opaque(obj=e, alt__text=_dafny.Seq(
          "".join(
              [
