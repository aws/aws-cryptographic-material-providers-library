...
def _smithy_error_to_dafny_error(e: ServiceError):
    ...
    if isinstance(e, OpaqueWithTextError):
        return aws_cryptography_primitives.internaldafny.generated.AwsCryptographyPrimitivesTypes.Error_OpaqueWithText(obj=e.obj, objMessage=e.obj_message)

    else:
        return aws_cryptography_primitives.internaldafny.generated.AwsCryptographyPrimitivesTypes.Error_Opaque(obj=e)
