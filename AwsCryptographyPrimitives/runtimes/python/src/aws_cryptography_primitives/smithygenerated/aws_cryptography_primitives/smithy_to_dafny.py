...
def aws_cryptography_primitives_DigestInput(native_input):
    return DafnyDigestInput(
        digestAlgorithm=aws_cryptography_primitives.smithygenerated.aws_cryptography_primitives.smithy_to_dafny.aws_cryptography_primitives_DigestAlgorithm(native_input.digest_algorithm),
...
def aws_cryptography_primitives_HkdfExtractInput(native_input):
    return DafnyHkdfExtractInput(
        digestAlgorithm=aws_cryptography_primitives.smithygenerated.aws_cryptography_primitives.smithy_to_dafny.aws_cryptography_primitives_DigestAlgorithm(native_input.digest_algorithm),
        salt=((Option_Some(Seq(native_input.salt))) if (native_input.salt is not None) else (Option_None())),
...
def aws_cryptography_primitives_KdfCtrInput(native_input):
    return DafnyKdfCtrInput(
        ...
        ikm=Seq(native_input.ikm),
        expectedLength=native_input.expected_length,
        purpose=((Option_Some(Seq(native_input.purpose))) if (native_input.purpose is not None) else (Option_None())),
        nonce=((Option_Some(Seq(native_input.nonce))) if (native_input.nonce is not None) else (Option_None())),
    )
...
def aws_cryptography_primitives_AESEncryptInput(native_input):
    return DafnyAESEncryptInput(
        encAlg=aws_cryptography_primitives.smithygenerated.aws_cryptography_primitives.smithy_to_dafny.aws_cryptography_primitives_AES_GCM(native_input.enc_alg),
...
def aws_cryptography_primitives_RSADecryptInput(native_input):
    return DafnyRSADecryptInput(
        padding=aws_cryptography_primitives.smithygenerated.aws_cryptography_primitives.smithy_to_dafny.aws_cryptography_primitives_RSAPaddingMode(native_input.padding),
...
def aws_cryptography_primitives_GenerateECDSASignatureKeyInput(native_input):
    return DafnyGenerateECDSASignatureKeyInput(
        signatureAlgorithm=aws_cryptography_primitives.smithygenerated.aws_cryptography_primitives.smithy_to_dafny.aws_cryptography_primitives_ECDSASignatureAlgorithm(native_input.signature_algorithm),
    )
...
def aws_cryptography_primitives_GenerateECCKeyPairInput(native_input):
    return DafnyGenerateECCKeyPairInput(
        eccCurve=aws_cryptography_primitives.smithygenerated.aws_cryptography_primitives.smithy_to_dafny.aws_cryptography_primitives_ECDHCurveSpec(native_input.ecc_curve),
    )
...
def aws_cryptography_primitives_GetPublicKeyFromPrivateKeyInput(native_input):
    return DafnyGetPublicKeyFromPrivateKeyInput(
        eccCurve=aws_cryptography_primitives.smithygenerated.aws_cryptography_primitives.smithy_to_dafny.aws_cryptography_primitives_ECDHCurveSpec(native_input.ecc_curve),
        privateKey=aws_cryptography_primitives.smithygenerated.aws_cryptography_primitives.smithy_to_dafny.aws_cryptography_primitives_ECCPrivateKey(native_input.private_key),
    )
...
def aws_cryptography_primitives_DeriveSharedSecretInput(native_input):
    return DafnyDeriveSharedSecretInput(
        eccCurve=aws_cryptography_primitives.smithygenerated.aws_cryptography_primitives.smithy_to_dafny.aws_cryptography_primitives_ECDHCurveSpec(native_input.ecc_curve),
        privateKey=aws_cryptography_primitives.smithygenerated.aws_cryptography_primitives.smithy_to_dafny.aws_cryptography_primitives_ECCPrivateKey(native_input.private_key),
        publicKey=aws_cryptography_primitives.smithygenerated.aws_cryptography_primitives.smithy_to_dafny.aws_cryptography_primitives_ECCPublicKey(native_input.public_key),
    )
...
def aws_cryptography_primitives_GenerateRSAKeyPairOutput(native_input):
    return DafnyGenerateRSAKeyPairOutput(
        publicKey=aws_cryptography_primitives.smithygenerated.aws_cryptography_primitives.smithy_to_dafny.aws_cryptography_primitives_RSAPublicKey(native_input.public_key),
        privateKey=aws_cryptography_primitives.smithygenerated.aws_cryptography_primitives.smithy_to_dafny.aws_cryptography_primitives_RSAPrivateKey(native_input.private_key),
    )
