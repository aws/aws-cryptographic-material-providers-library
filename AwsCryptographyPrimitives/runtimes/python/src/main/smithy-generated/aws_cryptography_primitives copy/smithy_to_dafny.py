...
def SmithyToDafny_aws_cryptography_primitives_AESDecryptInput(input):
    return DafnyAESDecryptInput(
        encAlg=aws_cryptography_primitives.smithygenerated.smithy_to_dafny.SmithyToDafny_aws_cryptography_primitives_AES_GCM(input.enc_alg),
        key=Seq(input.key),
...
def SmithyToDafny_aws_cryptography_primitives_GenerateRandomBytesOutput(input):
    return Seq(input.data)

def SmithyToDafny_aws_cryptography_primitives_GenerateRSAKeyPairOutput(input):
    return DafnyGenerateRSAKeyPairOutput(
        publicKey=aws_cryptography_primitives.smithygenerated.smithy_to_dafny.SmithyToDafny_aws_cryptography_primitives_RSAPublicKey(input.public_key),
        privateKey=aws_cryptography_primitives.smithygenerated.smithy_to_dafny.SmithyToDafny_aws_cryptography_primitives_RSAPrivateKey(input.private_key),
    )
