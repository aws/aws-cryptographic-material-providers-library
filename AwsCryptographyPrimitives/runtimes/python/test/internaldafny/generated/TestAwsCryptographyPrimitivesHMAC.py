...
class default__:
    ...
    def BasicHMACTest(digestAlgorithm, key, message, expectedDigest):
        d_122_client_: Aws_Cryptography_Primitives.AtomicPrimitivesClient
        d_123_valueOrError0_: Wrappers.Result = None
        out25_: Wrappers.Result
        out25_ = Aws_Cryptography_Primitives.default__.AtomicPrimitives(Aws_Cryptography_Primitives.default__.DefaultCryptoConfig())
