...
class default__:
    ...
    def RSAEncryptTests():
        ...
        if not(not((d_0_valueOrError0_).IsFailure())):
            raise _dafny.HaltException("test/TestRSA.dfy(51,18): " + _dafny.string_of(d_0_valueOrError0_))
    ...
    def GetRSAKeyModulusLength():
        ...
        d_0_valueOrError0_ = out0_
        if not(not((d_0_valueOrError0_).IsFailure())):
            raise _dafny.HaltException("test/TestRSA.dfy(67,18): " + _dafny.string_of(d_0_valueOrError0_))
        d_1_client_: AtomicPrimitives.AtomicPrimitivesClient
        d_1_client_ = (d_0_valueOrError0_).Extract()
        ...
        if not(not((d_2_valueOrError1_).IsFailure())):
            raise _dafny.HaltException("test/TestRSA.dfy(71,25): " + _dafny.string_of(d_2_valueOrError1_))
        ...
        if not(not((d_4_valueOrError2_).IsFailure())):
            raise _dafny.HaltException("test/TestRSA.dfy(72,22): " + _dafny.string_of(d_4_valueOrError2_))
        ...
        if not(not((d_6_valueOrError3_).IsFailure())):
            raise _dafny.HaltException("test/TestRSA.dfy(77,25): " + _dafny.string_of(d_6_valueOrError3_))
        ...
        if not(not((d_8_valueOrError4_).IsFailure())):
            raise _dafny.HaltException("test/TestRSA.dfy(78,22): " + _dafny.string_of(d_8_valueOrError4_))
        ...
        if not(not((d_10_valueOrError5_).IsFailure())):
            raise _dafny.HaltException("test/TestRSA.dfy(83,25): " + _dafny.string_of(d_10_valueOrError5_))
        ...
        if not(not((d_12_valueOrError6_).IsFailure())):
            raise _dafny.HaltException("test/TestRSA.dfy(84,22): " + _dafny.string_of(d_12_valueOrError6_))
    ...
    def BasicRSADecryptTests(input, expectedOutput):
        ...
        d_0_valueOrError0_ = out0_
        if not(not((d_0_valueOrError0_).IsFailure())):
            raise _dafny.HaltException("test/TestRSA.dfy(94,18): " + _dafny.string_of(d_0_valueOrError0_))
        d_1_client_: AtomicPrimitives.AtomicPrimitivesClient
        d_1_client_ = (d_0_valueOrError0_).Extract()
        ...
        if not(not((d_2_valueOrError1_).IsFailure())):
            raise _dafny.HaltException("test/TestRSA.dfy(95,18): " + _dafny.string_of(d_2_valueOrError1_))
    ...
    def BasicRSAEncryptTest(input, keypair):
        ...
        d_0_valueOrError0_ = out0_
        if not(not((d_0_valueOrError0_).IsFailure())):
            raise _dafny.HaltException("test/TestRSA.dfy(106,18): " + _dafny.string_of(d_0_valueOrError0_))
        d_1_client_: AtomicPrimitives.AtomicPrimitivesClient
        d_1_client_ = (d_0_valueOrError0_).Extract()
        d_2_valueOrError1_: Wrappers.Result = Wrappers.Result.default(_dafny.Seq)()
        out1_: Wrappers.Result
        ...
        d_2_valueOrError1_ = out1_
        if not(not((d_2_valueOrError1_).IsFailure())):
            raise _dafny.HaltException("test/TestRSA.dfy(107,18): " + _dafny.string_of(d_2_valueOrError1_))
        d_3_output_: _dafny.Seq
        d_3_output_ = (d_2_valueOrError1_).Extract()
    ...
    def TestingPemParsingInRSAEncryptionForRSAKeyPairStoredInPEM():
        ...
        if not(not((d_2_valueOrError0_).IsFailure())):
            raise _dafny.HaltException("test/TestRSA.dfy(121,51): " + _dafny.string_of(d_2_valueOrError0_))
        ...
        if not(not((d_4_valueOrError1_).IsFailure())):
            raise _dafny.HaltException("test/TestRSA.dfy(122,52): " + _dafny.string_of(d_4_valueOrError1_))
        ...
        while (d_0_allPadding_) != (_dafny.Set({})):
            d_7_padding_: AwsCryptographyPrimitivesTypes.RSAPaddingMode
            with _dafny.label("_ASSIGN_SUCH_THAT_d_0"):
                assign_such_that_0_: AwsCryptographyPrimitivesTypes.RSAPaddingMode
                for assign_such_that_0_ in (d_0_allPadding_).Elements:
                    d_7_padding_ = assign_such_that_0_
                    if (d_7_padding_) in (d_0_allPadding_):
                        raise _dafny.Break("_ASSIGN_SUCH_THAT_d_0")
                raise Exception("assign-such-that search produced no value (line 136)")
                pass
            default__.BasicRSAEncryptTest(AwsCryptographyPrimitivesTypes.RSAEncryptInput_RSAEncryptInput(d_7_padding_, ((d_6_KeyFromGenerateRSAKeyPair_).publicKey).pem, _dafny.Seq([97, 115, 100, 102])), d_6_KeyFromGenerateRSAKeyPair_)
            d_0_allPadding_ = (d_0_allPadding_) - (_dafny.Set({d_7_padding_}))
    ...
    def TestingPemParsingInRSAEncryptionForOnlyRSAPrivateKeyStoredInPEM():
        ...
        if not(not((d_2_valueOrError0_).IsFailure())):
            raise _dafny.HaltException("test/TestRSA.dfy(154,44): " + _dafny.string_of(d_2_valueOrError0_))
        ...
        if not(not((d_4_valueOrError1_).IsFailure())):
            raise _dafny.HaltException("test/TestRSA.dfy(155,45): " + _dafny.string_of(d_4_valueOrError1_))
        ...
        while (d_0_allPadding_) != (_dafny.Set({})):
            ...
            with _dafny.label("_ASSIGN_SUCH_THAT_d_0"):
                ...
                pass
            default__.BasicRSAEncryptTest(AwsCryptographyPrimitivesTypes.RSAEncryptInput_RSAEncryptInput(d_7_padding_, ((d_6_KeyFromTestVectorsPair_).publicKey).pem, _dafny.Seq([97, 115, 100, 102])), d_6_KeyFromTestVectorsPair_)
            d_0_allPadding_ = (d_0_allPadding_) - (_dafny.Set({d_7_padding_}))
