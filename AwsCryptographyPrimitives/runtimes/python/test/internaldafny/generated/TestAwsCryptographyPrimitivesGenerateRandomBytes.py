...
class default__:
    ...
    def BasicGenerateRandomBytes():
        d_34_client_: Aws_Cryptography_Primitives.AtomicPrimitivesClient
        d_35_valueOrError0_: Wrappers.Result = None
        out9_: Wrappers.Result
        out9_ = Aws_Cryptography_Primitives.default__.AtomicPrimitives(Aws_Cryptography_Primitives.default__.DefaultCryptoConfig())
