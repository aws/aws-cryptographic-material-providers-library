...
class default__:
    ...
    @staticmethod
    def DigestTests():
        d_132_client_: software.amazon.cryptography.primitives.internaldafny.types.IAwsCryptographicPrimitivesClient
    ...
    def HmacSHA__256(client):
        ...
        d_135_valueOrError0_ = default__.BasicHMacTest(client, software.amazon.cryptography.primitives.internaldafny.types.HMacInput_HMacInput(software.amazon.cryptography.primitives.internaldafny.types.DigestAlgorithm_SHA__256(), _dafny.Seq([1, 1, 1, 1]), _dafny.Seq([97, 115, 100, 102])), _dafny.Seq([93, 12, 86, 145, 123, 239, 169, 72, 195, 226, 204, 179, 103, 94, 195, 83, 134, 128, 226, 185, 184, 203, 98, 100, 115, 32, 7, 44, 172, 11, 81, 16]))
    ...
    def HmacSHA__384(client):
        ...
        d_137_valueOrError0_ = default__.BasicHMacTest(client, software.amazon.cryptography.primitives.internaldafny.types.HMacInput_HMacInput(software.amazon.cryptography.primitives.internaldafny.types.DigestAlgorithm_SHA__384(), _dafny.Seq([1, 1, 1, 1]), _dafny.Seq([97, 115, 100, 102])), _dafny.Seq([219, 44, 51, 60, 217, 57, 186, 208, 8, 69, 115, 185, 190, 136, 136, 1, 69, 143, 151, 148, 7, 66, 149, 193, 16, 225, 51, 85, 92, 176, 139, 249, 56, 93, 189, 11, 150, 21, 135, 54, 153, 37, 76, 68, 70, 77, 154, 124]))
    ...
    def HmacSHA__512(client):
        ...
        d_139_valueOrError0_ = default__.BasicHMacTest(client, software.amazon.cryptography.primitives.internaldafny.types.HMacInput_HMacInput(software.amazon.cryptography.primitives.internaldafny.types.DigestAlgorithm_SHA__512(), _dafny.Seq([1, 1, 1, 1]), _dafny.Seq([97, 115, 100, 102])), _dafny.Seq([49, 213, 21, 219, 23, 169, 195, 39, 177, 1, 15, 162, 233, 182, 208, 84, 226, 3, 27, 120, 75, 78, 85, 46, 220, 5, 166, 206, 79, 47, 25, 94, 88, 119, 211, 192, 148, 23, 252, 155, 98, 218, 97, 225, 38, 93, 83, 113, 139, 95, 101, 222, 154, 98, 244, 206, 88, 229, 6, 115, 226, 188, 152, 173]))
    ...
    def BasicHMacTest(client, input, expectedDigest):
        ...
        if (d_140_valueOrError0_).IsFailure():
            ...
            d_142_valueOrError1_ = Wrappers.default__.Need((len(d_141_output_)) == (Digest.default__.Length((input).digestAlgorithm)), software.amazon.cryptography.primitives.internaldafny.types.Error_AwsCryptographicPrimitivesError(_dafny.Seq("Error")))
            if (d_142_valueOrError1_).IsFailure():
                return (d_142_valueOrError1_).PropagateFailure()
            elif True:
                d_143_valueOrError2_ = Wrappers.default__.Need((d_141_output_) == (expectedDigest), software.amazon.cryptography.primitives.internaldafny.types.Error_AwsCryptographicPrimitivesError(_dafny.Seq("Error")))
