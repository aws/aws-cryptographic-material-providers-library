...
namespace AWS.Cryptography.Primitives
{
    public class AtomicPrimitives
    {
        ...
        public AtomicPrimitives(AWS.Cryptography.Primitives.CryptoConfig input)
        {
            ...
            var result = software.amazon.cryptography.primitives.internaldafny.AwsCryptographyPrimitives.__default.AtomicPrimitives(internalInput);
        ...
        public System.IO.MemoryStream GenerateRandomBytes(AWS.Cryptography.Primitives.GenerateRandomBytesInput input)
        {
            ...
            software.amazon.cryptography.standardlibrary.internaldafny.Wrappers._IResult<Dafny.ISequence<byte>, software.amazon.cryptography.primitives.internaldafny.types._IError> result = _impl.GenerateRandomBytes(internalInput);
            if (result.is_Failure) throw TypeConversion.FromDafny_CommonError(result.dtor_error);
        ...
        public System.IO.MemoryStream Digest(AWS.Cryptography.Primitives.DigestInput input)
        {
            ...
            software.amazon.cryptography.standardlibrary.internaldafny.Wrappers._IResult<Dafny.ISequence<byte>, software.amazon.cryptography.primitives.internaldafny.types._IError> result = _impl.Digest(internalInput);
            if (result.is_Failure) throw TypeConversion.FromDafny_CommonError(result.dtor_error);
        ...
        public System.IO.MemoryStream HMac(AWS.Cryptography.Primitives.HMacInput input)
        {
            ...
            software.amazon.cryptography.standardlibrary.internaldafny.Wrappers._IResult<Dafny.ISequence<byte>, software.amazon.cryptography.primitives.internaldafny.types._IError> result = _impl.HMac(internalInput);
            if (result.is_Failure) throw TypeConversion.FromDafny_CommonError(result.dtor_error);
        ...
        public System.IO.MemoryStream HkdfExtract(AWS.Cryptography.Primitives.HkdfExtractInput input)
        {
            ...
            software.amazon.cryptography.standardlibrary.internaldafny.Wrappers._IResult<Dafny.ISequence<byte>, software.amazon.cryptography.primitives.internaldafny.types._IError> result = _impl.HkdfExtract(internalInput);
            if (result.is_Failure) throw TypeConversion.FromDafny_CommonError(result.dtor_error);
        ...
        public System.IO.MemoryStream HkdfExpand(AWS.Cryptography.Primitives.HkdfExpandInput input)
        {
            ...
            software.amazon.cryptography.standardlibrary.internaldafny.Wrappers._IResult<Dafny.ISequence<byte>, software.amazon.cryptography.primitives.internaldafny.types._IError> result = _impl.HkdfExpand(internalInput);
            if (result.is_Failure) throw TypeConversion.FromDafny_CommonError(result.dtor_error);
        ...
        public System.IO.MemoryStream Hkdf(AWS.Cryptography.Primitives.HkdfInput input)
        {
            ...
            software.amazon.cryptography.standardlibrary.internaldafny.Wrappers._IResult<Dafny.ISequence<byte>, software.amazon.cryptography.primitives.internaldafny.types._IError> result = _impl.Hkdf(internalInput);
            if (result.is_Failure) throw TypeConversion.FromDafny_CommonError(result.dtor_error);
        ...
        public System.IO.MemoryStream KdfCounterMode(AWS.Cryptography.Primitives.KdfCtrInput input)
        {
            ...
            software.amazon.cryptography.standardlibrary.internaldafny.Wrappers._IResult<Dafny.ISequence<byte>, software.amazon.cryptography.primitives.internaldafny.types._IError> result = _impl.KdfCounterMode(internalInput);
            if (result.is_Failure) throw TypeConversion.FromDafny_CommonError(result.dtor_error);
        ...
        public System.IO.MemoryStream AesKdfCounterMode(AWS.Cryptography.Primitives.AesKdfCtrInput input)
        {
            ...
            software.amazon.cryptography.standardlibrary.internaldafny.Wrappers._IResult<Dafny.ISequence<byte>, software.amazon.cryptography.primitives.internaldafny.types._IError> result = _impl.AesKdfCounterMode(internalInput);
            if (result.is_Failure) throw TypeConversion.FromDafny_CommonError(result.dtor_error);
        ...
        public AWS.Cryptography.Primitives.AESEncryptOutput AESEncrypt(AWS.Cryptography.Primitives.AESEncryptInput input)
        {
            ...
            software.amazon.cryptography.standardlibrary.internaldafny.Wrappers._IResult<software.amazon.cryptography.primitives.internaldafny.types._IAESEncryptOutput, software.amazon.cryptography.primitives.internaldafny.types._IError> result = _impl.AESEncrypt(internalInput);
            if (result.is_Failure) throw TypeConversion.FromDafny_CommonError(result.dtor_error);
        ...
        public System.IO.MemoryStream AESDecrypt(AWS.Cryptography.Primitives.AESDecryptInput input)
        {
            ...
            software.amazon.cryptography.standardlibrary.internaldafny.Wrappers._IResult<Dafny.ISequence<byte>, software.amazon.cryptography.primitives.internaldafny.types._IError> result = _impl.AESDecrypt(internalInput);
            if (result.is_Failure) throw TypeConversion.FromDafny_CommonError(result.dtor_error);
        ...
        public AWS.Cryptography.Primitives.GenerateRSAKeyPairOutput GenerateRSAKeyPair(AWS.Cryptography.Primitives.GenerateRSAKeyPairInput input)
        {
            ...
            software.amazon.cryptography.standardlibrary.internaldafny.Wrappers._IResult<software.amazon.cryptography.primitives.internaldafny.types._IGenerateRSAKeyPairOutput, software.amazon.cryptography.primitives.internaldafny.types._IError> result = _impl.GenerateRSAKeyPair(internalInput);
            if (result.is_Failure) throw TypeConversion.FromDafny_CommonError(result.dtor_error);
        ...
        public AWS.Cryptography.Primitives.GetRSAKeyModulusLengthOutput GetRSAKeyModulusLength(AWS.Cryptography.Primitives.GetRSAKeyModulusLengthInput input)
        {
            ...
            software.amazon.cryptography.standardlibrary.internaldafny.Wrappers._IResult<software.amazon.cryptography.primitives.internaldafny.types._IGetRSAKeyModulusLengthOutput, software.amazon.cryptography.primitives.internaldafny.types._IError> result = _impl.GetRSAKeyModulusLength(internalInput);
            if (result.is_Failure) throw TypeConversion.FromDafny_CommonError(result.dtor_error);
        ...
        public System.IO.MemoryStream RSADecrypt(AWS.Cryptography.Primitives.RSADecryptInput input)
        {
            ...
            software.amazon.cryptography.standardlibrary.internaldafny.Wrappers._IResult<Dafny.ISequence<byte>, software.amazon.cryptography.primitives.internaldafny.types._IError> result = _impl.RSADecrypt(internalInput);
            if (result.is_Failure) throw TypeConversion.FromDafny_CommonError(result.dtor_error);
        ...
        public System.IO.MemoryStream RSAEncrypt(AWS.Cryptography.Primitives.RSAEncryptInput input)
        {
            ...
            software.amazon.cryptography.standardlibrary.internaldafny.Wrappers._IResult<Dafny.ISequence<byte>, software.amazon.cryptography.primitives.internaldafny.types._IError> result = _impl.RSAEncrypt(internalInput);
            if (result.is_Failure) throw TypeConversion.FromDafny_CommonError(result.dtor_error);
        ...
        public AWS.Cryptography.Primitives.GenerateECDSASignatureKeyOutput GenerateECDSASignatureKey(AWS.Cryptography.Primitives.GenerateECDSASignatureKeyInput input)
        {
            ...
            software.amazon.cryptography.standardlibrary.internaldafny.Wrappers._IResult<software.amazon.cryptography.primitives.internaldafny.types._IGenerateECDSASignatureKeyOutput, software.amazon.cryptography.primitives.internaldafny.types._IError> result = _impl.GenerateECDSASignatureKey(internalInput);
            if (result.is_Failure) throw TypeConversion.FromDafny_CommonError(result.dtor_error);
        ...
        public System.IO.MemoryStream ECDSASign(AWS.Cryptography.Primitives.ECDSASignInput input)
        {
            ...
            software.amazon.cryptography.standardlibrary.internaldafny.Wrappers._IResult<Dafny.ISequence<byte>, software.amazon.cryptography.primitives.internaldafny.types._IError> result = _impl.ECDSASign(internalInput);
            if (result.is_Failure) throw TypeConversion.FromDafny_CommonError(result.dtor_error);
        ...
        public bool ECDSAVerify(AWS.Cryptography.Primitives.ECDSAVerifyInput input)
        {
            ...
            software.amazon.cryptography.standardlibrary.internaldafny.Wrappers._IResult<bool, software.amazon.cryptography.primitives.internaldafny.types._IError> result = _impl.ECDSAVerify(internalInput);
            if (result.is_Failure) throw TypeConversion.FromDafny_CommonError(result.dtor_error);
        ...
        public AWS.Cryptography.Primitives.GenerateECCKeyPairOutput GenerateECCKeyPair(AWS.Cryptography.Primitives.GenerateECCKeyPairInput input)
        {
            ...
            software.amazon.cryptography.standardlibrary.internaldafny.Wrappers._IResult<software.amazon.cryptography.primitives.internaldafny.types._IGenerateECCKeyPairOutput, software.amazon.cryptography.primitives.internaldafny.types._IError> result = _impl.GenerateECCKeyPair(internalInput);
            if (result.is_Failure) throw TypeConversion.FromDafny_CommonError(result.dtor_error);
        ...
        public AWS.Cryptography.Primitives.GetPublicKeyFromPrivateKeyOutput GetPublicKeyFromPrivateKey(AWS.Cryptography.Primitives.GetPublicKeyFromPrivateKeyInput input)
        {
            ...
            software.amazon.cryptography.standardlibrary.internaldafny.Wrappers._IResult<software.amazon.cryptography.primitives.internaldafny.types._IGetPublicKeyFromPrivateKeyOutput, software.amazon.cryptography.primitives.internaldafny.types._IError> result = _impl.GetPublicKeyFromPrivateKey(internalInput);
            if (result.is_Failure) throw TypeConversion.FromDafny_CommonError(result.dtor_error);
        ...
        public AWS.Cryptography.Primitives.ValidatePublicKeyOutput ValidatePublicKey(AWS.Cryptography.Primitives.ValidatePublicKeyInput input)
        {
            ...
            software.amazon.cryptography.standardlibrary.internaldafny.Wrappers._IResult<software.amazon.cryptography.primitives.internaldafny.types._IValidatePublicKeyOutput, software.amazon.cryptography.primitives.internaldafny.types._IError> result = _impl.ValidatePublicKey(internalInput);
            if (result.is_Failure) throw TypeConversion.FromDafny_CommonError(result.dtor_error);
        ...
        public AWS.Cryptography.Primitives.DeriveSharedSecretOutput DeriveSharedSecret(AWS.Cryptography.Primitives.DeriveSharedSecretInput input)
        {
            ...
            software.amazon.cryptography.standardlibrary.internaldafny.Wrappers._IResult<software.amazon.cryptography.primitives.internaldafny.types._IDeriveSharedSecretOutput, software.amazon.cryptography.primitives.internaldafny.types._IError> result = _impl.DeriveSharedSecret(internalInput);
            if (result.is_Failure) throw TypeConversion.FromDafny_CommonError(result.dtor_error);
        ...
        public AWS.Cryptography.Primitives.CompressPublicKeyOutput CompressPublicKey(AWS.Cryptography.Primitives.CompressPublicKeyInput input)
        {
            ...
            software.amazon.cryptography.standardlibrary.internaldafny.Wrappers._IResult<software.amazon.cryptography.primitives.internaldafny.types._ICompressPublicKeyOutput, software.amazon.cryptography.primitives.internaldafny.types._IError> result = _impl.CompressPublicKey(internalInput);
            if (result.is_Failure) throw TypeConversion.FromDafny_CommonError(result.dtor_error);
        ...
        public AWS.Cryptography.Primitives.DecompressPublicKeyOutput DecompressPublicKey(AWS.Cryptography.Primitives.DecompressPublicKeyInput input)
        {
            ...
            software.amazon.cryptography.standardlibrary.internaldafny.Wrappers._IResult<software.amazon.cryptography.primitives.internaldafny.types._IDecompressPublicKeyOutput, software.amazon.cryptography.primitives.internaldafny.types._IError> result = _impl.DecompressPublicKey(internalInput);
            if (result.is_Failure) throw TypeConversion.FromDafny_CommonError(result.dtor_error);
        ...
        public AWS.Cryptography.Primitives.ParsePublicKeyOutput ParsePublicKey(AWS.Cryptography.Primitives.ParsePublicKeyInput input)
        {
            ...
            software.amazon.cryptography.standardlibrary.internaldafny.Wrappers._IResult<software.amazon.cryptography.primitives.internaldafny.types._IParsePublicKeyOutput, software.amazon.cryptography.primitives.internaldafny.types._IError> result = _impl.ParsePublicKey(internalInput);
            if (result.is_Failure) throw TypeConversion.FromDafny_CommonError(result.dtor_error);
