...
// Dafny module ConstantTime compiled into Go
...
func (_static *CompanionStruct_Default___) Compare(a _dafny.Sequence, b _dafny.Sequence, acc uint8) uint8 {
	goto TAIL_CALL_START
TAIL_CALL_START:
	if (_dafny.IntOfUint32((a).Cardinality())).Sign() == 0 {
		return acc
	} else {
		var _0_x uint8 = (uint8((a).Select(0).(uint8))) ^ (uint8((b).Select(0).(uint8)))
		_ = _0_x
		var _in0 _dafny.Sequence = (a).Drop(1)
		_ = _in0
		var _in1 _dafny.Sequence = (b).Drop(1)
		_ = _in1
		var _in2 uint8 = (_0_x) | (acc)
		_ = _in2
		a = _in0
		b = _in1
		acc = _in2
...
func (_static *CompanionStruct_Default___) Equals(a _dafny.Sequence, b _dafny.Sequence) bool {
	return (Companion_Default___.Compare(a, b, uint8(0))) == (uint8(0))
}
