// Package TestAwsCryptographyPrimitivesGenerateRandomBytes
// Dafny module TestAwsCryptographyPrimitivesGenerateRandomBytes compiled into Go
...
func (*Default__) String() string {
	return "TestAwsCryptographyPrimitivesGenerateRandomBytes.Default__"
}
...
func (_static *CompanionStruct_Default___) BasicGenerateRandomBytes() {
	...
	if !(!((_0_valueOrError0).IsFailure())) {
		panic("test/TestGenerateRandomBytes.dfy(11,18): " + (_0_valueOrError0).String())
	}
	...
	_ = _2_length
	_2_length = int32(5)
	var _3_input m_AwsCryptographyPrimitivesTypes.GenerateRandomBytesInput
	_ = _3_input
	_3_input = m_AwsCryptographyPrimitivesTypes.Companion_GenerateRandomBytesInput_.Create_GenerateRandomBytesInput_(_2_length)
	var _4_output m_Wrappers.Result
	_ = _4_output
	var _out1 m_Wrappers.Result
	_ = _out1
	_out1 = (_1_client).GenerateRandomBytes(_3_input)
	_4_output = _out1
	var _5_valueOrError1 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(_dafny.EmptySeq)
	_ = _5_valueOrError1
	_5_valueOrError1 = _4_output
	if !(!((_5_valueOrError1).IsFailure())) {
		panic("test/TestGenerateRandomBytes.dfy(20,17): " + (_5_valueOrError1).String())
	}
	var _6_value _dafny.Sequence
	_ = _6_value
	_6_value = (_5_valueOrError1).Extract().(_dafny.Sequence)
	if !((_dafny.IntOfUint32((_6_value).Cardinality())).Cmp(_dafny.IntOfInt32(_2_length)) == 0) {
		panic("test/TestGenerateRandomBytes.dfy(21,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
}
