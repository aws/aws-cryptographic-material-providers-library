// Package ConstantTimeTest
// Dafny module ConstantTimeTest compiled into Go
...
func (*Default__) String() string {
	return "ConstantTimeTest.Default__"
}
...
func (_static *CompanionStruct_Default___) ConstantTimeTest() {
	if !(m_ConstantTime.Companion_Default___.Equals(_dafny.SeqOf(), _dafny.SeqOf())) {
		panic("test/ConstantTime.dfy(10,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
	if !(m_ConstantTime.Companion_Default___.Equals(_dafny.SeqOf(uint8(1)), _dafny.SeqOf(uint8(1)))) {
		panic("test/ConstantTime.dfy(11,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
	if !(!(m_ConstantTime.Companion_Default___.Equals(_dafny.SeqOf(uint8(1)), _dafny.SeqOf(uint8(2))))) {
		panic("test/ConstantTime.dfy(12,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
	if !(m_ConstantTime.Companion_Default___.Equals(_dafny.SeqOf(uint8(1), uint8(2), uint8(3)), _dafny.SeqOf(uint8(1), uint8(2), uint8(3)))) {
		panic("test/ConstantTime.dfy(13,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
	if !(!(m_ConstantTime.Companion_Default___.Equals(_dafny.SeqOf(uint8(2), uint8(2), uint8(3)), _dafny.SeqOf(uint8(1), uint8(2), uint8(3))))) {
		panic("test/ConstantTime.dfy(14,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
	if !(!(m_ConstantTime.Companion_Default___.Equals(_dafny.SeqOf(uint8(1), uint8(2), uint8(3)), _dafny.SeqOf(uint8(1), uint8(2), uint8(4))))) {
		panic("test/ConstantTime.dfy(15,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
}
