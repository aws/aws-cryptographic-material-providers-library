...
import software.amazon.cryptography.standardlibrary.internaldafny.Wrappers.Option;
...
public class ToDafny {
  ...
  public static AesKdfCtrInput AesKdfCtrInput(
    ...
    nonce = Objects.nonNull(nativeValue.nonce()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.BYTE), software.amazon.smithy.dafny.conversion.ToDafny.Simple.ByteSequence(nativeValue.nonce()))
  ...
  public static CompressPublicKeyOutput CompressPublicKeyOutput(
    ...
    compressedPublicKey = software.amazon.smithy.dafny.conversion.ToDafny.Simple.ByteSequence(nativeValue.compressedPublicKey());
  ...
  public static DeriveSharedSecretOutput DeriveSharedSecretOutput(
    ...
    sharedSecret = software.amazon.smithy.dafny.conversion.ToDafny.Simple.ByteSequence(nativeValue.sharedSecret());
  ...
  public static ECCPublicKey ECCPublicKey(
    ...
    der = software.amazon.smithy.dafny.conversion.ToDafny.Simple.ByteSequence(nativeValue.der());
  ...
  public static HkdfExtractInput HkdfExtractInput(
    ...
    salt = Objects.nonNull(nativeValue.salt()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.BYTE), software.amazon.smithy.dafny.conversion.ToDafny.Simple.ByteSequence(nativeValue.salt()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.BYTE));
    DafnySequence<? extends Byte> ikm;
    ikm = software.amazon.smithy.dafny.conversion.ToDafny.Simple.ByteSequence(nativeValue.ikm());
  ...
  public static KdfCtrInput KdfCtrInput(
    ...
    purpose = Objects.nonNull(nativeValue.purpose()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.BYTE), software.amazon.smithy.dafny.conversion.ToDafny.Simple.ByteSequence(nativeValue.purpose()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.BYTE));
    Option<DafnySequence<? extends Byte>> nonce;
    nonce = Objects.nonNull(nativeValue.nonce()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.BYTE), software.amazon.smithy.dafny.conversion.ToDafny.Simple.ByteSequence(nativeValue.nonce()))
  ...
  public static ECDHCurveSpec ECDHCurveSpec(
    ...
    switch (nativeValue) {
      ...
      default: {
        throw new RuntimeException("Cannot convert " + nativeValue + " to software.amazon.cryptography.primitives.internaldafny.types.ECDHCurveSpec.");
      }
    }
  }
