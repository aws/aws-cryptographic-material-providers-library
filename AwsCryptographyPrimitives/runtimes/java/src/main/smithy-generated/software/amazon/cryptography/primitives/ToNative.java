...
public class ToNative {
  ...
  public static CompressPublicKeyInput CompressPublicKeyInput(
    ...
    CompressPublicKeyInput.Builder nativeBuilder = CompressPublicKeyInput.builder();
  ...
  public static CompressPublicKeyOutput CompressPublicKeyOutput(
    ...
    CompressPublicKeyOutput.Builder nativeBuilder = CompressPublicKeyOutput.builder();
    nativeBuilder.compressedPublicKey(software.amazon.smithy.dafny.conversion.ToNative.Simple.ByteBuffer(dafnyValue.dtor_compressedPublicKey()));
    return nativeBuilder.build();
  }
  ...
  public static DecompressPublicKeyInput DecompressPublicKeyInput(
    ...
    DecompressPublicKeyInput.Builder nativeBuilder = DecompressPublicKeyInput.builder();
    nativeBuilder.compressedPublicKey(software.amazon.smithy.dafny.conversion.ToNative.Simple.ByteBuffer(dafnyValue.dtor_compressedPublicKey()));
    nativeBuilder.eccCurve(ToNative.ECDHCurveSpec(dafnyValue.dtor_eccCurve()));
    return nativeBuilder.build();
  }
  ...
  public static DeriveSharedSecretInput DeriveSharedSecretInput(
    ...
    DeriveSharedSecretInput.Builder nativeBuilder = DeriveSharedSecretInput.builder();
    nativeBuilder.eccCurve(ToNative.ECDHCurveSpec(dafnyValue.dtor_eccCurve()));
  ...
  public static DeriveSharedSecretOutput DeriveSharedSecretOutput(
    ...
    nativeBuilder.sharedSecret(software.amazon.smithy.dafny.conversion.ToNative.Simple.ByteBuffer(dafnyValue.dtor_sharedSecret()));
    return nativeBuilder.build();
  }
  ...
  public static ECCPublicKey ECCPublicKey(
    ...
    nativeBuilder.der(software.amazon.smithy.dafny.conversion.ToNative.Simple.ByteBuffer(dafnyValue.dtor_der()));
    return nativeBuilder.build();
  }
  ...
  public static GetPublicKeyFromPrivateKeyInput GetPublicKeyFromPrivateKeyInput(
    ...
    GetPublicKeyFromPrivateKeyInput.Builder nativeBuilder = GetPublicKeyFromPrivateKeyInput.builder();
    nativeBuilder.eccCurve(ToNative.ECDHCurveSpec(dafnyValue.dtor_eccCurve()));
    nativeBuilder.privateKey(ToNative.ECCPrivateKey(dafnyValue.dtor_privateKey()));
    return nativeBuilder.build();
  }
  ...
  public static GetPublicKeyFromPrivateKeyOutput GetPublicKeyFromPrivateKeyOutput(
    ...
    GetPublicKeyFromPrivateKeyOutput.Builder nativeBuilder = GetPublicKeyFromPrivateKeyOutput.builder();
    nativeBuilder.eccCurve(ToNative.ECDHCurveSpec(dafnyValue.dtor_eccCurve()));
    nativeBuilder.privateKey(ToNative.ECCPrivateKey(dafnyValue.dtor_privateKey()));
  ...
  public static ValidatePublicKeyInput ValidatePublicKeyInput(
    ...
    ValidatePublicKeyInput.Builder nativeBuilder = ValidatePublicKeyInput.builder();
    nativeBuilder.eccCurve(ToNative.ECDHCurveSpec(dafnyValue.dtor_eccCurve()));
    nativeBuilder.publicKey(software.amazon.smithy.dafny.conversion.ToNative.Simple.ByteBuffer(dafnyValue.dtor_publicKey()));
    return nativeBuilder.build();
  }
