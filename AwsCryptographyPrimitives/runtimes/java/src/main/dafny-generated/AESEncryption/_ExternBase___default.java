...
public abstract class _ExternBase___default {
  ...
  {
    dafny.DafnySequence<? extends java.lang.Byte> _0_cipherText = (s).take((java.math.BigInteger.valueOf((s).length())).subtract(java.math.BigInteger.valueOf((encAlg).dtor_tagLength())));
    dafny.DafnySequence<? extends java.lang.Byte> _1_authTag = (s).drop((java.math.BigInteger.valueOf((s).length())).subtract(java.math.BigInteger.valueOf((encAlg).dtor_tagLength())));
    return software.amazon.cryptography.primitives.internaldafny.types.AESEncryptOutput.create(_0_cipherText, _1_authTag);
  }
  public static Wrappers_Compile.Result<software.amazon.cryptography.primitives.internaldafny.types.AESEncryptOutput, software.amazon.cryptography.primitives.internaldafny.types.Error> AESEncrypt(software.amazon.cryptography.primitives.internaldafny.types.AESEncryptInput input)
  {
    ...
    _0_valueOrError0 = Wrappers_Compile.__default.<software.amazon.cryptography.primitives.internaldafny.types.Error>Need(software.amazon.cryptography.primitives.internaldafny.types.Error._typeDescriptor(), (java.util.Objects.equals(java.math.BigInteger.valueOf(((input).dtor_iv()).length()), java.math.BigInteger.valueOf(((input).dtor_encAlg()).dtor_ivLength()))) && (java.util.Objects.equals(java.math.BigInteger.valueOf(((input).dtor_key()).length()), java.math.BigInteger.valueOf(((input).dtor_encAlg()).dtor_keyLength()))), software.amazon.cryptography.primitives.internaldafny.types.Error.create_AwsCryptographicPrimitivesError(dafny.DafnySequence.asString("Request does not match algorithm.")));
    ...
    _8_valueOrError2 = Wrappers_Compile.__default.<software.amazon.cryptography.primitives.internaldafny.types.Error>Need(software.amazon.cryptography.primitives.internaldafny.types.Error._typeDescriptor(), java.util.Objects.equals(java.math.BigInteger.valueOf(((_7_value).dtor_cipherText()).length()), java.math.BigInteger.valueOf((_4_msg).length())), software.amazon.cryptography.primitives.internaldafny.types.Error.create_AwsCryptographicPrimitivesError(dafny.DafnySequence.asString("AESEncrypt did not return cipherText of expected length")));
    ...
    _9_valueOrError3 = Wrappers_Compile.__default.<software.amazon.cryptography.primitives.internaldafny.types.Error>Need(software.amazon.cryptography.primitives.internaldafny.types.Error._typeDescriptor(), java.util.Objects.equals(java.math.BigInteger.valueOf(((_7_value).dtor_authTag()).length()), java.math.BigInteger.valueOf((_1_encAlg).dtor_tagLength())), software.amazon.cryptography.primitives.internaldafny.types.Error.create_AwsCryptographicPrimitivesError(dafny.DafnySequence.asString("AESEncryption did not return valid tag")));
  ...
  public static Wrappers_Compile.Result<dafny.DafnySequence<? extends java.lang.Byte>, software.amazon.cryptography.primitives.internaldafny.types.Error> AESDecrypt(software.amazon.cryptography.primitives.internaldafny.types.AESDecryptInput input)
  {
    ...
    Wrappers_Compile.Outcome<software.amazon.cryptography.primitives.internaldafny.types.Error> _0_valueOrError0 = Wrappers_Compile.Outcome.<software.amazon.cryptography.primitives.internaldafny.types.Error>Default(software.amazon.cryptography.primitives.internaldafny.types.Error._typeDescriptor());
    _0_valueOrError0 = Wrappers_Compile.__default.<software.amazon.cryptography.primitives.internaldafny.types.Error>Need(software.amazon.cryptography.primitives.internaldafny.types.Error._typeDescriptor(), ((java.util.Objects.equals(java.math.BigInteger.valueOf(((input).dtor_key()).length()), java.math.BigInteger.valueOf(((input).dtor_encAlg()).dtor_keyLength()))) && (java.util.Objects.equals(java.math.BigInteger.valueOf(((input).dtor_iv()).length()), java.math.BigInteger.valueOf(((input).dtor_encAlg()).dtor_ivLength())))) && (java.util.Objects.equals(java.math.BigInteger.valueOf(((input).dtor_authTag()).length()), java.math.BigInteger.valueOf(((input).dtor_encAlg()).dtor_tagLength()))), software.amazon.cryptography.primitives.internaldafny.types.Error.create_AwsCryptographicPrimitivesError(dafny.DafnySequence.asString("Request does not match algorithm.")));
    if ((_0_valueOrError0).IsFailure(software.amazon.cryptography.primitives.internaldafny.types.Error._typeDescriptor())) {
    ...
    _9_valueOrError2 = Wrappers_Compile.__default.<software.amazon.cryptography.primitives.internaldafny.types.Error>Need(software.amazon.cryptography.primitives.internaldafny.types.Error._typeDescriptor(), java.util.Objects.equals(java.math.BigInteger.valueOf((_3_cipherTxt).length()), java.math.BigInteger.valueOf((_8_value).length())), software.amazon.cryptography.primitives.internaldafny.types.Error.create_AwsCryptographicPrimitivesError(dafny.DafnySequence.asString("AESDecrypt did not return plaintext of expected length")));
