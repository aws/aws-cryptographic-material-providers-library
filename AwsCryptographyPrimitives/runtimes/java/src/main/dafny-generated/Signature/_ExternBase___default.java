...
public abstract class _ExternBase___default {
  ...
  public static java.math.BigInteger FieldSize(software.amazon.cryptography.primitives.internaldafny.types.ECDSASignatureAlgorithm signatureAlgorithm) {
    software.amazon.cryptography.primitives.internaldafny.types.ECDSASignatureAlgorithm _source0 = signatureAlgorithm;
    if (_source0.is_ECDSA__P384()) {
  ...
  public static Wrappers_Compile.Result<software.amazon.cryptography.primitives.internaldafny.types.GenerateECDSASignatureKeyOutput, software.amazon.cryptography.primitives.internaldafny.types.Error> KeyGen(software.amazon.cryptography.primitives.internaldafny.types.GenerateECDSASignatureKeyInput input)
  {
    ...
    _2_valueOrError1 = Wrappers_Compile.__default.<software.amazon.cryptography.primitives.internaldafny.types.Error>Need(software.amazon.cryptography.primitives.internaldafny.types.Error._typeDescriptor(), java.util.Objects.equals(java.math.BigInteger.valueOf(((_1_sigKeyPair).dtor_verificationKey()).length()), __default.FieldSize((input).dtor_signatureAlgorithm())), software.amazon.cryptography.primitives.internaldafny.types.Error.create_AwsCryptographicPrimitivesError(dafny.DafnySequence.asString("Incorrect verification-key length from ExternKeyGen.")));
