...
public class __default {
  ...
  public static Wrappers_Compile.Result<dafny.DafnySequence<? extends java.lang.Byte>, software.amazon.cryptography.primitives.internaldafny.types.Error> Extract(software.amazon.cryptography.primitives.internaldafny.types.HkdfExtractInput input)
  {
    ...
    _0_valueOrError0 = Wrappers_Compile.__default.<software.amazon.cryptography.primitives.internaldafny.types.Error>Need(software.amazon.cryptography.primitives.internaldafny.types.Error._typeDescriptor(), ((((input).dtor_salt()).is_None()) || ((((long) (((input).dtor_salt()).dtor_value()).cardinalityInt()) == 0 ? 0 : 1) != 0)) && (java.lang.Long.compareUnsigned((long) ((input).dtor_ikm()).cardinalityInt(), (StandardLibrary_mUInt_Compile.__default.INT32__MAX__LIMIT()).longValue()) < 0), software.amazon.cryptography.primitives.internaldafny.types.Error.create_AwsCryptographicPrimitivesError(dafny.DafnySequence.asString("HKDF Extract needs a salt and reasonable ikm.")));
  ...
  public static Wrappers_Compile.Result<dafny.DafnySequence<? extends java.lang.Byte>, software.amazon.cryptography.primitives.internaldafny.types.Error> Expand(software.amazon.cryptography.primitives.internaldafny.types.HkdfExpandInput input)
  {
    Wrappers_Compile.Result<dafny.DafnySequence<? extends java.lang.Byte>, software.amazon.cryptography.primitives.internaldafny.types.Error> output = Wrappers_Compile.Result.<dafny.DafnySequence<? extends java.lang.Byte>, software.amazon.cryptography.primitives.internaldafny.types.Error>Default(dafny.DafnySequence.<java.lang.Byte>_typeDescriptor(BoundedInts_Compile.uint8._typeDescriptor()), software.amazon.cryptography.primitives.internaldafny.types.Error._typeDescriptor(), dafny.DafnySequence.<java.lang.Byte> empty(BoundedInts_Compile.uint8._typeDescriptor()));
    Wrappers_Compile.Outcome<software.amazon.cryptography.primitives.internaldafny.types.Error> _0_valueOrError0 = Wrappers_Compile.Outcome.<software.amazon.cryptography.primitives.internaldafny.types.Error>Default(software.amazon.cryptography.primitives.internaldafny.types.Error._typeDescriptor());
    _0_valueOrError0 = Wrappers_Compile.__default.<software.amazon.cryptography.primitives.internaldafny.types.Error>Need(software.amazon.cryptography.primitives.internaldafny.types.Error._typeDescriptor(), (((java.lang.Long.compareUnsigned((long) 1L, ((long) ((input).dtor_expectedLength()))) <= 0) && (java.lang.Long.compareUnsigned(((long) ((input).dtor_expectedLength())), (long) (long) (((long) 255L) * (Digest_Compile.__default.Length((input).dtor_digestAlgorithm())))) <= 0)) && (java.lang.Long.compareUnsigned((long) ((input).dtor_info()).cardinalityInt(), (StandardLibrary_mUInt_Compile.__default.INT32__MAX__LIMIT()).longValue()) < 0)) && ((Digest_Compile.__default.Length((input).dtor_digestAlgorithm())) == ((long) ((input).dtor_prk()).cardinalityInt())), software.amazon.cryptography.primitives.internaldafny.types.Error.create_AwsCryptographicPrimitivesError(dafny.DafnySequence.asString("HKDF Expand needs valid input.")));
    if ((_0_valueOrError0).IsFailure(software.amazon.cryptography.primitives.internaldafny.types.Error._typeDescriptor())) {
      output = (_0_valueOrError0).<dafny.DafnySequence<? extends java.lang.Byte>>PropagateFailure(software.amazon.cryptography.primitives.internaldafny.types.Error._typeDescriptor(), dafny.DafnySequence.<java.lang.Byte>_typeDescriptor(BoundedInts_Compile.uint8._typeDescriptor()));
      return output;
    }
    ...
    dafny.DafnySequence<? extends java.lang.Byte> _out1;
    _out1 = HKDF_Compile.__default.Expand(_6_hmac, _2_prk, _3_info, ((long) (_4_expectedLength)), _1_digestAlgorithm);
    _7_omk = _out1;
  ...
  public static Wrappers_Compile.Result<dafny.DafnySequence<? extends java.lang.Byte>, software.amazon.cryptography.primitives.internaldafny.types.Error> Hkdf(software.amazon.cryptography.primitives.internaldafny.types.HkdfInput input)
  {
    Wrappers_Compile.Result<dafny.DafnySequence<? extends java.lang.Byte>, software.amazon.cryptography.primitives.internaldafny.types.Error> output = Wrappers_Compile.Result.<dafny.DafnySequence<? extends java.lang.Byte>, software.amazon.cryptography.primitives.internaldafny.types.Error>Default(dafny.DafnySequence.<java.lang.Byte>_typeDescriptor(BoundedInts_Compile.uint8._typeDescriptor()), software.amazon.cryptography.primitives.internaldafny.types.Error._typeDescriptor(), dafny.DafnySequence.<java.lang.Byte> empty(BoundedInts_Compile.uint8._typeDescriptor()));
    Wrappers_Compile.Outcome<software.amazon.cryptography.primitives.internaldafny.types.Error> _0_valueOrError0 = Wrappers_Compile.Outcome.<software.amazon.cryptography.primitives.internaldafny.types.Error>Default(software.amazon.cryptography.primitives.internaldafny.types.Error._typeDescriptor());
    _0_valueOrError0 = Wrappers_Compile.__default.<software.amazon.cryptography.primitives.internaldafny.types.Error>Need(software.amazon.cryptography.primitives.internaldafny.types.Error._typeDescriptor(), ((((java.lang.Long.compareUnsigned((long) 1L, ((long) ((input).dtor_expectedLength()))) <= 0) && (java.lang.Long.compareUnsigned(((long) ((input).dtor_expectedLength())), (long) (long) (((long) 255L) * (Digest_Compile.__default.Length((input).dtor_digestAlgorithm())))) <= 0)) && ((((input).dtor_salt()).is_None()) || ((((long) (((input).dtor_salt()).dtor_value()).cardinalityInt()) == 0 ? 0 : 1) != 0))) && (java.lang.Long.compareUnsigned((long) ((input).dtor_info()).cardinalityInt(), (StandardLibrary_mUInt_Compile.__default.INT32__MAX__LIMIT()).longValue()) < 0)) && (java.lang.Long.compareUnsigned((long) ((input).dtor_ikm()).cardinalityInt(), (StandardLibrary_mUInt_Compile.__default.INT32__MAX__LIMIT()).longValue()) < 0), software.amazon.cryptography.primitives.internaldafny.types.Error.create_AwsCryptographicPrimitivesError(dafny.DafnySequence.asString("Wrapped Hkdf input is invalid.")));
    if ((_0_valueOrError0).IsFailure(software.amazon.cryptography.primitives.internaldafny.types.Error._typeDescriptor())) {
      output = (_0_valueOrError0).<dafny.DafnySequence<? extends java.lang.Byte>>PropagateFailure(software.amazon.cryptography.primitives.internaldafny.types.Error._typeDescriptor(), dafny.DafnySequence.<java.lang.Byte>_typeDescriptor(BoundedInts_Compile.uint8._typeDescriptor()));
      return output;
    }
    ...
    _out0 = HKDF_Compile.__default.Hkdf(_1_digest, _2_salt, _3_ikm, _4_info, ((long) (_5_expectedLength)));
    _6_okm = _out0;
