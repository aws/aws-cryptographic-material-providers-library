...
public class GenerateRSAKeyPairOutput {
  ...
  private static final GenerateRSAKeyPairOutput theDefault = software.amazon.cryptography.primitives.internaldafny.types.GenerateRSAKeyPairOutput.create(RSAPublicKey.Default(), RSAPrivateKey.Default());
