...
public class ParsePublicKeyOutput {
  ...
  private static final ParsePublicKeyOutput theDefault = software.amazon.cryptography.primitives.internaldafny.types.ParsePublicKeyOutput.create(ECCPublicKey.Default());
