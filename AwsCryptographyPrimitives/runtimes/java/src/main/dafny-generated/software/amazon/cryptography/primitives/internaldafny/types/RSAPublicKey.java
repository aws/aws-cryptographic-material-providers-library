...
public class RSAPublicKey {
  ...
  private static final RSAPublicKey theDefault = software.amazon.cryptography.primitives.internaldafny.types.RSAPublicKey.create(0, dafny.DafnySequence.<java.lang.Byte> empty(BoundedInts_Compile.uint8._typeDescriptor()));
