...
public class GenerateRandomBytesInput {
  ...
  private static final GenerateRandomBytesInput theDefault = software.amazon.cryptography.primitives.internaldafny.types.GenerateRandomBytesInput.create(0);
