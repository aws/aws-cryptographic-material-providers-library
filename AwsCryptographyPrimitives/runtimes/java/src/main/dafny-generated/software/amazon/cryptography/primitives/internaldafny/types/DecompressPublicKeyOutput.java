...
public class DecompressPublicKeyOutput {
  ...
  private static final DecompressPublicKeyOutput theDefault = software.amazon.cryptography.primitives.internaldafny.types.DecompressPublicKeyOutput.create(ECCPublicKey.Default());
