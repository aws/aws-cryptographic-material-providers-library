...
public class ECDSASignInput {
  ...
  private static final ECDSASignInput theDefault = software.amazon.cryptography.primitives.internaldafny.types.ECDSASignInput.create(ECDSASignatureAlgorithm.Default(), dafny.DafnySequence.<java.lang.Byte> empty(BoundedInts_Compile.uint8._typeDescriptor()), dafny.DafnySequence.<java.lang.Byte> empty(BoundedInts_Compile.uint8._typeDescriptor()));
