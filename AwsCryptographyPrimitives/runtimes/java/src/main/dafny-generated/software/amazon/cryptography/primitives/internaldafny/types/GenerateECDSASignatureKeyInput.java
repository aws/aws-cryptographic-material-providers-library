...
public class GenerateECDSASignatureKeyInput {
  ...
  private static final GenerateECDSASignatureKeyInput theDefault = software.amazon.cryptography.primitives.internaldafny.types.GenerateECDSASignatureKeyInput.create(ECDSASignatureAlgorithm.Default());
