...
public class DeriveSharedSecretInput {
  ...
  private static final DeriveSharedSecretInput theDefault = software.amazon.cryptography.primitives.internaldafny.types.DeriveSharedSecretInput.create(ECDHCurveSpec.Default(), ECCPrivateKey.Default(), ECCPublicKey.Default());
