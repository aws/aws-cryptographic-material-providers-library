...
public class ECCPrivateKey {
  ...
  private static final ECCPrivateKey theDefault = software.amazon.cryptography.primitives.internaldafny.types.ECCPrivateKey.create(dafny.DafnySequence.<java.lang.Byte> empty(BoundedInts_Compile.uint8._typeDescriptor()));
