...
public class GenerateECCKeyPairInput {
  ...
  private static final GenerateECCKeyPairInput theDefault = software.amazon.cryptography.primitives.internaldafny.types.GenerateECCKeyPairInput.create(ECDHCurveSpec.Default());
