...
public class AesKdfCtrInput {
  ...
  private static final AesKdfCtrInput theDefault = software.amazon.cryptography.primitives.internaldafny.types.AesKdfCtrInput.create(dafny.DafnySequence.<java.lang.Byte> empty(BoundedInts_Compile.uint8._typeDescriptor()), 0, Wrappers_Compile.Option.<dafny.DafnySequence<? extends java.lang.Byte>>Default(dafny.DafnySequence.<java.lang.Byte>_typeDescriptor(BoundedInts_Compile.uint8._typeDescriptor())));
