...
public class HkdfExpandInput {
  ...
  private static final HkdfExpandInput theDefault = software.amazon.cryptography.primitives.internaldafny.types.HkdfExpandInput.create(DigestAlgorithm.Default(), dafny.DafnySequence.<java.lang.Byte> empty(BoundedInts_Compile.uint8._typeDescriptor()), dafny.DafnySequence.<java.lang.Byte> empty(BoundedInts_Compile.uint8._typeDescriptor()), 0);
