...
public class GenerateECCKeyPairOutput {
  ...
  private static final GenerateECCKeyPairOutput theDefault = software.amazon.cryptography.primitives.internaldafny.types.GenerateECCKeyPairOutput.create(ECDHCurveSpec.Default(), ECCPrivateKey.Default(), ECCPublicKey.Default());
