...
public class DecompressPublicKeyInput {
  ...
  private static final DecompressPublicKeyInput theDefault = software.amazon.cryptography.primitives.internaldafny.types.DecompressPublicKeyInput.create(dafny.DafnySequence.<java.lang.Byte> empty(BoundedInts_Compile.uint8._typeDescriptor()), ECDHCurveSpec.Default());
