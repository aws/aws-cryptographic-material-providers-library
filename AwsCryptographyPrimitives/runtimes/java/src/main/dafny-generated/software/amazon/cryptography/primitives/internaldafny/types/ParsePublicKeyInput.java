...
public class ParsePublicKeyInput {
  ...
  private static final ParsePublicKeyInput theDefault = software.amazon.cryptography.primitives.internaldafny.types.ParsePublicKeyInput.create(dafny.DafnySequence.<java.lang.Byte> empty(BoundedInts_Compile.uint8._typeDescriptor()));
