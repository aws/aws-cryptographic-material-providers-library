...
public class RSAPrivateKey {
  ...
  private static final RSAPrivateKey theDefault = software.amazon.cryptography.primitives.internaldafny.types.RSAPrivateKey.create(0, dafny.DafnySequence.<java.lang.Byte> empty(BoundedInts_Compile.uint8._typeDescriptor()));
