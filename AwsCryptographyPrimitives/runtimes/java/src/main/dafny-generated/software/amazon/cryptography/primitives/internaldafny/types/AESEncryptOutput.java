...
public class AESEncryptOutput {
  ...
  private static final AESEncryptOutput theDefault = software.amazon.cryptography.primitives.internaldafny.types.AESEncryptOutput.create(dafny.DafnySequence.<java.lang.Byte> empty(BoundedInts_Compile.uint8._typeDescriptor()), dafny.DafnySequence.<java.lang.Byte> empty(BoundedInts_Compile.uint8._typeDescriptor()));
