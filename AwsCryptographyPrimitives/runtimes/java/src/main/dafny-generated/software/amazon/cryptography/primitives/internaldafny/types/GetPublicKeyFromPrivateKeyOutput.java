...
public class GetPublicKeyFromPrivateKeyOutput {
  ...
  private static final GetPublicKeyFromPrivateKeyOutput theDefault = GetPublicKeyFromPrivateKeyOutput.create(ECDHCurveSpec.Default(), ECCPrivateKey.Default(), dafny.DafnySequence.<java.lang.Byte> empty(BoundedInts_Compile.uint8._typeDescriptor()));
