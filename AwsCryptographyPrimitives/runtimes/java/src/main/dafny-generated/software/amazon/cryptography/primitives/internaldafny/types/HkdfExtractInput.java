...
public class HkdfExtractInput {
  ...
  private static final HkdfExtractInput theDefault = software.amazon.cryptography.primitives.internaldafny.types.HkdfExtractInput.create(DigestAlgorithm.Default(), Wrappers_Compile.Option.<dafny.DafnySequence<? extends java.lang.Byte>>Default(dafny.DafnySequence.<java.lang.Byte>_typeDescriptor(BoundedInts_Compile.uint8._typeDescriptor())), dafny.DafnySequence.<java.lang.Byte> empty(BoundedInts_Compile.uint8._typeDescriptor()));
