...
public class GetRSAKeyModulusLengthInput {
  ...
  private static final GetRSAKeyModulusLengthInput theDefault = software.amazon.cryptography.primitives.internaldafny.types.GetRSAKeyModulusLengthInput.create(dafny.DafnySequence.<java.lang.Byte> empty(BoundedInts_Compile.uint8._typeDescriptor()));
