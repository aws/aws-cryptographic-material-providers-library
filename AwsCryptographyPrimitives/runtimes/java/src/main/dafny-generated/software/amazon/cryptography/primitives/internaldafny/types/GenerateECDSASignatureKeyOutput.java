...
public class GenerateECDSASignatureKeyOutput {
  ...
  private static final GenerateECDSASignatureKeyOutput theDefault = GenerateECDSASignatureKeyOutput.create(ECDSASignatureAlgorithm.Default(), dafny.DafnySequence.<java.lang.Byte> empty(BoundedInts_Compile.uint8._typeDescriptor()), dafny.DafnySequence.<java.lang.Byte> empty(BoundedInts_Compile.uint8._typeDescriptor()));
