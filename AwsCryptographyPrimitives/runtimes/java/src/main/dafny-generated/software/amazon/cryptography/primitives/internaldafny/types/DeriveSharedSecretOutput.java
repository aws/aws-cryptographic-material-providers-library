...
public class DeriveSharedSecretOutput {
  ...
  private static final DeriveSharedSecretOutput theDefault = software.amazon.cryptography.primitives.internaldafny.types.DeriveSharedSecretOutput.create(dafny.DafnySequence.<java.lang.Byte> empty(BoundedInts_Compile.uint8._typeDescriptor()));
