...
public class CompressPublicKeyOutput {
  ...
  private static final CompressPublicKeyOutput theDefault = CompressPublicKeyOutput.create(dafny.DafnySequence.<java.lang.Byte> empty(BoundedInts_Compile.uint8._typeDescriptor()));
