...
public class ECCPublicKey {
  ...
  private static final ECCPublicKey theDefault = software.amazon.cryptography.primitives.internaldafny.types.ECCPublicKey.create(dafny.DafnySequence.<java.lang.Byte> empty(BoundedInts_Compile.uint8._typeDescriptor()));
