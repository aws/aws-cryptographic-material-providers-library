...
public class ValidatePublicKeyOutput {
  ...
  private static final ValidatePublicKeyOutput theDefault = software.amazon.cryptography.primitives.internaldafny.types.ValidatePublicKeyOutput.create(false);
