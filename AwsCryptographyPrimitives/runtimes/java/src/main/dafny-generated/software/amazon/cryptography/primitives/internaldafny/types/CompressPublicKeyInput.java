...
public class CompressPublicKeyInput {
  ...
  private static final CompressPublicKeyInput theDefault = software.amazon.cryptography.primitives.internaldafny.types.CompressPublicKeyInput.create(ECCPublicKey.Default(), ECDHCurveSpec.Default());
