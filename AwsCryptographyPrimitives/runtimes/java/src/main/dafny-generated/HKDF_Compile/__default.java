...
public class __default {
  ...
  public static dafny.DafnySequence<? extends java.lang.Byte> Expand(HMAC.HMac hmac, dafny.DafnySequence<? extends java.lang.Byte> prk, dafny.DafnySequence<? extends java.lang.Byte> info, long expectedLength, software.amazon.cryptography.primitives.internaldafny.types.DigestAlgorithm digest)
  {
    ...
    if(true) {
      ...
      long _1_n;
      _1_n = (long) java.lang.Long.divideUnsigned((long) (long) (((long) (long) ((_0_hashLength) + (expectedLength))) - ((long) 1L)), _0_hashLength);
      (hmac).Init(prk);
      ...
      long _4_i;
      _4_i = (long) 1L;
      while (java.lang.Long.compareUnsigned(_4_i, _1_n) <= 0) {
        (hmac).BlockUpdate(_2_t__prev);
        (hmac).BlockUpdate(info);
        (hmac).BlockUpdate(dafny.DafnySequence.<java.lang.Byte> of(((byte) (_4_i))));
        dafny.DafnySequence<? extends java.lang.Byte> _out0;
        _out0 = (hmac).GetResult();
        _2_t__prev = _out0;
      ...
      okm = _3_t__n;
      if (java.lang.Long.compareUnsigned(expectedLength, (long) (okm).cardinalityInt()) < 0) {
        okm = (okm).take(expectedLength);
      }
    }
    return okm;
  }
  public static dafny.DafnySequence<? extends java.lang.Byte> Hkdf(software.amazon.cryptography.primitives.internaldafny.types.DigestAlgorithm digest, Wrappers_Compile.Option<dafny.DafnySequence<? extends java.lang.Byte>> salt, dafny.DafnySequence<? extends java.lang.Byte> ikm, dafny.DafnySequence<? extends java.lang.Byte> info, long L)
  {
    dafny.DafnySequence<? extends java.lang.Byte> okm = dafny.DafnySequence.<java.lang.Byte> empty(BoundedInts_Compile.uint8._typeDescriptor());
    if(true) {
      if (((L) == 0 ? 0 : 1) == 0) {
      ...
      if (!(!((_0_valueOrError0).IsFailure(((dafny.TypeDescriptor<HMAC.HMac>)(java.lang.Object)dafny.TypeDescriptor.reference(HMAC.HMac.class)), software.amazon.cryptography.primitives.internaldafny.types.Error._typeDescriptor())))) {
        throw new dafny.DafnyHaltException("src/HKDF/HKDF.dfy(224,16): " + java.lang.String.valueOf(_0_valueOrError0));
      }
      HMAC.HMac _1_hmac;
      ...
      if (_source0.is_None()) {
        _3_nonEmptySalt = StandardLibrary_Compile.__default.<java.lang.Byte>Fill(BoundedInts_Compile.uint8._typeDescriptor(), (byte) 0, dafny.Helpers.unsignedToBigInteger(_2_hashLength));
      } else {
