...
class default__:
    ...
    def TestFromBytesSuccess():
        ...
        d_243_valueOrError0_: Wrappers.Result = Wrappers.Result.default(_dafny.Seq)()
        d_243_valueOrError0_ = UUID.default__.FromByteArray(default__.byteUuid)
        ...
        if not((d_242_fromBytes_) == (default__.uuid)):
    ...
    def TestFromBytesFailure():
        ...
        d_245_valueOrError0_: Wrappers.Result = Wrappers.Result.default(_dafny.Seq)()
        d_245_valueOrError0_ = UUID.default__.FromByteArray(default__.wrongByteUuid)
        ...
        if not((d_244_fromBytes_) != (default__.uuid)):
    ...
    def TestToBytesSuccess():
        ...
        d_247_valueOrError0_: Wrappers.Result = Wrappers.Result.default(_dafny.Seq)()
        d_247_valueOrError0_ = UUID.default__.ToByteArray(default__.uuid)
        ...
        if not((d_246_toBytes_) == (default__.byteUuid)):
    ...
    def TestToBytesFailure():
        ...
        d_249_valueOrError0_ = UUID.default__.ToByteArray(default__.uuid)
        ...
        if not((d_248_toBytes_) != (default__.wrongByteUuid)):
    ...
    def TestRoundTripStringConversion():
        ...
        d_251_valueOrError0_ = UUID.default__.ToByteArray(default__.uuid)
        ...
        d_253_valueOrError1_: Wrappers.Result = Wrappers.Result.default(_dafny.Seq)()
        ...
        if not((d_252_bytesToString_) == (default__.uuid)):
    ...
    def TestRoundTripByteConversion():
        ...
        d_255_valueOrError0_ = UUID.default__.FromByteArray(default__.byteUuid)
        ...
        if not((d_256_stringToBytes_) == (default__.byteUuid)):
    ...
    def TestGenerateAndConversion():
        ...
        d_261_valueOrError1_: Wrappers.Result = Wrappers.Result.default(_dafny.Seq)()
        ...
        d_263_valueOrError2_: Wrappers.Result = Wrappers.Result.default(_dafny.Seq)()
        ...
        d_265_valueOrError3_: Wrappers.Result = Wrappers.Result.default(_dafny.Seq)()
        ...
        d_267_valueOrError4_: Wrappers.Result = Wrappers.Result.default(_dafny.Seq)()
        ...
        d_269_valueOrError5_: Wrappers.Result = Wrappers.Result.default(_dafny.Seq)()
