...
class default__:
    ...
    def MergeSortBy(a, lessThanOrEq):
        if (len(a)) <= (1):
            ...
            d_143_leftSorted_ = default__.MergeSortBy(d_141_left_, lessThanOrEq)
            d_144_rightSorted_ = default__.MergeSortBy(d_142_right_, lessThanOrEq)
            return default__.MergeSortedWith(d_143_leftSorted_, d_144_rightSorted_, lessThanOrEq)
