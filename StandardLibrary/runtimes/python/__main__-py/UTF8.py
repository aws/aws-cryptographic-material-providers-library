        ...
        while True:
            with _dafny.label():
                if (lo) == (hi):
                    ...
                    if default__.Uses1Byte(d_72_r_):
                        in12_ = a
                        in13_ = (lo) + (1)
                        in14_ = hi
                        a = in12_
                        ...
                        hi = in14_
                        raise _dafny.TailCall()
                    elif ((2) <= (len(d_72_r_))) and (default__.Uses2Bytes(d_72_r_)):
                        in15_ = a
                        in16_ = (lo) + (2)
                        in17_ = hi
                        a = in15_
                        ...
                        hi = in17_
                        raise _dafny.TailCall()
                    elif ((3) <= (len(d_72_r_))) and (default__.Uses3Bytes(d_72_r_)):
                        in18_ = a
                        in19_ = (lo) + (3)
                        in20_ = hi
                        a = in18_
                        ...
                        hi = in20_
                        raise _dafny.TailCall()
                    elif ((4) <= (len(d_72_r_))) and (default__.Uses4Bytes(d_72_r_)):
                        in21_ = a
                        in22_ = (lo) + (4)
                        in23_ = hi
                        a = in21_
