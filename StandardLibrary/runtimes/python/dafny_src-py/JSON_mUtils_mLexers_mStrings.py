...
# Module: JSON_mUtils_mLexers_mStrings
...
class default__:
    ...
    def String(st, byte):
        ...
        if source6_.is_Start:
            if (byte) == (ord('\"')):
                return JSON_mUtils_mLexers_mCore.LexerResult_Partial(StringLexerState_Body(False))
            elif True:
            ...
            if (byte) == (ord('\\')):
                return JSON_mUtils_mLexers_mCore.LexerResult_Partial(StringLexerState_Body(not(d_336_escaped_)))
            elif ((byte) == (ord('\"'))) and (not(d_336_escaped_)):
                return JSON_mUtils_mLexers_mCore.LexerResult_Partial(StringLexerState_End())
            elif True:
                return JSON_mUtils_mLexers_mCore.LexerResult_Partial(StringLexerState_Body(False))
        elif True:
            return JSON_mUtils_mLexers_mCore.LexerResult_Accept()
