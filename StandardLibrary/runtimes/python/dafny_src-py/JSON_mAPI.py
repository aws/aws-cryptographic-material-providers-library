...
class default__:
    ...
    def SerializeAlloc(js):
        ...
        d_810_valueOrError0_: Wrappers.Result = Wrappers.Result.default(JSON_mGrammar.Structural.default(JSON_mGrammar.Value.default()))()
    ...
    def SerializeInto(js, bs):
        ...
        d_812_valueOrError0_: Wrappers.Result = Wrappers.Result.default(JSON_mGrammar.Structural.default(JSON_mGrammar.Value.default()))()
