...
class default__:
    ...
    def String(str):
        ...
        if (d_454_valueOrError0_).IsFailure():
            ...
            d_456_valueOrError1_ = default__.CheckLength(d_455_bs_, JSON_mErrors.SerializationError_StringTooLong(str))
    ...
    @staticmethod
    def Int_k(n):
        return JSON_mSerializer_mByteStrConversion.default__.OfInt__any(n, default__.DIGITS, default__.MINUS)

    @staticmethod
    def Int(n):
        d_457_bs_ = default__.Int_k(n)
        d_458_valueOrError0_ = default__.CheckLength(d_457_bs_, JSON_mErrors.SerializationError_IntTooLarge(n))
    ...
    def KeyValue(kv):
        ...
        if (d_469_valueOrError0_).IsFailure():
            ...
            if (d_471_valueOrError1_).IsFailure():
                ...
                return Wrappers.Result_Success(JSON_mGrammar.jKeyValue_KeyValue(d_470_k_, default__.COLON, d_472_v_))
    ...
    def Object(obj):
        ...
        if (d_474_valueOrError0_).IsFailure():
            ...
            return Wrappers.Result_Success(JSON_mGrammar.Bracketed_Bracketed(default__.MkStructural(JSON_mGrammar.default__.LBRACE), default__.MkSuffixedSequence(d_477_items_, default__.COMMA, 0), default__.MkStructural(JSON_mGrammar.default__.RBRACE)))
    ...
    def Array(arr):
        ...
        if (d_478_valueOrError0_).IsFailure():
            ...
            return Wrappers.Result_Success(JSON_mGrammar.Bracketed_Bracketed(default__.MkStructural(JSON_mGrammar.default__.LBRACKET), default__.MkSuffixedSequence(d_481_items_, default__.COMMA, 0), default__.MkStructural(JSON_mGrammar.default__.RBRACKET)))
    ...
    def Value(js):
        ...
        if source12_.is_Null:
            ...
            return Wrappers.Result_Success(JSON_mGrammar.Value_Bool(default__.Bool(d_483_b_)))
    ...
    @_dafny.classproperty
    def COLON(instance):
        return default__.MkStructural(JSON_mGrammar.default__.COLON)
    @_dafny.classproperty
    def COMMA(instance):
        return default__.MkStructural(JSON_mGrammar.default__.COMMA)
