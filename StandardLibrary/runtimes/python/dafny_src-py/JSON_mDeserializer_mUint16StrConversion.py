...
# Module: JSON_mDeserializer_mUint16StrConversion
...
class default__:
    ...
    def Digits(n, base):
        if (n) == (0):
            ...
            d_502_digits_k_ = default__.Digits(_dafny.euclidian_division(n, base), base)
    ...
    def OfNat__any(n, chars):
        ...
        if (n) == (0):
            ...
            return default__.OfDigits(default__.Digits(n, d_505_base_), chars)

    @staticmethod
    def NumberStr(str, minus, is__digit):
        def lambda35_(forall_var_8_):
            d_506_c_: int = forall_var_8_
