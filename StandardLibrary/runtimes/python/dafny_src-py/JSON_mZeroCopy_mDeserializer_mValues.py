...
# Module: JSON_mZeroCopy_mDeserializer_mValues
...
class default__:
    ...
    def Value(cs):
        d_758_c_ = (cs).Peek()
        if (d_758_c_) == (ord('{')):
            d_759_valueOrError0_ = JSON_mZeroCopy_mDeserializer_mObjects.default__.Object(cs, default__.ValueParser(cs))
            ...
            d_764_valueOrError1_ = JSON_mZeroCopy_mDeserializer_mArrays.default__.Array(cs, default__.ValueParser(cs))
    ...
    def ValueParser(cs):
        ...
        def lambda58_(d_790_pre_):
            def lambda59_(d_791_ps_k_):
                return default__.Value(d_791_ps_k_)
