...
class default__:
    ...
    @staticmethod
    def OfNat(n, base):
        return JSON_mUtils_mStr_mCharStrConversion.default__.OfNat__any(n, _dafny.Seq((default__.HEX__DIGITS)[:base:]))

    @staticmethod
    def OfInt(n, base):
        return JSON_mUtils_mStr_mCharStrConversion.default__.OfInt__any(n, _dafny.Seq((default__.HEX__DIGITS)[:base:]), '-')

    @staticmethod
    def ToNat(str, base):
        return JSON_mUtils_mStr_mCharStrConversion.default__.ToNat__any(str, base, default__.HEX__TABLE)

    @staticmethod
    def ToInt(str, base):
        return JSON_mUtils_mStr_mCharStrConversion.default__.ToInt__any(str, '-', base, default__.HEX__TABLE)
