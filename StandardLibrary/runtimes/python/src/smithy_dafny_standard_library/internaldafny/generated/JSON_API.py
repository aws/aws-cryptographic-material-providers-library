...
import smithy_dafny_standard_library.internaldafny.generated.JSON_ZeroCopy as JSON_ZeroCopy
...
class default__:
    ...
    @staticmethod
    def Serialize(js):
        d_0_valueOrError0_ = JSON_Serializer.default__.JSON(js)
        if (d_0_valueOrError0_).IsFailure():
            return (d_0_valueOrError0_).PropagateFailure()
        elif True:
            d_1_js_ = (d_0_valueOrError0_).Extract()
            return JSON_ZeroCopy_API.default__.Serialize(d_1_js_)

    @staticmethod
    def SerializeAlloc(js):
        bs: Wrappers.Result = Wrappers.Result.default(_dafny.defaults.pointer)()
        d_0_valueOrError0_: Wrappers.Result = Wrappers.Result.default(JSON_Grammar.Structural.default(JSON_Grammar.Value.default()))()
        d_0_valueOrError0_ = JSON_Serializer.default__.JSON(js)
        if (d_0_valueOrError0_).IsFailure():
            bs = (d_0_valueOrError0_).PropagateFailure()
            return bs
        d_1_js_: JSON_Grammar.Structural
        d_1_js_ = (d_0_valueOrError0_).Extract()
        out0_: Wrappers.Result
        out0_ = JSON_ZeroCopy_API.default__.SerializeAlloc(d_1_js_)
        bs = out0_
        return bs
    ...
    def SerializeInto(js, bs):
        ...
        d_0_valueOrError0_ = JSON_Serializer.default__.JSON(js)
        if (d_0_valueOrError0_).IsFailure():
            len = (d_0_valueOrError0_).PropagateFailure()
            return len
        d_1_js_: JSON_Grammar.Structural
        d_1_js_ = (d_0_valueOrError0_).Extract()
        out0_: Wrappers.Result
        out0_ = JSON_ZeroCopy_API.default__.SerializeInto(d_1_js_, bs)
        len = out0_
        return len

    @staticmethod
    def Deserialize(bs):
        d_0_valueOrError0_ = JSON_ZeroCopy_API.default__.Deserialize(bs)
        if (d_0_valueOrError0_).IsFailure():
            return (d_0_valueOrError0_).PropagateFailure()
        elif True:
            d_1_js_ = (d_0_valueOrError0_).Extract()
            return JSON_Deserializer.default__.JSON(d_1_js_)
