...
class default__:
    ...
    @staticmethod
    def Open(cs):
        d_0_valueOrError0_ = (cs).AssertByte(JSON_ZeroCopy_Deserializer_ArrayParams.default__.OPEN)
        if (d_0_valueOrError0_).IsFailure():
            return (d_0_valueOrError0_).PropagateFailure()
        elif True:
    ...
    @staticmethod
    def Close(cs):
        d_0_valueOrError0_ = (cs).AssertByte(JSON_ZeroCopy_Deserializer_ArrayParams.default__.CLOSE)
        if (d_0_valueOrError0_).IsFailure():
            return (d_0_valueOrError0_).PropagateFailure()
        elif True:
            d_1_cs_ = (d_0_valueOrError0_).Extract()
    ...
    def Elements(json, open, elems):
        while True:
            with _dafny.label():
                d_0_valueOrError0_ = JSON_ZeroCopy_Deserializer_ArrayParams.default__.Element((elems).cs, json)
                if (d_0_valueOrError0_).IsFailure():
                    return (d_0_valueOrError0_).PropagateFailure()
                elif True:
                    ...
                    if ((d_1_elem_).cs).EOF_q:
                        ...
                        if ((d_3_s0_) == (default__.SEPARATOR)) and (((((d_2_sep_).t).t).Length()) == (1)):
                        ...
                        elif ((d_3_s0_) == (JSON_ZeroCopy_Deserializer_ArrayParams.default__.CLOSE)) and (((((d_2_sep_).t).t).Length()) == (1)):
                            d_6_sep_ = d_2_sep_
                            ...
                            d_10_pr_ = Wrappers.Result_Failure(JSON_Utils_Cursors.CursorError_ExpectingAnyByte(_dafny.Seq([JSON_ZeroCopy_Deserializer_ArrayParams.default__.CLOSE, d_9_separator_]), d_3_s0_))
                            return d_10_pr_
                break
    ...
    def Bracketed(cs, json):
        ...
        if (d_0_valueOrError0_).IsFailure():
            ...
            if (((d_1_open_).cs).Peek()) == (JSON_ZeroCopy_Deserializer_ArrayParams.default__.CLOSE):
