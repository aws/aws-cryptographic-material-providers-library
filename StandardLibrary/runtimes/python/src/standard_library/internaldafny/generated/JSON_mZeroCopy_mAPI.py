...
# assert "JSON_mZeroCopy_mAPI" == __name__
JSON_mZeroCopy_mAPI = sys.modules[__name__]
...
class default__:
    ...
    @staticmethod
    def Serialize(js):
        return Wrappers.Result_Success((JSON_mZeroCopy_mSerializer.default__.Text(js)).Bytes())

    @staticmethod
    def SerializeAlloc(js):
        bs: Wrappers.Result = Wrappers.Result_Success.default(_dafny.defaults.pointer)()
        out27_: Wrappers.Result
        out27_ = JSON_mZeroCopy_mSerializer.default__.Serialize(js)
        bs = out27_
        return bs
    ...
    def SerializeInto(js, bs):
        ...
        out28_ = JSON_mZeroCopy_mSerializer.default__.SerializeTo(js, bs)
        len = out28_
        return len

    @staticmethod
    def Deserialize(bs):
        return JSON_mZeroCopy_mDeserializer_mAPI.default__.OfBytes(bs)
