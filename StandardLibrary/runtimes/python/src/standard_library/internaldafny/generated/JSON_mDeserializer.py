...
# assert "JSON_mDeserializer" == __name__
JSON_mDeserializer = sys.modules[__name__]
...
class default__:
    ...
    @staticmethod
    def ToNat16(str):
        d_512_hd_ = JSON_mDeserializer_mUint16StrConversion.default__.ToNat__any(str, 16, (JSON_mDeserializer.default__).HEX__TABLE__16)
        return d_512_hd_
                        ...
                        if (d_513_c_) == (ord('u')):
                            if (len(str)) <= ((start) + (6)):
                                ...
                                def lambda37_(exists_var_1_):
                                    d_515_c_: BoundedInts.uint16 = exists_var_1_
                                    return ((d_515_c_) in (d_514_code_)) and ((d_515_c_) not in ((JSON_mDeserializer.default__).HEX__TABLE__16))

                                if _dafny.quantifier((d_514_code_).UniqueElements, False, lambda37_):
                                    return Wrappers.Result_Failure(JSON_mDeserializer.default__.UnsupportedEscape16(d_514_code_))
                                elif True:
                                    d_516_hd_ = JSON_mDeserializer.default__.ToNat16(d_514_code_)
                                    in112_ = str
                                    in113_ = (start) + (6)
                            ...
                            if (d_517_unescaped_) == (0):
                                return Wrappers.Result_Failure(JSON_mDeserializer.default__.UnsupportedEscape16(_dafny.Seq((str)[start:(start) + (2):])))
                            elif True:
                                in115_ = str
                                in116_ = (start) + (2)
    ...
    def String(js):
        ...
        if (d_518_valueOrError0_).IsFailure():
            ...
            if (d_520_valueOrError1_).IsFailure():
                ...
                d_522_valueOrError2_ = JSON_mDeserializer.default__.Unescape(d_521_asUint16_, 0, _dafny.Seq([]))
    ...
    @staticmethod
    def ToInt(sign, n):
        d_524_n_ = JSON_mDeserializer_mByteStrConversion.default__.ToNat__any((n).Bytes(), 10, (JSON_mDeserializer.default__).DIGITS)
    ...
    def Number(js):
        ...
        d_529_valueOrError0_ = JSON_mDeserializer.default__.ToInt(d_525_minus_, d_526_num_)
                                ...
                                def iife13_(d_536_num_):
                                    def iife14_(_pat_let7_0):
                                        def iife15_(d_537_sign_):
                                            return JSON_mDeserializer.default__.ToInt(d_537_sign_, d_536_num_)
            ...
            if (d_531_valueOrError1_).IsFailure():
                ...
                if source15_.is_Empty:
                    ...
                    if True:
                        ...
                        d_544_valueOrError2_ = JSON_mDeserializer.default__.ToInt(d_525_minus_, d_542_num_)
    ...
    @staticmethod
    def KeyValue(js):
        d_546_valueOrError0_ = JSON_mDeserializer.default__.String((js).k)
        if (d_546_valueOrError0_).IsFailure():
            return (d_546_valueOrError0_).PropagateFailure()
        elif True:
            d_547_k_ = (d_546_valueOrError0_).Extract()
            d_548_valueOrError1_ = JSON_mDeserializer.default__.Value((js).v)
    ...
    def Object(js):
        def lambda40_(d_550_js_):
            def lambda41_(d_551_d_):
                return JSON_mDeserializer.default__.KeyValue((d_551_d_).t)
    ...
    def Array(js):
        def lambda42_(d_552_js_):
            def lambda43_(d_553_d_):
                return JSON_mDeserializer.default__.Value((d_553_d_).t)
    ...
    def Value(js):
        ...
        if source17_.is_Null:
            ...
            return Wrappers.Result_Success(JSON_mValues.JSON_Bool(JSON_mDeserializer.default__.Bool(d_556_b_)))
        elif source17_.is_String:
            d_557___mcc_h2_ = source17_.str
            d_558_str_ = d_557___mcc_h2_
            d_559_valueOrError0_ = JSON_mDeserializer.default__.String(d_558_str_)
            ...
            d_563_valueOrError1_ = JSON_mDeserializer.default__.Number(d_562_dec_)
            ...
            d_567_valueOrError2_ = JSON_mDeserializer.default__.Object(d_566_obj_)
            ...
            d_571_valueOrError3_ = JSON_mDeserializer.default__.Array(d_570_arr_)
    ...
    @staticmethod
    def JSON(js):
        return JSON_mDeserializer.default__.Value((js).t)
