...
# Module: standard_library.internaldafny.generated.JSON_ZeroCopy_API
...
class default__:
    ...
    def SerializeAlloc(js):
        ...
        out27_ = JSON_ZeroCopy_Serializer.default__.Serialize(js)
        bs = out27_
        return bs
    ...
    def SerializeInto(js, bs):
        ...
        out28_ = JSON_ZeroCopy_Serializer.default__.SerializeTo(js, bs)
        len = out28_
        return len
