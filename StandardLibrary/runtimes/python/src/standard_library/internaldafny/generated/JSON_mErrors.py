...
# assert "JSON_mErrors" == __name__
JSON_mErrors = sys.modules[__name__]
...
class DeserializationError:
    ...
    def is_UnterminatedSequence(self) -> bool:
        return isinstance(self, JSON_mErrors.DeserializationError_UnterminatedSequence)
    @property
    def is_UnsupportedEscape(self) -> bool:
        return isinstance(self, JSON_mErrors.DeserializationError_UnsupportedEscape)
    @property
    def is_EscapeAtEOS(self) -> bool:
        return isinstance(self, JSON_mErrors.DeserializationError_EscapeAtEOS)
    @property
    def is_EmptyNumber(self) -> bool:
        return isinstance(self, JSON_mErrors.DeserializationError_EmptyNumber)
    @property
    def is_ExpectingEOF(self) -> bool:
        return isinstance(self, JSON_mErrors.DeserializationError_ExpectingEOF)
    @property
    def is_IntOverflow(self) -> bool:
        return isinstance(self, JSON_mErrors.DeserializationError_IntOverflow)
    @property
    def is_ReachedEOF(self) -> bool:
        return isinstance(self, JSON_mErrors.DeserializationError_ReachedEOF)
    @property
    def is_ExpectingByte(self) -> bool:
        return isinstance(self, JSON_mErrors.DeserializationError_ExpectingByte)
    @property
    def is_ExpectingAnyByte(self) -> bool:
        return isinstance(self, JSON_mErrors.DeserializationError_ExpectingAnyByte)
    @property
    def is_InvalidUnicode(self) -> bool:
        return isinstance(self, JSON_mErrors.DeserializationError_InvalidUnicode)
    def ToString(self):
        source9_ = self
...
class DeserializationError_UnterminatedSequence(DeserializationError, NamedTuple('UnterminatedSequence', [])):
    ...
    def __eq__(self, __o: object) -> bool:
        return isinstance(__o, JSON_mErrors.DeserializationError_UnterminatedSequence)
...
class DeserializationError_UnsupportedEscape(DeserializationError, NamedTuple('UnsupportedEscape', [('str', Any)])):
    ...
    def __eq__(self, __o: object) -> bool:
        return isinstance(__o, JSON_mErrors.DeserializationError_UnsupportedEscape) and self.str == __o.str
    def __hash__(self) -> int:
        return super().__hash__()
...
class DeserializationError_EscapeAtEOS(DeserializationError, NamedTuple('EscapeAtEOS', [])):
    ...
    def __eq__(self, __o: object) -> bool:
        return isinstance(__o, JSON_mErrors.DeserializationError_EscapeAtEOS)
    def __hash__(self) -> int:
        return super().__hash__()
...
class DeserializationError_EmptyNumber(DeserializationError, NamedTuple('EmptyNumber', [])):
    ...
    def __eq__(self, __o: object) -> bool:
        return isinstance(__o, JSON_mErrors.DeserializationError_EmptyNumber)
    def __hash__(self) -> int:
        return super().__hash__()
...
class DeserializationError_ExpectingEOF(DeserializationError, NamedTuple('ExpectingEOF', [])):
    ...
    def __eq__(self, __o: object) -> bool:
        return isinstance(__o, JSON_mErrors.DeserializationError_ExpectingEOF)
    def __hash__(self) -> int:
        return super().__hash__()
...
class DeserializationError_IntOverflow(DeserializationError, NamedTuple('IntOverflow', [])):
    ...
    def __eq__(self, __o: object) -> bool:
        return isinstance(__o, JSON_mErrors.DeserializationError_IntOverflow)
    def __hash__(self) -> int:
        return super().__hash__()
...
class DeserializationError_ReachedEOF(DeserializationError, NamedTuple('ReachedEOF', [])):
    ...
    def __eq__(self, __o: object) -> bool:
        return isinstance(__o, JSON_mErrors.DeserializationError_ReachedEOF)
    def __hash__(self) -> int:
        return super().__hash__()
...
class DeserializationError_ExpectingByte(DeserializationError, NamedTuple('ExpectingByte', [('expected', Any), ('b', Any)])):
    ...
    def __eq__(self, __o: object) -> bool:
        return isinstance(__o, JSON_mErrors.DeserializationError_ExpectingByte) and self.expected == __o.expected and self.b == __o.b
    def __hash__(self) -> int:
        return super().__hash__()
...
class DeserializationError_ExpectingAnyByte(DeserializationError, NamedTuple('ExpectingAnyByte', [('expected__sq', Any), ('b', Any)])):
    ...
    def __eq__(self, __o: object) -> bool:
        return isinstance(__o, JSON_mErrors.DeserializationError_ExpectingAnyByte) and self.expected__sq == __o.expected__sq and self.b == __o.b
    def __hash__(self) -> int:
        return super().__hash__()
...
class DeserializationError_InvalidUnicode(DeserializationError, NamedTuple('InvalidUnicode', [])):
    ...
    def __eq__(self, __o: object) -> bool:
        return isinstance(__o, JSON_mErrors.DeserializationError_InvalidUnicode)
    def __hash__(self) -> int:
        return super().__hash__()
...
class SerializationError:
    ...
    def is_OutOfMemory(self) -> bool:
        return isinstance(self, JSON_mErrors.SerializationError_OutOfMemory)
    @property
    def is_IntTooLarge(self) -> bool:
        return isinstance(self, JSON_mErrors.SerializationError_IntTooLarge)
    @property
    def is_StringTooLong(self) -> bool:
        return isinstance(self, JSON_mErrors.SerializationError_StringTooLong)
    @property
    def is_InvalidUnicode(self) -> bool:
        return isinstance(self, JSON_mErrors.SerializationError_InvalidUnicode)
    def ToString(self):
        source10_ = self
        if source10_.is_OutOfMemory:
            ...
            return (_dafny.Seq("Integer too large: ")) + (JSON_mUtils_mStr.default__.OfInt(d_409_i_, 10))
...
class SerializationError_OutOfMemory(SerializationError, NamedTuple('OutOfMemory', [])):
    ...
    def __eq__(self, __o: object) -> bool:
        return isinstance(__o, JSON_mErrors.SerializationError_OutOfMemory)
    def __hash__(self) -> int:
        return super().__hash__()
...
class SerializationError_IntTooLarge(SerializationError, NamedTuple('IntTooLarge', [('i', Any)])):
    ...
    def __eq__(self, __o: object) -> bool:
        return isinstance(__o, JSON_mErrors.SerializationError_IntTooLarge) and self.i == __o.i
    def __hash__(self) -> int:
        return super().__hash__()
...
class SerializationError_StringTooLong(SerializationError, NamedTuple('StringTooLong', [('s', Any)])):
    ...
    def __eq__(self, __o: object) -> bool:
        return isinstance(__o, JSON_mErrors.SerializationError_StringTooLong) and self.s == __o.s
    def __hash__(self) -> int:
        return super().__hash__()
...
class SerializationError_InvalidUnicode(SerializationError, NamedTuple('InvalidUnicode', [])):
    ...
    def __eq__(self, __o: object) -> bool:
        return isinstance(__o, JSON_mErrors.SerializationError_InvalidUnicode)
    def __hash__(self) -> int:
        return super().__hash__()
