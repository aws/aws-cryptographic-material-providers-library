...
class default__:
    ...
    @staticmethod
    def ToNat16(str):
        d_512_hd_ = JSON_Deserializer_Uint16StrConversion.default__.ToNat__any(str, 16, default__.HEX__TABLE__16)
        return d_512_hd_
    ...
    @staticmethod
    def String(js):
        d_518_valueOrError0_ = (UnicodeStrings.default__.FromUTF8Checked(((js).contents).Bytes())).ToResult_k(JSON_Errors.DeserializationError_InvalidUnicode())
        if (d_518_valueOrError0_).IsFailure():
            return (d_518_valueOrError0_).PropagateFailure()
        elif True:
            d_519_asUtf32_ = (d_518_valueOrError0_).Extract()
            d_520_valueOrError1_ = (UnicodeStrings.default__.ToUTF16Checked(d_519_asUtf32_)).ToResult_k(JSON_Errors.DeserializationError_InvalidUnicode())
            if (d_520_valueOrError1_).IsFailure():
                ...
                if (d_522_valueOrError2_).IsFailure():
                    ...
                    return (UnicodeStrings.default__.FromUTF16Checked(d_523_unescaped_)).ToResult_k(JSON_Errors.DeserializationError_InvalidUnicode())

    @staticmethod
    def ToInt(sign, n):
        d_524_n_ = JSON_Deserializer_ByteStrConversion.default__.ToNat__any((n).Bytes(), 10, default__.DIGITS)
        ...
        if (d_529_valueOrError0_).IsFailure():
            ...
            if (d_531_valueOrError1_).IsFailure():
                ...
                if source15_.is_Empty:
                    return Wrappers.Result_Success(JSON_Values.Decimal_Decimal(d_530_n_, d_538_e10_))
                elif True:
                    ...
                    if (d_544_valueOrError2_).IsFailure():
                        ...
                        return Wrappers.Result_Success(JSON_Values.Decimal_Decimal(((d_530_n_) * (Power.default__.Pow(10, d_543_pow10_))) + (d_545_frac_), (d_538_e10_) - (d_543_pow10_)))
    ...
    @staticmethod
    def Object(js):
        def lambda39_(d_550_js_):
            def lambda40_(d_551_d_):
                return default__.KeyValue((d_551_d_).t)

            return lambda40_

        return Seq.default__.MapWithResult(lambda39_(js), (js).data)

    @staticmethod
    def Array(js):
        def lambda41_(d_552_js_):
            def lambda42_(d_553_d_):
    ...
    def Value(js):
        ...
        if source17_.is_Null:
            ...
            return Wrappers.Result_Success(JSON_Values.JSON_Bool(default__.Bool(d_556_b_)))
            ...
            if (d_559_valueOrError0_).IsFailure():
                ...
                return Wrappers.Result_Success(JSON_Values.JSON_String(d_560_s_))
            ...
            if (d_563_valueOrError1_).IsFailure():
                ...
                return Wrappers.Result_Success(JSON_Values.JSON_Number(d_564_n_))
            ...
            if (d_567_valueOrError2_).IsFailure():
                ...
                return Wrappers.Result_Success(JSON_Values.JSON_Object(d_568_o_))
        elif True:
            ...
            if (d_571_valueOrError3_).IsFailure():
                ...
                return Wrappers.Result_Success(JSON_Values.JSON_Array(d_572_a_))
