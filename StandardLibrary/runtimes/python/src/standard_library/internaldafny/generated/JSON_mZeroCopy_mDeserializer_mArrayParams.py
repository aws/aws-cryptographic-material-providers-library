...
# assert "JSON_mZeroCopy_mDeserializer_mArrayParams" == __name__
JSON_mZeroCopy_mDeserializer_mArrayParams = sys.modules[__name__]
...
class default__:
    ...
    @staticmethod
    def ElementSpec(t):
        return JSON_mConcreteSyntax_mSpec.default__.Value(t)
