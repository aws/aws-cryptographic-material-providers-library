...
# assert "JSON_mUtils_mStr" == __name__
JSON_mUtils_mStr = sys.modules[__name__]
...
class default__:
    ...
    @staticmethod
    def OfNat(n, base):
        return JSON_mUtils_mStr_mCharStrConversion.default__.OfNat__any(n, _dafny.Seq(((JSON_mUtils_mStr.default__).HEX__DIGITS)[:base:]))

    @staticmethod
    def OfInt(n, base):
        return JSON_mUtils_mStr_mCharStrConversion.default__.OfInt__any(n, _dafny.Seq(((JSON_mUtils_mStr.default__).HEX__DIGITS)[:base:]), '-')

    @staticmethod
    def ToNat(str, base):
        return JSON_mUtils_mStr_mCharStrConversion.default__.ToNat__any(str, base, (JSON_mUtils_mStr.default__).HEX__TABLE)

    @staticmethod
    def ToInt(str, base):
        return JSON_mUtils_mStr_mCharStrConversion.default__.ToInt__any(str, '-', base, (JSON_mUtils_mStr.default__).HEX__TABLE)

    @staticmethod
    def EscapeQuotes(str):
        return JSON_mUtils_mStr_mCharStrEscaping.default__.Escape(str, _dafny.Set({'\"', '\''}), '\\')

    @staticmethod
    def UnescapeQuotes(str):
        return JSON_mUtils_mStr_mCharStrEscaping.default__.Unescape(str, '\\')

    @staticmethod
    def Test():
        if not((JSON_mUtils_mStr.default__.OfInt(0, 10)) == (_dafny.Seq("0"))):
        ...
        if not((JSON_mUtils_mStr.default__.OfInt(3, 10)) == (_dafny.Seq("3"))):
        ...
        if not((JSON_mUtils_mStr.default__.OfInt(302, 10)) == (_dafny.Seq("302"))):
