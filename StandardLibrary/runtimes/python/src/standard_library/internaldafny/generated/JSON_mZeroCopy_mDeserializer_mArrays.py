...
# assert "JSON_mZeroCopy_mDeserializer_mArrays" == __name__
JSON_mZeroCopy_mDeserializer_mArrays = sys.modules[__name__]
...
class default__:
    ...
    @staticmethod
    def Array(cs, json):
        d_731_valueOrError0_ = JSON_mZeroCopy_mDeserializer_mArrays.default__.Bracketed(cs, json)
        ...
        while True:
            with _dafny.label():
                ...
                if (d_742_valueOrError0_).IsFailure():
                    ...
                    if (d_745_s0_) == ((JSON_mZeroCopy_mDeserializer_mArrays.default__).SEPARATOR):
                        d_746_elems_ = JSON_mZeroCopy_mDeserializer_mArrays.default__.AppendWithSuffix(elems, d_743_elem_, d_744_sep_)
                        in126_ = json
                        in127_ = open
                        in128_ = d_746_elems_
                        json = in126_
                        ...
                        d_747_elems_k_ = JSON_mZeroCopy_mDeserializer_mArrays.default__.AppendLast(elems, d_743_elem_, d_744_sep_)
                        d_748_bracketed_ = JSON_mZeroCopy_mDeserializer_mArrays.default__.BracketedFromParts(open, d_747_elems_k_, d_744_sep_)
                        return Wrappers.Result_Success(d_748_bracketed_)
                    elif True:
                        d_749_separator_ = (JSON_mZeroCopy_mDeserializer_mArrays.default__).SEPARATOR
    ...
    def Bracketed(cs, json):
        d_751_valueOrError0_ = JSON_mZeroCopy_mDeserializer_mCore.default__.Structural(cs, JSON_mUtils_mParsers.Parser___Parser(JSON_mZeroCopy_mDeserializer_mArrays.default__.Open))
        if (d_751_valueOrError0_).IsFailure():
            ...
            if (((d_752_open_).cs).Peek()) == ((JSON_mZeroCopy_mDeserializer_mArrayParams.default__).CLOSE):
                d_754_valueOrError1_ = JSON_mZeroCopy_mDeserializer_mCore.default__.Structural((d_752_open_).cs, JSON_mUtils_mParsers.Parser___Parser(JSON_mZeroCopy_mDeserializer_mArrays.default__.Close))
                if (d_754_valueOrError1_).IsFailure():
                    return (d_754_valueOrError1_).PropagateFailure()
                elif True:
                    d_755_close_ = (d_754_valueOrError1_).Extract()
                    return Wrappers.Result_Success(JSON_mZeroCopy_mDeserializer_mArrays.default__.BracketedFromParts(d_752_open_, d_753_elems_, d_755_close_))
            elif True:
                return JSON_mZeroCopy_mDeserializer_mArrays.default__.Elements(json, d_752_open_, d_753_elems_)
