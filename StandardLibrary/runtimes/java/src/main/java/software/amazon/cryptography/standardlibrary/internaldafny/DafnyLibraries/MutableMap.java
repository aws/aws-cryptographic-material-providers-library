package software.amazon.cryptography.standardlibrary.internaldafny.DafnyLibraries;
...
public class MutableMap<K, V>
  extends software.amazon.cryptography.standardlibrary.internaldafny.DafnyLibraries._ExternBase_MutableMap<K, V> {
