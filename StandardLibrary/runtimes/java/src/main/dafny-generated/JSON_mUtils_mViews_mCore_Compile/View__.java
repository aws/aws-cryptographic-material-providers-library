...
public class View__ {
  ...
  private static final View__ theDefault = JSON_mUtils_mViews_mCore_Compile.View__.create(dafny.DafnySequence.<java.lang.Byte> empty(BoundedInts_Compile.uint8._typeDescriptor()), 0, 0);
  ...
  public static View__ OfBytes(dafny.DafnySequence<? extends java.lang.Byte> bs) {
    return JSON_mUtils_mViews_mCore_Compile.View__.create(bs, 0, (bs).cardinalityInt());
  }
  ...
  {
    return JSON_mUtils_mViews_mCore_Compile.View__.create(dafny.DafnySequence.<java.lang.Byte> empty(BoundedInts_Compile.uint8._typeDescriptor()), 0, 0);
  }
