...
public class __default {
  ...
  public static Wrappers_Compile.Result<Boolean, dafny.DafnySequence<? extends Character>> Example(dafny.DafnySequence<? extends dafny.DafnySequence<? extends Character>> args)
  {
    ...
    _0_MyOptions = dafny.DafnySequence.<Param> of(Param._typeDescriptor(), GetOpt_Compile.Param.create_Flag(dafny.DafnySequence.asString("foo"), dafny.DafnySequence.asString("Does foo things"), __default.NullChar(), false, false, GetOpt_Compile.Visibility.create_Normal(), dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR), dafny.DafnySequence.<dafny.DafnySequence<? extends Character>> empty(dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR))), GetOpt_Compile.Param.create_Opt(dafny.DafnySequence.asString("two"), dafny.DafnySequence.asString("Does bar things to thingy"), dafny.DafnySequence.asString("thingy"), 't', GetOpt_Compile.Unused.create_UnusedOk(), false, GetOpt_Compile.Visibility.create_Normal(), dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR), dafny.DafnySequence.<dafny.DafnySequence<? extends Character>> empty(dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR)), GetOpt_Compile.Tri.create_No()), GetOpt_Compile.Param.create_Command(GetOpt_Compile.Options.create(dafny.DafnySequence.asString("command"), dafny.DafnySequence.asString("Does command stuff"), dafny.DafnySequence.<Param> of(Param._typeDescriptor(), GetOpt_Compile.Param.create_Opt(dafny.DafnySequence.asString("two"), dafny.DafnySequence.asString("Does bar things to thingy"), dafny.DafnySequence.asString("thingy"), 't', GetOpt_Compile.Unused.create_UnusedOk(), false, GetOpt_Compile.Visibility.create_Normal(), dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR), dafny.DafnySequence.<dafny.DafnySequence<? extends Character>> empty(dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR)), GetOpt_Compile.Tri.create_No()), GetOpt_Compile.Param.create_Flag(dafny.DafnySequence.asString("foo"), dafny.DafnySequence.asString("Does foo things"), __default.NullChar(), false, false, GetOpt_Compile.Visibility.create_Normal(), dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR), dafny.DafnySequence.<dafny.DafnySequence<? extends Character>> empty(dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR)))))));
    Options _1_opts;
    _1_opts = GetOpt_Compile.Options.create(dafny.DafnySequence.asString("myProg"), dafny.DafnySequence.asString("does prog stuff"), _0_MyOptions);
  ...
  Parsed _pat_let1_0 = ((Parsed)(java.lang.Object)(boxed0));
  return ((Parsed)(java.lang.Object)(dafny.Helpers.<Parsed, Parsed>Let(_pat_let1_0, boxed1 -> {
    ...
    return ((Parsed)(java.lang.Object)(dafny.Helpers.<Wrappers_Compile.Option<Parsed>, Parsed>Let(Wrappers_Compile.Option.<Parsed>create_Some(Parsed._typeDescriptor(), _4_sub), boxed2 -> {
      Wrappers_Compile.Option<Parsed> _pat_let2_0 = ((Wrappers_Compile.Option<Parsed>)(java.lang.Object)(boxed2));
      return ((Parsed)(java.lang.Object)(dafny.Helpers.<Wrappers_Compile.Option<Parsed>, Parsed>Let(_pat_let2_0, boxed3 -> {
        ...
        return ((Parsed)(java.lang.Object)(dafny.Helpers.<dafny.DafnySequence<? extends OneArg>, Parsed>Let(dafny.DafnySequence.<OneArg>concatenate((_pat_let_tv0).dtor_params(), _1_newParams), boxed4 -> {
          dafny.DafnySequence<? extends OneArg> _pat_let3_0 = ((dafny.DafnySequence<? extends OneArg>)(java.lang.Object)(boxed4));
          return ((Parsed)(java.lang.Object)(dafny.Helpers.<dafny.DafnySequence<? extends OneArg>, Parsed>Let(_pat_let3_0, boxed5 -> {
            dafny.DafnySequence<? extends OneArg> _7_dt__update_hparams_h0 = ((dafny.DafnySequence<? extends OneArg>)(java.lang.Object)(boxed5));
            return GetOpt_Compile.Parsed.create((_5_dt__update__tmp_h0).dtor_command(), _7_dt__update_hparams_h0, (_5_dt__update__tmp_h0).dtor_files(), _6_dt__update_hsubcommand_h0);
          }
          )));
        }
        )));
  ...
  Parsed _pat_let4_0 = ((Parsed)(java.lang.Object)(boxed6));
  return ((Parsed)(java.lang.Object)(dafny.Helpers.<Parsed, Parsed>Let(_pat_let4_0, boxed7 -> {
    ...
    return ((Parsed)(java.lang.Object)(dafny.Helpers.<dafny.DafnySequence<? extends OneArg>, Parsed>Let(dafny.DafnySequence.<OneArg>concatenate((_pat_let_tv1).dtor_params(), _1_newParams), boxed8 -> {
      dafny.DafnySequence<? extends OneArg> _pat_let5_0 = ((dafny.DafnySequence<? extends OneArg>)(java.lang.Object)(boxed8));
      return ((Parsed)(java.lang.Object)(dafny.Helpers.<dafny.DafnySequence<? extends OneArg>, Parsed>Let(_pat_let5_0, boxed9 -> {
        dafny.DafnySequence<? extends OneArg> _9_dt__update_hparams_h1 = ((dafny.DafnySequence<? extends OneArg>)(java.lang.Object)(boxed9));
        return GetOpt_Compile.Parsed.create((_8_dt__update__tmp_h1).dtor_command(), _9_dt__update_hparams_h1, (_8_dt__update__tmp_h1).dtor_files(), (_8_dt__update__tmp_h1).dtor_subcommand());
      }
      )));
    }
    )));
  ...
  public static Wrappers_Compile.Outcome<dafny.DafnySequence<? extends Character>> TestPositionals(dafny.DafnySequence<? extends Param> opts, Wrappers_Compile.Option<dafny.DafnySequence<? extends Character>> optional)
  {
    TAIL_CALL_START: while (true) {
      if ((java.math.BigInteger.valueOf((opts).length())).signum() == 0) {
        ...
        optional = _in1;
        continue TAIL_CALL_START;
      } else if (java.util.Objects.equals((((Param)(java.lang.Object)((opts).select(dafny.Helpers.toInt((java.math.BigInteger.ZERO)))))).dtor_positional(), GetOpt_Compile.Tri.create_No())) {
        ...
        optional = _in3;
        continue TAIL_CALL_START;
      } else if (java.util.Objects.equals((((Param)(java.lang.Object)((opts).select(dafny.Helpers.toInt((java.math.BigInteger.ZERO)))))).dtor_positional(), GetOpt_Compile.Tri.create_Maybe())) {
        dafny.DafnySequence<? extends Param> _in4 = (opts).drop(java.math.BigInteger.ONE);
  ...
  public static Wrappers_Compile.Result<dafny.Tuple2<dafny.DafnySequence<? extends dafny.DafnySequence<? extends Character>>, dafny.DafnySequence<? extends OneArg>>, dafny.DafnySequence<? extends Character>> GetPositionals(dafny.DafnySequence<? extends Param> opts, dafny.DafnySequence<? extends dafny.DafnySequence<? extends Character>> args, dafny.DafnySequence<? extends OneArg> params)
  {
    TAIL_CALL_START: while (true) {
      if ((java.math.BigInteger.valueOf((opts).length())).signum() == 0) {
        ...
        params = _in5;
        continue TAIL_CALL_START;
      } else if (java.util.Objects.equals((((Param)(java.lang.Object)((opts).select(dafny.Helpers.toInt((java.math.BigInteger.ZERO)))))).dtor_positional(), GetOpt_Compile.Tri.create_Yes())) {
        if ((java.math.BigInteger.valueOf((args).length())).signum() == 0) {
          ...
          dafny.DafnySequence<? extends OneArg> _in8 = dafny.DafnySequence.<OneArg>concatenate(params, dafny.DafnySequence.<OneArg> of(OneArg._typeDescriptor(), GetOpt_Compile.OneArg.create((((Param)(java.lang.Object)((opts).select(dafny.Helpers.toInt((java.math.BigInteger.ZERO)))))).dtor_name(), Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>create_Some(dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR), ((dafny.DafnySequence<? extends Character>)(java.lang.Object)((args).select(dafny.Helpers.toInt((java.math.BigInteger.ZERO)))))))));
          opts = _in6;
          args = _in7;
          params = _in8;
          continue TAIL_CALL_START;
        ...
        if ((java.math.BigInteger.valueOf((args).length())).signum() == 0) {
          ...
          dafny.DafnySequence<? extends OneArg> _in11 = dafny.DafnySequence.<OneArg>concatenate(params, dafny.DafnySequence.<OneArg> of(OneArg._typeDescriptor(), GetOpt_Compile.OneArg.create((((Param)(java.lang.Object)((opts).select(dafny.Helpers.toInt((java.math.BigInteger.ZERO)))))).dtor_name(), Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>create_Some(dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR), ((dafny.DafnySequence<? extends Character>)(java.lang.Object)((args).select(dafny.Helpers.toInt((java.math.BigInteger.ZERO)))))))));
          opts = _in9;
          args = _in10;
          params = _in11;
          continue TAIL_CALL_START;
    ...
    if ((_3_valueOrError0).IsFailure(dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR))) {
      ...
      if ((_4_valueOrError1).IsFailure(dafny.Tuple2.<dafny.DafnySequence<? extends dafny.DafnySequence<? extends Character>>, dafny.DafnySequence<? extends OneArg>>_typeDescriptor(dafny.DafnySequence.<dafny.DafnySequence<? extends Character>>_typeDescriptor(dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR)), dafny.DafnySequence.<OneArg>_typeDescriptor(OneArg._typeDescriptor())), dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR))) {
        ...
        if ((_7_valueOrError2).IsFailure(dafny.Tuple3.<dafny.DafnyMap<? extends dafny.DafnySequence<? extends Character>, ? extends Param>, dafny.DafnyMap<? extends Character, ? extends dafny.DafnySequence<? extends Character>>, dafny.DafnyMap<? extends dafny.DafnySequence<? extends Character>, ? extends Options>>_typeDescriptor(dafny.DafnyMap.<dafny.DafnySequence<? extends Character>, Param>_typeDescriptor(dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR), Param._typeDescriptor()), dafny.DafnyMap.<Character, dafny.DafnySequence<? extends Character>>_typeDescriptor(dafny.TypeDescriptor.CHAR, dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR)), CommandMap._typeDescriptor()), dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR))) {
          ...
          Context _11_context = GetOpt_Compile.Context.create(_8_longMap, _9_shortMap, _1_inherits, _10_commandMap, ((dafny.DafnySequence<? extends Character>)(java.lang.Object)((args).select(dafny.Helpers.toInt((java.math.BigInteger.ZERO))))));
  ...
  {
    if ((java.math.BigInteger.valueOf((args).length())).signum() == 0) {
      return Wrappers_Compile.Result.<Parsed, dafny.DafnySequence<? extends Character>>create_Success(Parsed._typeDescriptor(), dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR), GetOpt_Compile.Parsed.create((context).dtor_command(), parms, files, Wrappers_Compile.Option.<Parsed>create_None(Parsed._typeDescriptor())));
      ...
      if ((_3_valueOrError0).IsFailure(dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR))) {
        ...
        if ((_4_valueOrError1).IsFailure(dafny.Tuple2.<dafny.DafnySequence<? extends dafny.DafnySequence<? extends Character>>, dafny.DafnySequence<? extends OneArg>>_typeDescriptor(dafny.DafnySequence.<dafny.DafnySequence<? extends Character>>_typeDescriptor(dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR)), dafny.DafnySequence.<OneArg>_typeDescriptor(OneArg._typeDescriptor())), dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR))) {
          ...
          if ((_7_valueOrError2).IsFailure(dafny.Tuple3.<dafny.DafnyMap<? extends dafny.DafnySequence<? extends Character>, ? extends Param>, dafny.DafnyMap<? extends Character, ? extends dafny.DafnySequence<? extends Character>>, dafny.DafnyMap<? extends dafny.DafnySequence<? extends Character>, ? extends Options>>_typeDescriptor(dafny.DafnyMap.<dafny.DafnySequence<? extends Character>, Param>_typeDescriptor(dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR), Param._typeDescriptor()), dafny.DafnyMap.<Character, dafny.DafnySequence<? extends Character>>_typeDescriptor(dafny.TypeDescriptor.CHAR, dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR)), CommandMap._typeDescriptor()), dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR))) {
            ...
            Context _11_newContext = GetOpt_Compile.Context.create(_8_longMap, _9_shortMap, dafny.DafnySequence.<Param>concatenate((context).dtor_inherits(), _0_inherits), _10_commandSet, ((dafny.DafnySequence<? extends Character>)(java.lang.Object)((args).select(dafny.Helpers.toInt((java.math.BigInteger.ZERO))))));
      ...
      return Wrappers_Compile.Result.<Parsed, dafny.DafnySequence<? extends Character>>create_Success(Parsed._typeDescriptor(), dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR), GetOpt_Compile.Parsed.create((context).dtor_command(), parms, dafny.DafnySequence.<dafny.DafnySequence<? extends Character>>concatenate(files, (args).drop(java.math.BigInteger.ONE)), Wrappers_Compile.Option.<Parsed>create_None(Parsed._typeDescriptor())));
  ...
  {
    return GetOpt_Compile.Param.create_Flag(__default.HELP__STR(), dafny.DafnySequence.asString("This help text."), __default.NullChar(), true, true, GetOpt_Compile.Visibility.create_Normal(), dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR), dafny.DafnySequence.<dafny.DafnySequence<? extends Character>> empty(dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR)));
  }
  @Override
