...
public class Parsed {
  ...
  private static final Parsed theDefault = GetOpt_Compile.Parsed.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR), dafny.DafnySequence.<OneArg> empty(OneArg._typeDescriptor()), dafny.DafnySequence.<dafny.DafnySequence<? extends Character>> empty(dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR)), Wrappers_Compile.Option.<Parsed>Default(Parsed._typeDescriptor()));
