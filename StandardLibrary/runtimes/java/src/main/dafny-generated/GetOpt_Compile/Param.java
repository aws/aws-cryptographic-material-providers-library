...
public abstract class Param {
  ...
  private static final Param theDefault = GetOpt_Compile.Param.create_Opt(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR), dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR), dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR), 'D', Unused.Default(), false, Visibility.Default(), dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR), dafny.DafnySequence.<dafny.DafnySequence<? extends Character>> empty(dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR)), Tri.Default());
  ...
  public boolean ShowHelp() {
    return ((this).is_Command()) || (java.util.Objects.equals((this).dtor_vis(), GetOpt_Compile.Visibility.create_Normal()));
  }
  public boolean KeepResult() {
    return ((this).is_Command()) || (!java.util.Objects.equals((this).dtor_vis(), GetOpt_Compile.Visibility.create_Deprecated()));
  }
  ...
  public dafny.DafnySequence<? extends OneArg> MakeArg(Wrappers_Compile.Option<dafny.DafnySequence<? extends Character>> value) {
    if ((this).KeepResult()) {
      return dafny.DafnySequence.<OneArg> of(OneArg._typeDescriptor(), GetOpt_Compile.OneArg.create((this).Name(), value));
    } else {
