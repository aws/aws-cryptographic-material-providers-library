...
public abstract class Option<T> {
  ...
  public static <T> Option<T> Default(dafny.TypeDescriptor<T> _td_T) {
    return Wrappers_Compile.Option.<T>create_None(_td_T);
  }
  @Deprecated()
  ...
  public Result<T, dafny.DafnySequence<? extends Character>> ToResult(dafny.TypeDescriptor<T> _td_T) {
    ...
    if (_source0.is_None()) {
      return Wrappers_Compile.Result.<T, dafny.DafnySequence<? extends Character>>create_Failure(_td_T, dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR), dafny.DafnySequence.asString("Option is None"));
    } else {
      T _0___mcc_h0 = ((Wrappers_Compile.Option_Some<T>)_source0)._value;
      T _1_v = _0___mcc_h0;
      return Wrappers_Compile.Result.<T, dafny.DafnySequence<? extends Character>>create_Success(_td_T, dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR), _1_v);
    }
  }
  public <__R> Result<T, __R> ToResult_k(dafny.TypeDescriptor<T> _td_T, dafny.TypeDescriptor<__R> _td___R, __R error)
  {
    Option<T> _source0 = this;
    if (_source0.is_None()) {
      return Wrappers_Compile.Result.<T, __R>create_Failure(_td_T, _td___R, error);
    } else {
      T _0___mcc_h0 = ((Wrappers_Compile.Option_Some<T>)_source0)._value;
      T _1_v = _0___mcc_h0;
      return Wrappers_Compile.Result.<T, __R>create_Success(_td_T, _td___R, _1_v);
    }
  }
  ...
  {
    return Wrappers_Compile.Option.<__U>create_None(_td___U);
  }
