...
public class Bracketed<L, D, S, R> {
  ...
  public static <L, D, S, R> Bracketed<L, D, S, R> Default(dafny.TypeDescriptor<L> _td_L, dafny.TypeDescriptor<D> _td_D, dafny.TypeDescriptor<S> _td_S, dafny.TypeDescriptor<R> _td_R, L _default_L, R _default_R) {
    return Bracketed.<L, D, S, R>create(_td_L, _td_D, _td_S, _td_R, Structural.<L>Default(_td_L, _default_L), dafny.DafnySequence.<Suffixed<D, S>> empty(Suffixed.<D, S>_typeDescriptor(_td_D, _td_S)), Structural.<R>Default(_td_R, _default_R));
  }
  @Deprecated()
