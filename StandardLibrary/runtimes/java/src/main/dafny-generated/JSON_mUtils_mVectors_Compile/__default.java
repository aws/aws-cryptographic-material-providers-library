...
public class __default {
  ...
  public static Wrappers_Compile.Outcome<VectorError> OOM__FAILURE()
  {
    return Wrappers_Compile.Outcome.<VectorError>create_Fail(VectorError._typeDescriptor(), JSON_mUtils_mVectors_Compile.VectorError.create());
  }
  @Override
