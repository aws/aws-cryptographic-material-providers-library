...
public class Writer__ {
  ...
  private static final Writer__ theDefault = Writer__.create(0, Chain.Default());
  ...
  public Writer__ Append(JSON_mUtils_mViews_mCore_Compile.View__ v_k) {
    return Writer__.create(Writer__.SaturatedAddU32((this).dtor_length(), (v_k).Length()), ((this).dtor_chain()).Append(v_k));
  }
  ...
  {
    return Writer__.create(0, Chain.create_Empty());
  }
