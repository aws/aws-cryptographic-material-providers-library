...
public class Cursor__ {
  ...
  private static final Cursor__ theDefault = JSON_mUtils_mCursors_Compile.Cursor__.create(dafny.DafnySequence.<java.lang.Byte> empty(BoundedInts_Compile.uint8._typeDescriptor()), 0, 0, 0);
  ...
  public static Cursor__ OfBytes(dafny.DafnySequence<? extends java.lang.Byte> bs) {
    return JSON_mUtils_mCursors_Compile.Cursor__.create(bs, 0, 0, (bs).cardinalityInt());
  }
  ...
  public Cursor__ Suffix() {
    ...
    return JSON_mUtils_mCursors_Compile.Cursor__.create((_0_dt__update__tmp_h0).dtor_s(), _1_dt__update_hbeg_h0, (_0_dt__update__tmp_h0).dtor_point(), (_0_dt__update__tmp_h0).dtor_end());
  }
  public Split<JSON_mUtils_mViews_mCore_Compile.View__> Split() {
    return JSON_mUtils_mCursors_Compile.Split.<JSON_mUtils_mViews_mCore_Compile.View__>create(JSON_mUtils_mViews_mCore_Compile.View._typeDescriptor(), (this).Prefix(), (this).Suffix());
  }
  ...
  public Cursor__ Skip(int n) {
    ...
    return JSON_mUtils_mCursors_Compile.Cursor__.create((_0_dt__update__tmp_h0).dtor_s(), (_0_dt__update__tmp_h0).dtor_beg(), _1_dt__update_hpoint_h0, (_0_dt__update__tmp_h0).dtor_end());
  }
  ...
  {
    if ((this).EOF_q()) {
      return Wrappers_Compile.Result.<Cursor__, CursorError<__R>>create_Failure(Cursor._typeDescriptor(), CursorError.<__R>_typeDescriptor(_td___R), JSON_mUtils_mCursors_Compile.CursorError.<__R>create_OtherError(_td___R, err));
    } else {
  ...
  public <__R> Wrappers_Compile.Result<Cursor__, CursorError<__R>> AssertByte(dafny.TypeDescriptor<__R> _td___R, byte b)
  {
    ...
    if ((_0_nxt) == ((short) java.lang.Byte.toUnsignedInt(b))) {
      ...
      return Wrappers_Compile.Result.<Cursor__, CursorError<__R>>create_Failure(Cursor._typeDescriptor(), CursorError.<__R>_typeDescriptor(_td___R), JSON_mUtils_mCursors_Compile.CursorError.<__R>create_ExpectingByte(_td___R, b, _0_nxt));
    }
  }
  ...
  public Cursor__ SkipWhile(java.util.function.Function<java.lang.Byte, Boolean> p)
  {
    ...
    ps = JSON_mUtils_mCursors_Compile.Cursor__.create((this).dtor_s(), (this).dtor_beg(), _0_point_k, (this).dtor_end());
    return ps;
  }
    ...
    if(true) {
      ...
      while (true) {
        ...
        if (_source0.is_Accept()) {
          pr = Wrappers_Compile.Result.<Cursor__, CursorError<__R>>create_Success(Cursor__._typeDescriptor(), CursorError.<__R>_typeDescriptor(_td___R), JSON_mUtils_mCursors_Compile.Cursor__.create((this).dtor_s(), (this).dtor_beg(), _0_point_k, (this).dtor_end()));
          return pr;
          ...
          pr = Wrappers_Compile.Result.<Cursor__, CursorError<__R>>create_Failure(Cursor._typeDescriptor(), CursorError.<__R>_typeDescriptor(_td___R), JSON_mUtils_mCursors_Compile.CursorError.<__R>create_OtherError(_td___R, _7_err));
          return pr;
        } else {
          __A _8___mcc_h1 = ((JSON_mUtils_mLexers_mCore_Compile.LexerResult_Partial<__A, __R>)_source0)._st;
          __A _9_st_k_k = _8___mcc_h1;
          if (_3_eof) {
            pr = Wrappers_Compile.Result.<Cursor__, CursorError<__R>>create_Failure(Cursor._typeDescriptor(), CursorError.<__R>_typeDescriptor(_td___R), JSON_mUtils_mCursors_Compile.CursorError.<__R>create_EOF(_td___R));
            return pr;
          } else {
            _2_st_k = _9_st_k_k;
            _0_point_k = (int) ((_0_point_k) + (1));
