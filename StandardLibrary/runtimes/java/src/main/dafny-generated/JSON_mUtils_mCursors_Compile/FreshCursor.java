// Class FreshCursor
// Dafny class FreshCursor compiled into Java
...
public class FreshCursor {
  ...
  private static final dafny.TypeDescriptor<Cursor__> _TYPE = dafny.TypeDescriptor.<Cursor__>referenceWithInitializer(Cursor__.class, () -> FreshCursor.defaultValue());
