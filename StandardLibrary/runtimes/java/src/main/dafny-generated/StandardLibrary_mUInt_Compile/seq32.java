// Class seq32
// Dafny class seq32 compiled into Java
...
public class seq32<T> {
  protected dafny.TypeDescriptor<T> _td_T;
  public seq32(dafny.TypeDescriptor<T> _td_T) {
    this._td_T = _td_T;
  }
  public static <T> boolean _Is(dafny.TypeDescriptor<T> _td_T, dafny.DafnySequence<? extends T> __source) {
    dafny.DafnySequence<? extends T> _1_s = __source;
    return __default.<T>HasUint32Len(_td_T, _1_s);
  }
