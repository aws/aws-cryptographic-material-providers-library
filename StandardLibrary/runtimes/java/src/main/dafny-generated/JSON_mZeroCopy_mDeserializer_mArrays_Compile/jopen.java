...
public class jopen {
  ...
  public static JSON_mUtils_mViews_mCore_Compile.View__ Witness = JSON_mUtils_mViews_mCore_Compile.View__.OfBytes(dafny.DafnySequence.<java.lang.Byte> of(JSON_mZeroCopy_mDeserializer_mArrayParams_Compile.__default.OPEN()));
