...
public class __default {
  ...
  public static void Test()
  {
    if (!((__default.OfInt(java.math.BigInteger.ZERO, java.math.BigInteger.valueOf(10L))).equals(dafny.DafnySequence.asString("0")))) {
      throw new dafny.DafnyHaltException("/Users/rishavkj/Documents/Storage/Team-Repos/aws-cryptographic-material-providers-library/libraries/src/JSON/Utils/Str.dfy(229,4): " + (dafny.DafnySequence.asString("expectation violation")).verbatimString());
    }
    if (!((__default.OfInt(java.math.BigInteger.valueOf(3L), java.math.BigInteger.valueOf(10L))).equals(dafny.DafnySequence.asString("3")))) {
      throw new dafny.DafnyHaltException("/Users/rishavkj/Documents/Storage/Team-Repos/aws-cryptographic-material-providers-library/libraries/src/JSON/Utils/Str.dfy(230,4): " + (dafny.DafnySequence.asString("expectation violation")).verbatimString());
    }
    if (!((__default.OfInt(java.math.BigInteger.valueOf(302L), java.math.BigInteger.valueOf(10L))).equals(dafny.DafnySequence.asString("302")))) {
      throw new dafny.DafnyHaltException("/Users/rishavkj/Documents/Storage/Team-Repos/aws-cryptographic-material-providers-library/libraries/src/JSON/Utils/Str.dfy(231,4): " + (dafny.DafnySequence.asString("expectation violation")).verbatimString());
    }
    if (!((__default.OfInt(java.math.BigInteger.valueOf(-3L), java.math.BigInteger.valueOf(10L))).equals(dafny.DafnySequence.asString("-3")))) {
      throw new dafny.DafnyHaltException("/Users/rishavkj/Documents/Storage/Team-Repos/aws-cryptographic-material-providers-library/libraries/src/JSON/Utils/Str.dfy(232,4): " + (dafny.DafnySequence.asString("expectation violation")).verbatimString());
    }
    if (!((__default.OfInt(java.math.BigInteger.valueOf(-302L), java.math.BigInteger.valueOf(10L))).equals(dafny.DafnySequence.asString("-302")))) {
      throw new dafny.DafnyHaltException("/Users/rishavkj/Documents/Storage/Team-Repos/aws-cryptographic-material-providers-library/libraries/src/JSON/Utils/Str.dfy(233,4): " + (dafny.DafnySequence.asString("expectation violation")).verbatimString());
    }
  }
