...
public abstract class _ExternBase___default {
  ...
  public static AbsoluteTime GetAbsoluteTime()
  {
    ...
    _1_CpuTime = _out1;
    output = Time.AbsoluteTime.create((_0_ClockTime), (_1_CpuTime));
    return output;
  }
  ...
  public static RelativeTime TimeDiff(AbsoluteTime start, AbsoluteTime end)
  {
    if ((java.lang.Long.compareUnsigned((start).dtor_ClockTime(), (end).dtor_ClockTime()) <= 0) && (java.lang.Long.compareUnsigned((start).dtor_CpuTime(), (end).dtor_CpuTime()) <= 0)) {
      return Time.RelativeTime.create((long) (long) (((end).dtor_ClockTime()) - ((start).dtor_ClockTime())), (long) (long) (((end).dtor_CpuTime()) - ((start).dtor_CpuTime())));
    } else {
      return Time.RelativeTime.create((long) 0L, (long) 0L);
    }
  }
  ...
  public static void PrintTimeLong(RelativeTime time, dafny.DafnySequence<? extends Character> tag)
  {
