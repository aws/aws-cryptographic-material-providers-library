...
func (_static *CompanionStruct_Default___) Test() {
  if (!(_dafny.Companion_Sequence_.Equal(Companion_Default___.OfInt(_dafny.Zero, _dafny.IntOfInt64(10)), _dafny.SeqOfString("0")))) {
    panic("/Users/jocorell/crypto-tools/mpl/private-aws-cryptographic-material-providers-library-dafny-staging/libraries/src/JSON/Utils/Str.dfy(229,4): " + (_dafny.SeqOfString("expectation violation")).String())
  }
  if (!(_dafny.Companion_Sequence_.Equal(Companion_Default___.OfInt(_dafny.IntOfInt64(3), _dafny.IntOfInt64(10)), _dafny.SeqOfString("3")))) {
    panic("/Users/jocorell/crypto-tools/mpl/private-aws-cryptographic-material-providers-library-dafny-staging/libraries/src/JSON/Utils/Str.dfy(230,4): " + (_dafny.SeqOfString("expectation violation")).String())
  }
  if (!(_dafny.Companion_Sequence_.Equal(Companion_Default___.OfInt(_dafny.IntOfInt64(302), _dafny.IntOfInt64(10)), _dafny.SeqOfString("302")))) {
    panic("/Users/jocorell/crypto-tools/mpl/private-aws-cryptographic-material-providers-library-dafny-staging/libraries/src/JSON/Utils/Str.dfy(231,4): " + (_dafny.SeqOfString("expectation violation")).String())
  }
  if (!(_dafny.Companion_Sequence_.Equal(Companion_Default___.OfInt(_dafny.IntOfInt64(-3), _dafny.IntOfInt64(10)), _dafny.SeqOfString("-3")))) {
    panic("/Users/jocorell/crypto-tools/mpl/private-aws-cryptographic-material-providers-library-dafny-staging/libraries/src/JSON/Utils/Str.dfy(232,4): " + (_dafny.SeqOfString("expectation violation")).String())
  }
  if (!(_dafny.Companion_Sequence_.Equal(Companion_Default___.OfInt(_dafny.IntOfInt64(-302), _dafny.IntOfInt64(10)), _dafny.SeqOfString("-302")))) {
    panic("/Users/jocorell/crypto-tools/mpl/private-aws-cryptographic-material-providers-library-dafny-staging/libraries/src/JSON/Utils/Str.dfy(233,4): " + (_dafny.SeqOfString("expectation violation")).String())
  }
}
