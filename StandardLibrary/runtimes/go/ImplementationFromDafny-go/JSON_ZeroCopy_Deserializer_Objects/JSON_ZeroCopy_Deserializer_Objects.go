// Package JSON_ZeroCopy_Deserializer_Objects
// Dafny module JSON_ZeroCopy_Deserializer_Objects compiled into Go
...
func (*Default__) String() string {
	return "JSON_ZeroCopy_Deserializer_Objects.Default__"
}
...
func (_static *CompanionStruct_Default___) Object(cs m_JSON_Utils_Cursors.Cursor__, json m_JSON_Utils_Parsers.SubParser__) m_Wrappers.Result {
...
func (_static *CompanionStruct_Default___) Open(cs m_JSON_Utils_Cursors.Cursor__) m_Wrappers.Result {
	var _0_valueOrError0 m_Wrappers.Result = (cs).AssertByte(m_JSON_ZeroCopy_Deserializer_ObjectParams.Companion_Default___.OPEN())
	_ = _0_valueOrError0
	if (_0_valueOrError0).IsFailure() {
		return (_0_valueOrError0).PropagateFailure()
	} else {
...
func (_static *CompanionStruct_Default___) Close(cs m_JSON_Utils_Cursors.Cursor__) m_Wrappers.Result {
	var _0_valueOrError0 m_Wrappers.Result = (cs).AssertByte(m_JSON_ZeroCopy_Deserializer_ObjectParams.Companion_Default___.CLOSE())
	_ = _0_valueOrError0
	if (_0_valueOrError0).IsFailure() {
		return (_0_valueOrError0).PropagateFailure()
	} else {
...
func (_static *CompanionStruct_Default___) AppendWithSuffix(elems m_JSON_Utils_Cursors.Split, elem m_JSON_Utils_Cursors.Split, sep m_JSON_Utils_Cursors.Split) m_JSON_Utils_Cursors.Split {
	var _0_suffixed m_JSON_Grammar.Suffixed = m_JSON_Grammar.Companion_Suffixed_.Create_Suffixed_((elem).Dtor_t().(m_JSON_Grammar.JKeyValue), m_JSON_Grammar.Companion_Maybe_.Create_NonEmpty_((sep).Dtor_t().(m_JSON_Grammar.Structural)))
	_ = _0_suffixed
...
func (_static *CompanionStruct_Default___) AppendLast(elems m_JSON_Utils_Cursors.Split, elem m_JSON_Utils_Cursors.Split, sep m_JSON_Utils_Cursors.Split) m_JSON_Utils_Cursors.Split {
	var _0_suffixed m_JSON_Grammar.Suffixed = m_JSON_Grammar.Companion_Suffixed_.Create_Suffixed_((elem).Dtor_t().(m_JSON_Grammar.JKeyValue), m_JSON_Grammar.Companion_Maybe_.Create_Empty_())
	_ = _0_suffixed
...
TAIL_CALL_START:
	var _0_valueOrError0 m_Wrappers.Result = m_JSON_ZeroCopy_Deserializer_ObjectParams.Companion_Default___.Element((elems).Dtor_cs(), json)
	_ = _0_valueOrError0
	if (_0_valueOrError0).IsFailure() {
		return (_0_valueOrError0).PropagateFailure()
	} else {
		...
		if ((_1_elem).Dtor_cs()).EOF_q() {
			...
			if ((_3_s0) == (int16(Companion_Default___.SEPARATOR()))) && (((((_2_sep).Dtor_t().(m_JSON_Grammar.Structural)).Dtor_t().(m_JSON_Utils_Views_Core.View__)).Length()) == (uint32(1))) {
				...
				elems = _in2
				goto TAIL_CALL_START
			} else if ((_3_s0) == (int16(m_JSON_ZeroCopy_Deserializer_ObjectParams.Companion_Default___.CLOSE()))) && (((((_2_sep).Dtor_t().(m_JSON_Grammar.Structural)).Dtor_t().(m_JSON_Utils_Views_Core.View__)).Length()) == (uint32(1))) {
				...
				_ = _9_separator
				var _10_pr m_Wrappers.Result = m_Wrappers.Companion_Result_.Create_Failure_(m_JSON_Utils_Cursors.Companion_CursorError_.Create_ExpectingAnyByte_(_dafny.SeqOf(m_JSON_ZeroCopy_Deserializer_ObjectParams.Companion_Default___.CLOSE(), _9_separator), _3_s0))
				_ = _10_pr
				return _10_pr
			}
		}
...
func (*Jopen) String() string {
	return "JSON_ZeroCopy_Deserializer_Objects.Jopen"
}
func (_this *CompanionStruct_Jopen_) Witness() m_JSON_Utils_Views_Core.View__ {
	return m_JSON_Utils_Views_Core.Companion_View___.OfBytes(_dafny.SeqOf(m_JSON_ZeroCopy_Deserializer_ObjectParams.Companion_Default___.OPEN()))
}
...
func (*Jclose) String() string {
	return "JSON_ZeroCopy_Deserializer_Objects.Jclose"
}
func (_this *CompanionStruct_Jclose_) Witness() m_JSON_Utils_Views_Core.View__ {
	return m_JSON_Utils_Views_Core.Companion_View___.OfBytes(_dafny.SeqOf(m_JSON_ZeroCopy_Deserializer_ObjectParams.Companion_Default___.CLOSE()))
}
