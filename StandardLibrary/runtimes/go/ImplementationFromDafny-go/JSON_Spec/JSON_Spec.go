...
func (_static *CompanionStruct_Default___) JSON(js m_JSON_Values.JSON) m_Wrappers.Result {
  ...
  }
  {
    if (_source0.Is_Bool()) {
      ...
      _ = _0_b
      return m_Wrappers.Companion_Result_.Create_Success_((func () _dafny.Sequence { if _0_b { return m_UnicodeStrings.Companion_Default___.ASCIIToUTF8(_dafny.SeqOfString("true")) }; return m_UnicodeStrings.Companion_Default___.ASCIIToUTF8(_dafny.SeqOfString("false")) })() )
    }
  }
  {
