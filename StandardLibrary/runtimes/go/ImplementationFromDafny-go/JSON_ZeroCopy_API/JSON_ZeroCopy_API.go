// Package JSON_ZeroCopy_API
// Dafny module JSON_ZeroCopy_API compiled into Go
...
func (*Default__) String() string {
	return "JSON_ZeroCopy_API.Default__"
}
...
func (_static *CompanionStruct_Default___) Serialize(js m_JSON_Grammar.Structural) m_Wrappers.Result {
	return m_Wrappers.Companion_Result_.Create_Success_((m_JSON_ZeroCopy_Serializer.Companion_Default___.Text(js)).Bytes())
}
func (_static *CompanionStruct_Default___) SerializeAlloc(js m_JSON_Grammar.Structural) m_Wrappers.Result {
	var bs m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(_dafny.NewArrayWithValue(nil, _dafny.IntOf(0)))
	_ = bs
	var _out0 m_Wrappers.Result
	_ = _out0
	_out0 = m_JSON_ZeroCopy_Serializer.Companion_Default___.Serialize(js)
	bs = _out0
	return bs
}
func (_static *CompanionStruct_Default___) SerializeInto(js m_JSON_Grammar.Structural, bs _dafny.Array) m_Wrappers.Result {
	var len_ m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(uint32(0))
	_ = len_
	var _out0 m_Wrappers.Result
	_ = _out0
	_out0 = m_JSON_ZeroCopy_Serializer.Companion_Default___.SerializeTo(js, bs)
	len_ = _out0
	return len_
}
func (_static *CompanionStruct_Default___) Deserialize(bs _dafny.Sequence) m_Wrappers.Result {
	return m_JSON_ZeroCopy_Deserializer_API.Companion_Default___.OfBytes(bs)
}
