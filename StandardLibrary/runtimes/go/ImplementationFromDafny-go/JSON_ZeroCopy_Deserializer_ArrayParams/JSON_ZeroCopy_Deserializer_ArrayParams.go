// Package JSON_ZeroCopy_Deserializer_ArrayParams
// Dafny module JSON_ZeroCopy_Deserializer_ArrayParams compiled into Go
...
func (*Default__) String() string {
	return "JSON_ZeroCopy_Deserializer_ArrayParams.Default__"
}
...
func (_static *CompanionStruct_Default___) ElementSpec(t m_JSON_Grammar.Value) _dafny.Sequence {
	return m_JSON_ConcreteSyntax_Spec.Companion_Default___.Value(t)
}
func (_static *CompanionStruct_Default___) Element(cs m_JSON_Utils_Cursors.Cursor__, json m_JSON_Utils_Parsers.SubParser__) m_Wrappers.Result {
	return (func(coer56 func(m_JSON_Utils_Cursors.Cursor__) m_Wrappers.Result) func(m_JSON_Utils_Cursors.Cursor__) m_Wrappers.Result {
