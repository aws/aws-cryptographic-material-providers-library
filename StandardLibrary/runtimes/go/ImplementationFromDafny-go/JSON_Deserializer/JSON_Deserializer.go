...
func (_static *CompanionStruct_Default___) String_(js m_JSON_Grammar.Jstring) m_Wrappers.Result {
...
func (_static *CompanionStruct_Default___) KeyValue(js m_JSON_Grammar.JKeyValue) m_Wrappers.Result {
	var _0_valueOrError0 m_Wrappers.Result = Companion_Default___.String_((js).Dtor_k())
	_ = _0_valueOrError0
	if (_0_valueOrError0).IsFailure() {
		return (_0_valueOrError0).PropagateFailure()
	} else {
