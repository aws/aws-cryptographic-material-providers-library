...
func (_static *CompanionStruct_Default___) Filter(f func (interface{}) bool, xs _dafny.Sequence) _dafny.Sequence {
  ...
  if ((_dafny.IntOfUint32((xs).Cardinality())).Sign() == 0) {
    ...
    _0___accumulator = _dafny.Companion_Sequence_.Concatenate(_0___accumulator, (func () _dafny.Sequence { if (f)((xs).Select(0).(interface{})) { return _dafny.SeqOf((xs).Select(0).(interface{})) }; return _dafny.SeqOf() })() )
...
func (_static *CompanionStruct_Default___) GetLongHelp(opt Param, longLen _dafny.Int) _dafny.Sequence {
  if (((opt).Is_Opt()) || ((opt).Is_Flag())) {
    var _0_tmp _dafny.Sequence = _dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.SeqOfString("--"), (opt).Dtor_name()), (func () _dafny.Sequence { if (opt).Is_Opt() { return _dafny.Companion_Sequence_.Concatenate(_dafny.SeqOfString("="), (opt).Dtor_argName()) }; return _dafny.SeqOfString("") })() )
    _ = _0_tmp
...
func (_static *CompanionStruct_Default___) GetCmdHelp(opts _dafny.Sequence, commandLen _dafny.Int) _dafny.Sequence {
  ...
  if ((_dafny.IntOfUint32((opts).Cardinality())).Sign() == 0) {
    ...
    var _1_x _dafny.Sequence = (func () _dafny.Sequence { if ((opts).Select(0).(Param)).Is_Command() { return Companion_Default___.GetCommandHelp((opts).Select(0).(Param), commandLen) }; return _dafny.SeqOfString("") })() 
    _ = _1_x
    _0___accumulator = _dafny.Companion_Sequence_.Concatenate(_0___accumulator, _1_x)
    var _in0 _dafny.Sequence = (opts).Drop(1)
    _ = _in0
...
func (_static *CompanionStruct_Default___) GetLongLen(opts _dafny.Sequence, max _dafny.Int) _dafny.Int {
  ...
  if ((_dafny.IntOfUint32((opts).Cardinality())).Sign() == 0) {
    ...
    _ = _0_x
    var _1_newMax _dafny.Int = (func () _dafny.Int { if (_0_x).Cmp(max) > 0 { return _0_x }; return max })() 
    _ = _1_newMax
    var _in0 _dafny.Sequence = (opts).Drop(1)
    _ = _in0
...
func (_static *CompanionStruct_Default___) GetCommandLen(opts _dafny.Sequence, max _dafny.Int) _dafny.Int {
  ...
  if ((_dafny.IntOfUint32((opts).Cardinality())).Sign() == 0) {
    ...
    var _0_x _dafny.Int = (func () _dafny.Int { if ((opts).Select(0).(Param)).Is_Command() { return _dafny.IntOfUint32(((((opts).Select(0).(Param)).Dtor_options()).Dtor_name()).Cardinality()) }; return _dafny.Zero })() 
    _ = _0_x
    var _1_newMax _dafny.Int = (func () _dafny.Int { if (_0_x).Cmp(max) > 0 { return _0_x }; return max })() 
    _ = _1_newMax
    var _in0 _dafny.Sequence = (opts).Drop(1)
...
func (_ CompanionStruct_Tri_) AllSingletonConstructors() _dafny.Iterator {
  ...
  return func() (interface{}, bool) {
    i++
    switch i {
      case 0: return Companion_Tri_.Create_Yes_(), true
      case 1: return Companion_Tri_.Create_No_(), true
      case 2: return Companion_Tri_.Create_Maybe_(), true
...
func (_ CompanionStruct_Visibility_) AllSingletonConstructors() _dafny.Iterator {
  ...
  return func() (interface{}, bool) {
    i++
    switch i {
      case 0: return Companion_Visibility_.Create_Normal_(), true
      case 1: return Companion_Visibility_.Create_Hidden_(), true
      case 2: return Companion_Visibility_.Create_Deprecated_(), true
      default: return Visibility{}, false
    }
  }
}
...
func (_this Param) Dtor_name() _dafny.Sequence {
  switch data := _this.Get_().(type) {
    case Param_Opt: return data.Name
    default: return data.(Param_Flag).Name
  }
}

func (_this Param) Dtor_help() _dafny.Sequence {
  switch data := _this.Get_().(type) {
    case Param_Opt: return data.Help
    default: return data.(Param_Flag).Help
  }
}
...
func (_this Param) Dtor_short() _dafny.Char {
  switch data := _this.Get_().(type) {
    case Param_Opt: return data.Short
    default: return data.(Param_Flag).Short
  }
}
...
func (_this Param) Dtor_inherit() bool {
  switch data := _this.Get_().(type) {
    case Param_Opt: return data.Inherit
    default: return data.(Param_Flag).Inherit
  }
}

func (_this Param) Dtor_vis() Visibility {
  switch data := _this.Get_().(type) {
    case Param_Opt: return data.Vis
    default: return data.(Param_Flag).Vis
  }
}

func (_this Param) Dtor_shortAlias() _dafny.Sequence {
  switch data := _this.Get_().(type) {
    case Param_Opt: return data.ShortAlias
    default: return data.(Param_Flag).ShortAlias
  }
}

func (_this Param) Dtor_longAlias() _dafny.Sequence {
  switch data := _this.Get_().(type) {
    case Param_Opt: return data.LongAlias
    default: return data.(Param_Flag).LongAlias
  }
}
