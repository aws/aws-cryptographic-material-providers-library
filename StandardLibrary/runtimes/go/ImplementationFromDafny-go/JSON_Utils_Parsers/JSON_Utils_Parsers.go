...
func (CompanionStruct_Parser___) Default(_default_T interface{}) Parser__ {
  return Companion_Parser___.Create_Parser_(func (m_JSON_Utils_Cursors.Cursor__) m_Wrappers.Result { return m_Wrappers.Companion_Result_.Default(m_JSON_Utils_Cursors.Companion_Split_.Default(_default_T)); })
}
