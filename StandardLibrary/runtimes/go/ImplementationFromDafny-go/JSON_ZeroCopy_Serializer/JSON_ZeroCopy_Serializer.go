...
func (_static *CompanionStruct_Default___) Number(num m_JSON_Grammar.Jnumber, writer m_JSON_Utils_Views_Writers.Writer__) m_JSON_Utils_Views_Writers.Writer__ {
  ...
  _ = _0_wr
  var _1_wr m_JSON_Utils_Views_Writers.Writer__ = (func () m_JSON_Utils_Views_Writers.Writer__ { if ((num).Dtor_frac()).Is_NonEmpty() { return ((_0_wr).Append((((num).Dtor_frac()).Dtor_t().(m_JSON_Grammar.Jfrac)).Dtor_period())).Append((((num).Dtor_frac()).Dtor_t().(m_JSON_Grammar.Jfrac)).Dtor_num()) }; return _0_wr })() 
  _ = _1_wr
  var _2_wr m_JSON_Utils_Views_Writers.Writer__ = (func () m_JSON_Utils_Views_Writers.Writer__ { if ((num).Dtor_exp()).Is_NonEmpty() { return (((_1_wr).Append((((num).Dtor_exp()).Dtor_t().(m_JSON_Grammar.Jexp)).Dtor_e())).Append((((num).Dtor_exp()).Dtor_t().(m_JSON_Grammar.Jexp)).Dtor_sign())).Append((((num).Dtor_exp()).Dtor_t().(m_JSON_Grammar.Jexp)).Dtor_num()) }; return _1_wr })() 
  _ = _2_wr
  return _2_wr
}
...
func (_static *CompanionStruct_Default___) Member(m m_JSON_Grammar.Suffixed, writer m_JSON_Utils_Views_Writers.Writer__) m_JSON_Utils_Views_Writers.Writer__ {
  ...
  _ = _2_wr
  var _3_wr m_JSON_Utils_Views_Writers.Writer__ = (func () m_JSON_Utils_Views_Writers.Writer__ { if ((m).Dtor_suffix()).Is_Empty() { return _2_wr }; return Companion_Default___.StructuralView(((m).Dtor_suffix()).Dtor_t().(m_JSON_Grammar.Structural), _2_wr) })() 
  _ = _3_wr
  return _3_wr
}
func (_static *CompanionStruct_Default___) Item(m m_JSON_Grammar.Suffixed, writer m_JSON_Utils_Views_Writers.Writer__) m_JSON_Utils_Views_Writers.Writer__ {
  ...
  _ = _0_wr
  var _1_wr m_JSON_Utils_Views_Writers.Writer__ = (func () m_JSON_Utils_Views_Writers.Writer__ { if ((m).Dtor_suffix()).Is_Empty() { return _0_wr }; return Companion_Default___.StructuralView(((m).Dtor_suffix()).Dtor_t().(m_JSON_Grammar.Structural), _0_wr) })() 
  _ = _1_wr
  return _1_wr
}
