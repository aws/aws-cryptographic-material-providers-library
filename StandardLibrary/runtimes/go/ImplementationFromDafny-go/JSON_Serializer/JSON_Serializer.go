...
func (_static *CompanionStruct_Default___) Bool(b bool) m_JSON_Utils_Views_Core.View__ {
  return m_JSON_Utils_Views_Core.Companion_View___.OfBytes((func () _dafny.Sequence { if b { return m_JSON_Grammar.Companion_Default___.TRUE() }; return m_JSON_Grammar.Companion_Default___.FALSE() })() )
}
...
func (_static *CompanionStruct_Default___) Sign(n _dafny.Int) m_JSON_Utils_Views_Core.View__ {
  return m_JSON_Utils_Views_Core.Companion_View___.OfBytes((func () _dafny.Sequence { if (n).Sign() == -1 { return _dafny.SeqOf(uint8(_dafny.Char('-'))) }; return _dafny.SeqOf() })() )
}
...
func (_static *CompanionStruct_Default___) Number(dec m_JSON_Values.Decimal) m_Wrappers.Result {
  ...
  if ((_1_valueOrError0).IsFailure()) {
    ...
    _ = _3_frac
    var _4_valueOrError1 m_Wrappers.Result = (func () m_Wrappers.Result { if ((dec).Dtor_e10()).Sign() == 0 { return m_Wrappers.Companion_Result_.Create_Success_(m_JSON_Grammar.Companion_Maybe_.Create_Empty_()) }; return func (_pat_let6_0 m_JSON_Utils_Views_Core.View__) m_Wrappers.Result {
          ...
          return func (_6_sign m_JSON_Utils_Views_Core.View__) m_Wrappers.Result {
            return func (_pat_let8_0 m_Wrappers.Result) m_Wrappers.Result {
              return func (_7_valueOrError2 m_Wrappers.Result) m_Wrappers.Result {
                return (func () m_Wrappers.Result { if (_7_valueOrError2).IsFailure() { return (_7_valueOrError2).PropagateFailure() }; return func (_pat_let9_0 m_JSON_Utils_Views_Core.View__) m_Wrappers.Result {
