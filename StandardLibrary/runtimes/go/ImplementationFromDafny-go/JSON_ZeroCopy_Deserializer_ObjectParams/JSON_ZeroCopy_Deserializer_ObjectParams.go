// Package JSON_ZeroCopy_Deserializer_ObjectParams
// Dafny module JSON_ZeroCopy_Deserializer_ObjectParams compiled into Go
...
func (*Default__) String() string {
	return "JSON_ZeroCopy_Deserializer_ObjectParams.Default__"
}
...
func (_static *CompanionStruct_Default___) Colon(cs m_JSON_Utils_Cursors.Cursor__) m_Wrappers.Result {
...
func (_static *CompanionStruct_Default___) KeyValueFromParts(k m_JSON_Utils_Cursors.Split, colon m_JSON_Utils_Cursors.Split, v m_JSON_Utils_Cursors.Split) m_JSON_Utils_Cursors.Split {
	var _0_sp m_JSON_Utils_Cursors.Split = m_JSON_Utils_Cursors.Companion_Split_.Create_SP_(m_JSON_Grammar.Companion_JKeyValue_.Create_KeyValue_((k).Dtor_t().(m_JSON_Grammar.Jstring), (colon).Dtor_t().(m_JSON_Grammar.Structural), (v).Dtor_t().(m_JSON_Grammar.Value)), (v).Dtor_cs())
	_ = _0_sp
	return _0_sp
}
func (_static *CompanionStruct_Default___) ElementSpec(t m_JSON_Grammar.JKeyValue) _dafny.Sequence {
	return m_JSON_ConcreteSyntax_Spec.Companion_Default___.KeyValue(t)
}
func (_static *CompanionStruct_Default___) Element(cs m_JSON_Utils_Cursors.Cursor__, json m_JSON_Utils_Parsers.SubParser__) m_Wrappers.Result {
	var _0_valueOrError0 m_Wrappers.Result = m_JSON_ZeroCopy_Deserializer_Strings.Companion_Default___.String_(cs)
	_ = _0_valueOrError0
	if (_0_valueOrError0).IsFailure() {
		return (_0_valueOrError0).PropagateFailure()
	} else {
		...
		_ = _2_p
		var _3_valueOrError1 m_Wrappers.Result = m_JSON_ZeroCopy_Deserializer_Core.Companion_Default___.Structural((_1_k).Dtor_cs(), _2_p)
		_ = _3_valueOrError1
		if (_3_valueOrError1).IsFailure() {
			...
			if (_5_valueOrError2).IsFailure() {
				...
				var _6_v m_JSON_Utils_Cursors.Split = (_5_valueOrError2).Extract().(m_JSON_Utils_Cursors.Split)
				_ = _6_v
				var _7_kv m_JSON_Utils_Cursors.Split = Companion_Default___.KeyValueFromParts(_1_k, _4_colon, _6_v)
				_ = _7_kv
				return m_Wrappers.Companion_Result_.Create_Success_(_7_kv)
			}
		}
	}
}
