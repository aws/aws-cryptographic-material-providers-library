...
func (_this DeserializationError) ToString() _dafny.Sequence {
  {
    ...
    }
    {
      if (_source0.Is_ExpectingByte()) {
        ...
        _ = _2_b
        var _3_c _dafny.Sequence = (func () _dafny.Sequence { if (_2_b) > (int16(0)) { return _dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.SeqOfString("'"), _dafny.SeqOfChars(_dafny.Char((_2_b)))), _dafny.SeqOfString("'")) }; return _dafny.SeqOfString("EOF") })() 
        _ = _3_c
    ...
    }
    {
      if (_source0.Is_ExpectingAnyByte()) {
        ...
        _ = _5_b
        var _6_c _dafny.Sequence = (func () _dafny.Sequence { if (_5_b) > (int16(0)) { return _dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.SeqOfString("'"), _dafny.SeqOfChars(_dafny.Char((_5_b)))), _dafny.SeqOfString("'")) }; return _dafny.SeqOfString("EOF") })() 
        _ = _6_c
        var _7_c0s _dafny.Sequence = _dafny.SeqCreate((_dafny.IntOfUint32((_4_bs0).Cardinality())).Uint32(), func (coer35 func (_dafny.Int) _dafny.Char) func (_dafny.Int) interface{} {
