// Package JSON_Deserializer_ByteStrConversion
// Dafny module JSON_Deserializer_ByteStrConversion compiled into Go
...
func (*Default__) String() string {
	return "JSON_Deserializer_ByteStrConversion.Default__"
}
