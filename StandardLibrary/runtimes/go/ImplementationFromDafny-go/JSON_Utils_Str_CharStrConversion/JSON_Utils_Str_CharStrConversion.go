// Package JSON_Utils_Str_CharStrConversion
// Dafny module JSON_Utils_Str_CharStrConversion compiled into Go
...
func (*Default__) String() string {
	return "JSON_Utils_Str_CharStrConversion.Default__"
}
...
func (_static *CompanionStruct_Default___) OfNat__any(n _dafny.Int, chars _dafny.Sequence) _dafny.Sequence {
	...
	_ = _0_base
	if (n).Sign() == 0 {
		return _dafny.SeqOfChars((chars).Select(0).(_dafny.Char))
	} else {
		return Companion_Default___.OfDigits(Companion_Default___.Digits(n, _0_base), chars)
	}
}
func (_static *CompanionStruct_Default___) NumberStr(str _dafny.Sequence, minus _dafny.Char, is__digit func(_dafny.Char) bool) bool {
	return !(!_dafny.Companion_Sequence_.Equal(str, _dafny.SeqOfChars())) || (((((str).Select(0).(_dafny.Char)) == (minus)) || ((is__digit)((str).Select(0).(_dafny.Char)))) && (_dafny.Quantifier(((str).Drop(1)).UniqueElements(), true, func(_forall_var_0 _dafny.Char) bool {
		var _0_c _dafny.Char
		_0_c = interface{}(_forall_var_0).(_dafny.Char)
		return !(_dafny.Companion_Sequence_.Contains((str).Drop(1), _0_c)) || ((is__digit)(_0_c))
	})))
}
func (_static *CompanionStruct_Default___) OfInt__any(n _dafny.Int, chars _dafny.Sequence, minus _dafny.Char) _dafny.Sequence {
	if (n).Sign() != -1 {
		return Companion_Default___.OfNat__any(n, chars)
	} else {
		return _dafny.Companion_Sequence_.Concatenate(_dafny.SeqOfChars(minus), Companion_Default___.OfNat__any((_dafny.Zero).Minus(n), chars))
	}
}
func (_static *CompanionStruct_Default___) ToNat__any(str _dafny.Sequence, base _dafny.Int, digits _dafny.Map) _dafny.Int {
	if _dafny.Companion_Sequence_.Equal(str, _dafny.SeqOfChars()) {
		...
		return ((Companion_Default___.ToNat__any((str).Take(((_dafny.IntOfUint32((str).Cardinality())).Minus(_dafny.One)).Uint32()), base, digits)).Times(base)).Plus((digits).Get((str).Select(((_dafny.IntOfUint32((str).Cardinality())).Minus(_dafny.One)).Uint32()).(_dafny.Char)).(_dafny.Int))
	}
}
func (_static *CompanionStruct_Default___) ToInt__any(str _dafny.Sequence, minus _dafny.Char, base _dafny.Int, digits _dafny.Map) _dafny.Int {
	if _dafny.Companion_Sequence_.IsPrefixOf(_dafny.SeqOfChars(minus), str) {
