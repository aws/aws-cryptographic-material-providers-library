...
func (_this CursorError) ToString(pr func (interface{}) _dafny.Sequence) _dafny.Sequence {
  {
    ...
    }
    {
      if (_source0.Is_ExpectingByte()) {
        ...
        _ = _1_b
        var _2_c _dafny.Sequence = (func () _dafny.Sequence { if (_1_b) > (int16(0)) { return _dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.SeqOfString("'"), _dafny.SeqOfChars(_dafny.Char((_1_b)))), _dafny.SeqOfString("'")) }; return _dafny.SeqOfString("EOF") })() 
        _ = _2_c
    ...
    }
    {
      if (_source0.Is_ExpectingAnyByte()) {
        ...
        _ = _4_b
        var _5_c _dafny.Sequence = (func () _dafny.Sequence { if (_4_b) > (int16(0)) { return _dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.SeqOfString("'"), _dafny.SeqOfChars(_dafny.Char((_4_b)))), _dafny.SeqOfString("'")) }; return _dafny.SeqOfString("EOF") })() 
        _ = _5_c
