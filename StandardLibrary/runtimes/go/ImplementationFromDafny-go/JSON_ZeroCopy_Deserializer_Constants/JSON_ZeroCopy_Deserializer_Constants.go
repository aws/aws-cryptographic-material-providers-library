// Package JSON_ZeroCopy_Deserializer_Constants
// Dafny module JSON_ZeroCopy_Deserializer_Constants compiled into Go
...
func (*Default__) String() string {
	return "JSON_ZeroCopy_Deserializer_Constants.Default__"
}
...
func (_static *CompanionStruct_Default___) Constant(cs m_JSON_Utils_Cursors.Cursor__, expected _dafny.Sequence) m_Wrappers.Result {
	var _0_valueOrError0 m_Wrappers.Result = (cs).AssertBytes(expected, uint32(0))
	_ = _0_valueOrError0
