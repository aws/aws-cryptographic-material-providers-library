// Package Sets
// Dafny module Sets compiled into Go
...
func (_static *CompanionStruct_Default___) Map(xs _dafny.Set, f func(interface{}) interface{}) _dafny.Set {
...
func (_static *CompanionStruct_Default___) Filter(xs _dafny.Set, f func(interface{}) bool) _dafny.Set {
	var _0_ys _dafny.Set = func() _dafny.Set {
		var _coll0 = _dafny.NewBuilder()
		_ = _coll0
