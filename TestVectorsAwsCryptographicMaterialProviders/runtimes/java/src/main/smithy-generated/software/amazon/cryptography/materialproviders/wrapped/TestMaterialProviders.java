...
import software.amazon.cryptography.materialproviders.internaldafny.types.ClientSupplier;
...
import software.amazon.cryptography.materialproviders.internaldafny.types.CryptographicMaterialsCache;
import software.amazon.cryptography.materialproviders.internaldafny.types.CryptographicMaterialsManager;
...
import software.amazon.cryptography.materialproviders.internaldafny.types.Keyring;
...
public class TestMaterialProviders implements IAwsCryptographicMaterialProvidersClient {
  ...
  public Result<IKeyring, Error> CreateAwsKmsDiscoveryKeyring(
    ...
    try {
      ...
      return Result.create_Success(Keyring._typeDescriptor(), Error._typeDescriptor(), dafnyOutput);
    } catch (RuntimeException ex) {
      return Result.create_Failure(Keyring._typeDescriptor(), Error._typeDescriptor(), ToDafny.Error(ex));
    }
  }
  ...
  public Result<ICryptographicMaterialsCache, Error> CreateCryptographicMaterialsCache(
    ...
    try {
      ...
      return Result.create_Success(CryptographicMaterialsCache._typeDescriptor(), Error._typeDescriptor(), dafnyOutput);
    } catch (RuntimeException ex) {
      return Result.create_Failure(CryptographicMaterialsCache._typeDescriptor(), Error._typeDescriptor(), ToDafny.Error(ex));
    }
  }
  ...
  public Result<IClientSupplier, Error> CreateDefaultClientSupplier(
    ...
    try {
      ...
      return Result.create_Success(ClientSupplier._typeDescriptor(), Error._typeDescriptor(), dafnyOutput);
    } catch (RuntimeException ex) {
      return Result.create_Failure(ClientSupplier._typeDescriptor(), Error._typeDescriptor(), ToDafny.Error(ex));
    }
  }
  ...
  public Result<ICryptographicMaterialsManager, Error> CreateDefaultCryptographicMaterialsManager(
    ...
    try {
      ...
      return Result.create_Success(CryptographicMaterialsManager._typeDescriptor(), Error._typeDescriptor(), dafnyOutput);
    } catch (RuntimeException ex) {
      return Result.create_Failure(CryptographicMaterialsManager._typeDescriptor(), Error._typeDescriptor(), ToDafny.Error(ex));
    }
  }
  ...
  public Result<AlgorithmSuiteInfo, Error> GetAlgorithmSuiteInfo(
    ...
    try {
      ...
      return Result.create_Success(AlgorithmSuiteInfo._typeDescriptor(), Error._typeDescriptor(), dafnyOutput);
    } catch (RuntimeException ex) {
      return Result.create_Failure(AlgorithmSuiteInfo._typeDescriptor(), Error._typeDescriptor(), ToDafny.Error(ex));
    }
  }
  ...
  public Result<GetHKDFProviderOutput, Error> GetHKDFProvider(GetHKDFProviderInput dafnyInput) {
    ...
    try {
      ...
      return Result.create_Success(GetHKDFProviderOutput._typeDescriptor(), Error._typeDescriptor(), dafnyOutput);
    } catch (RuntimeException ex) {
      return Result.create_Failure(GetHKDFProviderOutput._typeDescriptor(), Error._typeDescriptor(), ToDafny.Error(ex));
    }
  }
  ...
  public Result<DecryptionMaterials, Error> InitializeDecryptionMaterials(
    ...
    try {
      ...
      return Result.create_Success(DecryptionMaterials._typeDescriptor(), Error._typeDescriptor(), dafnyOutput);
    } catch (RuntimeException ex) {
      return Result.create_Failure(DecryptionMaterials._typeDescriptor(), Error._typeDescriptor(), ToDafny.Error(ex));
    }
  }
  ...
  public Result<EncryptionMaterials, Error> InitializeEncryptionMaterials(
    ...
    try {
      ...
      return Result.create_Success(EncryptionMaterials._typeDescriptor(), Error._typeDescriptor(), dafnyOutput);
    } catch (RuntimeException ex) {
      return Result.create_Failure(EncryptionMaterials._typeDescriptor(), Error._typeDescriptor(), ToDafny.Error(ex));
    }
  }
