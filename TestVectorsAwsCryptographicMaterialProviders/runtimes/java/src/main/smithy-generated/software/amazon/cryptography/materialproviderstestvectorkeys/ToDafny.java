...
public class ToDafny {
  ...
  public static KmsMrkAwareDiscovery KmsMrkAwareDiscovery(
    ...
    awsKmsDiscoveryFilter = Objects.nonNull(nativeValue.awsKmsDiscoveryFilter()) ?
        Option.create_Some(DiscoveryFilter._typeDescriptor(), software.amazon.cryptography.materialproviders.ToDafny.DiscoveryFilter(nativeValue.awsKmsDiscoveryFilter()))
