...
public abstract class Error {
  ...
  private static final Error theDefault = Error.create_KeyVectorException(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR));
  public static Error Default() {
    return theDefault;
  }
  public static Error create_KeyVectorException(dafny.DafnySequence<? extends Character> message) {
  ...
  public boolean is_KeyVectorException() { return this instanceof Error_KeyVectorException; }
  ...
  public dafny.DafnySequence<? extends Character> dtor_message() {
    Error d = this;
    if (d instanceof Error_KeyVectorException) { return ((Error_KeyVectorException)d)._message; }
