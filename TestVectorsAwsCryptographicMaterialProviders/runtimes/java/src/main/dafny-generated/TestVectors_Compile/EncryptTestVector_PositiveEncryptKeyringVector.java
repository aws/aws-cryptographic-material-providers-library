// Class EncryptTestVector_PositiveEncryptKeyringVector
// Dafny class EncryptTestVector_PositiveEncryptKeyringVector compiled into Java
package TestVectors_Compile;

@SuppressWarnings({"unchecked", "deprecation"})
public class EncryptTestVector_PositiveEncryptKeyringVector extends EncryptTestVector {
  ...
  public boolean equals(Object other) {
    ...
    EncryptTestVector_PositiveEncryptKeyringVector o = (EncryptTestVector_PositiveEncryptKeyringVector)other;
    return true && java.util.Objects.equals(this._name, o._name) && java.util.Objects.equals(this._description, o._description) && java.util.Objects.equals(this._encryptionContext, o._encryptionContext) && java.util.Objects.equals(this._commitmentPolicy, o._commitmentPolicy) && java.util.Objects.equals(this._algorithmSuite, o._algorithmSuite) && java.util.Objects.equals(this._maxPlaintextLength, o._maxPlaintextLength) && java.util.Objects.equals(this._requiredEncryptionContextKeys, o._requiredEncryptionContextKeys) && java.util.Objects.equals(this._encryptDescription, o._encryptDescription) && java.util.Objects.equals(this._decryptDescription, o._decryptDescription) && java.util.Objects.equals(this._reproducedEncryptionContext, o._reproducedEncryptionContext);
  }
  @Override
  public int hashCode() {
    long hash = 5381;
  ...
  public String toString() {
    ...
    s.append("TestVectors.EncryptTestVector.PositiveEncryptKeyringVector");
    s.append("(");
