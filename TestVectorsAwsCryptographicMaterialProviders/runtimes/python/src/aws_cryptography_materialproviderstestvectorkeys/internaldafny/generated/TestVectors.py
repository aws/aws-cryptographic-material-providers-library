...
class default__:
    ...
    def ToEncryptTest(keys, vector):
        ...
        out73_ = (keys).CreateWappedTestVectorKeyring(software_amazon_cryptography_materialproviderstestvectorkeys_internaldafny_types.TestVectorKeyringInput_TestVectorKeyringInput(((vector).encryptDescription if (vector).is_PositiveEncryptKeyringVector else (vector).keyDescription)))
    ...
    def ToDecryptTest(keys, test, materials):
        ...
        out76_ = (keys).CreateWappedTestVectorKeyring(software_amazon_cryptography_materialproviderstestvectorkeys_internaldafny_types.TestVectorKeyringInput_TestVectorKeyringInput((d_553_vector_).keyDescription))
