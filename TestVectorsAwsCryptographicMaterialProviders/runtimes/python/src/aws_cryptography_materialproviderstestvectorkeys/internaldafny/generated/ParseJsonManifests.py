                                        ...
                                        if (d_608_typ_) == (_dafny.Seq("positive-keyring")):
                                                ...
                                                if (d_630_valueOrError9_).IsFailure():
                                                    ...
                                                    if (d_632_valueOrError10_).IsFailure():
                                                        ...
                                                        if (d_635_valueOrError11_).IsFailure():
                                                            ...
                                                            d_638_valueOrError12_ = ((keys).GetKeyDescription(software_amazon_cryptography_materialproviderstestvectorkeys_internaldafny_types.GetKeyDescriptionInput_GetKeyDescriptionInput(d_634_encryptStr_))).MapFailure(default__.ErrorToString)
                                                            if (d_638_valueOrError12_).IsFailure():
                                                                ...
                                                                d_640_valueOrError13_ = ((keys).GetKeyDescription(software_amazon_cryptography_materialproviderstestvectorkeys_internaldafny_types.GetKeyDescriptionInput_GetKeyDescriptionInput(d_637_decryptStr_))).MapFailure(default__.ErrorToString)
                                            ...
                                            if (d_642_valueOrError14_).IsFailure():
                                                ...
                                                if (d_644_valueOrError15_).IsFailure():
                                                    ...
                                                    d_647_valueOrError16_ = ((keys).GetKeyDescription(software_amazon_cryptography_materialproviderstestvectorkeys_internaldafny_types.GetKeyDescriptionInput_GetKeyDescriptionInput(d_646_keyStr_))).MapFailure(default__.ErrorToString)
