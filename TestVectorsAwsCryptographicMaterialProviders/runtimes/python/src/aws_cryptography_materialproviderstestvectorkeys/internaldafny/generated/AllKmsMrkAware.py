...
# Module: aws_cryptography_materialproviderstestvectorkeys.internaldafny.generated.AllKmsMrkAware
        ...
        def iife26_():
            ...
            for compr_14_ in (default__.AllAwsKMSMrkKeys).Elements:
                ...
                if (d_682_key_) in (default__.AllAwsKMSMrkKeys):
                    coll10_ = coll10_.union(_dafny.Set([AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription_KmsMrk(AwsCryptographyMaterialProvidersTestVectorKeysTypes.KmsMrkAware_KmsMrkAware(d_682_key_))]))
    ...
    def Tests(instance):
        def iife27_():
            ...
            for compr_15_ in (default__.KeyDescriptions).Elements:
                d_683_encryptDescription_: AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription = compr_15_
                ...
                for compr_16_ in (default__.KeyDescriptions).Elements:
                    d_684_decryptDescription_: AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription = compr_16_
                    ...
                    for compr_17_ in (AllAlgorithmSuites.default__.AllAlgorithmSuites).Elements:
                        d_685_algorithmSuite_: AwsCryptographyMaterialProvidersTypes.AlgorithmSuiteInfo = compr_17_
                        ...
                        for compr_18_ in [AllAlgorithmSuites.default__.GetCompatibleCommitmentPolicy(d_685_algorithmSuite_)]:
                            d_686_commitmentPolicy_: AwsCryptographyMaterialProvidersTypes.CommitmentPolicy = compr_18_
