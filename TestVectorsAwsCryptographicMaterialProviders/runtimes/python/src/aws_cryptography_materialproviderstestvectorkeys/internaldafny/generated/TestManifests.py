...
class default__:
    ...
    def StartEncrypt(encryptManifestPath, keysManifiestPath):
        ...
        d_680_encryptManifestJSON_: JSON_Values.JSON
        d_681_valueOrError1_: Wrappers.Result = Wrappers.Result.default(JSON_Values.JSON.default())()
        d_681_valueOrError1_ = JSON_API.default__.Deserialize(d_679_encryptManifestBytes_)
        ...
        d_682_keys_: software_amazon_cryptography_materialproviderstestvectorkeys_internaldafny_types.IKeyVectorsClient
        d_683_valueOrError2_: Wrappers.Result = None
        out81_: Wrappers.Result
        out81_ = software_amazon_cryptography_materialproviderstestvectorkeys_internaldafny.default__.KeyVectors(software_amazon_cryptography_materialproviderstestvectorkeys_internaldafny_types.KeyVectorsConfig_KeyVectorsConfig(keysManifiestPath))
