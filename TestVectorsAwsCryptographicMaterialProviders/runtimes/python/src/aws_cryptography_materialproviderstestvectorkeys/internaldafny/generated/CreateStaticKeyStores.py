...
# Module: aws_cryptography_materialproviderstestvectorkeys.internaldafny.generated.CreateStaticKeyStores
...
class default__:
    ...
    def CreateStaticKeyStore(staticKeyMaterial):
        keyStore: AwsCryptographyKeyStoreTypes.IKeyStoreClient = None
        nw1_ = StaticKeyStore()
...
class StaticKeyStore(AwsCryptographyKeyStoreTypes.IKeyStoreClient):
    def  __init__(self):
    ...
    def GetActiveBranchKey(self, input):
        ...
        output = Wrappers.Result_Success(AwsCryptographyKeyStoreTypes.GetActiveBranchKeyOutput_GetActiveBranchKeyOutput(AwsCryptographyKeyStoreTypes.BranchKeyMaterials_BranchKeyMaterials((input).branchKeyIdentifier, ((self).staticKeyMaterial).branchKeyVersion, _dafny.Map({}), ((self).staticKeyMaterial).branchKey)))
        return output
    ...
    def GetBranchKeyVersion(self, input):
        ...
        output = Wrappers.Result_Success(AwsCryptographyKeyStoreTypes.GetBranchKeyVersionOutput_GetBranchKeyVersionOutput(AwsCryptographyKeyStoreTypes.BranchKeyMaterials_BranchKeyMaterials((input).branchKeyIdentifier, ((self).staticKeyMaterial).branchKeyVersion, _dafny.Map({}), ((self).staticKeyMaterial).branchKey)))
        return output
    ...
    def GetBeaconKey(self, input):
        ...
        output = Wrappers.Result_Success(AwsCryptographyKeyStoreTypes.GetBeaconKeyOutput_GetBeaconKeyOutput(AwsCryptographyKeyStoreTypes.BeaconKeyMaterials_BeaconKeyMaterials((input).branchKeyIdentifier, _dafny.Map({}), Wrappers.Option_Some(((self).staticKeyMaterial).beaconKey), Wrappers.Option_None())))
        return output
