...
from smithygenerated.aws_cryptography_materialproviderstestvectorkeys.deserialize import (
...
from smithygenerated.aws_cryptography_materialproviderstestvectorkeys.errors import (
    ServiceError,
)
...
from smithygenerated.aws_cryptography_materialproviderstestvectorkeys.serialize import (
...
class KeyVectors:
    ...
    def create_test_vector_keyring(self, input: TestVectorKeyringInput) -> CreateKeyringOutput:
    ...
    def create_wapped_test_vector_keyring(self, input: TestVectorKeyringInput) -> CreateKeyringOutput:
