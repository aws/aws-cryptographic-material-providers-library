...
from smithygenerated.aws_cryptography_materialproviders.models import (
    CreateKeyringOutput,
...
from smithygenerated.aws_cryptography_materialproviderstestvectorkeys.models import (
...
def dafny_config_to_smithy_config(dafny_config) -> KeyVectorsConfig:
    ...
    '''
    return smithygenerated.aws_cryptography_materialproviderstestvectorkeys.dafny_to_smithy.DafnyToSmithy_aws_cryptography_materialproviderstestvectorkeys_KeyVectorsConfig(dafny_config)
...
def smithy_config_to_dafny_config(smithy_config) -> DafnyKeyVectorsConfig:
    ...
    '''
    return smithygenerated.aws_cryptography_materialproviderstestvectorkeys.smithy_to_dafny.SmithyToDafny_aws_cryptography_materialproviderstestvectorkeys_KeyVectorsConfig(smithy_config)
