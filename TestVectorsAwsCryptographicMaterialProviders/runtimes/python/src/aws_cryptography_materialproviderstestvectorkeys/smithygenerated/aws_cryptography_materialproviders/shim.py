...
def _smithy_error_to_dafny_error(e: ServiceError):
       ...
       if isinstance(e, ComAmazonawsDynamodb):
           return software_amazon_cryptography_materialproviders_internaldafny_types.Error_ComAmazonawsDynamodb(com_amazonaws_dynamodb_sdk_error_to_dafny_error(e.message))

       if isinstance(e, ComAmazonawsKms):
           return software_amazon_cryptography_materialproviders_internaldafny_types.Error_ComAmazonawsKms(com_amazonaws_kms_sdk_error_to_dafny_error(e.message))
