...
def aws_cryptography_materialproviderstestvectorkeys_KeyDescription(native_input):
    if isinstance(
        ...
        native_input,
        aws_cryptography_materialproviderstestvectorkeys.smithygenerated.aws_cryptography_materialproviderstestvectorkeys.models.KeyDescriptionECDH,
    ):
        KeyDescription_union_value = KeyDescription_ECDH(
            aws_cryptography_materialproviderstestvectorkeys.smithygenerated.aws_cryptography_materialproviderstestvectorkeys.smithy_to_dafny.aws_cryptography_materialproviderstestvectorkeys_RawEcdh(
                native_input.value
            )
        )
    elif isinstance(
        ...
        native_input,
        aws_cryptography_materialproviderstestvectorkeys.smithygenerated.aws_cryptography_materialproviderstestvectorkeys.models.KeyDescriptionKmsECDH,
    ):
        KeyDescription_union_value = KeyDescription_KmsECDH(
            aws_cryptography_materialproviderstestvectorkeys.smithygenerated.aws_cryptography_materialproviderstestvectorkeys.smithy_to_dafny.aws_cryptography_materialproviderstestvectorkeys_KmsEcdhKeyring(
                native_input.value
            )
        )
    elif isinstance(
