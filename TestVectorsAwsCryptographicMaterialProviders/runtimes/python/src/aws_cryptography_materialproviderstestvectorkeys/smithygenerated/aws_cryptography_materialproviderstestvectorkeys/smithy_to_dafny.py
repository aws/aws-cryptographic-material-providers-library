...
def aws_cryptography_materialproviderstestvectorkeys_TestVectorKeyringInput(native_input):
    return DafnyTestVectorKeyringInput(
        keyDescription=aws_cryptography_materialproviderstestvectorkeys.smithygenerated.aws_cryptography_materialproviderstestvectorkeys.smithy_to_dafny.aws_cryptography_materialproviderstestvectorkeys_KeyDescription(native_input.key_description),
    )

def aws_cryptography_materialproviderstestvectorkeys_KeyDescription(native_input):
    if isinstance(native_input, aws_cryptography_materialproviderstestvectorkeys.smithygenerated.aws_cryptography_materialproviderstestvectorkeys.models.KeyDescriptionKms):
        KeyDescription_union_value = KeyDescription_Kms(aws_cryptography_materialproviderstestvectorkeys.smithygenerated.aws_cryptography_materialproviderstestvectorkeys.smithy_to_dafny.aws_cryptography_materialproviderstestvectorkeys_KMSInfo(native_input.value))
    elif isinstance(native_input, aws_cryptography_materialproviderstestvectorkeys.smithygenerated.aws_cryptography_materialproviderstestvectorkeys.models.KeyDescriptionKmsMrk):
        KeyDescription_union_value = KeyDescription_KmsMrk(aws_cryptography_materialproviderstestvectorkeys.smithygenerated.aws_cryptography_materialproviderstestvectorkeys.smithy_to_dafny.aws_cryptography_materialproviderstestvectorkeys_KmsMrkAware(native_input.value))
    elif isinstance(native_input, aws_cryptography_materialproviderstestvectorkeys.smithygenerated.aws_cryptography_materialproviderstestvectorkeys.models.KeyDescriptionKmsMrkDiscovery):
        KeyDescription_union_value = KeyDescription_KmsMrkDiscovery(aws_cryptography_materialproviderstestvectorkeys.smithygenerated.aws_cryptography_materialproviderstestvectorkeys.smithy_to_dafny.aws_cryptography_materialproviderstestvectorkeys_KmsMrkAwareDiscovery(native_input.value))
    elif isinstance(native_input, aws_cryptography_materialproviderstestvectorkeys.smithygenerated.aws_cryptography_materialproviderstestvectorkeys.models.KeyDescriptionRSA):
        ...
        KeyDescription_union_value = KeyDescription_Multi(aws_cryptography_materialproviderstestvectorkeys.smithygenerated.aws_cryptography_materialproviderstestvectorkeys.smithy_to_dafny.aws_cryptography_materialproviderstestvectorkeys_MultiKeyring(native_input.value))
    elif isinstance(native_input, aws_cryptography_materialproviderstestvectorkeys.smithygenerated.aws_cryptography_materialproviderstestvectorkeys.models.KeyDescriptionRequiredEncryptionContext):
        KeyDescription_union_value = KeyDescription_RequiredEncryptionContext(aws_cryptography_materialproviderstestvectorkeys.smithygenerated.aws_cryptography_materialproviderstestvectorkeys.smithy_to_dafny.aws_cryptography_materialproviderstestvectorkeys_RequiredEncryptionContextCMM(native_input.value))
    else:
...
def aws_cryptography_materialproviderstestvectorkeys_KmsMrkAwareDiscovery(native_input):
    return DafnyKmsMrkAwareDiscovery(
        ...
        awsKmsDiscoveryFilter=((Option_Some(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_DiscoveryFilter(native_input.aws_kms_discovery_filter))) if (native_input.aws_kms_discovery_filter is not None) else (Option_None())),
    )
...
def aws_cryptography_materialproviderstestvectorkeys_RawRSA(native_input):
    return DafnyRawRSA(
        ...
        padding=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_PaddingScheme(native_input.padding),
    )
...
def aws_cryptography_materialproviderstestvectorkeys_MultiKeyring(native_input):
    return DafnyMultiKeyring(
        generator=((Option_Some(aws_cryptography_materialproviderstestvectorkeys.smithygenerated.aws_cryptography_materialproviderstestvectorkeys.smithy_to_dafny.aws_cryptography_materialproviderstestvectorkeys_KeyDescription(native_input.generator))) if (native_input.generator is not None) else (Option_None())),
        childKeyrings=Seq([aws_cryptography_materialproviderstestvectorkeys.smithygenerated.aws_cryptography_materialproviderstestvectorkeys.smithy_to_dafny.aws_cryptography_materialproviderstestvectorkeys_KeyDescription(list_element) for list_element in native_input.child_keyrings]),
    )
...
def aws_cryptography_materialproviderstestvectorkeys_RequiredEncryptionContextCMM(native_input):
    return DafnyRequiredEncryptionContextCMM(
        underlying=aws_cryptography_materialproviderstestvectorkeys.smithygenerated.aws_cryptography_materialproviderstestvectorkeys.smithy_to_dafny.aws_cryptography_materialproviderstestvectorkeys_KeyDescription(native_input.underlying),
...
def aws_cryptography_materialproviderstestvectorkeys_TestVectorCmmInput(native_input):
    return DafnyTestVectorCmmInput(
        keyDescription=aws_cryptography_materialproviderstestvectorkeys.smithygenerated.aws_cryptography_materialproviderstestvectorkeys.smithy_to_dafny.aws_cryptography_materialproviderstestvectorkeys_KeyDescription(native_input.key_description),
        forOperation=aws_cryptography_materialproviderstestvectorkeys.smithygenerated.aws_cryptography_materialproviderstestvectorkeys.smithy_to_dafny.aws_cryptography_materialproviderstestvectorkeys_CmmOperation(native_input.for_operation),
    )
