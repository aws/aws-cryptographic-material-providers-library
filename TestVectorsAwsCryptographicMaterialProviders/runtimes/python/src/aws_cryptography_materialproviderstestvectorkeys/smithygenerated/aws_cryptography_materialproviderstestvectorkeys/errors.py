...
def _smithy_error_to_dafny_error(e: ServiceError):
    ...
    if isinstance(
        ...
        return software_amazon_cryptography_materialproviderstestvectorkeys_internaldafny_types.Error_KeyVectorException(
            message=e.message
        )

    if isinstance(e, CollectionOfErrors):
        return software_amazon_cryptography_materialproviderstestvectorkeys_internaldafny_types.Error_CollectionOfErrors(
            message=e.message, list=e.list
        )

    if isinstance(e, OpaqueError):
        return software_amazon_cryptography_materialproviderstestvectorkeys_internaldafny_types.Error_Opaque(
            obj=e.obj
        )
