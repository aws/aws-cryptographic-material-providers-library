...
def aws_cryptography_materialproviderstestvectorkeys_KeyDescription(dafny_input):
    ...
    if isinstance(dafny_input, KeyDescription_Kms):
        ...
        KeyDescription_union_value = aws_cryptography_materialproviderstestvectorkeys.smithygenerated.aws_cryptography_materialproviderstestvectorkeys.models.KeyDescriptionECDH(
            aws_cryptography_materialproviderstestvectorkeys.smithygenerated.aws_cryptography_materialproviderstestvectorkeys.dafny_to_smithy.aws_cryptography_materialproviderstestvectorkeys_RawEcdh(
                dafny_input.ECDH
            )
        )
        ...
        KeyDescription_union_value = aws_cryptography_materialproviderstestvectorkeys.smithygenerated.aws_cryptography_materialproviderstestvectorkeys.models.KeyDescriptionKmsECDH(
            aws_cryptography_materialproviderstestvectorkeys.smithygenerated.aws_cryptography_materialproviderstestvectorkeys.dafny_to_smithy.aws_cryptography_materialproviderstestvectorkeys_KmsEcdhKeyring(
                dafny_input.KmsECDH
            )
        )
...
def aws_cryptography_materialproviderstestvectorkeys_RawEcdh(dafny_input):
    return aws_cryptography_materialproviderstestvectorkeys.smithygenerated.aws_cryptography_materialproviderstestvectorkeys.models.RawEcdh(
        sender_key_id=dafny_input.senderKeyId.VerbatimString(False),
        recipient_key_id=dafny_input.recipientKeyId.VerbatimString(False),
        sender_public_key=dafny_input.senderPublicKey.VerbatimString(False),
        recipient_public_key=dafny_input.recipientPublicKey.VerbatimString(False),
        provider_id=dafny_input.providerId.VerbatimString(False),
        curve_spec=dafny_input.curveSpec.VerbatimString(False),
        key_agreement_scheme=dafny_input.keyAgreementScheme.VerbatimString(False),
    )
...
def aws_cryptography_materialproviderstestvectorkeys_KmsEcdhKeyring(dafny_input):
    return aws_cryptography_materialproviderstestvectorkeys.smithygenerated.aws_cryptography_materialproviderstestvectorkeys.models.KmsEcdhKeyring(
        sender_key_id=dafny_input.senderKeyId.VerbatimString(False),
        recipient_key_id=dafny_input.recipientKeyId.VerbatimString(False),
        sender_public_key=dafny_input.senderPublicKey.VerbatimString(False),
        recipient_public_key=dafny_input.recipientPublicKey.VerbatimString(False),
