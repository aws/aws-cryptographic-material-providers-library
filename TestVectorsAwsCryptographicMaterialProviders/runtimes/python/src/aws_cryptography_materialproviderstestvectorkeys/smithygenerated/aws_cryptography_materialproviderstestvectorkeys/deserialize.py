...
async def _deserialize_create_test_vector_keyring(input: DafnyResponse, config: Config):
  ...
  return null.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.DafnyToSmithy_aws_cryptography_materialproviders_CreateKeyringOutput(input.value)
...
async def _deserialize_get_key_description(input: DafnyResponse, config: Config):
  ...
  if input.IsFailure():
    return await _deserialize_error(input.error)
  return aws_cryptography_materialproviderstestvectorkeys.smithygenerated.aws_cryptography_materialproviderstestvectorkeys.dafny_to_smithy.DafnyToSmithy_aws_cryptography_materialproviderstestvectorkeys_GetKeyDescriptionOutput(input.value)

async def _deserialize_serialize_key_description(input: DafnyResponse, config: Config):

  if input.IsFailure():
    return await _deserialize_error(input.error)
  return aws_cryptography_materialproviderstestvectorkeys.smithygenerated.aws_cryptography_materialproviderstestvectorkeys.dafny_to_smithy.DafnyToSmithy_aws_cryptography_materialproviderstestvectorkeys_SerializeKeyDescriptionOutput(input.value)
