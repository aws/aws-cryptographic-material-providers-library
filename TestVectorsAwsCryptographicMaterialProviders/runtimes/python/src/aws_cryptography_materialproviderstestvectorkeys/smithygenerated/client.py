...
class KeyVectors:
    ...
    async def create_test_vector_keyring(self, input: TestVectorKeyringInput, plugins: list[Plugin] | None = None):
    ...
    async def create_wapped_test_vector_keyring(self, input: TestVectorKeyringInput, plugins: list[Plugin] | None = None):
    ...
    async def get_key_description(self, input: GetKeyDescriptionInput, plugins: list[Plugin] | None = None):
    ...
    async def serialize_key_description(self, input: SerializeKeyDescriptionInput, plugins: list[Plugin] | None = None):
