...
def dafny_config_to_smithy_config(dafny_config) -> KeyVectorsConfig:
    ...
    '''
    return aws_cryptography_materialproviderstestvectorkeys.smithygenerated.dafny_to_smithy.DafnyToSmithy_aws_cryptography_materialproviderstestvectorkeys_KeyVectorsConfig(dafny_config)
...
def smithy_config_to_dafny_config(smithy_config) -> DafnyKeyVectorsConfig:
    ...
    '''
    return aws_cryptography_materialproviderstestvectorkeys.smithygenerated.smithy_to_dafny.SmithyToDafny_aws_cryptography_materialproviderstestvectorkeys_KeyVectorsConfig(smithy_config)
