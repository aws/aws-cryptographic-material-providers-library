...
class default__:
    ...
    def KeyVectors(config):
        ...
        out0_ = FileIO.default__.ReadBytesFromFile((config).keyManifestPath)
        d_0_valueOrError0_ = out0_
        if not(not((d_0_valueOrError0_).IsFailure())):
            raise _dafny.HaltException("dafny/KeyVectors/src/Index.dfy(30,29): " + _dafny.string_of(d_0_valueOrError0_))
        d_1_keysManifestBytes_: _dafny.Seq
        d_1_keysManifestBytes_ = (d_0_valueOrError0_).Extract()
        d_2_valueOrError1_: Wrappers.Result = Wrappers.Result.default(JSON_Values.JSON.default())()
        def lambda0_(d_3_e_):
            return AwsCryptographyMaterialProvidersTestVectorKeysTypes.Error_KeyVectorException((d_3_e_).ToString())

        d_2_valueOrError1_ = (JSON_API.default__.Deserialize(d_1_keysManifestBytes_)).MapFailure(lambda0_)
        if (d_2_valueOrError1_).IsFailure():
            res = (d_2_valueOrError1_).PropagateFailure()
            return res
        d_4_keysManifestJSON_: JSON_Values.JSON
        d_4_keysManifestJSON_ = (d_2_valueOrError1_).Extract()
        if not((d_4_keysManifestJSON_).is_Object):
            raise _dafny.HaltException("dafny/KeyVectors/src/Index.dfy(35,4): " + _dafny.string_of(_dafny.Seq("expectation violation")))
        d_5_valueOrError2_: Wrappers.Result = Wrappers.Result.default(JSON_Values.JSON.default())()
        d_5_valueOrError2_ = JSONHelpers.default__.Get(_dafny.Seq("keys"), (d_4_keysManifestJSON_).obj)
        if not(not((d_5_valueOrError2_).IsFailure())):
            raise _dafny.HaltException("dafny/KeyVectors/src/Index.dfy(36,22): " + _dafny.string_of(d_5_valueOrError2_))
        d_6_keysObject_: JSON_Values.JSON
        d_6_keysObject_ = (d_5_valueOrError2_).Extract()
        if not((d_6_keysObject_).is_Object):
            raise _dafny.HaltException("dafny/KeyVectors/src/Index.dfy(37,4): " + _dafny.string_of(_dafny.Seq("expectation violation")))
        d_7_maybeMpl_: Wrappers.Result
        ...
        def lambda1_(d_9_e_):
            return AwsCryptographyMaterialProvidersTestVectorKeysTypes.Error_AwsCryptographyMaterialProviders(d_9_e_)

        d_8_valueOrError3_ = (d_7_maybeMpl_).MapFailure(lambda1_)
        if (d_8_valueOrError3_).IsFailure():
            res = (d_8_valueOrError3_).PropagateFailure()
            return res
        d_10_mpl_: MaterialProviders.MaterialProvidersClient
        d_10_mpl_ = (d_8_valueOrError3_).Extract()
        d_11_valueOrError4_: Wrappers.Result = Wrappers.Result.default(_dafny.Map)()
        def lambda2_(d_12_e_):
            return AwsCryptographyMaterialProvidersTestVectorKeysTypes.Error_KeyVectorException(d_12_e_)

        d_11_valueOrError4_ = (KeyMaterial.default__.BuildKeyMaterials(d_10_mpl_, (d_6_keysObject_).obj)).MapFailure(lambda2_)
        if (d_11_valueOrError4_).IsFailure():
            res = (d_11_valueOrError4_).PropagateFailure()
            return res
        d_13_keys_: _dafny.Map
        d_13_keys_ = (d_11_valueOrError4_).Extract()
        d_14_config_: KeysVectorOperations.Config
        d_14_config_ = KeysVectorOperations.Config_Config(d_13_keys_, d_4_keysManifestJSON_)
        d_15_client_: KeyVectorsClient
        nw0_ = KeyVectorsClient()
        nw0_.ctor__(d_14_config_)
        d_15_client_ = nw0_
        res = Wrappers.Result_Success(d_15_client_)
        return res
...
class KeyVectorsClient(AwsCryptographyMaterialProvidersTestVectorKeysTypes.IKeyVectorsClient):
    ...
    def CreateTestVectorKeyring(self, input):
        ...
        out0_: Wrappers.Result
        out0_ = KeysVectorOperations.default__.CreateTestVectorKeyring((self).config, input)
        output = out0_
        return output
    ...
    def CreateWrappedTestVectorKeyring(self, input):
        output: Wrappers.Result = None
        out0_: Wrappers.Result
        out0_ = KeysVectorOperations.default__.CreateWrappedTestVectorKeyring((self).config, input)
        output = out0_
        return output
    ...
    def CreateWrappedTestVectorCmm(self, input):
        output: Wrappers.Result = None
        out0_: Wrappers.Result
        out0_ = KeysVectorOperations.default__.CreateWrappedTestVectorCmm((self).config, input)
        output = out0_
        return output
