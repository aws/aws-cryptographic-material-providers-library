...
class default__:
    ...
    def EphemeralKeyDescriptionsEncrypt(instance):
        def iife0_():
            coll0_ = _dafny.Set()
            compr_0_: _dafny.Seq
            for compr_0_ in (default__.ecdhCurveNames).Elements:
                d_0_key_: _dafny.Seq = compr_0_
                if (d_0_key_) in (default__.ecdhCurveNames):
                    coll0_ = coll0_.union(_dafny.Set([AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription_ECDH(AwsCryptographyMaterialProvidersTestVectorKeysTypes.RawEcdh_RawEcdh(_dafny.Seq("ephemeral"), (d_0_key_) + (_dafny.Seq("-private")), _dafny.Seq("ephemeral"), _dafny.Seq("recipient-material-public-key"), (_dafny.Seq("aws-raw-vectors-persistent-ephemeral ")) + (d_0_key_), d_0_key_, _dafny.Seq("ephemeral")))]))
    ...
    def DiscoveryKeyDescriptionsDecrypt(instance):
        def iife0_():
            ...
            for compr_0_ in (default__.ecdhCurveNames).Elements:
                d_0_key_: _dafny.Seq = compr_0_
                if (d_0_key_) in (default__.ecdhCurveNames):
                    coll0_ = coll0_.union(_dafny.Set([AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription_ECDH(AwsCryptographyMaterialProvidersTestVectorKeysTypes.RawEcdh_RawEcdh(_dafny.Seq("discovery"), (d_0_key_) + (_dafny.Seq("-private")), _dafny.Seq("discovery"), _dafny.Seq("recipient-material-public-key"), (_dafny.Seq("aws-raw-vectors-persistent-discovery ")) + (d_0_key_), d_0_key_, _dafny.Seq("discovery")))]))
            return _dafny.Set(coll0_)
        return iife0_()
    ...
    def SenderKeyDescriptions(instance):
        def iife0_():
            ...
            for compr_0_ in (default__.ecdhCurveNames).Elements:
                d_0_key_: _dafny.Seq = compr_0_
                if (d_0_key_) in (default__.ecdhCurveNames):
                    coll0_ = coll0_.union(_dafny.Set([AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription_ECDH(AwsCryptographyMaterialProvidersTestVectorKeysTypes.RawEcdh_RawEcdh((d_0_key_) + (_dafny.Seq("-private")), (d_0_key_) + (_dafny.Seq("-private")), _dafny.Seq("sender-material-public-key"), _dafny.Seq("recipient-material-public-key"), (_dafny.Seq("aws-raw-vectors-persistent-static ")) + (d_0_key_), d_0_key_, _dafny.Seq("static")))]))
            return _dafny.Set(coll0_)
        return iife0_()
    ...
    def EphemeralDiscoveryTests(instance):
        def iife0_():
            ...
            for compr_0_ in (default__.EphemeralKeyDescriptionsEncrypt).Elements:
                d_0_encryptKeyDescription_: AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription = compr_0_
                if (d_0_encryptKeyDescription_) in (default__.EphemeralKeyDescriptionsEncrypt):
                    compr_1_: AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription
                    for compr_1_ in (default__.DiscoveryKeyDescriptionsDecrypt).Elements:
                        d_1_decryptKeyDescription_: AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription = compr_1_
                        if ((d_1_decryptKeyDescription_) in (default__.DiscoveryKeyDescriptionsDecrypt)) and ((((d_1_decryptKeyDescription_).ECDH).curveSpec) == (((d_0_encryptKeyDescription_).ECDH).curveSpec)):
                            compr_2_: AwsCryptographyMaterialProvidersTypes.AlgorithmSuiteInfo
                            for compr_2_ in (AllAlgorithmSuites.default__.AllAlgorithmSuites).Elements:
                                d_2_algorithmSuite_: AwsCryptographyMaterialProvidersTypes.AlgorithmSuiteInfo = compr_2_
                                if (d_2_algorithmSuite_) in (AllAlgorithmSuites.default__.AllAlgorithmSuites):
                                    compr_3_: AwsCryptographyMaterialProvidersTypes.CommitmentPolicy
                                    for compr_3_ in [AllAlgorithmSuites.default__.GetCompatibleCommitmentPolicy(d_2_algorithmSuite_)]:
                                        d_3_commitmentPolicy_: AwsCryptographyMaterialProvidersTypes.CommitmentPolicy = compr_3_
                                        if (d_3_commitmentPolicy_) == (AllAlgorithmSuites.default__.GetCompatibleCommitmentPolicy(d_2_algorithmSuite_)):
                                            coll0_ = coll0_.union(_dafny.Set([TestVectors.EncryptTestVector_PositiveEncryptKeyringVector((((_dafny.Seq("Generated RawECDH Ephemeral-Discovery ")) + (((d_0_encryptKeyDescription_).ECDH).senderKeyId)) + (_dafny.Seq(" "))) + (((d_1_decryptKeyDescription_).ECDH).recipientKeyId), Wrappers.Option_None(), _dafny.Map({}), d_3_commitmentPolicy_, d_2_algorithmSuite_, Wrappers.Option_None(), Wrappers.Option_None(), d_0_encryptKeyDescription_, d_1_decryptKeyDescription_, Wrappers.Option_None())]))
            return _dafny.Set(coll0_)
        return iife0_()
    ...
    def StaticSenderDiscoveryRecipientTests(instance):
        def iife0_():
            coll0_ = _dafny.Set()
            compr_0_: AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription
            for compr_0_ in (default__.SenderKeyDescriptions).Elements:
                d_0_encryptKeyDescription_: AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription = compr_0_
                if (d_0_encryptKeyDescription_) in (default__.SenderKeyDescriptions):
                    compr_1_: AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription
                    for compr_1_ in (default__.DiscoveryKeyDescriptionsDecrypt).Elements:
                        d_1_decryptKeyDescription_: AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription = compr_1_
                        if ((d_1_decryptKeyDescription_) in (default__.DiscoveryKeyDescriptionsDecrypt)) and ((((d_1_decryptKeyDescription_).ECDH).curveSpec) == (((d_0_encryptKeyDescription_).ECDH).curveSpec)):
                            ...
                            for compr_2_ in (AllAlgorithmSuites.default__.AllAlgorithmSuites).Elements:
                                ...
                                if (d_2_algorithmSuite_) in (AllAlgorithmSuites.default__.AllAlgorithmSuites):
                                    ...
                                    for compr_3_ in [AllAlgorithmSuites.default__.GetCompatibleCommitmentPolicy(d_2_algorithmSuite_)]:
                                        d_3_commitmentPolicy_: AwsCryptographyMaterialProvidersTypes.CommitmentPolicy = compr_3_
                                        if (d_3_commitmentPolicy_) == (AllAlgorithmSuites.default__.GetCompatibleCommitmentPolicy(d_2_algorithmSuite_)):
                                            coll0_ = coll0_.union(_dafny.Set([TestVectors.EncryptTestVector_PositiveEncryptKeyringVector((((_dafny.Seq("Generated RawECDH Static ")) + (((d_0_encryptKeyDescription_).ECDH).senderKeyId)) + (_dafny.Seq(" Discovery "))) + (((d_1_decryptKeyDescription_).ECDH).recipientKeyId), Wrappers.Option_None(), _dafny.Map({}), d_3_commitmentPolicy_, d_2_algorithmSuite_, Wrappers.Option_None(), Wrappers.Option_None(), d_0_encryptKeyDescription_, d_1_decryptKeyDescription_, Wrappers.Option_None())]))
            return _dafny.Set(coll0_)
        return iife0_()
    ...
    def StaticSenderRecipientTests(instance):
        def iife0_():
            ...
            for compr_0_ in (default__.SenderKeyDescriptions).Elements:
                ...
                if (d_0_encryptKeyDescription_) in (default__.SenderKeyDescriptions):
                    compr_1_: AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription
                    for compr_1_ in (default__.RecipientKeyDescriptions).Elements:
                        d_1_decryptKeyDescription_: AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription = compr_1_
                        if ((d_1_decryptKeyDescription_) in (default__.RecipientKeyDescriptions)) and ((((d_1_decryptKeyDescription_).ECDH).curveSpec) == (((d_0_encryptKeyDescription_).ECDH).curveSpec)):
                            compr_2_: AwsCryptographyMaterialProvidersTypes.AlgorithmSuiteInfo
                            for compr_2_ in (AllAlgorithmSuites.default__.AllAlgorithmSuites).Elements:
                                d_2_algorithmSuite_: AwsCryptographyMaterialProvidersTypes.AlgorithmSuiteInfo = compr_2_
                                if (d_2_algorithmSuite_) in (AllAlgorithmSuites.default__.AllAlgorithmSuites):
                                    ...
                                    for compr_3_ in [AllAlgorithmSuites.default__.GetCompatibleCommitmentPolicy(d_2_algorithmSuite_)]:
                                        d_3_commitmentPolicy_: AwsCryptographyMaterialProvidersTypes.CommitmentPolicy = compr_3_
                                        if (d_3_commitmentPolicy_) == (AllAlgorithmSuites.default__.GetCompatibleCommitmentPolicy(d_2_algorithmSuite_)):
                                            coll0_ = coll0_.union(_dafny.Set([TestVectors.EncryptTestVector_PositiveEncryptKeyringVector((((_dafny.Seq("Generated RawECDH Static ")) + (((d_0_encryptKeyDescription_).ECDH).senderKeyId)) + (_dafny.Seq(" "))) + (((d_1_decryptKeyDescription_).ECDH).senderKeyId), Wrappers.Option_None(), _dafny.Map({}), d_3_commitmentPolicy_, d_2_algorithmSuite_, Wrappers.Option_None(), Wrappers.Option_None(), d_0_encryptKeyDescription_, d_1_decryptKeyDescription_, Wrappers.Option_None())]))
            return _dafny.Set(coll0_)
        return iife0_()
