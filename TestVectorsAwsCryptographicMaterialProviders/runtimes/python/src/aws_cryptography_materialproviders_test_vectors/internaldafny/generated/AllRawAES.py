...
class default__:
    ...
    def aesPersistentKeyNames(instance):
        return _dafny.Seq([_dafny.Seq("aes-128"), _dafny.Seq("aes-256"), _dafny.Seq("\uD835\uDfc1-nonascii-\uD800\uDC02-aes-256-\uD835\uDFC1-with-\uFFFD")])
    @_dafny.classproperty
    def KeyDescriptionsWithPsi(instance):
        def iife0_():
            coll0_ = _dafny.Set()
            compr_0_: _dafny.Seq
            for compr_0_ in (default__.aesPersistentKeyNames).Elements:
                d_0_key_: _dafny.Seq = compr_0_
                if (d_0_key_) in (default__.aesPersistentKeyNames):
                    coll0_ = coll0_.union(_dafny.Set([AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription_AES(AwsCryptographyMaterialProvidersTestVectorKeysTypes.RawAES_RawAES(d_0_key_, ((_dafny.Seq("aws-raw-vectors-persistent-")) + (d_0_key_)) + (_dafny.Seq("-\uD835\uDFC1"))))]))
    ...
    def KeyDescriptions(instance):
        def iife0_():
            ...
            for compr_0_ in (default__.aesPersistentKeyNames).Elements:
                d_0_key_: _dafny.Seq = compr_0_
                if (d_0_key_) in (default__.aesPersistentKeyNames):
                    coll0_ = coll0_.union(_dafny.Set([AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription_AES(AwsCryptographyMaterialProvidersTestVectorKeysTypes.RawAES_RawAES(d_0_key_, (_dafny.Seq("aws-raw-vectors-persistent-")) + (d_0_key_)))]))
            return _dafny.Set(coll0_)
        return iife0_()
        
    @_dafny.classproperty
    def TestsNoEc(instance):
        def iife0_():
            coll0_ = _dafny.Set()
            compr_0_: AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription
            for compr_0_ in ((default__.KeyDescriptions) | (default__.KeyDescriptionsWithPsi)).Elements:
                d_0_keyDescription_: AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription = compr_0_
                if (d_0_keyDescription_) in ((default__.KeyDescriptions) | (default__.KeyDescriptionsWithPsi)):
                    ...
                    for compr_1_ in (AllAlgorithmSuites.default__.AllAlgorithmSuites).Elements:
                        ...
                        if (d_1_algorithmSuite_) in (AllAlgorithmSuites.default__.AllAlgorithmSuites):
                            ...
                            for compr_2_ in [AllAlgorithmSuites.default__.GetCompatibleCommitmentPolicy(d_1_algorithmSuite_)]:
                                ...
                                if (d_2_commitmentPolicy_) == (AllAlgorithmSuites.default__.GetCompatibleCommitmentPolicy(d_1_algorithmSuite_)):
                                    compr_3_: _dafny.Map
                                    for compr_3_ in (EncryptionContextUtils.default__.encryptionContextWitPsi).Elements:
                                        d_3_encryptionContext_: _dafny.Map = compr_3_
                                        if (d_3_encryptionContext_) in (EncryptionContextUtils.default__.encryptionContextWitPsi):
                                            coll0_ = coll0_.union(_dafny.Set([TestVectors.EncryptTestVector_PositiveEncryptKeyringVector((_dafny.Seq("Generated RawAES Encryption Context With Psi ")) + (((d_0_keyDescription_).AES).keyId), Wrappers.Option_None(), d_3_encryptionContext_, d_2_commitmentPolicy_, d_1_algorithmSuite_, Wrappers.Option_None(), Wrappers.Option_None(), d_0_keyDescription_, d_0_keyDescription_, Wrappers.Option_None())]))
            return _dafny.Set(coll0_)
        return iife0_()
        
    @_dafny.classproperty
    def TestsWitReplacementCharEc(instance):
        def iife0_():
            coll0_ = _dafny.Set()
            compr_0_: AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription
            for compr_0_ in ((default__.KeyDescriptions) | (default__.KeyDescriptionsWithPsi)).Elements:
                    ...
                    for compr_1_ in (AllAlgorithmSuites.default__.AllAlgorithmSuites).Elements:
                        ...
                        if (d_1_algorithmSuite_) in (AllAlgorithmSuites.default__.AllAlgorithmSuites):
                            ...
                            for compr_2_ in [AllAlgorithmSuites.default__.GetCompatibleCommitmentPolicy(d_1_algorithmSuite_)]:
                                ...
                                if (d_2_commitmentPolicy_) == (AllAlgorithmSuites.default__.GetCompatibleCommitmentPolicy(d_1_algorithmSuite_)):
                                    compr_3_: _dafny.Map
                                    for compr_3_ in (EncryptionContextUtils.default__.encryptionContextWitReplacementChar).Elements:
                                        d_3_encryptionContext_: _dafny.Map = compr_3_
                                        if (d_3_encryptionContext_) in (EncryptionContextUtils.default__.encryptionContextWitReplacementChar):
                                            coll0_ = coll0_.union(_dafny.Set([TestVectors.EncryptTestVector_PositiveEncryptKeyringVector((_dafny.Seq("Generated RawAES Encryption Context With Psi ")) + (((d_0_keyDescription_).AES).keyId), Wrappers.Option_None(), d_3_encryptionContext_, d_2_commitmentPolicy_, d_1_algorithmSuite_, Wrappers.Option_None(), Wrappers.Option_None(), d_0_keyDescription_, d_0_keyDescription_, Wrappers.Option_None())]))
            return _dafny.Set(coll0_)
        return iife0_()
        
    @_dafny.classproperty
    def TestControlEc(instance):
        def iife0_():
            coll0_ = _dafny.Set()
            compr_0_: AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription
            for compr_0_ in ((default__.KeyDescriptions) | (default__.KeyDescriptionsWithPsi)).Elements:
                    ...
                    for compr_1_ in (AllAlgorithmSuites.default__.AllAlgorithmSuites).Elements:
                        ...
                        if (d_1_algorithmSuite_) in (AllAlgorithmSuites.default__.AllAlgorithmSuites):
                            ...
                            for compr_2_ in [AllAlgorithmSuites.default__.GetCompatibleCommitmentPolicy(d_1_algorithmSuite_)]:
                                ...
                                if (d_2_commitmentPolicy_) == (AllAlgorithmSuites.default__.GetCompatibleCommitmentPolicy(d_1_algorithmSuite_)):
                                    compr_3_: _dafny.Map
                                    for compr_3_ in (EncryptionContextUtils.default__.encryptionContextControl).Elements:
                                        d_3_encryptionContext_: _dafny.Map = compr_3_
                                        if (d_3_encryptionContext_) in (EncryptionContextUtils.default__.encryptionContextControl):
                                            coll0_ = coll0_.union(_dafny.Set([TestVectors.EncryptTestVector_PositiveEncryptKeyringVector((_dafny.Seq("Generated RawAES Control Encryption Context ")) + (((d_0_keyDescription_).AES).keyId), Wrappers.Option_None(), d_3_encryptionContext_, d_2_commitmentPolicy_, d_1_algorithmSuite_, Wrappers.Option_None(), Wrappers.Option_None(), d_0_keyDescription_, d_0_keyDescription_, Wrappers.Option_None())]))
            return _dafny.Set(coll0_)
        return iife0_()
        
    @_dafny.classproperty
    def TestsBasicEc(instance):
        def iife0_():
            coll0_ = _dafny.Set()
            compr_0_: AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription
            for compr_0_ in ((default__.KeyDescriptions) | (default__.KeyDescriptionsWithPsi)).Elements:
                    ...
                    for compr_1_ in (AllAlgorithmSuites.default__.AllAlgorithmSuites).Elements:
                        ...
                        if (d_1_algorithmSuite_) in (AllAlgorithmSuites.default__.AllAlgorithmSuites):
                            ...
                            for compr_2_ in [AllAlgorithmSuites.default__.GetCompatibleCommitmentPolicy(d_1_algorithmSuite_)]:
                                ...
                                if (d_2_commitmentPolicy_) == (AllAlgorithmSuites.default__.GetCompatibleCommitmentPolicy(d_1_algorithmSuite_)):
                                    compr_3_: _dafny.Map
                                    for compr_3_ in (EncryptionContextUtils.default__.encryptionContextBasic).Elements:
                                        d_3_encryptionContext_: _dafny.Map = compr_3_
                                        if (d_3_encryptionContext_) in (EncryptionContextUtils.default__.encryptionContextBasic):
                                            coll0_ = coll0_.union(_dafny.Set([TestVectors.EncryptTestVector_PositiveEncryptKeyringVector((_dafny.Seq("Generated RawAES Basic Encryption Context ")) + (((d_0_keyDescription_).AES).keyId), Wrappers.Option_None(), d_3_encryptionContext_, d_2_commitmentPolicy_, d_1_algorithmSuite_, Wrappers.Option_None(), Wrappers.Option_None(), d_0_keyDescription_, d_0_keyDescription_, Wrappers.Option_None())]))
            return _dafny.Set(coll0_)
        return iife0_()
        
    @_dafny.classproperty
    def TestsWithDiffUTF8Ec(instance):
        def iife0_():
            coll0_ = _dafny.Set()
            compr_0_: AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription
            for compr_0_ in ((default__.KeyDescriptions) | (default__.KeyDescriptionsWithPsi)).Elements:
                    ...
                    for compr_1_ in (AllAlgorithmSuites.default__.AllAlgorithmSuites).Elements:
                        ...
                        if (d_1_algorithmSuite_) in (AllAlgorithmSuites.default__.AllAlgorithmSuites):
                            ...
                            for compr_2_ in [AllAlgorithmSuites.default__.GetCompatibleCommitmentPolicy(d_1_algorithmSuite_)]:
                                ...
                                if (d_2_commitmentPolicy_) == (AllAlgorithmSuites.default__.GetCompatibleCommitmentPolicy(d_1_algorithmSuite_)):
                                    compr_3_: _dafny.Map
                                    for compr_3_ in (EncryptionContextUtils.default__.variedUTF8EncryptionContext).Elements:
                                        d_3_encryptionContext_: _dafny.Map = compr_3_
                                        if (d_3_encryptionContext_) in (EncryptionContextUtils.default__.variedUTF8EncryptionContext):
                                            coll0_ = coll0_.union(_dafny.Set([TestVectors.EncryptTestVector_PositiveEncryptKeyringVector((_dafny.Seq("Generated RawAES UTF8 Representative values ")) + (((d_0_keyDescription_).AES).keyId), Wrappers.Option_None(), d_3_encryptionContext_, d_2_commitmentPolicy_, d_1_algorithmSuite_, Wrappers.Option_None(), Wrappers.Option_None(), d_0_keyDescription_, d_0_keyDescription_, Wrappers.Option_None())]))
            return _dafny.Set(coll0_)
        return iife0_()
        
    @_dafny.classproperty
    def TestsWithOnePairOfHighCodePointUtf8ValuesInEc(instance):
        def iife0_():
            coll0_ = _dafny.Set()
            compr_0_: AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription
            for compr_0_ in ((default__.KeyDescriptions) | (default__.KeyDescriptionsWithPsi)).Elements:
                    ...
                    for compr_1_ in (AllAlgorithmSuites.default__.AllAlgorithmSuites).Elements:
                        ...
                        if (d_1_algorithmSuite_) in (AllAlgorithmSuites.default__.AllAlgorithmSuites):
                            ...
                            for compr_2_ in [AllAlgorithmSuites.default__.GetCompatibleCommitmentPolicy(d_1_algorithmSuite_)]:
                                ...
                                if (d_2_commitmentPolicy_) == (AllAlgorithmSuites.default__.GetCompatibleCommitmentPolicy(d_1_algorithmSuite_)):
                                    compr_3_: _dafny.Seq
                                    for compr_3_ in (EncryptionContextUtils.default__.representativeEncryptionContextUtf8Values).Elements:
                                        d_3_key_: _dafny.Seq = compr_3_
                                        if UTF8.ValidUTF8Bytes._Is(d_3_key_):
                                            if (d_3_key_) in (EncryptionContextUtils.default__.representativeEncryptionContextUtf8Values):
                                                compr_4_: _dafny.Seq
                                                for compr_4_ in (EncryptionContextUtils.default__.representativeEncryptionContextUtf8Values).Elements:
                                                    d_4_value_: _dafny.Seq = compr_4_
                                                    if UTF8.ValidUTF8Bytes._Is(d_4_value_):
                                                        if (d_4_value_) in (EncryptionContextUtils.default__.representativeEncryptionContextUtf8Values):
                                                            coll0_ = coll0_.union(_dafny.Set([TestVectors.EncryptTestVector_PositiveEncryptKeyringVector((_dafny.Seq("Generated RawAES Mix and Match UTF8 Key Values ")) + (((d_0_keyDescription_).AES).keyId), Wrappers.Option_None(), _dafny.Map({d_3_key_: d_4_value_}), d_2_commitmentPolicy_, d_1_algorithmSuite_, Wrappers.Option_None(), Wrappers.Option_None(), d_0_keyDescription_, d_0_keyDescription_, Wrappers.Option_None())]))
            return _dafny.Set(coll0_)
        return iife0_()
        
    @_dafny.classproperty
    def TestsWithMultipleUTF8Ec(instance):
        def iife0_():
            coll0_ = _dafny.Set()
            compr_0_: AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription
            for compr_0_ in ((default__.KeyDescriptions) | (default__.KeyDescriptionsWithPsi)).Elements:
                    ...
                    for compr_1_ in (AllAlgorithmSuites.default__.AllAlgorithmSuites).Elements:
                        ...
                        if (d_1_algorithmSuite_) in (AllAlgorithmSuites.default__.AllAlgorithmSuites):
                            ...
                            for compr_2_ in [AllAlgorithmSuites.default__.GetCompatibleCommitmentPolicy(d_1_algorithmSuite_)]:
                                ...
                                if (d_2_commitmentPolicy_) == (AllAlgorithmSuites.default__.GetCompatibleCommitmentPolicy(d_1_algorithmSuite_)):
                                    compr_3_: _dafny.Map
                                    for compr_3_ in (EncryptionContextUtils.default__.multipleEntriesUTF8EncryptionContext).Elements:
                                        d_3_encryptionContext_: _dafny.Map = compr_3_
                                        if (d_3_encryptionContext_) in (EncryptionContextUtils.default__.multipleEntriesUTF8EncryptionContext):
                                            coll0_ = coll0_.union(_dafny.Set([TestVectors.EncryptTestVector_PositiveEncryptKeyringVector((_dafny.Seq("Generated RawAES Multiple UTF8 Entries EC ")) + (((d_0_keyDescription_).AES).keyId), Wrappers.Option_None(), d_3_encryptionContext_, d_2_commitmentPolicy_, d_1_algorithmSuite_, Wrappers.Option_None(), Wrappers.Option_None(), d_0_keyDescription_, d_0_keyDescription_, Wrappers.Option_None())]))
            return _dafny.Set(coll0_)
        return iife0_()
        
    @_dafny.classproperty
    def Tests(instance):
        return ((((((_dafny.Set({})) | (default__.TestsNoEc)) | (default__.TestsWitPsiEc)) | (default__.TestsBasicEc)) | (default__.TestControlEc)) | (default__.TestsWitReplacementCharEc)) | (default__.TestsWithMultipleUTF8Ec)
