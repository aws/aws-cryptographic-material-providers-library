...
class default__:
    ...
    @_dafny.classproperty
    def Tests(instance):
        return ((((((_dafny.Set({})) | (default__.TestsNoEc)) | (default__.TestsWitPsiEc)) | (default__.TestsBasicEc)) | (default__.TestControlEc)) | (default__.TestsWithDiffUTF8Ec)) | (default__.TestsWitReplacementCharEc)
