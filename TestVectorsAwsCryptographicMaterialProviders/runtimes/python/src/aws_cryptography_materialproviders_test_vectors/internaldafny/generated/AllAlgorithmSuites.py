...
class default__:
    ...
    def DBEAlgorithmSuites(instance):
        def iife0_():
            coll0_ = _dafny.Set()
            compr_0_: AwsCryptographyMaterialProvidersTypes.DBEAlgorithmSuiteId
            for compr_0_ in AwsCryptographyMaterialProvidersTypes.DBEAlgorithmSuiteId.AllSingletonConstructors:
                d_0_id_: AwsCryptographyMaterialProvidersTypes.DBEAlgorithmSuiteId = compr_0_
                coll0_ = coll0_.union(_dafny.Set([AlgorithmSuites.default__.GetDBESuite(d_0_id_)]))
            return _dafny.Set(coll0_)
        return iife0_()
