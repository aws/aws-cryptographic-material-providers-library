...
class default__:
    ...
    def WriteStuff(op):
        ...
        d_0_time_ = out0_
        d_1_tests_: _dafny.Seq
        out1_: _dafny.Seq
        out1_ = SortedSets.default__.SetToSequence(default__.AllPositiveKeyringTests)
        d_1_tests_ = out1_
        d_2_testsJSON_: _dafny.Seq
        d_2_testsJSON_ = _dafny.Seq([])
        hi0_ = len(d_1_tests_)
        for d_3_i_ in range(0, hi0_):
            ...
            if (d_4_valueOrError0_).IsFailure():
                ...
                return output
            d_5_name_: _dafny.Seq
            d_5_name_ = (d_4_valueOrError0_).Extract()
            d_6_valueOrError1_: Wrappers.Result = Wrappers.Result.default(JSON_Values.JSON.default())()
            d_6_valueOrError1_ = WriteJsonManifests.default__.EncryptTestVectorToJson((d_1_tests_)[d_3_i_])
            if (d_6_valueOrError1_).IsFailure():
                output = (d_6_valueOrError1_).PropagateFailure()
                return output
            d_7_test_: JSON_Values.JSON
            d_7_test_ = (d_6_valueOrError1_).Extract()
            d_2_testsJSON_ = (d_2_testsJSON_) + (_dafny.Seq([(d_5_name_, d_7_test_)]))
        d_8_mplEncryptManifest_: JSON_Values.JSON
        d_8_mplEncryptManifest_ = JSON_Values.JSON_Object(_dafny.Seq([(_dafny.Seq("manifest"), JSON_Values.JSON_Object(_dafny.Seq([(_dafny.Seq("version"), JSON_Values.JSON_Number(JSON_Values.default__.Int(4))), (_dafny.Seq("type"), JSON_Values.JSON_String(_dafny.Seq("awses-mpl-encrypt")))]))), (_dafny.Seq("keys"), JSON_Values.JSON_String(_dafny.Seq("file://keys.json"))), (_dafny.Seq("tests"), JSON_Values.JSON_Object(d_2_testsJSON_))]))
        d_9_valueOrError2_: Wrappers.Result = Wrappers.Result.default(_dafny.Seq)()
        def lambda0_(d_10_e_):
            return (d_10_e_).ToString()

        d_9_valueOrError2_ = (JSON_API.default__.Serialize(d_8_mplEncryptManifest_)).MapFailure(lambda0_)
        if (d_9_valueOrError2_).IsFailure():
            output = (d_9_valueOrError2_).PropagateFailure()
            return output
        d_11_mplEncryptManifestBytes_: _dafny.Seq
        d_11_mplEncryptManifestBytes_ = (d_9_valueOrError2_).Extract()
        d_12_valueOrError3_: Wrappers.Result = Wrappers.Result.default(_dafny.defaults.tuple())()
        out3_: Wrappers.Result
        out3_ = default__.WriteVectorsFile(((op).encryptManifestOutput) + (_dafny.Seq("manifest.json")), d_11_mplEncryptManifestBytes_)
        d_12_valueOrError3_ = out3_
        if (d_12_valueOrError3_).IsFailure():
            output = (d_12_valueOrError3_).PropagateFailure()
            return output
        d_13___v0_: tuple
        d_13___v0_ = (d_12_valueOrError3_).Extract()
    ...
    def WriteDecryptManifest(op, keys, tests):
        ...
        for d_1_i_ in range(0, hi0_):
            ...
            d_3_name_ = (d_2_valueOrError0_).Extract()
            d_4_valueOrError1_: Wrappers.Result = Wrappers.Result.default(JSON_Values.JSON.default())()
            d_4_valueOrError1_ = WriteJsonManifests.default__.DecryptTestVectorToJson((tests)[d_1_i_])
            if (d_4_valueOrError1_).IsFailure():
                output = (d_4_valueOrError1_).PropagateFailure()
                return output
            d_5_test_: JSON_Values.JSON
            d_5_test_ = (d_4_valueOrError1_).Extract()
            d_0_testsJSON_ = (d_0_testsJSON_) + (_dafny.Seq([(d_3_name_, d_5_test_)]))
        d_6_mplDecryptManifest_: JSON_Values.JSON
        d_6_mplDecryptManifest_ = JSON_Values.JSON_Object(_dafny.Seq([(_dafny.Seq("manifest"), JSON_Values.JSON_Object(_dafny.Seq([(_dafny.Seq("version"), JSON_Values.JSON_Number(JSON_Values.default__.Int(4))), (_dafny.Seq("type"), JSON_Values.JSON_String(_dafny.Seq("awses-mpl-decrypt")))]))), (_dafny.Seq("client"), JSON_Values.JSON_String(_dafny.Seq("mpl-dafny"))), (_dafny.Seq("keys"), JSON_Values.JSON_String(_dafny.Seq("file://keys.json"))), (_dafny.Seq("tests"), JSON_Values.JSON_Object(d_0_testsJSON_))]))
        d_7_valueOrError2_: Wrappers.Result = Wrappers.Result.default(_dafny.Seq)()
        def lambda0_(d_8_e_):
            return (d_8_e_).ToString()

        d_7_valueOrError2_ = (JSON_API.default__.Serialize(d_6_mplDecryptManifest_)).MapFailure(lambda0_)
        if (d_7_valueOrError2_).IsFailure():
            output = (d_7_valueOrError2_).PropagateFailure()
            return output
        d_9_mplDecryptManifestBytes_: _dafny.Seq
        d_9_mplDecryptManifestBytes_ = (d_7_valueOrError2_).Extract()
        d_10_valueOrError3_: Wrappers.Result = Wrappers.Result.default(_dafny.defaults.tuple())()
        out1_: Wrappers.Result
        out1_ = default__.WriteVectorsFile(((op).decryptManifestOutput) + (_dafny.Seq("manifest.json")), d_9_mplDecryptManifestBytes_)
        d_10_valueOrError3_ = out1_
        if (d_10_valueOrError3_).IsFailure():
            output = (d_10_valueOrError3_).PropagateFailure()
            return output
        d_11___v1_: tuple
        d_11___v1_ = (d_10_valueOrError3_).Extract()
        d_12_keysJsonFileName_: _dafny.Seq
        d_12_keysJsonFileName_ = _dafny.Seq("keys.json")
        d_13_valueOrError4_: Wrappers.Result = Wrappers.Result.default(_dafny.Seq)()
        def lambda1_(d_14_e_):
            return (d_14_e_).ToString()

        d_13_valueOrError4_ = (JSON_API.default__.Serialize(((keys).config).keysJson)).MapFailure(lambda1_)
        if (d_13_valueOrError4_).IsFailure():
            output = (d_13_valueOrError4_).PropagateFailure()
            return output
        d_15_keysJsonBytes_: _dafny.Seq
        d_15_keysJsonBytes_ = (d_13_valueOrError4_).Extract()
        d_16_valueOrError5_: Wrappers.Result = Wrappers.Result.default(_dafny.defaults.tuple())()
        out2_: Wrappers.Result
        out2_ = default__.WriteVectorsFile(((op).decryptManifestOutput) + (d_12_keysJsonFileName_), d_15_keysJsonBytes_)
        d_16_valueOrError5_ = out2_
    ...
    def WriteVectorsFile(location, bytes):
        output: Wrappers.Result = Wrappers.Result.default(_dafny.defaults.tuple())()
        out0_: Wrappers.Result
        out0_ = FileIO.default__.WriteBytesToFile(location, bytes)
        output = out0_
        return output
