...
class default__:
    ...
    def WriteStuff(op):
        ...
        d_0_tests_: _dafny.Seq
        d_0_tests_ = SortedSets.default__.SetToSequence(default__.AllPositiveKeyringTests)
        d_1_testsJSON_: _dafny.Seq
        d_1_testsJSON_ = _dafny.Seq([])
        hi0_ = len(d_0_tests_)
        for d_2_i_ in range(0, hi0_):
            ...
            if (d_3_valueOrError0_).IsFailure():
                ...
                return output
            d_4_name_: _dafny.Seq
            d_4_name_ = (d_3_valueOrError0_).Extract()
            d_5_valueOrError1_: Wrappers.Result = Wrappers.Result.default(JSON_Values.JSON.default())()
            d_5_valueOrError1_ = WriteJsonManifests.default__.EncryptTestVectorToJson((d_0_tests_)[d_2_i_])
            if (d_5_valueOrError1_).IsFailure():
                output = (d_5_valueOrError1_).PropagateFailure()
                return output
            d_6_test_: JSON_Values.JSON
            d_6_test_ = (d_5_valueOrError1_).Extract()
            d_1_testsJSON_ = (d_1_testsJSON_) + (_dafny.Seq([(d_4_name_, d_6_test_)]))
        d_7_mplEncryptManifest_: JSON_Values.JSON
        d_7_mplEncryptManifest_ = JSON_Values.JSON_Object(_dafny.Seq([(_dafny.Seq("manifest"), JSON_Values.JSON_Object(_dafny.Seq([(_dafny.Seq("version"), JSON_Values.JSON_Number(JSON_Values.default__.Int(4))), (_dafny.Seq("type"), JSON_Values.JSON_String(_dafny.Seq("awses-mpl-encrypt")))]))), (_dafny.Seq("keys"), JSON_Values.JSON_String(_dafny.Seq("file://keys.json"))), (_dafny.Seq("tests"), JSON_Values.JSON_Object(d_1_testsJSON_))]))
        d_8_valueOrError2_: Wrappers.Result = Wrappers.Result.default(_dafny.Seq)()
        def lambda0_(d_9_e_):
            return (d_9_e_).ToString()

        d_8_valueOrError2_ = (JSON_API.default__.Serialize(d_7_mplEncryptManifest_)).MapFailure(lambda0_)
        if (d_8_valueOrError2_).IsFailure():
            output = (d_8_valueOrError2_).PropagateFailure()
            return output
        d_10_mplEncryptManifestBytes_: _dafny.Seq
        d_10_mplEncryptManifestBytes_ = (d_8_valueOrError2_).Extract()
        d_11_valueOrError3_: Wrappers.Result = Wrappers.Result.default(_dafny.defaults.tuple())()
        out1_: Wrappers.Result
        out1_ = default__.WriteVectorsFile(((op).encryptManifestOutput) + (_dafny.Seq("manifest.json")), d_10_mplEncryptManifestBytes_)
        d_11_valueOrError3_ = out1_
        if (d_11_valueOrError3_).IsFailure():
            output = (d_11_valueOrError3_).PropagateFailure()
            return output
        d_12___v0_: tuple
        d_12___v0_ = (d_11_valueOrError3_).Extract()
