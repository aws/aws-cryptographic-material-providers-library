...
class default__:
    ...
    def StaticKmsDescriptionsEncryptSender(instance):
        def iife0_():
            coll0_ = _dafny.Set()
            compr_0_: _dafny.Seq
            for compr_0_ in (default__.kmsKeys).Elements:
                d_0_key_: _dafny.Seq = compr_0_
                if (d_0_key_) in (default__.kmsKeys):
                    coll0_ = coll0_.union(_dafny.Set([AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription_KmsECDH(AwsCryptographyMaterialProvidersTestVectorKeysTypes.KmsEcdhKeyring_KmsEcdhKeyring(d_0_key_, d_0_key_, _dafny.Seq("sender-material-public-key"), _dafny.Seq("recipient-material-public-key"), d_0_key_, _dafny.Seq("static")))]))
    ...
    def DiscoveryKeyDescriptionsDecrypt(instance):
        def iife0_():
            ...
            for compr_0_ in (default__.kmsKeys).Elements:
                d_0_key_: _dafny.Seq = compr_0_
                if (d_0_key_) in (default__.kmsKeys):
                    coll0_ = coll0_.union(_dafny.Set([AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription_KmsECDH(AwsCryptographyMaterialProvidersTestVectorKeysTypes.KmsEcdhKeyring_KmsEcdhKeyring(_dafny.Seq("discovery"), d_0_key_, _dafny.Seq("discovery"), _dafny.Seq("recipient-material-public-key"), d_0_key_, _dafny.Seq("discovery")))]))
            return _dafny.Set(coll0_)
        return iife0_()
    ...
    def StaticKmsSenderRecipientTests(instance):
        def iife0_():
            ...
            for compr_0_ in (default__.StaticKmsDescriptionsEncryptSender).Elements:
                d_0_encryptKeyDescription_: AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription = compr_0_
                if (d_0_encryptKeyDescription_) in (default__.StaticKmsDescriptionsEncryptSender):
                    compr_1_: AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription
                    for compr_1_ in (default__.StaticKmsDescriptionsEncryptRecipient).Elements:
                        d_1_decryptKeyDescription_: AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription = compr_1_
                        if ((d_1_decryptKeyDescription_) in (default__.StaticKmsDescriptionsEncryptRecipient)) and ((((d_1_decryptKeyDescription_).KmsECDH).curveSpec) == (((d_0_encryptKeyDescription_).KmsECDH).curveSpec)):
                                ...
                                if (d_2_algorithmSuite_) in (AllAlgorithmSuites.default__.AllAlgorithmSuites):
                                    ...
                                    for compr_3_ in [AllAlgorithmSuites.default__.GetCompatibleCommitmentPolicy(d_2_algorithmSuite_)]:
                                        ...
                                        if (d_3_commitmentPolicy_) == (AllAlgorithmSuites.default__.GetCompatibleCommitmentPolicy(d_2_algorithmSuite_)):
                                            coll0_ = coll0_.union(_dafny.Set([TestVectors.EncryptTestVector_PositiveEncryptKeyringVector((((_dafny.Seq("AWS KMS ECDH Static ")) + (((d_0_encryptKeyDescription_).KmsECDH).senderKeyId)) + (_dafny.Seq(" "))) + (((d_1_decryptKeyDescription_).KmsECDH).senderKeyId), Wrappers.Option_None(), _dafny.Map({}), d_3_commitmentPolicy_, d_2_algorithmSuite_, Wrappers.Option_None(), Wrappers.Option_None(), d_0_encryptKeyDescription_, d_1_decryptKeyDescription_, Wrappers.Option_None())]))
            return _dafny.Set(coll0_)
        return iife0_()
            ...
            for compr_0_ in (default__.StaticKmsDescriptionsEncryptSender).Elements:
                ...
                if (d_0_encryptKeyDescription_) in (default__.StaticKmsDescriptionsEncryptSender):
                    ...
                    for compr_1_ in (default__.DiscoveryKeyDescriptionsDecrypt).Elements:
                        d_1_decryptKeyDescription_: AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription = compr_1_
                        if ((d_1_decryptKeyDescription_) in (default__.DiscoveryKeyDescriptionsDecrypt)) and ((((d_1_decryptKeyDescription_).KmsECDH).curveSpec) == (((d_0_encryptKeyDescription_).KmsECDH).curveSpec)):
                            compr_2_: AwsCryptographyMaterialProvidersTypes.AlgorithmSuiteInfo
                            for compr_2_ in (AllAlgorithmSuites.default__.AllAlgorithmSuites).Elements:
                                d_2_algorithmSuite_: AwsCryptographyMaterialProvidersTypes.AlgorithmSuiteInfo = compr_2_
                                if (d_2_algorithmSuite_) in (AllAlgorithmSuites.default__.AllAlgorithmSuites):
                                    ...
                                    for compr_3_ in [AllAlgorithmSuites.default__.GetCompatibleCommitmentPolicy(d_2_algorithmSuite_)]:
                                        d_3_commitmentPolicy_: AwsCryptographyMaterialProvidersTypes.CommitmentPolicy = compr_3_
                                        if (d_3_commitmentPolicy_) == (AllAlgorithmSuites.default__.GetCompatibleCommitmentPolicy(d_2_algorithmSuite_)):
                                            coll0_ = coll0_.union(_dafny.Set([TestVectors.EncryptTestVector_PositiveEncryptKeyringVector((((_dafny.Seq("AWS KMS ECDH Discovery ")) + (((d_0_encryptKeyDescription_).KmsECDH).senderKeyId)) + (_dafny.Seq(" "))) + (((d_1_decryptKeyDescription_).KmsECDH).senderKeyId), Wrappers.Option_None(), _dafny.Map({}), d_3_commitmentPolicy_, d_2_algorithmSuite_, Wrappers.Option_None(), Wrappers.Option_None(), d_0_encryptKeyDescription_, d_1_decryptKeyDescription_, Wrappers.Option_None())]))
            return _dafny.Set(coll0_)
        return iife0_()
