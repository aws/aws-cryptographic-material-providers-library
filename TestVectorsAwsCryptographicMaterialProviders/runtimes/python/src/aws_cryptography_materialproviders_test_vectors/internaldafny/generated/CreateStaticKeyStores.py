...
class StaticKeyStore(AwsCryptographyKeyStoreTypes.IKeyStoreClient):
    ...
    def GetKeyStoreInfo(self):
        ...
        output = Wrappers.Result_Success(AwsCryptographyKeyStoreTypes.GetKeyStoreInfoOutput_GetKeyStoreInfoOutput(_dafny.Seq("key-store-id"), _dafny.Seq("key-store-name"), _dafny.Seq("logical-key-store-name"), _dafny.Seq([]), AwsCryptographyKeyStoreTypes.KMSConfiguration_kmsKeyArn(_dafny.Seq("arn:aws:kms:us-east-2:111122223333:key/1234abcd-12ab-34cd-56ef-1234567890ab"))))
        return output
