...
class default__:
    ...
    def KeyDescriptions(instance):
        def iife0_():
            coll0_ = _dafny.Set()
            compr_0_: _dafny.Seq
            for compr_0_ in (default__.AllAwsKMSMrkKeys).Elements:
                d_0_key_: _dafny.Seq = compr_0_
                if (d_0_key_) in (default__.AllAwsKMSMrkKeys):
                    coll0_ = coll0_.union(_dafny.Set([AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription_KmsMrk(AwsCryptographyMaterialProvidersTestVectorKeysTypes.KmsMrkAware_KmsMrkAware(d_0_key_))]))
    ...
    def Tests(instance):
        def iife0_():
            ...
            for compr_0_ in (default__.KeyDescriptions).Elements:
                ...
                if (d_0_encryptDescription_) in (default__.KeyDescriptions):
                                ...
                                if (d_2_algorithmSuite_) in (AllAlgorithmSuites.default__.AllAlgorithmSuites):
                                    ...
                                    for compr_3_ in [AllAlgorithmSuites.default__.GetCompatibleCommitmentPolicy(d_2_algorithmSuite_)]:
                                        ...
                                        if (d_3_commitmentPolicy_) == (AllAlgorithmSuites.default__.GetCompatibleCommitmentPolicy(d_2_algorithmSuite_)):
                                            coll0_ = coll0_.union(_dafny.Set([TestVectors.EncryptTestVector_PositiveEncryptKeyringVector((((_dafny.Seq("Generated KMS MRK ")) + (((d_0_encryptDescription_).KmsMrk).keyId)) + (_dafny.Seq("->"))) + (((d_1_decryptDescription_).KmsMrk).keyId), Wrappers.Option_None(), _dafny.Map({}), d_3_commitmentPolicy_, d_2_algorithmSuite_, Wrappers.Option_None(), Wrappers.Option_None(), d_0_encryptDescription_, d_1_decryptDescription_, Wrappers.Option_None())]))
            return _dafny.Set(coll0_)
        return iife0_()
