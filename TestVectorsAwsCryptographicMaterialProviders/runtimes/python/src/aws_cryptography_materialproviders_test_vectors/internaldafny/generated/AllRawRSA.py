...
class default__:
    ...
    def KeyDescriptions(instance):
        def iife0_():
            coll0_ = _dafny.Set()
            compr_0_: _dafny.Seq
            for compr_0_ in (default__.rsaPersistentKeyNamesWithoutPublicPrivate).Elements:
                d_0_key_: _dafny.Seq = compr_0_
                if (d_0_key_) in (default__.rsaPersistentKeyNamesWithoutPublicPrivate):
                    compr_1_: AwsCryptographyMaterialProvidersTypes.PaddingScheme
                    for compr_1_ in AwsCryptographyMaterialProvidersTypes.PaddingScheme.AllSingletonConstructors:
                        d_1_padding_: AwsCryptographyMaterialProvidersTypes.PaddingScheme = compr_1_
                        coll0_ = coll0_.union(_dafny.Set([AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription_RSA(AwsCryptographyMaterialProvidersTestVectorKeysTypes.RawRSA_RawRSA(d_0_key_, (_dafny.Seq("aws-raw-vectors-persistent-")) + (d_0_key_), d_1_padding_))]))
                        ...
                        if (d_1_algorithmSuite_) in (AllAlgorithmSuites.default__.AllAlgorithmSuites):
                            ...
                            for compr_2_ in [AllAlgorithmSuites.default__.GetCompatibleCommitmentPolicy(d_1_algorithmSuite_)]:
                                ...
                                if (d_2_commitmentPolicy_) == (AllAlgorithmSuites.default__.GetCompatibleCommitmentPolicy(d_1_algorithmSuite_)):
                                    def iife1_(_pat_let8_0):
                                        def iife2_(d_3_dt__update__tmp_h0_):
                                            def iife4_(_pat_let10_0):
                                                def iife5_(d_4_dt__update__tmp_h1_):
                                                    def iife6_(_pat_let11_0):
                                                        def iife7_(d_5_dt__update_hkeyId_h0_):
                                                            return AwsCryptographyMaterialProvidersTestVectorKeysTypes.RawRSA_RawRSA(d_5_dt__update_hkeyId_h0_, (d_4_dt__update__tmp_h1_).providerId, (d_4_dt__update__tmp_h1_).padding)
                                                        return iife7_(_pat_let11_0)
                                                    return iife6_((((d_0_keyDescription_).RSA).keyId) + (_dafny.Seq("-public")))
                                                return iife5_(_pat_let10_0)
                                            def iife3_(_pat_let9_0):
                                                def iife8_(d_6_dt__update_hRSA_h0_):
                                                    return AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription_RSA(d_6_dt__update_hRSA_h0_)
                                                return iife8_(_pat_let9_0)
                                            return iife3_(iife4_((d_0_keyDescription_).RSA))
                                        return iife2_(_pat_let8_0)
                                    def iife9_(_pat_let12_0):
                                        def iife10_(d_7_dt__update__tmp_h2_):
                                            def iife12_(_pat_let14_0):
                                                def iife13_(d_8_dt__update__tmp_h3_):
                                                    def iife14_(_pat_let15_0):
                                                        def iife15_(d_9_dt__update_hkeyId_h1_):
                                                            return AwsCryptographyMaterialProvidersTestVectorKeysTypes.RawRSA_RawRSA(d_9_dt__update_hkeyId_h1_, (d_8_dt__update__tmp_h3_).providerId, (d_8_dt__update__tmp_h3_).padding)
                                                        return iife15_(_pat_let15_0)
                                                    return iife14_((((d_0_keyDescription_).RSA).keyId) + (_dafny.Seq("-private")))
                                                return iife13_(_pat_let14_0)
                                            def iife11_(_pat_let13_0):
                                                def iife16_(d_10_dt__update_hRSA_h1_):
                                                    return AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription_RSA(d_10_dt__update_hRSA_h1_)
                                                return iife16_(_pat_let13_0)
                                            return iife11_(iife12_((d_0_keyDescription_).RSA))
                                        return iife10_(_pat_let12_0)
                                    coll0_ = coll0_.union(_dafny.Set([TestVectors.EncryptTestVector_PositiveEncryptKeyringVector((_dafny.Seq("Generated RawRSA ")) + (((d_0_keyDescription_).RSA).keyId), Wrappers.Option_None(), _dafny.Map({}), d_2_commitmentPolicy_, d_1_algorithmSuite_, Wrappers.Option_None(), Wrappers.Option_None(), iife1_(d_0_keyDescription_), iife9_(d_0_keyDescription_), Wrappers.Option_None())]))
            return _dafny.Set(coll0_)
        return iife0_()
