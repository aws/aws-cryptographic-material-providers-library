...
class default__:
    ...
    @_dafny.classproperty
    def psiECMap(instance):
        return _dafny.Map({default__.a: default__.a, default__.d: default__.d})
    @_dafny.classproperty
    def psiEC(instance):
        return _dafny.Set({default__.psiECMap})
    @_dafny.classproperty
    def replacementChar(instance):
        return _dafny.Seq([239, 191, 189])
    @_dafny.classproperty
    def replacementCharECMap(instance):
        return _dafny.Map({default__.a: default__.a, default__.replacementChar: default__.replacementChar})
    @_dafny.classproperty
    def replacementCharEC(instance):
        return _dafny.Set({default__.replacementCharECMap})
    @_dafny.classproperty
    def SuccessTestingRequiredEncryptionContextKeysReproducedEncryptionContext(instance):
        def iife0_():
            ...
            def iife4_():
                ...
                compr_6_: _dafny.Map
                for compr_6_ in (AllDefaultCmm.default__.SubSets(d_0_encryptionContext_, SortedSets.default__.SetToOrderedSequence2((d_0_encryptionContext_).keys, lambda6_))).Elements:
                    d_10_s_: _dafny.Map = compr_6_
                    if ((d_10_s_) in (AllDefaultCmm.default__.SubSets(d_0_encryptionContext_, SortedSets.default__.SetToOrderedSequence2((d_0_encryptionContext_).keys, lambda7_)))) and ((((d_10_s_).keys).intersection(d_4_requiredEncryptionContextKeys_)) == (d_4_requiredEncryptionContextKeys_)):
                    ...
                    for compr_1_ in (iife1_()
                        ...
                        if (d_4_requiredEncryptionContextKeys_) in (iife2_()
                            ...
                            def iife3_():
                                ...
                                compr_5_: _dafny.Map
                                for compr_5_ in (AllDefaultCmm.default__.SubSets(d_0_encryptionContext_, SortedSets.default__.SetToOrderedSequence2((d_0_encryptionContext_).keys, lambda4_))).Elements:
                                    d_8_s_: _dafny.Map = compr_5_
                                    if ((d_8_s_) in (AllDefaultCmm.default__.SubSets(d_0_encryptionContext_, SortedSets.default__.SetToOrderedSequence2((d_0_encryptionContext_).keys, lambda5_)))) and ((((d_8_s_).keys).intersection(d_4_requiredEncryptionContextKeys_)) == (d_4_requiredEncryptionContextKeys_)):
                            ...
                            for compr_4_ in (iife3_()
                                ...
                                if (d_9_reproducedEncryptionContext_) in (iife4_()
                                    ...
                                    def lambda9_(d_13_a_, d_14_b_):
                                        return (d_13_a_) < (d_14_b_)

                                    def lambda10_(d_15_a_, d_16_b_):
                                        return (d_15_a_) < (d_16_b_)

                                    coll0_ = coll0_.union(_dafny.Set([TestVectors.EncryptTestVector_PositiveEncryptKeyringVector(_dafny.Seq("Success testing requiredEncryptionContextKeys/reproducedEncryptionContext"), Wrappers.Option_None(), d_0_encryptionContext_, AllAlgorithmSuites.default__.GetCompatibleCommitmentPolicy(AllDefaultCmm.default__.StaticAlgorithmSuite), AllDefaultCmm.default__.StaticAlgorithmSuite, Wrappers.Option_None(), Wrappers.Option_Some(SortedSets.default__.SetToOrderedSequence2(d_4_requiredEncryptionContextKeys_, lambda8_)), AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription_RequiredEncryptionContext(AwsCryptographyMaterialProvidersTestVectorKeysTypes.RequiredEncryptionContextCMM_RequiredEncryptionContextCMM(AllDefaultCmm.default__.RawAesKeyring, SortedSets.default__.SetToOrderedSequence2(d_4_requiredEncryptionContextKeys_, lambda9_))), AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription_RequiredEncryptionContext(AwsCryptographyMaterialProvidersTestVectorKeysTypes.RequiredEncryptionContextCMM_RequiredEncryptionContextCMM(AllDefaultCmm.default__.RawAesKeyring, SortedSets.default__.SetToOrderedSequence2(d_4_requiredEncryptionContextKeys_, lambda10_))), Wrappers.Option_Some(d_9_reproducedEncryptionContext_))]))
    ...
    def FailureBadReproducedEncryptionContext(instance):
        def iife0_():
            ...
            def iife4_():
                ...
                compr_6_: _dafny.Map
                for compr_6_ in (AllDefaultCmm.default__.SubSets(default__.disjointEncryptionContext, SortedSets.default__.SetToOrderedSequence2((default__.disjointEncryptionContext).keys, lambda6_))).Elements:
                    d_10_s_: _dafny.Map = compr_6_
                    if ((d_10_s_) in (AllDefaultCmm.default__.SubSets(default__.disjointEncryptionContext, SortedSets.default__.SetToOrderedSequence2((default__.disjointEncryptionContext).keys, lambda7_)))) and ((d_10_s_) != (_dafny.Map({}))):
                        coll4_ = coll4_.union(_dafny.Set([d_10_s_]))
                return _dafny.Set(coll4_)
            def iife6_():
                ...
                compr_9_: _dafny.Map
                for compr_9_ in (AllDefaultCmm.default__.SubSets(d_0_encryptionContext_, SortedSets.default__.SetToOrderedSequence2((d_0_encryptionContext_).keys, lambda10_))).Elements:
                    d_15_s_: _dafny.Map = compr_9_
                    if (d_15_s_) in (AllDefaultCmm.default__.SubSets(d_0_encryptionContext_, SortedSets.default__.SetToOrderedSequence2((d_0_encryptionContext_).keys, lambda11_))):
                    ...
                    for compr_1_ in (iife1_()
                        ...
                        if (d_4_requiredEncryptionContextKeys_) in (iife2_()
                            ...
                            def iife3_():
                                ...
                                compr_5_: _dafny.Map
                                for compr_5_ in (AllDefaultCmm.default__.SubSets(default__.disjointEncryptionContext, SortedSets.default__.SetToOrderedSequence2((default__.disjointEncryptionContext).keys, lambda4_))).Elements:
                                    d_8_s_: _dafny.Map = compr_5_
                                    if ((d_8_s_) in (AllDefaultCmm.default__.SubSets(default__.disjointEncryptionContext, SortedSets.default__.SetToOrderedSequence2((default__.disjointEncryptionContext).keys, lambda5_)))) and ((d_8_s_) != (_dafny.Map({}))):
                                        coll3_ = coll3_.union(_dafny.Set([d_8_s_]))
                                return _dafny.Set(coll3_)
                            compr_4_: _dafny.Map
                            for compr_4_ in (iife3_()
                                ...
                                if (d_9_incorrectEncryptionContext_) in (iife4_()
                                    ...
                                    def iife5_():
                                        ...
                                        compr_8_: _dafny.Map
                                        for compr_8_ in (AllDefaultCmm.default__.SubSets(d_0_encryptionContext_, SortedSets.default__.SetToOrderedSequence2((d_0_encryptionContext_).keys, lambda8_))).Elements:
                                            d_13_s_: _dafny.Map = compr_8_
                                            if (d_13_s_) in (AllDefaultCmm.default__.SubSets(d_0_encryptionContext_, SortedSets.default__.SetToOrderedSequence2((d_0_encryptionContext_).keys, lambda9_))):
                                    ...
                                    for compr_7_ in (iife5_()
                                        ...
                                        if (d_14_reproducedEncryptionContext_) in (iife6_()
                                            ...
                                            def lambda13_(d_18_a_, d_19_b_):
                                                return (d_18_a_) < (d_19_b_)

                                            def lambda14_(d_20_a_, d_21_b_):
                                                return (d_20_a_) < (d_21_b_)

                                            coll0_ = coll0_.union(_dafny.Set([TestVectors.EncryptTestVector_PositiveEncryptNegativeDecryptKeyringVector(_dafny.Seq("Failure of reproducedEncryptionContext"), Wrappers.Option_None(), d_0_encryptionContext_, AllAlgorithmSuites.default__.GetCompatibleCommitmentPolicy(AllDefaultCmm.default__.StaticAlgorithmSuite), AllDefaultCmm.default__.StaticAlgorithmSuite, Wrappers.Option_None(), Wrappers.Option_Some(SortedSets.default__.SetToOrderedSequence2(d_4_requiredEncryptionContextKeys_, lambda12_)), _dafny.Seq("The reproducedEncryptionContext is not correct"), AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription_RequiredEncryptionContext(AwsCryptographyMaterialProvidersTestVectorKeysTypes.RequiredEncryptionContextCMM_RequiredEncryptionContextCMM(AllDefaultCmm.default__.RawAesKeyring, SortedSets.default__.SetToOrderedSequence2(d_4_requiredEncryptionContextKeys_, lambda13_))), AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription_RequiredEncryptionContext(AwsCryptographyMaterialProvidersTestVectorKeysTypes.RequiredEncryptionContextCMM_RequiredEncryptionContextCMM(AllDefaultCmm.default__.RawAesKeyring, SortedSets.default__.SetToOrderedSequence2(d_4_requiredEncryptionContextKeys_, lambda14_))), Wrappers.Option_Some(d_14_reproducedEncryptionContext_))]))
            return _dafny.Set(coll0_)
        return iife0_()
        
    @_dafny.classproperty
    def SuccessTestingRequiredEncryptionContextKeysReproducedEncryptionContextPsi(instance):
        def iife0_():
            def iife2_():
                def lambda3_(d_1_a_, d_2_d_):
                    return (d_1_a_) < (d_2_d_)

                coll2_ = _dafny.Set()
                def lambda2_(d_1_a_, d_2_d_):
                    return (d_1_a_) < (d_2_d_)
                ...
                return _dafny.Set(coll2_)
            def iife4_():
                def lambda7_(d_6_a_, d_7_d_):
                    return (d_6_a_) < (d_7_d_)

                coll4_ = _dafny.Set()
                def lambda6_(d_6_a_, d_7_d_):
                    return (d_6_a_) < (d_7_d_)
            ...
            coll0_ = _dafny.Set()
            compr_0_: _dafny.Map
            for compr_0_ in (default__.psiEC).Elements:
                d_0_encryptionContext_: _dafny.Map = compr_0_
                if (d_0_encryptionContext_) in (default__.psiEC):
                    def iife1_():
                        def lambda1_(d_1_a_, d_2_d_):
                            return (d_1_a_) < (d_2_d_)

                        coll1_ = _dafny.Set()
                        def lambda0_(d_1_a_, d_2_d_):
                            return (d_1_a_) < (d_2_d_)
                    ...
                    for compr_1_ in (iife1_()
                        ...
                        if (d_4_requiredEncryptionContextKeys_) in (iife2_()
                            ...
                            def iife3_():
                                def lambda5_(d_6_a_, d_7_d_):
                                    return (d_6_a_) < (d_7_d_)

                                coll3_ = _dafny.Set()
                                def lambda4_(d_6_a_, d_7_d_):
                                    return (d_6_a_) < (d_7_d_)
                            ...
                            for compr_4_ in (iife3_()
                                ...
                                if (d_9_reproducedEncryptionContext_) in (iife4_()
                                    ...
                                    def lambda8_(d_11_a_, d_12_d_):
                                        return (d_11_a_) < (d_12_d_)

                                    def lambda9_(d_13_a_, d_14_d_):
                                        return (d_13_a_) < (d_14_d_)

                                    def lambda10_(d_15_a_, d_16_d_):
                                        return (d_15_a_) < (d_16_d_)

                                    coll0_ = coll0_.union(_dafny.Set([TestVectors.EncryptTestVector_PositiveEncryptKeyringVector(_dafny.Seq("Success testing requiredEncryptionContextKeys/reproducedEncryptionContext"), Wrappers.Option_None(), d_0_encryptionContext_, AllAlgorithmSuites.default__.GetCompatibleCommitmentPolicy(AllDefaultCmm.default__.StaticAlgorithmSuite), AllDefaultCmm.default__.StaticAlgorithmSuite, Wrappers.Option_None(), Wrappers.Option_Some(SortedSets.default__.SetToOrderedSequence2(d_4_requiredEncryptionContextKeys_, lambda8_)), AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription_RequiredEncryptionContext(AwsCryptographyMaterialProvidersTestVectorKeysTypes.RequiredEncryptionContextCMM_RequiredEncryptionContextCMM(AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription_Kms(AwsCryptographyMaterialProvidersTestVectorKeysTypes.KMSInfo_KMSInfo(_dafny.Seq("us-west-2-decryptable"))), SortedSets.default__.SetToOrderedSequence2(d_4_requiredEncryptionContextKeys_, lambda9_))), AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription_RequiredEncryptionContext(AwsCryptographyMaterialProvidersTestVectorKeysTypes.RequiredEncryptionContextCMM_RequiredEncryptionContextCMM(AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription_Kms(AwsCryptographyMaterialProvidersTestVectorKeysTypes.KMSInfo_KMSInfo(_dafny.Seq("us-west-2-decryptable"))), SortedSets.default__.SetToOrderedSequence2(d_4_requiredEncryptionContextKeys_, lambda10_))), Wrappers.Option_Some(d_9_reproducedEncryptionContext_))]))
            return _dafny.Set(coll0_)
        return iife0_()
        
    @_dafny.classproperty
    def SuccessTestingRequiredEncryptionContextKeysReproducedEncryptionContextReplacementChar(instance):
        def iife0_():
            def iife2_():
                def lambda3_(d_1_a_, d_2_replacementChar_):
                    return (d_1_a_) < (d_2_replacementChar_)

                coll2_ = _dafny.Set()
                def lambda2_(d_1_a_, d_2_replacementChar_):
                    return (d_1_a_) < (d_2_replacementChar_)
                ...
                return _dafny.Set(coll2_)
            def iife4_():
                def lambda7_(d_6_a_, d_7_replacementChar_):
                    return (d_6_a_) < (d_7_replacementChar_)

                coll4_ = _dafny.Set()
                def lambda6_(d_6_a_, d_7_replacementChar_):
                    return (d_6_a_) < (d_7_replacementChar_)
            ...
            coll0_ = _dafny.Set()
            compr_0_: _dafny.Map
            for compr_0_ in (default__.replacementCharEC).Elements:
                d_0_encryptionContext_: _dafny.Map = compr_0_
                if (d_0_encryptionContext_) in (default__.replacementCharEC):
                    def iife1_():
                        def lambda1_(d_1_a_, d_2_replacementChar_):
                            return (d_1_a_) < (d_2_replacementChar_)

                        coll1_ = _dafny.Set()
                        def lambda0_(d_1_a_, d_2_replacementChar_):
                            return (d_1_a_) < (d_2_replacementChar_)
                    ...
                    for compr_1_ in (iife1_()
                        ...
                        if (d_4_requiredEncryptionContextKeys_) in (iife2_()
                            ...
                            def iife3_():
                                def lambda5_(d_6_a_, d_7_replacementChar_):
                                    return (d_6_a_) < (d_7_replacementChar_)

                                coll3_ = _dafny.Set()
                                def lambda4_(d_6_a_, d_7_replacementChar_):
                                    return (d_6_a_) < (d_7_replacementChar_)
                            ...
                            for compr_4_ in (iife3_()
                                ...
                                if (d_9_reproducedEncryptionContext_) in (iife4_()
                                    ...
                                    def lambda8_(d_11_a_, d_12_replacementChar_):
                                        return (d_11_a_) < (d_12_replacementChar_)

                                    def lambda9_(d_13_a_, d_14_replacementChar_):
                                        return (d_13_a_) < (d_14_replacementChar_)

                                    def lambda10_(d_15_a_, d_16_replacementChar_):
                                        return (d_15_a_) < (d_16_replacementChar_)
    ...
    @_dafny.classproperty
    def Tests(instance):
        return ((((_dafny.Set({})) | (default__.SuccessTestingRequiredEncryptionContextKeysReproducedEncryptionContextPsi)) | (default__.SuccessTestingRequiredEncryptionContextKeysReproducedEncryptionContext)) | (default__.FailureBadReproducedEncryptionContext)) | (default__.SuccessTestingRequiredEncryptionContextKeysReproducedEncryptionContextReplacementChar)
