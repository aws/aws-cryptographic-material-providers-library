...
class MaterialProvidersShim(aws_cryptographic_material_providers.internaldafny.generated.AwsCryptographyMaterialProvidersTypes.IAwsCryptographicMaterialProvidersClient):
    ...
    def CreateCachingCMM(self, input):
        try:
            smithy_client_request: aws_cryptographic_material_providers.smithygenerated.aws_cryptography_materialproviders.models.CreateCachingCMMInput = aws_cryptographic_material_providers.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_CreateCachingCMMInput(input)
            smithy_client_response = self._impl.create_caching_cmm(smithy_client_request)
            return Wrappers.Result_Success(aws_cryptographic_material_providers.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_CreateCachingCMMOutput(smithy_client_response))
        except Exception as e:
            return Wrappers.Result_Failure(_smithy_error_to_dafny_error(e))
