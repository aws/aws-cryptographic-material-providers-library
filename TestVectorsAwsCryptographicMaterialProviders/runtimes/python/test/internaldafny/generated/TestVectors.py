...
class default__:
    ...
    def ToDecryptTest(keys, test, materials):
        ...
        out332_ = (keys).CreateWappedTestVectorKeyring(software_amazon_cryptography_materialproviderstestvectorkeys_internaldafny_types.TestVectorKeyringInput_TestVectorKeyringInput((d_1787_vector_).keyDescription))
