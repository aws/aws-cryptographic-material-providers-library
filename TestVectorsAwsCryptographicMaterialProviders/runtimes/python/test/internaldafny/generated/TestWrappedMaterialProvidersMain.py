...
class default__:
    ...
    def TestGenerateEncryptManifest():
        ...
        if not((d_1_result_).is_Success):
            raise _dafny.HaltException("dafny/TestVectorsAwsCryptographicMaterialProviders/test/RunMain.dfy(37,4): " + _dafny.string_of(_dafny.Seq("expectation violation")))
    ...
    def TestEncryptManifest():
        ...
        d_1_result_: Wrappers.Result
        out1_: Wrappers.Result
        out1_ = TestManifests.default__.StartEncrypt(MplManifestOptions.ManifestOptions_Encrypt((d_0_directory_) + (_dafny.Seq("dafny/TestVectorsAwsCryptographicMaterialProviders/test/")), (d_0_directory_) + (_dafny.Seq("dafny/TestVectorsAwsCryptographicMaterialProviders/")), Wrappers.Option_None()))
        d_1_result_ = out1_
        if (d_1_result_).is_Failure:
            _dafny.print(_dafny.string_of((d_1_result_).error))
        if not((d_1_result_).is_Success):
    ...
    def TestDecryptManifest():
        ...
        d_1_result_: Wrappers.Result
        out1_: Wrappers.Result
        out1_ = TestManifests.default__.StartDecrypt(MplManifestOptions.ManifestOptions_Decrypt((d_0_directory_) + (_dafny.Seq("dafny/TestVectorsAwsCryptographicMaterialProviders/")), Wrappers.Option_None()))
        d_1_result_ = out1_
        if (d_1_result_).is_Failure:
            _dafny.print(_dafny.string_of(d_1_result_))
        if not((d_1_result_).is_Success):
            raise _dafny.HaltException("dafny/TestVectorsAwsCryptographicMaterialProviders/test/RunMain.dfy(64,4): " + _dafny.string_of(_dafny.Seq("expectation violation")))
