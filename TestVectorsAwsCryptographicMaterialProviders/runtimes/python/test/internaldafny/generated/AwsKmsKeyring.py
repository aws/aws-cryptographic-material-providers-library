...
class AwsKmsKeyring(Keyring.VerifiableInterface, software_amazon_cryptography_materialproviders_internaldafny_types.IKeyring):
    ...
    def OnEncrypt_k(self, input):
        ...
        d_421_valueOrError0_: Wrappers.Result = Wrappers.Result_Success.default(_dafny.Map)()
        ...
        d_422_kmsGenerateAndWrap_: AwsKmsKeyring.KmsGenerateAndWrapKeyMaterial
        nw1_ = AwsKmsKeyring.KmsGenerateAndWrapKeyMaterial()
        nw1_.ctor__((self).client, (self).awsKmsKey, (self).grantTokens)
        d_422_kmsGenerateAndWrap_ = nw1_
        d_423_kmsWrap_: AwsKmsKeyring.KmsWrapKeyMaterial
        nw2_ = AwsKmsKeyring.KmsWrapKeyMaterial()
        nw2_.ctor__((self).client, (self).awsKmsKey, (self).grantTokens)
        d_423_kmsWrap_ = nw2_
        d_424_wrapOutput_: EdkWrapping.WrapEdkMaterialOutput
        d_425_valueOrError1_: Wrappers.Result = Wrappers.Result_Success.default(EdkWrapping.WrapEdkMaterialOutput.default(AwsKmsKeyring.KmsWrapInfo.default()))()
        ...
        d_429_valueOrError2_: Wrappers.Result = Wrappers.Result_Success.default(UTF8.ValidUTF8Bytes.default)()
        ...
        d_430_valueOrError3_: Wrappers.Outcome = Wrappers.Outcome_Pass.default()()
        d_430_valueOrError3_ = Wrappers.default__.Need((len(d_428_providerInfo_)) < ((StandardLibrary_mUInt.default__).UINT16__LIMIT), software_amazon_cryptography_materialproviders_internaldafny_types.Error_AwsCryptographicMaterialProvidersException(_dafny.Seq("Invalid response from AWS KMS GenerateDataKey: Key ID too long.")))
    ...
    def OnDecrypt_k(self, input):
        ...
        d_438_valueOrError0_: Wrappers.Outcome = Wrappers.Outcome_Pass.default()()
        ...
        if (d_438_valueOrError0_).IsFailure():
            ...
            return res
        d_439_filter_: AwsKmsKeyring.OnDecryptEncryptedDataKeyFilter
        nw3_ = AwsKmsKeyring.OnDecryptEncryptedDataKeyFilter()
        nw3_.ctor__((self).awsKmsKey)
        d_439_filter_ = nw3_
        d_440_edksToAttempt_: _dafny.Seq
        d_441_valueOrError1_: Wrappers.Result = Wrappers.Result_Success.default(_dafny.Seq)()
        ...
        d_442_valueOrError2_: Wrappers.Outcome = Wrappers.Outcome_Pass.default()()
        ...
        nw4_ = AwsKmsKeyring.DecryptSingleEncryptedDataKey()
...
class OnDecryptEncryptedDataKeyFilter(Actions.DeterministicActionWithResult, Actions.DeterministicAction):
    ...
    def Invoke(self, edk):
        ...
        d_449_valueOrError0_: Wrappers.Result = Wrappers.Result_Success.default(_dafny.Seq)()
...
class DecryptSingleEncryptedDataKey(Actions.ActionWithResult, Actions.Action):
    ...
    def Invoke(self, edk):
        res: Wrappers.Result = None
        d_452_kmsUnwrap_: AwsKmsKeyring.KmsUnwrapKeyMaterial
        nw5_ = AwsKmsKeyring.KmsUnwrapKeyMaterial()
        ...
        d_455_valueOrError0_: Wrappers.Result = Wrappers.Result_Success.default(EdkWrapping.UnwrapEdkMaterialOutput.default(AwsKmsKeyring.KmsUnwrapInfo.default()))()
...
class KmsUnwrapKeyMaterial(MaterialWrapping.UnwrapMaterial, Actions.ActionWithResult, Actions.Action):
    ...
    def Invoke(self, input):
        ...
        d_458_valueOrError0_: Wrappers.Outcome = Wrappers.Outcome_Pass.default()()
        ...
        d_460_valueOrError1_: Wrappers.Result = Wrappers.Result_Success.default(_dafny.Map)()
        ...
        d_464_valueOrError2_: Wrappers.Result = Wrappers.Result_Success.default(software_amazon_cryptography_services_kms_internaldafny_types.DecryptResponse.default())()
        ...
        d_466_valueOrError3_: Wrappers.Outcome = Wrappers.Outcome_Pass.default()()
        ...
        d_467_output_ = MaterialWrapping.UnwrapOutput_UnwrapOutput(((d_463_decryptResponse_).Plaintext).value, AwsKmsKeyring.KmsUnwrapInfo_KmsUnwrapInfo())
...
class KmsGenerateAndWrapKeyMaterial(MaterialWrapping.GenerateAndWrapMaterial, Actions.ActionWithResult, Actions.Action):
    ...
    def Invoke(self, input):
        ...
        d_470_valueOrError0_: Wrappers.Result = Wrappers.Result_Success.default(_dafny.Map)()
        ...
        d_474_valueOrError1_: Wrappers.Result = Wrappers.Result_Success.default(software_amazon_cryptography_services_kms_internaldafny_types.GenerateDataKeyResponse.default())()
        ...
        d_476_valueOrError2_: Wrappers.Outcome = Wrappers.Outcome_Pass.default()()
        ...
        if (d_476_valueOrError2_).IsFailure():
            ...
            return res
        d_477_valueOrError3_: Wrappers.Outcome = Wrappers.Outcome_Pass.default()()
        ...
        if (d_477_valueOrError3_).IsFailure():
            ...
            return res
        d_478_valueOrError4_: Wrappers.Outcome = Wrappers.Outcome_Pass.default()()
        ...
        d_479_output_ = MaterialWrapping.GenerateAndWrapOutput_GenerateAndWrapOutput(((d_473_generateResponse_).Plaintext).value, ((d_473_generateResponse_).CiphertextBlob).value, AwsKmsKeyring.KmsWrapInfo_KmsWrapInfo(((d_473_generateResponse_).KeyId).value))
...
class KmsWrapKeyMaterial(MaterialWrapping.WrapMaterial, Actions.ActionWithResult, Actions.Action):
    ...
    def Invoke(self, input):
        ...
        d_482_valueOrError0_: Wrappers.Result = Wrappers.Result_Success.default(_dafny.Map)()
        ...
        d_483_valueOrError1_: Wrappers.Outcome = Wrappers.Outcome_Pass.default()()
        ...
        d_487_valueOrError2_: Wrappers.Result = Wrappers.Result_Success.default(software_amazon_cryptography_services_kms_internaldafny_types.EncryptResponse.default())()
        ...
        d_489_valueOrError3_: Wrappers.Outcome = Wrappers.Outcome_Pass.default()()
        ...
        if (d_489_valueOrError3_).IsFailure():
            ...
            return res
        d_490_valueOrError4_: Wrappers.Outcome = Wrappers.Outcome_Pass.default()()
        ...
        d_491_output_ = MaterialWrapping.WrapOutput_WrapOutput(((d_486_encryptResponse_).CiphertextBlob).value, AwsKmsKeyring.KmsWrapInfo_KmsWrapInfo(((d_486_encryptResponse_).KeyId).value))
