...
class default__:
    ...
    def CreateAwsKmsKeyring(config, input):
        ...
        d_1116___v0_: tuple
        d_1117_valueOrError0_: Wrappers.Result = Wrappers.Result_Success.default(_dafny.defaults.tuple())()
        ...
        d_1119_valueOrError1_: Wrappers.Result = Wrappers.Result_Success.default(_dafny.Seq)()
    ...
    def CreateAwsKmsDiscoveryKeyring(config, input):
        ...
        if ((input).discoveryFilter).is_Some:
            d_1121___v1_: tuple
            d_1122_valueOrError0_: Wrappers.Result = Wrappers.Result_Success.default(_dafny.defaults.tuple())()
        ...
        d_1124_valueOrError1_: Wrappers.Result = Wrappers.Result_Success.default(_dafny.Seq)()
    ...
    def CreateAwsKmsMultiKeyring(config, input):
        ...
        if ((input).clientSupplier).is_Some:
            ...
            out229_ = AwsCryptographyMaterialProvidersOperations.default__.CreateDefaultClientSupplier(config, software_amazon_cryptography_materialproviders_internaldafny_types.CreateDefaultClientSupplierInput_CreateDefaultClientSupplierInput())
    ...
    def CreateAwsKmsDiscoveryMultiKeyring(config, input):
        ...
        d_1131_valueOrError0_: Wrappers.Result = Wrappers.Result_Success.default(_dafny.Seq)()
        ...
        if ((input).clientSupplier).is_None:
            ...
            out231_ = AwsCryptographyMaterialProvidersOperations.default__.CreateDefaultClientSupplier(config, software_amazon_cryptography_materialproviders_internaldafny_types.CreateDefaultClientSupplierInput_CreateDefaultClientSupplierInput())
    ...
    def CreateAwsKmsMrkKeyring(config, input):
        output: Wrappers.Result = None
        d_1134___v2_: tuple
        d_1135_valueOrError0_: Wrappers.Result = Wrappers.Result_Success.default(_dafny.defaults.tuple())()
        ...
        d_1137_valueOrError1_: Wrappers.Result = Wrappers.Result_Success.default(_dafny.Seq)()
    ...
    def CreateAwsKmsMrkMultiKeyring(config, input):
        ...
        d_1140_valueOrError0_: Wrappers.Result = Wrappers.Result_Success.default(_dafny.Seq)()
        ...
        if ((input).clientSupplier).is_None:
            ...
            out233_ = AwsCryptographyMaterialProvidersOperations.default__.CreateDefaultClientSupplier(config, software_amazon_cryptography_materialproviders_internaldafny_types.CreateDefaultClientSupplierInput_CreateDefaultClientSupplierInput())
    ...
    def CreateAwsKmsMrkDiscoveryKeyring(config, input):
        ...
        if ((input).discoveryFilter).is_Some:
            d_1143___v3_: tuple
            d_1144_valueOrError0_: Wrappers.Result = Wrappers.Result_Success.default(_dafny.defaults.tuple())()
        ...
        d_1146_valueOrError1_: Wrappers.Outcome = Wrappers.Outcome_Pass.default()()
        ...
        d_1148_valueOrError2_: Wrappers.Result = Wrappers.Result_Success.default(_dafny.Seq)()
    ...
    def CreateAwsKmsMrkDiscoveryMultiKeyring(config, input):
        ...
        d_1151_valueOrError0_: Wrappers.Result = Wrappers.Result_Success.default(_dafny.Seq)()
        ...
        if ((input).clientSupplier).is_None:
            ...
            out235_ = AwsCryptographyMaterialProvidersOperations.default__.CreateDefaultClientSupplier(config, software_amazon_cryptography_materialproviders_internaldafny_types.CreateDefaultClientSupplierInput_CreateDefaultClientSupplierInput())
    ...
    def CreateAwsKmsHierarchicalKeyring(config, input):
        output: Wrappers.Result = None
        d_1154_maxCacheSize_: BoundedInts.int32 = int(0)
        ...
        d_1156_valueOrError0_: Wrappers.Outcome = Wrappers.Outcome_Pass.default()()
        ...
        if (d_1156_valueOrError0_).IsFailure():
            ...
            return output
        d_1157_valueOrError1_: Wrappers.Outcome = Wrappers.Outcome_Pass.default()()
        ...
        out237_ = AwsCryptographyMaterialProvidersOperations.default__.CreateCryptographicMaterialsCache(config, software_amazon_cryptography_materialproviders_internaldafny_types.CreateCryptographicMaterialsCacheInput_CreateCryptographicMaterialsCacheInput(d_1155_cache_))
    ...
    def CreateMultiKeyring(config, input):
        output: Wrappers.Result = None
        d_1161_valueOrError0_: Wrappers.Outcome = Wrappers.Outcome_Pass.default()()
    ...
    def CreateRawAesKeyring(config, input):
        output: Wrappers.Result = None
        d_1163_valueOrError0_: Wrappers.Outcome = Wrappers.Outcome_Pass.default()()
        ...
        d_1166_valueOrError1_: Wrappers.Result = Wrappers.Result_Success.default(_dafny.defaults.tuple(UTF8.ValidUTF8Bytes.default, UTF8.ValidUTF8Bytes.default))()
        ...
        d_1169_valueOrError2_: Wrappers.Outcome = Wrappers.Outcome_Pass.default()()
    ...
    def CreateRawRsaKeyring(config, input):
        output: Wrappers.Result = None
        d_1172_valueOrError0_: Wrappers.Outcome = Wrappers.Outcome_Pass.default()()
        ...
        if (d_1172_valueOrError0_).IsFailure():
            ...
            return output
        d_1173_valueOrError1_: Wrappers.Outcome = Wrappers.Outcome_Pass.default()()
        ...
        d_1176_valueOrError2_: Wrappers.Result = Wrappers.Result_Success.default(_dafny.defaults.tuple(UTF8.ValidUTF8Bytes.default, UTF8.ValidUTF8Bytes.default))()
    ...
    def CreateAwsKmsRsaKeyring(config, input):
        ...
        if (d_1180_valueOrError0_).IsFailure():
            ...
            return output
        d_1181_valueOrError1_: Wrappers.Outcome = Wrappers.Outcome_Pass.default()()
        ...
        if ((input).publicKey).is_Some:
            ...
            d_1187_valueOrError4_: Wrappers.Outcome = Wrappers.Outcome_Pass.default()()
            ...
            if (d_1187_valueOrError4_).IsFailure():
                ...
                return output
        d_1188___v4_: tuple
        d_1189_valueOrError5_: Wrappers.Result = Wrappers.Result_Success.default(_dafny.defaults.tuple())()
        ...
        d_1191_valueOrError6_: Wrappers.Result = Wrappers.Result_Success.default(_dafny.Seq)()
    ...
    def CreateRequiredEncryptionContextCMM(config, input):
        output: Wrappers.Result = None
        d_1194_valueOrError0_: Wrappers.Outcome = Wrappers.Outcome_Pass.default()()
        d_1194_valueOrError0_ = Wrappers.default__.Need((((input).underlyingCMM).is_Some) and (((input).keyring).is_None), AwsCryptographyMaterialProvidersOperations.default__.CmpError(_dafny.Seq("CreateRequiredEncryptionContextCMM currently only supports cmm.")))
        ...
        d_1197_valueOrError1_: Wrappers.Outcome = Wrappers.Outcome_Pass.default()()
        d_1197_valueOrError1_ = Wrappers.default__.Need((0) < (len(d_1195_keySet_)), AwsCryptographyMaterialProvidersOperations.default__.CmpError(_dafny.Seq("RequiredEncryptionContextCMM needs at least one requiredEncryptionContextKey.")))
    ...
    def CreateCryptographicMaterialsCache(config, input):
        ...
        if source36_.is_Default:
            ...
            nw66_.ctor__((d_1209_c_).entryCapacity, ((d_1209_c_).entryPruningTailSize).UnwrapOr(1))
            d_1210_cmc_ = nw66_
            ...
            nw67_.ctor__((d_1212_c_).entryCapacity, ((d_1212_c_).entryPruningTailSize).UnwrapOr(1))
            d_1213_cmc_ = nw67_
            ...
            nw69_.ctor__(d_1216_c_)
            d_1217_cmc_ = nw69_
            d_1218_synCmc_: software_amazon_cryptography_internaldafny_StormTrackingCMC.StormTrackingCMC
            nw70_ = software_amazon_cryptography_internaldafny_StormTrackingCMC.StormTrackingCMC(d_1217_cmc_)
            d_1218_synCmc_ = nw70_
            output = Wrappers.Result_Success(d_1218_synCmc_)
            return output
        return output
    ...
    def CreateDefaultClientSupplier(config, input):
        output: Wrappers.Result = None
        d_1219_clientSupplier_: DefaultClientSupplier.DefaultClientSupplier
        nw71_ = DefaultClientSupplier.DefaultClientSupplier()
        nw71_.ctor__()
        d_1219_clientSupplier_ = nw71_
        output = Wrappers.Result_Success(d_1219_clientSupplier_)
        return output
        return output
    ...
    def ValidEncryptionMaterialsTransition(config, input):
        d_1220_valueOrError0_ = Wrappers.default__.Need(Materials.default__.ValidEncryptionMaterialsTransition((input).start, (input).stop), software_amazon_cryptography_materialproviders_internaldafny_types.Error_InvalidEncryptionMaterialsTransition(_dafny.Seq("Invalid Encryption Materials Transition")))
        if (d_1220_valueOrError0_).IsFailure():
            return (d_1220_valueOrError0_).PropagateFailure()
        elif True:
            return Wrappers.Result_Success(())

    @staticmethod
    def ValidDecryptionMaterialsTransition(config, input):
        d_1221_valueOrError0_ = Wrappers.default__.Need(Materials.default__.DecryptionMaterialsTransitionIsValid((input).start, (input).stop), software_amazon_cryptography_materialproviders_internaldafny_types.Error_InvalidDecryptionMaterialsTransition(_dafny.Seq("Invalid Decryption Materials Transition")))
        if (d_1221_valueOrError0_).IsFailure():
            return (d_1221_valueOrError0_).PropagateFailure()
        elif True:
            return Wrappers.Result_Success(())

    @staticmethod
    def EncryptionMaterialsHasPlaintextDataKey(config, input):
        d_1222_valueOrError0_ = Wrappers.default__.Need(Materials.default__.EncryptionMaterialsHasPlaintextDataKey(input), software_amazon_cryptography_materialproviders_internaldafny_types.Error_InvalidDecryptionMaterials(_dafny.Seq("Invalid Encryption Materials")))
    ...
    def DecryptionMaterialsWithPlaintextDataKey(config, input):
        d_1223_valueOrError0_ = Wrappers.default__.Need(Materials.default__.DecryptionMaterialsWithPlaintextDataKey(input), software_amazon_cryptography_materialproviders_internaldafny_types.Error_InvalidDecryptionMaterials(_dafny.Seq("Invalid Decryption Materials")))
    ...
    def ValidAlgorithmSuiteInfo(config, input):
        d_1224_valueOrError0_ = Wrappers.default__.Need(AlgorithmSuites.default__.AlgorithmSuite_q(input), software_amazon_cryptography_materialproviders_internaldafny_types.Error_InvalidAlgorithmSuiteInfo(_dafny.Seq("Invalid AlgorithmSuiteInfo")))
    ...
    def ValidateCommitmentPolicyOnEncrypt(config, input):
        d_1225_valueOrError0_ = Commitment.default__.ValidateCommitmentPolicyOnEncrypt((input).algorithm, (input).commitmentPolicy)
    ...
    def ValidateCommitmentPolicyOnDecrypt(config, input):
        d_1226_valueOrError0_ = Commitment.default__.ValidateCommitmentPolicyOnDecrypt((input).algorithm, (input).commitmentPolicy)
