...
class default__:
    ...
    def ToKeyring(mpl, info):
        ...
        if source40_.is_Kms:
            ...
            if True:
                ...
                d_1538_valueOrError1_ = Wrappers.default__.Need(((d_1534_material_).is_Some) and (((d_1534_material_).value).is_KMS), software_amazon_cryptography_materialproviderstestvectorkeys_internaldafny_types.Error_KeyVectorException(_dafny.Seq("Not type: KMS")))
                ...
                def lambda92_(d_1543_e_):
                    return software_amazon_cryptography_materialproviderstestvectorkeys_internaldafny_types.Error_AwsCryptographyMaterialProviders(d_1543_e_)
            ...
            if True:
                ...
                d_1547_valueOrError3_ = Wrappers.default__.Need(((d_1534_material_).is_Some) and (((d_1534_material_).value).is_KMS), software_amazon_cryptography_materialproviderstestvectorkeys_internaldafny_types.Error_KeyVectorException(_dafny.Seq("Not type: KMS")))
                ...
                def lambda93_(d_1552_e_):
                    return software_amazon_cryptography_materialproviderstestvectorkeys_internaldafny_types.Error_AwsCryptographyMaterialProviders(d_1552_e_)
            ...
            if True:
                ...
                d_1559_valueOrError8_ = Wrappers.default__.Need((d_1534_material_).is_None, software_amazon_cryptography_materialproviderstestvectorkeys_internaldafny_types.Error_KeyVectorException(_dafny.Seq("Discovery has not key")))
                ...
                def lambda94_(d_1562_e_):
                    return software_amazon_cryptography_materialproviderstestvectorkeys_internaldafny_types.Error_AwsCryptographyMaterialProviders(d_1562_e_)
            ...
            if True:
                ...
                if source46_.is_PrivateRSA:
                    ...
                    if True:
                        ...
                        d_1583_valueOrError12_ = Wrappers.default__.Need(d_1582_decrypt_, software_amazon_cryptography_materialproviderstestvectorkeys_internaldafny_types.Error_KeyVectorException(_dafny.Seq("Private RSA keys only supports decrypt.")))
                        ...
                        def lambda95_(d_1586_e_):
                            return software_amazon_cryptography_materialproviderstestvectorkeys_internaldafny_types.Error_KeyVectorException(d_1586_e_)
                        ...
                        def lambda96_(d_1589_e_):
                            return software_amazon_cryptography_materialproviderstestvectorkeys_internaldafny_types.Error_AwsCryptographyMaterialProviders(d_1589_e_)
                    ...
                    if True:
                        ...
                        d_1601_valueOrError14_ = Wrappers.default__.Need(d_1600_encrypt_, software_amazon_cryptography_materialproviderstestvectorkeys_internaldafny_types.Error_KeyVectorException(_dafny.Seq("Public RSA keys only supports encrypt.")))
                        ...
                        def lambda97_(d_1604_e_):
                            return software_amazon_cryptography_materialproviderstestvectorkeys_internaldafny_types.Error_KeyVectorException(d_1604_e_)
                        ...
                        def lambda98_(d_1607_e_):
                            return software_amazon_cryptography_materialproviderstestvectorkeys_internaldafny_types.Error_AwsCryptographyMaterialProviders(d_1607_e_)
            ...
            if True:
                ...
                d_1613_valueOrError9_ = Wrappers.default__.Need(((d_1534_material_).is_Some) and (((d_1534_material_).value).is_Symetric), software_amazon_cryptography_materialproviderstestvectorkeys_internaldafny_types.Error_KeyVectorException(_dafny.Seq("Not type: Symetric")))
                ...
                def lambda99_(d_1618_e_):
                    return software_amazon_cryptography_materialproviderstestvectorkeys_internaldafny_types.Error_AwsCryptographyMaterialProviders(d_1618_e_)
            ...
            if True:
                ...
                d_1622_valueOrError0_ = Wrappers.default__.Need(((d_1534_material_).is_Some) and (((d_1534_material_).value).is_StaticMaterial), software_amazon_cryptography_materialproviderstestvectorkeys_internaldafny_types.Error_KeyVectorException(_dafny.Seq("Not type: StaticMaterial")))
            ...
            if True:
                ...
                d_1631_valueOrError5_ = Wrappers.default__.Need(((d_1534_material_).is_Some) and (((d_1534_material_).value).is_KMSAsymetric), software_amazon_cryptography_materialproviderstestvectorkeys_internaldafny_types.Error_KeyVectorException(_dafny.Seq("Not type: KMSAsymetric")))
                ...
                def lambda100_(d_1636_e_):
                    return software_amazon_cryptography_materialproviderstestvectorkeys_internaldafny_types.Error_AwsCryptographyMaterialProviders(d_1636_e_)
            ...
            if True:
                ...
                d_1640_valueOrError7_ = Wrappers.default__.Need(((d_1534_material_).is_Some) and (((d_1534_material_).value).is_StaticKeyStoreInformation), software_amazon_cryptography_materialproviderstestvectorkeys_internaldafny_types.Error_KeyVectorException(_dafny.Seq("Not type: StaticKeyStoreInformation")))
                ...
                def lambda101_(d_1644_e_):
                    return software_amazon_cryptography_materialproviderstestvectorkeys_internaldafny_types.Error_AwsCryptographyMaterialProviders(d_1644_e_)
    ...
    def getKmsClient(mpl, maybeKmsArn):
        ...
        def lambda102_(d_1648_e_):
            return software_amazon_cryptography_materialproviderstestvectorkeys_internaldafny_types.Error_AwsCryptographyMaterialProviders(d_1648_e_)
        ...
        def lambda103_(d_1651_e_):
            return software_amazon_cryptography_materialproviderstestvectorkeys_internaldafny_types.Error_KeyVectorException(d_1651_e_)
        ...
        def lambda104_(d_1653_e_):
            return software_amazon_cryptography_materialproviderstestvectorkeys_internaldafny_types.Error_AwsCryptographyMaterialProviders(d_1653_e_)
