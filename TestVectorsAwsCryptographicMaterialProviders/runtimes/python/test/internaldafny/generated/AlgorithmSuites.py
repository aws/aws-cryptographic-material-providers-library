...
class default__:
    ...
    def ESDKAlgorithmSuite_q(a):
        ...
        return ((AlgorithmSuites.default__.AlgorithmSuiteInfo_q(a)) and (AlgorithmSuites.default__.SupportedESDKEncrypt_q((a).encrypt))) and (lambda0_(((a).id).ESDK))
    ...
    def DBEAlgorithmSuite_q(a):
        ...
        return (((AlgorithmSuites.default__.AlgorithmSuiteInfo_q(a)) and (AlgorithmSuites.default__.SupportedDBEEncrypt_q((a).encrypt))) and (AlgorithmSuites.default__.SupportedDBEEDKWrapping_q((a).edkWrapping))) and (lambda1_(((a).id).DBE))
    ...
    def GetSuite(id):
        ...
        if source3_.is_ESDK:
            ...
            return AlgorithmSuites.default__.GetESDKSuite(d_3_e_)
        elif True:
            d_4___mcc_h1_ = source3_.DBE
            d_5_e_ = d_4___mcc_h1_
            return AlgorithmSuites.default__.GetDBESuite(d_5_e_)
    ...
    def GetAlgorithmSuiteInfo(binaryId_q):
        d_12_valueOrError0_ = Wrappers.default__.Need((binaryId_q) in ((AlgorithmSuites.default__).AlgorithmSuiteInfoByBinaryId), software_amazon_cryptography_materialproviders_internaldafny_types.Error_AwsCryptographicMaterialProvidersException(_dafny.Seq("Invalid BinaryId")))
