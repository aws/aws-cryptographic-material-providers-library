...
class default__:
    ...
    def EncryptionContextDigest(cryptoPrimitives, encryptionContext):
        ...
        d_893_valueOrError0_: Wrappers.Result = Wrappers.Result_Success.default(_dafny.Seq)()
        ...
        d_897_valueOrError1_: Wrappers.Result = Wrappers.Result_Success.default(_dafny.Seq)()
...
class AwsKmsRsaKeyring(Keyring.VerifiableInterface, software_amazon_cryptography_materialproviders_internaldafny_types.IKeyring):
    ...
    def OnEncrypt_k(self, input):
        ...
        d_900_valueOrError0_: Wrappers.Outcome = Wrappers.Outcome_Pass.default()()
        ...
        if (d_900_valueOrError0_).IsFailure():
            ...
            return res
        d_901_valueOrError1_: Wrappers.Outcome = Wrappers.Outcome_Pass.default()()
        ...
        if (d_901_valueOrError1_).IsFailure():
            ...
            return res
        d_902_wrap_: AwsKmsRsaKeyring.KmsRsaWrapKeyMaterial
        nw39_ = AwsKmsRsaKeyring.KmsRsaWrapKeyMaterial()
        nw39_.ctor__(((self).publicKey).value, (self).paddingScheme, (self).cryptoPrimitives)
        d_902_wrap_ = nw39_
        d_903_generateAndWrap_: AwsKmsRsaKeyring.KmsRsaGenerateAndWrapKeyMaterial
        nw40_ = AwsKmsRsaKeyring.KmsRsaGenerateAndWrapKeyMaterial()
        ...
        d_905_valueOrError2_: Wrappers.Result = Wrappers.Result_Success.default(EdkWrapping.WrapEdkMaterialOutput.default(AwsKmsRsaKeyring.KmsRsaWrapInfo.default()))()
    ...
    def OnDecrypt_k(self, input):
        ...
        d_913_valueOrError1_: Wrappers.Outcome = Wrappers.Outcome_Pass.default()()
        ...
        if (d_913_valueOrError1_).IsFailure():
            ...
            return res
        d_914_valueOrError2_: Wrappers.Outcome = Wrappers.Outcome_Pass.default()()
        ...
        d_917_valueOrError3_: Wrappers.Result = Wrappers.Result_Success.default(_dafny.Seq)()
        ...
        d_918_valueOrError4_: Wrappers.Outcome = Wrappers.Outcome_Pass.default()()
        ...
        d_920_valueOrError5_: Wrappers.Result = Wrappers.Result_Success.default(_dafny.Seq)()
        out192_: Wrappers.Result
        out192_ = AwsKmsRsaKeyring.default__.EncryptionContextDigest((self).cryptoPrimitives, (d_912_materials_).encryptionContext)
        ...
        nw42_ = AwsKmsRsaKeyring.DecryptSingleAWSRSAEncryptedDataKey()
...
class DecryptSingleAWSRSAEncryptedDataKey(Actions.ActionWithResult, Actions.Action):
    ...
    def Invoke(self, edk):
        res: Wrappers.Result = None
        d_926_unwrap_: AwsKmsRsaKeyring.KmsRsaUnwrapKeyMaterial
        nw43_ = AwsKmsRsaKeyring.KmsRsaUnwrapKeyMaterial()
        ...
        d_928_valueOrError0_: Wrappers.Result = Wrappers.Result_Success.default(EdkWrapping.UnwrapEdkMaterialOutput.default(AwsKmsRsaKeyring.KmsRsaUnwrapInfo.default()))()
...
class KmsRsaGenerateAndWrapKeyMaterial(MaterialWrapping.GenerateAndWrapMaterial, Actions.ActionWithResult, Actions.Action):
    ...
    def Invoke(self, input):
        ...
        d_933_valueOrError0_: Wrappers.Result = Wrappers.Result_Success.default(_dafny.Seq)()
        ...
        d_935_wrap_: AwsKmsRsaKeyring.KmsRsaWrapKeyMaterial
        nw44_ = AwsKmsRsaKeyring.KmsRsaWrapKeyMaterial()
        nw44_.ctor__((self).publicKey, (self).paddingScheme, (self).cryptoPrimitives)
        d_935_wrap_ = nw44_
        d_936_wrapOutput_: MaterialWrapping.WrapOutput
        d_937_valueOrError1_: Wrappers.Result = Wrappers.Result_Success.default(MaterialWrapping.WrapOutput.default(AwsKmsRsaKeyring.KmsRsaWrapInfo.default()))()
        ...
        d_938_output_ = MaterialWrapping.GenerateAndWrapOutput_GenerateAndWrapOutput(d_932_plaintextMaterial_, (d_936_wrapOutput_).wrappedMaterial, AwsKmsRsaKeyring.KmsRsaWrapInfo_KmsRsaWrapInfo())
...
class KmsRsaWrapKeyMaterial(MaterialWrapping.WrapMaterial, Actions.ActionWithResult, Actions.Action):
    ...
    def Invoke(self, input):
        ...
        d_940_valueOrError0_: Wrappers.Result = Wrappers.Result_Success.default(_dafny.Seq)()
        out197_: Wrappers.Result
        out197_ = AwsKmsRsaKeyring.default__.EncryptionContextDigest((self).cryptoPrimitives, (input).encryptionContext)
        ...
        d_944_valueOrError1_: Wrappers.Result = Wrappers.Result_Success.default(_dafny.Seq)()
        ...
        d_946_output_ = MaterialWrapping.WrapOutput_WrapOutput(d_943_ciphertext_, AwsKmsRsaKeyring.KmsRsaWrapInfo_KmsRsaWrapInfo())
...
class KmsRsaUnwrapKeyMaterial(MaterialWrapping.UnwrapMaterial, Actions.ActionWithResult, Actions.Action):
    ...
    def Invoke(self, input):
        ...
        d_947_valueOrError0_: Wrappers.Outcome = Wrappers.Outcome_Pass.default()()
        ...
        d_951_valueOrError1_: Wrappers.Result = Wrappers.Result_Success.default(software_amazon_cryptography_services_kms_internaldafny_types.DecryptResponse.default())()
        ...
        d_953_valueOrError2_: Wrappers.Outcome = Wrappers.Outcome_Pass.default()()
        ...
        if (d_953_valueOrError2_).IsFailure():
            ...
            return res
        d_954_valueOrError3_: Wrappers.Outcome = Wrappers.Outcome_Pass.default()()
        ...
        d_955_output_ = MaterialWrapping.UnwrapOutput_UnwrapOutput(_dafny.Seq((((d_950_decryptResponse_).Plaintext).value)[len((self).encryptionContextDigest)::]), AwsKmsRsaKeyring.KmsRsaUnwrapInfo_KmsRsaUnwrapInfo())
