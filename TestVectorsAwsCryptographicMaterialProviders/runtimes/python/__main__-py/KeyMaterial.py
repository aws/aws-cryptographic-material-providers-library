                                                    ...
                                                    if (d_1475_valueOrError10_).IsFailure():
                                                        ...
                                                        if (d_1477_valueOrError11_).IsFailure():
                                                            ...
                                                            if (d_1479_valueOrError12_).IsFailure():
                                                                ...
                                                                d_1481_valueOrError13_ = (iife37_(Base64.default__.Decode((d_1480_plaintextDataKeyEncoded_).value)) if (d_1480_plaintextDataKeyEncoded_).is_Some else Wrappers.Result_Success(Wrappers.Option_None()))
