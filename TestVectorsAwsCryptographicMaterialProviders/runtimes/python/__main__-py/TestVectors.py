...
class default__:
    ...
    def TestGetEncryptionMaterials(test):
        ...
        _dafny.print(_dafny.string_of(_dafny.Seq("\n")))
        d_1707_result_: Wrappers.Result
        ...
        def lambda112_(source52_):
            if source52_.is_PositiveEncryptKeyringVector:
                ...
                d_1709___mcc_h1_ = source52_.description
                d_1710___mcc_h2_ = source52_.encryptionContext
                d_1711___mcc_h3_ = source52_.commitmentPolicy
                d_1712___mcc_h4_ = source52_.algorithmSuite
                d_1713___mcc_h5_ = source52_.maxPlaintextLength
                ...
                d_1719___mcc_h11_ = source52_.encryptionContext
                d_1720___mcc_h12_ = source52_.commitmentPolicy
                d_1721___mcc_h13_ = source52_.algorithmSuite
                d_1722___mcc_h14_ = source52_.maxPlaintextLength
        ...
        if not(testResult):
            if ((test).vector).is_PositiveEncryptKeyringVector:
                _dafny.print(_dafny.string_of((d_1707_result_).error))
            _dafny.print(_dafny.string_of(_dafny.Seq("\nFAILED! <-----------\n")))
    ...
    def TestDecryptMaterials(test):
        ...
        d_1726_result_: Wrappers.Result
        ...
        def lambda113_(source53_):
            if source53_.is_PositiveDecryptKeyringTest:
                ...
                d_1728___mcc_h1_ = source53_.algorithmSuite
                d_1729___mcc_h2_ = source53_.commitmentPolicy
                d_1730___mcc_h3_ = source53_.encryptedDataKeys
                d_1731___mcc_h4_ = source53_.encryptionContext
                d_1732___mcc_h5_ = source53_.keyDescription
                ...
                d_1738___mcc_h11_ = source53_.commitmentPolicy
                d_1739___mcc_h12_ = source53_.encryptedDataKeys
                d_1740___mcc_h13_ = source53_.encryptionContext
                d_1741___mcc_h14_ = source53_.errorDescription
        ...
        if not(output):
            if (((test).vector).is_PositiveDecryptKeyringTest) and ((d_1726_result_).is_Failure):
                _dafny.print(_dafny.string_of((d_1726_result_).error))
            _dafny.print(_dafny.string_of(_dafny.Seq("\nFAILED! <-----------\n")))
        return output
    ...
    def ToEncryptTest(keys, vector):
        ...
        d_1745_input_: software_amazon_cryptography_materialproviders_internaldafny_types.GetEncryptionMaterialsInput
        def lambda114_(source54_):
            if source54_.is_PositiveEncryptKeyringVector:
                d_1746___mcc_h0_ = source54_.name
                d_1747___mcc_h1_ = source54_.description
                d_1748___mcc_h2_ = source54_.encryptionContext
                d_1749___mcc_h3_ = source54_.commitmentPolicy
                d_1750___mcc_h4_ = source54_.algorithmSuite
                d_1751___mcc_h5_ = source54_.maxPlaintextLength
                ...
                d_1762___mcc_h11_ = source54_.encryptionContext
                d_1763___mcc_h12_ = source54_.commitmentPolicy
                d_1764___mcc_h13_ = source54_.algorithmSuite
                d_1765___mcc_h14_ = source54_.maxPlaintextLength
        ...
        d_1775_valueOrError0_ = out328_
        if not(not((d_1775_valueOrError0_).IsFailure())):
            raise _dafny.HaltException("dafny/TestVectorsAwsCryptographicMaterialProviders/src/TestVectors.dfy(131,12): " + _dafny.string_of(d_1775_valueOrError0_))
        d_1774_mpl_ = (d_1775_valueOrError0_).Extract()
        d_1776_maybeKeyring_: Wrappers.Result
        out329_: Wrappers.Result
        out329_ = (keys).CreateWappedTestVectorKeyring(software.amazon.cryptography.materialproviderstestvectorkeys.internaldafny.types.TestVectorKeyringInput_TestVectorKeyringInput(((vector).encryptDescription if (vector).is_PositiveEncryptKeyringVector else (vector).keyDescription)))
        d_1776_maybeKeyring_ = out329_
        ...
        if (d_1778_valueOrError1_).IsFailure():
            output = (d_1778_valueOrError1_).PropagateFailure()
            return output
        d_1777_keyring_ = (d_1778_valueOrError1_).Extract()
        d_1781_maybeCmm_: Wrappers.Result
        out330_: Wrappers.Result
        out330_ = (d_1774_mpl_).CreateDefaultCryptographicMaterialsManager(software_amazon_cryptography_materialproviders_internaldafny_types.CreateDefaultCryptographicMaterialsManagerInput_CreateDefaultCryptographicMaterialsManagerInput(d_1777_keyring_))
        d_1781_maybeCmm_ = out330_
        d_1782_cmm_: software_amazon_cryptography_materialproviders_internaldafny_types.ICryptographicMaterialsManager
        d_1783_valueOrError2_: Wrappers.Result = None
        def lambda116_(d_1784_e_):
            return _dafny.Seq("CMM failure")

        d_1783_valueOrError2_ = (d_1781_maybeCmm_).MapFailure(lambda116_)
        if (d_1783_valueOrError2_).IsFailure():
            output = (d_1783_valueOrError2_).PropagateFailure()
            return output
        d_1782_cmm_ = (d_1783_valueOrError2_).Extract()
        output = Wrappers.Result_Success(EncryptTest_EncryptTest(d_1745_input_, d_1782_cmm_, vector))
        return output
        return output
    ...
    def ToDecryptTest(keys, test, materials):
        output: Wrappers.Result = None
        d_1785_reproducedEncryptionContext_: Wrappers.Option
        d_1785_reproducedEncryptionContext_ = Wrappers.Option_None()
        d_1786_input_: software_amazon_cryptography_materialproviders_internaldafny_types.DecryptMaterialsInput
        d_1786_input_ = software_amazon_cryptography_materialproviders_internaldafny_types.DecryptMaterialsInput_DecryptMaterialsInput(((materials).algorithmSuite).id, ((test).vector).commitmentPolicy, (materials).encryptedDataKeys, (materials).encryptionContext, d_1785_reproducedEncryptionContext_)
        d_1787_vector_: DecryptTestVector
        d_1787_vector_ = DecryptTestVector_PositiveDecryptKeyringTest((((test).vector).name) + (_dafny.Seq("->Decryption")), (materials).algorithmSuite, ((test).vector).commitmentPolicy, (materials).encryptedDataKeys, (materials).encryptionContext, ((test).vector).decryptDescription, DecryptResult_DecryptResult((materials).plaintextDataKey, (Wrappers.Option_Some((((materials).symmetricSigningKeys).value)[0]) if (((materials).symmetricSigningKeys).is_Some) and ((0) < (len(((materials).symmetricSigningKeys).value))) else Wrappers.Option_None()), (materials).requiredEncryptionContextKeys), (Wrappers.Option_Some((_dafny.Seq("Decryption for ")) + ((((test).vector).description).value)) if (((test).vector).description).is_Some else Wrappers.Option_None()), d_1785_reproducedEncryptionContext_)
        d_1788_mpl_: software_amazon_cryptography_materialproviders_internaldafny_types.IAwsCryptographicMaterialProvidersClient
        d_1789_valueOrError0_: Wrappers.Result = None
        ...
        d_1789_valueOrError0_ = out331_
        if not(not((d_1789_valueOrError0_).IsFailure())):
            raise _dafny.HaltException("dafny/TestVectorsAwsCryptographicMaterialProviders/src/TestVectors.dfy(196,12): " + _dafny.string_of(d_1789_valueOrError0_))
        d_1788_mpl_ = (d_1789_valueOrError0_).Extract()
        d_1790_maybeKeyring_: Wrappers.Result
        out332_: Wrappers.Result
        out332_ = (keys).CreateWappedTestVectorKeyring(software.amazon.cryptography.materialproviderstestvectorkeys.internaldafny.types.TestVectorKeyringInput_TestVectorKeyringInput((d_1787_vector_).keyDescription))
        d_1790_maybeKeyring_ = out332_
        ...
        if (d_1792_valueOrError1_).IsFailure():
            output = (d_1792_valueOrError1_).PropagateFailure()
            return output
        d_1791_keyring_ = (d_1792_valueOrError1_).Extract()
        d_1795_maybeCmm_: Wrappers.Result
        out333_: Wrappers.Result
        out333_ = (d_1788_mpl_).CreateDefaultCryptographicMaterialsManager(software_amazon_cryptography_materialproviders_internaldafny_types.CreateDefaultCryptographicMaterialsManagerInput_CreateDefaultCryptographicMaterialsManagerInput(d_1791_keyring_))
        d_1795_maybeCmm_ = out333_
        d_1796_cmm_: software_amazon_cryptography_materialproviders_internaldafny_types.ICryptographicMaterialsManager
        d_1797_valueOrError2_: Wrappers.Result = None
        def lambda118_(d_1798_e_):
            return _dafny.Seq("CMM failure")

        d_1797_valueOrError2_ = (d_1795_maybeCmm_).MapFailure(lambda118_)
        if (d_1797_valueOrError2_).IsFailure():
            output = (d_1797_valueOrError2_).PropagateFailure()
            return output
        d_1796_cmm_ = (d_1797_valueOrError2_).Extract()
        output = Wrappers.Result_Success(DecryptTest_DecryptTest(d_1786_input_, d_1796_cmm_, d_1787_vector_))
        return output
        return output
