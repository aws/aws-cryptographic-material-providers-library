...
class default__:
    ...
    def KdfCounterMode(input):
        ...
        if (d_285_valueOrError2_).IsFailure():
            ...
            return output
        d_286_valueOrError3_: Wrappers.Result = Wrappers.Result.default(_dafny.Seq)()
        out32_: Wrappers.Result
        out32_ = default__.RawDerive(d_277_ikm_, d_284_explicitInfo_, (input).expectedLength, 0)
    ...
    def RawDerive(ikm, explicitInfo, length, offset):
        ...
        for d_294_iteration_ in range(1, hi2_):
            ...
            d_296_valueOrError1_: Wrappers.Result = Wrappers.Result.default(_dafny.Seq)()
            d_296_valueOrError1_ = default__.Increment(d_293_i_)
            if (d_296_valueOrError1_).IsFailure():
                output = (d_296_valueOrError1_).PropagateFailure()
                return output
            d_293_i_ = (d_296_valueOrError1_).Extract()
        d_297_valueOrError2_: Wrappers.Outcome = Wrappers.Outcome.default()()
