...
class default__:
    ...
    def StartEncrypt(encryptManifestPath, keysManifiestPath):
        ...
        d_1914_encryptManifestJSON_: JSON_Values.JSON
        d_1915_valueOrError1_: Wrappers.Result = Wrappers.Result.default(JSON_Values.JSON.default())()
        d_1915_valueOrError1_ = JSON_API.default__.Deserialize(d_1913_encryptManifestBytes_)
