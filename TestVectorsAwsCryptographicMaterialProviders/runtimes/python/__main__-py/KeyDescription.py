                    ...
                    if (d_1418_typ_) == (_dafny.Seq("aws-kms-mrk-aware-discovery")):
                        ...
                        if (d_1424_valueOrError4_).IsFailure():
                            ...
                            if (d_1418_typ_) == (_dafny.Seq("static-material-keyring")):
                                return Wrappers.Result_Success(software.amazon.cryptography.materialproviderstestvectorkeys.internaldafny.types.KeyDescription_Static(software.amazon.cryptography.materialproviderstestvectorkeys.internaldafny.types.StaticKeyring_StaticKeyring(d_1425_key_)))
                            elif (d_1418_typ_) == (_dafny.Seq("aws-kms")):
                                return Wrappers.Result_Success(software.amazon.cryptography.materialproviderstestvectorkeys.internaldafny.types.KeyDescription_Kms(software.amazon.cryptography.materialproviderstestvectorkeys.internaldafny.types.KMSInfo_KMSInfo(d_1425_key_)))
                            elif (d_1418_typ_) == (_dafny.Seq("aws-kms-mrk-aware")):
                                return Wrappers.Result_Success(software.amazon.cryptography.materialproviderstestvectorkeys.internaldafny.types.KeyDescription_KmsMrk(software.amazon.cryptography.materialproviderstestvectorkeys.internaldafny.types.KmsMrkAware_KmsMrkAware(d_1425_key_)))
                                ...
                                if (d_1426_valueOrError5_).IsFailure():
                                    ...
                                    if (d_1428_valueOrError6_).IsFailure():
                                        ...
                                        return Wrappers.Result_Success(software.amazon.cryptography.materialproviderstestvectorkeys.internaldafny.types.KeyDescription_KmsRsa(software.amazon.cryptography.materialproviderstestvectorkeys.internaldafny.types.KmsRsaKeyring_KmsRsaKeyring(d_1425_key_, d_1429_encryptionAlgorithm_)))
                            elif (d_1418_typ_) == (_dafny.Seq("aws-kms-hierarchy")):
                                return Wrappers.Result_Success(software.amazon.cryptography.materialproviderstestvectorkeys.internaldafny.types.KeyDescription_Hierarchy(software.amazon.cryptography.materialproviderstestvectorkeys.internaldafny.types.HierarchyKeyring_HierarchyKeyring(d_1425_key_)))
                            elif True:
                                    ...
                                    if (d_1432_valueOrError8_).IsFailure():
                                        ...
                                        if (d_1434_valueOrError9_).IsFailure():
                                            ...
                                            if (d_1431_algorithm_) == (_dafny.Seq("aes")):
                                                return Wrappers.Result_Success(software.amazon.cryptography.materialproviderstestvectorkeys.internaldafny.types.KeyDescription_AES(software.amazon.cryptography.materialproviderstestvectorkeys.internaldafny.types.RawAES_RawAES(d_1425_key_, d_1433_providerId_)))
                                            elif True:
                                                            ...
                                                            if (d_1440_valueOrError13_).IsFailure():
                                                                ...
                                                                if (d_1436_paddingAlgorithm_) == (_dafny.Seq("pkcs1")):
                                                                    ...
                                                                    if (d_1441_valueOrError14_).IsFailure():
                                                                        ...
                                                                        return Wrappers.Result_Success(software.amazon.cryptography.materialproviderstestvectorkeys.internaldafny.types.KeyDescription_RSA(software.amazon.cryptography.materialproviderstestvectorkeys.internaldafny.types.RawRSA_RawRSA(d_1425_key_, d_1433_providerId_, software_amazon_cryptography_materialproviders_internaldafny_types.PaddingScheme_PKCS1())))
                                                                elif True:
