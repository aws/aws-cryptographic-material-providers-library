...
class default__:
    ...
    def CreateTestVectorKeyring(config, input):
        ...
        d_1654_keyDescription_: software.amazon.cryptography.materialproviderstestvectorkeys.internaldafny.types.KeyDescription
        ...
        def lambda105_(d_1660_e_):
            return software.amazon.cryptography.materialproviderstestvectorkeys.internaldafny.types.Error_AwsCryptographyMaterialProviders(d_1660_e_)
    ...
    def CreateWappedTestVectorKeyring(config, input):
        output: Wrappers.Result = None
        d_1661_keyDescription_: software.amazon.cryptography.materialproviderstestvectorkeys.internaldafny.types.KeyDescription
        ...
        def lambda106_(d_1667_e_):
            return software.amazon.cryptography.materialproviderstestvectorkeys.internaldafny.types.Error_AwsCryptographyMaterialProviders(d_1667_e_)
    ...
    def GetKeyDescription(config, input):
        def lambda107_(d_1669_e_):
            return software.amazon.cryptography.materialproviderstestvectorkeys.internaldafny.types.Error_AwsCryptographyMaterialProviders(software_amazon_cryptography_materialproviders_internaldafny_types.Error_AwsCryptographicMaterialProvidersException((d_1669_e_).ToString()))

        d_1668_valueOrError0_ = (JSON_API.default__.Deserialize((input).json)).MapFailure(lambda107_)
        if (d_1668_valueOrError0_).IsFailure():
            ...
            def lambda108_(d_1672_e_):
                return software.amazon.cryptography.materialproviderstestvectorkeys.internaldafny.types.Error_AwsCryptographyMaterialProviders(software_amazon_cryptography_materialproviders_internaldafny_types.Error_AwsCryptographicMaterialProvidersException(d_1672_e_))
            ...
            if (d_1671_valueOrError1_).IsFailure():
                ...
                return Wrappers.Result_Success(software.amazon.cryptography.materialproviderstestvectorkeys.internaldafny.types.GetKeyDescriptionOutput_GetKeyDescriptionOutput(d_1673_keyDescription_))
