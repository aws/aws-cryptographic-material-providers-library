                        ...
                        if (d_1848_valueOrError4_).IsFailure():
                            ...
                            if (d_1850_valueOrError5_).IsFailure():
                                ...
                                if (d_1852_valueOrError6_).IsFailure():
                                    ...
                                    d_1857_valueOrError7_ = (iife62_(JSONHelpers.default__.utf8EncodeSeq((d_1856_keysAsStrings_).value)) if (d_1856_keysAsStrings_).is_Some else Wrappers.Result_Success(Wrappers.Option_None()))
                                        ...
                                        if (d_1842_typ_) == (_dafny.Seq("positive-keyring")):
                                            ...
                                            if (d_1862_valueOrError8_).IsFailure():
                                                ...
                                                if (d_1864_valueOrError9_).IsFailure():
                                                    ...
                                                    d_1866_valueOrError10_ = (JSON_API.default__.Serialize(d_1863_encryptKeyDescriptionObject_)).MapFailure(lambda126_)
                                                    if (d_1866_valueOrError10_).IsFailure():
                                                        ...
                                                        d_1869_valueOrError11_ = (JSON_API.default__.Serialize(d_1865_decryptKeyDescriptionObject_)).MapFailure(lambda127_)
                                                        if (d_1869_valueOrError11_).IsFailure():
                                                            ...
                                                            d_1872_valueOrError12_ = ((keys).GetKeyDescription(software.amazon.cryptography.materialproviderstestvectorkeys.internaldafny.types.GetKeyDescriptionInput_GetKeyDescriptionInput(d_1868_encryptStr_))).MapFailure(default__.ErrorToString)
                                                            if (d_1872_valueOrError12_).IsFailure():
                                                                ...
                                                                d_1874_valueOrError13_ = ((keys).GetKeyDescription(software.amazon.cryptography.materialproviderstestvectorkeys.internaldafny.types.GetKeyDescriptionInput_GetKeyDescriptionInput(d_1871_decryptStr_))).MapFailure(default__.ErrorToString)
                                            ...
                                            if (d_1876_valueOrError14_).IsFailure():
                                                ...
                                                d_1878_valueOrError15_ = (JSON_API.default__.Serialize(d_1877_keyDescriptionObject_)).MapFailure(lambda128_)
                                                if (d_1878_valueOrError15_).IsFailure():
                                                    ...
                                                    d_1881_valueOrError16_ = ((keys).GetKeyDescription(software.amazon.cryptography.materialproviderstestvectorkeys.internaldafny.types.GetKeyDescriptionInput_GetKeyDescriptionInput(d_1880_keyStr_))).MapFailure(default__.ErrorToString)
