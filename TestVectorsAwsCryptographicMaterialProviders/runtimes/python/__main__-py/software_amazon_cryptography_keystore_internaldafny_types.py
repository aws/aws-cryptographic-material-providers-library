...
assert "software.amazon.cryptography.keystore.internaldafny.types" == __name__
...
class DafnyCallEvent:
    ...
    def is_DafnyCallEvent(self) -> bool:
        return isinstance(self, software.amazon.cryptography.keystore.internaldafny.types.DafnyCallEvent_DafnyCallEvent)
...
class DafnyCallEvent_DafnyCallEvent(DafnyCallEvent, NamedTuple('DafnyCallEvent', [('input', Any), ('output', Any)])):
    ...
    def __eq__(self, __o: object) -> bool:
        return isinstance(__o, software.amazon.cryptography.keystore.internaldafny.types.DafnyCallEvent_DafnyCallEvent) and self.input == __o.input and self.output == __o.output
...
class BeaconKeyMaterials:
    ...
    def is_BeaconKeyMaterials(self) -> bool:
        return isinstance(self, software.amazon.cryptography.keystore.internaldafny.types.BeaconKeyMaterials_BeaconKeyMaterials)
...
class BeaconKeyMaterials_BeaconKeyMaterials(BeaconKeyMaterials, NamedTuple('BeaconKeyMaterials', [('beaconKeyIdentifier', Any), ('encryptionContext', Any), ('beaconKey', Any), ('hmacKeys', Any)])):
    ...
    def __eq__(self, __o: object) -> bool:
        return isinstance(__o, software.amazon.cryptography.keystore.internaldafny.types.BeaconKeyMaterials_BeaconKeyMaterials) and self.beaconKeyIdentifier == __o.beaconKeyIdentifier and self.encryptionContext == __o.encryptionContext and self.beaconKey == __o.beaconKey and self.hmacKeys == __o.hmacKeys
    def __hash__(self) -> int:
        return super().__hash__()
...
class BranchKeyMaterials:
    ...
    def is_BranchKeyMaterials(self) -> bool:
        return isinstance(self, software.amazon.cryptography.keystore.internaldafny.types.BranchKeyMaterials_BranchKeyMaterials)
...
class BranchKeyMaterials_BranchKeyMaterials(BranchKeyMaterials, NamedTuple('BranchKeyMaterials', [('branchKeyIdentifier', Any), ('branchKeyVersion', Any), ('encryptionContext', Any), ('branchKey', Any)])):
    ...
    def __eq__(self, __o: object) -> bool:
        return isinstance(__o, software.amazon.cryptography.keystore.internaldafny.types.BranchKeyMaterials_BranchKeyMaterials) and self.branchKeyIdentifier == __o.branchKeyIdentifier and self.branchKeyVersion == __o.branchKeyVersion and self.encryptionContext == __o.encryptionContext and self.branchKey == __o.branchKey
    def __hash__(self) -> int:
        return super().__hash__()
...
class CreateKeyInput:
    ...
    def is_CreateKeyInput(self) -> bool:
        return isinstance(self, software.amazon.cryptography.keystore.internaldafny.types.CreateKeyInput_CreateKeyInput)
...
class CreateKeyInput_CreateKeyInput(CreateKeyInput, NamedTuple('CreateKeyInput', [('branchKeyIdentifier', Any), ('encryptionContext', Any)])):
    ...
    def __eq__(self, __o: object) -> bool:
        return isinstance(__o, software.amazon.cryptography.keystore.internaldafny.types.CreateKeyInput_CreateKeyInput) and self.branchKeyIdentifier == __o.branchKeyIdentifier and self.encryptionContext == __o.encryptionContext
    def __hash__(self) -> int:
        return super().__hash__()
...
class CreateKeyOutput:
    ...
    def is_CreateKeyOutput(self) -> bool:
        return isinstance(self, software.amazon.cryptography.keystore.internaldafny.types.CreateKeyOutput_CreateKeyOutput)
...
class CreateKeyOutput_CreateKeyOutput(CreateKeyOutput, NamedTuple('CreateKeyOutput', [('branchKeyIdentifier', Any)])):
    ...
    def __eq__(self, __o: object) -> bool:
        return isinstance(__o, software.amazon.cryptography.keystore.internaldafny.types.CreateKeyOutput_CreateKeyOutput) and self.branchKeyIdentifier == __o.branchKeyIdentifier
    def __hash__(self) -> int:
        return super().__hash__()
...
class CreateKeyStoreInput:
    ...
    def is_CreateKeyStoreInput(self) -> bool:
        return isinstance(self, software.amazon.cryptography.keystore.internaldafny.types.CreateKeyStoreInput_CreateKeyStoreInput)
...
class CreateKeyStoreInput_CreateKeyStoreInput(CreateKeyStoreInput, NamedTuple('CreateKeyStoreInput', [])):
    ...
    def __eq__(self, __o: object) -> bool:
        return isinstance(__o, software.amazon.cryptography.keystore.internaldafny.types.CreateKeyStoreInput_CreateKeyStoreInput)
    def __hash__(self) -> int:
        return super().__hash__()
...
class CreateKeyStoreOutput:
    ...
    def is_CreateKeyStoreOutput(self) -> bool:
        return isinstance(self, software.amazon.cryptography.keystore.internaldafny.types.CreateKeyStoreOutput_CreateKeyStoreOutput)
...
class CreateKeyStoreOutput_CreateKeyStoreOutput(CreateKeyStoreOutput, NamedTuple('CreateKeyStoreOutput', [('tableArn', Any)])):
    ...
    def __eq__(self, __o: object) -> bool:
        return isinstance(__o, software.amazon.cryptography.keystore.internaldafny.types.CreateKeyStoreOutput_CreateKeyStoreOutput) and self.tableArn == __o.tableArn
    def __hash__(self) -> int:
        return super().__hash__()
...
class GetActiveBranchKeyInput:
    ...
    def is_GetActiveBranchKeyInput(self) -> bool:
        return isinstance(self, software.amazon.cryptography.keystore.internaldafny.types.GetActiveBranchKeyInput_GetActiveBranchKeyInput)
...
class GetActiveBranchKeyInput_GetActiveBranchKeyInput(GetActiveBranchKeyInput, NamedTuple('GetActiveBranchKeyInput', [('branchKeyIdentifier', Any)])):
    ...
    def __eq__(self, __o: object) -> bool:
        return isinstance(__o, software.amazon.cryptography.keystore.internaldafny.types.GetActiveBranchKeyInput_GetActiveBranchKeyInput) and self.branchKeyIdentifier == __o.branchKeyIdentifier
    def __hash__(self) -> int:
        return super().__hash__()
...
class GetActiveBranchKeyOutput:
    @classmethod
    def default(cls, ):
        return lambda: GetActiveBranchKeyOutput_GetActiveBranchKeyOutput(software.amazon.cryptography.keystore.internaldafny.types.BranchKeyMaterials_BranchKeyMaterials.default()())
    def __ne__(self, __o: object) -> bool:
        return not self.__eq__(__o)
    @property
    def is_GetActiveBranchKeyOutput(self) -> bool:
        return isinstance(self, software.amazon.cryptography.keystore.internaldafny.types.GetActiveBranchKeyOutput_GetActiveBranchKeyOutput)
...
class GetActiveBranchKeyOutput_GetActiveBranchKeyOutput(GetActiveBranchKeyOutput, NamedTuple('GetActiveBranchKeyOutput', [('branchKeyMaterials', Any)])):
    ...
    def __eq__(self, __o: object) -> bool:
        return isinstance(__o, software.amazon.cryptography.keystore.internaldafny.types.GetActiveBranchKeyOutput_GetActiveBranchKeyOutput) and self.branchKeyMaterials == __o.branchKeyMaterials
    def __hash__(self) -> int:
        return super().__hash__()
...
class GetBeaconKeyInput:
    ...
    def is_GetBeaconKeyInput(self) -> bool:
        return isinstance(self, software.amazon.cryptography.keystore.internaldafny.types.GetBeaconKeyInput_GetBeaconKeyInput)
...
class GetBeaconKeyInput_GetBeaconKeyInput(GetBeaconKeyInput, NamedTuple('GetBeaconKeyInput', [('branchKeyIdentifier', Any)])):
    ...
    def __eq__(self, __o: object) -> bool:
        return isinstance(__o, software.amazon.cryptography.keystore.internaldafny.types.GetBeaconKeyInput_GetBeaconKeyInput) and self.branchKeyIdentifier == __o.branchKeyIdentifier
    def __hash__(self) -> int:
        return super().__hash__()
...
class GetBeaconKeyOutput:
    @classmethod
    def default(cls, ):
        return lambda: GetBeaconKeyOutput_GetBeaconKeyOutput(software.amazon.cryptography.keystore.internaldafny.types.BeaconKeyMaterials_BeaconKeyMaterials.default()())
    def __ne__(self, __o: object) -> bool:
        return not self.__eq__(__o)
    @property
    def is_GetBeaconKeyOutput(self) -> bool:
        return isinstance(self, software.amazon.cryptography.keystore.internaldafny.types.GetBeaconKeyOutput_GetBeaconKeyOutput)
...
class GetBeaconKeyOutput_GetBeaconKeyOutput(GetBeaconKeyOutput, NamedTuple('GetBeaconKeyOutput', [('beaconKeyMaterials', Any)])):
    ...
    def __eq__(self, __o: object) -> bool:
        return isinstance(__o, software.amazon.cryptography.keystore.internaldafny.types.GetBeaconKeyOutput_GetBeaconKeyOutput) and self.beaconKeyMaterials == __o.beaconKeyMaterials
    def __hash__(self) -> int:
        return super().__hash__()
...
class GetBranchKeyVersionInput:
    ...
    def is_GetBranchKeyVersionInput(self) -> bool:
        return isinstance(self, software.amazon.cryptography.keystore.internaldafny.types.GetBranchKeyVersionInput_GetBranchKeyVersionInput)
...
class GetBranchKeyVersionInput_GetBranchKeyVersionInput(GetBranchKeyVersionInput, NamedTuple('GetBranchKeyVersionInput', [('branchKeyIdentifier', Any), ('branchKeyVersion', Any)])):
    ...
    def __eq__(self, __o: object) -> bool:
        return isinstance(__o, software.amazon.cryptography.keystore.internaldafny.types.GetBranchKeyVersionInput_GetBranchKeyVersionInput) and self.branchKeyIdentifier == __o.branchKeyIdentifier and self.branchKeyVersion == __o.branchKeyVersion
    def __hash__(self) -> int:
        return super().__hash__()
...
class GetBranchKeyVersionOutput:
    @classmethod
    def default(cls, ):
        return lambda: GetBranchKeyVersionOutput_GetBranchKeyVersionOutput(software.amazon.cryptography.keystore.internaldafny.types.BranchKeyMaterials_BranchKeyMaterials.default()())
    def __ne__(self, __o: object) -> bool:
        return not self.__eq__(__o)
    @property
    def is_GetBranchKeyVersionOutput(self) -> bool:
        return isinstance(self, software.amazon.cryptography.keystore.internaldafny.types.GetBranchKeyVersionOutput_GetBranchKeyVersionOutput)
...
class GetBranchKeyVersionOutput_GetBranchKeyVersionOutput(GetBranchKeyVersionOutput, NamedTuple('GetBranchKeyVersionOutput', [('branchKeyMaterials', Any)])):
    ...
    def __eq__(self, __o: object) -> bool:
        return isinstance(__o, software.amazon.cryptography.keystore.internaldafny.types.GetBranchKeyVersionOutput_GetBranchKeyVersionOutput) and self.branchKeyMaterials == __o.branchKeyMaterials
    def __hash__(self) -> int:
        return super().__hash__()
...
class GetKeyStoreInfoOutput:
    @classmethod
    def default(cls, ):
        return lambda: GetKeyStoreInfoOutput_GetKeyStoreInfoOutput(_dafny.Seq({}), _dafny.Seq({}), _dafny.Seq({}), _dafny.Seq({}), software.amazon.cryptography.keystore.internaldafny.types.KMSConfiguration_kmsKeyArn.default()())
    def __ne__(self, __o: object) -> bool:
        return not self.__eq__(__o)
    @property
    def is_GetKeyStoreInfoOutput(self) -> bool:
        return isinstance(self, software.amazon.cryptography.keystore.internaldafny.types.GetKeyStoreInfoOutput_GetKeyStoreInfoOutput)
...
class GetKeyStoreInfoOutput_GetKeyStoreInfoOutput(GetKeyStoreInfoOutput, NamedTuple('GetKeyStoreInfoOutput', [('keyStoreId', Any), ('keyStoreName', Any), ('logicalKeyStoreName', Any), ('grantTokens', Any), ('kmsConfiguration', Any)])):
    ...
    def __eq__(self, __o: object) -> bool:
        return isinstance(__o, software.amazon.cryptography.keystore.internaldafny.types.GetKeyStoreInfoOutput_GetKeyStoreInfoOutput) and self.keyStoreId == __o.keyStoreId and self.keyStoreName == __o.keyStoreName and self.logicalKeyStoreName == __o.logicalKeyStoreName and self.grantTokens == __o.grantTokens and self.kmsConfiguration == __o.kmsConfiguration
    def __hash__(self) -> int:
        return super().__hash__()
...
class KeyStoreConfig:
    @classmethod
    def default(cls, ):
        return lambda: KeyStoreConfig_KeyStoreConfig(_dafny.Seq({}), software.amazon.cryptography.keystore.internaldafny.types.KMSConfiguration_kmsKeyArn.default()(), _dafny.Seq({}), Wrappers.Option_None.default()(), Wrappers.Option_None.default()(), Wrappers.Option_None.default()(), Wrappers.Option_None.default()())
    def __ne__(self, __o: object) -> bool:
        return not self.__eq__(__o)
    @property
    def is_KeyStoreConfig(self) -> bool:
        return isinstance(self, software.amazon.cryptography.keystore.internaldafny.types.KeyStoreConfig_KeyStoreConfig)
...
class KMSConfiguration:
    ...
    def is_kmsKeyArn(self) -> bool:
        return isinstance(self, software.amazon.cryptography.keystore.internaldafny.types.KMSConfiguration_kmsKeyArn)
...
class KMSConfiguration_kmsKeyArn(KMSConfiguration, NamedTuple('kmsKeyArn', [('kmsKeyArn', Any)])):
    ...
    def __eq__(self, __o: object) -> bool:
        return isinstance(__o, software.amazon.cryptography.keystore.internaldafny.types.KMSConfiguration_kmsKeyArn) and self.kmsKeyArn == __o.kmsKeyArn
    def __hash__(self) -> int:
        return super().__hash__()
...
class VersionKeyInput:
    ...
    def is_VersionKeyInput(self) -> bool:
        return isinstance(self, software.amazon.cryptography.keystore.internaldafny.types.VersionKeyInput_VersionKeyInput)
...
class VersionKeyInput_VersionKeyInput(VersionKeyInput, NamedTuple('VersionKeyInput', [('branchKeyIdentifier', Any)])):
    ...
    def __eq__(self, __o: object) -> bool:
        return isinstance(__o, software.amazon.cryptography.keystore.internaldafny.types.VersionKeyInput_VersionKeyInput) and self.branchKeyIdentifier == __o.branchKeyIdentifier
    def __hash__(self) -> int:
        return super().__hash__()
...
class VersionKeyOutput:
    ...
    def is_VersionKeyOutput(self) -> bool:
        return isinstance(self, software.amazon.cryptography.keystore.internaldafny.types.VersionKeyOutput_VersionKeyOutput)
...
class VersionKeyOutput_VersionKeyOutput(VersionKeyOutput, NamedTuple('VersionKeyOutput', [])):
    ...
    def __eq__(self, __o: object) -> bool:
        return isinstance(__o, software.amazon.cryptography.keystore.internaldafny.types.VersionKeyOutput_VersionKeyOutput)
    def __hash__(self) -> int:
        return super().__hash__()
...
class Error:
    ...
    def is_KeyStoreException(self) -> bool:
        return isinstance(self, software.amazon.cryptography.keystore.internaldafny.types.Error_KeyStoreException)
    @property
    def is_ComAmazonawsDynamodb(self) -> bool:
        return isinstance(self, software.amazon.cryptography.keystore.internaldafny.types.Error_ComAmazonawsDynamodb)
    @property
    def is_ComAmazonawsKms(self) -> bool:
        return isinstance(self, software.amazon.cryptography.keystore.internaldafny.types.Error_ComAmazonawsKms)
    @property
    def is_CollectionOfErrors(self) -> bool:
        return isinstance(self, software.amazon.cryptography.keystore.internaldafny.types.Error_CollectionOfErrors)
    @property
    def is_Opaque(self) -> bool:
        return isinstance(self, software.amazon.cryptography.keystore.internaldafny.types.Error_Opaque)
...
class Error_KeyStoreException(Error, NamedTuple('KeyStoreException', [('message', Any)])):
    ...
    def __eq__(self, __o: object) -> bool:
        return isinstance(__o, software.amazon.cryptography.keystore.internaldafny.types.Error_KeyStoreException) and self.message == __o.message
    def __hash__(self) -> int:
        return super().__hash__()
...
class Error_ComAmazonawsDynamodb(Error, NamedTuple('ComAmazonawsDynamodb', [('ComAmazonawsDynamodb', Any)])):
    ...
    def __eq__(self, __o: object) -> bool:
        return isinstance(__o, software.amazon.cryptography.keystore.internaldafny.types.Error_ComAmazonawsDynamodb) and self.ComAmazonawsDynamodb == __o.ComAmazonawsDynamodb
    def __hash__(self) -> int:
        return super().__hash__()
...
class Error_ComAmazonawsKms(Error, NamedTuple('ComAmazonawsKms', [('ComAmazonawsKms', Any)])):
    ...
    def __eq__(self, __o: object) -> bool:
        return isinstance(__o, software.amazon.cryptography.keystore.internaldafny.types.Error_ComAmazonawsKms) and self.ComAmazonawsKms == __o.ComAmazonawsKms
    def __hash__(self) -> int:
        return super().__hash__()
...
class Error_CollectionOfErrors(Error, NamedTuple('CollectionOfErrors', [('list', Any), ('message', Any)])):
    ...
    def __eq__(self, __o: object) -> bool:
        return isinstance(__o, software.amazon.cryptography.keystore.internaldafny.types.Error_CollectionOfErrors) and self.list == __o.list and self.message == __o.message
    def __hash__(self) -> int:
        return super().__hash__()
...
class Error_Opaque(Error, NamedTuple('Opaque', [('obj', Any)])):
    ...
    def __eq__(self, __o: object) -> bool:
        return isinstance(__o, software.amazon.cryptography.keystore.internaldafny.types.Error_Opaque) and self.obj == __o.obj
    def __hash__(self) -> int:
        return super().__hash__()
...
class OpaqueError:
    ...
    @staticmethod
    def default():
        return software.amazon.cryptography.keystore.internaldafny.types.Error_KeyStoreException.default()()
