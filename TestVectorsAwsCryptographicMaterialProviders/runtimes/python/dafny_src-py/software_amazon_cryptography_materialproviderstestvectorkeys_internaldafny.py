...
class default__:
    ...
    def KeyVectors(config):
        ...
        d_459_keysManifestJSON_: JSON_mValues.JSON
        d_460_valueOrError1_: Wrappers.Result = Wrappers.Result.default(JSON_mValues.JSON.default())()
        ...
        d_460_valueOrError1_ = (JSON_mAPI.default__.Deserialize(d_458_keysManifestBytes_)).MapFailure(lambda27_)
        ...
        d_462_keysObject_: JSON_mValues.JSON
        d_463_valueOrError2_: Wrappers.Result = Wrappers.Result.default(JSON_mValues.JSON.default())()
