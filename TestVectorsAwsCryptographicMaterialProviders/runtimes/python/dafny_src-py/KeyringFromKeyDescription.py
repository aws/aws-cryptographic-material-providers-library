...
class default__:
    ...
    def ToKeyring(mpl, info):
        ...
        if source3_.is_Kms:
            ...
            if True:
                ...
                d_304_valueOrError1_ = Wrappers.default__.Need(((d_300_material_).is_Some) and (((d_300_material_).value).is_KMS), software.amazon.cryptography.materialproviderstestvectorkeys.internaldafny.types.Error_KeyVectorException(_dafny.Seq("Not type: KMS")))
                ...
                def lambda10_(d_309_e_):
                    return software.amazon.cryptography.materialproviderstestvectorkeys.internaldafny.types.Error_AwsCryptographyMaterialProviders(d_309_e_)
            ...
            if True:
                ...
                d_313_valueOrError3_ = Wrappers.default__.Need(((d_300_material_).is_Some) and (((d_300_material_).value).is_KMS), software.amazon.cryptography.materialproviderstestvectorkeys.internaldafny.types.Error_KeyVectorException(_dafny.Seq("Not type: KMS")))
                ...
                def lambda11_(d_318_e_):
                    return software.amazon.cryptography.materialproviderstestvectorkeys.internaldafny.types.Error_AwsCryptographyMaterialProviders(d_318_e_)
            ...
            if True:
                ...
                d_325_valueOrError8_ = Wrappers.default__.Need((d_300_material_).is_None, software.amazon.cryptography.materialproviderstestvectorkeys.internaldafny.types.Error_KeyVectorException(_dafny.Seq("Discovery has not key")))
                ...
                def lambda12_(d_328_e_):
                    return software.amazon.cryptography.materialproviderstestvectorkeys.internaldafny.types.Error_AwsCryptographyMaterialProviders(d_328_e_)
            ...
            if True:
                ...
                d_336_valueOrError11_ = Wrappers.default__.Need(((d_300_material_).is_Some) and ((((d_300_material_).value).is_PrivateRSA) or (((d_300_material_).value).is_PublicRSA)), software.amazon.cryptography.materialproviderstestvectorkeys.internaldafny.types.Error_KeyVectorException(_dafny.Seq("Not type: PrivateRSA or PublicRSA")))
                ...
                if source9_.is_PrivateRSA:
                    ...
                    if True:
                        ...
                        d_349_valueOrError12_ = Wrappers.default__.Need(d_348_decrypt_, software.amazon.cryptography.materialproviderstestvectorkeys.internaldafny.types.Error_KeyVectorException(_dafny.Seq("Private RSA keys only supports decrypt.")))
                        ...
                        def lambda13_(d_352_e_):
                            return software.amazon.cryptography.materialproviderstestvectorkeys.internaldafny.types.Error_KeyVectorException(d_352_e_)
                        ...
                        def lambda14_(d_355_e_):
                            return software.amazon.cryptography.materialproviderstestvectorkeys.internaldafny.types.Error_AwsCryptographyMaterialProviders(d_355_e_)
                    ...
                    if True:
                        ...
                        d_367_valueOrError14_ = Wrappers.default__.Need(d_366_encrypt_, software.amazon.cryptography.materialproviderstestvectorkeys.internaldafny.types.Error_KeyVectorException(_dafny.Seq("Public RSA keys only supports encrypt.")))
                        ...
                        def lambda15_(d_370_e_):
                            return software.amazon.cryptography.materialproviderstestvectorkeys.internaldafny.types.Error_KeyVectorException(d_370_e_)
                        ...
                        def lambda16_(d_373_e_):
                            return software.amazon.cryptography.materialproviderstestvectorkeys.internaldafny.types.Error_AwsCryptographyMaterialProviders(d_373_e_)
            ...
            if True:
                ...
                d_379_valueOrError9_ = Wrappers.default__.Need(((d_300_material_).is_Some) and (((d_300_material_).value).is_Symetric), software.amazon.cryptography.materialproviderstestvectorkeys.internaldafny.types.Error_KeyVectorException(_dafny.Seq("Not type: Symetric")))
                ...
                def lambda17_(d_384_e_):
                    return software.amazon.cryptography.materialproviderstestvectorkeys.internaldafny.types.Error_AwsCryptographyMaterialProviders(d_384_e_)
            ...
            if True:
                ...
                d_388_valueOrError0_ = Wrappers.default__.Need(((d_300_material_).is_Some) and (((d_300_material_).value).is_StaticMaterial), software.amazon.cryptography.materialproviderstestvectorkeys.internaldafny.types.Error_KeyVectorException(_dafny.Seq("Not type: StaticMaterial")))
            ...
            if True:
                ...
                d_397_valueOrError5_ = Wrappers.default__.Need(((d_300_material_).is_Some) and (((d_300_material_).value).is_KMSAsymetric), software.amazon.cryptography.materialproviderstestvectorkeys.internaldafny.types.Error_KeyVectorException(_dafny.Seq("Not type: KMSAsymetric")))
                ...
                def lambda18_(d_402_e_):
                    return software.amazon.cryptography.materialproviderstestvectorkeys.internaldafny.types.Error_AwsCryptographyMaterialProviders(d_402_e_)
            ...
            if True:
                ...
                d_406_valueOrError7_ = Wrappers.default__.Need(((d_300_material_).is_Some) and (((d_300_material_).value).is_StaticKeyStoreInformation), software.amazon.cryptography.materialproviderstestvectorkeys.internaldafny.types.Error_KeyVectorException(_dafny.Seq("Not type: StaticKeyStoreInformation")))
                ...
                def lambda19_(d_410_e_):
                    return software.amazon.cryptography.materialproviderstestvectorkeys.internaldafny.types.Error_AwsCryptographyMaterialProviders(d_410_e_)
    ...
    def getKmsClient(mpl, maybeKmsArn):
        ...
        def lambda20_(d_414_e_):
            return software.amazon.cryptography.materialproviderstestvectorkeys.internaldafny.types.Error_AwsCryptographyMaterialProviders(d_414_e_)
        ...
        def lambda21_(d_417_e_):
            return software.amazon.cryptography.materialproviderstestvectorkeys.internaldafny.types.Error_KeyVectorException(d_417_e_)
        ...
        def lambda22_(d_419_e_):
            return software.amazon.cryptography.materialproviderstestvectorkeys.internaldafny.types.Error_AwsCryptographyMaterialProviders(d_419_e_)
