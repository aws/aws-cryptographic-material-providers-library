...
import (
	...
	m_TestWrappedMaterialProvidersMain "github.com/aws/aws-cryptographic-material-providers-library/testvectors/test/TestWrappedMaterialProvidersMain"
...
func (_static *CompanionStruct_Default___) Test____Main____(__noArgsParameter _dafny.Sequence) {
	...
	_ = _0_success
	_0_success = true
	_dafny.Print((_dafny.SeqOfString("TestWrappedMaterialProvidersMain.RunManifestTests: ")).SetString())
	func() {
		defer func() {
			if r := recover(); r != nil {
		...
		{
			m_TestWrappedMaterialProvidersMain.Companion_Default___.RunManifestTests()
			{
