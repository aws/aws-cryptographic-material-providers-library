...
replace github.com/aws/aws-cryptographic-material-providers-library/mpl v0.0.0 => ../../../../AwsCryptographicMaterialProviders/runtimes/go/ImplementationFromDafny-go/

replace github.com/aws/aws-cryptographic-material-providers-library/testvectors v0.0.0 => ../ImplementationFromDafny-go/

// TODO: Uncomment the below line to run profiling against a custom DafnyRuntimeGo
//replace github.com/dafny-lang/DafnyRuntimeGo/v4 v4.8.0 => /Volumes/workplace/smithy-dafny/DafnyRuntimeGo/
