// Package AllKmsMrkAware
// Dafny module AllKmsMrkAware compiled into Go
...
func (*Default__) String() string {
	return "AllKmsMrkAware.Default__"
}
...
func (_static *CompanionStruct_Default___) AllAwsKMSMrkKeys() _dafny.Sequence {
	return _dafny.SeqOf(_dafny.SeqOfString("us-west-2-mrk"), _dafny.SeqOfString("us-east-1-mrk"))
}
func (_static *CompanionStruct_Default___) KeyDescriptions() _dafny.Set {
	return func() _dafny.Set {
		var _coll0 = _dafny.NewBuilder()
		_ = _coll0
		for _iter34 := _dafny.Iterate((Companion_Default___.AllAwsKMSMrkKeys()).Elements()); ; {
			...
			if _dafny.Companion_Sequence_.Contains(Companion_Default___.AllAwsKMSMrkKeys(), _0_key) {
				_coll0.Add(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Companion_KeyDescription_.Create_KmsMrk_(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Companion_KmsMrkAware_.Create_KmsMrkAware_(_0_key)))
			}
		}
		return _coll0.ToSet()
	}()
...
func (_static *CompanionStruct_Default___) Tests() _dafny.Set {
	return func() _dafny.Set {
		var _coll0 = _dafny.NewBuilder()
		_ = _coll0
		for _iter35 := _dafny.Iterate((Companion_Default___.KeyDescriptions()).Elements()); ; {
			_compr_0, _ok35 := _iter35()
			if !_ok35 {
				break
			}
			...
			if (Companion_Default___.KeyDescriptions()).Contains(_0_encryptDescription) {
				for _iter36 := _dafny.Iterate((Companion_Default___.KeyDescriptions()).Elements()); ; {
					_compr_1, _ok36 := _iter36()
					if !_ok36 {
						break
					}
					...
					if (Companion_Default___.KeyDescriptions()).Contains(_1_decryptDescription) {
						for _iter37 := _dafny.Iterate((m_AllAlgorithmSuites.Companion_Default___.AllAlgorithmSuites()).Elements()); ; {
							_compr_2, _ok37 := _iter37()
							if !_ok37 {
								break
							}
							...
							if (m_AllAlgorithmSuites.Companion_Default___.AllAlgorithmSuites()).Contains(_2_algorithmSuite) {
								for _iter38 := _dafny.Iterate(_dafny.SingleValue(m_AllAlgorithmSuites.Companion_Default___.GetCompatibleCommitmentPolicy(_2_algorithmSuite))); ; {
									_compr_3, _ok38 := _iter38()
									if !_ok38 {
										break
									}
									...
									if (_3_commitmentPolicy).Equals(m_AllAlgorithmSuites.Companion_Default___.GetCompatibleCommitmentPolicy(_2_algorithmSuite)) {
										_coll0.Add(m_TestVectors.Companion_EncryptTestVector_.Create_PositiveEncryptKeyringVector_(_dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.SeqOfString("Generated KMS MRK "), ((_0_encryptDescription).Dtor_KmsMrk()).Dtor_keyId()), _dafny.SeqOfString("->")), ((_1_decryptDescription).Dtor_KmsMrk()).Dtor_keyId()), m_Wrappers.Companion_Option_.Create_None_(), _dafny.NewMapBuilder().ToMap(), _3_commitmentPolicy, _2_algorithmSuite, m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), _0_encryptDescription, _1_decryptDescription, m_Wrappers.Companion_Option_.Create_None_()))
									}
								}
							}
						}
