...
func (_static *CompanionStruct_Default___) KeyDescriptions() _dafny.Set {
	return func() _dafny.Set {
		...
		_ = _coll0
		for _iter14 := _dafny.Iterate((Companion_Default___.AllAwsKMSMrkKeys()).Elements()); ; {
...
func (_static *CompanionStruct_Default___) Tests() _dafny.Set {
	return func() _dafny.Set {
		var _coll0 = _dafny.NewBuilder()
		_ = _coll0
		for _iter15 := _dafny.Iterate((Companion_Default___.KeyDescriptions()).Elements()); ; {
			...
			if (Companion_Default___.KeyDescriptions()).Contains(_0_encryptDescription) {
				for _iter16 := _dafny.Iterate((Companion_Default___.KeyDescriptions()).Elements()); ; {
					_compr_1, _ok16 := _iter16()
					if !_ok16 {
						break
					}
					...
					if (Companion_Default___.KeyDescriptions()).Contains(_1_decryptDescription) {
						for _iter17 := _dafny.Iterate((m_AllAlgorithmSuites.Companion_Default___.AllAlgorithmSuites()).Elements()); ; {
							_compr_2, _ok17 := _iter17()
							if !_ok17 {
								break
							}
							...
							if (m_AllAlgorithmSuites.Companion_Default___.AllAlgorithmSuites()).Contains(_2_algorithmSuite) {
								for _iter18 := _dafny.Iterate(_dafny.SingleValue(m_AllAlgorithmSuites.Companion_Default___.GetCompatibleCommitmentPolicy(_2_algorithmSuite))); ; {
									_compr_3, _ok18 := _iter18()
									if !_ok18 {
										break
									}
