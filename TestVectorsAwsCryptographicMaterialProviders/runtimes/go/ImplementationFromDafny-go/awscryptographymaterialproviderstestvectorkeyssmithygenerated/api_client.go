...
type Client struct {
	DafnyClient *KeyVectors.KeyVectorsClient
}
...
func NewClient(clientConfig awscryptographymaterialproviderstestvectorkeyssmithygeneratedtypes.KeyVectorsConfig) (*Client, error) {
	...
	var dafnyClient = dafny_response.Extract().(*KeyVectors.KeyVectorsClient)
	client := &Client{dafnyClient}
	return client, nil
}

func (client *Client) CreateTestVectorKeyring(ctx context.Context, params awscryptographymaterialproviderstestvectorkeyssmithygeneratedtypes.TestVectorKeyringInput) (interface{}, error) {
	err := params.Validate()
	if err != nil {
...
func (client *Client) CreateWrappedTestVectorKeyring(ctx context.Context, params awscryptographymaterialproviderstestvectorkeyssmithygeneratedtypes.TestVectorKeyringInput) (interface{}, error) {
	err := params.Validate()
	if err != nil {
		opaqueErr := awscryptographymaterialproviderstestvectorkeyssmithygeneratedtypes.OpaqueError{
			ErrObject: err,
...
func (client *Client) CreateWrappedTestVectorCmm(ctx context.Context, params awscryptographymaterialproviderstestvectorkeyssmithygeneratedtypes.TestVectorCmmInput) (interface{}, error) {
	err := params.Validate()
	if err != nil {
		opaqueErr := awscryptographymaterialproviderstestvectorkeyssmithygeneratedtypes.OpaqueError{
			ErrObject: err,
...
func (client *Client) GetKeyDescription(ctx context.Context, params awscryptographymaterialproviderstestvectorkeyssmithygeneratedtypes.GetKeyDescriptionInput) (*awscryptographymaterialproviderstestvectorkeyssmithygeneratedtypes.GetKeyDescriptionOutput, error) {
	...
	var native_response = GetKeyDescriptionOutput_FromDafny(dafny_response.Extract().(AwsCryptographyMaterialProvidersTestVectorKeysTypes.GetKeyDescriptionOutput))
	return &native_response, nil
...
func (client *Client) SerializeKeyDescription(ctx context.Context, params awscryptographymaterialproviderstestvectorkeyssmithygeneratedtypes.SerializeKeyDescriptionInput) (*awscryptographymaterialproviderstestvectorkeyssmithygeneratedtypes.SerializeKeyDescriptionOutput, error) {
	...
	var native_response = SerializeKeyDescriptionOutput_FromDafny(dafny_response.Extract().(AwsCryptographyMaterialProvidersTestVectorKeysTypes.SerializeKeyDescriptionOutput))
	return &native_response, nil
