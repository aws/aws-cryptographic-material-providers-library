...
func (_static *CompanionStruct_Default___) WriteStuff(op m_MplManifestOptions.ManifestOptions) m_Wrappers.Result {
	...
	_ = output
	var _0_tests _dafny.Sequence
	_ = _0_tests
	_0_tests = m_SortedSets.SetToSequence(Companion_Default___.AllPositiveKeyringTests())
	var _1_testsJSON _dafny.Sequence
	_ = _1_testsJSON
	_1_testsJSON = _dafny.SeqOf()
	var _hi0 _dafny.Int = _dafny.IntOfUint32((_0_tests).Cardinality())
	_ = _hi0
	for _2_i := _dafny.Zero; _2_i.Cmp(_hi0) < 0; _2_i = _2_i.Plus(_dafny.One) {
		...
		var _4_name _dafny.Sequence
		_ = _4_name
		_4_name = (_3_valueOrError0).Extract().(_dafny.Sequence)
		var _5_valueOrError1 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(m_JSON_Values.Companion_JSON_.Default())
		_ = _5_valueOrError1
		_5_valueOrError1 = m_WriteJsonManifests.Companion_Default___.EncryptTestVectorToJson((_0_tests).Select((_2_i).Uint32()).(m_TestVectors.EncryptTestVector))
		if (_5_valueOrError1).IsFailure() {
			output = (_5_valueOrError1).PropagateFailure()
			return output
		}
		var _6_test m_JSON_Values.JSON
		_ = _6_test
		_6_test = (_5_valueOrError1).Extract().(m_JSON_Values.JSON)
		_1_testsJSON = _dafny.Companion_Sequence_.Concatenate(_1_testsJSON, _dafny.SeqOf(_dafny.TupleOf(_4_name, _6_test)))
	}
	var _7_mplEncryptManifest m_JSON_Values.JSON
	_ = _7_mplEncryptManifest
	_7_mplEncryptManifest = m_JSON_Values.Companion_JSON_.Create_Object_(_dafny.SeqOf(_dafny.TupleOf(_dafny.SeqOfString("manifest"), m_JSON_Values.Companion_JSON_.Create_Object_(_dafny.SeqOf(_dafny.TupleOf(_dafny.SeqOfString("version"), m_JSON_Values.Companion_JSON_.Create_Number_(m_JSON_Values.Companion_Default___.Int(_dafny.IntOfInt64(4)))), _dafny.TupleOf(_dafny.SeqOfString("type"), m_JSON_Values.Companion_JSON_.Create_String_(_dafny.SeqOfString("awses-mpl-encrypt")))))), _dafny.TupleOf(_dafny.SeqOfString("keys"), m_JSON_Values.Companion_JSON_.Create_String_(_dafny.SeqOfString("file://keys.json"))), _dafny.TupleOf(_dafny.SeqOfString("tests"), m_JSON_Values.Companion_JSON_.Create_Object_(_1_testsJSON))))
	var _8_valueOrError2 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(_dafny.EmptySeq)
	_ = _8_valueOrError2
	_8_valueOrError2 = (m_JSON_API.Companion_Default___.Serialize(_7_mplEncryptManifest)).MapFailure(func(coer97 func(m_JSON_Errors.SerializationError) _dafny.Sequence) func(interface{}) interface{} {
		return func(arg137 interface{}) interface{} {
			return coer97(arg137.(m_JSON_Errors.SerializationError))
		}
	}(func(_9_e m_JSON_Errors.SerializationError) _dafny.Sequence {
		return (_9_e).ToString()
	}))
	if (_8_valueOrError2).IsFailure() {
		output = (_8_valueOrError2).PropagateFailure()
		return output
	}
	var _10_mplEncryptManifestBytes _dafny.Sequence
	_ = _10_mplEncryptManifestBytes
	_10_mplEncryptManifestBytes = (_8_valueOrError2).Extract().(_dafny.Sequence)
	var _11_valueOrError3 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(_dafny.TupleOf())
	_ = _11_valueOrError3
	var _out1 m_Wrappers.Result
	_ = _out1
	_out1 = Companion_Default___.WriteVectorsFile(_dafny.Companion_Sequence_.Concatenate((op).Dtor_encryptManifestOutput(), _dafny.SeqOfString("manifest.json")), _10_mplEncryptManifestBytes)
	_11_valueOrError3 = _out1
	if (_11_valueOrError3).IsFailure() {
		output = (_11_valueOrError3).PropagateFailure()
		return output
	}
	var _12___v0 _dafny.Tuple
	_ = _12___v0
	_12___v0 = (_11_valueOrError3).Extract().(_dafny.Tuple)
...
func (_static *CompanionStruct_Default___) WriteDecryptManifest(op m_MplManifestOptions.ManifestOptions, keys *m_KeyVectors.KeyVectorsClient, tests _dafny.Sequence) m_Wrappers.Result {
	...
	_ = _7_valueOrError2
	_7_valueOrError2 = (m_JSON_API.Companion_Default___.Serialize(_6_mplDecryptManifest)).MapFailure(func(coer98 func(m_JSON_Errors.SerializationError) _dafny.Sequence) func(interface{}) interface{} {
		return func(arg138 interface{}) interface{} {
			return coer98(arg138.(m_JSON_Errors.SerializationError))
		}
	...
	_ = _13_valueOrError4
	_13_valueOrError4 = (m_JSON_API.Companion_Default___.Serialize(((keys).Config()).Dtor_keysJson())).MapFailure(func(coer99 func(m_JSON_Errors.SerializationError) _dafny.Sequence) func(interface{}) interface{} {
		return func(arg139 interface{}) interface{} {
			return coer99(arg139.(m_JSON_Errors.SerializationError))
		}
