// Package AllKmsMrkAwareDiscovery
// Dafny module AllKmsMrkAwareDiscovery compiled into Go
...
func (*Default__) String() string {
	return "AllKmsMrkAwareDiscovery.Default__"
}
...
func (_static *CompanionStruct_Default___) AllDiscoveryFilters() _dafny.Set {
	return _dafny.SetOf(m_Wrappers.Companion_Option_.Create_Some_(m_AwsCryptographyMaterialProvidersTypes.Companion_DiscoveryFilter_.Create_DiscoveryFilter_(_dafny.SeqOf(_dafny.SeqOfString("658956600833")), _dafny.SeqOfString("aws"))), m_Wrappers.Companion_Option_.Create_None_())
}
func (_static *CompanionStruct_Default___) KeyDescriptions() _dafny.Set {
	return func() _dafny.Set {
		var _coll0 = _dafny.NewBuilder()
		_ = _coll0
		for _iter39 := _dafny.Iterate((Companion_Default___.AllDiscoveryFilters()).Elements()); ; {
			_compr_0, _ok39 := _iter39()
			if !_ok39 {
				break
			}
			var _0_filter m_Wrappers.Option
			_0_filter = interface{}(_compr_0).(m_Wrappers.Option)
			if (Companion_Default___.AllDiscoveryFilters()).Contains(_0_filter) {
				_coll0.Add(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Companion_KeyDescription_.Create_KmsMrkDiscovery_(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Companion_KmsMrkAwareDiscovery_.Create_KmsMrkAwareDiscovery_(_dafny.SeqOfString(""), _dafny.SeqOfString("us-west-2"), _0_filter)))
			}
		}
		return _coll0.ToSet()
	}()
...
func (_static *CompanionStruct_Default___) Tests() _dafny.Set {
	return func() _dafny.Set {
		var _coll0 = _dafny.NewBuilder()
		_ = _coll0
		for _iter40 := _dafny.Iterate((m_AllKmsMrkAware.Companion_Default___.KeyDescriptions()).Elements()); ; {
			_compr_0, _ok40 := _iter40()
			if !_ok40 {
				break
			}
			var _0_encryptDescription m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription
			_0_encryptDescription = interface{}(_compr_0).(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription)
			if (m_AllKmsMrkAware.Companion_Default___.KeyDescriptions()).Contains(_0_encryptDescription) {
				for _iter41 := _dafny.Iterate((Companion_Default___.KeyDescriptions()).Elements()); ; {
					_compr_1, _ok41 := _iter41()
					if !_ok41 {
						break
					}
					var _1_decryptDescription m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription
					_1_decryptDescription = interface{}(_compr_1).(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription)
					if (Companion_Default___.KeyDescriptions()).Contains(_1_decryptDescription) {
						for _iter42 := _dafny.Iterate((m_AllAlgorithmSuites.Companion_Default___.AllAlgorithmSuites()).Elements()); ; {
							_compr_2, _ok42 := _iter42()
							if !_ok42 {
								break
							}
							...
							if (m_AllAlgorithmSuites.Companion_Default___.AllAlgorithmSuites()).Contains(_2_algorithmSuite) {
								for _iter43 := _dafny.Iterate(_dafny.SingleValue(m_AllAlgorithmSuites.Companion_Default___.GetCompatibleCommitmentPolicy(_2_algorithmSuite))); ; {
									_compr_3, _ok43 := _iter43()
									if !_ok43 {
										break
									}
									...
									if (_3_commitmentPolicy).Equals(m_AllAlgorithmSuites.Companion_Default___.GetCompatibleCommitmentPolicy(_2_algorithmSuite)) {
										_coll0.Add(m_TestVectors.Companion_EncryptTestVector_.Create_PositiveEncryptKeyringVector_(_dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.SeqOfString("Generated Discovery KMS MRK "), ((_0_encryptDescription).Dtor_KmsMrk()).Dtor_keyId()), _dafny.SeqOfString("->")), (func() _dafny.Sequence {
											if (((_1_decryptDescription).Dtor_KmsMrkDiscovery()).Dtor_awsKmsDiscoveryFilter()).Is_Some() {
												return _dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.SeqOfString("Filter "), ((((_1_decryptDescription).Dtor_KmsMrkDiscovery()).Dtor_awsKmsDiscoveryFilter()).Dtor_value().(m_AwsCryptographyMaterialProvidersTypes.DiscoveryFilter)).Dtor_partition()), _dafny.SeqOfString(" ")), m_Seq.Companion_Default___.Flatten(((((_1_decryptDescription).Dtor_KmsMrkDiscovery()).Dtor_awsKmsDiscoveryFilter()).Dtor_value().(m_AwsCryptographyMaterialProvidersTypes.DiscoveryFilter)).Dtor_accountIds()))
											}
											return _dafny.SeqOfString("No Filter")
										})()), m_Wrappers.Companion_Option_.Create_None_(), _dafny.NewMapBuilder().ToMap(), _3_commitmentPolicy, _2_algorithmSuite, m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), _0_encryptDescription, _1_decryptDescription, m_Wrappers.Companion_Option_.Create_None_()))
									}
								}
							}
						}
...
func (_static *CompanionStruct_Default___) AwsPartitions() _dafny.Sequence {
	return _dafny.SeqOf(_dafny.SeqOfString("aws"))
}
func (_static *CompanionStruct_Default___) AWSAccounts() _dafny.Sequence {
