...
func (_static *CompanionStruct_Default___) KeyDescriptions() _dafny.Set {
	return func() _dafny.Set {
		...
		_ = _coll0
		for _iter19 := _dafny.Iterate((Companion_Default___.AllDiscoveryFilters()).Elements()); ; {
...
func (_static *CompanionStruct_Default___) Tests() _dafny.Set {
	return func() _dafny.Set {
		var _coll0 = _dafny.NewBuilder()
		_ = _coll0
		for _iter20 := _dafny.Iterate((m_AllKmsMrkAware.Companion_Default___.KeyDescriptions()).Elements()); ; {
			...
			if (m_AllKmsMrkAware.Companion_Default___.KeyDescriptions()).Contains(_0_encryptDescription) {
				for _iter21 := _dafny.Iterate((Companion_Default___.KeyDescriptions()).Elements()); ; {
					_compr_1, _ok21 := _iter21()
					if !_ok21 {
						break
					}
					...
					if (Companion_Default___.KeyDescriptions()).Contains(_1_decryptDescription) {
						for _iter22 := _dafny.Iterate((m_AllAlgorithmSuites.Companion_Default___.AllAlgorithmSuites()).Elements()); ; {
							_compr_2, _ok22 := _iter22()
							if !_ok22 {
								break
							}
							...
							if (m_AllAlgorithmSuites.Companion_Default___.AllAlgorithmSuites()).Contains(_2_algorithmSuite) {
								for _iter23 := _dafny.Iterate(_dafny.SingleValue(m_AllAlgorithmSuites.Companion_Default___.GetCompatibleCommitmentPolicy(_2_algorithmSuite))); ; {
									_compr_3, _ok23 := _iter23()
									if !_ok23 {
										break
									}
