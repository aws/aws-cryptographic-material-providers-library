...
func (_static CompanionStruct_Default___) WrappedMaterialProviders(i AwsCryptographyMaterialProvidersTypes.MaterialProvidersConfig) Wrappers.Result {
	return WrappedAwsCryptographyMaterialProvidersService.WrappedMaterialProviders(i)
}
