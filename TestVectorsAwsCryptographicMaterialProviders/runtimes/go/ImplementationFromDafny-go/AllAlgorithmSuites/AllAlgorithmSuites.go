// Package AllAlgorithmSuites
// Dafny module AllAlgorithmSuites compiled into Go
...
func (*Default__) String() string {
	return "AllAlgorithmSuites.Default__"
}
...
func (_static *CompanionStruct_Default___) GetCompatibleCommitmentPolicy(algorithmSuite m_AwsCryptographyMaterialProvidersTypes.AlgorithmSuiteInfo) m_AwsCryptographyMaterialProvidersTypes.CommitmentPolicy {
...
func (_static *CompanionStruct_Default___) ToHex(algorithmSuite m_AwsCryptographyMaterialProvidersTypes.AlgorithmSuiteInfo) _dafny.Sequence {
	return m_HexStrings.Companion_Default___.ToHexString((algorithmSuite).Dtor_binaryId())
}
func (_static *CompanionStruct_Default___) ESDKAlgorithmSuites() _dafny.Set {
	return func() _dafny.Set {
		var _coll0 = _dafny.NewBuilder()
		_ = _coll0
		for _iter0 := _dafny.Iterate(m_AwsCryptographyMaterialProvidersTypes.Companion_ESDKAlgorithmSuiteId_.AllSingletonConstructors()); ; {
			_compr_0, _ok0 := _iter0()
			if !_ok0 {
				break
			}
			var _0_id m_AwsCryptographyMaterialProvidersTypes.ESDKAlgorithmSuiteId
			_0_id = interface{}(_compr_0).(m_AwsCryptographyMaterialProvidersTypes.ESDKAlgorithmSuiteId)
			_coll0.Add(m_AlgorithmSuites.Companion_Default___.GetESDKSuite(_0_id))
		}
		return _coll0.ToSet()
	}()
}
func (_static *CompanionStruct_Default___) DBEAlgorithmSuites() _dafny.Set {
	return func() _dafny.Set {
		var _coll0 = _dafny.NewBuilder()
		_ = _coll0
		for _iter1 := _dafny.Iterate(m_AwsCryptographyMaterialProvidersTypes.Companion_DBEAlgorithmSuiteId_.AllSingletonConstructors()); ; {
			_compr_0, _ok1 := _iter1()
			if !_ok1 {
				break
			}
			var _0_id m_AwsCryptographyMaterialProvidersTypes.DBEAlgorithmSuiteId
			_0_id = interface{}(_compr_0).(m_AwsCryptographyMaterialProvidersTypes.DBEAlgorithmSuiteId)
			_coll0.Add(m_AlgorithmSuites.Companion_Default___.GetDBESuite(_0_id))
		}
		return _coll0.ToSet()
	}()
}
func (_static *CompanionStruct_Default___) AllAlgorithmSuites() _dafny.Set {
	return (Companion_Default___.ESDKAlgorithmSuites()).Union(Companion_Default___.DBEAlgorithmSuites())
}
