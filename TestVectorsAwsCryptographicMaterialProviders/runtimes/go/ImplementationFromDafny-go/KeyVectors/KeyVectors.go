...
func (_static *CompanionStruct_Default___) KeyVectors(config m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyVectorsConfig) m_Wrappers.Result {
	...
	if !(!((_0_valueOrError0).IsFailure())) {
		panic("dafny/KeyVectors/src/Index.dfy(30,26): " + (_0_valueOrError0).String())
	}
	var _1_keysManifestBv _dafny.Sequence
	_ = _1_keysManifestBv
	_1_keysManifestBv = (_0_valueOrError0).Extract().(_dafny.Sequence)
	var _2_keysManifestBytes _dafny.Sequence
	_ = _2_keysManifestBytes
	_2_keysManifestBytes = m_JSONHelpers.Companion_Default___.BvToBytes(_1_keysManifestBv)
	var _3_valueOrError1 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(m_JSON_Values.Companion_JSON_.Default())
	_ = _3_valueOrError1
	_3_valueOrError1 = (m_JSON_API.Companion_Default___.Deserialize(_2_keysManifestBytes)).MapFailure(func(coer49 func(m_JSON_Errors.DeserializationError) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Error) func(interface{}) interface{} {
		return func(arg49 interface{}) interface{} {
			return coer49(arg49.(m_JSON_Errors.DeserializationError))
		}
	}(func(_4_e m_JSON_Errors.DeserializationError) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Error {
		return m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Companion_Error_.Create_KeyVectorException_((_4_e).ToString())
	}))
	if (_3_valueOrError1).IsFailure() {
		res = (_3_valueOrError1).PropagateFailure()
		return res
	}
	var _5_keysManifestJSON m_JSON_Values.JSON
	_ = _5_keysManifestJSON
	_5_keysManifestJSON = (_3_valueOrError1).Extract().(m_JSON_Values.JSON)
	if !((_5_keysManifestJSON).Is_Object()) {
		panic("dafny/KeyVectors/src/Index.dfy(36,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
	var _6_valueOrError2 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(m_JSON_Values.Companion_JSON_.Default())
	_ = _6_valueOrError2
	_6_valueOrError2 = m_JSONHelpers.Companion_Default___.Get(_dafny.SeqOfString("keys"), (_5_keysManifestJSON).Dtor_obj())
	if !(!((_6_valueOrError2).IsFailure())) {
		panic("dafny/KeyVectors/src/Index.dfy(37,22): " + (_6_valueOrError2).String())
	}
	var _7_keysObject m_JSON_Values.JSON
	_ = _7_keysObject
	_7_keysObject = (_6_valueOrError2).Extract().(m_JSON_Values.JSON)
	if !((_7_keysObject).Is_Object()) {
		panic("dafny/KeyVectors/src/Index.dfy(38,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
	var _8_maybeMpl m_Wrappers.Result
	_ = _8_maybeMpl
	...
	_ = _9_valueOrError3
	_9_valueOrError3 = (_8_maybeMpl).MapFailure(func(coer50 func(m_AwsCryptographyMaterialProvidersTypes.Error) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Error) func(interface{}) interface{} {
		return func(arg50 interface{}) interface{} {
			return coer50(arg50.(m_AwsCryptographyMaterialProvidersTypes.Error))
		}
	}(func(_10_e m_AwsCryptographyMaterialProvidersTypes.Error) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Error {
		return m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Companion_Error_.Create_AwsCryptographyMaterialProviders_(_10_e)
	}))
	if (_9_valueOrError3).IsFailure() {
		res = (_9_valueOrError3).PropagateFailure()
		return res
	}
	var _11_mpl *m_MaterialProviders.MaterialProvidersClient
	_ = _11_mpl
	_11_mpl = (_9_valueOrError3).Extract().(*m_MaterialProviders.MaterialProvidersClient)
	var _12_valueOrError4 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(_dafny.EmptyMap)
	_ = _12_valueOrError4
	_12_valueOrError4 = (m_KeyMaterial.Companion_Default___.BuildKeyMaterials(_11_mpl, (_7_keysObject).Dtor_obj())).MapFailure(func(coer51 func(_dafny.Sequence) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Error) func(interface{}) interface{} {
		return func(arg51 interface{}) interface{} {
			return coer51(arg51.(_dafny.Sequence))
		}
	}(func(_13_e _dafny.Sequence) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Error {
		return m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Companion_Error_.Create_KeyVectorException_(_13_e)
	}))
	if (_12_valueOrError4).IsFailure() {
		res = (_12_valueOrError4).PropagateFailure()
		return res
	}
	var _14_keys _dafny.Map
	_ = _14_keys
	_14_keys = (_12_valueOrError4).Extract().(_dafny.Map)
	var _15_config m_KeysVectorOperations.Config
	_ = _15_config
	_15_config = m_KeysVectorOperations.Companion_Config_.Create_Config_(_14_keys, _5_keysManifestJSON)
	var _16_client *KeyVectorsClient
	_ = _16_client
	var _nw0 *KeyVectorsClient = New_KeyVectorsClient_()
	_ = _nw0
	_nw0.Ctor__(_15_config)
	_16_client = _nw0
	res = m_Wrappers.Companion_Result_.Create_Success_(_16_client)
	return res
}
