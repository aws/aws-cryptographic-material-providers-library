// Package CreateStaticKeyrings
// Dafny module CreateStaticKeyrings compiled into Go
...
func (*Default__) String() string {
	return "CreateStaticKeyrings.Default__"
}
...
func (_static *CompanionStruct_Default___) CreateStaticMaterialsKeyring(encryptMaterial m_AwsCryptographyMaterialProvidersTypes.EncryptionMaterials, decryptMaterial m_AwsCryptographyMaterialProvidersTypes.DecryptionMaterials) m_AwsCryptographyMaterialProvidersTypes.IKeyring {
	var keyring m_AwsCryptographyMaterialProvidersTypes.IKeyring = (m_AwsCryptographyMaterialProvidersTypes.IKeyring)(nil)
	_ = keyring
	var _nw0 *StaticMaterialsKeyring = New_StaticMaterialsKeyring_()
	_ = _nw0
	_nw0.Ctor__(encryptMaterial, decryptMaterial)
	keyring = _nw0
	return keyring
	return keyring
}
...
// Definition of class StaticMaterialsKeyring
type StaticMaterialsKeyring struct {
	_encryptMaterial m_AwsCryptographyMaterialProvidersTypes.EncryptionMaterials
	_decryptMaterial m_AwsCryptographyMaterialProvidersTypes.DecryptionMaterials
}

func New_StaticMaterialsKeyring_() *StaticMaterialsKeyring {
	_this := StaticMaterialsKeyring{}

	_this._encryptMaterial = m_AwsCryptographyMaterialProvidersTypes.EncryptionMaterials{}
	_this._decryptMaterial = m_AwsCryptographyMaterialProvidersTypes.DecryptionMaterials{}
	return &_this
}

type CompanionStruct_StaticMaterialsKeyring_ struct {
}

var Companion_StaticMaterialsKeyring_ = CompanionStruct_StaticMaterialsKeyring_{}

func (_this *StaticMaterialsKeyring) Equals(other *StaticMaterialsKeyring) bool {
	return _this == other
}

func (_this *StaticMaterialsKeyring) EqualsGeneric(x interface{}) bool {
	other, ok := x.(*StaticMaterialsKeyring)
	return ok && _this.Equals(other)
}

func (*StaticMaterialsKeyring) String() string {
	return "CreateStaticKeyrings.StaticMaterialsKeyring"
}

func Type_StaticMaterialsKeyring_() _dafny.TypeDescriptor {
	return type_StaticMaterialsKeyring_{}
}

type type_StaticMaterialsKeyring_ struct {
}

func (_this type_StaticMaterialsKeyring_) Default() interface{} {
	return (*StaticMaterialsKeyring)(nil)
}

func (_this type_StaticMaterialsKeyring_) String() string {
	return "CreateStaticKeyrings.StaticMaterialsKeyring"
}
func (_this *StaticMaterialsKeyring) ParentTraits_() []*_dafny.TraitID {
	return [](*_dafny.TraitID){m_AwsCryptographyMaterialProvidersTypes.Companion_IKeyring_.TraitID_}
}

var _ m_AwsCryptographyMaterialProvidersTypes.IKeyring = &StaticMaterialsKeyring{}
var _ _dafny.TraitOffspring = &StaticMaterialsKeyring{}

func (_this *StaticMaterialsKeyring) OnDecrypt(input m_AwsCryptographyMaterialProvidersTypes.OnDecryptInput) m_Wrappers.Result {
	var _out0 m_Wrappers.Result
	_ = _out0
	_out0 = m_AwsCryptographyMaterialProvidersTypes.Companion_IKeyring_.OnDecrypt(_this, input)
	return _out0
}
func (_this *StaticMaterialsKeyring) OnEncrypt(input m_AwsCryptographyMaterialProvidersTypes.OnEncryptInput) m_Wrappers.Result {
	var _out0 m_Wrappers.Result
	_ = _out0
	_out0 = m_AwsCryptographyMaterialProvidersTypes.Companion_IKeyring_.OnEncrypt(_this, input)
	return _out0
}
func (_this *StaticMaterialsKeyring) Ctor__(encryptMaterial m_AwsCryptographyMaterialProvidersTypes.EncryptionMaterials, decryptMaterial m_AwsCryptographyMaterialProvidersTypes.DecryptionMaterials) {
	{
		(_this)._encryptMaterial = encryptMaterial
		(_this)._decryptMaterial = decryptMaterial
	}
}
func (_this *StaticMaterialsKeyring) OnEncrypt_k(input m_AwsCryptographyMaterialProvidersTypes.OnEncryptInput) m_Wrappers.Result {
	{
		var res m_Wrappers.Result = m_Wrappers.Result{}
		_ = res
		res = m_Wrappers.Companion_Result_.Create_Success_(m_AwsCryptographyMaterialProvidersTypes.Companion_OnEncryptOutput_.Create_OnEncryptOutput_((_this).EncryptMaterial()))
		return res
		return res
	}
}
func (_this *StaticMaterialsKeyring) OnDecrypt_k(input m_AwsCryptographyMaterialProvidersTypes.OnDecryptInput) m_Wrappers.Result {
	{
		var res m_Wrappers.Result = m_Wrappers.Result{}
		_ = res
		res = m_Wrappers.Companion_Result_.Create_Success_(m_AwsCryptographyMaterialProvidersTypes.Companion_OnDecryptOutput_.Create_OnDecryptOutput_((_this).DecryptMaterial()))
		return res
		return res
	}
}
func (_this *StaticMaterialsKeyring) EncryptMaterial() m_AwsCryptographyMaterialProvidersTypes.EncryptionMaterials {
	{
		return _this._encryptMaterial
	}
}
func (_this *StaticMaterialsKeyring) DecryptMaterial() m_AwsCryptographyMaterialProvidersTypes.DecryptionMaterials {
	{
		return _this._decryptMaterial
	}
}

// End of class StaticMaterialsKeyring
