// Package AllRawRSA
// Dafny module AllRawRSA compiled into Go
...
func (_static *CompanionStruct_Default___) RsaPersistentKeyNamesWithoutPublicPrivate() _dafny.Sequence {
	return _dafny.SeqOf(_dafny.SeqOfString("rsa-4096"))
}
func (_static *CompanionStruct_Default___) KeyDescriptions() _dafny.Set {
	return func() _dafny.Set {
		var _coll0 = _dafny.NewBuilder()
		_ = _coll0
		for _iter96 := _dafny.Iterate((Companion_Default___.RsaPersistentKeyNamesWithoutPublicPrivate()).Elements()); ; {
			_compr_0, _ok96 := _iter96()
			if !_ok96 {
				break
			}
			var _0_key _dafny.Sequence
			_0_key = interface{}(_compr_0).(_dafny.Sequence)
			if _dafny.Companion_Sequence_.Contains(Companion_Default___.RsaPersistentKeyNamesWithoutPublicPrivate(), _0_key) {
				for _iter97 := _dafny.Iterate(m_AwsCryptographyMaterialProvidersTypes.Companion_PaddingScheme_.AllSingletonConstructors()); ; {
					_compr_1, _ok97 := _iter97()
					if !_ok97 {
						break
					}
					var _1_padding m_AwsCryptographyMaterialProvidersTypes.PaddingScheme
					_1_padding = interface{}(_compr_1).(m_AwsCryptographyMaterialProvidersTypes.PaddingScheme)
					_coll0.Add(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Companion_KeyDescription_.Create_RSA_(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Companion_RawRSA_.Create_RawRSA_(_0_key, _dafny.Companion_Sequence_.Concatenate(_dafny.SeqOfString("aws-raw-vectors-persistent-"), _0_key), _1_padding)))
				}
			}
		}
		return _coll0.ToSet()
...
func (_static *CompanionStruct_Default___) Tests() _dafny.Set {
	return func() _dafny.Set {
		var _coll0 = _dafny.NewBuilder()
		_ = _coll0
		for _iter98 := _dafny.Iterate((Companion_Default___.KeyDescriptions()).Elements()); ; {
			_compr_0, _ok98 := _iter98()
			if !_ok98 {
				break
			}
			...
			if (Companion_Default___.KeyDescriptions()).Contains(_0_keyDescription) {
				for _iter99 := _dafny.Iterate((m_AllAlgorithmSuites.Companion_Default___.AllAlgorithmSuites()).Elements()); ; {
					_compr_1, _ok99 := _iter99()
					if !_ok99 {
						break
					}
					...
					if (m_AllAlgorithmSuites.Companion_Default___.AllAlgorithmSuites()).Contains(_1_algorithmSuite) {
						for _iter100 := _dafny.Iterate(_dafny.SingleValue(m_AllAlgorithmSuites.Companion_Default___.GetCompatibleCommitmentPolicy(_1_algorithmSuite))); ; {
							_compr_2, _ok100 := _iter100()
							if !_ok100 {
								break
							}
							...
							if (_2_commitmentPolicy).Equals(m_AllAlgorithmSuites.Companion_Default___.GetCompatibleCommitmentPolicy(_1_algorithmSuite)) {
								_coll0.Add(m_TestVectors.Companion_EncryptTestVector_.Create_PositiveEncryptKeyringVector_(_dafny.Companion_Sequence_.Concatenate(_dafny.SeqOfString("Generated RawRSA "), ((_0_keyDescription).Dtor_RSA()).Dtor_keyId()), m_Wrappers.Companion_Option_.Create_None_(), _dafny.NewMapBuilder().ToMap(), _2_commitmentPolicy, _1_algorithmSuite, m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), func(_pat_let8_0 m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription {
									return func(_3_dt__update__tmp_h0 m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription {
										return func(_pat_let9_0 m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.RawRSA) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription {
											return func(_6_dt__update_hRSA_h0 m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.RawRSA) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription {
												return m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Companion_KeyDescription_.Create_RSA_(_6_dt__update_hRSA_h0)
											}(_pat_let9_0)
										}(func(_pat_let10_0 m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.RawRSA) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.RawRSA {
											return func(_4_dt__update__tmp_h1 m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.RawRSA) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.RawRSA {
												return func(_pat_let11_0 _dafny.Sequence) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.RawRSA {
													return func(_5_dt__update_hkeyId_h0 _dafny.Sequence) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.RawRSA {
														return m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Companion_RawRSA_.Create_RawRSA_(_5_dt__update_hkeyId_h0, (_4_dt__update__tmp_h1).Dtor_providerId(), (_4_dt__update__tmp_h1).Dtor_padding())
													}(_pat_let11_0)
												}(_dafny.Companion_Sequence_.Concatenate(((_0_keyDescription).Dtor_RSA()).Dtor_keyId(), _dafny.SeqOfString("-public")))
											}(_pat_let10_0)
										}((_0_keyDescription).Dtor_RSA()))
									}(_pat_let8_0)
								}(_0_keyDescription), func(_pat_let12_0 m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription {
									return func(_7_dt__update__tmp_h2 m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription {
										return func(_pat_let13_0 m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.RawRSA) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription {
											return func(_10_dt__update_hRSA_h1 m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.RawRSA) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription {
												return m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Companion_KeyDescription_.Create_RSA_(_10_dt__update_hRSA_h1)
											}(_pat_let13_0)
										}(func(_pat_let14_0 m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.RawRSA) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.RawRSA {
											return func(_8_dt__update__tmp_h3 m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.RawRSA) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.RawRSA {
												return func(_pat_let15_0 _dafny.Sequence) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.RawRSA {
													return func(_9_dt__update_hkeyId_h1 _dafny.Sequence) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.RawRSA {
														return m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Companion_RawRSA_.Create_RawRSA_(_9_dt__update_hkeyId_h1, (_8_dt__update__tmp_h3).Dtor_providerId(), (_8_dt__update__tmp_h3).Dtor_padding())
													}(_pat_let15_0)
												}(_dafny.Companion_Sequence_.Concatenate(((_0_keyDescription).Dtor_RSA()).Dtor_keyId(), _dafny.SeqOfString("-private")))
											}(_pat_let14_0)
										}((_0_keyDescription).Dtor_RSA()))
									}(_pat_let12_0)
								}(_0_keyDescription), m_Wrappers.Companion_Option_.Create_None_()))
							}
						}
					}
				}
