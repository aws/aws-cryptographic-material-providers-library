...
func (_static *CompanionStruct_Default___) KeyDescriptions() _dafny.Set {
	return func() _dafny.Set {
		...
		_ = _coll0
		for _iter46 := _dafny.Iterate((Companion_Default___.RsaPersistentKeyNamesWithoutPublicPrivate()).Elements()); ; {
			_compr_0, _ok46 := _iter46()
			if !_ok46 {
				break
			}
			...
			if _dafny.Companion_Sequence_.Contains(Companion_Default___.RsaPersistentKeyNamesWithoutPublicPrivate(), _0_key) {
				for _iter47 := _dafny.Iterate(m_AwsCryptographyMaterialProvidersTypes.Companion_PaddingScheme_.AllSingletonConstructors()); ; {
					_compr_1, _ok47 := _iter47()
					if !_ok47 {
						break
					}
...
func (_static *CompanionStruct_Default___) Tests() _dafny.Set {
	return func() _dafny.Set {
		var _coll0 = _dafny.NewBuilder()
		_ = _coll0
		for _iter48 := _dafny.Iterate((Companion_Default___.KeyDescriptions()).Elements()); ; {
			_compr_0, _ok48 := _iter48()
			if !_ok48 {
				break
			}
			...
			if (Companion_Default___.KeyDescriptions()).Contains(_0_keyDescription) {
				for _iter49 := _dafny.Iterate((m_AllAlgorithmSuites.Companion_Default___.AllAlgorithmSuites()).Elements()); ; {
					_compr_1, _ok49 := _iter49()
					if !_ok49 {
						break
					}
					...
					if (m_AllAlgorithmSuites.Companion_Default___.AllAlgorithmSuites()).Contains(_1_algorithmSuite) {
						for _iter50 := _dafny.Iterate(_dafny.SingleValue(m_AllAlgorithmSuites.Companion_Default___.GetCompatibleCommitmentPolicy(_1_algorithmSuite))); ; {
							_compr_2, _ok50 := _iter50()
							if !_ok50 {
								break
							}
