// Package EncryptionContextUtils
// Dafny module EncryptionContextUtils compiled into Go
...
func (*Default__) String() string {
	return "EncryptionContextUtils.Default__"
}
...
func (_static *CompanionStruct_Default___) Normal() _dafny.Sequence {
	return _dafny.SeqOf(uint8(110), uint8(111), uint8(114), uint8(109), uint8(97), uint8(108), uint8(237), uint8(128), uint8(128))
}
func (_static *CompanionStruct_Default___) Psi() _dafny.Sequence {
	return _dafny.SeqOf(uint8(240), uint8(144), uint8(128), uint8(130))
}
func (_static *CompanionStruct_Default___) EncryptionContextWithPsiMap() _dafny.Map {
	return _dafny.NewMapBuilder().ToMap().UpdateUnsafe(Companion_Default___.Normal(), Companion_Default___.Normal()).UpdateUnsafe(Companion_Default___.Psi(), Companion_Default___.Psi())
}
func (_static *CompanionStruct_Default___) EncryptionContextWitPsi() _dafny.Set {
	return _dafny.SetOf(Companion_Default___.EncryptionContextWithPsiMap())
}
func (_static *CompanionStruct_Default___) ReplacementChar() _dafny.Sequence {
	return _dafny.SeqOf(uint8(239), uint8(191), uint8(189))
}
func (_static *CompanionStruct_Default___) EncryptionContextWithReplacementMap() _dafny.Map {
	return _dafny.NewMapBuilder().ToMap().UpdateUnsafe(Companion_Default___.Normal(), Companion_Default___.Normal()).UpdateUnsafe(Companion_Default___.ReplacementChar(), Companion_Default___.ReplacementChar())
}
func (_static *CompanionStruct_Default___) EncryptionContextWitReplacementChar() _dafny.Set {
	return _dafny.SetOf(Companion_Default___.EncryptionContextWithReplacementMap())
}
func (_static *CompanionStruct_Default___) EncryptionContextControlMap() _dafny.Map {
	return _dafny.NewMapBuilder().ToMap().UpdateUnsafe(Companion_Default___.Normal(), Companion_Default___.Normal())
}
func (_static *CompanionStruct_Default___) EncryptionContextControl() _dafny.Set {
	return _dafny.SetOf(Companion_Default___.EncryptionContextControlMap())
}
...
func (_static *CompanionStruct_Default___) EncryptionContextBasicMap() _dafny.Map {
	return _dafny.NewMapBuilder().ToMap().UpdateUnsafe(Companion_Default___.A(), Companion_Default___.A())
}
func (_static *CompanionStruct_Default___) EncryptionContextBasic() _dafny.Set {
	return _dafny.SetOf(Companion_Default___.EncryptionContextBasicMap())
}
func (_static *CompanionStruct_Default___) EncryptionContextEmptyMap() _dafny.Map {
	return _dafny.NewMapBuilder().ToMap()
}
func (_static *CompanionStruct_Default___) EncryptionContextEmpty() _dafny.Set {
	return _dafny.SetOf(Companion_Default___.EncryptionContextEmptyMap())
}
func (_static *CompanionStruct_Default___) Ascii1() _dafny.Sequence {
	return _dafny.SeqOf(uint8(49))
}
func (_static *CompanionStruct_Default___) Ascii2() _dafny.Sequence {
	return _dafny.SeqOf(uint8(194), uint8(160))
}
func (_static *CompanionStruct_Default___) Ascii3() _dafny.Sequence {
	return _dafny.SeqOf(uint8(85))
}
func (_static *CompanionStruct_Default___) EncryptionContextAsciiMapMultipleKeyValues() _dafny.Map {
	return _dafny.NewMapBuilder().ToMap().UpdateUnsafe(Companion_Default___.Ascii1(), Companion_Default___.Ascii1()).UpdateUnsafe(Companion_Default___.Ascii2(), Companion_Default___.Ascii2()).UpdateUnsafe(Companion_Default___.Ascii3(), Companion_Default___.Ascii3())
}
func (_static *CompanionStruct_Default___) Ascii4() _dafny.Sequence {
	return _dafny.SeqOf(uint8(194), uint8(182))
}
func (_static *CompanionStruct_Default___) EncryptionContextAsciiMapSingleKeyValue() _dafny.Map {
	return _dafny.NewMapBuilder().ToMap().UpdateUnsafe(Companion_Default___.Ascii4(), Companion_Default___.Ascii4())
}
func (_static *CompanionStruct_Default___) EncryptionContextAscii() _dafny.Set {
	return _dafny.SetOf(Companion_Default___.EncryptionContextAsciiMapSingleKeyValue())
}
func (_static *CompanionStruct_Default___) Utf8__2__1() _dafny.Sequence {
	return _dafny.SeqOf(uint8(196), uint8(128))
}
func (_static *CompanionStruct_Default___) Utf8__2__2() _dafny.Sequence {
	return _dafny.SeqOf(uint8(212), uint8(152))
}
func (_static *CompanionStruct_Default___) Utf8__2__3() _dafny.Sequence {
	return _dafny.SeqOf(uint8(212), uint8(136))
}
func (_static *CompanionStruct_Default___) EncryptionContextUTF82MapMultipleKeyValues() _dafny.Map {
	return _dafny.NewMapBuilder().ToMap().UpdateUnsafe(Companion_Default___.Utf8__2__1(), Companion_Default___.Utf8__2__1()).UpdateUnsafe(Companion_Default___.Utf8__2__2(), Companion_Default___.Utf8__2__2()).UpdateUnsafe(Companion_Default___.Utf8__2__3(), Companion_Default___.Utf8__2__3())
}
func (_static *CompanionStruct_Default___) EncryptionContextUTF82MapSingleKeyValue() _dafny.Map {
	return _dafny.NewMapBuilder().ToMap().UpdateUnsafe(Companion_Default___.Utf8__2__3(), Companion_Default___.Utf8__2__3())
}
func (_static *CompanionStruct_Default___) EncryptionContextUTF82() _dafny.Set {
	return _dafny.SetOf(Companion_Default___.EncryptionContextUTF82MapSingleKeyValue())
}
func (_static *CompanionStruct_Default___) Utf8__3__1() _dafny.Sequence {
	return _dafny.SeqOf(uint8(224), uint8(160), uint8(128))
}
func (_static *CompanionStruct_Default___) Utf8__3__2() _dafny.Sequence {
	return _dafny.SeqOf(uint8(224), uint8(183), uint8(180))
}
func (_static *CompanionStruct_Default___) Utf8__3__3() _dafny.Sequence {
	return _dafny.SeqOf(uint8(226), uint8(136), uint8(176))
}
func (_static *CompanionStruct_Default___) EncryptionContextUTF83MapMultipleKeyValues() _dafny.Map {
	return _dafny.NewMapBuilder().ToMap().UpdateUnsafe(Companion_Default___.Utf8__3__1(), Companion_Default___.Utf8__3__1()).UpdateUnsafe(Companion_Default___.Utf8__3__2(), Companion_Default___.Utf8__3__2()).UpdateUnsafe(Companion_Default___.Utf8__3__3(), Companion_Default___.Utf8__3__3())
}
func (_static *CompanionStruct_Default___) EncryptionContextUTF83MapSingleKeyValue() _dafny.Map {
	return _dafny.NewMapBuilder().ToMap().UpdateUnsafe(Companion_Default___.Utf8__3__3(), Companion_Default___.Utf8__3__3())
}
func (_static *CompanionStruct_Default___) EncryptionContextUTF83() _dafny.Set {
	return _dafny.SetOf(Companion_Default___.EncryptionContextUTF83MapSingleKeyValue())
}
func (_static *CompanionStruct_Default___) Utf8__4__1() _dafny.Sequence {
	return _dafny.SeqOf(uint8(240), uint8(146), uint8(128), uint8(128))
}
func (_static *CompanionStruct_Default___) Utf8__4__2() _dafny.Sequence {
	return _dafny.SeqOf(uint8(240), uint8(147), uint8(128), uint8(163))
}
func (_static *CompanionStruct_Default___) Utf8__4__3() _dafny.Sequence {
	return _dafny.SeqOf(uint8(240), uint8(147), uint8(137), uint8(169))
}
func (_static *CompanionStruct_Default___) EncryptionContextUTF84MapMultipleKeyValues() _dafny.Map {
	return _dafny.NewMapBuilder().ToMap().UpdateUnsafe(Companion_Default___.Utf8__4__1(), Companion_Default___.Utf8__4__1()).UpdateUnsafe(Companion_Default___.Utf8__4__2(), Companion_Default___.Utf8__4__2()).UpdateUnsafe(Companion_Default___.Utf8__4__3(), Companion_Default___.Utf8__4__3())
}
func (_static *CompanionStruct_Default___) EncryptionContextUTF84MapSingleKeyValue() _dafny.Map {
	return _dafny.NewMapBuilder().ToMap().UpdateUnsafe(Companion_Default___.Utf8__4__1(), Companion_Default___.Utf8__4__1())
}
func (_static *CompanionStruct_Default___) EncryptionContextUTF84() _dafny.Set {
	return _dafny.SetOf(Companion_Default___.EncryptionContextUTF84MapSingleKeyValue())
}
func (_static *CompanionStruct_Default___) VariedUTF8EncryptionContext() _dafny.Set {
	return (((((_dafny.SetOf()).Union(Companion_Default___.EncryptionContextAscii())).Union(Companion_Default___.EncryptionContextUTF82())).Union(Companion_Default___.EncryptionContextUTF83())).Union(Companion_Default___.EncryptionContextUTF84())).Union(Companion_Default___.EncryptionContextWitReplacementChar())
}
func (_static *CompanionStruct_Default___) RepresentativeEncryptionContextUtf8Values() _dafny.Set {
	return _dafny.SetOf(Companion_Default___.Ascii4(), Companion_Default___.Utf8__2__3(), Companion_Default___.Utf8__3__3(), Companion_Default___.Utf8__4__3())
}
func (_static *CompanionStruct_Default___) MultipleEntriesUTF8EncryptionContext() _dafny.Set {
	return _dafny.SetOf(Companion_Default___.EncryptionContextAsciiMapMultipleKeyValues(), Companion_Default___.EncryptionContextUTF82MapMultipleKeyValues(), Companion_Default___.EncryptionContextUTF83MapMultipleKeyValues(), Companion_Default___.EncryptionContextUTF84MapMultipleKeyValues())
}
func (_static *CompanionStruct_Default___) Ascii5() _dafny.Sequence {
	return _dafny.SeqOf(uint8(195), uint8(191))
}
func (_static *CompanionStruct_Default___) Utf8__2__4() _dafny.Sequence {
	return _dafny.SeqOf(uint8(223), uint8(159))
}
func (_static *CompanionStruct_Default___) Utf8__2__5() _dafny.Sequence {
	return _dafny.SeqOf(uint8(223), uint8(159))
}
func (_static *CompanionStruct_Default___) Utf8__3__4() _dafny.Sequence {
	return _dafny.SeqOf(uint8(239), uint8(163), uint8(191))
}
func (_static *CompanionStruct_Default___) Utf8__3__5() _dafny.Sequence {
	return _dafny.SeqOf(uint8(239), uint8(191), uint8(191))
}
func (_static *CompanionStruct_Default___) Utf8__4__4() _dafny.Sequence {
	return _dafny.SeqOf(uint8(240), uint8(157), uint8(132), uint8(162))
}
func (_static *CompanionStruct_Default___) Utf8__4__5() _dafny.Sequence {
	return _dafny.SeqOf(uint8(240), uint8(159), uint8(167), uint8(191))
}
