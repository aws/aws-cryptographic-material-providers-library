														...
														}
														{
															if _source2.Is_Array() {
																...
																if (_50_valueOrError24).IsFailure() {
																	...
																	var _52_strings _dafny.Sequence = m_Seq.Companion_Default___.Map(func(coer7 func(m_JSON_Values.JSON) _dafny.Sequence) func(interface{}) interface{} {
																		return func(arg7 interface{}) interface{} {
																			return coer7(arg7.(m_JSON_Values.JSON))
																		}
				...
				if (_6_valueOrError3).IsFailure() {
					...
					if (_8_valueOrError4).IsFailure() {
						...
						if (_10_valueOrError5).IsFailure() {
							...
							var _12_valueOrError6 m_Wrappers.Result = m_Seq.Companion_Default___.MapWithResult(func(coer8 func(_dafny.Sequence) m_Wrappers.Result) func(interface{}) m_Wrappers.Result {
...
func (_static *CompanionStruct_Default___) GetAlgorithmSuiteInfo(mpl m_AwsCryptographyMaterialProvidersTypes.IAwsCryptographicMaterialProvidersClient, obj _dafny.Sequence) m_Wrappers.Result {
	...
	if (_0_valueOrError0).IsFailure() {
		...
		if (_2_valueOrError1).IsFailure() {
			...
			_ = _3_binaryId
			return ((mpl).GetAlgorithmSuiteInfo(_3_binaryId)).MapFailure(func(coer9 func(m_AwsCryptographyMaterialProvidersTypes.Error) _dafny.Sequence) func(interface{}) interface{} {
				return func(arg9 interface{}) interface{} {
					return coer9(arg9.(m_AwsCryptographyMaterialProvidersTypes.Error))
				}
