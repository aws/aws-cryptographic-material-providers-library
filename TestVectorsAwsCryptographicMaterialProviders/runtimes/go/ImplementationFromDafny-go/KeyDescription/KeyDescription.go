...
func (_static *CompanionStruct_Default___) ToMultiKeyring(json m_JSON_Values.JSON, generatorJson m_Wrappers.Option, childKeyringsJson _dafny.Sequence) m_Wrappers.Result {
	...
	if (_0_valueOrError0).IsFailure() {
		...
		if (_1_valueOrError1).IsFailure() {
			...
			_ = _4_generator
			var _5_valueOrError3 m_Wrappers.Result = m_Seq.Companion_Default___.MapWithResult(func(coer4 func(m_JSON_Values.JSON) m_Wrappers.Result) func(interface{}) m_Wrappers.Result {
				return func(arg4 interface{}) m_Wrappers.Result {
					return coer4(arg4.(m_JSON_Values.JSON))
				}
...
func (_static *CompanionStruct_Default___) ToJson(keyDescription m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription, outputVersion _dafny.Int) m_Wrappers.Result {
				...
				}
				{
					...
					if (_24_valueOrError5).IsFailure() {
						...
						if (_26_valueOrError6).IsFailure() {
							...
							var _28_valueOrError7 m_Wrappers.Result = Companion_Default___.ToJson(((_15_MultiKeyring).Dtor_generator()).Dtor_value().(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription), outputVersion)
							_ = _28_valueOrError7
							if (_28_valueOrError7).IsFailure() {
								return (_28_valueOrError7).PropagateFailure()
							} else {
								var _29_g m_JSON_Values.JSON = (_28_valueOrError7).Extract().(m_JSON_Values.JSON)
								_ = _29_g
								var _30_valueOrError8 m_Wrappers.Result = Companion_Default___.KeyDescriptionListToJson((_15_MultiKeyring).Dtor_childKeyrings(), outputVersion)
								_ = _30_valueOrError8
								if (_30_valueOrError8).IsFailure() {
									return (_30_valueOrError8).PropagateFailure()
								} else {
									var _31_keyrings _dafny.Sequence = (_30_valueOrError8).Extract().(_dafny.Sequence)
									_ = _31_keyrings
									return m_Wrappers.Companion_Result_.Create_Success_(m_JSON_Values.Companion_JSON_.Create_Array_(_dafny.Companion_Sequence_.Concatenate(_dafny.SeqOf(_29_g), _31_keyrings)))
								}
							}
						}
					}
	...
	{
		var _32_RequiredEncryptionContext m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.RequiredEncryptionContextCMM = _source0.Get_().(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription_RequiredEncryptionContext).RequiredEncryptionContext
		_ = _32_RequiredEncryptionContext
		var _33_valueOrError9 m_Wrappers.Result = Companion_Default___.ToJson((_32_RequiredEncryptionContext).Dtor_underlying(), outputVersion)
		_ = _33_valueOrError9
		if (_33_valueOrError9).IsFailure() {
			return (_33_valueOrError9).PropagateFailure()
		} else {
			var _34_underlying m_JSON_Values.JSON = (_33_valueOrError9).Extract().(m_JSON_Values.JSON)
			_ = _34_underlying
			var _35_valueOrError10 m_Wrappers.Result = m_Seq.Companion_Default___.MapWithResult(func(coer6 func(_dafny.Sequence) m_Wrappers.Result) func(interface{}) m_Wrappers.Result {
				return func(arg6 interface{}) m_Wrappers.Result {
					return coer6(arg6.(_dafny.Sequence))
				}
			}(func(_36_key _dafny.Sequence) m_Wrappers.Result {
				return func(_pat_let4_0 m_Wrappers.Result) m_Wrappers.Result {
					return func(_37_valueOrError11 m_Wrappers.Result) m_Wrappers.Result {
						return (func() m_Wrappers.Result {
							if (_37_valueOrError11).IsFailure() {
								return (_37_valueOrError11).PropagateFailure()
							}
							return func(_pat_let5_0 _dafny.Sequence) m_Wrappers.Result {
								return func(_38_s _dafny.Sequence) m_Wrappers.Result {
									return m_Wrappers.Companion_Result_.Create_Success_(m_JSON_Values.Companion_JSON_.Create_String_(_38_s))
								}(_pat_let5_0)
							}((_37_valueOrError11).Extract().(_dafny.Sequence))
						})()
					}(_pat_let4_0)
				}(m_UTF8.Decode(_36_key))
			}), (_32_RequiredEncryptionContext).Dtor_requiredEncryptionContextKeys())
			_ = _35_valueOrError10
			if (_35_valueOrError10).IsFailure() {
				return (_35_valueOrError10).PropagateFailure()
			} else {
				var _39_requiredEncryptionContextKeys _dafny.Sequence = (_35_valueOrError10).Extract().(_dafny.Sequence)
				_ = _39_requiredEncryptionContextKeys
				return m_Wrappers.Companion_Result_.Create_Success_(m_JSON_Values.Companion_JSON_.Create_Object_(_dafny.SeqOf(_dafny.TupleOf(_dafny.SeqOfString("type"), m_JSON_Values.Companion_JSON_.Create_String_(_dafny.SeqOfString("required-encryption-context-cmm"))), _dafny.TupleOf(_dafny.SeqOfString("underlying"), _34_underlying), _dafny.TupleOf(_dafny.SeqOfString("requiredEncryptionContextKeys"), m_JSON_Values.Companion_JSON_.Create_Array_(_39_requiredEncryptionContextKeys)))))
			}
		}
	}
}
