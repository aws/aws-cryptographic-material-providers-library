// Package WrappedMaterialProvidersMain
// Dafny module WrappedMaterialProvidersMain compiled into Go
...
func (*Default__) String() string {
	return "WrappedMaterialProvidersMain.Default__"
}
...
func (_static *CompanionStruct_Default___) Main(args _dafny.Sequence) {
	...
	if !((_dafny.IntOfUint32((args).Cardinality())).Sign() == 1) {
		panic("dafny/TestVectorsAwsCryptographicMaterialProviders/src/Index.dfy(38,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
	...
	if (_1_parsedOptions_q).Is_Success() {
		...
		if (_3_op_q).Is_Success() {
			var _4_op m_MplManifestOptions.ManifestOptions
			_ = _4_op
			_4_op = (_3_op_q).Dtor_value().(m_MplManifestOptions.ManifestOptions)
			var _source0 m_MplManifestOptions.ManifestOptions = _4_op
			_ = _source0
			{
				{
					if _source0.Is_Decrypt() {
						...
						_ = _out0
						_out0 = m_TestManifests.Companion_Default___.StartDecrypt(_4_op)
						_5_result = _out0
						if (_5_result).Is_Failure() {
							_dafny.Print(((_5_result).Dtor_error().(_dafny.Sequence)).SetString())
						}
						if !((_5_result).Is_Success()) {
							panic("dafny/TestVectorsAwsCryptographicMaterialProviders/src/Index.dfy(57,10): " + (_dafny.SeqOfString("expectation violation")).String())
						}
						goto Lmatch0
					}
				}
				{
					if _source0.Is_Encrypt() {
						...
						_ = _out1
						_out1 = m_TestManifests.Companion_Default___.StartEncrypt(_4_op)
						...
						if !((_6_result).Is_Success()) {
							panic("dafny/TestVectorsAwsCryptographicMaterialProviders/src/Index.dfy(63,10): " + (_dafny.SeqOfString("expectation violation")).String())
						}
						goto Lmatch0
					}
				}
				{
					...
					_ = _out2
					_out2 = m_CompleteVectors.Companion_Default___.WriteStuff(_4_op)
					_7_result = _out2
					if (_7_result).Is_Failure() {
						_dafny.Print(((_7_result).Dtor_error().(_dafny.Sequence)).SetString())
					}
					if !((_7_result).Is_Success()) {
						panic("dafny/TestVectorsAwsCryptographicMaterialProviders/src/Index.dfy(69,10): " + (_dafny.SeqOfString("expectation violation")).String())
					}
				}
				goto Lmatch0
			}
...
func (_static *CompanionStruct_Default___) ParseDecryptCmd(params _dafny.Sequence) m_Wrappers.Result {
	...
	_ = _1_testName_q
	var _2_manifestPath _dafny.Sequence = (func() _dafny.Sequence {
	...
	_ = _2_manifestPath
	var _3_valueOrError0 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need((_dafny.IntOfUint32((_2_manifestPath).Cardinality())).Sign() == 1, _dafny.SeqOfString("Invalid manifest path length\n"))
	_ = _3_valueOrError0
	if (_3_valueOrError0).IsFailure() {
		return (_3_valueOrError0).PropagateFailure()
	} else {
		return m_Wrappers.Companion_Result_.Create_Success_(m_MplManifestOptions.Companion_ManifestOptions_.Create_Decrypt_((func() _dafny.Sequence {
			if (m_Seq.Companion_Default___.Last(_2_manifestPath).(_dafny.Char)) == (_dafny.Char('/')) {
				return _2_manifestPath
			}
			return _dafny.Companion_Sequence_.Concatenate(_2_manifestPath, _dafny.SeqOfString("/"))
...
func (_static *CompanionStruct_Default___) ParseEncryptCmd(params _dafny.Sequence) m_Wrappers.Result {
	var _0_manifestPath_q m_Wrappers.Option = m_GetOpt.Companion_Default___.OptValue(params, _dafny.SeqOfString("manifest-path"))
	_ = _0_manifestPath_q
	var _1_decryptManifestPath_q m_Wrappers.Option = m_GetOpt.Companion_Default___.OptValue(params, _dafny.SeqOfString("decrypt-manifest-path"))
	_ = _1_decryptManifestPath_q
	var _2_testName_q m_Wrappers.Option = m_GetOpt.Companion_Default___.OptValue(params, _dafny.SeqOfString("test-name"))
	_ = _2_testName_q
	...
	_ = _3_manifestPath
	var _4_decryptManifestPath _dafny.Sequence = (func() _dafny.Sequence {
		if (_1_decryptManifestPath_q).Is_Some() {
			return (_1_decryptManifestPath_q).Dtor_value().(_dafny.Sequence)
		}
		return _dafny.SeqOfString(".")
	})()
	_ = _4_decryptManifestPath
	var _5_valueOrError0 m_Wrappers.Outcome = m_Wrappers.Companion_Default___.Need(((_dafny.IntOfUint32((_3_manifestPath).Cardinality())).Sign() == 1) && ((_dafny.IntOfUint32((_4_decryptManifestPath).Cardinality())).Sign() == 1), _dafny.SeqOfString("Invalid manifest or decrypt manifest path length\n"))
	_ = _5_valueOrError0
	if (_5_valueOrError0).IsFailure() {
		return (_5_valueOrError0).PropagateFailure()
	} else {
		return m_Wrappers.Companion_Result_.Create_Success_(m_MplManifestOptions.Companion_ManifestOptions_.Create_Encrypt_((func() _dafny.Sequence {
			...
			if (m_Seq.Companion_Default___.Last(_4_decryptManifestPath).(_dafny.Char)) == (_dafny.Char('/')) {
				return _4_decryptManifestPath
			}
			return _dafny.Companion_Sequence_.Concatenate(_4_decryptManifestPath, _dafny.SeqOfString("/"))
		})(), (func() m_Wrappers.Option {
			if (_2_testName_q).Is_Some() {
				return _2_testName_q
			}
			return m_Wrappers.Companion_Option_.Create_None_()
		})()))
	}
...
func (_static *CompanionStruct_Default___) ParseEncryptManifestCmd(params _dafny.Sequence) m_Wrappers.Result {
	...
	if (_2_valueOrError0).IsFailure() {
		...
		return m_Wrappers.Companion_Result_.Create_Success_(m_MplManifestOptions.Companion_ManifestOptions_.Create_EncryptManifest_((func() _dafny.Sequence {
...
func (_static *CompanionStruct_Default___) DecryptSingleOptions_q(op _dafny.Map) bool {
	return ((((_dafny.IntOfInt64(3)).Cmp((op).Cardinality()) == 0) && ((op).Contains(_dafny.SeqOfString("-keys-path")))) && ((op).Contains(_dafny.SeqOfString("-key-description")))) && ((op).Contains(_dafny.SeqOfString("-base64-bytes")))
}
