// Package AllKmsEcdh
// Dafny module AllKmsEcdh compiled into Go
...
func (_static *CompanionStruct_Default___) KmsKeys() _dafny.Sequence {
	return _dafny.SeqOf(_dafny.SeqOfString("us-west-2-256-ecc"), _dafny.SeqOfString("us-west-2-384-ecc"), _dafny.SeqOfString("us-west-2-521-ecc"))
}
func (_static *CompanionStruct_Default___) StaticKmsDescriptionsEncryptSender() _dafny.Set {
	return func() _dafny.Set {
		var _coll0 = _dafny.NewBuilder()
		_ = _coll0
		for _iter52 := _dafny.Iterate((Companion_Default___.KmsKeys()).Elements()); ; {
			...
			if _dafny.Companion_Sequence_.Contains(Companion_Default___.KmsKeys(), _0_key) {
				_coll0.Add(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Companion_KeyDescription_.Create_KmsECDH_(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Companion_KmsEcdhKeyring_.Create_KmsEcdhKeyring_(_0_key, _0_key, _dafny.SeqOfString("sender-material-public-key"), _dafny.SeqOfString("recipient-material-public-key"), _0_key, _dafny.SeqOfString("static"))))
			}
		}
		return _coll0.ToSet()
	}()
...
func (_static *CompanionStruct_Default___) DiscoveryKeyDescriptionsDecrypt() _dafny.Set {
	return func() _dafny.Set {
		var _coll0 = _dafny.NewBuilder()
		_ = _coll0
		for _iter53 := _dafny.Iterate((Companion_Default___.KmsKeys()).Elements()); ; {
			...
			_0_key = interface{}(_compr_0).(_dafny.Sequence)
			if _dafny.Companion_Sequence_.Contains(Companion_Default___.KmsKeys(), _0_key) {
				_coll0.Add(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Companion_KeyDescription_.Create_KmsECDH_(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Companion_KmsEcdhKeyring_.Create_KmsEcdhKeyring_(_dafny.SeqOfString("discovery"), _0_key, _dafny.SeqOfString("discovery"), _dafny.SeqOfString("recipient-material-public-key"), _0_key, _dafny.SeqOfString("discovery"))))
			}
		}
		return _coll0.ToSet()
	}()
}
func (_static *CompanionStruct_Default___) StaticKmsDescriptionsEncryptRecipient() _dafny.Set {
	return Companion_Default___.StaticKmsDescriptionsEncryptSender()
}
func (_static *CompanionStruct_Default___) StaticKmsSenderRecipientTests() _dafny.Set {
	return func() _dafny.Set {
		var _coll0 = _dafny.NewBuilder()
		_ = _coll0
		for _iter54 := _dafny.Iterate((Companion_Default___.StaticKmsDescriptionsEncryptSender()).Elements()); ; {
			...
			if (Companion_Default___.StaticKmsDescriptionsEncryptSender()).Contains(_0_encryptKeyDescription) {
				for _iter55 := _dafny.Iterate((Companion_Default___.StaticKmsDescriptionsEncryptRecipient()).Elements()); ; {
					_compr_1, _ok55 := _iter55()
					if !_ok55 {
						break
					}
					...
					if ((Companion_Default___.StaticKmsDescriptionsEncryptRecipient()).Contains(_1_decryptKeyDescription)) && (_dafny.Companion_Sequence_.Equal(((_1_decryptKeyDescription).Dtor_KmsECDH()).Dtor_curveSpec(), ((_0_encryptKeyDescription).Dtor_KmsECDH()).Dtor_curveSpec())) {
						for _iter56 := _dafny.Iterate((m_AllAlgorithmSuites.Companion_Default___.AllAlgorithmSuites()).Elements()); ; {
							_compr_2, _ok56 := _iter56()
							if !_ok56 {
								break
							}
							...
							if (m_AllAlgorithmSuites.Companion_Default___.AllAlgorithmSuites()).Contains(_2_algorithmSuite) {
								for _iter57 := _dafny.Iterate(_dafny.SingleValue(m_AllAlgorithmSuites.Companion_Default___.GetCompatibleCommitmentPolicy(_2_algorithmSuite))); ; {
									_compr_3, _ok57 := _iter57()
									if !_ok57 {
										break
									}
...
func (_static *CompanionStruct_Default___) DiscoveryKmsTests() _dafny.Set {
	return func() _dafny.Set {
		var _coll0 = _dafny.NewBuilder()
		_ = _coll0
		for _iter58 := _dafny.Iterate((Companion_Default___.StaticKmsDescriptionsEncryptSender()).Elements()); ; {
			_compr_0, _ok58 := _iter58()
			if !_ok58 {
				break
			}
			var _0_encryptKeyDescription m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription
			_0_encryptKeyDescription = interface{}(_compr_0).(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription)
			if (Companion_Default___.StaticKmsDescriptionsEncryptSender()).Contains(_0_encryptKeyDescription) {
				for _iter59 := _dafny.Iterate((Companion_Default___.DiscoveryKeyDescriptionsDecrypt()).Elements()); ; {
					_compr_1, _ok59 := _iter59()
					if !_ok59 {
						break
					}
					var _1_decryptKeyDescription m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription
					_1_decryptKeyDescription = interface{}(_compr_1).(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription)
					if ((Companion_Default___.DiscoveryKeyDescriptionsDecrypt()).Contains(_1_decryptKeyDescription)) && (_dafny.Companion_Sequence_.Equal(((_1_decryptKeyDescription).Dtor_KmsECDH()).Dtor_curveSpec(), ((_0_encryptKeyDescription).Dtor_KmsECDH()).Dtor_curveSpec())) {
						for _iter60 := _dafny.Iterate((m_AllAlgorithmSuites.Companion_Default___.AllAlgorithmSuites()).Elements()); ; {
							_compr_2, _ok60 := _iter60()
							if !_ok60 {
								break
							}
							var _2_algorithmSuite m_AwsCryptographyMaterialProvidersTypes.AlgorithmSuiteInfo
							_2_algorithmSuite = interface{}(_compr_2).(m_AwsCryptographyMaterialProvidersTypes.AlgorithmSuiteInfo)
							if (m_AllAlgorithmSuites.Companion_Default___.AllAlgorithmSuites()).Contains(_2_algorithmSuite) {
								for _iter61 := _dafny.Iterate(_dafny.SingleValue(m_AllAlgorithmSuites.Companion_Default___.GetCompatibleCommitmentPolicy(_2_algorithmSuite))); ; {
									_compr_3, _ok61 := _iter61()
									if !_ok61 {
										break
									}
									var _3_commitmentPolicy m_AwsCryptographyMaterialProvidersTypes.CommitmentPolicy
									_3_commitmentPolicy = interface{}(_compr_3).(m_AwsCryptographyMaterialProvidersTypes.CommitmentPolicy)
									if (_3_commitmentPolicy).Equals(m_AllAlgorithmSuites.Companion_Default___.GetCompatibleCommitmentPolicy(_2_algorithmSuite)) {
										_coll0.Add(m_TestVectors.Companion_EncryptTestVector_.Create_PositiveEncryptKeyringVector_(_dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.SeqOfString("AWS KMS ECDH Discovery "), ((_0_encryptKeyDescription).Dtor_KmsECDH()).Dtor_senderKeyId()), _dafny.SeqOfString(" ")), ((_1_decryptKeyDescription).Dtor_KmsECDH()).Dtor_senderKeyId()), m_Wrappers.Companion_Option_.Create_None_(), _dafny.NewMapBuilder().ToMap(), _3_commitmentPolicy, _2_algorithmSuite, m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), _0_encryptKeyDescription, _1_decryptKeyDescription, m_Wrappers.Companion_Option_.Create_None_()))
									}
								}
							}
						}
...
func (_static *CompanionStruct_Default___) Tests() _dafny.Set {
	return (Companion_Default___.StaticKmsSenderRecipientTests()).Union(Companion_Default___.DiscoveryKmsTests())
}
