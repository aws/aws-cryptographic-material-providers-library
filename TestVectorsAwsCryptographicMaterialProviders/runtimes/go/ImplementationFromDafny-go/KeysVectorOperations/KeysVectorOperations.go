...
func (_static *CompanionStruct_Default___) CreateTestVectorKeyring(config Config, input m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.TestVectorKeyringInput) m_Wrappers.Result {
	...
	_ = _2_valueOrError1
	_2_valueOrError1 = (_1_maybeMpl).MapFailure(func(coer42 func(m_AwsCryptographyMaterialProvidersTypes.Error) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Error) func(interface{}) interface{} {
...
func (_static *CompanionStruct_Default___) CreateWrappedTestVectorKeyring(config Config, input m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.TestVectorKeyringInput) m_Wrappers.Result {
	...
	var _2_valueOrError1 m_Wrappers.Result = m_Wrappers.Result{}
	_ = _2_valueOrError1
	_2_valueOrError1 = (_1_maybeMpl).MapFailure(func(coer43 func(m_AwsCryptographyMaterialProvidersTypes.Error) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Error) func(interface{}) interface{} {
		return func(arg43 interface{}) interface{} {
			return coer43(arg43.(m_AwsCryptographyMaterialProvidersTypes.Error))
		}
	}(func(_3_e m_AwsCryptographyMaterialProvidersTypes.Error) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Error {
		return m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Companion_Error_.Create_AwsCryptographyMaterialProviders_(_3_e)
	}))
...
func (_static *CompanionStruct_Default___) CreateWrappedTestVectorCmm(config Config, input m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.TestVectorCmmInput) m_Wrappers.Result {
	...
	_ = _1_valueOrError0
	_1_valueOrError0 = (_0_maybeMpl).MapFailure(func(coer44 func(m_AwsCryptographyMaterialProvidersTypes.Error) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Error) func(interface{}) interface{} {
		return func(arg44 interface{}) interface{} {
			return coer44(arg44.(m_AwsCryptographyMaterialProvidersTypes.Error))
		}
...
func (_static *CompanionStruct_Default___) GetKeyDescription(config Config, input m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.GetKeyDescriptionInput) m_Wrappers.Result {
	var _0_valueOrError0 m_Wrappers.Result = (m_JSON_API.Companion_Default___.Deserialize((input).Dtor_json())).MapFailure(func(coer45 func(m_JSON_Errors.DeserializationError) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Error) func(interface{}) interface{} {
		return func(arg45 interface{}) interface{} {
			return coer45(arg45.(m_JSON_Errors.DeserializationError))
		}
	...
	if (_0_valueOrError0).IsFailure() {
		...
		var _3_valueOrError1 m_Wrappers.Result = (m_KeyDescription.Companion_Default___.ToKeyDescription(_2_keyDescriptionJSON)).MapFailure(func(coer46 func(_dafny.Sequence) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Error) func(interface{}) interface{} {
			return func(arg46 interface{}) interface{} {
				return coer46(arg46.(_dafny.Sequence))
			}
...
func (_static *CompanionStruct_Default___) SerializeKeyDescription(config Config, input m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.SerializeKeyDescriptionInput) m_Wrappers.Result {
	var _0_valueOrError0 m_Wrappers.Result = (m_KeyDescription.Companion_Default___.ToJson((input).Dtor_keyDescription(), _dafny.IntOfInt64(2))).MapFailure(func(coer47 func(_dafny.Sequence) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Error) func(interface{}) interface{} {
		return func(arg47 interface{}) interface{} {
			return coer47(arg47.(_dafny.Sequence))
		}
	...
	if (_0_valueOrError0).IsFailure() {
		...
		_ = _2_json
		var _3_valueOrError1 m_Wrappers.Result = (m_JSON_API.Companion_Default___.Serialize(_2_json)).MapFailure(func(coer48 func(m_JSON_Errors.SerializationError) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Error) func(interface{}) interface{} {
			return func(arg48 interface{}) interface{} {
				return coer48(arg48.(m_JSON_Errors.SerializationError))
			}
