...
func (_static *CompanionStruct_Default___) EncryptionContextKeysToJson(keys m_Wrappers.Option) m_Wrappers.Result {
	if (keys).Is_Some() {
		var _0_valueOrError0 m_Wrappers.Result = m_Seq.Companion_Default___.MapWithResult(func(coer122 func(_dafny.Sequence) m_Wrappers.Result) func(interface{}) m_Wrappers.Result {
			return func(arg192 interface{}) m_Wrappers.Result {
				return coer122(arg192.(_dafny.Sequence))
			}
...
func (_static *CompanionStruct_Default___) EncryptionContextToJson(key _dafny.Sequence, m _dafny.Map) m_Wrappers.Result {
	var _0_keys _dafny.Sequence = m_SortedSets.SetToOrderedSequence2((m).Keys(), func(coer123 func(uint8, uint8) bool) func(interface{}, interface{}) bool {
		return func(arg193 interface{}, arg194 interface{}) bool {
			return coer123(arg193.(uint8), arg194.(uint8))
		}
	}(func(_1_a uint8, _2_b uint8) bool {
		return (_1_a) < (_2_b)
	}))
	_ = _0_keys
	var _3_valueOrError0 m_Wrappers.Result = m_Seq.Companion_Default___.MapWithResult(func(coer124 func(_dafny.Sequence) m_Wrappers.Result) func(interface{}) m_Wrappers.Result {
		return func(arg195 interface{}) m_Wrappers.Result {
			return coer124(arg195.(_dafny.Sequence))
		}
	...
	if (_2_valueOrError0).IsFailure() {
		...
		if (_4_valueOrError1).IsFailure() {
			...
			if (_6_valueOrError2).IsFailure() {
				...
				_ = _7_keyDescription
				var _8_valueOrError3 m_Wrappers.Result = m_Seq.Companion_Default___.MapWithResult(func(coer125 func(m_AwsCryptographyMaterialProvidersTypes.EncryptedDataKey) m_Wrappers.Result) func(interface{}) m_Wrappers.Result {
					return func(arg196 interface{}) m_Wrappers.Result {
						return coer125(arg196.(m_AwsCryptographyMaterialProvidersTypes.EncryptedDataKey))
					}
