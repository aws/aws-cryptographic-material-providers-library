...
Lmatch0:
	...
	_ = _4_valueOrError1
	_4_valueOrError1 = (_3_cmm_k).MapFailure(func(coer50 func(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Error) _dafny.Sequence) func(interface{}) interface{} {
		return func(arg50 interface{}) interface{} {
			return coer50(arg50.(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Error))
		}
...
func (_static *CompanionStruct_Default___) DecryptVectorToDecryptTest(keys *m_KeyVectors.KeyVectorsClient, vector DecryptTestVector) m_Wrappers.Result {
	...
	var _4_valueOrError1 m_Wrappers.Result = m_Wrappers.Result{}
	_ = _4_valueOrError1
	_4_valueOrError1 = (_3_cmm_k).MapFailure(func(coer51 func(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Error) _dafny.Sequence) func(interface{}) interface{} {
		return func(arg51 interface{}) interface{} {
			return coer51(arg51.(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Error))
		}
