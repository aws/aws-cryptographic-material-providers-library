...
func (_static *CompanionStruct_Default___) AesPersistentKeyNames() _dafny.Sequence {
	return _dafny.SeqOf(_dafny.SeqOfString("aes-128"), _dafny.SeqOfString("aes-192"), _dafny.SeqOfString("aes-256"))
}
func (_static *CompanionStruct_Default___) KeyDescriptions() _dafny.Set {
	return func() _dafny.Set {
		var _coll0 = _dafny.NewBuilder()
		_ = _coll0
		for _iter42 := _dafny.Iterate((Companion_Default___.AesPersistentKeyNames()).Elements()); ; {
			_compr_0, _ok42 := _iter42()
			if !_ok42 {
				break
			}
...
func (_static *CompanionStruct_Default___) Tests() _dafny.Set {
	return func() _dafny.Set {
		var _coll0 = _dafny.NewBuilder()
		_ = _coll0
		for _iter43 := _dafny.Iterate((Companion_Default___.KeyDescriptions()).Elements()); ; {
			_compr_0, _ok43 := _iter43()
			if !_ok43 {
				break
			}
			...
			if (Companion_Default___.KeyDescriptions()).Contains(_0_keyDescription) {
				for _iter44 := _dafny.Iterate((m_AllAlgorithmSuites.Companion_Default___.AllAlgorithmSuites()).Elements()); ; {
					_compr_1, _ok44 := _iter44()
					if !_ok44 {
						break
					}
					...
					if (m_AllAlgorithmSuites.Companion_Default___.AllAlgorithmSuites()).Contains(_1_algorithmSuite) {
						for _iter45 := _dafny.Iterate(_dafny.SingleValue(m_AllAlgorithmSuites.Companion_Default___.GetCompatibleCommitmentPolicy(_1_algorithmSuite))); ; {
							_compr_2, _ok45 := _iter45()
							if !_ok45 {
								break
							}
