...
func (_static *CompanionStruct_Default___) KeyDescriptions() _dafny.Set {
	return func() _dafny.Set {
		...
		_ = _coll0
		for _iter24 := _dafny.Iterate((Companion_Default___.AllKmsRsaKeys()).Elements()); ; {
			...
			if _dafny.Companion_Sequence_.Contains(Companion_Default___.AllKmsRsaKeys(), _0_key) {
				for _iter25 := _dafny.Iterate((func() _dafny.Set {
					...
					_ = _coll1
					for _iter26 := _dafny.Iterate(m_ComAmazonawsKmsTypes.Companion_EncryptionAlgorithmSpec_.AllSingletonConstructors()); ; {
						_compr_2, _ok26 := _iter26()
						if !_ok26 {
							break
						}
					...
					if (func() _dafny.Set {
						...
						_ = _coll2
						for _iter27 := _dafny.Iterate(m_ComAmazonawsKmsTypes.Companion_EncryptionAlgorithmSpec_.AllSingletonConstructors()); ; {
							_compr_3, _ok27 := _iter27()
							if !_ok27 {
								break
							}
...
func (_static *CompanionStruct_Default___) AlgorithmSuites() _dafny.Set {
	return func() _dafny.Set {
		var _coll0 = _dafny.NewBuilder()
		_ = _coll0
		for _iter28 := _dafny.Iterate((m_AllAlgorithmSuites.Companion_Default___.AllAlgorithmSuites()).Elements()); ; {
...
func (_static *CompanionStruct_Default___) Tests() _dafny.Set {
	return func() _dafny.Set {
		var _coll0 = _dafny.NewBuilder()
		_ = _coll0
		for _iter29 := _dafny.Iterate((Companion_Default___.KeyDescriptions()).Elements()); ; {
			...
			if (Companion_Default___.KeyDescriptions()).Contains(_0_keyDescription) {
				for _iter30 := _dafny.Iterate((Companion_Default___.AlgorithmSuites()).Elements()); ; {
					_compr_1, _ok30 := _iter30()
					if !_ok30 {
						break
					}
					...
					if (Companion_Default___.AlgorithmSuites()).Contains(_1_algorithmSuite) {
						for _iter31 := _dafny.Iterate(_dafny.SingleValue(m_AllAlgorithmSuites.Companion_Default___.GetCompatibleCommitmentPolicy(_1_algorithmSuite))); ; {
							_compr_2, _ok31 := _iter31()
							if !_ok31 {
								break
							}
