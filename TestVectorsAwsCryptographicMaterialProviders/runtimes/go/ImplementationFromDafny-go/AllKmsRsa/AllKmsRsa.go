// Package AllKmsRsa
// Dafny module AllKmsRsa compiled into Go
...
func (_static *CompanionStruct_Default___) AllKmsRsaKeys() _dafny.Sequence {
	return _dafny.SeqOf(_dafny.SeqOfString("us-west-2-rsa-mrk"))
}
func (_static *CompanionStruct_Default___) KeyDescriptions() _dafny.Set {
	return func() _dafny.Set {
		var _coll0 = _dafny.NewBuilder()
		_ = _coll0
		for _iter44 := _dafny.Iterate((Companion_Default___.AllKmsRsaKeys()).Elements()); ; {
			_compr_0, _ok44 := _iter44()
			if !_ok44 {
				break
			}
			var _0_key _dafny.Sequence
			_0_key = interface{}(_compr_0).(_dafny.Sequence)
			if _dafny.Companion_Sequence_.Contains(Companion_Default___.AllKmsRsaKeys(), _0_key) {
				for _iter45 := _dafny.Iterate((func() _dafny.Set {
					var _coll1 = _dafny.NewBuilder()
					_ = _coll1
					for _iter46 := _dafny.Iterate(m_ComAmazonawsKmsTypes.Companion_EncryptionAlgorithmSpec_.AllSingletonConstructors()); ; {
						_compr_2, _ok46 := _iter46()
						if !_ok46 {
							break
						}
						var _1_e m_ComAmazonawsKmsTypes.EncryptionAlgorithmSpec
						_1_e = interface{}(_compr_2).(m_ComAmazonawsKmsTypes.EncryptionAlgorithmSpec)
					...
					_compr_1, _ok45 := _iter45()
					if !_ok45 {
						break
					}
					var _2_encryptionAlgorithm m_ComAmazonawsKmsTypes.EncryptionAlgorithmSpec
					_2_encryptionAlgorithm = interface{}(_compr_1).(m_ComAmazonawsKmsTypes.EncryptionAlgorithmSpec)
					if (func() _dafny.Set {
						var _coll2 = _dafny.NewBuilder()
						_ = _coll2
						for _iter47 := _dafny.Iterate(m_ComAmazonawsKmsTypes.Companion_EncryptionAlgorithmSpec_.AllSingletonConstructors()); ; {
							_compr_3, _ok47 := _iter47()
							if !_ok47 {
								break
							}
							var _3_e m_ComAmazonawsKmsTypes.EncryptionAlgorithmSpec
							_3_e = interface{}(_compr_3).(m_ComAmazonawsKmsTypes.EncryptionAlgorithmSpec)
							if !((_3_e).Is_SYMMETRIC__DEFAULT()) {
								_coll2.Add(_3_e)
							}
						}
						return _coll2.ToSet()
					}()).Contains(_2_encryptionAlgorithm) {
						_coll0.Add(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Companion_KeyDescription_.Create_KmsRsa_(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Companion_KmsRsaKeyring_.Create_KmsRsaKeyring_(_0_key, _2_encryptionAlgorithm)))
					}
				}
			}
		}
...
func (_static *CompanionStruct_Default___) AlgorithmSuites() _dafny.Set {
	return func() _dafny.Set {
		var _coll0 = _dafny.NewBuilder()
		_ = _coll0
		for _iter48 := _dafny.Iterate((m_AllAlgorithmSuites.Companion_Default___.AllAlgorithmSuites()).Elements()); ; {
			...
			if m_AlgorithmSuites.Companion_AlgorithmSuite_.Is_(_0_suite) {
				if ((m_AllAlgorithmSuites.Companion_Default___.AllAlgorithmSuites()).Contains(_0_suite)) && (!(((_0_suite).Dtor_signature()).Is_ECDSA())) {
					_coll0.Add(_0_suite)
				}
			}
		}
...
func (_static *CompanionStruct_Default___) Tests() _dafny.Set {
	return func() _dafny.Set {
		var _coll0 = _dafny.NewBuilder()
		_ = _coll0
		for _iter49 := _dafny.Iterate((Companion_Default___.KeyDescriptions()).Elements()); ; {
			_compr_0, _ok49 := _iter49()
			if !_ok49 {
				break
			}
			...
			if (Companion_Default___.KeyDescriptions()).Contains(_0_keyDescription) {
				for _iter50 := _dafny.Iterate((Companion_Default___.AlgorithmSuites()).Elements()); ; {
					_compr_1, _ok50 := _iter50()
					if !_ok50 {
						break
					}
					...
					if (Companion_Default___.AlgorithmSuites()).Contains(_1_algorithmSuite) {
						for _iter51 := _dafny.Iterate(_dafny.SingleValue(m_AllAlgorithmSuites.Companion_Default___.GetCompatibleCommitmentPolicy(_1_algorithmSuite))); ; {
							_compr_2, _ok51 := _iter51()
							if !_ok51 {
								break
							}
