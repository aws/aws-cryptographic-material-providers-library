...
func (_static *CompanionStruct_Default___) GetArrayString(key _dafny.Sequence, obj _dafny.Sequence) m_Wrappers.Result {
	...
	if (_0_valueOrError0).IsFailure() {
		...
		if (_2_valueOrError1).IsFailure() {
			...
			_ = _4_arr
			return m_Wrappers.Companion_Result_.Create_Success_(_dafny.SeqCreate((_dafny.IntOfUint32((_4_arr).Cardinality())).Uint32(), func(coer0 func(_dafny.Int) _dafny.Sequence) func(_dafny.Int) interface{} {
...
func (_static *CompanionStruct_Default___) GetArrayObject(key _dafny.Sequence, obj _dafny.Sequence) m_Wrappers.Result {
	...
	if (_0_valueOrError0).IsFailure() {
		...
		if (_2_valueOrError1).IsFailure() {
			...
			var _4_arr _dafny.Sequence = (_1_obj).Dtor_arr()
			_ = _4_arr
			return m_Wrappers.Companion_Result_.Create_Success_(_dafny.SeqCreate((_dafny.IntOfUint32((_4_arr).Cardinality())).Uint32(), func(coer1 func(_dafny.Int) _dafny.Sequence) func(_dafny.Int) interface{} {
...
func (_static *CompanionStruct_Default___) Utf8EncodeSeq(seqOfStrings _dafny.Sequence) m_Wrappers.Result {
	var _0_encodedResults _dafny.Sequence = _dafny.SeqCreate((_dafny.IntOfUint32((seqOfStrings).Cardinality())).Uint32(), func(coer2 func(_dafny.Int) m_Wrappers.Result) func(_dafny.Int) interface{} {
	...
	if (_3_valueOrError0).IsFailure() {
		...
		return m_Wrappers.Companion_Result_.Create_Success_(_dafny.SeqCreate((_dafny.IntOfUint32((_0_encodedResults).Cardinality())).Uint32(), func(coer3 func(_dafny.Int) _dafny.Sequence) func(_dafny.Int) interface{} {
