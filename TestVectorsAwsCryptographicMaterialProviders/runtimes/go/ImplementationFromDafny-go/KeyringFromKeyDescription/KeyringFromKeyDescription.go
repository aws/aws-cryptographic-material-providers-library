	...
	_ = _source0
	{
		...
		}
		{
			if _source0.Is_Kms() {
				...
				_ = _6_key
				{
					...
					_11_keyring = _out2
					output = (_11_keyring).MapFailure(func(coer10 func(m_AwsCryptographyMaterialProvidersTypes.Error) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Error) func(interface{}) interface{} {
						return func(arg10 interface{}) interface{} {
							return coer10(arg10.(m_AwsCryptographyMaterialProvidersTypes.Error))
						}
		...
		}
		{
			if _source0.Is_KmsMrk() {
				...
				_ = _13_key
				{
					...
					_18_keyring = _out4
					output = (_18_keyring).MapFailure(func(coer11 func(m_AwsCryptographyMaterialProvidersTypes.Error) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Error) func(interface{}) interface{} {
		...
		}
		{
			if _source0.Is_KmsRsa() {
				...
				_ = _21_encryptionAlgorithm
				{
					...
					_26_keyring = _out6
					output = (_26_keyring).MapFailure(func(coer12 func(m_AwsCryptographyMaterialProvidersTypes.Error) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Error) func(interface{}) interface{} {
		...
		}
		{
			if _source0.Is_Hierarchy() {
				...
				_ = _28_key
				{
					...
					_32_keyring = _out8
					output = (_32_keyring).MapFailure(func(coer13 func(m_AwsCryptographyMaterialProvidersTypes.Error) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Error) func(interface{}) interface{} {
		...
		}
		{
			if _source0.Is_KmsMrkDiscovery() {
				...
				_ = _35_awsKmsDiscoveryFilter
				{
					...
					_38_keyring = _out9
					output = (_38_keyring).MapFailure(func(coer14 func(m_AwsCryptographyMaterialProvidersTypes.Error) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Error) func(interface{}) interface{} {
		...
		}
		{
			if _source0.Is_AES() {
				...
				Lmatch1:
					...
					_46_keyring = _out10
					output = (_46_keyring).MapFailure(func(coer15 func(m_AwsCryptographyMaterialProvidersTypes.Error) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Error) func(interface{}) interface{} {
					...
					_ = _source2
					{
							...
							if _source2.Is_Some() {
								...
								if value0.Is_PrivateRSA() {
									...
									_ = _54_keyIdentifier
									{
										...
										_56_valueOrError13 = (m_UTF8.Encode(_53_material)).MapFailure(func(coer16 func(_dafny.Sequence) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Error) func(interface{}) interface{} {
											return func(arg16 interface{}) interface{} {
												return coer16(arg16.(_dafny.Sequence))
											}
										...
										_60_keyring = _out11
										output = (_60_keyring).MapFailure(func(coer17 func(m_AwsCryptographyMaterialProvidersTypes.Error) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Error) func(interface{}) interface{} {
						...
						}
						{
							...
							_ = _64_keyIdentifier
							{
								...
								_66_valueOrError15 = (m_UTF8.Encode(_63_material)).MapFailure(func(coer18 func(_dafny.Sequence) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Error) func(interface{}) interface{} {
								...
								_70_keyring = _out12
								output = (_70_keyring).MapFailure(func(coer19 func(m_AwsCryptographyMaterialProvidersTypes.Error) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Error) func(interface{}) interface{} {
		...
		}
		{
			if _source0.Is_ECDH() {
				...
				_ = _78_keyAgreementScheme
				{
					...
					_82_valueOrError17 = (_81_primitives_q).MapFailure(func(coer20 func(m_AwsCryptographyPrimitivesTypes.Error) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Error) func(interface{}) interface{} {
						return func(arg20 interface{}) interface{} {
							return coer20(arg20.(m_AwsCryptographyPrimitivesTypes.Error))
						}
							...
							if (_source3).Equals(_dafny.SeqOfString("static")) {
								{
									...
									_86_valueOrError19 = (m_UTF8.Encode(((_0_material).Dtor_value().(m_KeyMaterial.KeyMaterial)).Dtor_senderMaterial())).MapFailure(func(coer21 func(_dafny.Sequence) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Error) func(interface{}) interface{} {
									...
									_89_valueOrError20 = (m_UTF8.Encode(((_0_material).Dtor_value().(m_KeyMaterial.KeyMaterial)).Dtor_recipientMaterial())).MapFailure(func(coer22 func(_dafny.Sequence) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Error) func(interface{}) interface{} {
									...
									_92_valueOrError21 = (m_Base64.Companion_Default___.Decode(((_0_material).Dtor_value().(m_KeyMaterial.KeyMaterial)).Dtor_recipientPublicKey())).MapFailure(func(coer23 func(_dafny.Sequence) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Error) func(interface{}) interface{} {
									...
									_97_keyring = _out14
									output = (_97_keyring).MapFailure(func(coer24 func(m_AwsCryptographyMaterialProvidersTypes.Error) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Error) func(interface{}) interface{} {
										return func(arg24 interface{}) interface{} {
											return coer24(arg24.(m_AwsCryptographyMaterialProvidersTypes.Error))
										}
							...
							if (_source3).Equals(_dafny.SeqOfString("ephemeral")) {
								{
									...
									_101_valueOrError23 = (m_UTF8.Encode(((_99_recipientMaterial_q).Dtor_value().(m_KeyMaterial.KeyMaterial)).Dtor_recipientMaterial())).MapFailure(func(coer25 func(_dafny.Sequence) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Error) func(interface{}) interface{} {
									...
									_104_valueOrError24 = (m_Base64.Companion_Default___.Decode(((_99_recipientMaterial_q).Dtor_value().(m_KeyMaterial.KeyMaterial)).Dtor_recipientPublicKey())).MapFailure(func(coer26 func(_dafny.Sequence) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Error) func(interface{}) interface{} {
										return func(arg26 interface{}) interface{} {
											return coer26(arg26.(_dafny.Sequence))
										}
									...
									_109_keyring = _out15
									output = (_109_keyring).MapFailure(func(coer27 func(m_AwsCryptographyMaterialProvidersTypes.Error) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Error) func(interface{}) interface{} {
										return func(arg27 interface{}) interface{} {
											return coer27(arg27.(m_AwsCryptographyMaterialProvidersTypes.Error))
										}
							...
							if (_source3).Equals(_dafny.SeqOfString("discovery")) {
								{
									...
									_113_valueOrError26 = (m_UTF8.Encode(((_111_recipientMaterial_q).Dtor_value().(m_KeyMaterial.KeyMaterial)).Dtor_recipientMaterial())).MapFailure(func(coer28 func(_dafny.Sequence) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Error) func(interface{}) interface{} {
									...
									_118_keyring = _out16
									output = (_118_keyring).MapFailure(func(coer29 func(m_AwsCryptographyMaterialProvidersTypes.Error) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Error) func(interface{}) interface{} {
							...
							if (_source4).Equals(_dafny.SeqOfString("static")) {
								{
									...
									_134_valueOrError31 = (m_Base64.Companion_Default___.Decode(((_0_material).Dtor_value().(m_KeyMaterial.KeyMaterial)).Dtor_senderPublicKey())).MapFailure(func(coer30 func(_dafny.Sequence) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Error) func(interface{}) interface{} {
									...
									_137_valueOrError32 = (m_Base64.Companion_Default___.Decode(((_0_material).Dtor_value().(m_KeyMaterial.KeyMaterial)).Dtor_recipientPublicKey())).MapFailure(func(coer31 func(_dafny.Sequence) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Error) func(interface{}) interface{} {
									...
									_142_keyring = _out18
									output = (_142_keyring).MapFailure(func(coer32 func(m_AwsCryptographyMaterialProvidersTypes.Error) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Error) func(interface{}) interface{} {
										return func(arg32 interface{}) interface{} {
											return coer32(arg32.(m_AwsCryptographyMaterialProvidersTypes.Error))
										}
							...
							if (_source4).Equals(_dafny.SeqOfString("discovery")) {
								{
									...
									_151_keyring = _out20
									output = (_151_keyring).MapFailure(func(coer33 func(m_AwsCryptographyMaterialProvidersTypes.Error) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Error) func(interface{}) interface{} {
										return func(arg33 interface{}) interface{} {
											return coer33(arg33.(m_AwsCryptographyMaterialProvidersTypes.Error))
										}
		...
		}
		{
			...
			_ = _153_MultiKeyring
			{
				...
				_165_keyring = _out23
				output = (_165_keyring).MapFailure(func(coer34 func(m_AwsCryptographyMaterialProvidersTypes.Error) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Error) func(interface{}) interface{} {
...
func (_static *CompanionStruct_Default___) GetKmsClient(mpl m_AwsCryptographyMaterialProvidersTypes.IAwsCryptographicMaterialProvidersClient, maybeKmsArn _dafny.Sequence) m_Wrappers.Result {
	...
	_ = _1_valueOrError0
	_1_valueOrError0 = (_0_maybeClientSupplier).MapFailure(func(coer35 func(m_AwsCryptographyMaterialProvidersTypes.Error) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Error) func(interface{}) interface{} {
	...
	_6_tmp = _out1
	output = (_6_tmp).MapFailure(func(coer36 func(m_AwsCryptographyMaterialProvidersTypes.Error) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Error) func(interface{}) interface{} {
...
func (_static *CompanionStruct_Default___) GetEcdhPublicKey(client m_ComAmazonawsKmsTypes.IKMSClient, awsKmsKey _dafny.Sequence) m_Wrappers.Result {
	...
	_ = _2_valueOrError0
	_2_valueOrError0 = (_1_maybePublicKeyResponse).MapFailure(func(coer37 func(m_ComAmazonawsKmsTypes.Error) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Error) func(interface{}) interface{} {
		return func(arg37 interface{}) interface{} {
			return coer37(arg37.(m_ComAmazonawsKmsTypes.Error))
		}
