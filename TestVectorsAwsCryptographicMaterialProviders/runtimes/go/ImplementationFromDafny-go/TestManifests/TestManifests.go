...
func (_static *CompanionStruct_Default___) LogFileName() _dafny.Sequence {
	if (_dafny.Companion_Sequence_.Equal(m_OsLang.GetOsShort(), _dafny.SeqOfString("Windows"))) && (_dafny.Companion_Sequence_.Equal(m_OsLang.GetLanguageShort(), _dafny.SeqOfString("Dotnet"))) {
		return _dafny.SeqOfString("..\\..\\PerfLog.txt")
	} else {
		return _dafny.SeqOfString("../../PerfLog.txt")
	}
}
func (_static *CompanionStruct_Default___) StartEncrypt(op m_MplManifestOptions.ManifestOptions) m_Wrappers.Result {
	...
	_ = _out1
	_out1 = Companion_Default___.GetManifest((op).Dtor_manifestPath(), _dafny.SeqOfString("manifest.json"))
	_1_valueOrError0 = _out1
	if (_1_valueOrError0).IsFailure() {
		output = (_1_valueOrError0).PropagateFailure()
		return output
	}
	var _2_encryptManifest ManifestData
	_ = _2_encryptManifest
	_2_encryptManifest = (_1_valueOrError0).Extract().(ManifestData)
	var _3_valueOrError1 m_Wrappers.Outcome = m_Wrappers.Companion_Outcome_.Default()
	_ = _3_valueOrError1
	_3_valueOrError1 = m_Wrappers.Companion_Default___.Need((_2_encryptManifest).Is_EncryptManifest(), _dafny.SeqOfString("Not a encrypt manifest"))
	...
	_ = _4_valueOrError2
	_4_valueOrError2 = m_ParseJsonManifests.Companion_Default___.BuildEncryptTestVector((_2_encryptManifest).Dtor_keys(), (_2_encryptManifest).Dtor_jsonTests())
	if (_4_valueOrError2).IsFailure() {
		output = (_4_valueOrError2).PropagateFailure()
		return output
	}
	var _5_encryptVectors _dafny.Sequence
	_ = _5_encryptVectors
	_5_encryptVectors = (_4_valueOrError2).Extract().(_dafny.Sequence)
	var _6_valueOrError3 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(_dafny.EmptySeq)
	_ = _6_valueOrError3
	var _out2 m_Wrappers.Result
	_ = _out2
	_out2 = Companion_Default___.ToEncryptTests((_2_encryptManifest).Dtor_keys(), _5_encryptVectors)
	_6_valueOrError3 = _out2
	if (_6_valueOrError3).IsFailure() {
		output = (_6_valueOrError3).PropagateFailure()
		return output
	}
	var _7_encryptTests _dafny.Sequence
	_ = _7_encryptTests
	_7_encryptTests = (_6_valueOrError3).Extract().(_dafny.Sequence)
	var _8_decryptVectors _dafny.Sequence
	_ = _8_decryptVectors
	var _out3 _dafny.Sequence
	_ = _out3
	_out3 = Companion_Default___.TestEncrypts(_7_encryptTests, (_2_encryptManifest).Dtor_keys())
	_8_decryptVectors = _out3
	var _9_valueOrError4 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(_dafny.TupleOf())
	_ = _9_valueOrError4
	var _out4 m_Wrappers.Result
	_ = _out4
	_out4 = m_CompleteVectors.Companion_Default___.WriteDecryptManifest(op, (_2_encryptManifest).Dtor_keys(), _8_decryptVectors)
	...
	_ = _10___v0
	_10___v0 = (_9_valueOrError4).Extract().(_dafny.Tuple)
...
func (_static *CompanionStruct_Default___) TestEncrypts(tests _dafny.Sequence, keys *m_KeyVectors.KeyVectorsClient) _dafny.Sequence {
	...
	var _2_time m__Time.AbsoluteTime
	_ = _2_time
	var _out0 m__Time.AbsoluteTime
	_ = _out0
	_out0 = m__Time.Companion_Default___.GetAbsoluteTime()
	...
	for _3_i := _dafny.Zero; _3_i.Cmp(_hi0) < 0; _3_i = _3_i.Plus(_dafny.One) {
		var _4_test m_TestVectors.EncryptTest
		_ = _4_test
		_4_test = (tests).Select((_3_i).Uint32()).(m_TestVectors.EncryptTest)
		var _5_pass bool
		_ = _5_pass
		var _6_maybeEncryptionMaterials m_Wrappers.Option
		_ = _6_maybeEncryptionMaterials
		var _out1 bool
		_ = _out1
		var _out2 m_Wrappers.Option
		_ = _out2
		_out1, _out2 = m_TestVectors.Companion_Default___.TestGetEncryptionMaterials(_4_test)
		_5_pass = _out1
		_6_maybeEncryptionMaterials = _out2
		if (_5_pass) && (!(((_4_test).Dtor_vector()).Is_NegativeEncryptKeyringVector())) {
			_1_decryptableTests = _dafny.Companion_Sequence_.Concatenate(_1_decryptableTests, _dafny.SeqOf(_dafny.TupleOf(_4_test, (_6_maybeEncryptionMaterials).Dtor_value().(m_AwsCryptographyMaterialProvidersTypes.EncryptionMaterials))))
		} else if !(_5_pass) {
			_0_hasFailure = true
		}
	}
	var _7_elapsed m__Time.RelativeTime
	_ = _7_elapsed
	var _out3 m__Time.RelativeTime
	_ = _out3
	_out3 = m__Time.Companion_Default___.TimeSince(_2_time)
	_7_elapsed = _out3
	m__Time.Companion_Default___.PrintTimeLong(_7_elapsed, _dafny.SeqOfString("TestEncrypts"), m_Wrappers.Companion_Option_.Create_Some_(Companion_Default___.LogFileName()))
	_dafny.Print((_dafny.SeqOfString("\n=================== Completed ")).SetString())
	_dafny.Print(_dafny.IntOfUint32((tests).Cardinality()))
	_dafny.Print((_dafny.SeqOfString(" Encrypt Tests =================== \n\n")).SetString())
	if !(!(_0_hasFailure)) {
		panic("dafny/TestVectorsAwsCryptographicMaterialProviders/src/TestManifests.dfy(90,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
	var _8_valueOrError0 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(_dafny.EmptySeq)
	_ = _8_valueOrError0
	var _out4 m_Wrappers.Result
	_ = _out4
	_out4 = Companion_Default___.ToDecryptTestVectors(keys, _1_decryptableTests)
	_8_valueOrError0 = _out4
	if !(!((_8_valueOrError0).IsFailure())) {
		panic("dafny/TestVectorsAwsCryptographicMaterialProviders/src/TestManifests.dfy(91,14): " + (_8_valueOrError0).String())
	}
	output = (_8_valueOrError0).Extract().(_dafny.Sequence)
	return output
}
func (_static *CompanionStruct_Default___) StartDecrypt(op m_MplManifestOptions.ManifestOptions) m_Wrappers.Result {
	...
	var _2_decryptManifest ManifestData
	_ = _2_decryptManifest
	_2_decryptManifest = (_1_valueOrError0).Extract().(ManifestData)
	var _3_valueOrError1 m_Wrappers.Outcome = m_Wrappers.Companion_Outcome_.Default()
	_ = _3_valueOrError1
	_3_valueOrError1 = m_Wrappers.Companion_Default___.Need((_2_decryptManifest).Is_DecryptManifest(), _dafny.SeqOfString("Not a encrypt manifest"))
	if (_3_valueOrError1).IsFailure() {
		output = (_3_valueOrError1).PropagateFailure()
		return output
	}
	var _4_valueOrError2 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(_dafny.EmptySeq)
	_ = _4_valueOrError2
	_4_valueOrError2 = m_ParseJsonManifests.Companion_Default___.BuildDecryptTestVector((_2_decryptManifest).Dtor_keys(), (_2_decryptManifest).Dtor_jsonTests())
	if (_4_valueOrError2).IsFailure() {
		output = (_4_valueOrError2).PropagateFailure()
		return output
	}
	var _5_decryptVectors _dafny.Sequence
	_ = _5_decryptVectors
	_5_decryptVectors = (_4_valueOrError2).Extract().(_dafny.Sequence)
	var _6_valueOrError3 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(_dafny.EmptySeq)
	_ = _6_valueOrError3
	var _out2 m_Wrappers.Result
	_ = _out2
	_out2 = Companion_Default___.ToDecryptTests((_2_decryptManifest).Dtor_keys(), _5_decryptVectors)
	_6_valueOrError3 = _out2
	if (_6_valueOrError3).IsFailure() {
		output = (_6_valueOrError3).PropagateFailure()
		return output
	}
	var _7_decryptTests _dafny.Sequence
	_ = _7_decryptTests
	_7_decryptTests = (_6_valueOrError3).Extract().(_dafny.Sequence)
	Companion_Default___.TestDecrypts(_7_decryptTests)
	m__Time.Companion_Default___.PrintTimeSince(_0_time)
	output = m_Wrappers.Companion_Result_.Create_Success_(_dafny.TupleOf())
	return output
}
func (_static *CompanionStruct_Default___) TestDecrypts(tests _dafny.Sequence) {
	...
	_ = _0_hasFailure
	_0_hasFailure = false
	var _1_time m__Time.AbsoluteTime
	_ = _1_time
	var _out0 m__Time.AbsoluteTime
	_ = _out0
	_out0 = m__Time.Companion_Default___.GetAbsoluteTime()
	...
	for _2_i := _dafny.Zero; _2_i.Cmp(_hi0) < 0; _2_i = _2_i.Plus(_dafny.One) {
		...
		var _out1 bool
		_ = _out1
		_out1 = m_TestVectors.Companion_Default___.TestDecryptMaterials((tests).Select((_2_i).Uint32()).(m_TestVectors.DecryptTest))
		_3_pass = _out1
		if !(_3_pass) {
			_0_hasFailure = true
		}
	}
	var _4_elapsed m__Time.RelativeTime
	_ = _4_elapsed
	var _out2 m__Time.RelativeTime
	_ = _out2
	_out2 = m__Time.Companion_Default___.TimeSince(_1_time)
	_4_elapsed = _out2
	m__Time.Companion_Default___.PrintTimeLong(_4_elapsed, _dafny.SeqOfString("TestDecrypts"), m_Wrappers.Companion_Option_.Create_Some_(Companion_Default___.LogFileName()))
	_dafny.Print((_dafny.SeqOfString("\n=================== Completed ")).SetString())
	_dafny.Print(_dafny.IntOfUint32((tests).Cardinality()))
	_dafny.Print((_dafny.SeqOfString(" Decrypt Tests =================== \n\n")).SetString())
	if !(!(_0_hasFailure)) {
		panic("dafny/TestVectorsAwsCryptographicMaterialProviders/src/TestManifests.dfy(134,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
}
...
func (_static *CompanionStruct_Default___) ToDecryptTestVectors(keys *m_KeyVectors.KeyVectorsClient, tests _dafny.Sequence) m_Wrappers.Result {
	...
	_0_successfulEncrypt = m_Seq.Companion_Default___.Filter(func(coer133 func(_dafny.Tuple) bool) func(interface{}) bool {
		return func(arg204 interface{}) bool {
			return coer133(arg204.(_dafny.Tuple))
		}
...
func (_static *CompanionStruct_Default___) GetManifest(manifestPath _dafny.Sequence, manifestFileName _dafny.Sequence) m_Wrappers.Result {
	...
	var _1_decryptManifestBytes _dafny.Sequence
	_ = _1_decryptManifestBytes
	_1_decryptManifestBytes = (_0_valueOrError0).Extract().(_dafny.Sequence)
	var _2_valueOrError1 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(m_JSON_Values.Companion_JSON_.Default())
	_ = _2_valueOrError1
	_2_valueOrError1 = (m_JSON_API.Companion_Default___.Deserialize(_1_decryptManifestBytes)).MapFailure(func(coer134 func(m_JSON_Errors.DeserializationError) _dafny.Sequence) func(interface{}) interface{} {
		return func(arg205 interface{}) interface{} {
			return coer134(arg205.(m_JSON_Errors.DeserializationError))
		}
	}(func(_3_e m_JSON_Errors.DeserializationError) _dafny.Sequence {
		return (_3_e).ToString()
	}))
	if (_2_valueOrError1).IsFailure() {
		manifestData = (_2_valueOrError1).PropagateFailure()
		return manifestData
	}
	var _4_manifestJson m_JSON_Values.JSON
	_ = _4_manifestJson
	_4_manifestJson = (_2_valueOrError1).Extract().(m_JSON_Values.JSON)
	var _5_valueOrError2 m_Wrappers.Outcome = m_Wrappers.Companion_Outcome_.Default()
	_ = _5_valueOrError2
	_5_valueOrError2 = m_Wrappers.Companion_Default___.Need((_4_manifestJson).Is_Object(), _dafny.SeqOfString("Not a JSON object"))
	if (_5_valueOrError2).IsFailure() {
		manifestData = (_5_valueOrError2).PropagateFailure()
		return manifestData
	}
	var _6_valueOrError3 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(_dafny.EmptySeq)
	_ = _6_valueOrError3
	_6_valueOrError3 = m_JSONHelpers.Companion_Default___.GetObject(_dafny.SeqOfString("manifest"), (_4_manifestJson).Dtor_obj())
	if (_6_valueOrError3).IsFailure() {
		manifestData = (_6_valueOrError3).PropagateFailure()
		return manifestData
	}
	var _7_manifest _dafny.Sequence
	_ = _7_manifest
	_7_manifest = (_6_valueOrError3).Extract().(_dafny.Sequence)
	var _8_valueOrError4 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(_dafny.Zero)
	_ = _8_valueOrError4
	_8_valueOrError4 = m_JSONHelpers.Companion_Default___.GetNat(_dafny.SeqOfString("version"), _7_manifest)
	if (_8_valueOrError4).IsFailure() {
		manifestData = (_8_valueOrError4).PropagateFailure()
		return manifestData
	}
	var _9_version _dafny.Int
	_ = _9_version
	_9_version = (_8_valueOrError4).Extract().(_dafny.Int)
	var _10_valueOrError5 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(_dafny.EmptySeq.SetString())
	_ = _10_valueOrError5
	_10_valueOrError5 = m_JSONHelpers.Companion_Default___.GetString(_dafny.SeqOfString("type"), _7_manifest)
	if (_10_valueOrError5).IsFailure() {
		manifestData = (_10_valueOrError5).PropagateFailure()
		return manifestData
	}
	var _11_typ _dafny.Sequence
	_ = _11_typ
	_11_typ = (_10_valueOrError5).Extract().(_dafny.Sequence)
	var _12_valueOrError6 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(_dafny.EmptySeq.SetString())
	_ = _12_valueOrError6
	_12_valueOrError6 = m_JSONHelpers.Companion_Default___.GetString(_dafny.SeqOfString("keys"), (_4_manifestJson).Dtor_obj())
	if (_12_valueOrError6).IsFailure() {
		manifestData = (_12_valueOrError6).PropagateFailure()
		return manifestData
	}
	var _13_keyManifestUri _dafny.Sequence
	_ = _13_keyManifestUri
	_13_keyManifestUri = (_12_valueOrError6).Extract().(_dafny.Sequence)
	var _14_valueOrError7 m_Wrappers.Outcome = m_Wrappers.Companion_Outcome_.Default()
	_ = _14_valueOrError7
	_14_valueOrError7 = m_Wrappers.Companion_Default___.Need(_dafny.Companion_Sequence_.IsProperPrefixOf(_dafny.SeqOfString("file://"), _13_keyManifestUri), _dafny.SeqOfString("Unexpected URI prefix"))
	if (_14_valueOrError7).IsFailure() {
		manifestData = (_14_valueOrError7).PropagateFailure()
		return manifestData
	}
	var _15_keyManifestPath _dafny.Sequence
	_ = _15_keyManifestPath
	_15_keyManifestPath = _dafny.Companion_Sequence_.Concatenate(manifestPath, (_13_keyManifestUri).Drop(7))
	var _16_valueOrError8 m_Wrappers.Result = m_Wrappers.Result{}
	_ = _16_valueOrError8
	var _out1 m_Wrappers.Result
	_ = _out1
	_out1 = m_KeyVectors.Companion_Default___.KeyVectors(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Companion_KeyVectorsConfig_.Create_KeyVectorsConfig_(_15_keyManifestPath))
	_16_valueOrError8 = _out1
	if !(!((_16_valueOrError8).IsFailure())) {
		panic("dafny/TestVectorsAwsCryptographicMaterialProviders/src/TestManifests.dfy(242,16): " + (_16_valueOrError8).String())
	}
	var _17_keys *m_KeyVectors.KeyVectorsClient
	_ = _17_keys
	_17_keys = (_16_valueOrError8).Extract().(*m_KeyVectors.KeyVectorsClient)
	var _18_valueOrError9 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(_dafny.EmptySeq)
	_ = _18_valueOrError9
	_18_valueOrError9 = m_JSONHelpers.Companion_Default___.GetObject(_dafny.SeqOfString("tests"), (_4_manifestJson).Dtor_obj())
	if (_18_valueOrError9).IsFailure() {
		manifestData = (_18_valueOrError9).PropagateFailure()
		return manifestData
	}
	var _19_jsonTests _dafny.Sequence
	_ = _19_jsonTests
	_19_jsonTests = (_18_valueOrError9).Extract().(_dafny.Sequence)
	var _source0 _dafny.Sequence = _11_typ
	_ = _source0
	{
		{
			if (_source0).Equals(_dafny.SeqOfString("awses-mpl-decrypt")) {
				var _20_valueOrError10 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(m_JSON_Values.Companion_JSON_.Default())
				_ = _20_valueOrError10
				_20_valueOrError10 = m_JSONHelpers.Companion_Default___.Get(_dafny.SeqOfString("client"), (_4_manifestJson).Dtor_obj())
				if (_20_valueOrError10).IsFailure() {
					manifestData = (_20_valueOrError10).PropagateFailure()
					return manifestData
				}
				var _21_client m_JSON_Values.JSON
				_ = _21_client
				_21_client = (_20_valueOrError10).Extract().(m_JSON_Values.JSON)
				manifestData = m_Wrappers.Companion_Result_.Create_Success_(Companion_ManifestData_.Create_DecryptManifest_(_9_version, _17_keys, _21_client, _19_jsonTests))
				goto Lmatch0
			}
		}
		{
			if (_source0).Equals(_dafny.SeqOfString("awses-mpl-encrypt")) {
				manifestData = m_Wrappers.Companion_Result_.Create_Success_(Companion_ManifestData_.Create_EncryptManifest_(_9_version, _17_keys, _19_jsonTests))
				goto Lmatch0
			}
		}
		{
			manifestData = m_Wrappers.Companion_Result_.Create_Failure_(_dafny.Companion_Sequence_.Concatenate(_dafny.SeqOfString("Unsupported manifest type:"), _11_typ))
		}
		goto Lmatch0
	}
Lmatch0:
