// Package AllHierarchy
// Dafny module AllHierarchy compiled into Go
...
func (_static *CompanionStruct_Default___) AllHierarchyKeys() _dafny.Sequence {
	return _dafny.SeqOf(_dafny.SeqOfString("static-branch-key-1"))
}
func (_static *CompanionStruct_Default___) KeyDescriptions() _dafny.Set {
	return func() _dafny.Set {
		var _coll0 = _dafny.NewBuilder()
		_ = _coll0
		for _iter6 := _dafny.Iterate((Companion_Default___.AllHierarchyKeys()).Elements()); ; {
			...
			if _dafny.Companion_Sequence_.Contains(Companion_Default___.AllHierarchyKeys(), _0_key) {
				_coll0.Add(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Companion_KeyDescription_.Create_Hierarchy_(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Companion_HierarchyKeyring_.Create_HierarchyKeyring_(_0_key)))
			}
		}
		return _coll0.ToSet()
	}()
...
func (_static *CompanionStruct_Default___) Tests() _dafny.Set {
	return func() _dafny.Set {
		var _coll0 = _dafny.NewBuilder()
		_ = _coll0
		for _iter7 := _dafny.Iterate((Companion_Default___.KeyDescriptions()).Elements()); ; {
			...
			if (Companion_Default___.KeyDescriptions()).Contains(_0_keyDescription) {
				for _iter8 := _dafny.Iterate((m_AllAlgorithmSuites.Companion_Default___.AllAlgorithmSuites()).Elements()); ; {
					...
					if (m_AllAlgorithmSuites.Companion_Default___.AllAlgorithmSuites()).Contains(_1_algorithmSuite) {
						for _iter9 := _dafny.Iterate(_dafny.SingleValue(m_AllAlgorithmSuites.Companion_Default___.GetCompatibleCommitmentPolicy(_1_algorithmSuite))); ; {
							_compr_2, _ok9 := _iter9()
							if !_ok9 {
								break
							}
