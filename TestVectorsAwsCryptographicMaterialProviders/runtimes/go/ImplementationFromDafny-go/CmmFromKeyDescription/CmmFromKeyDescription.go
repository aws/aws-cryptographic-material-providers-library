	...
	{
		{
			if _source0.Is_RequiredEncryptionContext() {
				...
				_ = _1_cmm
				{
					...
					_4_output_k = _out1
					output = (_4_output_k).MapFailure(func(coer40 func(m_AwsCryptographyMaterialProvidersTypes.Error) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Error) func(interface{}) interface{} {
		...
		{
			{
				...
				_8_output_k = _out3
				output = (_8_output_k).MapFailure(func(coer41 func(m_AwsCryptographyMaterialProvidersTypes.Error) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Error) func(interface{}) interface{} {
