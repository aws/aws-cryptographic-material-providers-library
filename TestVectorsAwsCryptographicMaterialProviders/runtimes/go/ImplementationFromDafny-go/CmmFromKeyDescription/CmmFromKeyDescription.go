// Package CmmFromKeyDescription
// Dafny module CmmFromKeyDescription compiled into Go
...
func (*Default__) String() string {
	return "CmmFromKeyDescription.Default__"
}
...
func (_static *CompanionStruct_Default___) ToCmm(mpl m_AwsCryptographyMaterialProvidersTypes.IAwsCryptographicMaterialProvidersClient, keys _dafny.Map, description m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription, forOperation m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.CmmOperation) m_Wrappers.Result {
	var output m_Wrappers.Result = m_Wrappers.Result{}
	_ = output
	var _0_material m_Wrappers.Option
	_ = _0_material
	_0_material = m_KeyringFromKeyDescription.Companion_Default___.GetKeyMaterial(keys, description)
	...
	{
		{
			if _source0.Is_RequiredEncryptionContext() {
				var _1_cmm m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.RequiredEncryptionContextCMM = _source0.Get_().(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription_RequiredEncryptionContext).RequiredEncryptionContext
				_ = _1_cmm
				{
					...
					_ = _out0
					_out0 = Companion_Default___.ToCmm(mpl, keys, (_1_cmm).Dtor_underlying(), forOperation)
					_2_valueOrError0 = _out0
					if (_2_valueOrError0).IsFailure() {
						output = (_2_valueOrError0).PropagateFailure()
						return output
					}
					var _3_underlying m_AwsCryptographyMaterialProvidersTypes.ICryptographicMaterialsManager
					_ = _3_underlying
					_3_underlying = m_AwsCryptographyMaterialProvidersTypes.Companion_ICryptographicMaterialsManager_.CastTo_((_2_valueOrError0).Extract())
					var _4_output_k m_Wrappers.Result
					_ = _4_output_k
					var _out1 m_Wrappers.Result
					_ = _out1
					_out1 = (mpl).CreateRequiredEncryptionContextCMM(m_AwsCryptographyMaterialProvidersTypes.Companion_CreateRequiredEncryptionContextCMMInput_.Create_CreateRequiredEncryptionContextCMMInput_(m_Wrappers.Companion_Option_.Create_Some_(_3_underlying), m_Wrappers.Companion_Option_.Create_None_(), (_1_cmm).Dtor_requiredEncryptionContextKeys()))
					_4_output_k = _out1
					output = (_4_output_k).MapFailure(func(coer38 func(m_AwsCryptographyMaterialProvidersTypes.Error) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Error) func(interface{}) interface{} {
						return func(arg38 interface{}) interface{} {
							return coer38(arg38.(m_AwsCryptographyMaterialProvidersTypes.Error))
						}
					}(func(_5_e m_AwsCryptographyMaterialProvidersTypes.Error) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Error {
						return m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Companion_Error_.Create_AwsCryptographyMaterialProviders_(_5_e)
					}))
				}
				goto Lmatch0
			}
		...
		{
			{
				...
				_ = _out2
				_out2 = m_KeyringFromKeyDescription.Companion_Default___.ToKeyring(mpl, keys, description)
				...
				_ = _7_keyring
				_7_keyring = m_AwsCryptographyMaterialProvidersTypes.Companion_IKeyring_.CastTo_((_6_valueOrError1).Extract())
				var _8_output_k m_Wrappers.Result
				_ = _8_output_k
				var _out3 m_Wrappers.Result
				_ = _out3
				_out3 = (mpl).CreateDefaultCryptographicMaterialsManager(m_AwsCryptographyMaterialProvidersTypes.Companion_CreateDefaultCryptographicMaterialsManagerInput_.Create_CreateDefaultCryptographicMaterialsManagerInput_(_7_keyring))
				_8_output_k = _out3
				output = (_8_output_k).MapFailure(func(coer39 func(m_AwsCryptographyMaterialProvidersTypes.Error) m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Error) func(interface{}) interface{} {
					return func(arg39 interface{}) interface{} {
						return coer39(arg39.(m_AwsCryptographyMaterialProvidersTypes.Error))
					}
