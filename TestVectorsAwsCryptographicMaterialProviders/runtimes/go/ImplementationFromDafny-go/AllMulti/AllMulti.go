// Package AllMulti
// Dafny module AllMulti compiled into Go
...
func (_static *CompanionStruct_Default___) GetChildKeyrings(keys _dafny.Sequence, key _dafny.Sequence, i _dafny.Int) _dafny.Sequence {
	var _0___accumulator _dafny.Sequence = _dafny.SeqOf()
	_ = _0___accumulator
	goto TAIL_CALL_START
TAIL_CALL_START:
	if (i).Cmp(_dafny.IntOfUint32((keys).Cardinality())) == 0 {
		return _dafny.Companion_Sequence_.Concatenate(_0___accumulator, _dafny.SeqOf())
	} else if _dafny.Companion_Sequence_.Equal((keys).Select((i).Uint32()).(_dafny.Sequence), key) {
		var _in0 _dafny.Sequence = keys
		_ = _in0
		var _in1 _dafny.Sequence = key
		_ = _in1
		...
		_0___accumulator = _dafny.Companion_Sequence_.Concatenate(_0___accumulator, _dafny.SeqOf(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Companion_KeyDescription_.Create_AES_(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Companion_RawAES_.Create_RawAES_((keys).Select((i).Uint32()).(_dafny.Sequence), _dafny.Companion_Sequence_.Concatenate(_dafny.SeqOfString("aws-raw-vectors-persistent-"), (keys).Select((i).Uint32()).(_dafny.Sequence))))))
		var _in3 _dafny.Sequence = keys
		_ = _in3
		var _in4 _dafny.Sequence = key
		_ = _in4
		var _in5 _dafny.Int = (i).Plus(_dafny.One)
		_ = _in5
		keys = _in3
		key = _in4
		i = _in5
...
func (_static *CompanionStruct_Default___) KeyDescriptionsGeneratorAndChildren() _dafny.Set {
	return func() _dafny.Set {
		var _coll0 = _dafny.NewBuilder()
		_ = _coll0
		for _iter102 := _dafny.Iterate((m_AllRawAES.Companion_Default___.AesPersistentKeyNames()).Elements()); ; {
			...
			if _dafny.Companion_Sequence_.Contains(m_AllRawAES.Companion_Default___.AesPersistentKeyNames(), _0_key) {
				_coll0.Add(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Companion_KeyDescription_.Create_Multi_(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Companion_MultiKeyring_.Create_MultiKeyring_(m_Wrappers.Companion_Option_.Create_Some_(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Companion_KeyDescription_.Create_AES_(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Companion_RawAES_.Create_RawAES_(_0_key, _dafny.Companion_Sequence_.Concatenate(_dafny.SeqOfString("aws-raw-vectors-persistent-"), _0_key)))), Companion_Default___.GetChildKeyrings(m_AllRawAES.Companion_Default___.AesPersistentKeyNames(), _0_key, _dafny.Zero))))
			}
		}
		return _coll0.ToSet()
	}()
}
func (_static *CompanionStruct_Default___) OnlyGeneratorKeyDescriptions() _dafny.Set {
	return func() _dafny.Set {
		var _coll0 = _dafny.NewBuilder()
		_ = _coll0
		for _iter103 := _dafny.Iterate((m_AllRawAES.Companion_Default___.AesPersistentKeyNames()).Elements()); ; {
			...
			_0_key = interface{}(_compr_0).(_dafny.Sequence)
			if _dafny.Companion_Sequence_.Contains(m_AllRawAES.Companion_Default___.AesPersistentKeyNames(), _0_key) {
				_coll0.Add(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Companion_KeyDescription_.Create_Multi_(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Companion_MultiKeyring_.Create_MultiKeyring_(m_Wrappers.Companion_Option_.Create_Some_(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Companion_KeyDescription_.Create_AES_(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Companion_RawAES_.Create_RawAES_(_0_key, _dafny.Companion_Sequence_.Concatenate(_dafny.SeqOfString("aws-raw-vectors-persistent-"), _0_key)))), _dafny.SeqOf())))
			}
		}
		return _coll0.ToSet()
	}()
...
func (_static *CompanionStruct_Default___) KeyDescriptions() _dafny.Set {
	return (Companion_Default___.OnlyGeneratorKeyDescriptions()).Union(Companion_Default___.KeyDescriptionsGeneratorAndChildren())
}
func (_static *CompanionStruct_Default___) Tests() _dafny.Set {
	return func() _dafny.Set {
		var _coll0 = _dafny.NewBuilder()
		_ = _coll0
		for _iter104 := _dafny.Iterate((Companion_Default___.KeyDescriptions()).Elements()); ; {
			...
			if (Companion_Default___.KeyDescriptions()).Contains(_0_keyDescription) {
				for _iter105 := _dafny.Iterate((m_AllAlgorithmSuites.Companion_Default___.AllAlgorithmSuites()).Elements()); ; {
					_compr_1, _ok105 := _iter105()
					if !_ok105 {
						break
					}
					...
					if (m_AllAlgorithmSuites.Companion_Default___.AllAlgorithmSuites()).Contains(_1_algorithmSuite) {
						for _iter106 := _dafny.Iterate(_dafny.SingleValue(m_AllAlgorithmSuites.Companion_Default___.GetCompatibleCommitmentPolicy(_1_algorithmSuite))); ; {
							_compr_2, _ok106 := _iter106()
							if !_ok106 {
								break
							}
							...
							if (_2_commitmentPolicy).Equals(m_AllAlgorithmSuites.Companion_Default___.GetCompatibleCommitmentPolicy(_1_algorithmSuite)) {
								_coll0.Add(m_TestVectors.Companion_EncryptTestVector_.Create_PositiveEncryptKeyringVector_(_dafny.Companion_Sequence_.Concatenate(_dafny.SeqOfString("MultiKeyring "), (((((_0_keyDescription).Dtor_Multi()).Dtor_generator()).Dtor_value().(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription)).Dtor_AES()).Dtor_keyId()), m_Wrappers.Companion_Option_.Create_None_(), _dafny.NewMapBuilder().ToMap(), _2_commitmentPolicy, _1_algorithmSuite, m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), _0_keyDescription, _0_keyDescription, m_Wrappers.Companion_Option_.Create_None_()))
							}
						}
					}
				}
