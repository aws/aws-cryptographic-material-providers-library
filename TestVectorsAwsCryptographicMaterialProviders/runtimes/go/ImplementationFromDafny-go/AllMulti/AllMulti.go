...
func (_static *CompanionStruct_Default___) KeyDescriptionsGeneratorAndChildren() _dafny.Set {
	return func() _dafny.Set {
		...
		_ = _coll0
		for _iter166 := _dafny.Iterate((m_AllRawAES.Companion_Default___.AesPersistentKeyNames()).Elements()); ; {
			_compr_0, _ok166 := _iter166()
			if !_ok166 {
				break
			}
...
func (_static *CompanionStruct_Default___) OnlyGeneratorKeyDescriptions() _dafny.Set {
	return func() _dafny.Set {
		var _coll0 = _dafny.NewBuilder()
		_ = _coll0
		for _iter167 := _dafny.Iterate((m_AllRawAES.Companion_Default___.AesPersistentKeyNames()).Elements()); ; {
			_compr_0, _ok167 := _iter167()
			if !_ok167 {
				break
			}
			var _0_key _dafny.Sequence
...
func (_static *CompanionStruct_Default___) Tests() _dafny.Set {
	return func() _dafny.Set {
		var _coll0 = _dafny.NewBuilder()
		_ = _coll0
		for _iter168 := _dafny.Iterate((Companion_Default___.KeyDescriptions()).Elements()); ; {
			_compr_0, _ok168 := _iter168()
			if !_ok168 {
				break
			}
			...
			if (Companion_Default___.KeyDescriptions()).Contains(_0_keyDescription) {
				for _iter169 := _dafny.Iterate((m_AllAlgorithmSuites.Companion_Default___.AllAlgorithmSuites()).Elements()); ; {
					_compr_1, _ok169 := _iter169()
					if !_ok169 {
						break
					}
					...
					if (m_AllAlgorithmSuites.Companion_Default___.AllAlgorithmSuites()).Contains(_1_algorithmSuite) {
						for _iter170 := _dafny.Iterate(_dafny.SingleValue(m_AllAlgorithmSuites.Companion_Default___.GetCompatibleCommitmentPolicy(_1_algorithmSuite))); ; {
							_compr_2, _ok170 := _iter170()
							if !_ok170 {
								break
							}
