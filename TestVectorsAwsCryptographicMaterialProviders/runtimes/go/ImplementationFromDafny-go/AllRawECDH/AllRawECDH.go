// Package AllRawECDH
// Dafny module AllRawECDH compiled into Go
...
func (_static *CompanionStruct_Default___) EcdhCurveNames() _dafny.Sequence {
	return _dafny.SeqOf(_dafny.SeqOfString("ecc-256"), _dafny.SeqOfString("ecc-384"), _dafny.SeqOfString("ecc-521"))
}
func (_static *CompanionStruct_Default___) EphemeralKeyDescriptionsEncrypt() _dafny.Set {
	return func() _dafny.Set {
		var _coll0 = _dafny.NewBuilder()
		_ = _coll0
		for _iter101 := _dafny.Iterate((Companion_Default___.EcdhCurveNames()).Elements()); ; {
			_compr_0, _ok101 := _iter101()
			if !_ok101 {
				break
			}
			var _0_key _dafny.Sequence
			_0_key = interface{}(_compr_0).(_dafny.Sequence)
			if _dafny.Companion_Sequence_.Contains(Companion_Default___.EcdhCurveNames(), _0_key) {
				_coll0.Add(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Companion_KeyDescription_.Create_ECDH_(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Companion_RawEcdh_.Create_RawEcdh_(_dafny.SeqOfString("ephemeral"), _dafny.Companion_Sequence_.Concatenate(_0_key, _dafny.SeqOfString("-private")), _dafny.SeqOfString("ephemeral"), _dafny.SeqOfString("recipient-material-public-key"), _dafny.Companion_Sequence_.Concatenate(_dafny.SeqOfString("aws-raw-vectors-persistent-ephemeral "), _0_key), _0_key, _dafny.SeqOfString("ephemeral"))))
			}
		}
		return _coll0.ToSet()
	}()
}
func (_static *CompanionStruct_Default___) DiscoveryKeyDescriptionsDecrypt() _dafny.Set {
	return func() _dafny.Set {
		var _coll0 = _dafny.NewBuilder()
		_ = _coll0
		for _iter102 := _dafny.Iterate((Companion_Default___.EcdhCurveNames()).Elements()); ; {
			_compr_0, _ok102 := _iter102()
			if !_ok102 {
				break
			}
			var _0_key _dafny.Sequence
			_0_key = interface{}(_compr_0).(_dafny.Sequence)
			if _dafny.Companion_Sequence_.Contains(Companion_Default___.EcdhCurveNames(), _0_key) {
				_coll0.Add(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Companion_KeyDescription_.Create_ECDH_(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Companion_RawEcdh_.Create_RawEcdh_(_dafny.SeqOfString("discovery"), _dafny.Companion_Sequence_.Concatenate(_0_key, _dafny.SeqOfString("-private")), _dafny.SeqOfString("discovery"), _dafny.SeqOfString("recipient-material-public-key"), _dafny.Companion_Sequence_.Concatenate(_dafny.SeqOfString("aws-raw-vectors-persistent-discovery "), _0_key), _0_key, _dafny.SeqOfString("discovery"))))
			}
		}
		return _coll0.ToSet()
	}()
}
func (_static *CompanionStruct_Default___) SenderKeyDescriptions() _dafny.Set {
	return func() _dafny.Set {
		var _coll0 = _dafny.NewBuilder()
		_ = _coll0
		for _iter103 := _dafny.Iterate((Companion_Default___.EcdhCurveNames()).Elements()); ; {
			_compr_0, _ok103 := _iter103()
			if !_ok103 {
				break
			}
			var _0_key _dafny.Sequence
			_0_key = interface{}(_compr_0).(_dafny.Sequence)
			if _dafny.Companion_Sequence_.Contains(Companion_Default___.EcdhCurveNames(), _0_key) {
				_coll0.Add(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Companion_KeyDescription_.Create_ECDH_(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.Companion_RawEcdh_.Create_RawEcdh_(_dafny.Companion_Sequence_.Concatenate(_0_key, _dafny.SeqOfString("-private")), _dafny.Companion_Sequence_.Concatenate(_0_key, _dafny.SeqOfString("-private")), _dafny.SeqOfString("sender-material-public-key"), _dafny.SeqOfString("recipient-material-public-key"), _dafny.Companion_Sequence_.Concatenate(_dafny.SeqOfString("aws-raw-vectors-persistent-static "), _0_key), _0_key, _dafny.SeqOfString("static"))))
			}
		}
		return _coll0.ToSet()
	}()
}
func (_static *CompanionStruct_Default___) RecipientKeyDescriptions() _dafny.Set {
	return func() _dafny.Set {
		var _coll0 = _dafny.NewBuilder()
		_ = _coll0
		for _iter104 := _dafny.Iterate((Companion_Default___.EcdhCurveNames()).Elements()); ; {
			_compr_0, _ok104 := _iter104()
			if !_ok104 {
				break
			}
			var _0_key _dafny.Sequence
...
func (_static *CompanionStruct_Default___) EphemeralDiscoveryTests() _dafny.Set {
	return func() _dafny.Set {
		var _coll0 = _dafny.NewBuilder()
		_ = _coll0
		for _iter105 := _dafny.Iterate((Companion_Default___.EphemeralKeyDescriptionsEncrypt()).Elements()); ; {
			_compr_0, _ok105 := _iter105()
			if !_ok105 {
				break
			}
			var _0_encryptKeyDescription m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription
			_0_encryptKeyDescription = interface{}(_compr_0).(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription)
			if (Companion_Default___.EphemeralKeyDescriptionsEncrypt()).Contains(_0_encryptKeyDescription) {
				for _iter106 := _dafny.Iterate((Companion_Default___.DiscoveryKeyDescriptionsDecrypt()).Elements()); ; {
					_compr_1, _ok106 := _iter106()
					if !_ok106 {
						break
					}
					var _1_decryptKeyDescription m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription
					_1_decryptKeyDescription = interface{}(_compr_1).(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription)
					if ((Companion_Default___.DiscoveryKeyDescriptionsDecrypt()).Contains(_1_decryptKeyDescription)) && (_dafny.Companion_Sequence_.Equal(((_1_decryptKeyDescription).Dtor_ECDH()).Dtor_curveSpec(), ((_0_encryptKeyDescription).Dtor_ECDH()).Dtor_curveSpec())) {
						for _iter107 := _dafny.Iterate((m_AllAlgorithmSuites.Companion_Default___.AllAlgorithmSuites()).Elements()); ; {
							_compr_2, _ok107 := _iter107()
							if !_ok107 {
								break
							}
							var _2_algorithmSuite m_AwsCryptographyMaterialProvidersTypes.AlgorithmSuiteInfo
							_2_algorithmSuite = interface{}(_compr_2).(m_AwsCryptographyMaterialProvidersTypes.AlgorithmSuiteInfo)
							if (m_AllAlgorithmSuites.Companion_Default___.AllAlgorithmSuites()).Contains(_2_algorithmSuite) {
								for _iter108 := _dafny.Iterate(_dafny.SingleValue(m_AllAlgorithmSuites.Companion_Default___.GetCompatibleCommitmentPolicy(_2_algorithmSuite))); ; {
									_compr_3, _ok108 := _iter108()
									if !_ok108 {
										break
									}
									var _3_commitmentPolicy m_AwsCryptographyMaterialProvidersTypes.CommitmentPolicy
									_3_commitmentPolicy = interface{}(_compr_3).(m_AwsCryptographyMaterialProvidersTypes.CommitmentPolicy)
									if (_3_commitmentPolicy).Equals(m_AllAlgorithmSuites.Companion_Default___.GetCompatibleCommitmentPolicy(_2_algorithmSuite)) {
										_coll0.Add(m_TestVectors.Companion_EncryptTestVector_.Create_PositiveEncryptKeyringVector_(_dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.SeqOfString("Generated RawECDH Ephemeral-Discovery "), ((_0_encryptKeyDescription).Dtor_ECDH()).Dtor_senderKeyId()), _dafny.SeqOfString(" ")), ((_1_decryptKeyDescription).Dtor_ECDH()).Dtor_recipientKeyId()), m_Wrappers.Companion_Option_.Create_None_(), _dafny.NewMapBuilder().ToMap(), _3_commitmentPolicy, _2_algorithmSuite, m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), _0_encryptKeyDescription, _1_decryptKeyDescription, m_Wrappers.Companion_Option_.Create_None_()))
									}
								}
							}
						}
...
func (_static *CompanionStruct_Default___) StaticSenderDiscoveryRecipientTests() _dafny.Set {
	return func() _dafny.Set {
		var _coll0 = _dafny.NewBuilder()
		_ = _coll0
		for _iter109 := _dafny.Iterate((Companion_Default___.SenderKeyDescriptions()).Elements()); ; {
			_compr_0, _ok109 := _iter109()
			if !_ok109 {
				break
			}
			var _0_encryptKeyDescription m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription
			_0_encryptKeyDescription = interface{}(_compr_0).(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription)
			if (Companion_Default___.SenderKeyDescriptions()).Contains(_0_encryptKeyDescription) {
				for _iter110 := _dafny.Iterate((Companion_Default___.DiscoveryKeyDescriptionsDecrypt()).Elements()); ; {
					_compr_1, _ok110 := _iter110()
					if !_ok110 {
						break
					}
					var _1_decryptKeyDescription m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription
					_1_decryptKeyDescription = interface{}(_compr_1).(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription)
					if ((Companion_Default___.DiscoveryKeyDescriptionsDecrypt()).Contains(_1_decryptKeyDescription)) && (_dafny.Companion_Sequence_.Equal(((_1_decryptKeyDescription).Dtor_ECDH()).Dtor_curveSpec(), ((_0_encryptKeyDescription).Dtor_ECDH()).Dtor_curveSpec())) {
						for _iter111 := _dafny.Iterate((m_AllAlgorithmSuites.Companion_Default___.AllAlgorithmSuites()).Elements()); ; {
							_compr_2, _ok111 := _iter111()
							if !_ok111 {
								break
							}
							var _2_algorithmSuite m_AwsCryptographyMaterialProvidersTypes.AlgorithmSuiteInfo
							_2_algorithmSuite = interface{}(_compr_2).(m_AwsCryptographyMaterialProvidersTypes.AlgorithmSuiteInfo)
							if (m_AllAlgorithmSuites.Companion_Default___.AllAlgorithmSuites()).Contains(_2_algorithmSuite) {
								for _iter112 := _dafny.Iterate(_dafny.SingleValue(m_AllAlgorithmSuites.Companion_Default___.GetCompatibleCommitmentPolicy(_2_algorithmSuite))); ; {
									_compr_3, _ok112 := _iter112()
									if !_ok112 {
										break
									}
									var _3_commitmentPolicy m_AwsCryptographyMaterialProvidersTypes.CommitmentPolicy
									_3_commitmentPolicy = interface{}(_compr_3).(m_AwsCryptographyMaterialProvidersTypes.CommitmentPolicy)
									if (_3_commitmentPolicy).Equals(m_AllAlgorithmSuites.Companion_Default___.GetCompatibleCommitmentPolicy(_2_algorithmSuite)) {
										_coll0.Add(m_TestVectors.Companion_EncryptTestVector_.Create_PositiveEncryptKeyringVector_(_dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.SeqOfString("Generated RawECDH Static "), ((_0_encryptKeyDescription).Dtor_ECDH()).Dtor_senderKeyId()), _dafny.SeqOfString(" Discovery ")), ((_1_decryptKeyDescription).Dtor_ECDH()).Dtor_recipientKeyId()), m_Wrappers.Companion_Option_.Create_None_(), _dafny.NewMapBuilder().ToMap(), _3_commitmentPolicy, _2_algorithmSuite, m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), _0_encryptKeyDescription, _1_decryptKeyDescription, m_Wrappers.Companion_Option_.Create_None_()))
									}
								}
							}
						}
...
func (_static *CompanionStruct_Default___) StaticSenderRecipientTests() _dafny.Set {
	return func() _dafny.Set {
		var _coll0 = _dafny.NewBuilder()
		_ = _coll0
		for _iter113 := _dafny.Iterate((Companion_Default___.SenderKeyDescriptions()).Elements()); ; {
			_compr_0, _ok113 := _iter113()
			if !_ok113 {
				break
			}
			var _0_encryptKeyDescription m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription
			_0_encryptKeyDescription = interface{}(_compr_0).(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription)
			if (Companion_Default___.SenderKeyDescriptions()).Contains(_0_encryptKeyDescription) {
				for _iter114 := _dafny.Iterate((Companion_Default___.RecipientKeyDescriptions()).Elements()); ; {
					_compr_1, _ok114 := _iter114()
					if !_ok114 {
						break
					}
					var _1_decryptKeyDescription m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription
					_1_decryptKeyDescription = interface{}(_compr_1).(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription)
					if ((Companion_Default___.RecipientKeyDescriptions()).Contains(_1_decryptKeyDescription)) && (_dafny.Companion_Sequence_.Equal(((_1_decryptKeyDescription).Dtor_ECDH()).Dtor_curveSpec(), ((_0_encryptKeyDescription).Dtor_ECDH()).Dtor_curveSpec())) {
						for _iter115 := _dafny.Iterate((m_AllAlgorithmSuites.Companion_Default___.AllAlgorithmSuites()).Elements()); ; {
							_compr_2, _ok115 := _iter115()
							if !_ok115 {
								break
							}
							var _2_algorithmSuite m_AwsCryptographyMaterialProvidersTypes.AlgorithmSuiteInfo
							_2_algorithmSuite = interface{}(_compr_2).(m_AwsCryptographyMaterialProvidersTypes.AlgorithmSuiteInfo)
							if (m_AllAlgorithmSuites.Companion_Default___.AllAlgorithmSuites()).Contains(_2_algorithmSuite) {
								for _iter116 := _dafny.Iterate(_dafny.SingleValue(m_AllAlgorithmSuites.Companion_Default___.GetCompatibleCommitmentPolicy(_2_algorithmSuite))); ; {
									_compr_3, _ok116 := _iter116()
									if !_ok116 {
										break
									}
									var _3_commitmentPolicy m_AwsCryptographyMaterialProvidersTypes.CommitmentPolicy
									_3_commitmentPolicy = interface{}(_compr_3).(m_AwsCryptographyMaterialProvidersTypes.CommitmentPolicy)
									if (_3_commitmentPolicy).Equals(m_AllAlgorithmSuites.Companion_Default___.GetCompatibleCommitmentPolicy(_2_algorithmSuite)) {
										_coll0.Add(m_TestVectors.Companion_EncryptTestVector_.Create_PositiveEncryptKeyringVector_(_dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.SeqOfString("Generated RawECDH Static "), ((_0_encryptKeyDescription).Dtor_ECDH()).Dtor_senderKeyId()), _dafny.SeqOfString(" ")), ((_1_decryptKeyDescription).Dtor_ECDH()).Dtor_senderKeyId()), m_Wrappers.Companion_Option_.Create_None_(), _dafny.NewMapBuilder().ToMap(), _3_commitmentPolicy, _2_algorithmSuite, m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), _0_encryptKeyDescription, _1_decryptKeyDescription, m_Wrappers.Companion_Option_.Create_None_()))
									}
								}
							}
						}
...
func (_static *CompanionStruct_Default___) Tests() _dafny.Set {
	return ((Companion_Default___.EphemeralDiscoveryTests()).Union(Companion_Default___.StaticSenderRecipientTests())).Union(Companion_Default___.StaticSenderDiscoveryRecipientTests())
}
