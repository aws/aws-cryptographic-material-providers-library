...
func (_static *CompanionStruct_Default___) EphemeralKeyDescriptionsEncrypt() _dafny.Set {
	return func() _dafny.Set {
		...
		_ = _coll0
		for _iter51 := _dafny.Iterate((Companion_Default___.EcdhCurveNames()).Elements()); ; {
			_compr_0, _ok51 := _iter51()
			if !_ok51 {
				break
			}
...
func (_static *CompanionStruct_Default___) DiscoveryKeyDescriptionsDecrypt() _dafny.Set {
	return func() _dafny.Set {
		var _coll0 = _dafny.NewBuilder()
		_ = _coll0
		for _iter52 := _dafny.Iterate((Companion_Default___.EcdhCurveNames()).Elements()); ; {
			_compr_0, _ok52 := _iter52()
			if !_ok52 {
				break
			}
			var _0_key _dafny.Sequence
...
func (_static *CompanionStruct_Default___) SenderKeyDescriptions() _dafny.Set {
	return func() _dafny.Set {
		var _coll0 = _dafny.NewBuilder()
		_ = _coll0
		for _iter53 := _dafny.Iterate((Companion_Default___.EcdhCurveNames()).Elements()); ; {
			_compr_0, _ok53 := _iter53()
			if !_ok53 {
				break
			}
			var _0_key _dafny.Sequence
...
func (_static *CompanionStruct_Default___) RecipientKeyDescriptions() _dafny.Set {
	return func() _dafny.Set {
		var _coll0 = _dafny.NewBuilder()
		_ = _coll0
		for _iter54 := _dafny.Iterate((Companion_Default___.EcdhCurveNames()).Elements()); ; {
			_compr_0, _ok54 := _iter54()
			if !_ok54 {
				break
			}
			var _0_key _dafny.Sequence
...
func (_static *CompanionStruct_Default___) EphemeralDiscoveryTests() _dafny.Set {
	return func() _dafny.Set {
		var _coll0 = _dafny.NewBuilder()
		_ = _coll0
		for _iter55 := _dafny.Iterate((Companion_Default___.EphemeralKeyDescriptionsEncrypt()).Elements()); ; {
			_compr_0, _ok55 := _iter55()
			if !_ok55 {
				break
			}
			...
			if (Companion_Default___.EphemeralKeyDescriptionsEncrypt()).Contains(_0_encryptKeyDescription) {
				for _iter56 := _dafny.Iterate((Companion_Default___.DiscoveryKeyDescriptionsDecrypt()).Elements()); ; {
					_compr_1, _ok56 := _iter56()
					if !_ok56 {
						break
					}
					...
					if ((Companion_Default___.DiscoveryKeyDescriptionsDecrypt()).Contains(_1_decryptKeyDescription)) && (_dafny.Companion_Sequence_.Equal(((_1_decryptKeyDescription).Dtor_ECDH()).Dtor_curveSpec(), ((_0_encryptKeyDescription).Dtor_ECDH()).Dtor_curveSpec())) {
						for _iter57 := _dafny.Iterate((m_AllAlgorithmSuites.Companion_Default___.AllAlgorithmSuites()).Elements()); ; {
							_compr_2, _ok57 := _iter57()
							if !_ok57 {
								break
							}
							...
							if (m_AllAlgorithmSuites.Companion_Default___.AllAlgorithmSuites()).Contains(_2_algorithmSuite) {
								for _iter58 := _dafny.Iterate(_dafny.SingleValue(m_AllAlgorithmSuites.Companion_Default___.GetCompatibleCommitmentPolicy(_2_algorithmSuite))); ; {
									_compr_3, _ok58 := _iter58()
									if !_ok58 {
										break
									}
...
func (_static *CompanionStruct_Default___) StaticSenderDiscoveryRecipientTests() _dafny.Set {
	return func() _dafny.Set {
		var _coll0 = _dafny.NewBuilder()
		_ = _coll0
		for _iter59 := _dafny.Iterate((Companion_Default___.SenderKeyDescriptions()).Elements()); ; {
			_compr_0, _ok59 := _iter59()
			if !_ok59 {
				break
			}
			var _0_encryptKeyDescription m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription
			...
			if (Companion_Default___.SenderKeyDescriptions()).Contains(_0_encryptKeyDescription) {
				for _iter60 := _dafny.Iterate((Companion_Default___.DiscoveryKeyDescriptionsDecrypt()).Elements()); ; {
					_compr_1, _ok60 := _iter60()
					if !_ok60 {
						break
					}
					var _1_decryptKeyDescription m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription
					_1_decryptKeyDescription = interface{}(_compr_1).(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription)
					if ((Companion_Default___.DiscoveryKeyDescriptionsDecrypt()).Contains(_1_decryptKeyDescription)) && (_dafny.Companion_Sequence_.Equal(((_1_decryptKeyDescription).Dtor_ECDH()).Dtor_curveSpec(), ((_0_encryptKeyDescription).Dtor_ECDH()).Dtor_curveSpec())) {
						for _iter61 := _dafny.Iterate((m_AllAlgorithmSuites.Companion_Default___.AllAlgorithmSuites()).Elements()); ; {
							_compr_2, _ok61 := _iter61()
							if !_ok61 {
								break
							}
							var _2_algorithmSuite m_AwsCryptographyMaterialProvidersTypes.AlgorithmSuiteInfo
							_2_algorithmSuite = interface{}(_compr_2).(m_AwsCryptographyMaterialProvidersTypes.AlgorithmSuiteInfo)
							if (m_AllAlgorithmSuites.Companion_Default___.AllAlgorithmSuites()).Contains(_2_algorithmSuite) {
								for _iter62 := _dafny.Iterate(_dafny.SingleValue(m_AllAlgorithmSuites.Companion_Default___.GetCompatibleCommitmentPolicy(_2_algorithmSuite))); ; {
									_compr_3, _ok62 := _iter62()
									if !_ok62 {
										break
									}
									var _3_commitmentPolicy m_AwsCryptographyMaterialProvidersTypes.CommitmentPolicy
...
func (_static *CompanionStruct_Default___) StaticSenderRecipientTests() _dafny.Set {
	return func() _dafny.Set {
		var _coll0 = _dafny.NewBuilder()
		_ = _coll0
		for _iter63 := _dafny.Iterate((Companion_Default___.SenderKeyDescriptions()).Elements()); ; {
			...
			_0_encryptKeyDescription = interface{}(_compr_0).(m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription)
			if (Companion_Default___.SenderKeyDescriptions()).Contains(_0_encryptKeyDescription) {
				for _iter64 := _dafny.Iterate((Companion_Default___.RecipientKeyDescriptions()).Elements()); ; {
					_compr_1, _ok64 := _iter64()
					if !_ok64 {
						break
					}
					var _1_decryptKeyDescription m_AwsCryptographyMaterialProvidersTestVectorKeysTypes.KeyDescription
					...
					if ((Companion_Default___.RecipientKeyDescriptions()).Contains(_1_decryptKeyDescription)) && (_dafny.Companion_Sequence_.Equal(((_1_decryptKeyDescription).Dtor_ECDH()).Dtor_curveSpec(), ((_0_encryptKeyDescription).Dtor_ECDH()).Dtor_curveSpec())) {
						for _iter65 := _dafny.Iterate((m_AllAlgorithmSuites.Companion_Default___.AllAlgorithmSuites()).Elements()); ; {
							...
							_2_algorithmSuite = interface{}(_compr_2).(m_AwsCryptographyMaterialProvidersTypes.AlgorithmSuiteInfo)
							if (m_AllAlgorithmSuites.Companion_Default___.AllAlgorithmSuites()).Contains(_2_algorithmSuite) {
								for _iter66 := _dafny.Iterate(_dafny.SingleValue(m_AllAlgorithmSuites.Companion_Default___.GetCompatibleCommitmentPolicy(_2_algorithmSuite))); ; {
									_compr_3, _ok66 := _iter66()
									if !_ok66 {
										break
									}
									var _3_commitmentPolicy m_AwsCryptographyMaterialProvidersTypes.CommitmentPolicy
