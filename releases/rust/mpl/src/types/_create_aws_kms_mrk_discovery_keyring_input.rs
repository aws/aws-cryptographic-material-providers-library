...
impl CreateAwsKmsMrkDiscoveryKeyringInput {
    /// Creates a new builder-style object to manufacture [`CreateAwsKmsMrkDiscoveryKeyringInput`](crate::types::CreateAwsKmsMrkDiscoveryKeyringInput).
    pub fn builder() -> crate::types::builders::CreateAwsKmsMrkDiscoveryKeyringInputBuilder {
        crate::types::builders::CreateAwsKmsMrkDiscoveryKeyringInputBuilder::default()
    }
}

/// A builder for [`CreateAwsKmsMrkDiscoveryKeyringInput`](crate::types::CreateAwsKmsMrkDiscoveryKeyringInput).
#[non_exhaustive]
#[derive(
...
impl CreateAwsKmsMrkDiscoveryKeyringInputBuilder {
    ...
    /// Consumes the builder and constructs a [`CreateAwsKmsMrkDiscoveryKeyringInput`](crate::types::CreateAwsKmsMrkDiscoveryKeyringInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::types::CreateAwsKmsMrkDiscoveryKeyringInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::types::CreateAwsKmsMrkDiscoveryKeyringInput {
