...
impl DiscoveryFilter {
    /// Creates a new builder-style object to manufacture [`DiscoveryFilter`](crate::types::DiscoveryFilter).
    pub fn builder() -> crate::types::builders::DiscoveryFilterBuilder {
        crate::types::builders::DiscoveryFilterBuilder::default()
    }
}

/// A builder for [`DiscoveryFilter`](crate::types::DiscoveryFilter).
#[non_exhaustive]
#[derive(
...
impl DiscoveryFilterBuilder {
    ...
    /// Consumes the builder and constructs a [`DiscoveryFilter`](crate::types::DiscoveryFilter).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::types::DiscoveryFilter,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::types::DiscoveryFilter {
