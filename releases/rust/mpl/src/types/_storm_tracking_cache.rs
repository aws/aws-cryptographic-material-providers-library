...
pub struct StormTrackingCache {
    ...
    pub time_units: ::std::option::Option<crate::types::TimeUnits>,
}
impl StormTrackingCache {
    ...
    ///   The default is seconds.
    ///   If this is set to milliseconds, then these values will be treated as milliseconds.
    pub fn time_units(&self) -> &::std::option::Option<crate::types::TimeUnits> {
        &self.time_units
    }
}
impl StormTrackingCache {
    /// Creates a new builder-style object to manufacture [`StormTrackingCache`](crate::types::StormTrackingCache).
    pub fn builder() -> crate::types::builders::StormTrackingCacheBuilder {
        crate::types::builders::StormTrackingCacheBuilder::default()
    }
}

/// A builder for [`StormTrackingCache`](crate::types::StormTrackingCache).
#[non_exhaustive]
#[derive(
...
pub struct StormTrackingCacheBuilder {
    ...
    pub(crate) time_units: ::std::option::Option<crate::types::TimeUnits>,
}
impl StormTrackingCacheBuilder {
    ...
    /// Number of entries to prune at a time.
    pub fn entry_pruning_tail_size(
        mut self,
        input: impl ::std::convert::Into<::std::primitive::i32>,
    ) -> Self {
    ...
    /// Number of entries to prune at a time.
    pub fn set_entry_pruning_tail_size(
        mut self,
        input: ::std::option::Option<::std::primitive::i32>,
    ) -> Self {
    ...
    ///   The default is seconds.
    ///   If this is set to milliseconds, then these values will be treated as milliseconds.
    pub fn time_units(mut self, input: impl ::std::convert::Into<crate::types::TimeUnits>) -> Self {
    ...
    ///   The default is seconds.
    ///   If this is set to milliseconds, then these values will be treated as milliseconds.
    pub fn set_time_units(mut self, input: ::std::option::Option<crate::types::TimeUnits>) -> Self {
    ...
    ///   The default is seconds.
    ///   If this is set to milliseconds, then these values will be treated as milliseconds.
    pub fn get_time_units(&self) -> &::std::option::Option<crate::types::TimeUnits> {
        &self.time_units
    }
    /// Consumes the builder and constructs a [`StormTrackingCache`](crate::types::StormTrackingCache).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::types::StormTrackingCache,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::types::StormTrackingCache {
