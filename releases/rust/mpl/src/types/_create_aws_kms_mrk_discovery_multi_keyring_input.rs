...
impl CreateAwsKmsMrkDiscoveryMultiKeyringInput {
    ...
    pub fn client_supplier(
        &self,
    ) -> &::std::option::Option<crate::types::client_supplier::ClientSupplierRef> {
...
impl CreateAwsKmsMrkDiscoveryMultiKeyringInput {
    /// Creates a new builder-style object to manufacture [`CreateAwsKmsMrkDiscoveryMultiKeyringInput`](crate::types::CreateAwsKmsMrkDiscoveryMultiKeyringInput).
    pub fn builder() -> crate::types::builders::CreateAwsKmsMrkDiscoveryMultiKeyringInputBuilder {
        crate::types::builders::CreateAwsKmsMrkDiscoveryMultiKeyringInputBuilder::default()
    }
}

/// A builder for [`CreateAwsKmsMrkDiscoveryMultiKeyringInput`](crate::types::CreateAwsKmsMrkDiscoveryMultiKeyringInput).
#[non_exhaustive]
#[derive(
    ::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug,
)]
pub struct CreateAwsKmsMrkDiscoveryMultiKeyringInputBuilder {
    pub(crate) client_supplier:
        ::std::option::Option<crate::types::client_supplier::ClientSupplierRef>,
...
impl CreateAwsKmsMrkDiscoveryMultiKeyringInputBuilder {
    ...
    pub fn client_supplier(
        mut self,
        input: impl ::std::convert::Into<crate::types::client_supplier::ClientSupplierRef>,
    ) -> Self {
    ...
    pub fn discovery_filter(
        mut self,
        input: impl ::std::convert::Into<crate::types::DiscoveryFilter>,
    ) -> Self {
    ...
    /// Consumes the builder and constructs a [`CreateAwsKmsMrkDiscoveryMultiKeyringInput`](crate::types::CreateAwsKmsMrkDiscoveryMultiKeyringInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::types::CreateAwsKmsMrkDiscoveryMultiKeyringInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::types::CreateAwsKmsMrkDiscoveryMultiKeyringInput {
