...
impl GetBranchKeyIdOutput {
    /// Creates a new builder-style object to manufacture [`GetBranchKeyIdOutput`](crate::types::GetBranchKeyIdOutput).
    pub fn builder() -> crate::types::builders::GetBranchKeyIdOutputBuilder {
        crate::types::builders::GetBranchKeyIdOutputBuilder::default()
    }
}

/// A builder for [`GetBranchKeyIdOutput`](crate::types::GetBranchKeyIdOutput).
#[non_exhaustive]
#[derive(
...
impl GetBranchKeyIdOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`GetBranchKeyIdOutput`](crate::types::GetBranchKeyIdOutput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::types::GetBranchKeyIdOutput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::types::GetBranchKeyIdOutput {
