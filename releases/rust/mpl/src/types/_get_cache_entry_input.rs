...
impl GetCacheEntryInput {
    /// Creates a new builder-style object to manufacture [`GetCacheEntryInput`](crate::types::GetCacheEntryInput).
    pub fn builder() -> crate::types::builders::GetCacheEntryInputBuilder {
        crate::types::builders::GetCacheEntryInputBuilder::default()
    }
}

/// A builder for [`GetCacheEntryInput`](crate::types::GetCacheEntryInput).
#[non_exhaustive]
#[derive(
...
impl GetCacheEntryInputBuilder {
    ...
    /// Consumes the builder and constructs a [`GetCacheEntryInput`](crate::types::GetCacheEntryInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::types::GetCacheEntryInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::types::GetCacheEntryInput {
