...
impl CreateAwsKmsRsaKeyringInput {
    ...
    pub fn encryption_algorithm(
        &self,
    ) -> &::std::option::Option<aws_sdk_kms::types::EncryptionAlgorithmSpec> {
...
impl CreateAwsKmsRsaKeyringInput {
    /// Creates a new builder-style object to manufacture [`CreateAwsKmsRsaKeyringInput`](crate::types::CreateAwsKmsRsaKeyringInput).
    pub fn builder() -> crate::types::builders::CreateAwsKmsRsaKeyringInputBuilder {
        crate::types::builders::CreateAwsKmsRsaKeyringInputBuilder::default()
    }
}

/// A builder for [`CreateAwsKmsRsaKeyringInput`](crate::types::CreateAwsKmsRsaKeyringInput).
#[non_exhaustive]
#[derive(
    ::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug,
)]
pub struct CreateAwsKmsRsaKeyringInputBuilder {
    pub(crate) encryption_algorithm:
        ::std::option::Option<aws_sdk_kms::types::EncryptionAlgorithmSpec>,
...
impl CreateAwsKmsRsaKeyringInputBuilder {
    ...
    pub fn encryption_algorithm(
        mut self,
        input: impl ::std::convert::Into<aws_sdk_kms::types::EncryptionAlgorithmSpec>,
    ) -> Self {
    ...
    /// Consumes the builder and constructs a [`CreateAwsKmsRsaKeyringInput`](crate::types::CreateAwsKmsRsaKeyringInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::types::CreateAwsKmsRsaKeyringInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::types::CreateAwsKmsRsaKeyringInput {
