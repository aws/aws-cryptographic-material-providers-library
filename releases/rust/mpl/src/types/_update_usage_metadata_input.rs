...
impl UpdateUsageMetadataInput {
    /// Creates a new builder-style object to manufacture [`UpdateUsageMetadataInput`](crate::types::UpdateUsageMetadataInput).
    pub fn builder() -> crate::types::builders::UpdateUsageMetadataInputBuilder {
        crate::types::builders::UpdateUsageMetadataInputBuilder::default()
    }
}

/// A builder for [`UpdateUsageMetadataInput`](crate::types::UpdateUsageMetadataInput).
#[non_exhaustive]
#[derive(
...
impl UpdateUsageMetadataInputBuilder {
    ...
    /// Consumes the builder and constructs a [`UpdateUsageMetadataInput`](crate::types::UpdateUsageMetadataInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::types::UpdateUsageMetadataInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::types::UpdateUsageMetadataInput {
