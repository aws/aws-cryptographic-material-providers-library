...
impl EncryptedDataKey {
    /// Creates a new builder-style object to manufacture [`EncryptedDataKey`](crate::types::EncryptedDataKey).
    pub fn builder() -> crate::types::builders::EncryptedDataKeyBuilder {
        crate::types::builders::EncryptedDataKeyBuilder::default()
    }
}

/// A builder for [`EncryptedDataKey`](crate::types::EncryptedDataKey).
#[non_exhaustive]
#[derive(
...
impl EncryptedDataKeyBuilder {
    ...
    /// Consumes the builder and constructs a [`EncryptedDataKey`](crate::types::EncryptedDataKey).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::types::EncryptedDataKey,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::types::EncryptedDataKey {
