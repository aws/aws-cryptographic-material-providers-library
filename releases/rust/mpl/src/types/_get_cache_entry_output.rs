...
pub struct GetCacheEntryOutput {
    ...
    #[allow(missing_docs)]
    pub materials: ::std::option::Option<crate::types::Materials>,
    #[allow(missing_docs)]
...
impl GetCacheEntryOutput {
    ...
    #[allow(missing_docs)]
    pub fn materials(&self) -> &::std::option::Option<crate::types::Materials> {
        &self.materials
    }
    #[allow(missing_docs)]
...
impl GetCacheEntryOutput {
    /// Creates a new builder-style object to manufacture [`GetCacheEntryOutput`](crate::types::GetCacheEntryOutput).
    pub fn builder() -> crate::types::builders::GetCacheEntryOutputBuilder {
        crate::types::builders::GetCacheEntryOutputBuilder::default()
    }
}

/// A builder for [`GetCacheEntryOutput`](crate::types::GetCacheEntryOutput).
#[non_exhaustive]
#[derive(
...
pub struct GetCacheEntryOutputBuilder {
    ...
    pub(crate) materials: ::std::option::Option<crate::types::Materials>,
...
impl GetCacheEntryOutputBuilder {
    ...
    #[allow(missing_docs)]
    pub fn materials(mut self, input: impl ::std::convert::Into<crate::types::Materials>) -> Self {
        self.materials = ::std::option::Option::Some(input.into());
        self
    }
    #[allow(missing_docs)]
    pub fn set_materials(mut self, input: ::std::option::Option<crate::types::Materials>) -> Self {
        self.materials = input;
        self
    }
    #[allow(missing_docs)]
    pub fn get_materials(&self) -> &::std::option::Option<crate::types::Materials> {
        &self.materials
    }
    #[allow(missing_docs)]
    ...
    /// Consumes the builder and constructs a [`GetCacheEntryOutput`](crate::types::GetCacheEntryOutput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::types::GetCacheEntryOutput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::types::GetCacheEntryOutput {
