...
impl EphemeralPrivateKeyToStaticPublicKeyInput {
    /// Creates a new builder-style object to manufacture [`EphemeralPrivateKeyToStaticPublicKeyInput`](crate::types::EphemeralPrivateKeyToStaticPublicKeyInput).
    pub fn builder() -> crate::types::builders::EphemeralPrivateKeyToStaticPublicKeyInputBuilder {
        crate::types::builders::EphemeralPrivateKeyToStaticPublicKeyInputBuilder::default()
    }
}

/// A builder for [`EphemeralPrivateKeyToStaticPublicKeyInput`](crate::types::EphemeralPrivateKeyToStaticPublicKeyInput).
#[non_exhaustive]
#[derive(
...
impl EphemeralPrivateKeyToStaticPublicKeyInputBuilder {
    ...
    /// Consumes the builder and constructs a [`EphemeralPrivateKeyToStaticPublicKeyInput`](crate::types::EphemeralPrivateKeyToStaticPublicKeyInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::types::EphemeralPrivateKeyToStaticPublicKeyInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::types::EphemeralPrivateKeyToStaticPublicKeyInput {
