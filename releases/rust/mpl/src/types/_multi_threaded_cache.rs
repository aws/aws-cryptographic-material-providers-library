...
impl MultiThreadedCache {
    /// Creates a new builder-style object to manufacture [`MultiThreadedCache`](crate::types::MultiThreadedCache).
    pub fn builder() -> crate::types::builders::MultiThreadedCacheBuilder {
        crate::types::builders::MultiThreadedCacheBuilder::default()
    }
}

/// A builder for [`MultiThreadedCache`](crate::types::MultiThreadedCache).
#[non_exhaustive]
#[derive(
...
impl MultiThreadedCacheBuilder {
    ...
    /// Consumes the builder and constructs a [`MultiThreadedCache`](crate::types::MultiThreadedCache).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::types::MultiThreadedCache,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::types::MultiThreadedCache {
