...
impl Hkdf {
    /// Creates a new builder-style object to manufacture [`Hkdf`](crate::types::Hkdf).
    pub fn builder() -> crate::types::builders::HkdfBuilder {
        crate::types::builders::HkdfBuilder::default()
    }
}

/// A builder for [`Hkdf`](crate::types::Hkdf).
#[non_exhaustive]
#[derive(
...
impl HkdfBuilder {
    ...
    /// Consumes the builder and constructs a [`Hkdf`](crate::types::Hkdf).
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::types::Hkdf, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(crate::types::Hkdf {
            hmac: self.hmac,
