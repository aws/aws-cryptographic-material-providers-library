...
impl CreateAwsKmsDiscoveryKeyringInput {
    /// Creates a new builder-style object to manufacture [`CreateAwsKmsDiscoveryKeyringInput`](crate::types::CreateAwsKmsDiscoveryKeyringInput).
    pub fn builder() -> crate::types::builders::CreateAwsKmsDiscoveryKeyringInputBuilder {
        crate::types::builders::CreateAwsKmsDiscoveryKeyringInputBuilder::default()
    }
}

/// A builder for [`CreateAwsKmsDiscoveryKeyringInput`](crate::types::CreateAwsKmsDiscoveryKeyringInput).
#[non_exhaustive]
#[derive(
...
impl CreateAwsKmsDiscoveryKeyringInputBuilder {
    ...
    /// Consumes the builder and constructs a [`CreateAwsKmsDiscoveryKeyringInput`](crate::types::CreateAwsKmsDiscoveryKeyringInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::types::CreateAwsKmsDiscoveryKeyringInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::types::CreateAwsKmsDiscoveryKeyringInput {
