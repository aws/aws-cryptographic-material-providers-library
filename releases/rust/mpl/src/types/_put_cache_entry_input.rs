...
impl PutCacheEntryInput {
    /// Creates a new builder-style object to manufacture [`PutCacheEntryInput`](crate::types::PutCacheEntryInput).
    pub fn builder() -> crate::types::builders::PutCacheEntryInputBuilder {
        crate::types::builders::PutCacheEntryInputBuilder::default()
    }
}

/// A builder for [`PutCacheEntryInput`](crate::types::PutCacheEntryInput).
#[non_exhaustive]
#[derive(
...
impl PutCacheEntryInputBuilder {
    ...
    /// Consumes the builder and constructs a [`PutCacheEntryInput`](crate::types::PutCacheEntryInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::types::PutCacheEntryInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::types::PutCacheEntryInput {
