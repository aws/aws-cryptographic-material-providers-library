...
impl crate::types::cryptographic_materials_manager::CryptographicMaterialsManagerRef {
    ...
    ///   - [`algorithm_suite_id(impl Into<Option<crate::types::AlgorithmSuiteId>>)`](crate::operation::get_encryption_materials::builders::GetEncryptionMaterialsFluentBuilder::algorithm_suite_id) / [`set_algorithm_suite_id(Option<crate::types::AlgorithmSuiteId>)`](crate::operation::get_encryption_materials::builders::GetEncryptionMaterialsFluentBuilder::set_algorithm_suite_id): (undocumented)<br>
    ///   - [`commitment_policy(impl Into<Option<crate::types::CommitmentPolicy>>)`](crate::operation::get_encryption_materials::builders::GetEncryptionMaterialsFluentBuilder::commitment_policy) / [`set_commitment_policy(Option<crate::types::CommitmentPolicy>)`](crate::operation::get_encryption_materials::builders::GetEncryptionMaterialsFluentBuilder::set_commitment_policy): (undocumented)<br>
    ...
    ///   - [`encryption_materials(Option<crate::types::EncryptionMaterials>)`](crate::operation::get_encryption_materials::GetEncryptionMaterialsOutput::encryption_materials): (undocumented)
    ...
    pub fn get_encryption_materials(
        &self,
    ) -> crate::operation::get_encryption_materials::builders::GetEncryptionMaterialsFluentBuilder
    {
