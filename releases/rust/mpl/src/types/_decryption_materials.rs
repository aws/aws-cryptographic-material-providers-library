...
impl DecryptionMaterials {
    /// Creates a new builder-style object to manufacture [`DecryptionMaterials`](crate::types::DecryptionMaterials).
    pub fn builder() -> crate::types::builders::DecryptionMaterialsBuilder {
        crate::types::builders::DecryptionMaterialsBuilder::default()
    }
}

/// A builder for [`DecryptionMaterials`](crate::types::DecryptionMaterials).
#[non_exhaustive]
#[derive(
...
impl DecryptionMaterialsBuilder {
    ...
    /// Consumes the builder and constructs a [`DecryptionMaterials`](crate::types::DecryptionMaterials).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::types::DecryptionMaterials,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::types::DecryptionMaterials {
