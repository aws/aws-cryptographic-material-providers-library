...
impl CreateAwsKmsKeyringInput {
    /// Creates a new builder-style object to manufacture [`CreateAwsKmsKeyringInput`](crate::types::CreateAwsKmsKeyringInput).
    pub fn builder() -> crate::types::builders::CreateAwsKmsKeyringInputBuilder {
        crate::types::builders::CreateAwsKmsKeyringInputBuilder::default()
    }
}

/// A builder for [`CreateAwsKmsKeyringInput`](crate::types::CreateAwsKmsKeyringInput).
#[non_exhaustive]
#[derive(
...
impl CreateAwsKmsKeyringInputBuilder {
    ...
    /// Consumes the builder and constructs a [`CreateAwsKmsKeyringInput`](crate::types::CreateAwsKmsKeyringInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::types::CreateAwsKmsKeyringInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::types::CreateAwsKmsKeyringInput {
