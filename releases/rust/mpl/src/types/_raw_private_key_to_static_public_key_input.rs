...
impl RawPrivateKeyToStaticPublicKeyInput {
    /// Creates a new builder-style object to manufacture [`RawPrivateKeyToStaticPublicKeyInput`](crate::types::RawPrivateKeyToStaticPublicKeyInput).
    pub fn builder() -> crate::types::builders::RawPrivateKeyToStaticPublicKeyInputBuilder {
        crate::types::builders::RawPrivateKeyToStaticPublicKeyInputBuilder::default()
    }
}

/// A builder for [`RawPrivateKeyToStaticPublicKeyInput`](crate::types::RawPrivateKeyToStaticPublicKeyInput).
#[non_exhaustive]
#[derive(
...
impl RawPrivateKeyToStaticPublicKeyInputBuilder {
    ...
    /// The recipient's public key. MUST be DER encoded.
    pub fn set_recipient_public_key(
        mut self,
    ...
    /// The sender's private key. MUST be PEM encoded.
    pub fn sender_static_private_key(
        mut self,
        input: impl ::std::convert::Into<::aws_smithy_types::Blob>,
    ) -> Self {
    ...
    /// The sender's private key. MUST be PEM encoded.
    pub fn set_sender_static_private_key(
        mut self,
        input: ::std::option::Option<::aws_smithy_types::Blob>,
    ) -> Self {
    ...
    /// The sender's private key. MUST be PEM encoded.
    pub fn get_sender_static_private_key(
        &self,
    ) -> &::std::option::Option<::aws_smithy_types::Blob> {
        &self.sender_static_private_key
    }
    /// Consumes the builder and constructs a [`RawPrivateKeyToStaticPublicKeyInput`](crate::types::RawPrivateKeyToStaticPublicKeyInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::types::RawPrivateKeyToStaticPublicKeyInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::types::RawPrivateKeyToStaticPublicKeyInput {
