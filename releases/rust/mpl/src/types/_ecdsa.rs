...
pub struct EcdsaBuilder {
    pub(crate) curve: ::std::option::Option<
        crate::deps::aws_cryptography_primitives::types::EcdsaSignatureAlgorithm,
    >,
}
impl EcdsaBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::types::Ecdsa, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(crate::types::Ecdsa { curve: self.curve })
    }
}
