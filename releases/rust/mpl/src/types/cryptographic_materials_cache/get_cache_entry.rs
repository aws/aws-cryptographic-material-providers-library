...
impl crate::types::cryptographic_materials_cache::CryptographicMaterialsCacheRef {
    ...
    ///   - [`materials(Option<crate::types::Materials>)`](crate::operation::get_cache_entry::GetCacheEntryOutput::materials): (undocumented)
    ...
    pub fn get_cache_entry(
        &self,
    ) -> crate::operation::get_cache_entry::builders::GetCacheEntryFluentBuilder {
