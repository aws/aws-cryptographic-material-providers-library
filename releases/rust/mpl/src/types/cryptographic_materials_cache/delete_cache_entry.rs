...
impl crate::types::cryptographic_materials_cache::CryptographicMaterialsCacheRef {
    ...
    pub fn delete_cache_entry(
        &self,
    ) -> crate::operation::delete_cache_entry::builders::DeleteCacheEntryFluentBuilder {
        crate::operation::delete_cache_entry::builders::DeleteCacheEntryFluentBuilder::new(
            self.clone(),
        )
    }
}
