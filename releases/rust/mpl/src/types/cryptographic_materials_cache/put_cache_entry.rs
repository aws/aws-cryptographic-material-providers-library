...
impl crate::types::cryptographic_materials_cache::CryptographicMaterialsCacheRef {
    ...
    ///   - [`materials(impl Into<Option<crate::types::Materials>>)`](crate::operation::put_cache_entry::builders::PutCacheEntryFluentBuilder::materials) / [`set_materials(Option<crate::types::Materials>)`](crate::operation::put_cache_entry::builders::PutCacheEntryFluentBuilder::set_materials): (undocumented)<br>
    ...
    pub fn put_cache_entry(
        &self,
    ) -> crate::operation::put_cache_entry::builders::PutCacheEntryFluentBuilder {
