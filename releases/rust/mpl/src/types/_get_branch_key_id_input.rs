...
impl GetBranchKeyIdInput {
    /// Creates a new builder-style object to manufacture [`GetBranchKeyIdInput`](crate::types::GetBranchKeyIdInput).
    pub fn builder() -> crate::types::builders::GetBranchKeyIdInputBuilder {
        crate::types::builders::GetBranchKeyIdInputBuilder::default()
    }
}

/// A builder for [`GetBranchKeyIdInput`](crate::types::GetBranchKeyIdInput).
#[non_exhaustive]
#[derive(
...
impl GetBranchKeyIdInputBuilder {
    ...
    /// Consumes the builder and constructs a [`GetBranchKeyIdInput`](crate::types::GetBranchKeyIdInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::types::GetBranchKeyIdInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::types::GetBranchKeyIdInput {
