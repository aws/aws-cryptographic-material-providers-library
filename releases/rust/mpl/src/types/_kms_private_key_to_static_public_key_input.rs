...
impl KmsPrivateKeyToStaticPublicKeyInput {
    /// Creates a new builder-style object to manufacture [`KmsPrivateKeyToStaticPublicKeyInput`](crate::types::KmsPrivateKeyToStaticPublicKeyInput).
    pub fn builder() -> crate::types::builders::KmsPrivateKeyToStaticPublicKeyInputBuilder {
        crate::types::builders::KmsPrivateKeyToStaticPublicKeyInputBuilder::default()
    }
}

/// A builder for [`KmsPrivateKeyToStaticPublicKeyInput`](crate::types::KmsPrivateKeyToStaticPublicKeyInput).
#[non_exhaustive]
#[derive(
...
impl KmsPrivateKeyToStaticPublicKeyInputBuilder {
    ...
    /// AWS KMS Key Identifier belonging to the sender.
    pub fn set_sender_kms_identifier(
        mut self,
    ...
    /// Consumes the builder and constructs a [`KmsPrivateKeyToStaticPublicKeyInput`](crate::types::KmsPrivateKeyToStaticPublicKeyInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::types::KmsPrivateKeyToStaticPublicKeyInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::types::KmsPrivateKeyToStaticPublicKeyInput {
