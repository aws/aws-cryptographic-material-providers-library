...
impl KmsPublicKeyDiscoveryInput {
    /// Creates a new builder-style object to manufacture [`KmsPublicKeyDiscoveryInput`](crate::types::KmsPublicKeyDiscoveryInput).
    pub fn builder() -> crate::types::builders::KmsPublicKeyDiscoveryInputBuilder {
        crate::types::builders::KmsPublicKeyDiscoveryInputBuilder::default()
    }
}

/// A builder for [`KmsPublicKeyDiscoveryInput`](crate::types::KmsPublicKeyDiscoveryInput).
#[non_exhaustive]
#[derive(
...
impl KmsPublicKeyDiscoveryInputBuilder {
    ...
    /// Consumes the builder and constructs a [`KmsPublicKeyDiscoveryInput`](crate::types::KmsPublicKeyDiscoveryInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::types::KmsPublicKeyDiscoveryInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::types::KmsPublicKeyDiscoveryInput {
