...
impl CreateAwsKmsMrkKeyringInput {
    /// Creates a new builder-style object to manufacture [`CreateAwsKmsMrkKeyringInput`](crate::types::CreateAwsKmsMrkKeyringInput).
    pub fn builder() -> crate::types::builders::CreateAwsKmsMrkKeyringInputBuilder {
        crate::types::builders::CreateAwsKmsMrkKeyringInputBuilder::default()
    }
}

/// A builder for [`CreateAwsKmsMrkKeyringInput`](crate::types::CreateAwsKmsMrkKeyringInput).
#[non_exhaustive]
#[derive(
...
impl CreateAwsKmsMrkKeyringInputBuilder {
    ...
    /// Consumes the builder and constructs a [`CreateAwsKmsMrkKeyringInput`](crate::types::CreateAwsKmsMrkKeyringInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::types::CreateAwsKmsMrkKeyringInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::types::CreateAwsKmsMrkKeyringInput {
