...
pub struct CreateRequiredEncryptionContextCmmInput {
    ...
    pub underlying_cmm: ::std::option::Option<
...
pub struct CreateRequiredEncryptionContextCmmInputBuilder {
    ...
    pub(crate) required_encryption_context_keys:
        ::std::option::Option<::std::vec::Vec<::std::string::String>>,
    pub(crate) underlying_cmm: ::std::option::Option<
        crate::types::cryptographic_materials_manager::CryptographicMaterialsManagerRef,
    >,
}
impl CreateRequiredEncryptionContextCmmInputBuilder {
    ...
    pub fn keyring(
        mut self,
        input: impl ::std::convert::Into<crate::types::keyring::KeyringRef>,
    ) -> Self {
