...
impl PublicKeyDiscoveryInput {
    /// Creates a new builder-style object to manufacture [`PublicKeyDiscoveryInput`](crate::types::PublicKeyDiscoveryInput).
    pub fn builder() -> crate::types::builders::PublicKeyDiscoveryInputBuilder {
        crate::types::builders::PublicKeyDiscoveryInputBuilder::default()
    }
}

/// A builder for [`PublicKeyDiscoveryInput`](crate::types::PublicKeyDiscoveryInput).
#[non_exhaustive]
#[derive(
...
impl PublicKeyDiscoveryInputBuilder {
    ...
    /// Consumes the builder and constructs a [`PublicKeyDiscoveryInput`](crate::types::PublicKeyDiscoveryInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::types::PublicKeyDiscoveryInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::types::PublicKeyDiscoveryInput {
