...
> {
    ::dafny_runtime::Rc::new(match value {
        crate::types::error::Error::AwsCryptographicMaterialProvidersException { message } =>
...
crate::types::error::Error::TrentServiceError { error } =>
...
crate::types::error::Error::KeyStoreError { error } =>
...
pub fn from_dafny(
    ...
    crate::types::error::Error::AwsCryptographicMaterialProvidersException {
...
crate::r#software::amazon::cryptography::materialproviders::internaldafny::types::Error::ComAmazonawsKms { ComAmazonawsKms } =>
    crate::types::error::Error::TrentServiceError {
...
crate::r#software::amazon::cryptography::materialproviders::internaldafny::types::Error::AwsCryptographyKeyStore { AwsCryptographyKeyStore } =>
    crate::types::error::Error::KeyStoreError {
