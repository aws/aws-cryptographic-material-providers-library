...
#[allow(dead_code)]
pub fn to_dafny(
    value: &crate::types::CreateAwsKmsMrkDiscoveryMultiKeyringInput,
) -> ::dafny_runtime::Rc<
...
,
 discoveryFilter: ::dafny_runtime::Rc::new(match &value.discovery_filter {
    Some(x) => crate::_Wrappers_Compile::Option::Some { value: crate::conversions::discovery_filter::to_dafny(&x.clone()) },
    None => crate::_Wrappers_Compile::Option::None { }
})
,
 clientSupplier: ::dafny_runtime::Rc::new(match &value.client_supplier {
    Some(x) => crate::_Wrappers_Compile::Option::Some { value: crate::conversions::client_supplier::to_dafny(&x.clone()) },
    None => crate::_Wrappers_Compile::Option::None { }
})
,
...
pub fn option_to_dafny(
  value: ::std::option::Option<crate::types::CreateAwsKmsMrkDiscoveryMultiKeyringInput>,
...
pub fn plain_from_dafny(
    ...
    match dafny_value {
        crate::r#software::amazon::cryptography::materialproviders::internaldafny::types::CreateAwsKmsMrkDiscoveryMultiKeyringInput::CreateAwsKmsMrkDiscoveryMultiKeyringInput {..} =>
            crate::types::CreateAwsKmsMrkDiscoveryMultiKeyringInput::builder()
 ...
 .set_discovery_filter(match (*dafny_value.discoveryFilter()).as_ref() {
    crate::r#_Wrappers_Compile::Option::Some { value } =>
        Some(crate::conversions::discovery_filter::from_dafny(value.clone())),
    _ => None,
}
)
 .set_client_supplier(match (*dafny_value.clientSupplier()).as_ref() {
    crate::r#_Wrappers_Compile::Option::Some { value } =>
        Some(crate::conversions::client_supplier::from_dafny(value.clone())),
    _ => None,
}
)
...
pub fn option_from_dafny(
    dafny_value: ::dafny_runtime::Rc<crate::_Wrappers_Compile::Option<::dafny_runtime::Rc<
        crate::r#software::amazon::cryptography::materialproviders::internaldafny::types::CreateAwsKmsMrkDiscoveryMultiKeyringInput,
    >>>,
) -> ::std::option::Option<crate::types::CreateAwsKmsMrkDiscoveryMultiKeyringInput> {
    match &*dafny_value {
