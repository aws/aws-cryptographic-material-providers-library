...
#[allow(dead_code)]
pub fn to_dafny(
    value: &crate::types::CreateMultiKeyringInput,
) -> ::dafny_runtime::Rc<
...
,
 childKeyrings: ::dafny_runtime::dafny_runtime_conversions::vec_to_dafny_sequence(&value.child_keyrings.clone().unwrap(),
    |e| crate::conversions::keyring::to_dafny(&e.clone())
,
)
,
    }
...
pub fn option_to_dafny(
  value: ::std::option::Option<crate::types::CreateMultiKeyringInput>,
...
pub fn plain_from_dafny(
    ...
    match dafny_value {
        crate::r#software::amazon::cryptography::materialproviders::internaldafny::types::CreateMultiKeyringInput::CreateMultiKeyringInput {..} =>
            crate::types::CreateMultiKeyringInput::builder()
 ...
 .set_child_keyrings(Some( ::dafny_runtime::dafny_runtime_conversions::dafny_sequence_to_vec(dafny_value.childKeyrings(),
    |e: &::dafny_runtime::Object<dyn crate::r#software::amazon::cryptography::materialproviders::internaldafny::types::IKeyring>| crate::conversions::keyring::from_dafny(e.clone())
,
)
 ))
                .build()
...
pub fn option_from_dafny(
    dafny_value: ::dafny_runtime::Rc<crate::_Wrappers_Compile::Option<::dafny_runtime::Rc<
        crate::r#software::amazon::cryptography::materialproviders::internaldafny::types::CreateMultiKeyringInput,
    >>>,
) -> ::std::option::Option<crate::types::CreateMultiKeyringInput> {
    match &*dafny_value {
