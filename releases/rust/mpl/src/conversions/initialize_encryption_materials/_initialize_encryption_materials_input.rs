...
>{
    ::dafny_runtime::Rc::new(crate::r#software::amazon::cryptography::materialproviders::internaldafny::types::InitializeEncryptionMaterialsInput::InitializeEncryptionMaterialsInput {
        algorithmSuiteId: crate::conversions::algorithm_suite_id::to_dafny(&value.algorithm_suite_id.clone().unwrap())
,
...
pub fn from_dafny(
    ...
    crate::operation::initialize_encryption_materials::InitializeEncryptionMaterialsInput::builder()
        .set_algorithm_suite_id(Some(crate::conversions::algorithm_suite_id::from_dafny(
            dafny_value.algorithmSuiteId().clone(),
        )))
        .set_encryption_context(Some(
            ::dafny_runtime::dafny_runtime_conversions::dafny_map_to_hashmap(
                &dafny_value.encryptionContext(),
                |k: &::dafny_runtime::dafny_runtime_conversions::DafnySequence<u8>| {
                    ::std::string::String::from_utf8(
                        dafny_runtime::dafny_runtime_conversions::dafny_sequence_to_vec(
                            &::std::borrow::Borrow::borrow(k),
                            |b| *b,
                        ),
                    )
                    .unwrap()
                },
                |v: &::dafny_runtime::dafny_runtime_conversions::DafnySequence<u8>| {
                    ::std::string::String::from_utf8(
                        dafny_runtime::dafny_runtime_conversions::dafny_sequence_to_vec(
                            &::std::borrow::Borrow::borrow(v),
                            |b| *b,
                        ),
                    )
                    .unwrap()
        ...
        .set_required_encryption_context_keys(Some(
            ::dafny_runtime::dafny_runtime_conversions::dafny_sequence_to_vec(
                dafny_value.requiredEncryptionContextKeys(),
                |e: &::dafny_runtime::dafny_runtime_conversions::DafnySequence<u8>| {
                    ::std::string::String::from_utf8(
                        dafny_runtime::dafny_runtime_conversions::dafny_sequence_to_vec(
                            &::std::borrow::Borrow::borrow(e),
                            |b| *b,
                        ),
                    )
                    .unwrap()
        ...
        .set_signing_key(crate::standard_library_conversions::oblob_from_dafny(
            dafny_value.signingKey().clone(),
        ))
        .set_verification_key(crate::standard_library_conversions::oblob_from_dafny(
            dafny_value.verificationKey().clone(),
        ))
        .build()
        .unwrap()
}
