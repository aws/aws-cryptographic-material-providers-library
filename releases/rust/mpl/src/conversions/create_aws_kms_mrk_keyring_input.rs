...
#[allow(dead_code)]
pub fn to_dafny(
    value: &crate::types::CreateAwsKmsMrkKeyringInput,
) -> ::dafny_runtime::Rc<
...
pub fn option_to_dafny(
  value: ::std::option::Option<crate::types::CreateAwsKmsMrkKeyringInput>,
...
pub fn plain_from_dafny(
    ...
    match dafny_value {
        crate::r#software::amazon::cryptography::materialproviders::internaldafny::types::CreateAwsKmsMrkKeyringInput::CreateAwsKmsMrkKeyringInput {..} =>
            crate::types::CreateAwsKmsMrkKeyringInput::builder()
...
pub fn option_from_dafny(
    dafny_value: ::dafny_runtime::Rc<crate::_Wrappers_Compile::Option<::dafny_runtime::Rc<
        crate::r#software::amazon::cryptography::materialproviders::internaldafny::types::CreateAwsKmsMrkKeyringInput,
    >>>,
) -> ::std::option::Option<crate::types::CreateAwsKmsMrkKeyringInput> {
    match &*dafny_value {
