...
#[allow(dead_code)]
pub fn to_dafny(
    value: &crate::types::GetCacheEntryOutput,
) -> ::dafny_runtime::Rc<
...
pub fn option_to_dafny(
  value: ::std::option::Option<crate::types::GetCacheEntryOutput>,
...
pub fn plain_from_dafny(
    ...
    match dafny_value {
        crate::r#software::amazon::cryptography::materialproviders::internaldafny::types::GetCacheEntryOutput::GetCacheEntryOutput {..} =>
            crate::types::GetCacheEntryOutput::builder()
                .set_materials(Some( crate::conversions::materials::from_dafny(dafny_value.materials().clone())
 ))
...
pub fn option_from_dafny(
    dafny_value: ::dafny_runtime::Rc<crate::_Wrappers_Compile::Option<::dafny_runtime::Rc<
        crate::r#software::amazon::cryptography::materialproviders::internaldafny::types::GetCacheEntryOutput,
    >>>,
) -> ::std::option::Option<crate::types::GetCacheEntryOutput> {
    match &*dafny_value {
