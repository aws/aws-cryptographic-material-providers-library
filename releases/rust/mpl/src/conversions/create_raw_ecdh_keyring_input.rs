...
#[allow(dead_code)]
pub fn to_dafny(
    value: &crate::types::CreateRawEcdhKeyringInput,
) -> ::dafny_runtime::Rc<
...
pub fn option_to_dafny(
  value: ::std::option::Option<crate::types::CreateRawEcdhKeyringInput>,
...
pub fn plain_from_dafny(
    ...
    match dafny_value {
        crate::r#software::amazon::cryptography::materialproviders::internaldafny::types::CreateRawEcdhKeyringInput::CreateRawEcdhKeyringInput {..} =>
            crate::types::CreateRawEcdhKeyringInput::builder()
                .set_key_agreement_scheme(Some( crate::conversions::raw_ecdh_static_configurations::from_dafny(dafny_value.KeyAgreementScheme().clone())
 ))
...
pub fn option_from_dafny(
    dafny_value: ::dafny_runtime::Rc<crate::_Wrappers_Compile::Option<::dafny_runtime::Rc<
        crate::r#software::amazon::cryptography::materialproviders::internaldafny::types::CreateRawEcdhKeyringInput,
    >>>,
) -> ::std::option::Option<crate::types::CreateRawEcdhKeyringInput> {
    match &*dafny_value {
