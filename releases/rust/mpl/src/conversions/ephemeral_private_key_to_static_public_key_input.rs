...
#[allow(dead_code)]
pub fn to_dafny(
    value: &crate::types::EphemeralPrivateKeyToStaticPublicKeyInput,
) -> ::dafny_runtime::Rc<
...
pub fn option_to_dafny(
  value: ::std::option::Option<crate::types::EphemeralPrivateKeyToStaticPublicKeyInput>,
...
pub fn plain_from_dafny(
    ...
    match dafny_value {
        crate::r#software::amazon::cryptography::materialproviders::internaldafny::types::EphemeralPrivateKeyToStaticPublicKeyInput::EphemeralPrivateKeyToStaticPublicKeyInput {..} =>
            crate::types::EphemeralPrivateKeyToStaticPublicKeyInput::builder()
...
pub fn option_from_dafny(
    dafny_value: ::dafny_runtime::Rc<crate::_Wrappers_Compile::Option<::dafny_runtime::Rc<
        crate::r#software::amazon::cryptography::materialproviders::internaldafny::types::EphemeralPrivateKeyToStaticPublicKeyInput,
    >>>,
) -> ::std::option::Option<crate::types::EphemeralPrivateKeyToStaticPublicKeyInput> {
    match &*dafny_value {
