...
>{
    ::dafny_runtime::Rc::new(crate::r#software::amazon::cryptography::materialproviders::internaldafny::types::OnEncryptOutput::OnEncryptOutput {
...
pub fn from_dafny(
    ...
    crate::operation::on_encrypt::OnEncryptOutput::builder()
        .set_materials(Some(crate::conversions::encryption_materials::from_dafny(
