...
#[allow(dead_code)]
pub fn to_dafny(
    value: &crate::types::StormTrackingCache,
) -> ::dafny_runtime::Rc<
...
pub fn to_dafny_plain(
 ...
 timeUnits: ::dafny_runtime::Rc::new(match &value.time_units {
    Some(x) => crate::_Wrappers_Compile::Option::Some { value: crate::conversions::time_units::to_dafny(x.clone()) },
...
pub fn option_to_dafny(
  value: ::std::option::Option<crate::types::StormTrackingCache>,
...
pub fn plain_from_dafny(
    ...
    match dafny_value {
        crate::r#software::amazon::cryptography::materialproviders::internaldafny::types::StormTrackingCache::StormTrackingCache {..} =>
            crate::types::StormTrackingCache::builder()
 ...
 .set_time_units(match &**dafny_value.timeUnits() {
    crate::r#_Wrappers_Compile::Option::Some { value } => Some(
        crate::conversions::time_units::from_dafny(value)
    ),
    _ => None,
}
)
...
pub fn option_from_dafny(
    dafny_value: ::dafny_runtime::Rc<crate::_Wrappers_Compile::Option<::dafny_runtime::Rc<
        crate::r#software::amazon::cryptography::materialproviders::internaldafny::types::StormTrackingCache,
    >>>,
) -> ::std::option::Option<crate::types::StormTrackingCache> {
    match &*dafny_value {
