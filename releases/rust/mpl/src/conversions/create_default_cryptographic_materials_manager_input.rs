...
#[allow(dead_code)]
pub fn to_dafny(
    value: &crate::types::CreateDefaultCryptographicMaterialsManagerInput,
) -> ::dafny_runtime::Rc<
...
pub fn to_dafny_plain(
    ...
    crate::r#software::amazon::cryptography::materialproviders::internaldafny::types::CreateDefaultCryptographicMaterialsManagerInput::CreateDefaultCryptographicMaterialsManagerInput {
        keyring: crate::conversions::keyring::to_dafny(&value.keyring.clone().unwrap())
,
    }
}
...
pub fn option_to_dafny(
  value: ::std::option::Option<crate::types::CreateDefaultCryptographicMaterialsManagerInput>,
...
pub fn plain_from_dafny(
    ...
    match dafny_value {
        crate::r#software::amazon::cryptography::materialproviders::internaldafny::types::CreateDefaultCryptographicMaterialsManagerInput::CreateDefaultCryptographicMaterialsManagerInput {..} =>
            crate::types::CreateDefaultCryptographicMaterialsManagerInput::builder()
                .set_keyring(Some( crate::conversions::keyring::from_dafny(dafny_value.keyring().clone())
 ))
                .build()
                .unwrap()
    }
...
pub fn option_from_dafny(
    dafny_value: ::dafny_runtime::Rc<crate::_Wrappers_Compile::Option<::dafny_runtime::Rc<
        crate::r#software::amazon::cryptography::materialproviders::internaldafny::types::CreateDefaultCryptographicMaterialsManagerInput,
    >>>,
) -> ::std::option::Option<crate::types::CreateDefaultCryptographicMaterialsManagerInput> {
    match &*dafny_value {
