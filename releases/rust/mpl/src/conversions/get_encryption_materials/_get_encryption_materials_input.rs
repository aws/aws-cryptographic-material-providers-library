...
,
 commitmentPolicy: crate::conversions::commitment_policy::to_dafny(&value.commitment_policy.clone().unwrap())
,
 algorithmSuiteId: ::dafny_runtime::Rc::new(match &value.algorithm_suite_id {
    Some(x) => crate::_Wrappers_Compile::Option::Some { value: crate::conversions::algorithm_suite_id::to_dafny(&x.clone()) },
...
pub fn from_dafny(
    ...
    crate::operation::get_encryption_materials::GetEncryptionMaterialsInput::builder()
        ...
        .set_commitment_policy(Some(crate::conversions::commitment_policy::from_dafny(
            dafny_value.commitmentPolicy().clone(),
        )))
        .set_algorithm_suite_id(match (*dafny_value.algorithmSuiteId()).as_ref() {
            crate::r#_Wrappers_Compile::Option::Some { value } => Some(
                crate::conversions::algorithm_suite_id::from_dafny(value.clone()),
            ),
            _ => None,
        })
        .set_max_plaintext_length(crate::standard_library_conversions::olong_from_dafny(
            dafny_value.maxPlaintextLength().clone(),
        ))
        .set_required_encryption_context_keys(
            match (*dafny_value.requiredEncryptionContextKeys()).as_ref() {
                crate::r#_Wrappers_Compile::Option::Some { value } => Some(
                    ::dafny_runtime::dafny_runtime_conversions::dafny_sequence_to_vec(
                        value,
