...
#[allow(dead_code)]
pub fn to_dafny(
    value: &crate::types::CreateAwsKmsHierarchicalKeyringInput,
) -> ::dafny_runtime::Rc<
...
pub fn to_dafny_plain(
 ...
 branchKeyIdSupplier: ::dafny_runtime::Rc::new(match &value.branch_key_id_supplier {
    Some(x) => crate::_Wrappers_Compile::Option::Some { value: crate::conversions::branch_key_id_supplier::to_dafny(&x.clone()) },
...
,
 ...
 cache: ::dafny_runtime::Rc::new(match &value.cache {
    Some(x) => crate::_Wrappers_Compile::Option::Some { value: crate::conversions::cache_type::to_dafny(&x.clone()) },
    None => crate::_Wrappers_Compile::Option::None { }
})
,
...
pub fn option_to_dafny(
  value: ::std::option::Option<crate::types::CreateAwsKmsHierarchicalKeyringInput>,
...
pub fn plain_from_dafny(
    ...
    match dafny_value {
        crate::r#software::amazon::cryptography::materialproviders::internaldafny::types::CreateAwsKmsHierarchicalKeyringInput::CreateAwsKmsHierarchicalKeyringInput {..} =>
            crate::types::CreateAwsKmsHierarchicalKeyringInput::builder()
 ...
 .set_branch_key_id_supplier(match (*dafny_value.branchKeyIdSupplier()).as_ref() {
    crate::r#_Wrappers_Compile::Option::Some { value } =>
        Some(crate::conversions::branch_key_id_supplier::from_dafny(value.clone())),
    _ => None,
}
)
 ...
 .set_cache(match (*dafny_value.cache()).as_ref() {
    crate::r#_Wrappers_Compile::Option::Some { value } =>
        Some(crate::conversions::cache_type::from_dafny(value.clone())),
    _ => None,
}
)
...
pub fn option_from_dafny(
    dafny_value: ::dafny_runtime::Rc<crate::_Wrappers_Compile::Option<::dafny_runtime::Rc<
        crate::r#software::amazon::cryptography::materialproviders::internaldafny::types::CreateAwsKmsHierarchicalKeyringInput,
    >>>,
) -> ::std::option::Option<crate::types::CreateAwsKmsHierarchicalKeyringInput> {
    match &*dafny_value {
