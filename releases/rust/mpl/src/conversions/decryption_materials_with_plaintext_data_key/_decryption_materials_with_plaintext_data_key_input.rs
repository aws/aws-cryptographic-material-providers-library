...
>{
    ::dafny_runtime::Rc::new(crate::r#software::amazon::cryptography::materialproviders::internaldafny::types::DecryptionMaterials::DecryptionMaterials {
        algorithmSuite: crate::conversions::algorithm_suite_info::to_dafny(&value.algorithm_suite.clone().unwrap())
,
...
pub fn from_dafny(
    ...
    crate::operation::decryption_materials_with_plaintext_data_key::DecryptionMaterials::builder()
        .set_algorithm_suite(Some(crate::conversions::algorithm_suite_info::from_dafny(
            dafny_value.algorithmSuite().clone(),
        )))
        ...
        .set_plaintext_data_key(crate::standard_library_conversions::oblob_from_dafny(
            dafny_value.plaintextDataKey().clone(),
        ))
        .set_verification_key(crate::standard_library_conversions::oblob_from_dafny(
            dafny_value.verificationKey().clone(),
        ))
        .set_symmetric_signing_key(crate::standard_library_conversions::oblob_from_dafny(
            dafny_value.symmetricSigningKey().clone(),
        ))
        .build()
        .unwrap()
}
