...
#[allow(dead_code)]
pub fn to_dafny(
    value: &crate::types::DecryptMaterialsInput,
) -> ::dafny_runtime::Rc<
...
,
 encryptedDataKeys: ::dafny_runtime::dafny_runtime_conversions::vec_to_dafny_sequence(&value.encrypted_data_keys.clone().unwrap(),
    |e| crate::conversions::encrypted_data_key::to_dafny(&e.clone())
,
)
,
...
pub fn option_to_dafny(
  value: ::std::option::Option<crate::types::DecryptMaterialsInput>,
...
pub fn plain_from_dafny(
    ...
    match dafny_value {
        crate::r#software::amazon::cryptography::materialproviders::internaldafny::types::DecryptMaterialsInput::DecryptMaterialsInput {..} =>
            crate::types::DecryptMaterialsInput::builder()
                .set_algorithm_suite_id(Some( crate::conversions::algorithm_suite_id::from_dafny(dafny_value.algorithmSuiteId().clone())
 ))
 .set_commitment_policy(Some( crate::conversions::commitment_policy::from_dafny(dafny_value.commitmentPolicy().clone())
 ))
 .set_encrypted_data_keys(Some( ::dafny_runtime::dafny_runtime_conversions::dafny_sequence_to_vec(dafny_value.encryptedDataKeys(),
    |e: &::dafny_runtime::Rc<crate::r#software::amazon::cryptography::materialproviders::internaldafny::types::EncryptedDataKey>| crate::conversions::encrypted_data_key::from_dafny(e.clone())
,
)
 ))
...
pub fn option_from_dafny(
    dafny_value: ::dafny_runtime::Rc<crate::_Wrappers_Compile::Option<::dafny_runtime::Rc<
        crate::r#software::amazon::cryptography::materialproviders::internaldafny::types::DecryptMaterialsInput,
    >>>,
) -> ::std::option::Option<crate::types::DecryptMaterialsInput> {
    match &*dafny_value {
