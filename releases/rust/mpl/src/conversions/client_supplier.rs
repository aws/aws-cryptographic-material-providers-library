...
{
        let inner_input =
            crate::conversions::get_client::_get_client_input::from_dafny(input.clone());
...
impl crate::types::client_supplier::ClientSupplier for IClientSupplierDafnyWrapper {
    ...
    ) -> Result<crate::deps::com_amazonaws_kms::client::Client, crate::types::error::Error> {
        let inner_input = crate::conversions::get_client::_get_client_input::to_dafny(input);
