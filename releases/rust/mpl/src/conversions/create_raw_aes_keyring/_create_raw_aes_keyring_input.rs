...
>{
    ::dafny_runtime::Rc::new(crate::r#software::amazon::cryptography::materialproviders::internaldafny::types::CreateRawAesKeyringInput::CreateRawAesKeyringInput {
 ...
 wrappingAlg: crate::conversions::aes_wrapping_alg::to_dafny(value.wrapping_alg.clone().unwrap()),
    })
}
#[allow(dead_code)]
pub fn from_dafny(
    ...
    crate::operation::create_raw_aes_keyring::CreateRawAesKeyringInput::builder()
        ...
        .set_wrapping_key(Some(crate::standard_library_conversions::blob_from_dafny(
            dafny_value.wrappingKey().clone(),
        )))
        .set_wrapping_alg(Some(crate::conversions::aes_wrapping_alg::from_dafny(
            dafny_value.wrappingAlg(),
        )))
        .build()
        .unwrap()
}
