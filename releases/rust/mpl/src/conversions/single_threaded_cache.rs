...
#[allow(dead_code)]
pub fn to_dafny(
    value: &crate::types::SingleThreadedCache,
) -> ::dafny_runtime::Rc<
...
pub fn option_to_dafny(
  value: ::std::option::Option<crate::types::SingleThreadedCache>,
...
pub fn plain_from_dafny(
    ...
    match dafny_value {
        crate::r#software::amazon::cryptography::materialproviders::internaldafny::types::SingleThreadedCache::SingleThreadedCache {..} =>
            crate::types::SingleThreadedCache::builder()
...
pub fn option_from_dafny(
    dafny_value: ::dafny_runtime::Rc<crate::_Wrappers_Compile::Option<::dafny_runtime::Rc<
        crate::r#software::amazon::cryptography::materialproviders::internaldafny::types::SingleThreadedCache,
    >>>,
) -> ::std::option::Option<crate::types::SingleThreadedCache> {
    match &*dafny_value {
