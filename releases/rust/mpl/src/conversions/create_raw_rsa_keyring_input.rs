...
#[allow(dead_code)]
pub fn to_dafny(
    value: &crate::types::CreateRawRsaKeyringInput,
) -> ::dafny_runtime::Rc<
...
pub fn option_to_dafny(
  value: ::std::option::Option<crate::types::CreateRawRsaKeyringInput>,
...
pub fn plain_from_dafny(
    ...
    match dafny_value {
        crate::r#software::amazon::cryptography::materialproviders::internaldafny::types::CreateRawRsaKeyringInput::CreateRawRsaKeyringInput {..} =>
            crate::types::CreateRawRsaKeyringInput::builder()
 ...
 .set_padding_scheme(Some( crate::conversions::padding_scheme::from_dafny(dafny_value.paddingScheme()) ))
...
pub fn option_from_dafny(
    dafny_value: ::dafny_runtime::Rc<crate::_Wrappers_Compile::Option<::dafny_runtime::Rc<
        crate::r#software::amazon::cryptography::materialproviders::internaldafny::types::CreateRawRsaKeyringInput,
    >>>,
) -> ::std::option::Option<crate::types::CreateRawRsaKeyringInput> {
    match &*dafny_value {
