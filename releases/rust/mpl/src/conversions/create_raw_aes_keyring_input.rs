...
#[allow(dead_code)]
pub fn to_dafny(
    value: &crate::types::CreateRawAesKeyringInput,
) -> ::dafny_runtime::Rc<
...
pub fn option_to_dafny(
  value: ::std::option::Option<crate::types::CreateRawAesKeyringInput>,
...
pub fn plain_from_dafny(
    ...
    match dafny_value {
        crate::r#software::amazon::cryptography::materialproviders::internaldafny::types::CreateRawAesKeyringInput::CreateRawAesKeyringInput {..} =>
            crate::types::CreateRawAesKeyringInput::builder()
 ...
 .set_wrapping_alg(Some( crate::conversions::aes_wrapping_alg::from_dafny(dafny_value.wrappingAlg()) ))
                .build()
                .unwrap()
    }
}
...
pub fn option_from_dafny(
    dafny_value: ::dafny_runtime::Rc<crate::_Wrappers_Compile::Option<::dafny_runtime::Rc<
        crate::r#software::amazon::cryptography::materialproviders::internaldafny::types::CreateRawAesKeyringInput,
    >>>,
) -> ::std::option::Option<crate::types::CreateRawAesKeyringInput> {
    match &*dafny_value {
