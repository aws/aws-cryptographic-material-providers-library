...
impl crate::types::cryptographic_materials_cache::CryptographicMaterialsCache
    for ICryptographicMaterialsCacheDafnyWrapper
{
    fn put_cache_entry(
        &self,
    ...
    fn update_usage_metadata(
        ...
        let inner_input =
            crate::conversions::update_usage_metadata::_update_usage_metadata_input::to_dafny(
                input,
            );
    ...
    ) -> Result<crate::operation::get_cache_entry::GetCacheEntryOutput, crate::types::error::Error>
    {
        let inner_input =
