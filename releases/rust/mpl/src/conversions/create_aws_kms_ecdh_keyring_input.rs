...
#[allow(dead_code)]
pub fn to_dafny(
    value: &crate::types::CreateAwsKmsEcdhKeyringInput,
) -> ::dafny_runtime::Rc<
...
pub fn to_dafny_plain(
    ...
    crate::r#software::amazon::cryptography::materialproviders::internaldafny::types::CreateAwsKmsEcdhKeyringInput::CreateAwsKmsEcdhKeyringInput {
        KeyAgreementScheme: crate::conversions::kms_ecdh_static_configurations::to_dafny(&value.key_agreement_scheme.clone().unwrap())
,
...
pub fn option_to_dafny(
  value: ::std::option::Option<crate::types::CreateAwsKmsEcdhKeyringInput>,
...
pub fn plain_from_dafny(
    ...
    match dafny_value {
        crate::r#software::amazon::cryptography::materialproviders::internaldafny::types::CreateAwsKmsEcdhKeyringInput::CreateAwsKmsEcdhKeyringInput {..} =>
            crate::types::CreateAwsKmsEcdhKeyringInput::builder()
                .set_key_agreement_scheme(Some( crate::conversions::kms_ecdh_static_configurations::from_dafny(dafny_value.KeyAgreementScheme().clone())
 ))
...
pub fn option_from_dafny(
    dafny_value: ::dafny_runtime::Rc<crate::_Wrappers_Compile::Option<::dafny_runtime::Rc<
        crate::r#software::amazon::cryptography::materialproviders::internaldafny::types::CreateAwsKmsEcdhKeyringInput,
    >>>,
) -> ::std::option::Option<crate::types::CreateAwsKmsEcdhKeyringInput> {
    match &*dafny_value {
