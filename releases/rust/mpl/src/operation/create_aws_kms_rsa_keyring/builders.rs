...
pub struct CreateAwsKmsRsaKeyringFluentBuilder {
    client: crate::client::Client,
    pub(crate) inner:
        crate::operation::create_aws_kms_rsa_keyring::builders::CreateAwsKmsRsaKeyringInputBuilder,
}
impl CreateAwsKmsRsaKeyringFluentBuilder {
    ...
    pub async fn send(
        ...
        crate::operation::create_aws_kms_rsa_keyring::CreateAwsKmsRsaKeyring::send(
            &self.client,
            input,
        )
        .await
