...
impl DecryptMaterialsFluentBuilder {
    ...
    pub fn as_input(
        &self,
    ) -> &crate::operation::decrypt_materials::builders::DecryptMaterialsInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::decrypt_materials::DecryptMaterials::send(
            &self.cryptographic_materials_manager,
            input,
        )
        .await
    }
