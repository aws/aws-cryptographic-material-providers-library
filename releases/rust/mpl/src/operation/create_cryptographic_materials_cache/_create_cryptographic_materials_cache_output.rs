...
pub struct CreateCryptographicMaterialsCacheOutputBuilder {
    pub(crate) materials_cache: ::std::option::Option<
        crate::types::cryptographic_materials_cache::CryptographicMaterialsCacheRef,
    >,
}
