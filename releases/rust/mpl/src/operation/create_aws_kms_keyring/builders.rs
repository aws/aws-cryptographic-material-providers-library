...
pub struct CreateAwsKmsKeyringFluentBuilder {
    client: crate::client::Client,
    pub(crate) inner:
        crate::operation::create_aws_kms_keyring::builders::CreateAwsKmsKeyringInputBuilder,
}
impl CreateAwsKmsKeyringFluentBuilder {
    ...
    pub async fn send(
        ...
        crate::operation::create_aws_kms_keyring::CreateAwsKmsKeyring::send(&self.client, input)
            .await
    }
