...
impl GetAlgorithmSuiteInfo {
    ...
    > {
        crate::validation::validate_aws_Pcryptography_PmaterialProviders_HGetAlgorithmSuiteInfoInput_for_AwsCryptographicMaterialProviders_GetAlgorithmSuiteInfo(&input)
        ...
        if matches!(
            ...
            Ok(
                crate::conversions::get_algorithm_suite_info::_get_algorithm_suite_info_output::from_dafny(inner_result.value().clone()),
            )
        } else {
