...
pub struct CreateAwsKmsMrkKeyringFluentBuilder {
    client: crate::client::Client,
    pub(crate) inner:
        crate::operation::create_aws_kms_mrk_keyring::builders::CreateAwsKmsMrkKeyringInputBuilder,
}
impl CreateAwsKmsMrkKeyringFluentBuilder {
    ...
    pub async fn send(
        ...
        crate::operation::create_aws_kms_mrk_keyring::CreateAwsKmsMrkKeyring::send(
            &self.client,
            input,
        )
        .await
