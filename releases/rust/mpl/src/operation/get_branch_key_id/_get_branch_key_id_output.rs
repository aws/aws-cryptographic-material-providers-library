...
impl GetBranchKeyIdOutput {
    ...
    pub fn builder() -> crate::operation::get_branch_key_id::builders::GetBranchKeyIdOutputBuilder {
        crate::operation::get_branch_key_id::builders::GetBranchKeyIdOutputBuilder::default()
    }
}
...
impl GetBranchKeyIdOutputBuilder {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::get_branch_key_id::GetBranchKeyIdOutput {
