...
impl GetBranchKeyIdInput {
    ...
    pub fn builder() -> crate::operation::get_branch_key_id::builders::GetBranchKeyIdInputBuilder {
        crate::operation::get_branch_key_id::builders::GetBranchKeyIdInputBuilder::default()
    }
}
...
impl GetBranchKeyIdInputBuilder {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::get_branch_key_id::GetBranchKeyIdInput {
