...
impl CreateAwsKmsKeyring {
    ...
    pub(crate) async fn send(
        ...
        crate::validation::validate_aws_Pcryptography_PmaterialProviders_HCreateAwsKmsKeyringInput_for_AwsCryptographicMaterialProviders_CreateAwsKmsKeyring(&input)
            .map_err(crate::types::error::Error::wrap_validation_err)?;
        let inner_input =
            crate::conversions::create_aws_kms_keyring::_create_aws_kms_keyring_input::to_dafny(
                input,
            );
        let inner_result =
