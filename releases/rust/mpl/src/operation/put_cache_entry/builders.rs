...
impl PutCacheEntryFluentBuilder {
    ...
    pub fn as_input(
        &self,
    ) -> &crate::operation::put_cache_entry::builders::PutCacheEntryInputBuilder {
        &self.inner
    }
    ...
    pub async fn send(self) -> ::std::result::Result<(), crate::types::error::Error> {
        ...
        crate::operation::put_cache_entry::PutCacheEntry::send(
            &self.cryptographic_materials_cache,
            input,
        )
        .await
    }
