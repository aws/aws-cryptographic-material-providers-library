...
impl CreateRawRsaKeyring {
    ...
    pub(crate) async fn send(
        ...
        crate::validation::validate_aws_Pcryptography_PmaterialProviders_HCreateRawRsaKeyringInput_for_AwsCryptographicMaterialProviders_CreateRawRsaKeyring(&input)
            .map_err(crate::types::error::Error::wrap_validation_err)?;
        let inner_input =
            crate::conversions::create_raw_rsa_keyring::_create_raw_rsa_keyring_input::to_dafny(
                input,
            );
        let inner_result =
