...
impl GetClientInput {
    ...
    pub fn builder() -> crate::operation::get_client::builders::GetClientInputBuilder {
        crate::operation::get_client::builders::GetClientInputBuilder::default()
    }
}
...
impl GetClientInputBuilder {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::get_client::GetClientInput {
            region: self.region,
        })
    }
}
