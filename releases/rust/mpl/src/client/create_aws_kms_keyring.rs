...
impl crate::client::Client {
    ...
    ///   - [`keyring(Option<crate::types::keyring::KeyringRef>)`](crate::operation::create_aws_kms_keyring::CreateKeyringOutput::keyring): (undocumented)
    ...
    pub fn create_aws_kms_keyring(
        &self,
    ) -> crate::operation::create_aws_kms_keyring::builders::CreateAwsKmsKeyringFluentBuilder {
        crate::operation::create_aws_kms_keyring::builders::CreateAwsKmsKeyringFluentBuilder::new(
            self.clone(),
        )
    }
}
