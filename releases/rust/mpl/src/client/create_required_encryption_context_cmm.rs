...
impl crate::client::Client {
    ...
    ///   - [`keyring(impl Into<Option<crate::types::keyring::KeyringRef>>)`](crate::operation::create_required_encryption_context_cmm::builders::CreateRequiredEncryptionContextCMMFluentBuilder::keyring) / [`set_keyring(Option<crate::types::keyring::KeyringRef>)`](crate::operation::create_required_encryption_context_cmm::builders::CreateRequiredEncryptionContextCMMFluentBuilder::set_keyring): (undocumented)<br>
    ...
    ///   - [`underlying_cmm(impl Into<Option<crate::types::cryptographic_materials_manager::CryptographicMaterialsManagerRef>>)`](crate::operation::create_required_encryption_context_cmm::builders::CreateRequiredEncryptionContextCMMFluentBuilder::underlying_cmm) / [`set_underlying_cmm(Option<crate::types::cryptographic_materials_manager::CryptographicMaterialsManagerRef>)`](crate::operation::create_required_encryption_context_cmm::builders::CreateRequiredEncryptionContextCMMFluentBuilder::set_underlying_cmm): (undocumented)<br>
    ...
    ///   - [`materials_manager(Option<crate::types::cryptographic_materials_manager::CryptographicMaterialsManagerRef>)`](crate::operation::create_required_encryption_context_cmm::CreateRequiredEncryptionContextCMMOutput::materials_manager): (undocumented)
