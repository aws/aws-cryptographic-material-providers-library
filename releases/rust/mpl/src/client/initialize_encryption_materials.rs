...
impl crate::client::Client {
    ...
    ///   - [`algorithm_suite_id(impl Into<Option<crate::types::AlgorithmSuiteId>>)`](crate::operation::initialize_encryption_materials::builders::InitializeEncryptionMaterialsFluentBuilder::algorithm_suite_id) / [`set_algorithm_suite_id(Option<crate::types::AlgorithmSuiteId>)`](crate::operation::initialize_encryption_materials::builders::InitializeEncryptionMaterialsFluentBuilder::set_algorithm_suite_id): (undocumented)<br>
    ...
    ///   - [`algorithm_suite(Option<crate::types::AlgorithmSuiteInfo>)`](crate::operation::initialize_encryption_materials::EncryptionMaterials::algorithm_suite): (undocumented)
    ///   - [`encrypted_data_keys(Option<::std::vec::Vec<crate::types::EncryptedDataKey>>)`](crate::operation::initialize_encryption_materials::EncryptionMaterials::encrypted_data_keys): (undocumented)
