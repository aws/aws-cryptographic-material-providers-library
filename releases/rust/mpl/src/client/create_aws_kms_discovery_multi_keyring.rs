...
impl crate::client::Client {
    ...
    ///   - [`client_supplier(impl Into<Option<crate::types::client_supplier::ClientSupplierRef>>)`](crate::operation::create_aws_kms_discovery_multi_keyring::builders::CreateAwsKmsDiscoveryMultiKeyringFluentBuilder::client_supplier) / [`set_client_supplier(Option<crate::types::client_supplier::ClientSupplierRef>)`](crate::operation::create_aws_kms_discovery_multi_keyring::builders::CreateAwsKmsDiscoveryMultiKeyringFluentBuilder::set_client_supplier): (undocumented)<br>
    ///   - [`discovery_filter(impl Into<Option<crate::types::DiscoveryFilter>>)`](crate::operation::create_aws_kms_discovery_multi_keyring::builders::CreateAwsKmsDiscoveryMultiKeyringFluentBuilder::discovery_filter) / [`set_discovery_filter(Option<crate::types::DiscoveryFilter>)`](crate::operation::create_aws_kms_discovery_multi_keyring::builders::CreateAwsKmsDiscoveryMultiKeyringFluentBuilder::set_discovery_filter): (undocumented)<br>
    ...
    ///   - [`keyring(Option<crate::types::keyring::KeyringRef>)`](crate::operation::create_aws_kms_discovery_multi_keyring::CreateKeyringOutput::keyring): (undocumented)
