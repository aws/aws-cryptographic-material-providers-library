...
impl crate::client::Client {
    ...
    ///   - [`keyring(impl Into<Option<crate::types::keyring::KeyringRef>>)`](crate::operation::create_default_cryptographic_materials_manager::builders::CreateDefaultCryptographicMaterialsManagerFluentBuilder::keyring) / [`set_keyring(Option<crate::types::keyring::KeyringRef>)`](crate::operation::create_default_cryptographic_materials_manager::builders::CreateDefaultCryptographicMaterialsManagerFluentBuilder::set_keyring): (undocumented)<br>
    ...
    ///   - [`materials_manager(Option<crate::types::cryptographic_materials_manager::CryptographicMaterialsManagerRef>)`](crate::operation::create_default_cryptographic_materials_manager::CreateCryptographicMaterialsManagerOutput::materials_manager): (undocumented)
