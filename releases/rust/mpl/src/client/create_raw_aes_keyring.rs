...
impl crate::client::Client {
    ...
    ///   - [`wrapping_alg(impl Into<Option<crate::types::AesWrappingAlg>>)`](crate::operation::create_raw_aes_keyring::builders::CreateRawAesKeyringFluentBuilder::wrapping_alg) / [`set_wrapping_alg(Option<crate::types::AesWrappingAlg>)`](crate::operation::create_raw_aes_keyring::builders::CreateRawAesKeyringFluentBuilder::set_wrapping_alg): (undocumented)<br>
    ...
    ///   - [`keyring(Option<crate::types::keyring::KeyringRef>)`](crate::operation::create_raw_aes_keyring::CreateKeyringOutput::keyring): (undocumented)
    ...
    pub fn create_raw_aes_keyring(
        &self,
    ) -> crate::operation::create_raw_aes_keyring::builders::CreateRawAesKeyringFluentBuilder {
        crate::operation::create_raw_aes_keyring::builders::CreateRawAesKeyringFluentBuilder::new(
            self.clone(),
        )
    }
}
