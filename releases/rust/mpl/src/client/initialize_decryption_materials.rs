...
impl crate::client::Client {
    ...
    ///   - [`algorithm_suite_id(impl Into<Option<crate::types::AlgorithmSuiteId>>)`](crate::operation::initialize_decryption_materials::builders::InitializeDecryptionMaterialsFluentBuilder::algorithm_suite_id) / [`set_algorithm_suite_id(Option<crate::types::AlgorithmSuiteId>)`](crate::operation::initialize_decryption_materials::builders::InitializeDecryptionMaterialsFluentBuilder::set_algorithm_suite_id): (undocumented)<br>
    ...
    ///   - [`algorithm_suite(Option<crate::types::AlgorithmSuiteInfo>)`](crate::operation::initialize_decryption_materials::DecryptionMaterials::algorithm_suite): (undocumented)
