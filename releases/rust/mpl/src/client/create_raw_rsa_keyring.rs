...
impl crate::client::Client {
    ...
    ///   - [`padding_scheme(impl Into<Option<crate::types::PaddingScheme>>)`](crate::operation::create_raw_rsa_keyring::builders::CreateRawRsaKeyringFluentBuilder::padding_scheme) / [`set_padding_scheme(Option<crate::types::PaddingScheme>)`](crate::operation::create_raw_rsa_keyring::builders::CreateRawRsaKeyringFluentBuilder::set_padding_scheme): (undocumented)<br>
    ...
    ///   - [`keyring(Option<crate::types::keyring::KeyringRef>)`](crate::operation::create_raw_rsa_keyring::CreateKeyringOutput::keyring): (undocumented)
    ...
    pub fn create_raw_rsa_keyring(
        &self,
    ) -> crate::operation::create_raw_rsa_keyring::builders::CreateRawRsaKeyringFluentBuilder {
        crate::operation::create_raw_rsa_keyring::builders::CreateRawRsaKeyringFluentBuilder::new(
            self.clone(),
        )
    }
}
