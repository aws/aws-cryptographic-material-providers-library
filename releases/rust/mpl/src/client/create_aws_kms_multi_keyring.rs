...
impl crate::client::Client {
    ...
    ///   - [`client_supplier(impl Into<Option<crate::types::client_supplier::ClientSupplierRef>>)`](crate::operation::create_aws_kms_multi_keyring::builders::CreateAwsKmsMultiKeyringFluentBuilder::client_supplier) / [`set_client_supplier(Option<crate::types::client_supplier::ClientSupplierRef>)`](crate::operation::create_aws_kms_multi_keyring::builders::CreateAwsKmsMultiKeyringFluentBuilder::set_client_supplier): (undocumented)<br>
    ...
    ///   - [`keyring(Option<crate::types::keyring::KeyringRef>)`](crate::operation::create_aws_kms_multi_keyring::CreateKeyringOutput::keyring): (undocumented)
