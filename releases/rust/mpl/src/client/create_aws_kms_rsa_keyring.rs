...
impl crate::client::Client {
    ...
    ///   - [`keyring(Option<crate::types::keyring::KeyringRef>)`](crate::operation::create_aws_kms_rsa_keyring::CreateKeyringOutput::keyring): (undocumented)
    ...
    pub fn create_aws_kms_rsa_keyring(
        &self,
    ) -> crate::operation::create_aws_kms_rsa_keyring::builders::CreateAwsKmsRsaKeyringFluentBuilder
    {
