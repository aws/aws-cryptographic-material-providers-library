...
impl crate::client::Client {
    ...
    ///   - [`discovery_filter(impl Into<Option<crate::types::DiscoveryFilter>>)`](crate::operation::create_aws_kms_mrk_discovery_keyring::builders::CreateAwsKmsMrkDiscoveryKeyringFluentBuilder::discovery_filter) / [`set_discovery_filter(Option<crate::types::DiscoveryFilter>)`](crate::operation::create_aws_kms_mrk_discovery_keyring::builders::CreateAwsKmsMrkDiscoveryKeyringFluentBuilder::set_discovery_filter): (undocumented)<br>
    ...
    ///   - [`keyring(Option<crate::types::keyring::KeyringRef>)`](crate::operation::create_aws_kms_mrk_discovery_keyring::CreateKeyringOutput::keyring): (undocumented)
