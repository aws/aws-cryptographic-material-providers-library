...
impl crate::client::Client {
    ...
    ///   - [`key_agreement_scheme(impl Into<Option<crate::types::RawEcdhStaticConfigurations>>)`](crate::operation::create_raw_ecdh_keyring::builders::CreateRawEcdhKeyringFluentBuilder::key_agreement_scheme) / [`set_key_agreement_scheme(Option<crate::types::RawEcdhStaticConfigurations>)`](crate::operation::create_raw_ecdh_keyring::builders::CreateRawEcdhKeyringFluentBuilder::set_key_agreement_scheme): (undocumented)<br>
    ...
    ///   - [`keyring(Option<crate::types::keyring::KeyringRef>)`](crate::operation::create_raw_ecdh_keyring::CreateKeyringOutput::keyring): (undocumented)
    ...
    pub fn create_raw_ecdh_keyring(
        &self,
    ) -> crate::operation::create_raw_ecdh_keyring::builders::CreateRawEcdhKeyringFluentBuilder
    {
        crate::operation::create_raw_ecdh_keyring::builders::CreateRawEcdhKeyringFluentBuilder::new(
            self.clone(),
        )
    }
}
