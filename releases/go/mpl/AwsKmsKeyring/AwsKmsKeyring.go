...
func (_this *AwsKmsKeyring) OnDecrypt_k(input m_AwsCryptographyMaterialProvidersTypes.OnDecryptInput) m_Wrappers.Result {
	{
		...
		var _3_filter *OnDecryptEncryptedDataKeyFilter
		_ = _3_filter
		...
		if (_dafny.IntOfUint32((_5_edksToAttempt).Cardinality())).Sign() == 0 {
			...
			res = m_Wrappers.Companion_Result_.Create_Failure_(m_AwsCryptographyMaterialProvidersTypes.Companion_Error_.Create_AwsCryptographicMaterialProvidersException_(_7_errorMessage))
			return res
		}
		...
		_ = _10_valueOrError3
		_10_valueOrError3 = (_9_outcome).MapFailure(func(coer53 func(_dafny.Sequence) m_AwsCryptographyMaterialProvidersTypes.Error) func(interface{}) interface{} {
