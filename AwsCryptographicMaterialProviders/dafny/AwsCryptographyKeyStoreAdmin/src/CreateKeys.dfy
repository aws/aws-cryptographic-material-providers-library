...
module {:options "/functionSyntax:4" } CreateKeysHV2 {
  ...
  method CreateBranchAndBeaconKeys(
    ...
    ensures output.Success?
            ==>
              ...
              && var decryptOnlyEncryptionContext := Structure.Hv2DecryptOnlyBranchKeyEncryptionContext(
                                                       branchKeyIdentifier,
                                                       branchKeyVersion,
                                                       timestamp,
  ...
  {
    // Create Branch Key Encryption Contexts
    var decryptOnlyEncryptionContext := Structure.Hv2DecryptOnlyBranchKeyEncryptionContext(
      branchKeyIdentifier,
      branchKeyVersion,
      timestamp,
    ...
    var activeEncryptionContext := Structure.Hv2ActiveBranchKeyEncryptionContext(decryptOnlyEncryptionContext);
  ...
  //          && oldActiveItem.EncryptionContext[Structure.TABLE_FIELD] == logicalKeyStoreName
  //        ),
  //     KeyStoreTypes.KeyStoreException(
  ...
  //   );
  //   var overWrite := KeyStoreTypes.OverWriteEncryptedHierarchicalKey(
  //     Item := active,
  //     Old := oldActiveItem
  //   );

  //   var _ :- storage.WriteNewEncryptedBranchKeyVersion(
  //     KeyStoreTypes.WriteNewEncryptedBranchKeyVersionInput(
  //       Active := overWrite,
  //       Version :=  Structure.ConstructEncryptedHierarchicalKey(
  //         decryptOnlyEncryptionContext,
  //         wrappedDecryptOnlyBranchKey.CiphertextBlob.value
