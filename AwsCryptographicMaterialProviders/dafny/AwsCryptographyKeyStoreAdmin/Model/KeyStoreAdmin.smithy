...
structure KmsMRKey {
  @required
  @documentation("This MUST be a KMS MRK ARN; aliases and Single Region keys are rejected.")  
  KeyArn: com.amazonaws.kms#KeyIdType
  @required
  @documentation("MRK ARN will have its region replaced with this.")
...
structure MutableBranchKeyContext {
  @required
