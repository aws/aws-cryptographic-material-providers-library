...
module {:options "/functionSyntax:4" } TestContentHandler {
  ...
  const MutationCommitmentContentToSHA :=
    map[
      ...
      Utf8Constants.CREATE_TIME_UTF8_BYTES := Fixtures.NOW_BYTES,
      Utf8Constants.ORIGINAL_UTF8_BYTES := Fixtures.ORIGINAL_BYTES,
      Utf8Constants.TERMINAL_UTF8_BYTES := Fixtures.TERMINAL_BYTES,
      Utf8Constants.INPUT_UTF8_BYTES := Fixtures.INPUT_BYTES
    ]
