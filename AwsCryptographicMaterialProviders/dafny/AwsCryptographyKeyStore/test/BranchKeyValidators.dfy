...
module {:options "/functionSyntax:4" } BranchKeyValidators {
  ...
  */
  predicate branchKeyContextSaysHV1(bkc: Structure.EncryptionContextString)
  {
    Structure.HIERARCHY_VERSION in bkc && bkc[Structure.HIERARCHY_VERSION] == Structure.HIERARCHY_VERSION_VALUE_1
  }

  predicate branchKeyContextSaysHV2(bkc: Structure.EncryptionContextString)
  {
    ...
    ensures keyStore.ValidState()
  {
    ...
    expect |beaconKeyResult.beaconKeyMaterials.beaconKey.value| == 32, "Length of Beacon Key Materials MUST be 32 bytes.";
