...
module Fixtures {
  ...
  const RobbieECString : Structure.EncryptionContextString := map["Robbie" := "Is a dog."]
  const KodaECString : Structure.EncryptionContextString := map["Koda" := "Is a dog."]
              ...
              && fresh(output.value.Modifies)
  {
    ...
    assume {:axiom} fresh(keyStore.Modifies);
