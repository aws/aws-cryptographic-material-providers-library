...
rm -rf ../../../releases/rust/mpl
cp -r . ../../../releases/rust/mpl

# Go to the release directory
cd ../../../releases/rust/mpl

# Remove unnecessary files and directories
rm -rf *~  start_release.sh *.pem RELEASE.md CHANGELOG.md src/README.md
...
echo
echo Next Steps:
echo cd $(realpath ${PWD}/../../../releases/rust/mpl)
echo Make a PR
echo Get it merged
echo cargo publish
echo
