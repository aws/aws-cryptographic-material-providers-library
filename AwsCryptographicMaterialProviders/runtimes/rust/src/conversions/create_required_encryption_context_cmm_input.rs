...
#[allow(dead_code)]
pub fn to_dafny(
    value: &crate::types::CreateRequiredEncryptionContextCmmInput,
) -> ::std::rc::Rc<
...
pub fn to_dafny_plain(
    ...
    Some(x) => crate::_Wrappers_Compile::Option::Some { value: crate::conversions::cryptographic_materials_manager::to_dafny(&x.clone()) },
    None => crate::_Wrappers_Compile::Option::None { }
})
,
 keyring: ::std::rc::Rc::new(match &value.keyring {
    Some(x) => crate::_Wrappers_Compile::Option::Some { value: crate::conversions::keyring::to_dafny(&x.clone()) },
    None => crate::_Wrappers_Compile::Option::None { }
})
,
...
pub fn option_to_dafny(
  value: ::std::option::Option<crate::types::CreateRequiredEncryptionContextCmmInput>,
...
pub fn plain_from_dafny(
    ...
    match dafny_value {
        crate::r#software::amazon::cryptography::materialproviders::internaldafny::types::CreateRequiredEncryptionContextCMMInput::CreateRequiredEncryptionContextCMMInput {..} =>
            crate::types::CreateRequiredEncryptionContextCmmInput::builder()
                .set_underlying_cmm(match (*dafny_value.underlyingCMM()).as_ref() {
    crate::r#_Wrappers_Compile::Option::Some { value } =>
        Some(crate::conversions::cryptographic_materials_manager::from_dafny(value.clone())),
    _ => None,
}
)
 .set_keyring(match (*dafny_value.keyring()).as_ref() {
    crate::r#_Wrappers_Compile::Option::Some { value } =>
        Some(crate::conversions::keyring::from_dafny(value.clone())),
    _ => None,
}
)
 .set_required_encryption_context_keys(Some( ::dafny_runtime::dafny_runtime_conversions::dafny_sequence_to_vec(dafny_value.requiredEncryptionContextKeys(),
    |e: &::dafny_runtime::dafny_runtime_conversions::DafnySequence<u8>| ::std::string::String::from_utf8(dafny_runtime::dafny_runtime_conversions::dafny_sequence_to_vec(&e, |b| *b)).unwrap(),
)
 ))
                .build()
                .unwrap()
...
pub fn option_from_dafny(
    dafny_value: ::std::rc::Rc<crate::_Wrappers_Compile::Option<::std::rc::Rc<
        crate::r#software::amazon::cryptography::materialproviders::internaldafny::types::CreateRequiredEncryptionContextCMMInput,
    >>>,
) -> ::std::option::Option<crate::types::CreateRequiredEncryptionContextCmmInput> {
    match &*dafny_value {
