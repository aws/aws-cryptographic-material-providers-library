...
> {
  let inner_input = crate::conversions::get_branch_key_id::_get_branch_key_id_input::to_dafny(input);
  ...
  if matches!(
      ...
      Ok(
          crate::conversions::get_branch_key_id::_get_branch_key_id_output::from_dafny(inner_result.value().clone()),
      )
  } else {
