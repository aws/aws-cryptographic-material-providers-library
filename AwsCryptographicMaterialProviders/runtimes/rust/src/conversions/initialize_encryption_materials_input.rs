...
#[allow(dead_code)]
pub fn to_dafny(
    value: &crate::types::InitializeEncryptionMaterialsInput,
) -> ::std::rc::Rc<
...
pub fn option_to_dafny(
  value: ::std::option::Option<crate::types::InitializeEncryptionMaterialsInput>,
...
pub fn plain_from_dafny(
    ...
    match dafny_value {
        crate::r#software::amazon::cryptography::materialproviders::internaldafny::types::InitializeEncryptionMaterialsInput::InitializeEncryptionMaterialsInput {..} =>
            crate::types::InitializeEncryptionMaterialsInput::builder()
...
pub fn option_from_dafny(
    dafny_value: ::std::rc::Rc<crate::_Wrappers_Compile::Option<::std::rc::Rc<
        crate::r#software::amazon::cryptography::materialproviders::internaldafny::types::InitializeEncryptionMaterialsInput,
    >>>,
) -> ::std::option::Option<crate::types::InitializeEncryptionMaterialsInput> {
    match &*dafny_value {
