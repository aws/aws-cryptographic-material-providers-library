...
>
{
    let inner_input = crate::conversions::put_cache_entry::_put_cache_entry_input::from_dafny(input.clone());
...
>
{
    let inner_input = crate::conversions::update_usage_metadata::_update_usage_metadata_input::from_dafny(input.clone());
...
>
{
    let inner_input = crate::conversions::get_cache_entry::_get_cache_entry_input::from_dafny(input.clone());
    let inner_result = self.obj.inner.borrow_mut().get_cache_entry(inner_input);
    let result = match inner_result {
        Ok(x) => crate::r#_Wrappers_Compile::Result::Success {
            value: crate::conversions::get_cache_entry::_get_cache_entry_output::to_dafny(x.clone()),
        },
        Err(x) => crate::r#_Wrappers_Compile::Result::Failure {
            error: crate::conversions::error::to_dafny(x),
        },
...
>
{
    let inner_input = crate::conversions::delete_cache_entry::_delete_cache_entry_input::from_dafny(input.clone());
...
> {
  let inner_input = crate::conversions::put_cache_entry::_put_cache_entry_input::to_dafny(input);
...
fn update_usage_metadata(
  ...
  crate::types::error::Error,
> {
  let inner_input = crate::conversions::update_usage_metadata::_update_usage_metadata_input::to_dafny(input);
...
fn get_cache_entry(
  ...
  crate::types::error::Error,
> {
  let inner_input = crate::conversions::get_cache_entry::_get_cache_entry_input::to_dafny(input);
  ...
  if matches!(
      ...
      Ok(
          crate::conversions::get_cache_entry::_get_cache_entry_output::from_dafny(inner_result.value().clone()),
      )
  } else {
      Err(crate::conversions::error::from_dafny(
          inner_result.error().clone(),
...
fn delete_cache_entry(
  ...
  crate::types::error::Error,
> {
  let inner_input = crate::conversions::delete_cache_entry::_delete_cache_entry_input::to_dafny(input);
