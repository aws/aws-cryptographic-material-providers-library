...
>
{
    let inner_input = crate::conversions::get_encryption_materials::_get_encryption_materials_input::from_dafny(input.clone());
    ...
    let result = match inner_result {
        Ok(x) => crate::r#_Wrappers_Compile::Result::Success {
            value: crate::conversions::get_encryption_materials::_get_encryption_materials_output::to_dafny(x.clone()),
        },
...
>
{
    let inner_input = crate::conversions::decrypt_materials::_decrypt_materials_input::from_dafny(input.clone());
    let inner_result = self.obj.inner.borrow_mut().decrypt_materials(inner_input);
    let result = match inner_result {
        Ok(x) => crate::r#_Wrappers_Compile::Result::Success {
            value: crate::conversions::decrypt_materials::_decrypt_materials_output::to_dafny(x.clone()),
        },
        Err(x) => crate::r#_Wrappers_Compile::Result::Failure {
            error: crate::conversions::error::to_dafny(x),
        },
...
> {
  let inner_input = crate::conversions::get_encryption_materials::_get_encryption_materials_input::to_dafny(input);
  ...
  if matches!(
      ...
      Ok(
          crate::conversions::get_encryption_materials::_get_encryption_materials_output::from_dafny(inner_result.value().clone()),
      )
  } else {
...
fn decrypt_materials(
  ...
  crate::types::error::Error,
> {
  let inner_input = crate::conversions::decrypt_materials::_decrypt_materials_input::to_dafny(input);
  ...
  if matches!(
      ...
      Ok(
          crate::conversions::decrypt_materials::_decrypt_materials_output::from_dafny(inner_result.value().clone()),
      )
  } else {
      Err(crate::conversions::error::from_dafny(
          inner_result.error().clone(),
