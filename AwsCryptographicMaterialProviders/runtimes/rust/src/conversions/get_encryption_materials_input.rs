...
#[allow(dead_code)]
pub fn to_dafny(
    value: &crate::types::GetEncryptionMaterialsInput,
) -> ::std::rc::Rc<
...
pub fn option_to_dafny(
  value: ::std::option::Option<crate::types::GetEncryptionMaterialsInput>,
...
pub fn plain_from_dafny(
    ...
    match dafny_value {
        crate::r#software::amazon::cryptography::materialproviders::internaldafny::types::GetEncryptionMaterialsInput::GetEncryptionMaterialsInput {..} =>
            crate::types::GetEncryptionMaterialsInput::builder()
 ...
 .set_algorithm_suite_id(match (*dafny_value.algorithmSuiteId()).as_ref() {
    crate::r#_Wrappers_Compile::Option::Some { value } =>
        Some(crate::conversions::algorithm_suite_id::from_dafny(value.clone())),
    _ => None,
}
)
...
pub fn option_from_dafny(
    dafny_value: ::std::rc::Rc<crate::_Wrappers_Compile::Option<::std::rc::Rc<
        crate::r#software::amazon::cryptography::materialproviders::internaldafny::types::GetEncryptionMaterialsInput,
    >>>,
) -> ::std::option::Option<crate::types::GetEncryptionMaterialsInput> {
    match &*dafny_value {
