...
#[allow(dead_code)]
pub fn to_dafny(
    value: &crate::types::InitializeDecryptionMaterialsInput,
) -> ::std::rc::Rc<
...
pub fn option_to_dafny(
  value: ::std::option::Option<crate::types::InitializeDecryptionMaterialsInput>,
...
pub fn plain_from_dafny(
    ...
    match dafny_value {
        crate::r#software::amazon::cryptography::materialproviders::internaldafny::types::InitializeDecryptionMaterialsInput::InitializeDecryptionMaterialsInput {..} =>
            crate::types::InitializeDecryptionMaterialsInput::builder()
...
pub fn option_from_dafny(
    dafny_value: ::std::rc::Rc<crate::_Wrappers_Compile::Option<::std::rc::Rc<
        crate::r#software::amazon::cryptography::materialproviders::internaldafny::types::InitializeDecryptionMaterialsInput,
    >>>,
) -> ::std::option::Option<crate::types::InitializeDecryptionMaterialsInput> {
    match &*dafny_value {
