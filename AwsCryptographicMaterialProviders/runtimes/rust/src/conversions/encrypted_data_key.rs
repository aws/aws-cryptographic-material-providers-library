...
#[allow(dead_code)]
pub fn to_dafny(
    value: &crate::types::EncryptedDataKey,
) -> ::std::rc::Rc<
...
pub fn option_to_dafny(
  value: ::std::option::Option<crate::types::EncryptedDataKey>,
...
pub fn plain_from_dafny(
    ...
    match dafny_value {
        crate::r#software::amazon::cryptography::materialproviders::internaldafny::types::EncryptedDataKey::EncryptedDataKey {..} =>
            crate::types::EncryptedDataKey::builder()
                .set_key_provider_id(Some(::std::string::String::from_utf8(dafny_runtime::dafny_runtime_conversions::dafny_sequence_to_vec(&dafny_value.keyProviderId(), |b| *b)).unwrap()))
...
pub fn option_from_dafny(
    dafny_value: ::std::rc::Rc<crate::_Wrappers_Compile::Option<::std::rc::Rc<
        crate::r#software::amazon::cryptography::materialproviders::internaldafny::types::EncryptedDataKey,
    >>>,
) -> ::std::option::Option<crate::types::EncryptedDataKey> {
    match &*dafny_value {
