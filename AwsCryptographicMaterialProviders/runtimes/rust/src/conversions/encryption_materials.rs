...
#[allow(dead_code)]
pub fn to_dafny(
    value: &crate::types::EncryptionMaterials,
) -> ::std::rc::Rc<
...
pub fn option_to_dafny(
  value: ::std::option::Option<crate::types::EncryptionMaterials>,
...
pub fn plain_from_dafny(
    ...
    match dafny_value {
        crate::r#software::amazon::cryptography::materialproviders::internaldafny::types::EncryptionMaterials::EncryptionMaterials {..} =>
            crate::types::EncryptionMaterials::builder()
                .set_algorithm_suite(Some( crate::conversions::algorithm_suite_info::from_dafny(dafny_value.algorithmSuite().clone())
 ))
