...
impl Client {
    ...
    #[track_caller]
    pub fn from_conf(
        conf: crate::types::material_providers_config::MaterialProvidersConfig,
    ) -> Result<Self, BuildError> {
        let inner =
            crate::software::amazon::cryptography::materialproviders::internaldafny::_default::MaterialProviders(
                &crate::conversions::material_providers_config::_material_providers_config::to_dafny(conf),
            );
        if matches!(
            inner.as_ref(),
