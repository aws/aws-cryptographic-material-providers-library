...
impl GetEncryptionMaterialsInput {
    /// Creates a new builder-style object to manufacture [`GetEncryptionMaterialsInput`](crate::types::GetEncryptionMaterialsInput).
    pub fn builder() -> crate::types::builders::GetEncryptionMaterialsInputBuilder {
        crate::types::builders::GetEncryptionMaterialsInputBuilder::default()
    }
}

/// A builder for [`GetEncryptionMaterialsInput`](crate::types::GetEncryptionMaterialsInput).
#[non_exhaustive]
#[derive(
...
pub fn get_required_encryption_context_keys(&self) -> &::std::option::Option<::std::vec::Vec<::std::string::String>> {
    ...
    /// Consumes the builder and constructs a [`GetEncryptionMaterialsInput`](crate::types::GetEncryptionMaterialsInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::types::GetEncryptionMaterialsInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::types::GetEncryptionMaterialsInput {
