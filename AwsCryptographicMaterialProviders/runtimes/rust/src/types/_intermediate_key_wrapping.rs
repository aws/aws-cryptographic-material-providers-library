...
impl IntermediateKeyWrapping {
    #[allow(missing_docs)] // documentation missing in model
pub fn key_encryption_key_kdf(&self) -> &::std::option::Option<crate::types::DerivationAlgorithm> {
...
impl IntermediateKeyWrappingBuilder {
    #[allow(missing_docs)] // documentation missing in model
pub fn key_encryption_key_kdf(mut self, input: impl ::std::convert::Into<crate::types::DerivationAlgorithm>) -> Self {
    self.key_encryption_key_kdf = ::std::option::Option::Some(input.into());
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn set_key_encryption_key_kdf(mut self, input: ::std::option::Option<crate::types::DerivationAlgorithm>) -> Self {
    self.key_encryption_key_kdf = input;
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn get_key_encryption_key_kdf(&self) -> &::std::option::Option<crate::types::DerivationAlgorithm> {
    &self.key_encryption_key_kdf
}
#[allow(missing_docs)] // documentation missing in model
pub fn mac_key_kdf(mut self, input: impl ::std::convert::Into<crate::types::DerivationAlgorithm>) -> Self {
    self.mac_key_kdf = ::std::option::Option::Some(input.into());
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn set_mac_key_kdf(mut self, input: ::std::option::Option<crate::types::DerivationAlgorithm>) -> Self {
...
#[allow(missing_docs)] // documentation missing in model
pub fn pdk_encrypt_algorithm(mut self, input: impl ::std::convert::Into<crate::types::Encrypt>) -> Self {
    self.pdk_encrypt_algorithm = ::std::option::Option::Some(input.into());
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn set_pdk_encrypt_algorithm(mut self, input: ::std::option::Option<crate::types::Encrypt>) -> Self {
