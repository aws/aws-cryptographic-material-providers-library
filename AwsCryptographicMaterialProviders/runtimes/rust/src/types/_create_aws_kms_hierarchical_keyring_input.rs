...
#[allow(missing_docs)] // documentation missing in model
pub branch_key_id_supplier: ::std::option::Option<crate::types::branch_key_id_supplier::BranchKeyIdSupplierRef>,
#[allow(missing_docs)] // documentation missing in model
pub cache: ::std::option::Option<crate::types::CacheType>,
#[allow(missing_docs)] // documentation missing in model
...
#[allow(missing_docs)] // documentation missing in model
pub fn branch_key_id_supplier(&self) -> &::std::option::Option<crate::types::branch_key_id_supplier::BranchKeyIdSupplierRef> {
    &self.branch_key_id_supplier
}
#[allow(missing_docs)] // documentation missing in model
pub fn cache(&self) -> &::std::option::Option<crate::types::CacheType> {
    &self.cache
}
#[allow(missing_docs)] // documentation missing in model
...
impl CreateAwsKmsHierarchicalKeyringInput {
    /// Creates a new builder-style object to manufacture [`CreateAwsKmsHierarchicalKeyringInput`](crate::types::CreateAwsKmsHierarchicalKeyringInput).
    pub fn builder() -> crate::types::builders::CreateAwsKmsHierarchicalKeyringInputBuilder {
        crate::types::builders::CreateAwsKmsHierarchicalKeyringInputBuilder::default()
    }
}

/// A builder for [`CreateAwsKmsHierarchicalKeyringInput`](crate::types::CreateAwsKmsHierarchicalKeyringInput).
#[non_exhaustive]
#[derive(
...
pub(crate) branch_key_id_supplier: ::std::option::Option<crate::types::branch_key_id_supplier::BranchKeyIdSupplierRef>,
pub(crate) cache: ::std::option::Option<crate::types::CacheType>,
...
#[allow(missing_docs)] // documentation missing in model
pub fn branch_key_id_supplier(mut self, input: impl ::std::convert::Into<crate::types::branch_key_id_supplier::BranchKeyIdSupplierRef>) -> Self {
    self.branch_key_id_supplier = ::std::option::Option::Some(input.into());
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn set_branch_key_id_supplier(mut self, input: ::std::option::Option<crate::types::branch_key_id_supplier::BranchKeyIdSupplierRef>) -> Self {
    self.branch_key_id_supplier = input;
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn get_branch_key_id_supplier(&self) -> &::std::option::Option<crate::types::branch_key_id_supplier::BranchKeyIdSupplierRef> {
    &self.branch_key_id_supplier
}
#[allow(missing_docs)] // documentation missing in model
pub fn cache(mut self, input: impl ::std::convert::Into<crate::types::CacheType>) -> Self {
    self.cache = ::std::option::Option::Some(input.into());
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn set_cache(mut self, input: ::std::option::Option<crate::types::CacheType>) -> Self {
    self.cache = input;
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn get_cache(&self) -> &::std::option::Option<crate::types::CacheType> {
    &self.cache
}
#[allow(missing_docs)] // documentation missing in model
...
pub fn get_ttl_seconds(&self) -> &::std::option::Option<::std::primitive::i64> {
    ...
    /// Consumes the builder and constructs a [`CreateAwsKmsHierarchicalKeyringInput`](crate::types::CreateAwsKmsHierarchicalKeyringInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::types::CreateAwsKmsHierarchicalKeyringInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::types::CreateAwsKmsHierarchicalKeyringInput {
