...
impl crate::types::branch_key_id_supplier::BranchKeyIdSupplierRef {
    ...
    pub fn get_branch_key_id(&self) -> crate::operation::get_branch_key_id::builders::GetBranchKeyIdFluentBuilder {
        crate::operation::get_branch_key_id::builders::GetBranchKeyIdFluentBuilder::new(self.clone())
    }
}
