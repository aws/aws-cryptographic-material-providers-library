...
#[allow(missing_docs)] // documentation missing in model
pub padding_scheme: ::std::option::Option<crate::types::PaddingScheme>,
#[allow(missing_docs)] // documentation missing in model
...
#[allow(missing_docs)] // documentation missing in model
pub fn padding_scheme(&self) -> &::std::option::Option<crate::types::PaddingScheme> {
    &self.padding_scheme
}
#[allow(missing_docs)] // documentation missing in model
...
impl CreateRawRsaKeyringInput {
    /// Creates a new builder-style object to manufacture [`CreateRawRsaKeyringInput`](crate::types::CreateRawRsaKeyringInput).
    pub fn builder() -> crate::types::builders::CreateRawRsaKeyringInputBuilder {
        crate::types::builders::CreateRawRsaKeyringInputBuilder::default()
    }
}

/// A builder for [`CreateRawRsaKeyringInput`](crate::types::CreateRawRsaKeyringInput).
#[non_exhaustive]
#[derive(
...
pub(crate) padding_scheme: ::std::option::Option<crate::types::PaddingScheme>,
...
#[allow(missing_docs)] // documentation missing in model
pub fn padding_scheme(mut self, input: impl ::std::convert::Into<crate::types::PaddingScheme>) -> Self {
    self.padding_scheme = ::std::option::Option::Some(input.into());
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn set_padding_scheme(mut self, input: ::std::option::Option<crate::types::PaddingScheme>) -> Self {
    self.padding_scheme = input;
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn get_padding_scheme(&self) -> &::std::option::Option<crate::types::PaddingScheme> {
    &self.padding_scheme
}
#[allow(missing_docs)] // documentation missing in model
...
pub fn get_public_key(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    /// Consumes the builder and constructs a [`CreateRawRsaKeyringInput`](crate::types::CreateRawRsaKeyringInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::types::CreateRawRsaKeyringInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::types::CreateRawRsaKeyringInput {
