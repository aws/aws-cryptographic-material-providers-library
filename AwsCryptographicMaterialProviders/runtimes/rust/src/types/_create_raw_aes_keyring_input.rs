...
#[allow(missing_docs)] // documentation missing in model
pub wrapping_alg: ::std::option::Option<crate::types::AesWrappingAlg>,
#[allow(missing_docs)] // documentation missing in model
...
#[allow(missing_docs)] // documentation missing in model
pub fn wrapping_alg(&self) -> &::std::option::Option<crate::types::AesWrappingAlg> {
    &self.wrapping_alg
}
#[allow(missing_docs)] // documentation missing in model
...
impl CreateRawAesKeyringInput {
    /// Creates a new builder-style object to manufacture [`CreateRawAesKeyringInput`](crate::types::CreateRawAesKeyringInput).
    pub fn builder() -> crate::types::builders::CreateRawAesKeyringInputBuilder {
        crate::types::builders::CreateRawAesKeyringInputBuilder::default()
    }
}

/// A builder for [`CreateRawAesKeyringInput`](crate::types::CreateRawAesKeyringInput).
#[non_exhaustive]
#[derive(
...
pub(crate) wrapping_alg: ::std::option::Option<crate::types::AesWrappingAlg>,
...
#[allow(missing_docs)] // documentation missing in model
pub fn wrapping_alg(mut self, input: impl ::std::convert::Into<crate::types::AesWrappingAlg>) -> Self {
    self.wrapping_alg = ::std::option::Option::Some(input.into());
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn set_wrapping_alg(mut self, input: ::std::option::Option<crate::types::AesWrappingAlg>) -> Self {
    self.wrapping_alg = input;
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn get_wrapping_alg(&self) -> &::std::option::Option<crate::types::AesWrappingAlg> {
    &self.wrapping_alg
}
#[allow(missing_docs)] // documentation missing in model
...
pub fn get_wrapping_key(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    /// Consumes the builder and constructs a [`CreateRawAesKeyringInput`](crate::types::CreateRawAesKeyringInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::types::CreateRawAesKeyringInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::types::CreateRawAesKeyringInput {
