...
impl InitializeEncryptionMaterialsInput {
    /// Creates a new builder-style object to manufacture [`InitializeEncryptionMaterialsInput`](crate::types::InitializeEncryptionMaterialsInput).
    pub fn builder() -> crate::types::builders::InitializeEncryptionMaterialsInputBuilder {
        crate::types::builders::InitializeEncryptionMaterialsInputBuilder::default()
    }
}

/// A builder for [`InitializeEncryptionMaterialsInput`](crate::types::InitializeEncryptionMaterialsInput).
#[non_exhaustive]
#[derive(
...
pub fn get_verification_key(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    /// Consumes the builder and constructs a [`InitializeEncryptionMaterialsInput`](crate::types::InitializeEncryptionMaterialsInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::types::InitializeEncryptionMaterialsInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::types::InitializeEncryptionMaterialsInput {
