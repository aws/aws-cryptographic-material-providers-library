...
impl CreateAwsKmsMrkMultiKeyringInput {
    /// Creates a new builder-style object to manufacture [`CreateAwsKmsMrkMultiKeyringInput`](crate::types::CreateAwsKmsMrkMultiKeyringInput).
    pub fn builder() -> crate::types::builders::CreateAwsKmsMrkMultiKeyringInputBuilder {
        crate::types::builders::CreateAwsKmsMrkMultiKeyringInputBuilder::default()
    }
}

/// A builder for [`CreateAwsKmsMrkMultiKeyringInput`](crate::types::CreateAwsKmsMrkMultiKeyringInput).
#[non_exhaustive]
#[derive(
...
pub fn get_kms_key_ids(&self) -> &::std::option::Option<::std::vec::Vec<::std::string::String>> {
    ...
    /// Consumes the builder and constructs a [`CreateAwsKmsMrkMultiKeyringInput`](crate::types::CreateAwsKmsMrkMultiKeyringInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::types::CreateAwsKmsMrkMultiKeyringInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::types::CreateAwsKmsMrkMultiKeyringInput {
