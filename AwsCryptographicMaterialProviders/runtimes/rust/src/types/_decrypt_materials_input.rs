...
pub struct DecryptMaterialsInput {
    #[allow(missing_docs)] // documentation missing in model
pub algorithm_suite_id: ::std::option::Option<crate::types::AlgorithmSuiteId>,
#[allow(missing_docs)] // documentation missing in model
pub commitment_policy: ::std::option::Option<crate::types::CommitmentPolicy>,
#[allow(missing_docs)] // documentation missing in model
pub encrypted_data_keys: ::std::option::Option<::std::vec::Vec<crate::types::EncryptedDataKey>>,
#[allow(missing_docs)] // documentation missing in model
...
impl DecryptMaterialsInput {
    #[allow(missing_docs)] // documentation missing in model
pub fn algorithm_suite_id(&self) -> &::std::option::Option<crate::types::AlgorithmSuiteId> {
...
#[allow(missing_docs)] // documentation missing in model
pub fn encrypted_data_keys(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::EncryptedDataKey>> {
...
impl DecryptMaterialsInput {
    /// Creates a new builder-style object to manufacture [`DecryptMaterialsInput`](crate::types::DecryptMaterialsInput).
    pub fn builder() -> crate::types::builders::DecryptMaterialsInputBuilder {
        crate::types::builders::DecryptMaterialsInputBuilder::default()
    }
}

/// A builder for [`DecryptMaterialsInput`](crate::types::DecryptMaterialsInput).
#[non_exhaustive]
#[derive(
    ::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug,
)]
pub struct DecryptMaterialsInputBuilder {
    pub(crate) algorithm_suite_id: ::std::option::Option<crate::types::AlgorithmSuiteId>,
pub(crate) commitment_policy: ::std::option::Option<crate::types::CommitmentPolicy>,
pub(crate) encrypted_data_keys: ::std::option::Option<::std::vec::Vec<crate::types::EncryptedDataKey>>,
...
impl DecryptMaterialsInputBuilder {
    #[allow(missing_docs)] // documentation missing in model
pub fn algorithm_suite_id(mut self, input: impl ::std::convert::Into<crate::types::AlgorithmSuiteId>) -> Self {
    self.algorithm_suite_id = ::std::option::Option::Some(input.into());
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn set_algorithm_suite_id(mut self, input: ::std::option::Option<crate::types::AlgorithmSuiteId>) -> Self {
    self.algorithm_suite_id = input;
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn get_algorithm_suite_id(&self) -> &::std::option::Option<crate::types::AlgorithmSuiteId> {
    &self.algorithm_suite_id
}
#[allow(missing_docs)] // documentation missing in model
pub fn commitment_policy(mut self, input: impl ::std::convert::Into<crate::types::CommitmentPolicy>) -> Self {
    self.commitment_policy = ::std::option::Option::Some(input.into());
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn set_commitment_policy(mut self, input: ::std::option::Option<crate::types::CommitmentPolicy>) -> Self {
...
#[allow(missing_docs)] // documentation missing in model
pub fn encrypted_data_keys(mut self, input: impl ::std::convert::Into<::std::vec::Vec<crate::types::EncryptedDataKey>>) -> Self {
    self.encrypted_data_keys = ::std::option::Option::Some(input.into());
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn set_encrypted_data_keys(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::EncryptedDataKey>>) -> Self {
    self.encrypted_data_keys = input;
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn get_encrypted_data_keys(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::EncryptedDataKey>> {
    &self.encrypted_data_keys
}
#[allow(missing_docs)] // documentation missing in model
...
pub fn get_reproduced_encryption_context(&self) -> &::std::option::Option<::std::collections::HashMap<::std::string::String, ::std::string::String>> {
    ...
    /// Consumes the builder and constructs a [`DecryptMaterialsInput`](crate::types::DecryptMaterialsInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::types::DecryptMaterialsInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::types::DecryptMaterialsInput {
