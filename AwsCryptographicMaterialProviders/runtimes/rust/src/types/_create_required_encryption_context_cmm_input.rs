...
#[allow(missing_docs)] // documentation missing in model
pub underlying_cmm: ::std::option::Option<crate::types::cryptographic_materials_manager::CryptographicMaterialsManagerRef>,
}
...
#[allow(missing_docs)] // documentation missing in model
pub fn underlying_cmm(&self) -> &::std::option::Option<crate::types::cryptographic_materials_manager::CryptographicMaterialsManagerRef> {
    &self.underlying_cmm
}
}
impl CreateRequiredEncryptionContextCmmInput {
    /// Creates a new builder-style object to manufacture [`CreateRequiredEncryptionContextCmmInput`](crate::types::CreateRequiredEncryptionContextCmmInput).
    pub fn builder() -> crate::types::builders::CreateRequiredEncryptionContextCmmInputBuilder {
        crate::types::builders::CreateRequiredEncryptionContextCmmInputBuilder::default()
    }
}

/// A builder for [`CreateRequiredEncryptionContextCmmInput`](crate::types::CreateRequiredEncryptionContextCmmInput).
#[non_exhaustive]
#[derive(
...
pub(crate) underlying_cmm: ::std::option::Option<crate::types::cryptographic_materials_manager::CryptographicMaterialsManagerRef>,
}
...
#[allow(missing_docs)] // documentation missing in model
pub fn underlying_cmm(mut self, input: impl ::std::convert::Into<crate::types::cryptographic_materials_manager::CryptographicMaterialsManagerRef>) -> Self {
    self.underlying_cmm = ::std::option::Option::Some(input.into());
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn set_underlying_cmm(mut self, input: ::std::option::Option<crate::types::cryptographic_materials_manager::CryptographicMaterialsManagerRef>) -> Self {
    self.underlying_cmm = input;
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn get_underlying_cmm(&self) -> &::std::option::Option<crate::types::cryptographic_materials_manager::CryptographicMaterialsManagerRef> {
    &self.underlying_cmm
}
    /// Consumes the builder and constructs a [`CreateRequiredEncryptionContextCmmInput`](crate::types::CreateRequiredEncryptionContextCmmInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::types::CreateRequiredEncryptionContextCmmInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::types::CreateRequiredEncryptionContextCmmInput {
