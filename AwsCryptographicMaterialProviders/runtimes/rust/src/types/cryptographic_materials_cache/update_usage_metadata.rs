...
impl crate::types::cryptographic_materials_cache::CryptographicMaterialsCacheRef {
    ...
    pub fn update_usage_metadata(&self) -> crate::operation::update_usage_metadata::builders::UpdateUsageMetadataFluentBuilder {
        crate::operation::update_usage_metadata::builders::UpdateUsageMetadataFluentBuilder::new(self.clone())
    }
}
