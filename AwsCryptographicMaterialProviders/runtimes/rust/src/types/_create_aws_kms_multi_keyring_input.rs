...
impl CreateAwsKmsMultiKeyringInput {
    /// Creates a new builder-style object to manufacture [`CreateAwsKmsMultiKeyringInput`](crate::types::CreateAwsKmsMultiKeyringInput).
    pub fn builder() -> crate::types::builders::CreateAwsKmsMultiKeyringInputBuilder {
        crate::types::builders::CreateAwsKmsMultiKeyringInputBuilder::default()
    }
}

/// A builder for [`CreateAwsKmsMultiKeyringInput`](crate::types::CreateAwsKmsMultiKeyringInput).
#[non_exhaustive]
#[derive(
...
pub fn get_kms_key_ids(&self) -> &::std::option::Option<::std::vec::Vec<::std::string::String>> {
    ...
    /// Consumes the builder and constructs a [`CreateAwsKmsMultiKeyringInput`](crate::types::CreateAwsKmsMultiKeyringInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::types::CreateAwsKmsMultiKeyringInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::types::CreateAwsKmsMultiKeyringInput {
