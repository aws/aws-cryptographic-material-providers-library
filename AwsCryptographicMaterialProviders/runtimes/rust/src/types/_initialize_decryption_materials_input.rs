...
impl InitializeDecryptionMaterialsInput {
    /// Creates a new builder-style object to manufacture [`InitializeDecryptionMaterialsInput`](crate::types::InitializeDecryptionMaterialsInput).
    pub fn builder() -> crate::types::builders::InitializeDecryptionMaterialsInputBuilder {
        crate::types::builders::InitializeDecryptionMaterialsInputBuilder::default()
    }
}

/// A builder for [`InitializeDecryptionMaterialsInput`](crate::types::InitializeDecryptionMaterialsInput).
#[non_exhaustive]
#[derive(
...
pub fn get_required_encryption_context_keys(&self) -> &::std::option::Option<::std::vec::Vec<::std::string::String>> {
    ...
    /// Consumes the builder and constructs a [`InitializeDecryptionMaterialsInput`](crate::types::InitializeDecryptionMaterialsInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::types::InitializeDecryptionMaterialsInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::types::InitializeDecryptionMaterialsInput {
