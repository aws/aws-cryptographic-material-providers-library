...
pub struct EncryptionMaterials {
    #[allow(missing_docs)] // documentation missing in model
pub algorithm_suite: ::std::option::Option<crate::types::AlgorithmSuiteInfo>,
#[allow(missing_docs)] // documentation missing in model
...
impl EncryptionMaterials {
    #[allow(missing_docs)] // documentation missing in model
pub fn algorithm_suite(&self) -> &::std::option::Option<crate::types::AlgorithmSuiteInfo> {
...
impl EncryptionMaterials {
    /// Creates a new builder-style object to manufacture [`EncryptionMaterials`](crate::types::EncryptionMaterials).
    pub fn builder() -> crate::types::builders::EncryptionMaterialsBuilder {
        crate::types::builders::EncryptionMaterialsBuilder::default()
    }
}

/// A builder for [`EncryptionMaterials`](crate::types::EncryptionMaterials).
#[non_exhaustive]
#[derive(
    ::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug,
)]
pub struct EncryptionMaterialsBuilder {
    pub(crate) algorithm_suite: ::std::option::Option<crate::types::AlgorithmSuiteInfo>,
...
impl EncryptionMaterialsBuilder {
    #[allow(missing_docs)] // documentation missing in model
pub fn algorithm_suite(mut self, input: impl ::std::convert::Into<crate::types::AlgorithmSuiteInfo>) -> Self {
    self.algorithm_suite = ::std::option::Option::Some(input.into());
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn set_algorithm_suite(mut self, input: ::std::option::Option<crate::types::AlgorithmSuiteInfo>) -> Self {
    self.algorithm_suite = input;
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn get_algorithm_suite(&self) -> &::std::option::Option<crate::types::AlgorithmSuiteInfo> {
    &self.algorithm_suite
}
#[allow(missing_docs)] // documentation missing in model
...
pub fn get_symmetric_signing_keys(&self) -> &::std::option::Option<::std::vec::Vec<::aws_smithy_types::Blob>> {
    ...
    /// Consumes the builder and constructs a [`EncryptionMaterials`](crate::types::EncryptionMaterials).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::types::EncryptionMaterials,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::types::EncryptionMaterials {
