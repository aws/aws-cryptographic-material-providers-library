...
pub struct CreateAwsKmsEcdhKeyringInput {
    #[allow(missing_docs)] // documentation missing in model
pub key_agreement_scheme: ::std::option::Option<crate::types::KmsEcdhStaticConfigurations>,
#[allow(missing_docs)] // documentation missing in model
...
impl CreateAwsKmsEcdhKeyringInput {
    #[allow(missing_docs)] // documentation missing in model
pub fn key_agreement_scheme(&self) -> &::std::option::Option<crate::types::KmsEcdhStaticConfigurations> {
...
impl CreateAwsKmsEcdhKeyringInput {
    /// Creates a new builder-style object to manufacture [`CreateAwsKmsEcdhKeyringInput`](crate::types::CreateAwsKmsEcdhKeyringInput).
    pub fn builder() -> crate::types::builders::CreateAwsKmsEcdhKeyringInputBuilder {
        crate::types::builders::CreateAwsKmsEcdhKeyringInputBuilder::default()
    }
}

/// A builder for [`CreateAwsKmsEcdhKeyringInput`](crate::types::CreateAwsKmsEcdhKeyringInput).
#[non_exhaustive]
#[derive(
    ::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug,
)]
pub struct CreateAwsKmsEcdhKeyringInputBuilder {
    pub(crate) key_agreement_scheme: ::std::option::Option<crate::types::KmsEcdhStaticConfigurations>,
...
impl CreateAwsKmsEcdhKeyringInputBuilder {
    #[allow(missing_docs)] // documentation missing in model
pub fn key_agreement_scheme(mut self, input: impl ::std::convert::Into<crate::types::KmsEcdhStaticConfigurations>) -> Self {
    self.key_agreement_scheme = ::std::option::Option::Some(input.into());
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn set_key_agreement_scheme(mut self, input: ::std::option::Option<crate::types::KmsEcdhStaticConfigurations>) -> Self {
    self.key_agreement_scheme = input;
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn get_key_agreement_scheme(&self) -> &::std::option::Option<crate::types::KmsEcdhStaticConfigurations> {
    &self.key_agreement_scheme
}
#[allow(missing_docs)] // documentation missing in model
...
pub fn get_kms_client(&self) -> &::std::option::Option<crate::deps::com_amazonaws_kms::client::Client> {
    ...
    /// Consumes the builder and constructs a [`CreateAwsKmsEcdhKeyringInput`](crate::types::CreateAwsKmsEcdhKeyringInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::types::CreateAwsKmsEcdhKeyringInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::types::CreateAwsKmsEcdhKeyringInput {
