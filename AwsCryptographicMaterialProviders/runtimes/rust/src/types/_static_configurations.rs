...
pub fn as_aws_kms_ecdh(&self) -> ::std::result::Result<&crate::types::KmsEcdhStaticConfigurations, &Self> {
...
/// Returns `Err(&Self)` if it can't be converted.
pub fn as_raw_ecdh(&self) -> ::std::result::Result<&crate::types::RawEcdhStaticConfigurations, &Self> {
