...
impl GetEncryptionMaterialsOutput {
    #[allow(missing_docs)] // documentation missing in model
pub fn encryption_materials(&self) -> &::std::option::Option<crate::types::EncryptionMaterials> {
...
impl GetEncryptionMaterialsOutputBuilder {
    #[allow(missing_docs)] // documentation missing in model
pub fn encryption_materials(mut self, input: impl ::std::convert::Into<crate::types::EncryptionMaterials>) -> Self {
    self.encryption_materials = ::std::option::Option::Some(input.into());
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn set_encryption_materials(mut self, input: ::std::option::Option<crate::types::EncryptionMaterials>) -> Self {
    self.encryption_materials = input;
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn get_encryption_materials(&self) -> &::std::option::Option<crate::types::EncryptionMaterials> {
    &self.encryption_materials
}
