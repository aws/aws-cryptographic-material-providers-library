...
pub use crate::operation::get_cache_entry::_get_cache_entry_output::GetCacheEntryOutputBuilder;

pub use crate::operation::get_cache_entry::_get_cache_entry_input::GetCacheEntryInputBuilder;
...
pub struct GetCacheEntryFluentBuilder {
    cryptographic_materials_cache: crate::types::cryptographic_materials_cache::CryptographicMaterialsCacheRef,
    pub(crate) inner: crate::operation::get_cache_entry::builders::GetCacheEntryInputBuilder,
}
impl GetCacheEntryFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::get_cache_entry::builders::GetCacheEntryInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::get_cache_entry::GetCacheEntry::send(&self.cryptographic_materials_cache, input).await
    }
