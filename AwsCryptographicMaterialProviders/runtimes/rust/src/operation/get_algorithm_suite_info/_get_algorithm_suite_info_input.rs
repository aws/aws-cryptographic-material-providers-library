...
impl GetAlgorithmSuiteInfoInput {
    ...
    pub fn builder() -> crate::operation::get_algorithm_suite_info::builders::GetAlgorithmSuiteInfoInputBuilder {
        crate::operation::get_algorithm_suite_info::builders::GetAlgorithmSuiteInfoInputBuilder::default()
    }
}
...
pub fn get_binary_id(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::get_algorithm_suite_info::GetAlgorithmSuiteInfoInput {
