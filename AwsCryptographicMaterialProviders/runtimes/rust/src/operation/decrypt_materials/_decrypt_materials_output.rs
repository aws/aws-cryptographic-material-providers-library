...
impl DecryptMaterialsOutput {
    #[allow(missing_docs)] // documentation missing in model
pub fn decryption_materials(&self) -> &::std::option::Option<crate::types::DecryptionMaterials> {
...
impl DecryptMaterialsOutputBuilder {
    #[allow(missing_docs)] // documentation missing in model
pub fn decryption_materials(mut self, input: impl ::std::convert::Into<crate::types::DecryptionMaterials>) -> Self {
    self.decryption_materials = ::std::option::Option::Some(input.into());
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn set_decryption_materials(mut self, input: ::std::option::Option<crate::types::DecryptionMaterials>) -> Self {
    self.decryption_materials = input;
    self
}
#[allow(missing_docs)] // documentation missing in model
pub fn get_decryption_materials(&self) -> &::std::option::Option<crate::types::DecryptionMaterials> {
    &self.decryption_materials
}
