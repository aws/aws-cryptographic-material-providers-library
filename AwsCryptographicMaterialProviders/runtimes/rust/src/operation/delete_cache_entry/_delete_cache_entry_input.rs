...
impl DeleteCacheEntryInput {
    ...
    pub fn builder() -> crate::operation::delete_cache_entry::builders::DeleteCacheEntryInputBuilder {
        crate::operation::delete_cache_entry::builders::DeleteCacheEntryInputBuilder::default()
    }
}
...
pub fn get_identifier(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    > {
        ::std::result::Result::Ok(crate::operation::delete_cache_entry::DeleteCacheEntryInput {
