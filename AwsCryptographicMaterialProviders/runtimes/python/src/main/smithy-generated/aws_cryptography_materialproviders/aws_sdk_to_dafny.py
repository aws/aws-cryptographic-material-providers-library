...
def AwsSdkToDafny_com_amazonaws_dynamodb_ImportTableInput(input):
    return DafnyImportTableInput(
        ...
        S3BucketSource=com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_S3BucketSource(input["S3BucketSource"]),
        InputFormat=Seq(input["InputFormat"]),
        InputFormatOptions=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_InputFormatOptions(input["InputFormatOptions"])) if "InputFormatOptions" in input.keys() else Option_None(),
        InputCompressionType=Option_Some(Seq(input["InputCompressionType"])) if "InputCompressionType" in input.keys() else Option_None(),
        TableCreationParameters=com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_TableCreationParameters(input["TableCreationParameters"]),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_InputFormatOptions(input):
    return DafnyInputFormatOptions(
        Csv=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_CsvOptions(input["Csv"])) if "Csv" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_TableCreationParameters(input):
    return DafnyTableCreationParameters(
        ...
        AttributeDefinitions=Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AttributeDefinition(list_element) for list_element in input["AttributeDefinitions"]]),
        KeySchema=Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_KeySchemaElement(list_element) for list_element in input["KeySchema"]]),
        BillingMode=Option_Some(Seq(input["BillingMode"])) if "BillingMode" in input.keys() else Option_None(),
        ProvisionedThroughput=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ProvisionedThroughput(input["ProvisionedThroughput"])) if "ProvisionedThroughput" in input.keys() else Option_None(),
        SSESpecification=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_SSESpecification(input["SSESpecification"])) if "SSESpecification" in input.keys() else Option_None(),
        GlobalSecondaryIndexes=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_GlobalSecondaryIndex(list_element) for list_element in input["GlobalSecondaryIndexes"]])) if "GlobalSecondaryIndexes" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_GlobalSecondaryIndex(input):
    return DafnyGlobalSecondaryIndex(
        ...
        KeySchema=Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_KeySchemaElement(list_element) for list_element in input["KeySchema"]]),
        Projection=com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_Projection(input["Projection"]),
        ProvisionedThroughput=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ProvisionedThroughput(input["ProvisionedThroughput"])) if "ProvisionedThroughput" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_UpdateContinuousBackupsInput(input):
    return DafnyUpdateContinuousBackupsInput(
        TableName=Seq(input["TableName"]),
        PointInTimeRecoverySpecification=com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_PointInTimeRecoverySpecification(input["PointInTimeRecoverySpecification"]),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_UpdateGlobalTableSettingsInput(input):
    return DafnyUpdateGlobalTableSettingsInput(
        ...
        GlobalTableProvisionedWriteCapacityAutoScalingSettingsUpdate=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AutoScalingSettingsUpdate(input["GlobalTableProvisionedWriteCapacityAutoScalingSettingsUpdate"])) if "GlobalTableProvisionedWriteCapacityAutoScalingSettingsUpdate" in input.keys() else Option_None(),
        GlobalTableGlobalSecondaryIndexSettingsUpdate=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_GlobalTableGlobalSecondaryIndexSettingsUpdate(list_element) for list_element in input["GlobalTableGlobalSecondaryIndexSettingsUpdate"]])) if "GlobalTableGlobalSecondaryIndexSettingsUpdate" in input.keys() else Option_None(),
        ReplicaSettingsUpdate=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ReplicaSettingsUpdate(list_element) for list_element in input["ReplicaSettingsUpdate"]])) if "ReplicaSettingsUpdate" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_AutoScalingSettingsUpdate(input):
    return DafnyAutoScalingSettingsUpdate(
        ...
        ScalingPolicyUpdate=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AutoScalingPolicyUpdate(input["ScalingPolicyUpdate"])) if "ScalingPolicyUpdate" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_AutoScalingPolicyUpdate(input):
    return DafnyAutoScalingPolicyUpdate(
        ...
        TargetTrackingScalingPolicyConfiguration=com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AutoScalingTargetTrackingScalingPolicyConfigurationUpdate(input["TargetTrackingScalingPolicyConfiguration"]),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_ReplicaSettingsUpdate(input):
    return DafnyReplicaSettingsUpdate(
        ...
        ReplicaGlobalSecondaryIndexSettingsUpdate=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ReplicaGlobalSecondaryIndexSettingsUpdate(list_element) for list_element in input["ReplicaGlobalSecondaryIndexSettingsUpdate"]])) if "ReplicaGlobalSecondaryIndexSettingsUpdate" in input.keys() else Option_None(),
...
def AwsSdkToDafny_com_amazonaws_kms_CreateGrantRequest(input):
    return DafnyCreateGrantRequest(
        ...
        Operations=Seq([Seq(list_element) for list_element in input["Operations"]]),
        Constraints=Option_Some(com_amazonaws_kms.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_kms_GrantConstraints(input["Constraints"])) if "Constraints" in input.keys() else Option_None(),
...
def AwsSdkToDafny_com_amazonaws_kms_SignRequest(input):
    return DafnySignRequest(
        ...
        MessageType=Option_Some(Seq(input["MessageType"])) if "MessageType" in input.keys() else Option_None(),
        GrantTokens=Option_Some(Seq([Seq(list_element) for list_element in input["GrantTokens"]])) if "GrantTokens" in input.keys() else Option_None(),
        SigningAlgorithm=Seq(input["SigningAlgorithm"]),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_QueryInput(input):
    return DafnyQueryInput(
        ...
        KeyConditions=Option_Some(Map({Seq(key): com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_Condition(value) for (key, value) in input["KeyConditions"].items() })) if "KeyConditions" in input.keys() else Option_None(),
        QueryFilter=Option_Some(Map({Seq(key): com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_Condition(value) for (key, value) in input["QueryFilter"].items() })) if "QueryFilter" in input.keys() else Option_None(),
        ...
        ExclusiveStartKey=Option_Some(Map({Seq(key): com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in input["ExclusiveStartKey"].items() })) if "ExclusiveStartKey" in input.keys() else Option_None(),
        ...
        ExpressionAttributeValues=Option_Some(Map({Seq(key): com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in input["ExpressionAttributeValues"].items() })) if "ExpressionAttributeValues" in input.keys() else Option_None(),
    )

def AwsSdkToDafny_com_amazonaws_dynamodb_Condition(input):
    return DafnyCondition(
        AttributeValueList=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AttributeValue(list_element) for list_element in input["AttributeValueList"]])) if "AttributeValueList" in input.keys() else Option_None(),
...
def AwsSdkToDafny_com_amazonaws_dynamodb_AttributeValue(input):
    if "S" in input.keys():
        ...
        AttributeValue_union_value = AttributeValue_M(Map({Seq(key): com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in input["M"].items() }))
    elif "L" in input.keys():
        AttributeValue_union_value = AttributeValue_L(Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AttributeValue(list_element) for list_element in input["L"]]))
...
def AwsSdkToDafny_com_amazonaws_kms_GenerateDataKeyPairWithoutPlaintextRequest(input):
    return DafnyGenerateDataKeyPairWithoutPlaintextRequest(
        ...
        KeyId=Seq(input["KeyId"]),
        KeyPairSpec=Seq(input["KeyPairSpec"]),
        GrantTokens=Option_Some(Seq([Seq(list_element) for list_element in input["GrantTokens"]])) if "GrantTokens" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_GetItemInput(input):
    return DafnyGetItemInput(
        TableName=Seq(input["TableName"]),
        Key=Map({Seq(key): com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in input["Key"].items() }),
        AttributesToGet=Option_Some(Seq([Seq(list_element) for list_element in input["AttributesToGet"]])) if "AttributesToGet" in input.keys() else Option_None(),
        ConsistentRead=Option_Some(input["ConsistentRead"]) if "ConsistentRead" in input.keys() else Option_None(),
        ReturnConsumedCapacity=Option_Some(Seq(input["ReturnConsumedCapacity"])) if "ReturnConsumedCapacity" in input.keys() else Option_None(),
        ProjectionExpression=Option_Some(Seq(input["ProjectionExpression"])) if "ProjectionExpression" in input.keys() else Option_None(),
...
def AwsSdkToDafny_com_amazonaws_kms_CreateKeyRequest(input):
    return DafnyCreateKeyRequest(
        ...
        CustomKeyStoreId=Option_Some(Seq(input["CustomKeyStoreId"])) if "CustomKeyStoreId" in input.keys() else Option_None(),
        BypassPolicyLockoutSafetyCheck=Option_Some(input["BypassPolicyLockoutSafetyCheck"]) if "BypassPolicyLockoutSafetyCheck" in input.keys() else Option_None(),
        Tags=Option_Some(Seq([com_amazonaws_kms.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_kms_Tag(list_element) for list_element in input["Tags"]])) if "Tags" in input.keys() else Option_None(),
...
def AwsSdkToDafny_com_amazonaws_dynamodb_RestoreTableToPointInTimeInput(input):
    return DafnyRestoreTableToPointInTimeInput(
        ...
        GlobalSecondaryIndexOverride=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_GlobalSecondaryIndex(list_element) for list_element in input["GlobalSecondaryIndexOverride"]])) if "GlobalSecondaryIndexOverride" in input.keys() else Option_None(),
        LocalSecondaryIndexOverride=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_LocalSecondaryIndex(list_element) for list_element in input["LocalSecondaryIndexOverride"]])) if "LocalSecondaryIndexOverride" in input.keys() else Option_None(),
        ProvisionedThroughputOverride=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ProvisionedThroughput(input["ProvisionedThroughputOverride"])) if "ProvisionedThroughputOverride" in input.keys() else Option_None(),
        SSESpecificationOverride=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_SSESpecification(input["SSESpecificationOverride"])) if "SSESpecificationOverride" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_ExecuteTransactionInput(input):
    return DafnyExecuteTransactionInput(
        TransactStatements=Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ParameterizedStatement(list_element) for list_element in input["TransactStatements"]]),
...
def AwsSdkToDafny_com_amazonaws_dynamodb_ParameterizedStatement(input):
    return DafnyParameterizedStatement(
        ...
        Parameters=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AttributeValue(list_element) for list_element in input["Parameters"]])) if "Parameters" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_BatchWriteItemInput(input):
    return DafnyBatchWriteItemInput(
        RequestItems=Map({Seq(key): Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_WriteRequest(list_element) for list_element in value]) for (key, value) in input["RequestItems"].items() }),
        ReturnConsumedCapacity=Option_Some(Seq(input["ReturnConsumedCapacity"])) if "ReturnConsumedCapacity" in input.keys() else Option_None(),
...
def AwsSdkToDafny_com_amazonaws_dynamodb_WriteRequest(input):
    return DafnyWriteRequest(
        PutRequest=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_PutRequest(input["PutRequest"])) if "PutRequest" in input.keys() else Option_None(),
        DeleteRequest=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_DeleteRequest(input["DeleteRequest"])) if "DeleteRequest" in input.keys() else Option_None(),
    )

def AwsSdkToDafny_com_amazonaws_dynamodb_PutRequest(input):
    return DafnyPutRequest(
        Item=Map({Seq(key): com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in input["Item"].items() }),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_BatchExecuteStatementInput(input):
    return DafnyBatchExecuteStatementInput(
        Statements=Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_BatchStatementRequest(list_element) for list_element in input["Statements"]]),
        ReturnConsumedCapacity=Option_Some(Seq(input["ReturnConsumedCapacity"])) if "ReturnConsumedCapacity" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_TransactGetItemsInput(input):
    return DafnyTransactGetItemsInput(
        TransactItems=Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_TransactGetItem(list_element) for list_element in input["TransactItems"]]),
        ReturnConsumedCapacity=Option_Some(Seq(input["ReturnConsumedCapacity"])) if "ReturnConsumedCapacity" in input.keys() else Option_None(),
    )

def AwsSdkToDafny_com_amazonaws_dynamodb_TransactGetItem(input):
    return DafnyTransactGetItem(
        Get=com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_Get(input["Get"]),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_TagResourceInput(input):
    return DafnyTagResourceInput(
        ResourceArn=Seq(input["ResourceArn"]),
        Tags=Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_Tag(list_element) for list_element in input["Tags"]]),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_UpdateTimeToLiveInput(input):
    return DafnyUpdateTimeToLiveInput(
        TableName=Seq(input["TableName"]),
        TimeToLiveSpecification=com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_TimeToLiveSpecification(input["TimeToLiveSpecification"]),
    )
...
def AwsSdkToDafny_com_amazonaws_kms_GetParametersForImportRequest(input):
    return DafnyGetParametersForImportRequest(
        KeyId=Seq(input["KeyId"]),
        WrappingAlgorithm=Seq(input["WrappingAlgorithm"]),
        WrappingKeySpec=Seq(input["WrappingKeySpec"]),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_TransactWriteItemsInput(input):
    return DafnyTransactWriteItemsInput(
        TransactItems=Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_TransactWriteItem(list_element) for list_element in input["TransactItems"]]),
        ReturnConsumedCapacity=Option_Some(Seq(input["ReturnConsumedCapacity"])) if "ReturnConsumedCapacity" in input.keys() else Option_None(),
        ReturnItemCollectionMetrics=Option_Some(Seq(input["ReturnItemCollectionMetrics"])) if "ReturnItemCollectionMetrics" in input.keys() else Option_None(),
        ClientRequestToken=Option_Some(Seq(input["ClientRequestToken"])) if "ClientRequestToken" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_TransactWriteItem(input):
    return DafnyTransactWriteItem(
        ConditionCheck=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ConditionCheck(input["ConditionCheck"])) if "ConditionCheck" in input.keys() else Option_None(),
        Put=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_Put(input["Put"])) if "Put" in input.keys() else Option_None(),
        Delete=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_Delete(input["Delete"])) if "Delete" in input.keys() else Option_None(),
        Update=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_Update(input["Update"])) if "Update" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_CreateGlobalTableInput(input):
    return DafnyCreateGlobalTableInput(
        GlobalTableName=Seq(input["GlobalTableName"]),
        ReplicationGroup=Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_Replica(list_element) for list_element in input["ReplicationGroup"]]),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_UpdateTableInput(input):
    return DafnyUpdateTableInput(
        AttributeDefinitions=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AttributeDefinition(list_element) for list_element in input["AttributeDefinitions"]])) if "AttributeDefinitions" in input.keys() else Option_None(),
        TableName=Seq(input["TableName"]),
        BillingMode=Option_Some(Seq(input["BillingMode"])) if "BillingMode" in input.keys() else Option_None(),
        ProvisionedThroughput=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ProvisionedThroughput(input["ProvisionedThroughput"])) if "ProvisionedThroughput" in input.keys() else Option_None(),
        GlobalSecondaryIndexUpdates=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_GlobalSecondaryIndexUpdate(list_element) for list_element in input["GlobalSecondaryIndexUpdates"]])) if "GlobalSecondaryIndexUpdates" in input.keys() else Option_None(),
        StreamSpecification=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_StreamSpecification(input["StreamSpecification"])) if "StreamSpecification" in input.keys() else Option_None(),
        SSESpecification=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_SSESpecification(input["SSESpecification"])) if "SSESpecification" in input.keys() else Option_None(),
        ReplicaUpdates=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ReplicationGroupUpdate(list_element) for list_element in input["ReplicaUpdates"]])) if "ReplicaUpdates" in input.keys() else Option_None(),
...
def AwsSdkToDafny_com_amazonaws_dynamodb_GlobalSecondaryIndexUpdate(input):
    return DafnyGlobalSecondaryIndexUpdate(
        Update=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_UpdateGlobalSecondaryIndexAction(input["Update"])) if "Update" in input.keys() else Option_None(),
        Create=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_CreateGlobalSecondaryIndexAction(input["Create"])) if "Create" in input.keys() else Option_None(),
        Delete=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_DeleteGlobalSecondaryIndexAction(input["Delete"])) if "Delete" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_UpdateGlobalSecondaryIndexAction(input):
    return DafnyUpdateGlobalSecondaryIndexAction(
        IndexName=Seq(input["IndexName"]),
        ProvisionedThroughput=com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ProvisionedThroughput(input["ProvisionedThroughput"]),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_ReplicationGroupUpdate(input):
    return DafnyReplicationGroupUpdate(
        Create=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_CreateReplicationGroupMemberAction(input["Create"])) if "Create" in input.keys() else Option_None(),
        Update=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_UpdateReplicationGroupMemberAction(input["Update"])) if "Update" in input.keys() else Option_None(),
        Delete=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_DeleteReplicationGroupMemberAction(input["Delete"])) if "Delete" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_CreateReplicationGroupMemberAction(input):
    return DafnyCreateReplicationGroupMemberAction(
        RegionName=Seq(input["RegionName"]),
        KMSMasterKeyId=Option_Some(Seq(input["KMSMasterKeyId"])) if "KMSMasterKeyId" in input.keys() else Option_None(),
        ProvisionedThroughputOverride=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ProvisionedThroughputOverride(input["ProvisionedThroughputOverride"])) if "ProvisionedThroughputOverride" in input.keys() else Option_None(),
        GlobalSecondaryIndexes=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ReplicaGlobalSecondaryIndex(list_element) for list_element in input["GlobalSecondaryIndexes"]])) if "GlobalSecondaryIndexes" in input.keys() else Option_None(),
...
def AwsSdkToDafny_com_amazonaws_dynamodb_BatchGetItemInput(input):
    return DafnyBatchGetItemInput(
        RequestItems=Map({Seq(key): com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_KeysAndAttributes(value) for (key, value) in input["RequestItems"].items() }),
        ReturnConsumedCapacity=Option_Some(Seq(input["ReturnConsumedCapacity"])) if "ReturnConsumedCapacity" in input.keys() else Option_None(),
    )

def AwsSdkToDafny_com_amazonaws_dynamodb_KeysAndAttributes(input):
    return DafnyKeysAndAttributes(
        Keys=Seq([Map({Seq(key): com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in list_element.items() }) for list_element in input["Keys"]]),
        AttributesToGet=Option_Some(Seq([Seq(list_element) for list_element in input["AttributesToGet"]])) if "AttributesToGet" in input.keys() else Option_None(),
        ConsistentRead=Option_Some(input["ConsistentRead"]) if "ConsistentRead" in input.keys() else Option_None(),
        ProjectionExpression=Option_Some(Seq(input["ProjectionExpression"])) if "ProjectionExpression" in input.keys() else Option_None(),
        ExpressionAttributeNames=Option_Some(Map({Seq(key): Seq(value) for (key, value) in input["ExpressionAttributeNames"].items() })) if "ExpressionAttributeNames" in input.keys() else Option_None(),
...
def AwsSdkToDafny_com_amazonaws_dynamodb_PutItemInput(input):
    return DafnyPutItemInput(
        TableName=Seq(input["TableName"]),
        Item=Map({Seq(key): com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in input["Item"].items() }),
        Expected=Option_Some(Map({Seq(key): com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ExpectedAttributeValue(value) for (key, value) in input["Expected"].items() })) if "Expected" in input.keys() else Option_None(),
...
def AwsSdkToDafny_com_amazonaws_dynamodb_ExpectedAttributeValue(input):
    return DafnyExpectedAttributeValue(
        Value=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AttributeValue(input["Value"])) if "Value" in input.keys() else Option_None(),
...
def AwsSdkToDafny_com_amazonaws_kms_TagResourceRequest(input):
    return DafnyTagResourceRequest(
        KeyId=Seq(input["KeyId"]),
        Tags=Seq([com_amazonaws_kms.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_kms_Tag(list_element) for list_element in input["Tags"]]),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_CreateTableInput(input):
    return DafnyCreateTableInput(
        ...
        TableName=Seq(input["TableName"]),
        KeySchema=Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_KeySchemaElement(list_element) for list_element in input["KeySchema"]]),
        LocalSecondaryIndexes=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_LocalSecondaryIndex(list_element) for list_element in input["LocalSecondaryIndexes"]])) if "LocalSecondaryIndexes" in input.keys() else Option_None(),
        GlobalSecondaryIndexes=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_GlobalSecondaryIndex(list_element) for list_element in input["GlobalSecondaryIndexes"]])) if "GlobalSecondaryIndexes" in input.keys() else Option_None(),
        BillingMode=Option_Some(Seq(input["BillingMode"])) if "BillingMode" in input.keys() else Option_None(),
        ProvisionedThroughput=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ProvisionedThroughput(input["ProvisionedThroughput"])) if "ProvisionedThroughput" in input.keys() else Option_None(),
        StreamSpecification=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_StreamSpecification(input["StreamSpecification"])) if "StreamSpecification" in input.keys() else Option_None(),
        SSESpecification=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_SSESpecification(input["SSESpecification"])) if "SSESpecification" in input.keys() else Option_None(),
        Tags=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_Tag(list_element) for list_element in input["Tags"]])) if "Tags" in input.keys() else Option_None(),
        TableClass=Option_Some(Seq(input["TableClass"])) if "TableClass" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_UpdateTableReplicaAutoScalingInput(input):
    return DafnyUpdateTableReplicaAutoScalingInput(
        GlobalSecondaryIndexUpdates=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_GlobalSecondaryIndexAutoScalingUpdate(list_element) for list_element in input["GlobalSecondaryIndexUpdates"]])) if "GlobalSecondaryIndexUpdates" in input.keys() else Option_None(),
        TableName=Seq(input["TableName"]),
        ProvisionedWriteCapacityAutoScalingUpdate=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AutoScalingSettingsUpdate(input["ProvisionedWriteCapacityAutoScalingUpdate"])) if "ProvisionedWriteCapacityAutoScalingUpdate" in input.keys() else Option_None(),
        ReplicaUpdates=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ReplicaAutoScalingUpdate(list_element) for list_element in input["ReplicaUpdates"]])) if "ReplicaUpdates" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_ReplicaAutoScalingUpdate(input):
    return DafnyReplicaAutoScalingUpdate(
        RegionName=Seq(input["RegionName"]),
        ReplicaGlobalSecondaryIndexUpdates=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ReplicaGlobalSecondaryIndexAutoScalingUpdate(list_element) for list_element in input["ReplicaGlobalSecondaryIndexUpdates"]])) if "ReplicaGlobalSecondaryIndexUpdates" in input.keys() else Option_None(),
...
def AwsSdkToDafny_com_amazonaws_dynamodb_ReplicaGlobalSecondaryIndexAutoScalingUpdate(input):
    return DafnyReplicaGlobalSecondaryIndexAutoScalingUpdate(
        IndexName=Option_Some(Seq(input["IndexName"])) if "IndexName" in input.keys() else Option_None(),
        ProvisionedReadCapacityAutoScalingUpdate=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AutoScalingSettingsUpdate(input["ProvisionedReadCapacityAutoScalingUpdate"])) if "ProvisionedReadCapacityAutoScalingUpdate" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_UpdateItemInput(input):
    return DafnyUpdateItemInput(
        TableName=Seq(input["TableName"]),
        Key=Map({Seq(key): com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in input["Key"].items() }),
        AttributeUpdates=Option_Some(Map({Seq(key): com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AttributeValueUpdate(value) for (key, value) in input["AttributeUpdates"].items() })) if "AttributeUpdates" in input.keys() else Option_None(),
        Expected=Option_Some(Map({Seq(key): com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ExpectedAttributeValue(value) for (key, value) in input["Expected"].items() })) if "Expected" in input.keys() else Option_None(),
        ConditionalOperator=Option_Some(Seq(input["ConditionalOperator"])) if "ConditionalOperator" in input.keys() else Option_None(),
        ReturnValues=Option_Some(Seq(input["ReturnValues"])) if "ReturnValues" in input.keys() else Option_None(),
        ReturnConsumedCapacity=Option_Some(Seq(input["ReturnConsumedCapacity"])) if "ReturnConsumedCapacity" in input.keys() else Option_None(),
...
def AwsSdkToDafny_com_amazonaws_dynamodb_ScanInput(input):
    return DafnyScanInput(
        ...
        Limit=Option_Some(input["Limit"]) if "Limit" in input.keys() else Option_None(),
        Select=Option_Some(Seq(input["Select"])) if "Select" in input.keys() else Option_None(),
        ScanFilter=Option_Some(Map({Seq(key): com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_Condition(value) for (key, value) in input["ScanFilter"].items() })) if "ScanFilter" in input.keys() else Option_None(),
        ConditionalOperator=Option_Some(Seq(input["ConditionalOperator"])) if "ConditionalOperator" in input.keys() else Option_None(),
        ExclusiveStartKey=Option_Some(Map({Seq(key): com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in input["ExclusiveStartKey"].items() })) if "ExclusiveStartKey" in input.keys() else Option_None(),
        ReturnConsumedCapacity=Option_Some(Seq(input["ReturnConsumedCapacity"])) if "ReturnConsumedCapacity" in input.keys() else Option_None(),
...
def AwsSdkToDafny_com_amazonaws_dynamodb_UpdateGlobalTableInput(input):
    return DafnyUpdateGlobalTableInput(
        GlobalTableName=Seq(input["GlobalTableName"]),
        ReplicaUpdates=Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ReplicaUpdate(list_element) for list_element in input["ReplicaUpdates"]]),
    )

def AwsSdkToDafny_com_amazonaws_dynamodb_ReplicaUpdate(input):
    return DafnyReplicaUpdate(
        Create=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_CreateReplicaAction(input["Create"])) if "Create" in input.keys() else Option_None(),
        Delete=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_DeleteReplicaAction(input["Delete"])) if "Delete" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_ImportTableOutput(input):
    return DafnyImportTableOutput(
        ImportTableDescription=com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ImportTableDescription(input["ImportTableDescription"]),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_ImportTableDescription(input):
    return DafnyImportTableDescription(
        ...
        ClientToken=Option_Some(Seq(input["ClientToken"])) if "ClientToken" in input.keys() else Option_None(),
        S3BucketSource=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_S3BucketSource(input["S3BucketSource"])) if "S3BucketSource" in input.keys() else Option_None(),
        ...
        InputFormatOptions=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_InputFormatOptions(input["InputFormatOptions"])) if "InputFormatOptions" in input.keys() else Option_None(),
        InputCompressionType=Option_Some(Seq(input["InputCompressionType"])) if "InputCompressionType" in input.keys() else Option_None(),
        TableCreationParameters=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_TableCreationParameters(input["TableCreationParameters"])) if "TableCreationParameters" in input.keys() else Option_None(),
...
def AwsSdkToDafny_com_amazonaws_dynamodb_ListContributorInsightsOutput(input):
    return DafnyListContributorInsightsOutput(
        ContributorInsightsSummaries=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ContributorInsightsSummary(list_element) for list_element in input["ContributorInsightsSummaries"]])) if "ContributorInsightsSummaries" in input.keys() else Option_None(),
        NextToken=Option_Some(Seq(input["NextToken"])) if "NextToken" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_UpdateContinuousBackupsOutput(input):
    return DafnyUpdateContinuousBackupsOutput(
        ContinuousBackupsDescription=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ContinuousBackupsDescription(input["ContinuousBackupsDescription"])) if "ContinuousBackupsDescription" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_ContinuousBackupsDescription(input):
    return DafnyContinuousBackupsDescription(
        ...
        PointInTimeRecoveryDescription=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_PointInTimeRecoveryDescription(input["PointInTimeRecoveryDescription"])) if "PointInTimeRecoveryDescription" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_DescribeEndpointsResponse(input):
    return DafnyDescribeEndpointsResponse(
        Endpoints=Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_Endpoint(list_element) for list_element in input["Endpoints"]]),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_DescribeGlobalTableOutput(input):
    return DafnyDescribeGlobalTableOutput(
        GlobalTableDescription=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_GlobalTableDescription(input["GlobalTableDescription"])) if "GlobalTableDescription" in input.keys() else Option_None(),
    )

def AwsSdkToDafny_com_amazonaws_dynamodb_GlobalTableDescription(input):
    return DafnyGlobalTableDescription(
        ReplicationGroup=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ReplicaDescription(list_element) for list_element in input["ReplicationGroup"]])) if "ReplicationGroup" in input.keys() else Option_None(),
...
def AwsSdkToDafny_com_amazonaws_dynamodb_ReplicaDescription(input):
    return DafnyReplicaDescription(
        ...
        KMSMasterKeyId=Option_Some(Seq(input["KMSMasterKeyId"])) if "KMSMasterKeyId" in input.keys() else Option_None(),
        ProvisionedThroughputOverride=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ProvisionedThroughputOverride(input["ProvisionedThroughputOverride"])) if "ProvisionedThroughputOverride" in input.keys() else Option_None(),
        GlobalSecondaryIndexes=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ReplicaGlobalSecondaryIndexDescription(list_element) for list_element in input["GlobalSecondaryIndexes"]])) if "GlobalSecondaryIndexes" in input.keys() else Option_None(),
        ...
        ReplicaTableClassSummary=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_TableClassSummary(input["ReplicaTableClassSummary"])) if "ReplicaTableClassSummary" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_ListImportsOutput(input):
    return DafnyListImportsOutput(
        ImportSummaryList=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ImportSummary(list_element) for list_element in input["ImportSummaryList"]])) if "ImportSummaryList" in input.keys() else Option_None(),
        NextToken=Option_Some(Seq(input["NextToken"])) if "NextToken" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_UpdateGlobalTableSettingsOutput(input):
    return DafnyUpdateGlobalTableSettingsOutput(
        GlobalTableName=Option_Some(Seq(input["GlobalTableName"])) if "GlobalTableName" in input.keys() else Option_None(),
        ReplicaSettings=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ReplicaSettingsDescription(list_element) for list_element in input["ReplicaSettings"]])) if "ReplicaSettings" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_ReplicaSettingsDescription(input):
    return DafnyReplicaSettingsDescription(
        RegionName=Seq(input["RegionName"]),
        ReplicaStatus=Option_Some(Seq(input["ReplicaStatus"])) if "ReplicaStatus" in input.keys() else Option_None(),
        ReplicaBillingModeSummary=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_BillingModeSummary(input["ReplicaBillingModeSummary"])) if "ReplicaBillingModeSummary" in input.keys() else Option_None(),
        ReplicaProvisionedReadCapacityUnits=Option_Some(input["ReplicaProvisionedReadCapacityUnits"]) if "ReplicaProvisionedReadCapacityUnits" in input.keys() else Option_None(),
        ReplicaProvisionedReadCapacityAutoScalingSettings=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AutoScalingSettingsDescription(input["ReplicaProvisionedReadCapacityAutoScalingSettings"])) if "ReplicaProvisionedReadCapacityAutoScalingSettings" in input.keys() else Option_None(),
        ...
        ReplicaGlobalSecondaryIndexSettings=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ReplicaGlobalSecondaryIndexSettingsDescription(list_element) for list_element in input["ReplicaGlobalSecondaryIndexSettings"]])) if "ReplicaGlobalSecondaryIndexSettings" in input.keys() else Option_None(),
        ReplicaTableClassSummary=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_TableClassSummary(input["ReplicaTableClassSummary"])) if "ReplicaTableClassSummary" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_AutoScalingSettingsDescription(input):
    return DafnyAutoScalingSettingsDescription(
        ...
        AutoScalingDisabled=Option_Some(input["AutoScalingDisabled"]) if "AutoScalingDisabled" in input.keys() else Option_None(),
        AutoScalingRoleArn=Option_Some(Seq(input["AutoScalingRoleArn"])) if "AutoScalingRoleArn" in input.keys() else Option_None(),
        ScalingPolicies=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AutoScalingPolicyDescription(list_element) for list_element in input["ScalingPolicies"]])) if "ScalingPolicies" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_kms_DescribeCustomKeyStoresResponse(input):
    return DafnyDescribeCustomKeyStoresResponse(
        CustomKeyStores=Option_Some(Seq([com_amazonaws_kms.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_kms_CustomKeyStoresListEntry(list_element) for list_element in input["CustomKeyStores"]])) if "CustomKeyStores" in input.keys() else Option_None(),
        NextMarker=Option_Some(Seq(input["NextMarker"])) if "NextMarker" in input.keys() else Option_None(),
        Truncated=Option_Some(input["Truncated"]) if "Truncated" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_kms_ListGrantsResponse(input):
    return DafnyListGrantsResponse(
        Grants=Option_Some(Seq([com_amazonaws_kms.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_kms_GrantListEntry(list_element) for list_element in input["Grants"]])) if "Grants" in input.keys() else Option_None(),
        NextMarker=Option_Some(Seq(input["NextMarker"])) if "NextMarker" in input.keys() else Option_None(),
        Truncated=Option_Some(input["Truncated"]) if "Truncated" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_kms_GrantListEntry(input):
    return DafnyGrantListEntry(
        ...
        Operations=Option_Some(Seq([Seq(list_element) for list_element in input["Operations"]])) if "Operations" in input.keys() else Option_None(),
        Constraints=Option_Some(com_amazonaws_kms.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_kms_GrantConstraints(input["Constraints"])) if "Constraints" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_DescribeKinesisStreamingDestinationOutput(input):
    return DafnyDescribeKinesisStreamingDestinationOutput(
        TableName=Option_Some(Seq(input["TableName"])) if "TableName" in input.keys() else Option_None(),
        KinesisDataStreamDestinations=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_KinesisDataStreamDestination(list_element) for list_element in input["KinesisDataStreamDestinations"]])) if "KinesisDataStreamDestinations" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_QueryOutput(input):
    return DafnyQueryOutput(
        Items=Option_Some(Seq([Map({Seq(key): com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in list_element.items() }) for list_element in input["Items"]])) if "Items" in input.keys() else Option_None(),
        ...
        LastEvaluatedKey=Option_Some(Map({Seq(key): com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in input["LastEvaluatedKey"].items() })) if "LastEvaluatedKey" in input.keys() else Option_None(),
        ConsumedCapacity=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ConsumedCapacity(input["ConsumedCapacity"])) if "ConsumedCapacity" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_ConsumedCapacity(input):
    return DafnyConsumedCapacity(
        ...
        Table=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_Capacity(input["Table"])) if "Table" in input.keys() else Option_None(),
        LocalSecondaryIndexes=Option_Some(Map({Seq(key): com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_Capacity(value) for (key, value) in input["LocalSecondaryIndexes"].items() })) if "LocalSecondaryIndexes" in input.keys() else Option_None(),
        GlobalSecondaryIndexes=Option_Some(Map({Seq(key): com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_Capacity(value) for (key, value) in input["GlobalSecondaryIndexes"].items() })) if "GlobalSecondaryIndexes" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_GetItemOutput(input):
    return DafnyGetItemOutput(
        Item=Option_Some(Map({Seq(key): com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in input["Item"].items() })) if "Item" in input.keys() else Option_None(),
        ConsumedCapacity=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ConsumedCapacity(input["ConsumedCapacity"])) if "ConsumedCapacity" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_kms_CreateKeyResponse(input):
    return DafnyCreateKeyResponse(
        KeyMetadata=Option_Some(com_amazonaws_kms.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_kms_KeyMetadata(input["KeyMetadata"])) if "KeyMetadata" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_kms_KeyMetadata(input):
    return DafnyKeyMetadata(
        ...
        CustomerMasterKeySpec=Option_Some(Seq(input["CustomerMasterKeySpec"])) if "CustomerMasterKeySpec" in input.keys() else Option_None(),
        KeySpec=Option_Some(Seq(input["KeySpec"])) if "KeySpec" in input.keys() else Option_None(),
        EncryptionAlgorithms=Option_Some(Seq([Seq(list_element) for list_element in input["EncryptionAlgorithms"]])) if "EncryptionAlgorithms" in input.keys() else Option_None(),
        SigningAlgorithms=Option_Some(Seq([Seq(list_element) for list_element in input["SigningAlgorithms"]])) if "SigningAlgorithms" in input.keys() else Option_None(),
        MultiRegion=Option_Some(input["MultiRegion"]) if "MultiRegion" in input.keys() else Option_None(),
        MultiRegionConfiguration=Option_Some(com_amazonaws_kms.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_kms_MultiRegionConfiguration(input["MultiRegionConfiguration"])) if "MultiRegionConfiguration" in input.keys() else Option_None(),
...
def AwsSdkToDafny_com_amazonaws_kms_MultiRegionConfiguration(input):
    return DafnyMultiRegionConfiguration(
        ...
        PrimaryKey=Option_Some(com_amazonaws_kms.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_kms_MultiRegionKey(input["PrimaryKey"])) if "PrimaryKey" in input.keys() else Option_None(),
        ReplicaKeys=Option_Some(Seq([com_amazonaws_kms.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_kms_MultiRegionKey(list_element) for list_element in input["ReplicaKeys"]])) if "ReplicaKeys" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_DescribeTableReplicaAutoScalingOutput(input):
    return DafnyDescribeTableReplicaAutoScalingOutput(
        TableAutoScalingDescription=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_TableAutoScalingDescription(input["TableAutoScalingDescription"])) if "TableAutoScalingDescription" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_TableAutoScalingDescription(input):
    return DafnyTableAutoScalingDescription(
        ...
        Replicas=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ReplicaAutoScalingDescription(list_element) for list_element in input["Replicas"]])) if "Replicas" in input.keys() else Option_None(),
    )

def AwsSdkToDafny_com_amazonaws_dynamodb_ReplicaAutoScalingDescription(input):
    return DafnyReplicaAutoScalingDescription(
        RegionName=Option_Some(Seq(input["RegionName"])) if "RegionName" in input.keys() else Option_None(),
        GlobalSecondaryIndexes=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ReplicaGlobalSecondaryIndexAutoScalingDescription(list_element) for list_element in input["GlobalSecondaryIndexes"]])) if "GlobalSecondaryIndexes" in input.keys() else Option_None(),
        ReplicaProvisionedReadCapacityAutoScalingSettings=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AutoScalingSettingsDescription(input["ReplicaProvisionedReadCapacityAutoScalingSettings"])) if "ReplicaProvisionedReadCapacityAutoScalingSettings" in input.keys() else Option_None(),
        ReplicaProvisionedWriteCapacityAutoScalingSettings=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AutoScalingSettingsDescription(input["ReplicaProvisionedWriteCapacityAutoScalingSettings"])) if "ReplicaProvisionedWriteCapacityAutoScalingSettings" in input.keys() else Option_None(),
        ReplicaStatus=Option_Some(Seq(input["ReplicaStatus"])) if "ReplicaStatus" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_RestoreTableToPointInTimeOutput(input):
    return DafnyRestoreTableToPointInTimeOutput(
        TableDescription=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_TableDescription(input["TableDescription"])) if "TableDescription" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_TableDescription(input):
    return DafnyTableDescription(
        AttributeDefinitions=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AttributeDefinition(list_element) for list_element in input["AttributeDefinitions"]])) if "AttributeDefinitions" in input.keys() else Option_None(),
        TableName=Option_Some(Seq(input["TableName"])) if "TableName" in input.keys() else Option_None(),
        KeySchema=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_KeySchemaElement(list_element) for list_element in input["KeySchema"]])) if "KeySchema" in input.keys() else Option_None(),
        TableStatus=Option_Some(Seq(input["TableStatus"])) if "TableStatus" in input.keys() else Option_None(),
        CreationDateTime=Option_Some(TypeError("TimestampShape not supported")) if "CreationDateTime" in input.keys() else Option_None(),
        ProvisionedThroughput=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ProvisionedThroughputDescription(input["ProvisionedThroughput"])) if "ProvisionedThroughput" in input.keys() else Option_None(),
        ...
        TableArn=Option_Some(Seq(input["TableArn"])) if "TableArn" in input.keys() else Option_None(),
        TableId=Option_Some(Seq(input["TableId"])) if "TableId" in input.keys() else Option_None(),
        BillingModeSummary=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_BillingModeSummary(input["BillingModeSummary"])) if "BillingModeSummary" in input.keys() else Option_None(),
        LocalSecondaryIndexes=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_LocalSecondaryIndexDescription(list_element) for list_element in input["LocalSecondaryIndexes"]])) if "LocalSecondaryIndexes" in input.keys() else Option_None(),
        GlobalSecondaryIndexes=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_GlobalSecondaryIndexDescription(list_element) for list_element in input["GlobalSecondaryIndexes"]])) if "GlobalSecondaryIndexes" in input.keys() else Option_None(),
        StreamSpecification=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_StreamSpecification(input["StreamSpecification"])) if "StreamSpecification" in input.keys() else Option_None(),
        ...
        Replicas=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ReplicaDescription(list_element) for list_element in input["Replicas"]])) if "Replicas" in input.keys() else Option_None(),
        RestoreSummary=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_RestoreSummary(input["RestoreSummary"])) if "RestoreSummary" in input.keys() else Option_None(),
        SSEDescription=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_SSEDescription(input["SSEDescription"])) if "SSEDescription" in input.keys() else Option_None(),
        ArchivalSummary=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ArchivalSummary(input["ArchivalSummary"])) if "ArchivalSummary" in input.keys() else Option_None(),
        TableClassSummary=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_TableClassSummary(input["TableClassSummary"])) if "TableClassSummary" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_LocalSecondaryIndexDescription(input):
    return DafnyLocalSecondaryIndexDescription(
        IndexName=Option_Some(Seq(input["IndexName"])) if "IndexName" in input.keys() else Option_None(),
        KeySchema=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_KeySchemaElement(list_element) for list_element in input["KeySchema"]])) if "KeySchema" in input.keys() else Option_None(),
        Projection=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_Projection(input["Projection"])) if "Projection" in input.keys() else Option_None(),
...
def AwsSdkToDafny_com_amazonaws_dynamodb_ExecuteTransactionOutput(input):
    return DafnyExecuteTransactionOutput(
        Responses=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ItemResponse(list_element) for list_element in input["Responses"]])) if "Responses" in input.keys() else Option_None(),
        ConsumedCapacity=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ConsumedCapacity(list_element) for list_element in input["ConsumedCapacity"]])) if "ConsumedCapacity" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_kms_ReplicateKeyResponse(input):
    return DafnyReplicateKeyResponse(
        ReplicaKeyMetadata=Option_Some(com_amazonaws_kms.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_kms_KeyMetadata(input["ReplicaKeyMetadata"])) if "ReplicaKeyMetadata" in input.keys() else Option_None(),
        ReplicaPolicy=Option_Some(Seq(input["ReplicaPolicy"])) if "ReplicaPolicy" in input.keys() else Option_None(),
        ReplicaTags=Option_Some(Seq([com_amazonaws_kms.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_kms_Tag(list_element) for list_element in input["ReplicaTags"]])) if "ReplicaTags" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_DescribeContributorInsightsOutput(input):
    return DafnyDescribeContributorInsightsOutput(
        ...
        ContributorInsightsStatus=Option_Some(Seq(input["ContributorInsightsStatus"])) if "ContributorInsightsStatus" in input.keys() else Option_None(),
        LastUpdateDateTime=Option_Some(TypeError("TimestampShape not supported")) if "LastUpdateDateTime" in input.keys() else Option_None(),
        FailureException=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_FailureException(input["FailureException"])) if "FailureException" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_BatchWriteItemOutput(input):
    return DafnyBatchWriteItemOutput(
        UnprocessedItems=Option_Some(Map({Seq(key): Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_WriteRequest(list_element) for list_element in value]) for (key, value) in input["UnprocessedItems"].items() })) if "UnprocessedItems" in input.keys() else Option_None(),
        ItemCollectionMetrics=Option_Some(Map({Seq(key): Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ItemCollectionMetrics(list_element) for list_element in value]) for (key, value) in input["ItemCollectionMetrics"].items() })) if "ItemCollectionMetrics" in input.keys() else Option_None(),
        ConsumedCapacity=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ConsumedCapacity(list_element) for list_element in input["ConsumedCapacity"]])) if "ConsumedCapacity" in input.keys() else Option_None(),
    )

def AwsSdkToDafny_com_amazonaws_dynamodb_ItemCollectionMetrics(input):
    return DafnyItemCollectionMetrics(
        ItemCollectionKey=Option_Some(Map({Seq(key): com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in input["ItemCollectionKey"].items() })) if "ItemCollectionKey" in input.keys() else Option_None(),
...
def AwsSdkToDafny_com_amazonaws_dynamodb_BatchExecuteStatementOutput(input):
    return DafnyBatchExecuteStatementOutput(
        Responses=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_BatchStatementResponse(list_element) for list_element in input["Responses"]])) if "Responses" in input.keys() else Option_None(),
        ConsumedCapacity=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ConsumedCapacity(list_element) for list_element in input["ConsumedCapacity"]])) if "ConsumedCapacity" in input.keys() else Option_None(),
    )

def AwsSdkToDafny_com_amazonaws_dynamodb_BatchStatementResponse(input):
    return DafnyBatchStatementResponse(
        Error=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_BatchStatementError(input["Error"])) if "Error" in input.keys() else Option_None(),
        TableName=Option_Some(Seq(input["TableName"])) if "TableName" in input.keys() else Option_None(),
        Item=Option_Some(Map({Seq(key): com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in input["Item"].items() })) if "Item" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_ListExportsOutput(input):
    return DafnyListExportsOutput(
        ExportSummaries=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ExportSummary(list_element) for list_element in input["ExportSummaries"]])) if "ExportSummaries" in input.keys() else Option_None(),
        NextToken=Option_Some(Seq(input["NextToken"])) if "NextToken" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_DescribeTimeToLiveOutput(input):
    return DafnyDescribeTimeToLiveOutput(
        TimeToLiveDescription=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_TimeToLiveDescription(input["TimeToLiveDescription"])) if "TimeToLiveDescription" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_UpdateTimeToLiveOutput(input):
    return DafnyUpdateTimeToLiveOutput(
        TimeToLiveSpecification=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_TimeToLiveSpecification(input["TimeToLiveSpecification"])) if "TimeToLiveSpecification" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_CreateBackupOutput(input):
    return DafnyCreateBackupOutput(
        BackupDetails=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_BackupDetails(input["BackupDetails"])) if "BackupDetails" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_DescribeTableOutput(input):
    return DafnyDescribeTableOutput(
        Table=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_TableDescription(input["Table"])) if "Table" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_ExportTableToPointInTimeOutput(input):
    return DafnyExportTableToPointInTimeOutput(
        ExportDescription=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ExportDescription(input["ExportDescription"])) if "ExportDescription" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_DeleteBackupOutput(input):
    return DafnyDeleteBackupOutput(
        BackupDescription=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_BackupDescription(input["BackupDescription"])) if "BackupDescription" in input.keys() else Option_None(),
    )

def AwsSdkToDafny_com_amazonaws_dynamodb_BackupDescription(input):
    return DafnyBackupDescription(
        BackupDetails=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_BackupDetails(input["BackupDetails"])) if "BackupDetails" in input.keys() else Option_None(),
        SourceTableDetails=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_SourceTableDetails(input["SourceTableDetails"])) if "SourceTableDetails" in input.keys() else Option_None(),
        SourceTableFeatureDetails=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_SourceTableFeatureDetails(input["SourceTableFeatureDetails"])) if "SourceTableFeatureDetails" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_SourceTableFeatureDetails(input):
    return DafnySourceTableFeatureDetails(
        LocalSecondaryIndexes=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_LocalSecondaryIndexInfo(list_element) for list_element in input["LocalSecondaryIndexes"]])) if "LocalSecondaryIndexes" in input.keys() else Option_None(),
        GlobalSecondaryIndexes=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_GlobalSecondaryIndexInfo(list_element) for list_element in input["GlobalSecondaryIndexes"]])) if "GlobalSecondaryIndexes" in input.keys() else Option_None(),
        StreamDescription=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_StreamSpecification(input["StreamDescription"])) if "StreamDescription" in input.keys() else Option_None(),
        TimeToLiveDescription=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_TimeToLiveDescription(input["TimeToLiveDescription"])) if "TimeToLiveDescription" in input.keys() else Option_None(),
        SSEDescription=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_SSEDescription(input["SSEDescription"])) if "SSEDescription" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_BatchGetItemOutput(input):
    return DafnyBatchGetItemOutput(
        Responses=Option_Some(Map({Seq(key): Seq([Map({Seq(key): com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in list_element.items() }) for list_element in value]) for (key, value) in input["Responses"].items() })) if "Responses" in input.keys() else Option_None(),
        UnprocessedKeys=Option_Some(Map({Seq(key): com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_KeysAndAttributes(value) for (key, value) in input["UnprocessedKeys"].items() })) if "UnprocessedKeys" in input.keys() else Option_None(),
        ConsumedCapacity=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ConsumedCapacity(list_element) for list_element in input["ConsumedCapacity"]])) if "ConsumedCapacity" in input.keys() else Option_None(),
    )

def AwsSdkToDafny_com_amazonaws_dynamodb_PutItemOutput(input):
    return DafnyPutItemOutput(
        Attributes=Option_Some(Map({Seq(key): com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in input["Attributes"].items() })) if "Attributes" in input.keys() else Option_None(),
        ConsumedCapacity=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ConsumedCapacity(input["ConsumedCapacity"])) if "ConsumedCapacity" in input.keys() else Option_None(),
        ItemCollectionMetrics=Option_Some(com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ItemCollectionMetrics(input["ItemCollectionMetrics"])) if "ItemCollectionMetrics" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_kms_ListAliasesResponse(input):
    return DafnyListAliasesResponse(
        Aliases=Option_Some(Seq([com_amazonaws_kms.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_kms_AliasListEntry(list_element) for list_element in input["Aliases"]])) if "Aliases" in input.keys() else Option_None(),
        NextMarker=Option_Some(Seq(input["NextMarker"])) if "NextMarker" in input.keys() else Option_None(),
        Truncated=Option_Some(input["Truncated"]) if "Truncated" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_ListBackupsOutput(input):
    return DafnyListBackupsOutput(
        BackupSummaries=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_BackupSummary(list_element) for list_element in input["BackupSummaries"]])) if "BackupSummaries" in input.keys() else Option_None(),
...
def AwsSdkToDafny_com_amazonaws_dynamodb_ListGlobalTablesOutput(input):
    return DafnyListGlobalTablesOutput(
        GlobalTables=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_GlobalTable(list_element) for list_element in input["GlobalTables"]])) if "GlobalTables" in input.keys() else Option_None(),
...
def AwsSdkToDafny_com_amazonaws_dynamodb_GlobalTable(input):
    return DafnyGlobalTable(
        GlobalTableName=Option_Some(Seq(input["GlobalTableName"])) if "GlobalTableName" in input.keys() else Option_None(),
        ReplicationGroup=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_Replica(list_element) for list_element in input["ReplicationGroup"]])) if "ReplicationGroup" in input.keys() else Option_None(),
    )
