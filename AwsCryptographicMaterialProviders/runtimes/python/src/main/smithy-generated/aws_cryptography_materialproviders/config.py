...
def dafny_config_to_smithy_config(dafny_config) -> MaterialProvidersConfig:
    ...
    '''
    return aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.DafnyToSmithy_aws_cryptography_materialproviders_MaterialProvidersConfig(dafny_config)
...
def smithy_config_to_dafny_config(smithy_config) -> DafnyMaterialProvidersConfig:
    ...
    '''
    return aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.SmithyToDafny_aws_cryptography_materialproviders_MaterialProvidersConfig(smithy_config)
