...
import aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny
import module_
...
def SmithyToDafny_aws_cryptography_materialproviders_GetClientOutput(input):
    return aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.SmithyToDafny_aws_cryptography_materialproviders_KmsClientReference(input.client)
...
def SmithyToDafny_aws_cryptography_materialproviders_PutCacheEntryInput(input):
    return DafnyPutCacheEntryInput(
        ...
        materials=aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.SmithyToDafny_aws_cryptography_materialproviders_Materials(input.materials),
...
def SmithyToDafny_aws_cryptography_materialproviders_Materials(input):
    if isinstance(input, aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.MaterialsEncryption):
        Materials_union_value = Materials_Encryption(input.value)
    elif isinstance(input, aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.MaterialsDecryption):
        Materials_union_value = Materials_Decryption(input.value)
    elif isinstance(input, aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.MaterialsBranchKey):
        Materials_union_value = Materials_BranchKey(input.value)
    elif isinstance(input, aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.MaterialsBeaconKey):
...
def SmithyToDafny_aws_cryptography_materialproviders_GetEncryptionMaterialsInput(input):
    return DafnyGetEncryptionMaterialsInput(
        encryptionContext=Map({Seq(key): Seq(value) for (key, value) in input.encryption_context.items() }),
        commitmentPolicy=aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.SmithyToDafny_aws_cryptography_materialproviders_CommitmentPolicy(input.commitment_policy),
        algorithmSuiteId=((Option_Some(aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.SmithyToDafny_aws_cryptography_materialproviders_AlgorithmSuiteId(input.algorithm_suite_id))) if (input.algorithm_suite_id is not None) else (Option_None())),
...
def SmithyToDafny_aws_cryptography_materialproviders_CommitmentPolicy(input):
    if isinstance(input, aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.CommitmentPolicyESDK):
        CommitmentPolicy_union_value = CommitmentPolicy_ESDK(input.value)
    elif isinstance(input, aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.CommitmentPolicyDBE):
...
def SmithyToDafny_aws_cryptography_materialproviders_AlgorithmSuiteId(input):
    if isinstance(input, aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.AlgorithmSuiteIdESDK):
        AlgorithmSuiteId_union_value = AlgorithmSuiteId_ESDK(input.value)
    elif isinstance(input, aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.AlgorithmSuiteIdDBE):
...
def SmithyToDafny_aws_cryptography_materialproviders_GetEncryptionMaterialsOutput(input):
    return DafnyGetEncryptionMaterialsOutput(
        encryptionMaterials=aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.SmithyToDafny_aws_cryptography_materialproviders_EncryptionMaterials(input.encryption_materials),
    )

def SmithyToDafny_aws_cryptography_materialproviders_EncryptionMaterials(input):
    return DafnyEncryptionMaterials(
        algorithmSuite=aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.SmithyToDafny_aws_cryptography_materialproviders_AlgorithmSuiteInfo(input.algorithm_suite),
        encryptionContext=Map({Seq(key): Seq(value) for (key, value) in input.encryption_context.items() }),
        encryptedDataKeys=Seq([aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.SmithyToDafny_aws_cryptography_materialproviders_EncryptedDataKey(list_element) for list_element in input.encrypted_data_keys]),
...
def SmithyToDafny_aws_cryptography_materialproviders_AlgorithmSuiteInfo(input):
    return DafnyAlgorithmSuiteInfo(
        id=aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.SmithyToDafny_aws_cryptography_materialproviders_AlgorithmSuiteId(input.id),
        binaryId=Seq(input.binary_id),
        messageVersion=input.message_version,
        encrypt=aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.SmithyToDafny_aws_cryptography_materialproviders_Encrypt(input.encrypt),
        kdf=aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.SmithyToDafny_aws_cryptography_materialproviders_DerivationAlgorithm(input.kdf),
        commitment=aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.SmithyToDafny_aws_cryptography_materialproviders_DerivationAlgorithm(input.commitment),
        signature=aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.SmithyToDafny_aws_cryptography_materialproviders_SignatureAlgorithm(input.signature),
        symmetricSignature=aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.SmithyToDafny_aws_cryptography_materialproviders_SymmetricSignatureAlgorithm(input.symmetric_signature),
        edkWrapping=aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.SmithyToDafny_aws_cryptography_materialproviders_EdkWrappingAlgorithm(input.edk_wrapping),
    )
...
def SmithyToDafny_aws_cryptography_materialproviders_Encrypt(input):
    if isinstance(input, aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.EncryptAES_GCM):
...
def SmithyToDafny_aws_cryptography_materialproviders_DerivationAlgorithm(input):
    if isinstance(input, aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.DerivationAlgorithmHKDF):
        DerivationAlgorithm_union_value = DerivationAlgorithm_HKDF(input.value)
    elif isinstance(input, aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.DerivationAlgorithmIDENTITY):
        DerivationAlgorithm_union_value = DerivationAlgorithm_IDENTITY(input.value)
    elif isinstance(input, aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.DerivationAlgorithmNone):
...
def SmithyToDafny_aws_cryptography_materialproviders_SignatureAlgorithm(input):
    if isinstance(input, aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.SignatureAlgorithmECDSA):
        SignatureAlgorithm_union_value = SignatureAlgorithm_ECDSA(input.value)
    elif isinstance(input, aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.SignatureAlgorithmNone):
...
def SmithyToDafny_aws_cryptography_materialproviders_SymmetricSignatureAlgorithm(input):
    if isinstance(input, aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.SymmetricSignatureAlgorithmHMAC):
        SymmetricSignatureAlgorithm_union_value = SymmetricSignatureAlgorithm_HMAC(input.value)
    elif isinstance(input, aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.SymmetricSignatureAlgorithmNone):
...
def SmithyToDafny_aws_cryptography_materialproviders_EdkWrappingAlgorithm(input):
    if isinstance(input, aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.EdkWrappingAlgorithmDIRECT_KEY_WRAPPING):
        EdkWrappingAlgorithm_union_value = EdkWrappingAlgorithm_DIRECT__KEY__WRAPPING(input.value)
    elif isinstance(input, aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.EdkWrappingAlgorithmIntermediateKeyWrapping):
...
def SmithyToDafny_aws_cryptography_materialproviders_DecryptMaterialsInput(input):
    return DafnyDecryptMaterialsInput(
        algorithmSuiteId=aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.SmithyToDafny_aws_cryptography_materialproviders_AlgorithmSuiteId(input.algorithm_suite_id),
        commitmentPolicy=aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.SmithyToDafny_aws_cryptography_materialproviders_CommitmentPolicy(input.commitment_policy),
        encryptedDataKeys=Seq([aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.SmithyToDafny_aws_cryptography_materialproviders_EncryptedDataKey(list_element) for list_element in input.encrypted_data_keys]),
        encryptionContext=Map({Seq(key): Seq(value) for (key, value) in input.encryption_context.items() }),
...
def SmithyToDafny_aws_cryptography_materialproviders_DecryptMaterialsOutput(input):
    return DafnyDecryptMaterialsOutput(
        decryptionMaterials=aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.SmithyToDafny_aws_cryptography_materialproviders_DecryptionMaterials(input.decryption_materials),
    )
...
def SmithyToDafny_aws_cryptography_materialproviders_OnEncryptInput(input):
    return DafnyOnEncryptInput(
        materials=aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.SmithyToDafny_aws_cryptography_materialproviders_EncryptionMaterials(input.materials),
    )
...
def SmithyToDafny_aws_cryptography_materialproviders_OnDecryptInput(input):
    return DafnyOnDecryptInput(
        materials=aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.SmithyToDafny_aws_cryptography_materialproviders_DecryptionMaterials(input.materials),
        encryptedDataKeys=Seq([aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.SmithyToDafny_aws_cryptography_materialproviders_EncryptedDataKey(list_element) for list_element in input.encrypted_data_keys]),
    )
...
def SmithyToDafny_aws_cryptography_materialproviders_CreateAwsKmsKeyringInput(input):
    return DafnyCreateAwsKmsKeyringInput(
        ...
        kmsClient=aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.SmithyToDafny_aws_cryptography_materialproviders_KmsClientReference(input.kms_client),
...
def SmithyToDafny_aws_cryptography_materialproviders_CreateAwsKmsDiscoveryKeyringInput(input):
    return DafnyCreateAwsKmsDiscoveryKeyringInput(
        kmsClient=aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.SmithyToDafny_aws_cryptography_materialproviders_KmsClientReference(input.kms_client),
        discoveryFilter=((Option_Some(aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.SmithyToDafny_aws_cryptography_materialproviders_DiscoveryFilter(input.discovery_filter))) if (input.discovery_filter is not None) else (Option_None())),
        grantTokens=((Option_Some(Seq([Seq(list_element) for list_element in input.grant_tokens]))) if (input.grant_tokens is not None) else (Option_None())),
    )
...
def SmithyToDafny_aws_cryptography_materialproviders_CreateAwsKmsMultiKeyringInput(input):
    return DafnyCreateAwsKmsMultiKeyringInput(
        ...
        clientSupplier=((Option_Some(aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.SmithyToDafny_aws_cryptography_materialproviders_ClientSupplierReference(input.client_supplier))) if (aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.SmithyToDafny_aws_cryptography_materialproviders_ClientSupplierReference(input.client_supplier) is not None) else (Option_None())),
        grantTokens=((Option_Some(Seq([Seq(list_element) for list_element in input.grant_tokens]))) if (input.grant_tokens is not None) else (Option_None())),
    )
...
def SmithyToDafny_aws_cryptography_materialproviders_CreateAwsKmsHierarchicalKeyringInput(input):
    return DafnyCreateAwsKmsHierarchicalKeyringInput(
        ...
        branchKeyIdSupplier=((Option_Some(aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.SmithyToDafny_aws_cryptography_materialproviders_BranchKeyIdSupplierReference(input.branch_key_id_supplier))) if (aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.SmithyToDafny_aws_cryptography_materialproviders_BranchKeyIdSupplierReference(input.branch_key_id_supplier) is not None) else (Option_None())),
        keyStore=aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.SmithyToDafny_aws_cryptography_materialproviders_KeyStoreReference(input.key_store),
        ttlSeconds=input.ttl_seconds,
        cache=((Option_Some(aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.SmithyToDafny_aws_cryptography_materialproviders_CacheType(input.cache))) if (input.cache is not None) else (Option_None())),
    )
...
def SmithyToDafny_aws_cryptography_materialproviders_KeyStoreReference(input):
    return input._config.dafnyImplInterface._impl

def SmithyToDafny_aws_cryptography_materialproviders_CacheType(input):
    if isinstance(input, aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.CacheTypeDefault):
        CacheType_union_value = CacheType_Default(input.value)
    elif isinstance(input, aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.CacheTypeNo):
        CacheType_union_value = CacheType_No(input.value)
    elif isinstance(input, aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.CacheTypeSingleThreaded):
        CacheType_union_value = CacheType_SingleThreaded(input.value)
    elif isinstance(input, aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.CacheTypeMultiThreaded):
        CacheType_union_value = CacheType_MultiThreaded(input.value)
    elif isinstance(input, aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.CacheTypeStormTracking):
...
def SmithyToDafny_aws_cryptography_materialproviders_CreateMultiKeyringInput(input):
    return DafnyCreateMultiKeyringInput(
        generator=((Option_Some(aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.SmithyToDafny_aws_cryptography_materialproviders_KeyringReference(input.generator))) if (aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.SmithyToDafny_aws_cryptography_materialproviders_KeyringReference(input.generator) is not None) else (Option_None())),
        childKeyrings=Seq([aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.SmithyToDafny_aws_cryptography_materialproviders_KeyringReference(list_element) for list_element in input.child_keyrings]),
    )
...
def SmithyToDafny_aws_cryptography_materialproviders_CreateAwsKmsRsaKeyringInput(input):
    return DafnyCreateAwsKmsRsaKeyringInput(
        ...
        kmsClient=((Option_Some(aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.SmithyToDafny_aws_cryptography_materialproviders_KmsClientReference(input.kms_client))) if (aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.SmithyToDafny_aws_cryptography_materialproviders_KmsClientReference(input.kms_client) is not None) else (Option_None())),
        grantTokens=((Option_Some(Seq([Seq(list_element) for list_element in input.grant_tokens]))) if (input.grant_tokens is not None) else (Option_None())),
    )
...
def SmithyToDafny_aws_cryptography_materialproviders_CreateDefaultCryptographicMaterialsManagerInput(input):
    return DafnyCreateDefaultCryptographicMaterialsManagerInput(
        keyring=aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.SmithyToDafny_aws_cryptography_materialproviders_KeyringReference(input.keyring),
    )
...
def SmithyToDafny_aws_cryptography_materialproviders_CreateRequiredEncryptionContextCMMInput(input):
    return DafnyCreateRequiredEncryptionContextCMMInput(
        underlyingCMM=((Option_Some(aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.SmithyToDafny_aws_cryptography_materialproviders_CryptographicMaterialsManagerReference(input.underlying_cmm))) if (aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.SmithyToDafny_aws_cryptography_materialproviders_CryptographicMaterialsManagerReference(input.underlying_cmm) is not None) else (Option_None())),
        keyring=((Option_Some(aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.SmithyToDafny_aws_cryptography_materialproviders_KeyringReference(input.keyring))) if (aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.SmithyToDafny_aws_cryptography_materialproviders_KeyringReference(input.keyring) is not None) else (Option_None())),
        requiredEncryptionContextKeys=Seq([Seq(list_element) for list_element in input.required_encryption_context_keys]),
    )
...
def SmithyToDafny_aws_cryptography_materialproviders_CreateCryptographicMaterialsCacheInput(input):
    return DafnyCreateCryptographicMaterialsCacheInput(
        cache=aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.SmithyToDafny_aws_cryptography_materialproviders_CacheType(input.cache),
    )
...
def SmithyToDafny_aws_cryptography_materialproviders_ValidEncryptionMaterialsTransitionInput(input):
    return DafnyValidEncryptionMaterialsTransitionInput(
        start=aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.SmithyToDafny_aws_cryptography_materialproviders_EncryptionMaterials(input.start),
        stop=aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.SmithyToDafny_aws_cryptography_materialproviders_EncryptionMaterials(input.stop),
    )
...
def SmithyToDafny_aws_cryptography_materialproviders_ValidDecryptionMaterialsTransitionInput(input):
    return DafnyValidDecryptionMaterialsTransitionInput(
        start=aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.SmithyToDafny_aws_cryptography_materialproviders_DecryptionMaterials(input.start),
        stop=aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.SmithyToDafny_aws_cryptography_materialproviders_DecryptionMaterials(input.stop),
    )
...
def SmithyToDafny_aws_cryptography_materialproviders_ValidateCommitmentPolicyOnEncryptInput(input):
    return DafnyValidateCommitmentPolicyOnEncryptInput(
        algorithm=aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.SmithyToDafny_aws_cryptography_materialproviders_AlgorithmSuiteId(input.algorithm),
        commitmentPolicy=aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.SmithyToDafny_aws_cryptography_materialproviders_CommitmentPolicy(input.commitment_policy),
    )
...
def SmithyToDafny_aws_cryptography_materialproviders_CreateKeyringOutput(input):
    return aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.SmithyToDafny_aws_cryptography_materialproviders_KeyringReference(input.keyring)

def SmithyToDafny_aws_cryptography_materialproviders_CreateCryptographicMaterialsManagerOutput(input):
    return aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.SmithyToDafny_aws_cryptography_materialproviders_CryptographicMaterialsManagerReference(input.materials_manager)
...
def SmithyToDafny_aws_cryptography_materialproviders_CreateCryptographicMaterialsCacheOutput(input):
    return aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.SmithyToDafny_aws_cryptography_materialproviders_CryptographicMaterialsCacheReference(input.materials_cache)
...
def SmithyToDafny_aws_cryptography_materialproviders_CreateDefaultClientSupplierOutput(input):
    return aws_cryptography_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.SmithyToDafny_aws_cryptography_materialproviders_ClientSupplierReference(input.client)
