...
def DafnyToAwsSdk_com_amazonaws_kms_CustomKeyStoresListEntry(input):
    ...
    if input.ConnectionState.is_Some:
        output["ConnectionState"] = input.ConnectionState.value.VerbatimString(False)

    if input.ConnectionErrorCode.is_Some:
        output["ConnectionErrorCode"] = input.ConnectionErrorCode.value.VerbatimString(False)
...
def DafnyToAwsSdk_com_amazonaws_kms_GrantListEntry(input):
    ...
    if input.Operations.is_Some:
        output["Operations"] = [list_element.VerbatimString(False) for list_element in input.Operations.value]
...
def DafnyToAwsSdk_com_amazonaws_kms_SignResponse(input):
    ...
    if input.SigningAlgorithm.is_Some:
        output["SigningAlgorithm"] = input.SigningAlgorithm.value.VerbatimString(False)
...
def DafnyToAwsSdk_com_amazonaws_kms_GenerateDataKeyPairWithoutPlaintextResponse(input):
    ...
    if input.KeyPairSpec.is_Some:
        output["KeyPairSpec"] = input.KeyPairSpec.value.VerbatimString(False)
...
def DafnyToAwsSdk_com_amazonaws_kms_KeyMetadata(input):
    ...
    if input.KeyState.is_Some:
        output["KeyState"] = input.KeyState.value.VerbatimString(False)
    ...
    if input.KeyManager.is_Some:
        output["KeyManager"] = input.KeyManager.value.VerbatimString(False)
    ...
    if input.EncryptionAlgorithms.is_Some:
        output["EncryptionAlgorithms"] = [list_element.VerbatimString(False) for list_element in input.EncryptionAlgorithms.value]

    if input.SigningAlgorithms.is_Some:
        output["SigningAlgorithms"] = [list_element.VerbatimString(False) for list_element in input.SigningAlgorithms.value]
...
def DafnyToAwsSdk_com_amazonaws_kms_MultiRegionConfiguration(input):
    ...
    if input.MultiRegionKeyType.is_Some:
        output["MultiRegionKeyType"] = input.MultiRegionKeyType.value.VerbatimString(False)
