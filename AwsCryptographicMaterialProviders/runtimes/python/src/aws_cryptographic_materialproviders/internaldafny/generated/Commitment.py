...
class default__:
    ...
    def ValidateCommitmentPolicyOnEncrypt(algorithm, commitmentPolicy):
        d_1194_suite_ = AlgorithmSuites.default__.GetSuite(algorithm)
        if ((commitmentPolicy) == (AwsCryptographyMaterialProvidersTypes.CommitmentPolicy_ESDK(AwsCryptographyMaterialProvidersTypes.ESDKCommitmentPolicy_FORBID__ENCRYPT__ALLOW__DECRYPT()))) and (not(((d_1194_suite_).commitment).is_None)):
    ...
    def ValidateCommitmentPolicyOnDecrypt(algorithm, commitmentPolicy):
        d_1195_suite_ = AlgorithmSuites.default__.GetSuite(algorithm)
        if ((True) and (((commitmentPolicy) == (AwsCryptographyMaterialProvidersTypes.CommitmentPolicy_ESDK(AwsCryptographyMaterialProvidersTypes.ESDKCommitmentPolicy_REQUIRE__ENCRYPT__REQUIRE__DECRYPT()))) or ((commitmentPolicy) == (AwsCryptographyMaterialProvidersTypes.CommitmentPolicy_DBE(AwsCryptographyMaterialProvidersTypes.DBECommitmentPolicy_REQUIRE__ENCRYPT__REQUIRE__DECRYPT()))))) and (((d_1195_suite_).commitment).is_None):
