...
# Module: aws_cryptographic_materialproviders.internaldafny.generated.KeyStore
...
class default__:
    ...
    def DefaultKeyStoreConfig():
        return AwsCryptographyKeyStoreTypes.KeyStoreConfig_KeyStoreConfig(_dafny.Seq("None"), AwsCryptographyKeyStoreTypes.KMSConfiguration_kmsKeyArn(_dafny.Seq("1234abcd-12ab-34cd-56ef-1234567890ab")), _dafny.Seq("None"), Wrappers.Option_None(), Wrappers.Option_None(), Wrappers.Option_None(), Wrappers.Option_None())

    @staticmethod
    def KeyStore(config):
        res: Wrappers.Result = None
        d_282_valueOrError0_: Wrappers.Outcome = Wrappers.Outcome.default()()
        d_282_valueOrError0_ = Wrappers.default__.Need((ComAmazonawsKmsTypes.default__.IsValid__KeyIdType(((config).kmsConfiguration).kmsKeyArn)) and ((AwsArnParsing.default__.ParseAwsKmsArn(((config).kmsConfiguration).kmsKeyArn)).is_Success), AwsCryptographyKeyStoreTypes.Error_KeyStoreException(_dafny.Seq("Invalid AWS KMS Key Arn")))
        ...
        d_284_valueOrError1_ = Wrappers.default__.Need((True) and ((d_283_grantTokens_).is_Success), AwsCryptographyKeyStoreTypes.Error_KeyStoreException(_dafny.Seq("CreateKey received invalid grant tokens")))
        ...
        if ((config).id).is_Some:
            ...
            def lambda26_(d_289_e_):
                return AwsCryptographyKeyStoreTypes.Error_KeyStoreException(d_289_e_)
        ...
        d_290_kmsClient_: ComAmazonawsKmsTypes.IKMSClient = None
        d_291_ddbClient_: ComAmazonawsDynamodbTypes.IDynamoDBClient = None
        ...
        if ((config).kmsClient).is_None:
            ...
            out45_ = Com_Amazonaws_Kms.default__.KMSClientForRegion((d_293_kmsRegion_).value)
            d_294_maybeKmsClient_ = out45_
            d_295_valueOrError3_: Wrappers.Result = None
            def lambda27_(d_296_e_):
                return AwsCryptographyKeyStoreTypes.Error_ComAmazonawsKms(d_296_e_)
        ...
        if ((config).ddbClient).is_None:
            ...
            out46_ = Com_Amazonaws_Dynamodb.default__.DDBClientForRegion((d_293_kmsRegion_).value)
            d_297_maybeDdbClient_ = out46_
            d_298_valueOrError4_: Wrappers.Result = None
            def lambda28_(d_299_e_):
                return AwsCryptographyKeyStoreTypes.Error_ComAmazonawsDynamodb(d_299_e_)
        ...
        d_300_valueOrError5_ = Wrappers.default__.Need(ComAmazonawsDynamodbTypes.default__.IsValid__TableName((config).ddbTableName), AwsCryptographyKeyStoreTypes.Error_KeyStoreException(_dafny.Seq("Invalid Amazon DynamoDB Table Name")))
