...
class default__:
    ...
    def EncryptionContextDigest(cryptoPrimitives, encryptionContext):
        ...
        d_978_DigestInput_: software.amazon.cryptography.primitives.internaldafny.types.DigestInput
        d_978_DigestInput_ = software.amazon.cryptography.primitives.internaldafny.types.DigestInput_DigestInput(software.amazon.cryptography.primitives.internaldafny.types.DigestAlgorithm_SHA__384(), d_976_canonicalEC_)
        ...
        def lambda78_(d_982_e_):
            return software.amazon.cryptography.materialproviders.internaldafny.types.Error_AwsCryptographyPrimitives(d_982_e_)
...
class AwsKmsRsaKeyring(Keyring.VerifiableInterface, software.amazon.cryptography.materialproviders.internaldafny.types.IKeyring):
    def  __init__(self):
        ...
        self._paddingScheme: software.amazon.cryptography.services.kms.internaldafny.types.EncryptionAlgorithmSpec = software.amazon.cryptography.services.kms.internaldafny.types.EncryptionAlgorithmSpec.default()()
    ...
    def OnEncrypt(self, input):
        ...
        out181_ = software.amazon.cryptography.materialproviders.internaldafny.types.IKeyring.OnEncrypt(self, input)
        return out181_

    def OnDecrypt(self, input):
        out182_: Wrappers.Result
        out182_ = software.amazon.cryptography.materialproviders.internaldafny.types.IKeyring.OnDecrypt(self, input)
        return out182_
    ...
    def OnEncrypt_k(self, input):
        ...
        d_984_valueOrError0_ = Wrappers.default__.Need((((self).publicKey).is_Some) and ((len(((self).publicKey).Extract())) > (0)), software.amazon.cryptography.materialproviders.internaldafny.types.Error_AwsCryptographicMaterialProvidersException(_dafny.Seq("A AwsKmsRsaKeyring without a public key cannot provide OnEncrypt")))
        ...
        d_985_valueOrError1_ = Wrappers.default__.Need(((((input).materials).algorithmSuite).signature).is_None, software.amazon.cryptography.materialproviders.internaldafny.types.Error_AwsCryptographicMaterialProvidersException((_dafny.Seq("AwsKmsRsaKeyring cannot be used with an Algorithm Suite with asymmetric signing.")) + (_dafny.Seq(" Please specify an algorithm suite without asymmetric signing."))))
        ...
        d_991_edk_: software.amazon.cryptography.materialproviders.internaldafny.types.EncryptedDataKey
        d_991_edk_ = software.amazon.cryptography.materialproviders.internaldafny.types.EncryptedDataKey_EncryptedDataKey(Constants.default__.RSA__PROVIDER__ID, (UTF8.default__.Encode((self).awsKmsKey)).value, (d_988_wrapOutput_).wrappedMaterial)
        d_992_returnMaterials_: software.amazon.cryptography.materialproviders.internaldafny.types.EncryptionMaterials = None
        ...
        res = Wrappers.Result_Success(software.amazon.cryptography.materialproviders.internaldafny.types.OnEncryptOutput_OnEncryptOutput(d_992_returnMaterials_))
        return res
        return res
    ...
    def OnDecrypt_k(self, input):
        ...
        d_995_valueOrError0_ = Wrappers.default__.Need(((self).client).is_Some, software.amazon.cryptography.materialproviders.internaldafny.types.Error_AwsCryptographicMaterialProvidersException(_dafny.Seq("An AwsKmsRsaKeyring without an AWS KMS client cannot provide OnDecrypt")))
        if (d_995_valueOrError0_).IsFailure():
            res = (d_995_valueOrError0_).PropagateFailure()
            return res
        d_996_materials_: software.amazon.cryptography.materialproviders.internaldafny.types.DecryptionMaterials
        d_996_materials_ = (input).materials
        d_997_valueOrError1_: Wrappers.Outcome = Wrappers.Outcome.default()()
        d_997_valueOrError1_ = Wrappers.default__.Need(Materials.default__.DecryptionMaterialsWithoutPlaintextDataKey(d_996_materials_), software.amazon.cryptography.materialproviders.internaldafny.types.Error_AwsCryptographicMaterialProvidersException(_dafny.Seq("Keyring received decryption materials that already contain a plaintext data key.")))
        ...
        d_1002_valueOrError4_ = Wrappers.default__.Need((0) < (len(d_1000_edksToAttempt_)), software.amazon.cryptography.materialproviders.internaldafny.types.Error_AwsCryptographicMaterialProvidersException(_dafny.Seq("Unable to decrypt data key: No Encrypted Data Keys found to match.")))
        ...
        d_1007_SealedDecryptionMaterials_: software.amazon.cryptography.materialproviders.internaldafny.types.DecryptionMaterials
        d_1008_valueOrError6_: Wrappers.Result = None
        def lambda79_(d_1009_errors_):
            return software.amazon.cryptography.materialproviders.internaldafny.types.Error_CollectionOfErrors(d_1009_errors_, _dafny.Seq("No Configured KMS Key was able to decrypt the Data Key. The list of encountered Exceptions is available via `list`."))
        ...
        res = Wrappers.Result_Success(software.amazon.cryptography.materialproviders.internaldafny.types.OnDecryptOutput_OnDecryptOutput(d_1007_SealedDecryptionMaterials_))
        return res
        return res
...
class DecryptSingleAWSRSAEncryptedDataKey(Actions.ActionWithResult, Actions.Action):
    ...
    def Invoke(self, edk):
        ...
        d_1013_result_: software.amazon.cryptography.materialproviders.internaldafny.types.DecryptionMaterials
...
class KmsRsaGenerateAndWrapKeyMaterial(MaterialWrapping.GenerateAndWrapMaterial, Actions.ActionWithResult, Actions.Action):
    ...
    def Invoke(self, input):
        ...
        out188_ = ((self).cryptoPrimitives).GenerateRandomBytes(software.amazon.cryptography.primitives.internaldafny.types.GenerateRandomBytesInput_GenerateRandomBytesInput(AlgorithmSuites.default__.GetEncryptKeyLength((input).algorithmSuite)))
        ...
        def lambda80_(d_1018_e_):
            return software.amazon.cryptography.materialproviders.internaldafny.types.Error_AwsCryptographyPrimitives(d_1018_e_)
...
class KmsRsaWrapKeyMaterial(MaterialWrapping.WrapMaterial, Actions.ActionWithResult, Actions.Action):
    ...
    def Invoke(self, input):
        ...
        d_1025_padding_: software.amazon.cryptography.primitives.internaldafny.types.RSAPaddingMode
        ...
        out191_ = ((self).cryptoPrimitives).RSAEncrypt(software.amazon.cryptography.primitives.internaldafny.types.RSAEncryptInput_RSAEncryptInput(d_1025_padding_, (self).publicKey, (d_1023_encryptionContextDigest_) + ((input).plaintextMaterial)))
        ...
        def lambda82_(d_1029_e_):
            return software.amazon.cryptography.materialproviders.internaldafny.types.Error_AwsCryptographyPrimitives(d_1029_e_)
...
class KmsRsaUnwrapKeyMaterial(MaterialWrapping.UnwrapMaterial, Actions.ActionWithResult, Actions.Action):
    ...
    def Invoke(self, input):
        ...
        if (d_1031_valueOrError0_).IsFailure():
            ...
            return res
        d_1032_decryptRequest_: software.amazon.cryptography.services.kms.internaldafny.types.DecryptRequest
        d_1032_decryptRequest_ = software.amazon.cryptography.services.kms.internaldafny.types.DecryptRequest_DecryptRequest((input).wrappedMaterial, Wrappers.Option_None(), Wrappers.Option_Some((self).grantTokens), Wrappers.Option_Some((self).awsKmsKey), Wrappers.Option_Some((self).paddingScheme))
        ...
        d_1034_decryptResponse_: software.amazon.cryptography.services.kms.internaldafny.types.DecryptResponse
        d_1035_valueOrError1_: Wrappers.Result = Wrappers.Result.default(software.amazon.cryptography.services.kms.internaldafny.types.DecryptResponse.default())()
        def lambda83_(d_1036_e_):
            return software.amazon.cryptography.materialproviders.internaldafny.types.Error_ComAmazonawsKms(d_1036_e_)
        ...
        d_1037_valueOrError2_ = Wrappers.default__.Need(((((d_1034_decryptResponse_).KeyId).is_Some) and ((((d_1034_decryptResponse_).KeyId).value) == ((self).awsKmsKey))) and (((d_1034_decryptResponse_).Plaintext).is_Some), software.amazon.cryptography.materialproviders.internaldafny.types.Error_AwsCryptographicMaterialProvidersException(_dafny.Seq("Invalid response from KMS Decrypt")))
