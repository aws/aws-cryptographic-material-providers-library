...
# Module: software.amazon.cryptography.materialproviders.internaldafny.types
...
class CreateAwsKmsHierarchicalKeyringInput:
    @classmethod
    def default(cls, ):
        return lambda: CreateAwsKmsHierarchicalKeyringInput_CreateAwsKmsHierarchicalKeyringInput(Wrappers.Option.default()(), Wrappers.Option.default()(), None, int(0), Wrappers.Option.default()())
    def __ne__(self, __o: object) -> bool:
        return not self.__eq__(__o)
    @property
...
class CreateAwsKmsHierarchicalKeyringInput_CreateAwsKmsHierarchicalKeyringInput(CreateAwsKmsHierarchicalKeyringInput, NamedTuple('CreateAwsKmsHierarchicalKeyringInput', [('branchKeyId', Any), ('branchKeyIdSupplier', Any), ('keyStore', Any), ('ttlSeconds', Any), ('cache', Any)])):
    ...
    def __eq__(self, __o: object) -> bool:
        return isinstance(__o, CreateAwsKmsHierarchicalKeyringInput_CreateAwsKmsHierarchicalKeyringInput) and self.branchKeyId == __o.branchKeyId and self.branchKeyIdSupplier == __o.branchKeyIdSupplier and self.keyStore == __o.keyStore and self.ttlSeconds == __o.ttlSeconds and self.cache == __o.cache
    def __hash__(self) -> int:
        return super().__hash__()
...
class CreateAwsKmsRsaKeyringInput:
    @classmethod
    def default(cls, ):
        return lambda: CreateAwsKmsRsaKeyringInput_CreateAwsKmsRsaKeyringInput(Wrappers.Option.default()(), _dafny.Seq({}), software.amazon.cryptography.services.kms.internaldafny.types.EncryptionAlgorithmSpec.default()(), Wrappers.Option.default()(), Wrappers.Option.default()())
    def __ne__(self, __o: object) -> bool:
        return not self.__eq__(__o)
    @property
...
class ECDSA:
    @classmethod
    def default(cls, ):
        return lambda: ECDSA_ECDSA(software.amazon.cryptography.primitives.internaldafny.types.ECDSASignatureAlgorithm.default()())
    def __ne__(self, __o: object) -> bool:
        return not self.__eq__(__o)
    @property
...
class Encrypt:
    @classmethod
    def default(cls, ):
        return lambda: Encrypt_AES__GCM(software.amazon.cryptography.primitives.internaldafny.types.AES__GCM.default()())
    def __ne__(self, __o: object) -> bool:
        return not self.__eq__(__o)
    @property
...
class HKDF:
    @classmethod
    def default(cls, ):
        return lambda: HKDF_HKDF(software.amazon.cryptography.primitives.internaldafny.types.DigestAlgorithm.default()(), int(0), int(0), int(0))
    def __ne__(self, __o: object) -> bool:
        return not self.__eq__(__o)
    @property
    def is_HKDF(self) -> bool:
...
class StormTrackingCache:
    @classmethod
    def default(cls, ):
        return lambda: StormTrackingCache_StormTrackingCache(int(0), Wrappers.Option.default()(), int(0), int(0), int(0), int(0), int(0))
    def __ne__(self, __o: object) -> bool:
        return not self.__eq__(__o)
    @property
...
class SymmetricSignatureAlgorithm:
    @classmethod
    def default(cls, ):
        return lambda: SymmetricSignatureAlgorithm_HMAC(software.amazon.cryptography.primitives.internaldafny.types.DigestAlgorithm.default()())
    def __ne__(self, __o: object) -> bool:
        return not self.__eq__(__o)
    @property
