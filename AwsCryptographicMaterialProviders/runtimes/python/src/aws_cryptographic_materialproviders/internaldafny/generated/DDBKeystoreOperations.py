...
class default__:
    ...
    def WriteNewKeyToStore(versionBranchKeyItem, activeBranchKeyItem, beaconKeyItem, tableName, ddbClient):
        output: Wrappers.Result = Wrappers.Result.default(software.amazon.cryptography.services.dynamodb.internaldafny.types.TransactWriteItemsOutput.default())()
        ...
        d_140_transactRequest_: software.amazon.cryptography.services.dynamodb.internaldafny.types.TransactWriteItemsInput
        d_140_transactRequest_ = software.amazon.cryptography.services.dynamodb.internaldafny.types.TransactWriteItemsInput_TransactWriteItemsInput(d_139_items_, Wrappers.Option_None(), Wrappers.Option_None(), Wrappers.Option_None())
        ...
        d_142_transactWriteItemsResponse_: software.amazon.cryptography.services.dynamodb.internaldafny.types.TransactWriteItemsOutput
        d_143_valueOrError0_: Wrappers.Result = Wrappers.Result.default(software.amazon.cryptography.services.dynamodb.internaldafny.types.TransactWriteItemsOutput.default())()
        def lambda14_(d_144_e_):
            return software.amazon.cryptography.keystore.internaldafny.types.Error_ComAmazonawsDynamodb(d_144_e_)
    ...
    def WriteNewBranchKeyVersionToKeystore(versionBranchKeyItem, activeBranchKeyItem, tableName, ddbClient):
        ...
        d_146_transactRequest_: software.amazon.cryptography.services.dynamodb.internaldafny.types.TransactWriteItemsInput
        d_146_transactRequest_ = software.amazon.cryptography.services.dynamodb.internaldafny.types.TransactWriteItemsInput_TransactWriteItemsInput(d_145_items_, Wrappers.Option_None(), Wrappers.Option_None(), Wrappers.Option_None())
        ...
        d_148_transactWriteItemsResponse_: software.amazon.cryptography.services.dynamodb.internaldafny.types.TransactWriteItemsOutput
        d_149_valueOrError0_: Wrappers.Result = Wrappers.Result.default(software.amazon.cryptography.services.dynamodb.internaldafny.types.TransactWriteItemsOutput.default())()
        def lambda15_(d_150_e_):
            return software.amazon.cryptography.keystore.internaldafny.types.Error_ComAmazonawsDynamodb(d_150_e_)
    ...
    def GetActiveBranchKeyItem(branchKeyIdentifier, tableName, ddbClient):
        ...
        d_151_dynamoDbKey_ = _dafny.Map({Structure.default__.BRANCH__KEY__IDENTIFIER__FIELD: software.amazon.cryptography.services.dynamodb.internaldafny.types.AttributeValue_S(branchKeyIdentifier), Structure.default__.TYPE__FIELD: software.amazon.cryptography.services.dynamodb.internaldafny.types.AttributeValue_S(Structure.default__.BRANCH__KEY__ACTIVE__TYPE)})
        d_152_ItemRequest_: software.amazon.cryptography.services.dynamodb.internaldafny.types.GetItemInput
        d_152_ItemRequest_ = software.amazon.cryptography.services.dynamodb.internaldafny.types.GetItemInput_GetItemInput(tableName, d_151_dynamoDbKey_, Wrappers.Option_None(), Wrappers.Option_None(), Wrappers.Option_None(), Wrappers.Option_None(), Wrappers.Option_None())
        ...
        d_154_getItemResponse_: software.amazon.cryptography.services.dynamodb.internaldafny.types.GetItemOutput
        d_155_valueOrError0_: Wrappers.Result = Wrappers.Result.default(software.amazon.cryptography.services.dynamodb.internaldafny.types.GetItemOutput.default())()
        def lambda16_(d_156_e_):
            return software.amazon.cryptography.keystore.internaldafny.types.Error_ComAmazonawsDynamodb(d_156_e_)
        ...
        d_157_valueOrError1_ = Wrappers.default__.Need(((d_154_getItemResponse_).Item).is_Some, software.amazon.cryptography.keystore.internaldafny.types.Error_KeyStoreException(_dafny.Seq("No item found for corresponding branch key identifier.")))
        ...
        d_158_valueOrError2_ = Wrappers.default__.Need((Structure.default__.ActiveBranchKeyItem_q(((d_154_getItemResponse_).Item).value)) and ((((((d_154_getItemResponse_).Item).value)[Structure.default__.BRANCH__KEY__IDENTIFIER__FIELD]).S) == (branchKeyIdentifier)), software.amazon.cryptography.keystore.internaldafny.types.Error_KeyStoreException(_dafny.Seq("Item found is not a valid active branch key.")))
    ...
    def GetVersionBranchKeyItem(branchKeyIdentifier, branchKeyVersion, tableName, ddbClient):
        ...
        d_159_dynamoDbKey_ = _dafny.Map({Structure.default__.BRANCH__KEY__IDENTIFIER__FIELD: software.amazon.cryptography.services.dynamodb.internaldafny.types.AttributeValue_S(branchKeyIdentifier), Structure.default__.TYPE__FIELD: software.amazon.cryptography.services.dynamodb.internaldafny.types.AttributeValue_S((Structure.default__.BRANCH__KEY__TYPE__PREFIX) + (branchKeyVersion))})
        d_160_ItemRequest_: software.amazon.cryptography.services.dynamodb.internaldafny.types.GetItemInput
        d_160_ItemRequest_ = software.amazon.cryptography.services.dynamodb.internaldafny.types.GetItemInput_GetItemInput(tableName, d_159_dynamoDbKey_, Wrappers.Option_None(), Wrappers.Option_None(), Wrappers.Option_None(), Wrappers.Option_None(), Wrappers.Option_None())
        ...
        d_162_getItemResponse_: software.amazon.cryptography.services.dynamodb.internaldafny.types.GetItemOutput
        d_163_valueOrError0_: Wrappers.Result = Wrappers.Result.default(software.amazon.cryptography.services.dynamodb.internaldafny.types.GetItemOutput.default())()
        def lambda17_(d_164_e_):
            return software.amazon.cryptography.keystore.internaldafny.types.Error_ComAmazonawsDynamodb(d_164_e_)
        ...
        d_165_valueOrError1_ = Wrappers.default__.Need(((d_162_getItemResponse_).Item).is_Some, software.amazon.cryptography.keystore.internaldafny.types.Error_KeyStoreException(_dafny.Seq("No item found for corresponding branch key identifier.")))
        ...
        d_166_valueOrError2_ = Wrappers.default__.Need(((Structure.default__.VersionBranchKeyItem_q(((d_162_getItemResponse_).Item).value)) and ((((((d_162_getItemResponse_).Item).value)[Structure.default__.BRANCH__KEY__IDENTIFIER__FIELD]).S) == (branchKeyIdentifier))) and ((((((d_162_getItemResponse_).Item).value)[Structure.default__.TYPE__FIELD]).S) == ((Structure.default__.BRANCH__KEY__TYPE__PREFIX) + (branchKeyVersion))), software.amazon.cryptography.keystore.internaldafny.types.Error_KeyStoreException(_dafny.Seq("Item found is not a valid branch key version.")))
    ...
    def GetBeaconKeyItem(branchKeyIdentifier, tableName, ddbClient):
        ...
        d_167_dynamoDbKey_ = _dafny.Map({Structure.default__.BRANCH__KEY__IDENTIFIER__FIELD: software.amazon.cryptography.services.dynamodb.internaldafny.types.AttributeValue_S(branchKeyIdentifier), Structure.default__.TYPE__FIELD: software.amazon.cryptography.services.dynamodb.internaldafny.types.AttributeValue_S(Structure.default__.BEACON__KEY__TYPE__VALUE)})
        d_168_ItemRequest_: software.amazon.cryptography.services.dynamodb.internaldafny.types.GetItemInput
        d_168_ItemRequest_ = software.amazon.cryptography.services.dynamodb.internaldafny.types.GetItemInput_GetItemInput(tableName, d_167_dynamoDbKey_, Wrappers.Option_None(), Wrappers.Option_None(), Wrappers.Option_None(), Wrappers.Option_None(), Wrappers.Option_None())
        ...
        d_170_getItemResponse_: software.amazon.cryptography.services.dynamodb.internaldafny.types.GetItemOutput
        d_171_valueOrError0_: Wrappers.Result = Wrappers.Result.default(software.amazon.cryptography.services.dynamodb.internaldafny.types.GetItemOutput.default())()
        def lambda18_(d_172_e_):
            return software.amazon.cryptography.keystore.internaldafny.types.Error_ComAmazonawsDynamodb(d_172_e_)
        ...
        d_173_valueOrError1_ = Wrappers.default__.Need(((d_170_getItemResponse_).Item).is_Some, software.amazon.cryptography.keystore.internaldafny.types.Error_KeyStoreException(_dafny.Seq("No item found for corresponding branch key identifier.")))
        ...
        d_174_valueOrError2_ = Wrappers.default__.Need((Structure.default__.BeaconKeyItem_q(((d_170_getItemResponse_).Item).value)) and ((((((d_170_getItemResponse_).Item).value)[Structure.default__.BRANCH__KEY__IDENTIFIER__FIELD]).S) == (branchKeyIdentifier)), software.amazon.cryptography.keystore.internaldafny.types.Error_KeyStoreException(_dafny.Seq("Item found is not a valid beacon key.")))
    ...
    def CreateTransactWritePutItem(item, tableName, ConditionExpression):
        ...
        return software.amazon.cryptography.services.dynamodb.internaldafny.types.TransactWriteItem_TransactWriteItem(Wrappers.Option_None(), Wrappers.Option_Some(software.amazon.cryptography.services.dynamodb.internaldafny.types.Put_Put(item, tableName, Wrappers.Option_Some(lambda19_(ConditionExpression)), Wrappers.Option_Some(default__.BRANCH__KEY__EXISTS__EXPRESSION__ATTRIBUTE__NAMES), Wrappers.Option_None(), Wrappers.Option_None())), Wrappers.Option_None(), Wrappers.Option_None())
