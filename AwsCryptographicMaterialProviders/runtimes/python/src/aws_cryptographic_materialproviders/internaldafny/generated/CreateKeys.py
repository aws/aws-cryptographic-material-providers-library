...
class default__:
    ...
    def CreateBranchAndBeaconKeys(branchKeyIdentifier, customEncryptionContext, timestamp, branchKeyVersion, ddbTableName, logicalKeyStoreName, kmsConfiguration, grantTokens, kmsClient, ddbClient):
        ...
        d_178_wrappedDecryptOnlyBranchKey_: software.amazon.cryptography.services.kms.internaldafny.types.GenerateDataKeyWithoutPlaintextResponse
        d_179_valueOrError0_: Wrappers.Result = Wrappers.Result.default(software.amazon.cryptography.services.kms.internaldafny.types.GenerateDataKeyWithoutPlaintextResponse.default())()
        ...
        d_180_wrappedActiveBranchKey_: software.amazon.cryptography.services.kms.internaldafny.types.ReEncryptResponse
        d_181_valueOrError1_: Wrappers.Result = Wrappers.Result.default(software.amazon.cryptography.services.kms.internaldafny.types.ReEncryptResponse.default())()
        ...
        d_182_wrappedBeaconKey_: software.amazon.cryptography.services.kms.internaldafny.types.GenerateDataKeyWithoutPlaintextResponse
        d_183_valueOrError2_: Wrappers.Result = Wrappers.Result.default(software.amazon.cryptography.services.kms.internaldafny.types.GenerateDataKeyWithoutPlaintextResponse.default())()
        ...
        d_187___v0_: software.amazon.cryptography.services.dynamodb.internaldafny.types.TransactWriteItemsOutput
        d_188_valueOrError3_: Wrappers.Result = Wrappers.Result.default(software.amazon.cryptography.services.dynamodb.internaldafny.types.TransactWriteItemsOutput.default())()
        ...
        output = Wrappers.Result_Success(software.amazon.cryptography.keystore.internaldafny.types.CreateKeyOutput_CreateKeyOutput(branchKeyIdentifier))
        return output
    ...
    def VersionActiveBranchKey(input, timestamp, branchKeyVersion, ddbTableName, logicalKeyStoreName, kmsConfiguration, grantTokens, kmsClient, ddbClient):
        ...
        d_192_valueOrError1_ = Wrappers.default__.Need((True) and (KMSKeystoreOperations.default__.AttemptKmsOperation_q(kmsConfiguration, d_191_oldActiveEncryptionContext_)), software.amazon.cryptography.keystore.internaldafny.types.Error_KeyStoreException(_dafny.Seq("Wrapping AWS KMS key in dynamodb does not match configured AWS KMS information.")))
        if (d_192_valueOrError1_).IsFailure():
            output = (d_192_valueOrError1_).PropagateFailure()
            return output
        d_193___v1_: software.amazon.cryptography.services.kms.internaldafny.types.ReEncryptResponse
        d_194_valueOrError2_: Wrappers.Result = Wrappers.Result.default(software.amazon.cryptography.services.kms.internaldafny.types.ReEncryptResponse.default())()
        ...
        d_197_wrappedDecryptOnlyBranchKey_: software.amazon.cryptography.services.kms.internaldafny.types.GenerateDataKeyWithoutPlaintextResponse
        d_198_valueOrError3_: Wrappers.Result = Wrappers.Result.default(software.amazon.cryptography.services.kms.internaldafny.types.GenerateDataKeyWithoutPlaintextResponse.default())()
        ...
        d_199_wrappedActiveBranchKey_: software.amazon.cryptography.services.kms.internaldafny.types.ReEncryptResponse
        d_200_valueOrError4_: Wrappers.Result = Wrappers.Result.default(software.amazon.cryptography.services.kms.internaldafny.types.ReEncryptResponse.default())()
        ...
        d_203___v2_: software.amazon.cryptography.services.dynamodb.internaldafny.types.TransactWriteItemsOutput
        d_204_valueOrError5_: Wrappers.Result = Wrappers.Result.default(software.amazon.cryptography.services.dynamodb.internaldafny.types.TransactWriteItemsOutput.default())()
        ...
        output = Wrappers.Result_Success(software.amazon.cryptography.keystore.internaldafny.types.VersionKeyOutput_VersionKeyOutput())
        return output
