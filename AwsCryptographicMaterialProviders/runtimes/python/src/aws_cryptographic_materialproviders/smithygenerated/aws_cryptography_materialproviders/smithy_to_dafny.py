...
def aws_cryptography_materialproviders_GetClientOutput(input):
    return aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_KmsClientReference(input)
...
def aws_cryptography_materialproviders_PutCacheEntryInput(input):
    return DafnyPutCacheEntryInput(
        ...
        materials=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_Materials(input.materials),
...
def aws_cryptography_materialproviders_Materials(input):
    if isinstance(input, aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.MaterialsEncryption):
        Materials_union_value = Materials_Encryption(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_EncryptionMaterials(input.value))
        ...
        Materials_union_value = Materials_Decryption(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_DecryptionMaterials(input.value))
        ...
        Materials_union_value = Materials_BranchKey(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_keystore.smithy_to_dafny.aws_cryptography_keystore_BranchKeyMaterials(input.value))
        ...
        Materials_union_value = Materials_BeaconKey(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_keystore.smithy_to_dafny.aws_cryptography_keystore_BeaconKeyMaterials(input.value))
    else:
...
def aws_cryptography_materialproviders_EncryptionMaterials(input):
    return DafnyEncryptionMaterials(
        algorithmSuite=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_AlgorithmSuiteInfo(input.algorithm_suite),
        encryptionContext=Map({Seq(list(ord(c) for c in key)): Seq(list(ord(c) for c in value)) for (key, value) in input.encryption_context.items() }),
        encryptedDataKeys=Seq([aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_EncryptedDataKey(list_element) for list_element in input.encrypted_data_keys]),
...
def aws_cryptography_materialproviders_AlgorithmSuiteInfo(input):
    return DafnyAlgorithmSuiteInfo(
        id=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_AlgorithmSuiteId(input.id),
        binaryId=Seq(input.binary_id),
        messageVersion=input.message_version,
        encrypt=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_Encrypt(input.encrypt),
        kdf=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_DerivationAlgorithm(input.kdf),
        commitment=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_DerivationAlgorithm(input.commitment),
        signature=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_SignatureAlgorithm(input.signature),
        symmetricSignature=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_SymmetricSignatureAlgorithm(input.symmetric_signature),
        edkWrapping=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_EdkWrappingAlgorithm(input.edk_wrapping),
    )
...
def aws_cryptography_materialproviders_AlgorithmSuiteId(input):
    if isinstance(input, aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.AlgorithmSuiteIdESDK):
        AlgorithmSuiteId_union_value = AlgorithmSuiteId_ESDK(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_ESDKAlgorithmSuiteId(input.value))
        ...
        AlgorithmSuiteId_union_value = AlgorithmSuiteId_DBE(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_DBEAlgorithmSuiteId(input.value))
    else:
        raise ValueError("No recognized union value in union type: " + str(input))
...
def aws_cryptography_materialproviders_Encrypt(input):
    if isinstance(input, aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.EncryptAES_GCM):
        Encrypt_union_value = Encrypt_AES__GCM(aws_cryptography_primitives.smithygenerated.aws_cryptography_primitives.smithy_to_dafny.aws_cryptography_primitives_AES_GCM(input.value))
    else:
        raise ValueError("No recognized union value in union type: " + str(input))
...
def aws_cryptography_materialproviders_DerivationAlgorithm(input):
    if isinstance(input, aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.DerivationAlgorithmHKDF):
        DerivationAlgorithm_union_value = DerivationAlgorithm_HKDF(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_HKDF(input.value))
        ...
        DerivationAlgorithm_union_value = DerivationAlgorithm_IDENTITY(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_IDENTITY(input.value))
        ...
        DerivationAlgorithm_union_value = DerivationAlgorithm_None(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_None(input.value))
    else:
        raise ValueError("No recognized union value in union type: " + str(input))
...
def aws_cryptography_materialproviders_SignatureAlgorithm(input):
    if isinstance(input, aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.SignatureAlgorithmECDSA):
        SignatureAlgorithm_union_value = SignatureAlgorithm_ECDSA(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_ECDSA(input.value))
        ...
        SignatureAlgorithm_union_value = SignatureAlgorithm_None(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_None(input.value))
    else:
        raise ValueError("No recognized union value in union type: " + str(input))
...
def aws_cryptography_materialproviders_SymmetricSignatureAlgorithm(input):
    if isinstance(input, aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.SymmetricSignatureAlgorithmHMAC):
        SymmetricSignatureAlgorithm_union_value = SymmetricSignatureAlgorithm_HMAC(aws_cryptography_primitives.smithygenerated.aws_cryptography_primitives.smithy_to_dafny.aws_cryptography_primitives_DigestAlgorithm(input.value))
        ...
        SymmetricSignatureAlgorithm_union_value = SymmetricSignatureAlgorithm_None(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_None(input.value))
    else:
        raise ValueError("No recognized union value in union type: " + str(input))
...
def aws_cryptography_materialproviders_EdkWrappingAlgorithm(input):
    if isinstance(input, aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.EdkWrappingAlgorithmDIRECT_KEY_WRAPPING):
        EdkWrappingAlgorithm_union_value = EdkWrappingAlgorithm_DIRECT__KEY__WRAPPING(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_DIRECT_KEY_WRAPPING(input.value))
        ...
        EdkWrappingAlgorithm_union_value = EdkWrappingAlgorithm_IntermediateKeyWrapping(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_IntermediateKeyWrapping(input.value))
    else:
        raise ValueError("No recognized union value in union type: " + str(input))
...
def aws_cryptography_materialproviders_HKDF(input):
    return DafnyHKDF(
        hmac=aws_cryptography_primitives.smithygenerated.aws_cryptography_primitives.smithy_to_dafny.aws_cryptography_primitives_DigestAlgorithm(input.hmac),
...
def aws_cryptography_materialproviders_ECDSA(input):
    return DafnyECDSA(
        curve=aws_cryptography_primitives.smithygenerated.aws_cryptography_primitives.smithy_to_dafny.aws_cryptography_primitives_ECDSASignatureAlgorithm(input.curve),
    )
...
def aws_cryptography_materialproviders_IntermediateKeyWrapping(input):
    return DafnyIntermediateKeyWrapping(
        keyEncryptionKeyKdf=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_DerivationAlgorithm(input.key_encryption_key_kdf),
        macKeyKdf=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_DerivationAlgorithm(input.mac_key_kdf),
        pdkEncryptAlgorithm=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_Encrypt(input.pdk_encrypt_algorithm),
    )
...
def aws_cryptography_materialproviders_GetEncryptionMaterialsInput(input):
    return DafnyGetEncryptionMaterialsInput(
        encryptionContext=Map({Seq(list(ord(c) for c in key)): Seq(list(ord(c) for c in value)) for (key, value) in input.encryption_context.items() }),
        commitmentPolicy=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_CommitmentPolicy(input.commitment_policy),
        algorithmSuiteId=((Option_Some(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_AlgorithmSuiteId(input.algorithm_suite_id))) if (input.algorithm_suite_id is not None) else (Option_None())),
...
def aws_cryptography_materialproviders_CommitmentPolicy(input):
    if isinstance(input, aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.CommitmentPolicyESDK):
        CommitmentPolicy_union_value = CommitmentPolicy_ESDK(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_ESDKCommitmentPolicy(input.value))
        ...
        CommitmentPolicy_union_value = CommitmentPolicy_DBE(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_DBECommitmentPolicy(input.value))
    else:
        raise ValueError("No recognized union value in union type: " + str(input))
...
def aws_cryptography_materialproviders_GetEncryptionMaterialsOutput(input):
    return DafnyGetEncryptionMaterialsOutput(
        encryptionMaterials=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_EncryptionMaterials(input.encryption_materials),
    )

def aws_cryptography_materialproviders_DecryptMaterialsInput(input):
    return DafnyDecryptMaterialsInput(
        algorithmSuiteId=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_AlgorithmSuiteId(input.algorithm_suite_id),
        commitmentPolicy=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_CommitmentPolicy(input.commitment_policy),
        encryptedDataKeys=Seq([aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_EncryptedDataKey(list_element) for list_element in input.encrypted_data_keys]),
        encryptionContext=Map({Seq(list(ord(c) for c in key)): Seq(list(ord(c) for c in value)) for (key, value) in input.encryption_context.items() }),
...
def aws_cryptography_materialproviders_DecryptMaterialsOutput(input):
    return DafnyDecryptMaterialsOutput(
        decryptionMaterials=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_DecryptionMaterials(input.decryption_materials),
    )

def aws_cryptography_materialproviders_OnEncryptInput(input):
    return DafnyOnEncryptInput(
        materials=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_EncryptionMaterials(input.materials),
    )
...
def aws_cryptography_materialproviders_OnDecryptInput(input):
    return DafnyOnDecryptInput(
        materials=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_DecryptionMaterials(input.materials),
        encryptedDataKeys=Seq([aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_EncryptedDataKey(list_element) for list_element in input.encrypted_data_keys]),
    )
...
def aws_cryptography_materialproviders_CreateAwsKmsKeyringInput(input):
    return DafnyCreateAwsKmsKeyringInput(
        ...
        kmsClient=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_KmsClientReference(input.kms_client),
...
def aws_cryptography_materialproviders_CreateAwsKmsDiscoveryKeyringInput(input):
    return DafnyCreateAwsKmsDiscoveryKeyringInput(
        kmsClient=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_KmsClientReference(input.kms_client),
        discoveryFilter=((Option_Some(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_DiscoveryFilter(input.discovery_filter))) if (input.discovery_filter is not None) else (Option_None())),
        grantTokens=((Option_Some(Seq([Seq(list_element) for list_element in input.grant_tokens]))) if (input.grant_tokens is not None) else (Option_None())),
    )
...
def aws_cryptography_materialproviders_CreateAwsKmsHierarchicalKeyringInput(input):
    return DafnyCreateAwsKmsHierarchicalKeyringInput(
        ...
        branchKeyIdSupplier=((Option_Some(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_BranchKeyIdSupplierReference(input.branch_key_id_supplier))) if ((input.branch_key_id_supplier is not None) and (aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_BranchKeyIdSupplierReference(input.branch_key_id_supplier) is not None)) else (Option_None())),
        keyStore=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_KeyStoreReference(input.key_store),
        ttlSeconds=input.ttl_seconds,
        cache=((Option_Some(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_CacheType(input.cache))) if (input.cache is not None) else (Option_None())),
    )
...
def aws_cryptography_materialproviders_CacheType(input):
    if isinstance(input, aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.CacheTypeDefault):
        CacheType_union_value = CacheType_Default(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_DefaultCache(input.value))
        ...
        CacheType_union_value = CacheType_No(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_NoCache(input.value))
        ...
        CacheType_union_value = CacheType_SingleThreaded(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_SingleThreadedCache(input.value))
        ...
        CacheType_union_value = CacheType_MultiThreaded(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_MultiThreadedCache(input.value))
        ...
        CacheType_union_value = CacheType_StormTracking(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_StormTrackingCache(input.value))
    else:
        raise ValueError("No recognized union value in union type: " + str(input))
...
def aws_cryptography_materialproviders_CreateMultiKeyringInput(input):
    return DafnyCreateMultiKeyringInput(
        generator=((Option_Some(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_KeyringReference(input.generator))) if ((input.generator is not None) and (aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_KeyringReference(input.generator) is not None)) else (Option_None())),
        childKeyrings=Seq([aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_KeyringReference(list_element) for list_element in input.child_keyrings]),
    )
...
def aws_cryptography_materialproviders_CreateRawAesKeyringInput(input):
    return DafnyCreateRawAesKeyringInput(
        ...
        wrappingAlg=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_AesWrappingAlg(input.wrapping_alg),
    )
...
def aws_cryptography_materialproviders_CreateRawRsaKeyringInput(input):
    return DafnyCreateRawRsaKeyringInput(
        keyNamespace=Seq(input.key_namespace),
        keyName=Seq(input.key_name),
        paddingScheme=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_PaddingScheme(input.padding_scheme),
...
def aws_cryptography_materialproviders_CreateAwsKmsRsaKeyringInput(input):
    return DafnyCreateAwsKmsRsaKeyringInput(
        ...
        kmsClient=((Option_Some(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_KmsClientReference(input.kms_client))) if ((input.kms_client is not None) and (aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_KmsClientReference(input.kms_client) is not None)) else (Option_None())),
        grantTokens=((Option_Some(Seq([Seq(list_element) for list_element in input.grant_tokens]))) if (input.grant_tokens is not None) else (Option_None())),
    )

def aws_cryptography_materialproviders_CreateDefaultCryptographicMaterialsManagerInput(input):
    return DafnyCreateDefaultCryptographicMaterialsManagerInput(
        keyring=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_KeyringReference(input.keyring),
    )
...
def aws_cryptography_materialproviders_CreateRequiredEncryptionContextCMMInput(input):
    return DafnyCreateRequiredEncryptionContextCMMInput(
        underlyingCMM=((Option_Some(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_CryptographicMaterialsManagerReference(input.underlying_cmm))) if ((input.underlying_cmm is not None) and (aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_CryptographicMaterialsManagerReference(input.underlying_cmm) is not None)) else (Option_None())),
        keyring=((Option_Some(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_KeyringReference(input.keyring))) if ((input.keyring is not None) and (aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_KeyringReference(input.keyring) is not None)) else (Option_None())),
        requiredEncryptionContextKeys=Seq([Seq(list(ord(c) for c in list_element)) for list_element in input.required_encryption_context_keys]),
    )
...
def aws_cryptography_materialproviders_CreateCryptographicMaterialsCacheInput(input):
    return DafnyCreateCryptographicMaterialsCacheInput(
        cache=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_CacheType(input.cache),
    )
...
def aws_cryptography_materialproviders_ValidEncryptionMaterialsTransitionInput(input):
    return DafnyValidEncryptionMaterialsTransitionInput(
        start=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_EncryptionMaterials(input.start),
        stop=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_EncryptionMaterials(input.stop),
    )
...
def aws_cryptography_materialproviders_ValidDecryptionMaterialsTransitionInput(input):
    return DafnyValidDecryptionMaterialsTransitionInput(
        start=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_DecryptionMaterials(input.start),
        stop=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_DecryptionMaterials(input.stop),
    )
...
def aws_cryptography_materialproviders_ValidateCommitmentPolicyOnEncryptInput(input):
    return DafnyValidateCommitmentPolicyOnEncryptInput(
        algorithm=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_AlgorithmSuiteId(input.algorithm),
        commitmentPolicy=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_CommitmentPolicy(input.commitment_policy),
    )
...
def aws_cryptography_materialproviders_CreateKeyringOutput(input):
    return aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_KeyringReference(input)
...
def aws_cryptography_materialproviders_CreateCryptographicMaterialsCacheOutput(input):
    return aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_CryptographicMaterialsCacheReference(input)
...
def aws_cryptography_materialproviders_CreateDefaultClientSupplierOutput(input):
    return aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_ClientSupplierReference(input)
