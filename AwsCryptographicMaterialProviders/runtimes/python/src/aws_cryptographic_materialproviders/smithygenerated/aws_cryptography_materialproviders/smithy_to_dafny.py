...
def aws_cryptography_materialproviders_CacheType(native_input):
    ...
    elif isinstance(native_input, aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.CacheTypeShared):
        CacheType_union_value = CacheType_Shared(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_CryptographicMaterialsCacheReference(native_input.value))
    else:
        raise ValueError("No recognized union value in union type: " + str(native_input))
