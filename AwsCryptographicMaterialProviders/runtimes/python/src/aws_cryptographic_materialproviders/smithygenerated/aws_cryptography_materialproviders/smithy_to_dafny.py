...
def SmithyToDafny_aws_cryptography_materialproviders_GetEncryptionMaterialsInput(input):
    return DafnyGetEncryptionMaterialsInput(
        ...
        requiredEncryptionContextKeys=((Option_Some(Seq([Seq(list(ord(c) for c in list_element)) for list_element in input.required_encryption_context_keys]))) if (input.required_encryption_context_keys is not None) else (Option_None())),
    )
...
def SmithyToDafny_aws_cryptography_materialproviders_DecryptMaterialsInput(input):
    return DafnyDecryptMaterialsInput(
        ...
        encryptedDataKeys=Seq([aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.SmithyToDafny_aws_cryptography_materialproviders_EncryptedDataKey(list_element) for list_element in input.encrypted_data_keys]),
        encryptionContext=Map({Seq(list(ord(c) for c in key)): Seq(list(ord(c) for c in value)) for (key, value) in input.encryption_context.items() }),
        reproducedEncryptionContext=((Option_Some(Map({Seq(list(ord(c) for c in key)): Seq(list(ord(c) for c in value)) for (key, value) in input.reproduced_encryption_context.items() }))) if (input.reproduced_encryption_context is not None) else (Option_None())),
    )
