...
def aws_cryptography_materialproviders_PutCacheEntryInput(native_input):
    return DafnyPutCacheEntryInput(
        ...
        materials=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_Materials(native_input.materials),
...
def aws_cryptography_materialproviders_Materials(native_input):
    if isinstance(native_input, aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.MaterialsEncryption):
        Materials_union_value = Materials_Encryption(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_EncryptionMaterials(native_input.value))
    elif isinstance(native_input, aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.MaterialsDecryption):
        Materials_union_value = Materials_Decryption(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_DecryptionMaterials(native_input.value))
    elif isinstance(native_input, aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.MaterialsBranchKey):
        Materials_union_value = Materials_BranchKey(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_keystore.smithy_to_dafny.aws_cryptography_keystore_BranchKeyMaterials(native_input.value))
    elif isinstance(native_input, aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.MaterialsBeaconKey):
        Materials_union_value = Materials_BeaconKey(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_keystore.smithy_to_dafny.aws_cryptography_keystore_BeaconKeyMaterials(native_input.value))
    else:
...
def aws_cryptography_materialproviders_EncryptionMaterials(native_input):
    return DafnyEncryptionMaterials(
        algorithmSuite=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_AlgorithmSuiteInfo(native_input.algorithm_suite),
        encryptionContext=Map({UTF8.default__.Encode(Seq(key)).value: UTF8.default__.Encode(Seq(value)).value for (key, value) in native_input.encryption_context.items() }),
        encryptedDataKeys=Seq([aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_EncryptedDataKey(list_element) for list_element in native_input.encrypted_data_keys]),
        requiredEncryptionContextKeys=Seq([UTF8.default__.Encode(Seq(list_element)).value for list_element in native_input.required_encryption_context_keys]),
...
def aws_cryptography_materialproviders_AlgorithmSuiteInfo(native_input):
    return DafnyAlgorithmSuiteInfo(
        id=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_AlgorithmSuiteId(native_input.id),
        binaryId=Seq(native_input.binary_id),
        messageVersion=native_input.message_version,
        encrypt=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_Encrypt(native_input.encrypt),
        kdf=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_DerivationAlgorithm(native_input.kdf),
        commitment=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_DerivationAlgorithm(native_input.commitment),
        signature=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_SignatureAlgorithm(native_input.signature),
        symmetricSignature=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_SymmetricSignatureAlgorithm(native_input.symmetric_signature),
        edkWrapping=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_EdkWrappingAlgorithm(native_input.edk_wrapping),
    )
...
def aws_cryptography_materialproviders_AlgorithmSuiteId(native_input):
    if isinstance(native_input, aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.AlgorithmSuiteIdESDK):
        AlgorithmSuiteId_union_value = AlgorithmSuiteId_ESDK(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_ESDKAlgorithmSuiteId(native_input.value))
    elif isinstance(native_input, aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.AlgorithmSuiteIdDBE):
        AlgorithmSuiteId_union_value = AlgorithmSuiteId_DBE(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_DBEAlgorithmSuiteId(native_input.value))
    else:
        raise ValueError("No recognized union value in union type: " + str(native_input))
...
def aws_cryptography_materialproviders_Encrypt(native_input):
    if isinstance(native_input, aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.EncryptAES_GCM):
...
def aws_cryptography_materialproviders_DerivationAlgorithm(native_input):
    if isinstance(native_input, aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.DerivationAlgorithmHKDF):
        DerivationAlgorithm_union_value = DerivationAlgorithm_HKDF(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_HKDF(native_input.value))
    elif isinstance(native_input, aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.DerivationAlgorithmIDENTITY):
        DerivationAlgorithm_union_value = DerivationAlgorithm_IDENTITY(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_IDENTITY(native_input.value))
    elif isinstance(native_input, aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.DerivationAlgorithmNone):
        DerivationAlgorithm_union_value = DerivationAlgorithm_None(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_None(native_input.value))
    else:
        raise ValueError("No recognized union value in union type: " + str(native_input))
...
def aws_cryptography_materialproviders_SignatureAlgorithm(native_input):
    if isinstance(native_input, aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.SignatureAlgorithmECDSA):
        SignatureAlgorithm_union_value = SignatureAlgorithm_ECDSA(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_ECDSA(native_input.value))
    elif isinstance(native_input, aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.SignatureAlgorithmNone):
        SignatureAlgorithm_union_value = SignatureAlgorithm_None(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_None(native_input.value))
    else:
        raise ValueError("No recognized union value in union type: " + str(native_input))
...
def aws_cryptography_materialproviders_SymmetricSignatureAlgorithm(native_input):
    if isinstance(native_input, aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.SymmetricSignatureAlgorithmHMAC):
    ...
    elif isinstance(native_input, aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.SymmetricSignatureAlgorithmNone):
        SymmetricSignatureAlgorithm_union_value = SymmetricSignatureAlgorithm_None(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_None(native_input.value))
    else:
        raise ValueError("No recognized union value in union type: " + str(native_input))
...
def aws_cryptography_materialproviders_EdkWrappingAlgorithm(native_input):
    if isinstance(native_input, aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.EdkWrappingAlgorithmDIRECT_KEY_WRAPPING):
        EdkWrappingAlgorithm_union_value = EdkWrappingAlgorithm_DIRECT__KEY__WRAPPING(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_DIRECT_KEY_WRAPPING(native_input.value))
    elif isinstance(native_input, aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.EdkWrappingAlgorithmIntermediateKeyWrapping):
        EdkWrappingAlgorithm_union_value = EdkWrappingAlgorithm_IntermediateKeyWrapping(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_IntermediateKeyWrapping(native_input.value))
    else:
        raise ValueError("No recognized union value in union type: " + str(native_input))
...
def aws_cryptography_materialproviders_IntermediateKeyWrapping(native_input):
    return DafnyIntermediateKeyWrapping(
        keyEncryptionKeyKdf=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_DerivationAlgorithm(native_input.key_encryption_key_kdf),
        macKeyKdf=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_DerivationAlgorithm(native_input.mac_key_kdf),
        pdkEncryptAlgorithm=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_Encrypt(native_input.pdk_encrypt_algorithm),
    )
...
def aws_cryptography_materialproviders_GetEncryptionMaterialsInput(native_input):
    return DafnyGetEncryptionMaterialsInput(
        encryptionContext=Map({UTF8.default__.Encode(Seq(key)).value: UTF8.default__.Encode(Seq(value)).value for (key, value) in native_input.encryption_context.items() }),
        commitmentPolicy=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_CommitmentPolicy(native_input.commitment_policy),
        algorithmSuiteId=((Option_Some(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_AlgorithmSuiteId(native_input.algorithm_suite_id))) if (native_input.algorithm_suite_id is not None) else (Option_None())),
        ...
        requiredEncryptionContextKeys=((Option_Some(Seq([UTF8.default__.Encode(Seq(list_element)).value for list_element in native_input.required_encryption_context_keys]))) if (native_input.required_encryption_context_keys is not None) else (Option_None())),
    )

def aws_cryptography_materialproviders_CommitmentPolicy(native_input):
    if isinstance(native_input, aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.CommitmentPolicyESDK):
        CommitmentPolicy_union_value = CommitmentPolicy_ESDK(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_ESDKCommitmentPolicy(native_input.value))
    elif isinstance(native_input, aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.CommitmentPolicyDBE):
        CommitmentPolicy_union_value = CommitmentPolicy_DBE(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_DBECommitmentPolicy(native_input.value))
    else:
        raise ValueError("No recognized union value in union type: " + str(native_input))
...
def aws_cryptography_materialproviders_GetEncryptionMaterialsOutput(native_input):
    return DafnyGetEncryptionMaterialsOutput(
        encryptionMaterials=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_EncryptionMaterials(native_input.encryption_materials),
    )

def aws_cryptography_materialproviders_DecryptMaterialsInput(native_input):
    return DafnyDecryptMaterialsInput(
        algorithmSuiteId=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_AlgorithmSuiteId(native_input.algorithm_suite_id),
        commitmentPolicy=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_CommitmentPolicy(native_input.commitment_policy),
        encryptedDataKeys=Seq([aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_EncryptedDataKey(list_element) for list_element in native_input.encrypted_data_keys]),
        encryptionContext=Map({UTF8.default__.Encode(Seq(key)).value: UTF8.default__.Encode(Seq(value)).value for (key, value) in native_input.encryption_context.items() }),
        reproducedEncryptionContext=((Option_Some(Map({UTF8.default__.Encode(Seq(key)).value: UTF8.default__.Encode(Seq(value)).value for (key, value) in native_input.reproduced_encryption_context.items() }))) if (native_input.reproduced_encryption_context is not None) else (Option_None())),
    )

def aws_cryptography_materialproviders_DecryptMaterialsOutput(native_input):
    return DafnyDecryptMaterialsOutput(
        decryptionMaterials=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_DecryptionMaterials(native_input.decryption_materials),
    )

def aws_cryptography_materialproviders_OnEncryptInput(native_input):
    return DafnyOnEncryptInput(
        materials=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_EncryptionMaterials(native_input.materials),
    )
...
def aws_cryptography_materialproviders_OnDecryptInput(native_input):
    return DafnyOnDecryptInput(
        materials=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_DecryptionMaterials(native_input.materials),
        encryptedDataKeys=Seq([aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_EncryptedDataKey(list_element) for list_element in native_input.encrypted_data_keys]),
    )
...
def aws_cryptography_materialproviders_CreateAwsKmsKeyringInput(native_input):
    return DafnyCreateAwsKmsKeyringInput(
        ...
        kmsClient=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_KmsClientReference(native_input.kms_client),
...
def aws_cryptography_materialproviders_CreateAwsKmsDiscoveryKeyringInput(native_input):
    return DafnyCreateAwsKmsDiscoveryKeyringInput(
        kmsClient=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_KmsClientReference(native_input.kms_client),
        discoveryFilter=((Option_Some(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_DiscoveryFilter(native_input.discovery_filter))) if (native_input.discovery_filter is not None) else (Option_None())),
        grantTokens=((Option_Some(Seq([Seq(list_element) for list_element in native_input.grant_tokens]))) if (native_input.grant_tokens is not None) else (Option_None())),
    )

def aws_cryptography_materialproviders_DiscoveryFilter(native_input):
    return DafnyDiscoveryFilter(
        accountIds=Seq([Seq(list_element) for list_element in native_input.account_ids]),
...
def aws_cryptography_materialproviders_CreateAwsKmsMultiKeyringInput(native_input):
    return DafnyCreateAwsKmsMultiKeyringInput(
        generator=((Option_Some(Seq(native_input.generator))) if (native_input.generator is not None) else (Option_None())),
        kmsKeyIds=((Option_Some(Seq([Seq(list_element) for list_element in native_input.kms_key_ids]))) if (native_input.kms_key_ids is not None) else (Option_None())),
        clientSupplier=((Option_Some(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_ClientSupplierReference(native_input.client_supplier))) if ((native_input.client_supplier is not None) and (aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_ClientSupplierReference(native_input.client_supplier) is not None)) else (Option_None())),
        grantTokens=((Option_Some(Seq([Seq(list_element) for list_element in native_input.grant_tokens]))) if (native_input.grant_tokens is not None) else (Option_None())),
    )
...
def aws_cryptography_materialproviders_CreateAwsKmsHierarchicalKeyringInput(native_input):
    return DafnyCreateAwsKmsHierarchicalKeyringInput(
        branchKeyId=((Option_Some(Seq(native_input.branch_key_id))) if (native_input.branch_key_id is not None) else (Option_None())),
        branchKeyIdSupplier=((Option_Some(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_BranchKeyIdSupplierReference(native_input.branch_key_id_supplier))) if ((native_input.branch_key_id_supplier is not None) and (aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_BranchKeyIdSupplierReference(native_input.branch_key_id_supplier) is not None)) else (Option_None())),
        keyStore=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_KeyStoreReference(native_input.key_store),
        ttlSeconds=native_input.ttl_seconds,
        cache=((Option_Some(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_CacheType(native_input.cache))) if (native_input.cache is not None) else (Option_None())),
    )
...
def aws_cryptography_materialproviders_CacheType(native_input):
    if isinstance(native_input, aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.CacheTypeDefault):
        CacheType_union_value = CacheType_Default(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_DefaultCache(native_input.value))
    elif isinstance(native_input, aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.CacheTypeNo):
        CacheType_union_value = CacheType_No(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_NoCache(native_input.value))
    elif isinstance(native_input, aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.CacheTypeSingleThreaded):
        CacheType_union_value = CacheType_SingleThreaded(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_SingleThreadedCache(native_input.value))
    elif isinstance(native_input, aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.CacheTypeMultiThreaded):
        CacheType_union_value = CacheType_MultiThreaded(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_MultiThreadedCache(native_input.value))
    elif isinstance(native_input, aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.CacheTypeStormTracking):
        CacheType_union_value = CacheType_StormTracking(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_StormTrackingCache(native_input.value))
    else:
        raise ValueError("No recognized union value in union type: " + str(native_input))
...
def aws_cryptography_materialproviders_CreateAwsKmsRsaKeyringInput(native_input):
    return DafnyCreateAwsKmsRsaKeyringInput(
        ...
        kmsClient=((Option_Some(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_KmsClientReference(native_input.kms_client))) if ((native_input.kms_client is not None) and (aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_KmsClientReference(native_input.kms_client) is not None)) else (Option_None())),
        grantTokens=((Option_Some(Seq([Seq(list_element) for list_element in native_input.grant_tokens]))) if (native_input.grant_tokens is not None) else (Option_None())),
    )

def aws_cryptography_materialproviders_CreateAwsKmsEcdhKeyringInput(native_input):
    return DafnyCreateAwsKmsEcdhKeyringInput(
        KeyAgreementScheme=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_KmsEcdhStaticConfigurations(native_input.key_agreement_scheme),
...
def aws_cryptography_materialproviders_KmsEcdhStaticConfigurations(native_input):
    if isinstance(native_input, aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.KmsEcdhStaticConfigurationsKmsPublicKeyDiscovery):
        KmsEcdhStaticConfigurations_union_value = KmsEcdhStaticConfigurations_KmsPublicKeyDiscovery(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_KmsPublicKeyDiscoveryInput(native_input.value))
    elif isinstance(native_input, aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.KmsEcdhStaticConfigurationsKmsPrivateKeyToStaticPublicKey):
        KmsEcdhStaticConfigurations_union_value = KmsEcdhStaticConfigurations_KmsPrivateKeyToStaticPublicKey(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_KmsPrivateKeyToStaticPublicKeyInput(native_input.value))
    else:
        raise ValueError("No recognized union value in union type: " + str(native_input))
...
def aws_cryptography_materialproviders_CreateMultiKeyringInput(native_input):
    return DafnyCreateMultiKeyringInput(
        generator=((Option_Some(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_KeyringReference(native_input.generator))) if ((native_input.generator is not None) and (aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_KeyringReference(native_input.generator) is not None)) else (Option_None())),
        childKeyrings=Seq([aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_KeyringReference(list_element) for list_element in native_input.child_keyrings]),
    )
...
def aws_cryptography_materialproviders_CreateRawAesKeyringInput(native_input):
    return DafnyCreateRawAesKeyringInput(
        ...
        wrappingAlg=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_AesWrappingAlg(native_input.wrapping_alg),
    )
...
def aws_cryptography_materialproviders_CreateRawRsaKeyringInput(native_input):
    return DafnyCreateRawRsaKeyringInput(
        keyNamespace=Seq(native_input.key_namespace),
        keyName=Seq(native_input.key_name),
        paddingScheme=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_PaddingScheme(native_input.padding_scheme),
        publicKey=((Option_Some(Seq(native_input.public_key))) if (native_input.public_key is not None) else (Option_None())),
...
def aws_cryptography_materialproviders_CreateRawEcdhKeyringInput(native_input):
    return DafnyCreateRawEcdhKeyringInput(
        KeyAgreementScheme=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_RawEcdhStaticConfigurations(native_input.key_agreement_scheme),
        curveSpec=aws_cryptography_primitives.smithygenerated.aws_cryptography_primitives.smithy_to_dafny.aws_cryptography_primitives_ECDHCurveSpec(native_input.curve_spec),
    )

def aws_cryptography_materialproviders_RawEcdhStaticConfigurations(native_input):
    if isinstance(native_input, aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.RawEcdhStaticConfigurationsPublicKeyDiscovery):
        RawEcdhStaticConfigurations_union_value = RawEcdhStaticConfigurations_PublicKeyDiscovery(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_PublicKeyDiscoveryInput(native_input.value))
    elif isinstance(native_input, aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.RawEcdhStaticConfigurationsRawPrivateKeyToStaticPublicKey):
        RawEcdhStaticConfigurations_union_value = RawEcdhStaticConfigurations_RawPrivateKeyToStaticPublicKey(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_RawPrivateKeyToStaticPublicKeyInput(native_input.value))
    elif isinstance(native_input, aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.RawEcdhStaticConfigurationsEphemeralPrivateKeyToStaticPublicKey):
...
def aws_cryptography_materialproviders_CreateDefaultCryptographicMaterialsManagerInput(native_input):
    return DafnyCreateDefaultCryptographicMaterialsManagerInput(
        keyring=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_KeyringReference(native_input.keyring),
    )
...
def aws_cryptography_materialproviders_CreateRequiredEncryptionContextCMMInput(native_input):
    return DafnyCreateRequiredEncryptionContextCMMInput(
        ...
        keyring=((Option_Some(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_KeyringReference(native_input.keyring))) if ((native_input.keyring is not None) and (aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_KeyringReference(native_input.keyring) is not None)) else (Option_None())),
        requiredEncryptionContextKeys=Seq([UTF8.default__.Encode(Seq(list_element)).value for list_element in native_input.required_encryption_context_keys]),
    )
...
def aws_cryptography_materialproviders_CreateCryptographicMaterialsCacheInput(native_input):
    return DafnyCreateCryptographicMaterialsCacheInput(
        cache=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_CacheType(native_input.cache),
    )
...
def aws_cryptography_materialproviders_ValidEncryptionMaterialsTransitionInput(native_input):
    return DafnyValidEncryptionMaterialsTransitionInput(
        start=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_EncryptionMaterials(native_input.start),
        stop=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_EncryptionMaterials(native_input.stop),
    )
...
def aws_cryptography_materialproviders_ValidDecryptionMaterialsTransitionInput(native_input):
    return DafnyValidDecryptionMaterialsTransitionInput(
        start=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_DecryptionMaterials(native_input.start),
        stop=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_DecryptionMaterials(native_input.stop),
    )
...
def aws_cryptography_materialproviders_ValidateCommitmentPolicyOnEncryptInput(native_input):
    return DafnyValidateCommitmentPolicyOnEncryptInput(
        algorithm=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_AlgorithmSuiteId(native_input.algorithm),
        commitmentPolicy=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_CommitmentPolicy(native_input.commitment_policy),
    )
...
def aws_cryptography_materialproviders_CreateKeyringOutput(native_input):
    return aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_KeyringReference(native_input)

def aws_cryptography_materialproviders_CreateCryptographicMaterialsManagerOutput(native_input):
    return aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_CryptographicMaterialsManagerReference(native_input)
...
def aws_cryptography_materialproviders_CreateCryptographicMaterialsCacheOutput(native_input):
    return aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_CryptographicMaterialsCacheReference(native_input)
...
def aws_cryptography_materialproviders_CreateDefaultClientSupplierOutput(native_input):
    return aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_ClientSupplierReference(native_input)
