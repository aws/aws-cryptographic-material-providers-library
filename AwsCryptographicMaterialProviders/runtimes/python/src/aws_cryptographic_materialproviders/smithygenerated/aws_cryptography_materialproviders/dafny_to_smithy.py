...
def aws_cryptography_materialproviders_GetClientOutput(dafny_input):
    return aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_KmsClientReference(dafny_input)

def aws_cryptography_materialproviders_Materials(dafny_input):
    # Convert Materials
    if isinstance(dafny_input, Materials_Encryption):
        Materials_union_value = aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.MaterialsEncryption(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_EncryptionMaterials(dafny_input.Encryption))
    elif isinstance(dafny_input, Materials_Decryption):
        Materials_union_value = aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.MaterialsDecryption(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_DecryptionMaterials(dafny_input.Decryption))
    elif isinstance(dafny_input, Materials_BranchKey):
        Materials_union_value = aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.MaterialsBranchKey(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_keystore.dafny_to_smithy.aws_cryptography_keystore_BranchKeyMaterials(dafny_input.BranchKey))
    elif isinstance(dafny_input, Materials_BeaconKey):
        Materials_union_value = aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.MaterialsBeaconKey(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_keystore.dafny_to_smithy.aws_cryptography_keystore_BeaconKeyMaterials(dafny_input.BeaconKey))
    else:
...
def aws_cryptography_materialproviders_AlgorithmSuiteInfo(dafny_input):
    return aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.AlgorithmSuiteInfo(
        id=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_AlgorithmSuiteId(dafny_input.id),
        binary_id=bytes(dafny_input.binaryId),
        message_version=dafny_input.messageVersion,
        encrypt=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_Encrypt(dafny_input.encrypt),
        kdf=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_DerivationAlgorithm(dafny_input.kdf),
        commitment=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_DerivationAlgorithm(dafny_input.commitment),
        signature=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_SignatureAlgorithm(dafny_input.signature),
        symmetric_signature=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_SymmetricSignatureAlgorithm(dafny_input.symmetricSignature),
        edk_wrapping=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_EdkWrappingAlgorithm(dafny_input.edkWrapping),
    )
...
def aws_cryptography_materialproviders_AlgorithmSuiteId(dafny_input):
    ...
    if isinstance(dafny_input, AlgorithmSuiteId_ESDK):
        AlgorithmSuiteId_union_value = aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.AlgorithmSuiteIdESDK(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_ESDKAlgorithmSuiteId(dafny_input.ESDK))
    elif isinstance(dafny_input, AlgorithmSuiteId_DBE):
        AlgorithmSuiteId_union_value = aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.AlgorithmSuiteIdDBE(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_DBEAlgorithmSuiteId(dafny_input.DBE))
    else:
        raise ValueError("No recognized union value in union type: " + str(dafny_input))
...
def aws_cryptography_materialproviders_Encrypt(dafny_input):
    ...
    if isinstance(dafny_input, Encrypt_AES__GCM):
        Encrypt_union_value = aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.EncryptAES_GCM(aws_cryptography_primitives.smithygenerated.aws_cryptography_primitives.dafny_to_smithy.aws_cryptography_primitives_AES_GCM(dafny_input.AES__GCM))
    else:
        raise ValueError("No recognized union value in union type: " + str(dafny_input))
...
def aws_cryptography_materialproviders_DerivationAlgorithm(dafny_input):
    ...
    if isinstance(dafny_input, DerivationAlgorithm_HKDF):
        DerivationAlgorithm_union_value = aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.DerivationAlgorithmHKDF(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_HKDF(dafny_input.HKDF))
        ...
        DerivationAlgorithm_union_value = aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.DerivationAlgorithmNone(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_None(dafny_input.None_))
    else:
        raise ValueError("No recognized union value in union type: " + str(dafny_input))
...
def aws_cryptography_materialproviders_SignatureAlgorithm(dafny_input):
    ...
    if isinstance(dafny_input, SignatureAlgorithm_ECDSA):
        SignatureAlgorithm_union_value = aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.SignatureAlgorithmECDSA(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_ECDSA(dafny_input.ECDSA))
    elif isinstance(dafny_input, SignatureAlgorithm_None):
        SignatureAlgorithm_union_value = aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.SignatureAlgorithmNone(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_None(dafny_input.None_))
    else:
        raise ValueError("No recognized union value in union type: " + str(dafny_input))
...
def aws_cryptography_materialproviders_SymmetricSignatureAlgorithm(dafny_input):
    ...
    if isinstance(dafny_input, SymmetricSignatureAlgorithm_HMAC):
        ...
        SymmetricSignatureAlgorithm_union_value = aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.SymmetricSignatureAlgorithmNone(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_None(dafny_input.None_))
    else:
        raise ValueError("No recognized union value in union type: " + str(dafny_input))
...
def aws_cryptography_materialproviders_EdkWrappingAlgorithm(dafny_input):
    ...
    if isinstance(dafny_input, EdkWrappingAlgorithm_DIRECT__KEY__WRAPPING):
        EdkWrappingAlgorithm_union_value = aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.EdkWrappingAlgorithmDIRECT_KEY_WRAPPING(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_DIRECT_KEY_WRAPPING(dafny_input.DIRECT__KEY__WRAPPING))
...
def aws_cryptography_materialproviders_IDENTITY(dafny_input):
    return aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.IDENTITY(
    )

def aws_cryptography_materialproviders_None(dafny_input):
    return aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.None_(
    )
...
def aws_cryptography_materialproviders_DIRECT_KEY_WRAPPING(dafny_input):
    return aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.DIRECT_KEY_WRAPPING(
    )
...
def aws_cryptography_materialproviders_IntermediateKeyWrapping(dafny_input):
    return aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.IntermediateKeyWrapping(
        key_encryption_key_kdf=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_DerivationAlgorithm(dafny_input.keyEncryptionKeyKdf),
        mac_key_kdf=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_DerivationAlgorithm(dafny_input.macKeyKdf),
        pdk_encrypt_algorithm=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_Encrypt(dafny_input.pdkEncryptAlgorithm),
    )
...
def aws_cryptography_materialproviders_PutCacheEntryInput(dafny_input):
    return aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.PutCacheEntryInput(
        ...
        materials=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_Materials(dafny_input.materials),
...
def aws_cryptography_materialproviders_CommitmentPolicy(dafny_input):
    ...
    if isinstance(dafny_input, CommitmentPolicy_ESDK):
        CommitmentPolicy_union_value = aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.CommitmentPolicyESDK(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_ESDKCommitmentPolicy(dafny_input.ESDK))
    elif isinstance(dafny_input, CommitmentPolicy_DBE):
        CommitmentPolicy_union_value = aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.CommitmentPolicyDBE(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_DBECommitmentPolicy(dafny_input.DBE))
    else:
        raise ValueError("No recognized union value in union type: " + str(dafny_input))
...
def aws_cryptography_materialproviders_GetEncryptionMaterialsOutput(dafny_input):
    return aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.GetEncryptionMaterialsOutput(
        encryption_materials=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_EncryptionMaterials(dafny_input.encryptionMaterials),
    )
...
def aws_cryptography_materialproviders_DecryptMaterialsOutput(dafny_input):
    return aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.DecryptMaterialsOutput(
        decryption_materials=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_DecryptionMaterials(dafny_input.decryptionMaterials),
    )
...
def aws_cryptography_materialproviders_OnEncryptInput(dafny_input):
    return aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.OnEncryptInput(
        materials=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_EncryptionMaterials(dafny_input.materials),
    )
...
def aws_cryptography_materialproviders_OnDecryptInput(dafny_input):
    return aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.OnDecryptInput(
        materials=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_DecryptionMaterials(dafny_input.materials),
        encrypted_data_keys=[aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_EncryptedDataKey(list_element) for list_element in dafny_input.encryptedDataKeys],
    )
...
def aws_cryptography_materialproviders_CreateAwsKmsKeyringInput(dafny_input):
    return aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.CreateAwsKmsKeyringInput(
        ...
        kms_client=(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_KmsClientReference(dafny_input.kmsClient)) if (dafny_input.kmsClient is not None) else None,
...
def aws_cryptography_materialproviders_DiscoveryFilter(dafny_input):
    return aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.DiscoveryFilter(
        account_ids=[list_element.VerbatimString(False) for list_element in dafny_input.accountIds],
...
def aws_cryptography_materialproviders_CreateAwsKmsDiscoveryKeyringInput(dafny_input):
    return aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.CreateAwsKmsDiscoveryKeyringInput(
        kms_client=(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_KmsClientReference(dafny_input.kmsClient)) if (dafny_input.kmsClient is not None) else None,
        discovery_filter=(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_DiscoveryFilter(dafny_input.discoveryFilter.value)) if (dafny_input.discoveryFilter.is_Some) else None,
        grant_tokens=([list_element.VerbatimString(False) for list_element in dafny_input.grantTokens.value]) if (dafny_input.grantTokens.is_Some) else None,
    )
...
def aws_cryptography_materialproviders_CreateAwsKmsMultiKeyringInput(dafny_input):
    return aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.CreateAwsKmsMultiKeyringInput(
        generator=(dafny_input.generator.value.VerbatimString(False)) if (dafny_input.generator.is_Some) else None,
        kms_key_ids=([list_element.VerbatimString(False) for list_element in dafny_input.kmsKeyIds.value]) if (dafny_input.kmsKeyIds.is_Some) else None,
        client_supplier=(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_ClientSupplierReference(dafny_input.clientSupplier.UnwrapOr(None))) if (dafny_input.clientSupplier.UnwrapOr(None) is not None) else None,
        grant_tokens=([list_element.VerbatimString(False) for list_element in dafny_input.grantTokens.value]) if (dafny_input.grantTokens.is_Some) else None,
    )
...
def aws_cryptography_materialproviders_CreateAwsKmsDiscoveryMultiKeyringInput(dafny_input):
    return aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.CreateAwsKmsDiscoveryMultiKeyringInput(
        regions=[list_element.VerbatimString(False) for list_element in dafny_input.regions],
        discovery_filter=(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_DiscoveryFilter(dafny_input.discoveryFilter.value)) if (dafny_input.discoveryFilter.is_Some) else None,
        client_supplier=(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_ClientSupplierReference(dafny_input.clientSupplier.UnwrapOr(None))) if (dafny_input.clientSupplier.UnwrapOr(None) is not None) else None,
        grant_tokens=([list_element.VerbatimString(False) for list_element in dafny_input.grantTokens.value]) if (dafny_input.grantTokens.is_Some) else None,
    )
...
def aws_cryptography_materialproviders_CacheType(dafny_input):
    ...
    if isinstance(dafny_input, CacheType_Default):
        CacheType_union_value = aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.CacheTypeDefault(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_DefaultCache(dafny_input.Default))
    elif isinstance(dafny_input, CacheType_No):
        CacheType_union_value = aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.CacheTypeNo(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_NoCache(dafny_input.No))
    elif isinstance(dafny_input, CacheType_SingleThreaded):
        CacheType_union_value = aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.CacheTypeSingleThreaded(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_SingleThreadedCache(dafny_input.SingleThreaded))
    elif isinstance(dafny_input, CacheType_MultiThreaded):
        CacheType_union_value = aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.CacheTypeMultiThreaded(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_MultiThreadedCache(dafny_input.MultiThreaded))
    elif isinstance(dafny_input, CacheType_StormTracking):
        CacheType_union_value = aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.CacheTypeStormTracking(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_StormTrackingCache(dafny_input.StormTracking))
    else:
        raise ValueError("No recognized union value in union type: " + str(dafny_input))
...
def aws_cryptography_materialproviders_NoCache(dafny_input):
    return aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.NoCache(
    )
...
def aws_cryptography_materialproviders_CreateAwsKmsHierarchicalKeyringInput(dafny_input):
    return aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.CreateAwsKmsHierarchicalKeyringInput(
        branch_key_id=(dafny_input.branchKeyId.value.VerbatimString(False)) if (dafny_input.branchKeyId.is_Some) else None,
        branch_key_id_supplier=(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_BranchKeyIdSupplierReference(dafny_input.branchKeyIdSupplier.UnwrapOr(None))) if (dafny_input.branchKeyIdSupplier.UnwrapOr(None) is not None) else None,
        key_store=(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_KeyStoreReference(dafny_input.keyStore)) if (dafny_input.keyStore is not None) else None,
        ttl_seconds=dafny_input.ttlSeconds,
        cache=(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_CacheType(dafny_input.cache.value)) if (dafny_input.cache.is_Some) else None,
    )
...
def aws_cryptography_materialproviders_CreateAwsKmsRsaKeyringInput(dafny_input):
    return aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.CreateAwsKmsRsaKeyringInput(
        ...
        kms_client=(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_KmsClientReference(dafny_input.kmsClient.UnwrapOr(None))) if (dafny_input.kmsClient.UnwrapOr(None) is not None) else None,
        grant_tokens=([list_element.VerbatimString(False) for list_element in dafny_input.grantTokens.value]) if (dafny_input.grantTokens.is_Some) else None,
    )
...
def aws_cryptography_materialproviders_KmsEcdhStaticConfigurations(dafny_input):
    ...
    if isinstance(dafny_input, KmsEcdhStaticConfigurations_KmsPublicKeyDiscovery):
        KmsEcdhStaticConfigurations_union_value = aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.KmsEcdhStaticConfigurationsKmsPublicKeyDiscovery(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_KmsPublicKeyDiscoveryInput(dafny_input.KmsPublicKeyDiscovery))
    elif isinstance(dafny_input, KmsEcdhStaticConfigurations_KmsPrivateKeyToStaticPublicKey):
        KmsEcdhStaticConfigurations_union_value = aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.KmsEcdhStaticConfigurationsKmsPrivateKeyToStaticPublicKey(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_KmsPrivateKeyToStaticPublicKeyInput(dafny_input.KmsPrivateKeyToStaticPublicKey))
    else:
        raise ValueError("No recognized union value in union type: " + str(dafny_input))
...
def aws_cryptography_materialproviders_KmsPublicKeyDiscoveryInput(dafny_input):
    return aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.KmsPublicKeyDiscoveryInput(
        recipient_kms_identifier=dafny_input.recipientKmsIdentifier.VerbatimString(False),
    )
...
def aws_cryptography_materialproviders_CreateAwsKmsEcdhKeyringInput(dafny_input):
    return aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.CreateAwsKmsEcdhKeyringInput(
        key_agreement_scheme=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_KmsEcdhStaticConfigurations(dafny_input.KeyAgreementScheme),
...
def aws_cryptography_materialproviders_CreateMultiKeyringInput(dafny_input):
    return aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.CreateMultiKeyringInput(
        generator=(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_KeyringReference(dafny_input.generator.UnwrapOr(None))) if (dafny_input.generator.UnwrapOr(None) is not None) else None,
        child_keyrings=[aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_KeyringReference(list_element) for list_element in dafny_input.childKeyrings],
    )
...
def aws_cryptography_materialproviders_CreateRawAesKeyringInput(dafny_input):
    return aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.CreateRawAesKeyringInput(
        ...
        wrapping_alg=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_AesWrappingAlg(dafny_input.wrappingAlg),
    )
...
def aws_cryptography_materialproviders_CreateRawRsaKeyringInput(dafny_input):
    return aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.CreateRawRsaKeyringInput(
        key_namespace=dafny_input.keyNamespace.VerbatimString(False),
        key_name=dafny_input.keyName.VerbatimString(False),
        padding_scheme=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_PaddingScheme(dafny_input.paddingScheme),
        public_key=(bytes(dafny_input.publicKey.value)) if (dafny_input.publicKey.is_Some) else None,
...
def aws_cryptography_materialproviders_RawEcdhStaticConfigurations(dafny_input):
    ...
    if isinstance(dafny_input, RawEcdhStaticConfigurations_PublicKeyDiscovery):
        RawEcdhStaticConfigurations_union_value = aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.RawEcdhStaticConfigurationsPublicKeyDiscovery(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_PublicKeyDiscoveryInput(dafny_input.PublicKeyDiscovery))
    elif isinstance(dafny_input, RawEcdhStaticConfigurations_RawPrivateKeyToStaticPublicKey):
        RawEcdhStaticConfigurations_union_value = aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.RawEcdhStaticConfigurationsRawPrivateKeyToStaticPublicKey(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_RawPrivateKeyToStaticPublicKeyInput(dafny_input.RawPrivateKeyToStaticPublicKey))
    elif isinstance(dafny_input, RawEcdhStaticConfigurations_EphemeralPrivateKeyToStaticPublicKey):
        RawEcdhStaticConfigurations_union_value = aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.RawEcdhStaticConfigurationsEphemeralPrivateKeyToStaticPublicKey(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_EphemeralPrivateKeyToStaticPublicKeyInput(dafny_input.EphemeralPrivateKeyToStaticPublicKey))
    else:
        raise ValueError("No recognized union value in union type: " + str(dafny_input))
...
def aws_cryptography_materialproviders_PublicKeyDiscoveryInput(dafny_input):
    return aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.PublicKeyDiscoveryInput(
...
def aws_cryptography_materialproviders_RawPrivateKeyToStaticPublicKeyInput(dafny_input):
    return aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.RawPrivateKeyToStaticPublicKeyInput(
...
def aws_cryptography_materialproviders_EphemeralPrivateKeyToStaticPublicKeyInput(dafny_input):
    return aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.EphemeralPrivateKeyToStaticPublicKeyInput(
        recipient_public_key=bytes(dafny_input.recipientPublicKey),
    )

def aws_cryptography_materialproviders_CreateRawEcdhKeyringInput(dafny_input):
    return aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.CreateRawEcdhKeyringInput(
        key_agreement_scheme=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_RawEcdhStaticConfigurations(dafny_input.KeyAgreementScheme),
        curve_spec=aws_cryptography_primitives.smithygenerated.aws_cryptography_primitives.dafny_to_smithy.aws_cryptography_primitives_ECDHCurveSpec(dafny_input.curveSpec),
    )
...
def aws_cryptography_materialproviders_CreateDefaultCryptographicMaterialsManagerInput(dafny_input):
    return aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.CreateDefaultCryptographicMaterialsManagerInput(
        keyring=(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_KeyringReference(dafny_input.keyring)) if (dafny_input.keyring is not None) else None,
    )
...
def aws_cryptography_materialproviders_CreateCryptographicMaterialsCacheInput(dafny_input):
    return aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.CreateCryptographicMaterialsCacheInput(
        cache=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_CacheType(dafny_input.cache),
    )
...
def aws_cryptography_materialproviders_ValidEncryptionMaterialsTransitionInput(dafny_input):
    return aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.ValidEncryptionMaterialsTransitionInput(
        start=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_EncryptionMaterials(dafny_input.start),
        stop=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_EncryptionMaterials(dafny_input.stop),
    )
...
def aws_cryptography_materialproviders_ValidDecryptionMaterialsTransitionInput(dafny_input):
    return aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.ValidDecryptionMaterialsTransitionInput(
        start=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_DecryptionMaterials(dafny_input.start),
        stop=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_DecryptionMaterials(dafny_input.stop),
    )
...
def aws_cryptography_materialproviders_ValidateCommitmentPolicyOnEncryptInput(dafny_input):
    return aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.models.ValidateCommitmentPolicyOnEncryptInput(
        algorithm=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_AlgorithmSuiteId(dafny_input.algorithm),
        commitment_policy=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_CommitmentPolicy(dafny_input.commitmentPolicy),
    )
...
def aws_cryptography_materialproviders_CreateKeyringOutput(dafny_input):
    return aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_KeyringReference(dafny_input)
...
def aws_cryptography_materialproviders_CreateCryptographicMaterialsCacheOutput(dafny_input):
    return aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_CryptographicMaterialsCacheReference(dafny_input)

def aws_cryptography_materialproviders_CreateDefaultClientSupplierOutput(dafny_input):
    return aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_ClientSupplierReference(dafny_input)
