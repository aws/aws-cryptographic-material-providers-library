...
def aws_cryptography_keystoreadmin_KMSIdentifier(dafny_input):
    ...
    if isinstance(dafny_input, KMSIdentifier_KmsKeyArn):
        KMSIdentifier_union_value = aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_keystoreadmin.models.KMSIdentifierKmsKeyArn(
            b"".join(ord(c).to_bytes(2, "big") for c in dafny_input.KmsKeyArn).decode(
                "utf-16-be"
            )
        )
    elif isinstance(dafny_input, KMSIdentifier_KmsMRKeyArn):
        KMSIdentifier_union_value = aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_keystoreadmin.models.KMSIdentifierKmsMRKeyArn(
...
def aws_cryptography_keystoreadmin_CreateKeyInput(dafny_input):
    return aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_keystoreadmin.models.CreateKeyInput(
        ...
        kms_arn=aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_keystoreadmin.dafny_to_smithy.aws_cryptography_keystoreadmin_KMSIdentifier(
            dafny_input.KmsArn
        ),
        strategy=(
            (
