...
def _deserialize_create_key(input: DafnyResponse, config: Config):
    ...
    return aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_keystoreadmin.dafny_to_smithy.aws_cryptography_keystoreadmin_CreateKeyOutput(
        input.value
    )
...
def _deserialize_version_key(input: DafnyResponse, config: Config):
    ...
    if input.IsFailure():
        return _deserialize_error(input.error)
    return aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_keystoreadmin.dafny_to_smithy.aws_cryptography_keystoreadmin_VersionKeyOutput(
        input.value
    )
...
def _deserialize_initialize_mutation(input: DafnyResponse, config: Config):
    ...
    if input.IsFailure():
        return _deserialize_error(input.error)
    return aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_keystoreadmin.dafny_to_smithy.aws_cryptography_keystoreadmin_InitializeMutationOutput(
        input.value
    )
