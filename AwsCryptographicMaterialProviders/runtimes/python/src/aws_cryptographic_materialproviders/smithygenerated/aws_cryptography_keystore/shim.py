...
def smithy_error_to_dafny_error(e: ServiceError):
    ...
    if isinstance(e, DynamoDB_20120810):
        return software_amazon_cryptography_keystore_internaldafny_types.Error_DynamoDB_20120810(com_amazonaws_dynamodb_sdk_error_to_dafny_error(e.message))

    if isinstance(e, TrentService):
        return software_amazon_cryptography_keystore_internaldafny_types.Error_TrentService(com_amazonaws_kms_sdk_error_to_dafny_error(e.message))
...
class KeyStoreShim(software_amazon_cryptography_keystore_internaldafny_types.IKeyStoreClient):
    ...
    def GetKeyStoreInfo(self, ):
        smithy_client_request: Unit = aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_keystore.dafny_to_smithy.DafnyToSmithy_smithy_api_Unit()
        try:
        ...
        return Wrappers.Result_Success(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_keystore.smithy_to_dafny.SmithyToDafny_aws_cryptography_keystore_GetKeyStoreInfoOutput(smithy_client_response))

    def CreateKeyStore(self, input):
        smithy_client_request: CreateKeyStoreInput = aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_keystore.dafny_to_smithy.DafnyToSmithy_aws_cryptography_keystore_CreateKeyStoreInput(input)
        try:
            smithy_client_response = self._impl.create_key_store(smithy_client_request)
        except ServiceError as e:
            return Wrappers.Result_Failure(smithy_error_to_dafny_error(e))

        return Wrappers.Result_Success(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_keystore.smithy_to_dafny.SmithyToDafny_aws_cryptography_keystore_CreateKeyStoreOutput(smithy_client_response))

    def CreateKey(self, input):
        smithy_client_request: CreateKeyInput = aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_keystore.dafny_to_smithy.DafnyToSmithy_aws_cryptography_keystore_CreateKeyInput(input)
        try:
            smithy_client_response = self._impl.create_key(smithy_client_request)
        except ServiceError as e:
            return Wrappers.Result_Failure(smithy_error_to_dafny_error(e))

        return Wrappers.Result_Success(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_keystore.smithy_to_dafny.SmithyToDafny_aws_cryptography_keystore_CreateKeyOutput(smithy_client_response))

    def VersionKey(self, input):
        smithy_client_request: VersionKeyInput = aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_keystore.dafny_to_smithy.DafnyToSmithy_aws_cryptography_keystore_VersionKeyInput(input)
        try:
            smithy_client_response = self._impl.version_key(smithy_client_request)
        except ServiceError as e:
            return Wrappers.Result_Failure(smithy_error_to_dafny_error(e))

        return Wrappers.Result_Success(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_keystore.smithy_to_dafny.SmithyToDafny_aws_cryptography_keystore_VersionKeyOutput(smithy_client_response))

    def GetActiveBranchKey(self, input):
        smithy_client_request: GetActiveBranchKeyInput = aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_keystore.dafny_to_smithy.DafnyToSmithy_aws_cryptography_keystore_GetActiveBranchKeyInput(input)
        try:
            smithy_client_response = self._impl.get_active_branch_key(smithy_client_request)
        except ServiceError as e:
            return Wrappers.Result_Failure(smithy_error_to_dafny_error(e))

        return Wrappers.Result_Success(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_keystore.smithy_to_dafny.SmithyToDafny_aws_cryptography_keystore_GetActiveBranchKeyOutput(smithy_client_response))

    def GetBranchKeyVersion(self, input):
        smithy_client_request: GetBranchKeyVersionInput = aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_keystore.dafny_to_smithy.DafnyToSmithy_aws_cryptography_keystore_GetBranchKeyVersionInput(input)
        try:
            smithy_client_response = self._impl.get_branch_key_version(smithy_client_request)
        except ServiceError as e:
            return Wrappers.Result_Failure(smithy_error_to_dafny_error(e))

        return Wrappers.Result_Success(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_keystore.smithy_to_dafny.SmithyToDafny_aws_cryptography_keystore_GetBranchKeyVersionOutput(smithy_client_response))

    def GetBeaconKey(self, input):
        smithy_client_request: GetBeaconKeyInput = aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_keystore.dafny_to_smithy.DafnyToSmithy_aws_cryptography_keystore_GetBeaconKeyInput(input)
        try:
            smithy_client_response = self._impl.get_beacon_key(smithy_client_request)
        except ServiceError as e:
            return Wrappers.Result_Failure(smithy_error_to_dafny_error(e))

        return Wrappers.Result_Success(aws_cryptographic_materialproviders.smithygenerated.aws_cryptography_keystore.smithy_to_dafny.SmithyToDafny_aws_cryptography_keystore_GetBeaconKeyOutput(smithy_client_response))
