...
class default__:
    ...
    def ValidateCommitmentPolicyOnEncrypt(algorithm, commitmentPolicy):
        d_0_suite_ = AlgorithmSuites.default__.GetSuite(algorithm)
        if ((commitmentPolicy) == (AwsCryptographyMaterialProvidersTypes.CommitmentPolicy_ESDK(AwsCryptographyMaterialProvidersTypes.ESDKCommitmentPolicy_FORBID__ENCRYPT__ALLOW__DECRYPT()))) and (not(((d_0_suite_).commitment).is_None)):
