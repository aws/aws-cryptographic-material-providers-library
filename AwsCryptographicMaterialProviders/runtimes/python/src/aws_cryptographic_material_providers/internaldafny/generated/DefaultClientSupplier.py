...
class DefaultClientSupplier(AwsCryptographyMaterialProvidersTypes.IClientSupplier):
    ...
    def GetClient(self, input):
        ...
        out1_ = AwsCryptographyMaterialProvidersTypes.IClientSupplier.GetClient(self, input)
        return out1_
    ...
    def GetClient_k(self, input):
        ...
        d_0_maybeClient_: Wrappers.Result
        out0_: Wrappers.Result
        out0_ = Com_Amazonaws_Kms.default__.KMSClientForRegion((input).region)
        d_0_maybeClient_ = out0_
        def lambda0_(d_1_e_):
            return AwsCryptographyMaterialProvidersTypes.Error_ComAmazonawsKms(d_1_e_)

        output = (d_0_maybeClient_).MapFailure(lambda0_)
        return output
        return output
