...
def aws_cryptography_keystore_EncryptedHierarchicalKey(dafny_input):
    return aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.models.EncryptedHierarchicalKey(
        identifier=b''.join(ord(c).to_bytes(2, 'big') for c in dafny_input.Identifier).decode('utf-16-be'),
        type=aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.dafny_to_smithy.aws_cryptography_keystore_HierarchicalKeyType(dafny_input.Type),
        create_time=b''.join(ord(c).to_bytes(2, 'big') for c in dafny_input.CreateTime).decode('utf-16-be'),
        kms_arn=b''.join(ord(c).to_bytes(2, 'big') for c in dafny_input.KmsArn).decode('utf-16-be'),
        encryption_context={b''.join(ord(c).to_bytes(2, 'big') for c in key).decode('utf-16-be'): b''.join(ord(c).to_bytes(2, 'big') for c in value).decode('utf-16-be') for (key, value) in dafny_input.EncryptionContext.items },
...
def aws_cryptography_keystore_HierarchicalKeyType(dafny_input):
    ...
    if isinstance(dafny_input, HierarchicalKeyType_ActiveHierarchicalSymmetricVersion):
        HierarchicalKeyType_union_value = aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.models.HierarchicalKeyTypeActiveHierarchicalSymmetricVersion(aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.dafny_to_smithy.aws_cryptography_keystore_ActiveHierarchicalSymmetric(dafny_input.ActiveHierarchicalSymmetricVersion))
...
def aws_cryptography_keystore_ActiveHierarchicalSymmetric(dafny_input):
    return aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.models.ActiveHierarchicalSymmetric(
        version=b''.join(ord(c).to_bytes(2, 'big') for c in dafny_input.Version).decode('utf-16-be'),
    )
...
def aws_cryptography_keystore_ActiveHierarchicalSymmetricBeacon(dafny_input):
    return aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.models.ActiveHierarchicalSymmetricBeacon(
    )
...
def aws_cryptography_keystore_WriteNewEncryptedBranchKeyInput(dafny_input):
    return aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.models.WriteNewEncryptedBranchKeyInput(
        active=aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.dafny_to_smithy.aws_cryptography_keystore_EncryptedHierarchicalKey(dafny_input.Active),
        version=aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.dafny_to_smithy.aws_cryptography_keystore_EncryptedHierarchicalKey(dafny_input.Version),
        beacon=aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.dafny_to_smithy.aws_cryptography_keystore_EncryptedHierarchicalKey(dafny_input.Beacon),
    )

def aws_cryptography_keystore_WriteNewEncryptedBranchKeyOutput(dafny_input):
    return aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.models.WriteNewEncryptedBranchKeyOutput(
    )
...
def aws_cryptography_keystore_OverWriteEncryptedHierarchicalKey(dafny_input):
    return aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.models.OverWriteEncryptedHierarchicalKey(
        item=aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.dafny_to_smithy.aws_cryptography_keystore_EncryptedHierarchicalKey(dafny_input.Item),
        old=aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.dafny_to_smithy.aws_cryptography_keystore_EncryptedHierarchicalKey(dafny_input.Old),
    )
...
def aws_cryptography_keystore_WriteNewEncryptedBranchKeyVersionInput(dafny_input):
    return aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.models.WriteNewEncryptedBranchKeyVersionInput(
        active=aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.dafny_to_smithy.aws_cryptography_keystore_OverWriteEncryptedHierarchicalKey(dafny_input.Active),
        version=aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.dafny_to_smithy.aws_cryptography_keystore_EncryptedHierarchicalKey(dafny_input.Version),
    )

def aws_cryptography_keystore_WriteNewEncryptedBranchKeyVersionOutput(dafny_input):
    return aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.models.WriteNewEncryptedBranchKeyVersionOutput(
    )
...
def aws_cryptography_keystore_GetKeyStorageInfoInput(dafny_input):
    return aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.models.GetKeyStorageInfoInput(
    )
...
def aws_cryptography_keystore_MutationCommitment(dafny_input):
    return aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.models.MutationCommitment(
        identifier=b''.join(ord(c).to_bytes(2, 'big') for c in dafny_input.Identifier).decode('utf-16-be'),
        create_time=b''.join(ord(c).to_bytes(2, 'big') for c in dafny_input.CreateTime).decode('utf-16-be'),
        uuid=b''.join(ord(c).to_bytes(2, 'big') for c in dafny_input.UUID).decode('utf-16-be'),
...
def aws_cryptography_keystore_GetItemsForInitializeMutationOutput(dafny_input):
    return aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.models.GetItemsForInitializeMutationOutput(
        active_item=aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.dafny_to_smithy.aws_cryptography_keystore_EncryptedHierarchicalKey(dafny_input.ActiveItem),
        beacon_item=aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.dafny_to_smithy.aws_cryptography_keystore_EncryptedHierarchicalKey(dafny_input.BeaconItem),
        mutation_commitment=(aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.dafny_to_smithy.aws_cryptography_keystore_MutationCommitment(dafny_input.MutationCommitment.value)) if (dafny_input.MutationCommitment.is_Some) else None,
        mutation_index=(aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.dafny_to_smithy.aws_cryptography_keystore_MutationIndex(dafny_input.MutationIndex.value)) if (dafny_input.MutationIndex.is_Some) else None,
    )
...
def aws_cryptography_keystore_WriteInitializeMutationVersion(dafny_input):
    ...
    if isinstance(dafny_input, WriteInitializeMutationVersion_rotate):
        WriteInitializeMutationVersion_union_value = aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.models.WriteInitializeMutationVersionRotate(aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.dafny_to_smithy.aws_cryptography_keystore_EncryptedHierarchicalKey(dafny_input.rotate))
...
def aws_cryptography_keystore_WriteInitializeMutationInput(dafny_input):
    return aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.models.WriteInitializeMutationInput(
        active=aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.dafny_to_smithy.aws_cryptography_keystore_OverWriteEncryptedHierarchicalKey(dafny_input.Active),
        version=aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.dafny_to_smithy.aws_cryptography_keystore_WriteInitializeMutationVersion(dafny_input.Version),
        beacon=aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.dafny_to_smithy.aws_cryptography_keystore_OverWriteEncryptedHierarchicalKey(dafny_input.Beacon),
        mutation_commitment=aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.dafny_to_smithy.aws_cryptography_keystore_MutationCommitment(dafny_input.MutationCommitment),
        mutation_index=aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.dafny_to_smithy.aws_cryptography_keystore_MutationIndex(dafny_input.MutationIndex),
    )

def aws_cryptography_keystore_WriteInitializeMutationOutput(dafny_input):
    return aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.models.WriteInitializeMutationOutput(
    )
...
def aws_cryptography_keystore_WriteAtomicMutationInput(dafny_input):
    return aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.models.WriteAtomicMutationInput(
        ...
        version=aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.dafny_to_smithy.aws_cryptography_keystore_WriteInitializeMutationVersion(dafny_input.Version),
        beacon=aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.dafny_to_smithy.aws_cryptography_keystore_OverWriteEncryptedHierarchicalKey(dafny_input.Beacon),
        items=[aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.dafny_to_smithy.aws_cryptography_keystore_OverWriteEncryptedHierarchicalKey(list_element) for list_element in dafny_input.Items],
    )

def aws_cryptography_keystore_WriteAtomicMutationOutput(dafny_input):
    return aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.models.WriteAtomicMutationOutput(
    )
...
def aws_cryptography_keystore_QueryForVersionsInput(dafny_input):
    return aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.models.QueryForVersionsInput(
        exclusive_start_key=(bytes(dafny_input.ExclusiveStartKey.value)) if (dafny_input.ExclusiveStartKey.is_Some) else None,
        identifier=b''.join(ord(c).to_bytes(2, 'big') for c in dafny_input.Identifier).decode('utf-16-be'),
...
def aws_cryptography_keystore_QueryForVersionsOutput(dafny_input):
    return aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.models.QueryForVersionsOutput(
        ...
        items=[aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.dafny_to_smithy.aws_cryptography_keystore_EncryptedHierarchicalKey(list_element) for list_element in dafny_input.Items],
    )
...
def aws_cryptography_keystore_OverWriteMutationIndex(dafny_input):
    return aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.models.OverWriteMutationIndex(
        index=aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.dafny_to_smithy.aws_cryptography_keystore_MutationIndex(dafny_input.Index),
        old=aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.dafny_to_smithy.aws_cryptography_keystore_MutationIndex(dafny_input.Old),
    )
...
def aws_cryptography_keystore_WriteMutatedVersionsInput(dafny_input):
    return aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.models.WriteMutatedVersionsInput(
        items=[aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.dafny_to_smithy.aws_cryptography_keystore_OverWriteEncryptedHierarchicalKey(list_element) for list_element in dafny_input.Items],
        mutation_commitment=aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.dafny_to_smithy.aws_cryptography_keystore_MutationCommitment(dafny_input.MutationCommitment),
        mutation_index=aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.dafny_to_smithy.aws_cryptography_keystore_OverWriteMutationIndex(dafny_input.MutationIndex),
        end_mutation=dafny_input.EndMutation,
    )

def aws_cryptography_keystore_WriteMutatedVersionsOutput(dafny_input):
    return aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.models.WriteMutatedVersionsOutput(
    )
...
def aws_cryptography_keystore_DeleteMutationOutput(dafny_input):
    return aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.models.DeleteMutationOutput(
    )
...
def aws_cryptography_keystore_WriteMutationIndexOutput(dafny_input):
    return aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.models.WriteMutationIndexOutput(
    )
...
def aws_cryptography_keystore_KeyManagement(dafny_input):
    ...
    if isinstance(dafny_input, KeyManagement_kms):
        KeyManagement_union_value = aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.models.KeyManagementKms(aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.dafny_to_smithy.aws_cryptography_keystore_AwsKms(dafny_input.kms))
    else:
        raise ValueError("No recognized union value in union type: " + str(dafny_input))
...
def aws_cryptography_keystore_Storage(dafny_input):
    ...
    if isinstance(dafny_input, Storage_ddb):
        Storage_union_value = aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.models.StorageDdb(aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.dafny_to_smithy.aws_cryptography_keystore_DynamoDBTable(dafny_input.ddb))
    elif isinstance(dafny_input, Storage_custom):
        Storage_union_value = aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.models.StorageCustom(aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.dafny_to_smithy.aws_cryptography_keystore_KeyStorageInterfaceReference(dafny_input.custom))
    else:
        raise ValueError("No recognized union value in union type: " + str(dafny_input))
...
def aws_cryptography_keystore_KeyStoreConfig(dafny_input):
    ...
    return aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.config.KeyStoreConfig(
        kms_configuration=aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.dafny_to_smithy.aws_cryptography_keystore_KMSConfiguration(dafny_input.kmsConfiguration),
        logical_key_store_name=b''.join(ord(c).to_bytes(2, 'big') for c in dafny_input.logicalKeyStoreName).decode('utf-16-be'),
        key_management=(aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.dafny_to_smithy.aws_cryptography_keystore_KeyManagement(dafny_input.keyManagement.value)) if (dafny_input.keyManagement.is_Some) else None,
        ddb_table_name=(b''.join(ord(c).to_bytes(2, 'big') for c in dafny_input.ddbTableName.value).decode('utf-16-be')) if (dafny_input.ddbTableName.is_Some) else None,
        id=(b''.join(ord(c).to_bytes(2, 'big') for c in dafny_input.id.value).decode('utf-16-be')) if (dafny_input.id.is_Some) else None,
        grant_tokens=([b''.join(ord(c).to_bytes(2, 'big') for c in list_element).decode('utf-16-be') for list_element in dafny_input.grantTokens.value]) if (dafny_input.grantTokens.is_Some) else None,
        storage=(aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.dafny_to_smithy.aws_cryptography_keystore_Storage(dafny_input.storage.value)) if (dafny_input.storage.is_Some) else None,
        ddb_client=(aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.dafny_to_smithy.aws_cryptography_keystore_DdbClientReference(dafny_input.ddbClient.UnwrapOr(None))) if (dafny_input.ddbClient.UnwrapOr(None) is not None) else None,
        kms_client=(aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.dafny_to_smithy.aws_cryptography_keystore_KmsClientReference(dafny_input.kmsClient.UnwrapOr(None))) if (dafny_input.kmsClient.UnwrapOr(None) is not None) else None,
    )
