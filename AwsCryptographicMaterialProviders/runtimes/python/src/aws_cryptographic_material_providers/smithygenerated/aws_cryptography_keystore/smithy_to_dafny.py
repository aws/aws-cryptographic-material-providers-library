...
def aws_cryptography_keystore_WriteNewEncryptedBranchKeyInput(native_input):
    return DafnyWriteNewEncryptedBranchKeyInput(
        Active=aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.smithy_to_dafny.aws_cryptography_keystore_EncryptedHierarchicalKey(native_input.active),
        Version=aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.smithy_to_dafny.aws_cryptography_keystore_EncryptedHierarchicalKey(native_input.version),
        Beacon=aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.smithy_to_dafny.aws_cryptography_keystore_EncryptedHierarchicalKey(native_input.beacon),
    )
...
def aws_cryptography_keystore_EncryptedHierarchicalKey(native_input):
    return DafnyEncryptedHierarchicalKey(
        ...
        Type=aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.smithy_to_dafny.aws_cryptography_keystore_HierarchicalKeyType(native_input.type),
        ...
        EncryptionContext=Map({Seq(''.join([chr(int.from_bytes(pair, 'big')) for pair in zip(*[iter(key.encode('utf-16-be'))]*2)])): Seq(''.join([chr(int.from_bytes(pair, 'big')) for pair in zip(*[iter(value.encode('utf-16-be'))]*2)])) for (key, value) in native_input.encryption_context.items() }),
        CiphertextBlob=Seq(native_input.ciphertext_blob),
    )

def aws_cryptography_keystore_HierarchicalKeyType(native_input):
    if isinstance(native_input, aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.models.HierarchicalKeyTypeActiveHierarchicalSymmetricVersion):
        HierarchicalKeyType_union_value = HierarchicalKeyType_ActiveHierarchicalSymmetricVersion(aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.smithy_to_dafny.aws_cryptography_keystore_ActiveHierarchicalSymmetric(native_input.value))
    elif isinstance(native_input, aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.models.HierarchicalKeyTypeHierarchicalSymmetricVersion):
        HierarchicalKeyType_union_value = HierarchicalKeyType_HierarchicalSymmetricVersion(aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.smithy_to_dafny.aws_cryptography_keystore_HierarchicalSymmetric(native_input.value))
    elif isinstance(native_input, aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.models.HierarchicalKeyTypeActiveHierarchicalSymmetricBeacon):
        HierarchicalKeyType_union_value = HierarchicalKeyType_ActiveHierarchicalSymmetricBeacon(aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.smithy_to_dafny.aws_cryptography_keystore_ActiveHierarchicalSymmetricBeacon(native_input.value))
    else:
...
def aws_cryptography_keystore_ActiveHierarchicalSymmetric(native_input):
    return DafnyActiveHierarchicalSymmetric(
        Version=Seq(''.join([chr(int.from_bytes(pair, 'big')) for pair in zip(*[iter(native_input.version.encode('utf-16-be'))]*2)])),
    )
...
def aws_cryptography_keystore_WriteNewEncryptedBranchKeyVersionInput(native_input):
    return DafnyWriteNewEncryptedBranchKeyVersionInput(
        Active=aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.smithy_to_dafny.aws_cryptography_keystore_OverWriteEncryptedHierarchicalKey(native_input.active),
        Version=aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.smithy_to_dafny.aws_cryptography_keystore_EncryptedHierarchicalKey(native_input.version),
    )
...
def aws_cryptography_keystore_OverWriteEncryptedHierarchicalKey(native_input):
    return DafnyOverWriteEncryptedHierarchicalKey(
        Item=aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.smithy_to_dafny.aws_cryptography_keystore_EncryptedHierarchicalKey(native_input.item),
        Old=aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.smithy_to_dafny.aws_cryptography_keystore_EncryptedHierarchicalKey(native_input.old),
    )
...
def aws_cryptography_keystore_GetItemsForInitializeMutationOutput(native_input):
    return DafnyGetItemsForInitializeMutationOutput(
        ActiveItem=aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.smithy_to_dafny.aws_cryptography_keystore_EncryptedHierarchicalKey(native_input.active_item),
        BeaconItem=aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.smithy_to_dafny.aws_cryptography_keystore_EncryptedHierarchicalKey(native_input.beacon_item),
        MutationCommitment=((Option_Some(aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.smithy_to_dafny.aws_cryptography_keystore_MutationCommitment(native_input.mutation_commitment))) if (native_input.mutation_commitment is not None) else (Option_None())),
        MutationIndex=((Option_Some(aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.smithy_to_dafny.aws_cryptography_keystore_MutationIndex(native_input.mutation_index))) if (native_input.mutation_index is not None) else (Option_None())),
    )
...
def aws_cryptography_keystore_WriteInitializeMutationInput(native_input):
    return DafnyWriteInitializeMutationInput(
        Active=aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.smithy_to_dafny.aws_cryptography_keystore_OverWriteEncryptedHierarchicalKey(native_input.active),
        Version=aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.smithy_to_dafny.aws_cryptography_keystore_WriteInitializeMutationVersion(native_input.version),
        Beacon=aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.smithy_to_dafny.aws_cryptography_keystore_OverWriteEncryptedHierarchicalKey(native_input.beacon),
        MutationCommitment=aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.smithy_to_dafny.aws_cryptography_keystore_MutationCommitment(native_input.mutation_commitment),
        MutationIndex=aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.smithy_to_dafny.aws_cryptography_keystore_MutationIndex(native_input.mutation_index),
    )

def aws_cryptography_keystore_WriteInitializeMutationVersion(native_input):
    if isinstance(native_input, aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.models.WriteInitializeMutationVersionRotate):
        WriteInitializeMutationVersion_union_value = WriteInitializeMutationVersion_rotate(aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.smithy_to_dafny.aws_cryptography_keystore_EncryptedHierarchicalKey(native_input.value))
    elif isinstance(native_input, aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.models.WriteInitializeMutationVersionMutate):
        WriteInitializeMutationVersion_union_value = WriteInitializeMutationVersion_mutate(aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.smithy_to_dafny.aws_cryptography_keystore_OverWriteEncryptedHierarchicalKey(native_input.value))
    else:
        raise ValueError("No recognized union value in union type: " + str(native_input))
...
def aws_cryptography_keystore_WriteAtomicMutationInput(native_input):
    return DafnyWriteAtomicMutationInput(
        ...
        Version=aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.smithy_to_dafny.aws_cryptography_keystore_WriteInitializeMutationVersion(native_input.version),
        Beacon=aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.smithy_to_dafny.aws_cryptography_keystore_OverWriteEncryptedHierarchicalKey(native_input.beacon),
        Items=Seq([aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.smithy_to_dafny.aws_cryptography_keystore_OverWriteEncryptedHierarchicalKey(list_element) for list_element in native_input.items]),
    )
...
def aws_cryptography_keystore_QueryForVersionsInput(native_input):
    return DafnyQueryForVersionsInput(
        ExclusiveStartKey=((Option_Some(Seq(native_input.exclusive_start_key))) if (native_input.exclusive_start_key is not None) else (Option_None())),
        Identifier=Seq(''.join([chr(int.from_bytes(pair, 'big')) for pair in zip(*[iter(native_input.identifier.encode('utf-16-be'))]*2)])),
...
def aws_cryptography_keystore_QueryForVersionsOutput(native_input):
    return DafnyQueryForVersionsOutput(
        ...
        Items=Seq([aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.smithy_to_dafny.aws_cryptography_keystore_EncryptedHierarchicalKey(list_element) for list_element in native_input.items]),
    )
...
def aws_cryptography_keystore_WriteMutatedVersionsInput(native_input):
    return DafnyWriteMutatedVersionsInput(
        Items=Seq([aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.smithy_to_dafny.aws_cryptography_keystore_OverWriteEncryptedHierarchicalKey(list_element) for list_element in native_input.items]),
        MutationCommitment=aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.smithy_to_dafny.aws_cryptography_keystore_MutationCommitment(native_input.mutation_commitment),
        MutationIndex=aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.smithy_to_dafny.aws_cryptography_keystore_OverWriteMutationIndex(native_input.mutation_index),
...
def aws_cryptography_keystore_OverWriteMutationIndex(native_input):
    return DafnyOverWriteMutationIndex(
        Index=aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.smithy_to_dafny.aws_cryptography_keystore_MutationIndex(native_input.index),
        Old=aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.smithy_to_dafny.aws_cryptography_keystore_MutationIndex(native_input.old),
    )
...
def aws_cryptography_keystore_KeyManagement(native_input):
    if isinstance(native_input, aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.models.KeyManagementKms):
        KeyManagement_union_value = KeyManagement_kms(aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.smithy_to_dafny.aws_cryptography_keystore_AwsKms(native_input.value))
    else:
        raise ValueError("No recognized union value in union type: " + str(native_input))
...
def aws_cryptography_keystore_Storage(native_input):
    if isinstance(native_input, aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.models.StorageDdb):
        Storage_union_value = Storage_ddb(aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.smithy_to_dafny.aws_cryptography_keystore_DynamoDBTable(native_input.value))
    elif isinstance(native_input, aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.models.StorageCustom):
        Storage_union_value = Storage_custom(aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.smithy_to_dafny.aws_cryptography_keystore_KeyStorageInterfaceReference(native_input.value))
    else:
        raise ValueError("No recognized union value in union type: " + str(native_input))
...
def aws_cryptography_keystore_KeyStoreConfig(native_input):
    return DafnyKeyStoreConfig(
        kmsConfiguration=aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.smithy_to_dafny.aws_cryptography_keystore_KMSConfiguration(native_input.kms_configuration),
        logicalKeyStoreName=Seq(''.join([chr(int.from_bytes(pair, 'big')) for pair in zip(*[iter(native_input.logical_key_store_name.encode('utf-16-be'))]*2)])),
        keyManagement=((Option_Some(aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.smithy_to_dafny.aws_cryptography_keystore_KeyManagement(native_input.key_management))) if (native_input.key_management is not None) else (Option_None())),
        ddbTableName=((Option_Some(Seq(''.join([chr(int.from_bytes(pair, 'big')) for pair in zip(*[iter(native_input.ddb_table_name.encode('utf-16-be'))]*2)])))) if (native_input.ddb_table_name is not None) else (Option_None())),
        ...
        grantTokens=((Option_Some(Seq([Seq(''.join([chr(int.from_bytes(pair, 'big')) for pair in zip(*[iter(list_element.encode('utf-16-be'))]*2)])) for list_element in native_input.grant_tokens]))) if (native_input.grant_tokens is not None) else (Option_None())),
        storage=((Option_Some(aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.smithy_to_dafny.aws_cryptography_keystore_Storage(native_input.storage))) if (native_input.storage is not None) else (Option_None())),
        ddbClient=((Option_Some(aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.smithy_to_dafny.aws_cryptography_keystore_DdbClientReference(native_input.ddb_client))) if ((native_input.ddb_client is not None) and (aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.smithy_to_dafny.aws_cryptography_keystore_DdbClientReference(native_input.ddb_client) is not None)) else (Option_None())),
        kmsClient=((Option_Some(aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.smithy_to_dafny.aws_cryptography_keystore_KmsClientReference(native_input.kms_client))) if ((native_input.kms_client is not None) and (aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.smithy_to_dafny.aws_cryptography_keystore_KmsClientReference(native_input.kms_client) is not None)) else (Option_None())),
    )
