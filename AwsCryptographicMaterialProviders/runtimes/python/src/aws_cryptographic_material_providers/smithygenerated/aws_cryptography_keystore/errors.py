...
class MutationCommitmentConditionFailed(ApiError[Literal["MutationCommitmentConditionFailed"]]):
    code: Literal["MutationCommitmentConditionFailed"] = "MutationCommitmentConditionFailed"
    message: str
    def __init__(
        self,
        *,
...
class OldEncConditionFailed(ApiError[Literal["OldEncConditionFailed"]]):
    ...
    def __init__(
        ...
        *,
        ...
        """Write to Storage failed; cipher-text attribute of an item was updated since it
        was read.
        :param message: A message associated with the specific error.
...
class BranchKeyCiphertextException(ApiError[Literal["BranchKeyCiphertextException"]]):
    ...
    def __init__(
        ...
        *,
        ...
        """
        The cipher-text or additional authenticated data incorporated into the
        cipher-text,
        such as the encryption context, is corrupted, missing, or otherwise
        invalid.
        For Branch Keys,
...
def _smithy_error_to_dafny_error(e: ServiceError):
    ...
    """
    if isinstance(e, aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.errors.AlreadyExistsConditionFailed):
        return aws_cryptographic_material_providers.internaldafny.generated.AwsCryptographyKeyStoreTypes.Error_AlreadyExistsConditionFailed(message=_dafny.Seq(e.message))

    if isinstance(e, aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.errors.BranchKeyCiphertextException):
        return aws_cryptographic_material_providers.internaldafny.generated.AwsCryptographyKeyStoreTypes.Error_BranchKeyCiphertextException(message=_dafny.Seq(e.message))

    if isinstance(e, aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.errors.KeyManagementException):
        return aws_cryptographic_material_providers.internaldafny.generated.AwsCryptographyKeyStoreTypes.Error_KeyManagementException(message=_dafny.Seq(e.message))

    if isinstance(e, aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.errors.KeyStorageException):
        return aws_cryptographic_material_providers.internaldafny.generated.AwsCryptographyKeyStoreTypes.Error_KeyStorageException(message=_dafny.Seq(e.message))
    ...
    if isinstance(e, aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.errors.MutationCommitmentConditionFailed):
        return aws_cryptographic_material_providers.internaldafny.generated.AwsCryptographyKeyStoreTypes.Error_MutationCommitmentConditionFailed(message=_dafny.Seq(e.message))

    if isinstance(e, aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.errors.NoLongerExistsConditionFailed):
        return aws_cryptographic_material_providers.internaldafny.generated.AwsCryptographyKeyStoreTypes.Error_NoLongerExistsConditionFailed(message=_dafny.Seq(e.message))

    if isinstance(e, aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.errors.OldEncConditionFailed):
        return aws_cryptographic_material_providers.internaldafny.generated.AwsCryptographyKeyStoreTypes.Error_OldEncConditionFailed(message=_dafny.Seq(e.message))

    if isinstance(e, aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.errors.VersionRaceException):
        return aws_cryptographic_material_providers.internaldafny.generated.AwsCryptographyKeyStoreTypes.Error_VersionRaceException(message=_dafny.Seq(e.message))
