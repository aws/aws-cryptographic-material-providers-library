...
class GetBranchKeyVersionsInput:
    ...
    def __init__(
        ...
        *,
        ...
        :param branch_key_identifier: The identifier of the Branch Key to get recent
        versions for.
...
class GetBranchKeyVersionsOutput:
    ...
    def __init__(
        ...
        *,
        ...
        """Outputs for getting recent branch key versions.

        :param branch_key_materials: The list of decrypted branch key materials for
        recent versions.
        """
        self.branch_key_materials = branch_key_materials
