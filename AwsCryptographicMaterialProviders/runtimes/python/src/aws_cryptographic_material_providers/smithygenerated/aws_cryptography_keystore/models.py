...
class ActiveHierarchicalSymmetricBeacon:
    """Information for a symmetric beacon key. At this time there is no additional
    information.
    """
    def as_dict(self) -> Dict[str, Any]:
...
class MutationCommitment:
    ...
    def as_dict(self) -> Dict[str, Any]:
        """Converts the MutationCommitment to a dictionary.
    ...
    @staticmethod
    def from_dict(d: Dict[str, Any]) -> "MutationCommitment":
        """Creates a MutationCommitment from a dictionary.
        ...
        return MutationCommitment(**kwargs)

    def __repr__(self) -> str:
        result = "MutationCommitment("
    ...
    def __eq__(self, other: Any) -> bool:
        if not isinstance(other, MutationCommitment):
            return False
        attributes: list[str] = ['identifier','create_time','uuid','original','terminal','input','ciphertext_blob',]
        return all(
            getattr(self, a) == getattr(other, a)
            for a in attributes
        )
...
class DeleteMutationInput:
    ...
    def as_dict(self) -> Dict[str, Any]:
        """Converts the DeleteMutationInput to a dictionary.
    ...
    @staticmethod
    def from_dict(d: Dict[str, Any]) -> "DeleteMutationInput":
        """Creates a DeleteMutationInput from a dictionary.

        """
        kwargs: Dict[str, Any] = {
            "mutation_commitment": MutationCommitment.from_dict(d["mutation_commitment"]),
        }

        return DeleteMutationInput(**kwargs)

    def __repr__(self) -> str:
        result = "DeleteMutationInput("
    ...
    def __eq__(self, other: Any) -> bool:
        if not isinstance(other, DeleteMutationInput):
            return False
        attributes: list[str] = ['mutation_commitment',]
        return all(
            getattr(self, a) == getattr(other, a)
            for a in attributes
        )

class DeleteMutationOutput:
    def as_dict(self) -> Dict[str, Any]:
        """Converts the DeleteMutationOutput to a dictionary.

        """
        return {}

    @staticmethod
    def from_dict(d: Dict[str, Any]) -> "DeleteMutationOutput":
        """Creates a DeleteMutationOutput from a dictionary.

        """
        return DeleteMutationOutput()

    def __repr__(self) -> str:
        result = "DeleteMutationOutput("

        return result + ")"

    def __eq__(self, other: Any) -> bool:
        return isinstance(other, DeleteMutationOutput)
...
class HierarchicalKeyTypeActiveHierarchicalSymmetricVersion():
    ...
    def from_dict(d: Dict[str, Any]) -> "HierarchicalKeyTypeActiveHierarchicalSymmetricVersion":
        ...
        return HierarchicalKeyTypeActiveHierarchicalSymmetricVersion(ActiveHierarchicalSymmetric.from_dict(d["ActiveHierarchicalSymmetricVersion"]))
...
class HierarchicalKeyTypeHierarchicalSymmetricVersion():
    """The version for a decrypt only branch key type. These are used to decrypt
    messages. For every ACTIVE that has ever been, there exists a Version.
    """
    ...
    def from_dict(d: Dict[str, Any]) -> "HierarchicalKeyTypeHierarchicalSymmetricVersion":
        ...
        return HierarchicalKeyTypeHierarchicalSymmetricVersion(HierarchicalSymmetric.from_dict(d["HierarchicalSymmetricVersion"]))

    def __repr__(self) -> str:
        return f"HierarchicalKeyTypeHierarchicalSymmetricVersion(value=repr(self.value))"
...
class HierarchicalKeyTypeActiveHierarchicalSymmetricBeacon():
    ...
    def from_dict(d: Dict[str, Any]) -> "HierarchicalKeyTypeActiveHierarchicalSymmetricBeacon":
        ...
        return HierarchicalKeyTypeActiveHierarchicalSymmetricBeacon(ActiveHierarchicalSymmetricBeacon.from_dict(d["ActiveHierarchicalSymmetricBeacon"]))
...
HierarchicalKeyType = Union[HierarchicalKeyTypeActiveHierarchicalSymmetricVersion, HierarchicalKeyTypeHierarchicalSymmetricVersion, HierarchicalKeyTypeActiveHierarchicalSymmetricBeacon, HierarchicalKeyTypeUnknown]
...
class EncryptedHierarchicalKey:
    ...
    def __init__(
        ...
        *,
        ...
        """Information about an encrypted hierarchical key. This abstracts the structure of
        this information from the underlying storage.
        ...
        :param encryption_context: The encryption context needed to decrypt this
        encrypted key. This includes the user the provided custom encryption context, as
        well as the other Branch Key attributes.
    ...
    def __eq__(self, other: Any) -> bool:
        if not isinstance(other, EncryptedHierarchicalKey):
            return False
        attributes: list[str] = ['identifier','type','create_time','kms_arn','encryption_context','ciphertext_blob',]
        return all(
            getattr(self, a) == getattr(other, a)
            for a in attributes
        )
...
class GetEncryptedActiveBranchKeyInput:
    ...
    def __init__(
        ...
        *,
        ...
        :param identifier: The identifier for the Branch Key to get the ACTIVE version
        for.
        """
        self.identifier = identifier
...
class GetEncryptedBeaconKeyInput:
    ...
    def __init__(
        ...
        *,
        ...
        :param identifier: The identifier of the Branch Key the Beacon Key is associated
        with.
        """
        self.identifier = identifier
...
class GetEncryptedBranchKeyVersionInput:
    ...
    def __init__(
        ...
        *,
        ...
        :param identifier: The identifier for the Branch Key to get a particular version
        for.
    ...
    def __eq__(self, other: Any) -> bool:
        if not isinstance(other, GetEncryptedBranchKeyVersionInput):
            return False
        attributes: list[str] = ['identifier','version',]
        return all(
            getattr(self, a) == getattr(other, a)
            for a in attributes
        )
...
class GetItemsForInitializeMutationInput:
    identifier: str
    def __init__(
        self,
        *,
    ...
    def as_dict(self) -> Dict[str, Any]:
        """Converts the GetItemsForInitializeMutationInput to a dictionary.
    ...
    @staticmethod
    def from_dict(d: Dict[str, Any]) -> "GetItemsForInitializeMutationInput":
        """Creates a GetItemsForInitializeMutationInput from a dictionary.
        ...
        return GetItemsForInitializeMutationInput(**kwargs)

    def __repr__(self) -> str:
        result = "GetItemsForInitializeMutationInput("
        if self.identifier is not None:
            result += f"identifier={repr(self.identifier)}"
    ...
    def __eq__(self, other: Any) -> bool:
        if not isinstance(other, GetItemsForInitializeMutationInput):
            return False
        attributes: list[str] = ['identifier',]
        return all(
            getattr(self, a) == getattr(other, a)
...
class MutationIndex:
    ...
    def __eq__(self, other: Any) -> bool:
        if not isinstance(other, MutationIndex):
            return False
        attributes: list[str] = ['identifier','create_time','uuid','page_index','ciphertext_blob',]
        return all(
            getattr(self, a) == getattr(other, a)
            for a in attributes
        )
...
class GetItemsForInitializeMutationOutput:
    ...
    def __init__(
        ...
        *,
        ...
        :param mutation_commitment: The Mutation Commitment, if it exists.
    ...
    def as_dict(self) -> Dict[str, Any]:
        ...
        """
        d: Dict[str, Any] = {
            "active_item": self.active_item.as_dict(),
            "beacon_item": self.beacon_item.as_dict(),
        }

        if self.mutation_commitment is not None:
            d["mutation_commitment"] = self.mutation_commitment.as_dict()
    ...
    @staticmethod
    def from_dict(d: Dict[str, Any]) -> "GetItemsForInitializeMutationOutput":
        """Creates a GetItemsForInitializeMutationOutput from a dictionary.

        """
        kwargs: Dict[str, Any] = {
            "active_item": EncryptedHierarchicalKey.from_dict(d["active_item"]),
            "beacon_item": EncryptedHierarchicalKey.from_dict(d["beacon_item"]),
        }

        if "mutation_commitment" in d:
            kwargs["mutation_commitment"] = MutationCommitment.from_dict(d["mutation_commitment"])
    ...
    def __repr__(self) -> str:
        result = "GetItemsForInitializeMutationOutput("
        if self.active_item is not None:
            result += f"active_item={repr(self.active_item)}, "

        if self.beacon_item is not None:
    ...
    def __eq__(self, other: Any) -> bool:
        if not isinstance(other, GetItemsForInitializeMutationOutput):
            return False
        attributes: list[str] = ['active_item','beacon_item','mutation_commitment','mutation_index',]
        return all(
            getattr(self, a) == getattr(other, a)
            for a in attributes
        )
...
class GetKeyStorageInfoOutput:
    ...
    def __init__(
        ...
        *,
        ...
        :param logical_name: The Logical Key Store Name associated with this Storage.
        """
        self.name = name
    ...
    def __eq__(self, other: Any) -> bool:
        if not isinstance(other, GetKeyStorageInfoOutput):
            return False
        attributes: list[str] = ['name','logical_name',]
        return all(
            getattr(self, a) == getattr(other, a)
            for a in attributes
        )
...
class GetKeyStoreInfoOutput:
    ...
    def __init__(
        ...
        *,
        ...
        :param key_store_name: The physical name of the backing storage for this Key
        Store instance.
...
class GetMutationInput:
    ...
    def as_dict(self) -> Dict[str, Any]:
        """Converts the GetMutationInput to a dictionary.
    ...
    @staticmethod
    def from_dict(d: Dict[str, Any]) -> "GetMutationInput":
        """Creates a GetMutationInput from a dictionary.
        ...
        return GetMutationInput(**kwargs)

    def __repr__(self) -> str:
        result = "GetMutationInput("
        if self.identifier is not None:
            result += f"identifier={repr(self.identifier)}"
    ...
    def __eq__(self, other: Any) -> bool:
        if not isinstance(other, GetMutationInput):
            return False
        attributes: list[str] = ['identifier',]
        return all(
            getattr(self, a) == getattr(other, a)
...
class GetMutationOutput:
    ...
    def __init__(
        ...
        *,
        ...
        """
        :param mutation_commitment: If not present, there is no Mutation.
        :param mutation_index: If not present, there is no Mutation.
        """
        self.mutation_commitment = mutation_commitment
        self.mutation_index = mutation_index

    def as_dict(self) -> Dict[str, Any]:
        """Converts the GetMutationOutput to a dictionary.
    ...
    @staticmethod
    def from_dict(d: Dict[str, Any]) -> "GetMutationOutput":
        """Creates a GetMutationOutput from a dictionary.
        ...
        return GetMutationOutput(**kwargs)

    def __repr__(self) -> str:
        result = "GetMutationOutput("
        if self.mutation_commitment is not None:
            result += f"mutation_commitment={repr(self.mutation_commitment)}, "
    ...
    def __eq__(self, other: Any) -> bool:
        if not isinstance(other, GetMutationOutput):
            return False
        attributes: list[str] = ['mutation_commitment','mutation_index',]
        return all(
            getattr(self, a) == getattr(other, a)
            for a in attributes
        )
...
class QueryForVersionsInput:
    ...
    def __init__(
        ...
        *,
        ...
        :param page_size: The maximum read items.
    ...
    def as_dict(self) -> Dict[str, Any]:
        """Converts the QueryForVersionsInput to a dictionary.
    ...
    @staticmethod
    def from_dict(d: Dict[str, Any]) -> "QueryForVersionsInput":
        """Creates a QueryForVersionsInput from a dictionary.
        ...
        return QueryForVersionsInput(**kwargs)

    def __repr__(self) -> str:
        result = "QueryForVersionsInput("
        if self.exclusive_start_key is not None:
    ...
    def __eq__(self, other: Any) -> bool:
        if not isinstance(other, QueryForVersionsInput):
            return False
        attributes: list[str] = ['exclusive_start_key','identifier','page_size',]
        return all(
            getattr(self, a) == getattr(other, a)
            for a in attributes
        )

class QueryForVersionsOutput:
    exclusive_start_key: bytes | bytearray
    ...
    def __init__(
        ...
        *,
        ...
        """
        :param exclusive_start_key: If none-empty, Query did not finish searching
        storage.
        ...
        :param items: Up to pageSize list of version (decrypt only) items of a Branch
        Key.
        """
        self.exclusive_start_key = exclusive_start_key
        self.items = items
    ...
    def as_dict(self) -> Dict[str, Any]:
        """Converts the QueryForVersionsOutput to a dictionary.
    ...
    @staticmethod
    def from_dict(d: Dict[str, Any]) -> "QueryForVersionsOutput":
        """Creates a QueryForVersionsOutput from a dictionary.

        """
        kwargs: Dict[str, Any] = {
            "exclusive_start_key": d["exclusive_start_key"],
            "items": _encrypted_hierarchical_keys_from_dict(d["items"]),
        }

        return QueryForVersionsOutput(**kwargs)

    def __repr__(self) -> str:
        result = "QueryForVersionsOutput("
        if self.exclusive_start_key is not None:
            result += f"exclusive_start_key={repr(self.exclusive_start_key)}, "
    ...
    def __eq__(self, other: Any) -> bool:
        if not isinstance(other, QueryForVersionsOutput):
            return False
        attributes: list[str] = ['exclusive_start_key','items',]
        return all(
            getattr(self, a) == getattr(other, a)
            for a in attributes
        )
...
class OverWriteEncryptedHierarchicalKey:
    ...
    def __init__(
        ...
        *,
        ...
        :param item: Information about an encrypted hierarchical key. This abstracts the
        structure of this information from the underlying storage.
        :param old: The previous item. Used to construct an optimistic lock for the
        overwrite.
        """
        self.item = item
        self.old = old
    ...
    def __eq__(self, other: Any) -> bool:
        if not isinstance(other, OverWriteEncryptedHierarchicalKey):
            return False
        attributes: list[str] = ['item','old',]
        return all(
            getattr(self, a) == getattr(other, a)
            for a in attributes
        )

class WriteInitializeMutationVersionRotate():
    """Information about an encrypted hierarchical key. This abstracts the structure of
    this information from the underlying storage.
    """
    def __init__(self, value: EncryptedHierarchicalKey):
        self.value = value

    def as_dict(self) -> Dict[str, Any]:
        return {"rotate": self.value.as_dict()}
    ...
    def from_dict(d: Dict[str, Any]) -> "WriteInitializeMutationVersionRotate":
        ...
        return WriteInitializeMutationVersionRotate(EncryptedHierarchicalKey.from_dict(d["rotate"]))

    def __repr__(self) -> str:
        return f"WriteInitializeMutationVersionRotate(value=repr(self.value))"

    def __eq__(self, other: Any) -> bool:
        if not isinstance(other, WriteInitializeMutationVersionRotate):
            return False
        return self.value == other.value

class WriteInitializeMutationVersionMutate():
    """To avoid information loss, overwrites to a EncryptedHierarchicalKey
    are done
    conditioned on the old value.
    """
    def __init__(self, value: OverWriteEncryptedHierarchicalKey):
        self.value = value

    def as_dict(self) -> Dict[str, Any]:
        return {"mutate": self.value.as_dict()}

    @staticmethod
    def from_dict(d: Dict[str, Any]) -> "WriteInitializeMutationVersionMutate":
        if (len(d) != 1):
            raise TypeError(f"Unions may have exactly 1 value, but found {len(d)}")

        return WriteInitializeMutationVersionMutate(OverWriteEncryptedHierarchicalKey.from_dict(d["mutate"]))

    def __repr__(self) -> str:
        return f"WriteInitializeMutationVersionMutate(value=repr(self.value))"

    def __eq__(self, other: Any) -> bool:
        if not isinstance(other, WriteInitializeMutationVersionMutate):
            return False
        return self.value == other.value

class WriteInitializeMutationVersionUnknown():
    """Represents an unknown variant.
    ...
    def from_dict(d: Dict[str, Any]) -> "WriteInitializeMutationVersionUnknown":
        if (len(d) != 1):
            raise TypeError(f"Unions may have exactly 1 value, but found {len(d)}")
        return WriteInitializeMutationVersionUnknown(d["SDK_UNKNOWN_MEMBER"]["name"])
...
# mutate the Active.
WriteInitializeMutationVersion = Union[WriteInitializeMutationVersionRotate, WriteInitializeMutationVersionMutate, WriteInitializeMutationVersionUnknown]
def _write_initialize_mutation_version_from_dict(d: Dict[str, Any]) -> WriteInitializeMutationVersion:
    if "rotate" in d:
        return WriteInitializeMutationVersionRotate.from_dict(d)

    if "mutate" in d:
        return WriteInitializeMutationVersionMutate.from_dict(d)

    raise TypeError(f'Unions may have exactly 1 value, but found {len(d)}')

class WriteAtomicMutationInput:
    ...
    def as_dict(self) -> Dict[str, Any]:
        """Converts the WriteAtomicMutationInput to a dictionary.
    ...
    @staticmethod
    def from_dict(d: Dict[str, Any]) -> "WriteAtomicMutationInput":
        """Creates a WriteAtomicMutationInput from a dictionary.
        ...
        return WriteAtomicMutationInput(**kwargs)

    def __repr__(self) -> str:
        result = "WriteAtomicMutationInput("
    ...
    def __eq__(self, other: Any) -> bool:
        if not isinstance(other, WriteAtomicMutationInput):
            return False
        attributes: list[str] = ['active','version','beacon','items',]
        return all(
            getattr(self, a) == getattr(other, a)
            for a in attributes
        )

class WriteAtomicMutationOutput:
    def as_dict(self) -> Dict[str, Any]:
        """Converts the WriteAtomicMutationOutput to a dictionary.

        """
        return {}

    @staticmethod
    def from_dict(d: Dict[str, Any]) -> "WriteAtomicMutationOutput":
        """Creates a WriteAtomicMutationOutput from a dictionary.

        """
        return WriteAtomicMutationOutput()

    def __repr__(self) -> str:
        result = "WriteAtomicMutationOutput("

        return result + ")"

    def __eq__(self, other: Any) -> bool:
        return isinstance(other, WriteAtomicMutationOutput)
...
class WriteInitializeMutationInput:
    ...
    def __eq__(self, other: Any) -> bool:
        if not isinstance(other, WriteInitializeMutationInput):
            return False
        attributes: list[str] = ['active','version','beacon','mutation_commitment','mutation_index',]
        return all(
            getattr(self, a) == getattr(other, a)
            for a in attributes
        )

class WriteInitializeMutationOutput:
    def as_dict(self) -> Dict[str, Any]:
        """Converts the WriteInitializeMutationOutput to a dictionary.

        """
        return {}

    @staticmethod
    def from_dict(d: Dict[str, Any]) -> "WriteInitializeMutationOutput":
        """Creates a WriteInitializeMutationOutput from a dictionary.

        """
        return WriteInitializeMutationOutput()

    def __repr__(self) -> str:
        result = "WriteInitializeMutationOutput("

        return result + ")"

    def __eq__(self, other: Any) -> bool:
        return isinstance(other, WriteInitializeMutationOutput)
...
class WriteMutatedVersionsInput:
    ...
    def __repr__(self) -> str:
        result = "WriteMutatedVersionsInput("
        if self.items is not None:
            result += f"items={repr(self.items)}, "
        ...
        if self.end_mutation is not None:
            result += f"end_mutation={repr(self.end_mutation)}"

        return result + ")"

    def __eq__(self, other: Any) -> bool:
        if not isinstance(other, WriteMutatedVersionsInput):
            return False
        attributes: list[str] = ['items','mutation_commitment','mutation_index','end_mutation',]
        return all(
            getattr(self, a) == getattr(other, a)
            for a in attributes
        )

class WriteMutatedVersionsOutput:
    def as_dict(self) -> Dict[str, Any]:
        """Converts the WriteMutatedVersionsOutput to a dictionary.

        """
        return {}

    @staticmethod
    def from_dict(d: Dict[str, Any]) -> "WriteMutatedVersionsOutput":
        """Creates a WriteMutatedVersionsOutput from a dictionary.

        """
        return WriteMutatedVersionsOutput()

    def __repr__(self) -> str:
        result = "WriteMutatedVersionsOutput("

        return result + ")"

    def __eq__(self, other: Any) -> bool:
        return isinstance(other, WriteMutatedVersionsOutput)

class WriteMutationIndexInput:
    mutation_commitment: MutationCommitment
    mutation_index: MutationIndex
    def __init__(
        self,
    ...
    def as_dict(self) -> Dict[str, Any]:
        """Converts the WriteMutationIndexInput to a dictionary.
    ...
    @staticmethod
    def from_dict(d: Dict[str, Any]) -> "WriteMutationIndexInput":
        """Creates a WriteMutationIndexInput from a dictionary.
        ...
        return WriteMutationIndexInput(**kwargs)

    def __repr__(self) -> str:
        result = "WriteMutationIndexInput("
        if self.mutation_commitment is not None:
            result += f"mutation_commitment={repr(self.mutation_commitment)}, "
    ...
    def __eq__(self, other: Any) -> bool:
        if not isinstance(other, WriteMutationIndexInput):
            return False
        attributes: list[str] = ['mutation_commitment','mutation_index',]
        return all(
            getattr(self, a) == getattr(other, a)
...
class WriteMutationIndexOutput:
    def as_dict(self) -> Dict[str, Any]:
        """Converts the WriteMutationIndexOutput to a dictionary.

        """
        return {}

    @staticmethod
    def from_dict(d: Dict[str, Any]) -> "WriteMutationIndexOutput":
        """Creates a WriteMutationIndexOutput from a dictionary.

        """
        return WriteMutationIndexOutput()

    def __repr__(self) -> str:
        result = "WriteMutationIndexOutput("

        return result + ")"

    def __eq__(self, other: Any) -> bool:
        return isinstance(other, WriteMutationIndexOutput)
...
class WriteNewEncryptedBranchKeyInput:
    ...
    def __init__(
        ...
        *,
        ...
        """
        The information required to atomically write an a new branch key into a key
        store.
        ...
        :param active:
          The active representation of this branch key.
          The plain-text
        cryptographic material of the Active must be the same as the Version.
        ...
        :param beacon:
          ...
          This
        should be a different cryptographic material from the other two.
    ...
    def __eq__(self, other: Any) -> bool:
        if not isinstance(other, WriteNewEncryptedBranchKeyInput):
            return False
        attributes: list[str] = ['active','version','beacon',]
        return all(
            getattr(self, a) == getattr(other, a)
            for a in attributes
        )
...
class WriteNewEncryptedBranchKeyOutput:
    """The output of writing a new branch key. There is currently no additional
...
class WriteNewEncryptedBranchKeyVersionInput:
    ...
    def __init__(
        ...
        *,
        ...
        """
        The information required to atomically write a new version for an existing
        branch key into a key store.
        The identifiers for all keys passed should be the
        same.
    ...
    def as_dict(self) -> Dict[str, Any]:
        """Converts the WriteNewEncryptedBranchKeyVersionInput to a dictionary.
    ...
    def from_dict(d: Dict[str, Any]) -> "WriteNewEncryptedBranchKeyVersionInput":
        """Creates a WriteNewEncryptedBranchKeyVersionInput from a dictionary.
    ...
    def __eq__(self, other: Any) -> bool:
        if not isinstance(other, WriteNewEncryptedBranchKeyVersionInput):
            return False
        attributes: list[str] = ['active','version',]
        return all(
            getattr(self, a) == getattr(other, a)
            for a in attributes
        )
...
class WriteNewEncryptedBranchKeyVersionOutput:
    """The output of writing a new version for an existing branch key. There is
    currently no additional information returned.
    """
    def as_dict(self) -> Dict[str, Any]:
        """Converts the WriteNewEncryptedBranchKeyVersionOutput to a dictionary.
    ...
    def from_dict(d: Dict[str, Any]) -> "WriteNewEncryptedBranchKeyVersionOutput":
        """Creates a WriteNewEncryptedBranchKeyVersionOutput from a dictionary.
...
class AwsKms:
    ...
    def __eq__(self, other: Any) -> bool:
        if not isinstance(other, AwsKms):
            return False
        attributes: list[str] = ['grant_tokens','kms_client',]
        return all(
            getattr(self, a) == getattr(other, a)
            for a in attributes
        )
...
class DynamoDBTable:
    ...
    def __eq__(self, other: Any) -> bool:
        if not isinstance(other, DynamoDBTable):
            return False
        attributes: list[str] = ['ddb_table_name','ddb_client',]
        return all(
            getattr(self, a) == getattr(other, a)
            for a in attributes
        )
...
class StorageCustom():
    ...
    """
    def __init__(self, value: 'aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.references.KeyStorageInterface'):
        self.value = value
    ...
    def from_dict(d: Dict[str, Any]) -> "StorageCustom":
        from aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystore.references import KeyStorageInterface
        if (len(d) != 1):
            raise TypeError(f"Unions may have exactly 1 value, but found {len(d)}")
...
def _over_write_encrypted_hierarchical_keys_as_dict(given: list[OverWriteEncryptedHierarchicalKey]) -> List[Any]:
    return [v.as_dict() for v in given]

def _over_write_encrypted_hierarchical_keys_from_dict(given: List[Any]) -> list[OverWriteEncryptedHierarchicalKey]:
    return [OverWriteEncryptedHierarchicalKey.from_dict(v) for v in given]

def _encrypted_hierarchical_keys_as_dict(given: list[EncryptedHierarchicalKey]) -> List[Any]:
    return [v.as_dict() for v in given]

def _encrypted_hierarchical_keys_from_dict(given: List[Any]) -> list[EncryptedHierarchicalKey]:
    return [EncryptedHierarchicalKey.from_dict(v) for v in given]
