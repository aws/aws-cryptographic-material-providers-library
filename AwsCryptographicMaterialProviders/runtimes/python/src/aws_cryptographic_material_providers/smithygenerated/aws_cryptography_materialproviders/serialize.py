...
def _serialize_create_caching_cmm(input, config: Config) -> DafnyRequest:
    return DafnyRequest(operation_name="CreateCachingCMM", dafny_operation_input=aws_cryptographic_material_providers.smithygenerated.aws_cryptography_materialproviders.smithy_to_dafny.aws_cryptography_materialproviders_CreateCachingCMMInput(input))
