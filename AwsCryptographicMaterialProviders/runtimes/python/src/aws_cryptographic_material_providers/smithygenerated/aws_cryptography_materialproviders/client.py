...
from .deserialize import (
    ...
    _deserialize_create_caching_cmm,
...
class AwsCryptographicMaterialProviders:
    ...
    def create_caching_cmm(self, input: CreateCachingCMMInput) -> 'aws_cryptographic_material_providers.smithygenerated.aws_cryptography_materialproviders.references.CryptographicMaterialsManager':
        ...
        return self._execute_operation(
            input=input,
            plugins=[],
            serialize=_serialize_create_caching_cmm,
            deserialize=_deserialize_create_caching_cmm,
            config=self._config,
            operation_name="CreateCachingCMM",
        )
