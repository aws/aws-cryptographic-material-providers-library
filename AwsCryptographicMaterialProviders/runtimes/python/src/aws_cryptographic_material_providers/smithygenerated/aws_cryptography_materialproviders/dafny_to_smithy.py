...
def aws_cryptography_materialproviders_CreateCachingCMMInput(dafny_input):
    return aws_cryptographic_material_providers.smithygenerated.aws_cryptography_materialproviders.models.CreateCachingCMMInput(
        underlying_cmc=(aws_cryptographic_material_providers.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_CryptographicMaterialsCacheReference(dafny_input.underlyingCMC)) if (dafny_input.underlyingCMC is not None) else None,
        cache_limit_ttl_seconds=dafny_input.cacheLimitTtlSeconds,
        underlying_cmm=(aws_cryptographic_material_providers.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_CryptographicMaterialsManagerReference(dafny_input.underlyingCMM.UnwrapOr(None))) if (dafny_input.underlyingCMM.UnwrapOr(None) is not None) else None,
        keyring=(aws_cryptographic_material_providers.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_KeyringReference(dafny_input.keyring.UnwrapOr(None))) if (dafny_input.keyring.UnwrapOr(None) is not None) else None,
        partition_key=(bytes(dafny_input.partitionKey.value.Elements).decode('utf-8')) if (dafny_input.partitionKey.is_Some) else None,
        limit_bytes=(dafny_input.limitBytes.value) if (dafny_input.limitBytes.is_Some) else None,
        limit_messages=(dafny_input.limitMessages.value) if (dafny_input.limitMessages.is_Some) else None,
    )
...
def aws_cryptography_materialproviders_CreateCachingCMMOutput(dafny_input):
    return aws_cryptographic_material_providers.smithygenerated.aws_cryptography_materialproviders.dafny_to_smithy.aws_cryptography_materialproviders_CryptographicMaterialsManagerReference(dafny_input)
