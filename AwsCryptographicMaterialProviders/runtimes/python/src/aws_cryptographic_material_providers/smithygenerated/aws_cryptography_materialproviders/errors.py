...
def _smithy_error_to_dafny_error(e: ServiceError):
    ...
    if isinstance(e, OpaqueError):
        return aws_cryptographic_material_providers.internaldafny.generated.AwsCryptographyMaterialProvidersTypes.Error_Opaque(obj=e.obj, alt__text=e.alt_text)

    else:
        return aws_cryptographic_material_providers.internaldafny.generated.AwsCryptographyMaterialProvidersTypes.Error_Opaque(obj=e, alt__text=_dafny.Seq(
          "".join(
              [
