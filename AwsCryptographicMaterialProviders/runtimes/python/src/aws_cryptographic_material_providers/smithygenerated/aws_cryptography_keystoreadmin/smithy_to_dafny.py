...
def aws_cryptography_keystoreadmin_CreateKeyInput(native_input):
    return DafnyCreateKeyInput(
        ...
        KmsArn=aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystoreadmin.smithy_to_dafny.aws_cryptography_keystoreadmin_KMSIdentifier(
...
def aws_cryptography_keystoreadmin_KMSIdentifier(native_input):
    if isinstance(
        native_input,
        aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystoreadmin.models.KMSIdentifierKmsKeyArn,
    ):
        ...
        native_input,
        aws_cryptographic_material_providers.smithygenerated.aws_cryptography_keystoreadmin.models.KMSIdentifierKmsMRKeyArn,
    ):
