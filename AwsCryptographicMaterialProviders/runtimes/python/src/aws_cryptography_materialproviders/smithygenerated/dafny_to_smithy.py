...
def DafnyToSmithy_aws_cryptography_materialproviders_Materials(input):
    ...
    if isinstance(input, Materials_Encryption):
        ...
        Materials_union_value = aws_cryptography_materialproviders.smithygenerated.models.MaterialsBranchKey(input.BranchKey)
    elif isinstance(input, Materials_BeaconKey):
        Materials_union_value = aws_cryptography_materialproviders.smithygenerated.models.MaterialsBeaconKey(input.BeaconKey)
    else:
...
def DafnyToSmithy_aws_cryptography_materialproviders_EdkWrappingAlgorithm(input):
    ...
    if isinstance(input, EdkWrappingAlgorithm_DIRECT__KEY__WRAPPING):
        ...
        EdkWrappingAlgorithm_union_value = aws_cryptography_materialproviders.smithygenerated.models.EdkWrappingAlgorithmIntermediateKeyWrapping(input.IntermediateKeyWrapping)
    else:
        raise ValueError("No recognized union value in union type: " + input)
...
def DafnyToSmithy_aws_cryptography_materialproviders_CacheType(input):
    ...
    if isinstance(input, CacheType_Default):
        ...
        CacheType_union_value = aws_cryptography_materialproviders.smithygenerated.models.CacheTypeSingleThreaded(input.SingleThreaded)
    elif isinstance(input, CacheType_MultiThreaded):
        CacheType_union_value = aws_cryptography_materialproviders.smithygenerated.models.CacheTypeMultiThreaded(input.MultiThreaded)
    elif isinstance(input, CacheType_StormTracking):
        CacheType_union_value = aws_cryptography_materialproviders.smithygenerated.models.CacheTypeStormTracking(input.StormTracking)
    else:
        raise ValueError("No recognized union value in union type: " + input)
