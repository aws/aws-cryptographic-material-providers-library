...
class CreateAwsKmsDiscoveryMultiKeyringInput:
    regions: list[str]
    discovery_filter: Optional[DiscoveryFilter]
    client_supplier: Optional[ClientSupplierReference]
    grant_tokens: Optional[list[str]]
    def __init__(
        self,
        *,
        regions: list[str],
        discovery_filter: Optional[DiscoveryFilter] = None,
        client_supplier: Optional[ClientSupplierReference] = None,
        grant_tokens: Optional[list[str]] = None,
    ):
...
class CreateAwsKmsHierarchicalKeyringInput:
    ...
    branch_key_id_supplier: Optional[BranchKeyIdSupplierReference]
    key_store: KeyStoreReference
    ttl_seconds: int
    ...
    def __init__(
        ...
        *,
        ...
        branch_key_id_supplier: Optional[BranchKeyIdSupplierReference] = None,
        ttl_seconds: int = 0,
...
class CreateAwsKmsRsaKeyringInput:
    ...
    kms_client: Optional[KmsClientReference]
    grant_tokens: Optional[list[str]]
    def __init__(
        self,
        *,
        ...
        kms_client: Optional[KmsClientReference] = None,
        grant_tokens: Optional[list[str]] = None,
    ):
        """
        :param kms_key_id: ////////////////
...
class CreateCryptographicMaterialsCacheOutput:
    materials_cache: CryptographicMaterialsCacheReference
    def __init__(
        self,
        *,
        materials_cache: CryptographicMaterialsCacheReference,
...
class CreateCryptographicMaterialsManagerOutput:
    materials_manager: CryptographicMaterialsManagerReference
    def __init__(
        self,
        *,
        materials_manager: CryptographicMaterialsManagerReference,
...
class CreateMultiKeyringInput:
    generator: Optional[KeyringReference]
    child_keyrings: list[KeyringReference]
    def __init__(
        self,
        *,
        child_keyrings: list[KeyringReference],
        generator: Optional[KeyringReference] = None,
    ):
        """
        :param generator: //////////////////
        """
...
class CreateRequiredEncryptionContextCMMInput:
    underlying_cmm: Optional[CryptographicMaterialsManagerReference]
    keyring: Optional[KeyringReference]
    required_encryption_context_keys: list[str]
    def __init__(
        self,
        *,
        required_encryption_context_keys: list[str],
        underlying_cmm: Optional[CryptographicMaterialsManagerReference] = None,
        keyring: Optional[KeyringReference] = None,
    ):
        """
