...
class default__:
    ...
    def PROVIDER__ID(instance):
        d_494_s_ = _dafny.Seq([97, 119, 115, 45, 107, 109, 115])
        return d_494_s_
    @_dafny.classproperty
    def PROVIDER__ID__HIERARCHY(instance):
        d_495_s_ = _dafny.Seq([97, 119, 115, 45, 107, 109, 115, 45, 104, 105, 101, 114, 97, 114, 99, 104, 121])
        return d_495_s_
    @_dafny.classproperty
    def RSA__PROVIDER__ID(instance):
        d_496_s_ = _dafny.Seq([97, 119, 115, 45, 107, 109, 115, 45, 114, 115, 97])
        return d_496_s_
