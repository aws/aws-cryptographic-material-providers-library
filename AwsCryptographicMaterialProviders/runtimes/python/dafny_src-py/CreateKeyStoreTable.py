        ...
        if (d_205_maybeDescribeTableResponse_).is_Failure:
            ...
            if (d_206_error_).is_ResourceNotFoundException:
                ...
                if (d_207_maybeCreateTableResponse_).is_Failure:
                    ...
                    d_208_valueOrError0_: Wrappers.Outcome = Wrappers.Outcome_Pass.default()()
                    d_208_valueOrError0_ = Wrappers.default__.Need(((((d_207_maybeCreateTableResponse_).value).TableDescription).is_Some) and (CreateKeyStoreTable.default__.keyStoreHasExpectedConstruction_q((((d_207_maybeCreateTableResponse_).value).TableDescription).value)), CreateKeyStoreTable.default__.E(_dafny.Seq("Configured table name does not conform to expected Key Store construction.")))
            ...
            d_209_valueOrError1_: Wrappers.Outcome = Wrappers.Outcome_Pass.default()()
            d_209_valueOrError1_ = Wrappers.default__.Need(((((d_205_maybeDescribeTableResponse_).value).Table).is_Some) and (CreateKeyStoreTable.default__.keyStoreHasExpectedConstruction_q((((d_205_maybeDescribeTableResponse_).value).Table).value)), CreateKeyStoreTable.default__.E(_dafny.Seq("Configured table name does not conform to expected Key Store construction.")))
