...
class default__:
    ...
    def ESDKAlgorithmSuite_q(a):
        ...
        return ((AlgorithmSuites.default__.AlgorithmSuiteInfo_q(a)) and (AlgorithmSuites.default__.SupportedESDKEncrypt_q((a).encrypt))) and (lambda29_(((a).id).ESDK))
    ...
    def DBEAlgorithmSuite_q(a):
        ...
        return (((AlgorithmSuites.default__.AlgorithmSuiteInfo_q(a)) and (AlgorithmSuites.default__.SupportedDBEEncrypt_q((a).encrypt))) and (AlgorithmSuites.default__.SupportedDBEEDKWrapping_q((a).edkWrapping))) and (lambda30_(((a).id).DBE))

    @staticmethod
    def AlgorithmSuite_q(a):
        source16_ = (a).id
        if source16_.is_ESDK:
            d_391___mcc_h0_ = source16_.ESDK
            return AlgorithmSuites.default__.ESDKAlgorithmSuite_q(a)
        elif True:
            d_392___mcc_h1_ = source16_.DBE
    ...
    def GetSuite(id):
        ...
        if source17_.is_ESDK:
            d_393___mcc_h0_ = source17_.ESDK
            d_394_e_ = d_393___mcc_h0_
            return AlgorithmSuites.default__.GetESDKSuite(d_394_e_)
        elif True:
            d_395___mcc_h1_ = source17_.DBE
            d_396_e_ = d_395___mcc_h1_
            return AlgorithmSuites.default__.GetDBESuite(d_396_e_)
    ...
    def GetEncryptKeyLength(a):
        source18_ = (a).encrypt
        if True:
            d_397___mcc_h0_ = source18_.AES__GCM
            d_398_e_ = d_397___mcc_h0_
            return (d_398_e_).keyLength

    @staticmethod
    def GetEncryptTagLength(a):
        source19_ = (a).encrypt
        if True:
            d_399___mcc_h0_ = source19_.AES__GCM
            d_400_e_ = d_399___mcc_h0_
            return (d_400_e_).tagLength

    @staticmethod
    def GetEncryptIvLength(a):
        source20_ = (a).encrypt
        if True:
            d_401___mcc_h0_ = source20_.AES__GCM
            d_402_e_ = d_401___mcc_h0_
            return (d_402_e_).ivLength

    @staticmethod
    def GetAlgorithmSuiteInfo(binaryId_q):
        d_403_valueOrError0_ = Wrappers.default__.Need((binaryId_q) in ((AlgorithmSuites.default__).AlgorithmSuiteInfoByBinaryId), software_amazon_cryptography_materialproviders_internaldafny_types.Error_AwsCryptographicMaterialProvidersException(_dafny.Seq("Invalid BinaryId")))
        if (d_403_valueOrError0_).IsFailure():
            return (d_403_valueOrError0_).PropagateFailure()
        elif True:
