...
class default__:
    ...
    def ParseAwsKmsResources(identifier):
        ...
        if (d_3_valueOrError0_).IsFailure():
            ...
            d_6_resource_ = AwsArnParsing.AwsResource_AwsResource(d_4_resourceType_, d_5_value_)
            d_7_valueOrError1_ = Wrappers.default__.Need(AwsArnParsing.default__.ValidAwsKmsResource(d_6_resource_), (_dafny.Seq("Malformed resource: ")) + (identifier))
    ...
    def ParseAmazonDynamodbResources(identifier):
        ...
        if (d_9_valueOrError0_).IsFailure():
            ...
            if (d_12_valueOrError1_).IsFailure():
                ...
                d_13_resource_ = AwsArnParsing.AwsResource_AwsResource(d_10_resourceType_, d_11_value_)
                d_14_valueOrError2_ = Wrappers.default__.Need(AwsArnParsing.default__.ValidAmazonDynamodbResource(d_13_resource_), (_dafny.Seq("Malformed resource: ")) + (identifier))
    ...
    def ParseAwsKmsArn(identifier):
        ...
        if (d_16_valueOrError0_).IsFailure():
            ...
            d_17_valueOrError1_ = AwsArnParsing.default__.ParseAwsKmsResources((d_15_components_)[5])
            if (d_17_valueOrError1_).IsFailure():
                return (d_17_valueOrError1_).PropagateFailure()
            elif True:
                d_18_resource_ = (d_17_valueOrError1_).Extract()
                d_19_arn_ = AwsArnParsing.AwsArn_AwsArn((d_15_components_)[0], (d_15_components_)[1], (d_15_components_)[2], (d_15_components_)[3], (d_15_components_)[4], d_18_resource_)
                d_20_valueOrError2_ = Wrappers.default__.Need(AwsArnParsing.default__.ValidAwsKmsArn(d_19_arn_), (_dafny.Seq("Malformed Arn:")) + (identifier))
    ...
    def ParseAmazonDynamodbTableArn(identifier):
        ...
        if (d_22_valueOrError0_).IsFailure():
            ...
            d_23_valueOrError1_ = AwsArnParsing.default__.ParseAmazonDynamodbResources((d_21_components_)[5])
            if (d_23_valueOrError1_).IsFailure():
                return (d_23_valueOrError1_).PropagateFailure()
            elif True:
                d_24_resource_ = (d_23_valueOrError1_).Extract()
                d_25_arn_ = AwsArnParsing.AwsArn_AwsArn((d_21_components_)[0], (d_21_components_)[1], (d_21_components_)[2], (d_21_components_)[3], (d_21_components_)[4], d_24_resource_)
                d_26_valueOrError2_ = Wrappers.default__.Need(AwsArnParsing.default__.ValidAmazonDynamodbArn(d_25_arn_), (_dafny.Seq("Malformed Arn:")) + (identifier))
    ...
    def ParseAwsKmsIdentifier(identifier):
        if (_dafny.Seq("arn:")) <= (identifier):
            d_27_valueOrError0_ = AwsArnParsing.default__.ParseAwsKmsArn(identifier)
            if (d_27_valueOrError0_).IsFailure():
                return (d_27_valueOrError0_).PropagateFailure()
            elif True:
                d_28_arn_ = (d_27_valueOrError0_).Extract()
                return Wrappers.Result_Success(AwsArnParsing.AwsKmsIdentifier_AwsKmsArnIdentifier(d_28_arn_))
        elif True:
            d_29_valueOrError1_ = AwsArnParsing.default__.ParseAwsKmsRawResources(identifier)
            if (d_29_valueOrError1_).IsFailure():
                return (d_29_valueOrError1_).PropagateFailure()
            elif True:
                d_30_r_ = (d_29_valueOrError1_).Extract()
                return Wrappers.Result_Success(AwsArnParsing.AwsKmsIdentifier_AwsKmsRawResourceIdentifier(d_30_r_))

    @staticmethod
    def ParseAmazonDynamodbTableName(identifier):
        d_31_valueOrError0_ = AwsArnParsing.default__.ParseAmazonDynamodbTableArn(identifier)
        if (d_31_valueOrError0_).IsFailure():
            return (d_31_valueOrError0_).PropagateFailure()
        elif True:
            d_32_arn_ = (d_31_valueOrError0_).Extract()
            d_33_tableArn_ = AwsArnParsing.AmazonDynamodbTableName_AmazonDynamodbTableArn(d_32_arn_)
    ...
    def IsMultiRegionAwsKmsIdentifier(identifier):
        ...
        if source0_.is_AwsKmsArnIdentifier:
            ...
            return AwsArnParsing.default__.IsMultiRegionAwsKmsArn(d_36_arn_)
        elif True:
            d_37___mcc_h1_ = source0_.r
            d_38_r_ = d_37___mcc_h1_
            return AwsArnParsing.default__.IsMultiRegionAwsKmsResource(d_38_r_)
    ...
    def IsAwsKmsIdentifierString(s):
        ...
        if (d_42_valueOrError0_).IsFailure():
            ...
            d_43_valueOrError1_ = Wrappers.default__.Need(((0) < (len(s))) and ((len(s)) <= ((AwsArnParsing.default__).MAX__AWS__KMS__IDENTIFIER__LENGTH)), _dafny.Seq("Identifier exceeds maximum length."))
    ...
    def ValidateDdbTableArn(tableArn):
        d_44_valueOrError0_ = (AwsArnParsing.default__.ParseAmazonDynamodbTableName(tableArn)).MapFailure(AwsArnParsing.default__.Error)
