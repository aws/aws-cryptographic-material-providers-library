...
class default__:
    ...
    def CreateKeyStore(config, input):
        ...
        d_235_valueOrError0_: Wrappers.Result = Wrappers.Result_Success.default(_dafny.Seq)()
        ...
        d_237_valueOrError1_: Wrappers.Outcome = Wrappers.Outcome_Pass.default()()
    ...
    def CreateKey(config, input):
        ...
        d_238_valueOrError0_: Wrappers.Outcome = Wrappers.Outcome_Pass.default()()
        ...
        if ((input).branchKeyIdentifier).is_None:
            ...
            d_241_valueOrError1_: Wrappers.Result = Wrappers.Result_Success.default(_dafny.Seq)()
            ...
            d_243_valueOrError2_: Wrappers.Outcome = Wrappers.Outcome_Pass.default()()
        ...
        d_245_valueOrError3_: Wrappers.Result = Wrappers.Result_Success.default(_dafny.Seq)()
        ...
        d_249_valueOrError4_: Wrappers.Result = Wrappers.Result_Success.default(_dafny.Seq)()
        ...
        d_254_valueOrError5_: Wrappers.Outcome = Wrappers.Outcome_Pass.default()()
    ...
    def VersionKey(config, input):
        ...
        d_260_valueOrError1_: Wrappers.Result = Wrappers.Result_Success.default(_dafny.Seq)()
        ...
        d_264_valueOrError2_: Wrappers.Result = Wrappers.Result_Success.default(_dafny.Seq)()
