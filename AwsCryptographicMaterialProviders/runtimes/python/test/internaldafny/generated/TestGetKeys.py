...
class default__:
    ...
    def TestGetBeaconKey():
        d_37_kmsClient_: software.amazon.cryptography.services.kms.internaldafny.types.IKMSClient
        ...
        d_39_ddbClient_: software.amazon.cryptography.services.dynamodb.internaldafny.types.IDynamoDBClient
        ...
        d_41_kmsConfig_: software.amazon.cryptography.keystore.internaldafny.types.KMSConfiguration
        d_41_kmsConfig_ = software.amazon.cryptography.keystore.internaldafny.types.KMSConfiguration_kmsKeyArn(Fixtures.default__.keyArn)
        d_42_keyStoreConfig_: software.amazon.cryptography.keystore.internaldafny.types.KeyStoreConfig
        ...
        d_43_keyStore_: software.amazon.cryptography.keystore.internaldafny.types.IKeyStoreClient
        ...
        d_45_beaconKeyResult_: software.amazon.cryptography.keystore.internaldafny.types.GetBeaconKeyOutput
        d_46_valueOrError3_: Wrappers.Result = Wrappers.Result.default(software.amazon.cryptography.keystore.internaldafny.types.GetBeaconKeyOutput.default())()
        out19_: Wrappers.Result
        out19_ = (d_43_keyStore_).GetBeaconKey(software.amazon.cryptography.keystore.internaldafny.types.GetBeaconKeyInput_GetBeaconKeyInput(Fixtures.default__.branchKeyId))
    ...
    def TestGetActiveKey():
        d_47_kmsClient_: software.amazon.cryptography.services.kms.internaldafny.types.IKMSClient
        ...
        d_49_ddbClient_: software.amazon.cryptography.services.dynamodb.internaldafny.types.IDynamoDBClient
        ...
        d_51_kmsConfig_: software.amazon.cryptography.keystore.internaldafny.types.KMSConfiguration
        d_51_kmsConfig_ = software.amazon.cryptography.keystore.internaldafny.types.KMSConfiguration_kmsKeyArn(Fixtures.default__.keyArn)
        d_52_keyStoreConfig_: software.amazon.cryptography.keystore.internaldafny.types.KeyStoreConfig
        d_52_keyStoreConfig_ = software.amazon.cryptography.keystore.internaldafny.types.KeyStoreConfig_KeyStoreConfig(Fixtures.default__.branchKeyStoreName, d_51_kmsConfig_, Fixtures.default__.logicalKeyStoreName, Wrappers.Option_None(), Wrappers.Option_None(), Wrappers.Option_Some(d_49_ddbClient_), Wrappers.Option_Some(d_47_kmsClient_))
        d_53_keyStore_: software.amazon.cryptography.keystore.internaldafny.types.IKeyStoreClient
        ...
        d_55_activeResult_: software.amazon.cryptography.keystore.internaldafny.types.GetActiveBranchKeyOutput
        d_56_valueOrError3_: Wrappers.Result = Wrappers.Result.default(software.amazon.cryptography.keystore.internaldafny.types.GetActiveBranchKeyOutput.default())()
        out23_: Wrappers.Result
        out23_ = (d_53_keyStore_).GetActiveBranchKey(software.amazon.cryptography.keystore.internaldafny.types.GetActiveBranchKeyInput_GetActiveBranchKeyInput(Fixtures.default__.branchKeyId))
    ...
    def TestGetBranchKeyVersion():
        d_57_kmsClient_: software.amazon.cryptography.services.kms.internaldafny.types.IKMSClient
        ...
        d_59_ddbClient_: software.amazon.cryptography.services.dynamodb.internaldafny.types.IDynamoDBClient
        ...
        d_61_kmsConfig_: software.amazon.cryptography.keystore.internaldafny.types.KMSConfiguration
        d_61_kmsConfig_ = software.amazon.cryptography.keystore.internaldafny.types.KMSConfiguration_kmsKeyArn(Fixtures.default__.keyArn)
        d_62_keyStoreConfig_: software.amazon.cryptography.keystore.internaldafny.types.KeyStoreConfig
        d_62_keyStoreConfig_ = software.amazon.cryptography.keystore.internaldafny.types.KeyStoreConfig_KeyStoreConfig(Fixtures.default__.branchKeyStoreName, d_61_kmsConfig_, Fixtures.default__.logicalKeyStoreName, Wrappers.Option_None(), Wrappers.Option_None(), Wrappers.Option_Some(d_59_ddbClient_), Wrappers.Option_Some(d_57_kmsClient_))
        d_63_keyStore_: software.amazon.cryptography.keystore.internaldafny.types.IKeyStoreClient
        ...
        d_65_versionResult_: software.amazon.cryptography.keystore.internaldafny.types.GetBranchKeyVersionOutput
        d_66_valueOrError3_: Wrappers.Result = Wrappers.Result.default(software.amazon.cryptography.keystore.internaldafny.types.GetBranchKeyVersionOutput.default())()
        out27_: Wrappers.Result
        out27_ = (d_63_keyStore_).GetBranchKeyVersion(software.amazon.cryptography.keystore.internaldafny.types.GetBranchKeyVersionInput_GetBranchKeyVersionInput(Fixtures.default__.branchKeyId, Fixtures.default__.branchKeyIdActiveVersion))
    ...
    def TestGetActiveKeyWithIncorrectKmsKeyArn():
        d_69_kmsClient_: software.amazon.cryptography.services.kms.internaldafny.types.IKMSClient
        ...
        d_71_ddbClient_: software.amazon.cryptography.services.dynamodb.internaldafny.types.IDynamoDBClient
        ...
        d_73_kmsConfig_: software.amazon.cryptography.keystore.internaldafny.types.KMSConfiguration
        d_73_kmsConfig_ = software.amazon.cryptography.keystore.internaldafny.types.KMSConfiguration_kmsKeyArn(Fixtures.default__.mkrKeyArn)
        d_74_keyStoreConfig_: software.amazon.cryptography.keystore.internaldafny.types.KeyStoreConfig
        d_74_keyStoreConfig_ = software.amazon.cryptography.keystore.internaldafny.types.KeyStoreConfig_KeyStoreConfig(Fixtures.default__.branchKeyStoreName, d_73_kmsConfig_, Fixtures.default__.logicalKeyStoreName, Wrappers.Option_None(), Wrappers.Option_None(), Wrappers.Option_Some(d_71_ddbClient_), Wrappers.Option_Some(d_69_kmsClient_))
        d_75_keyStore_: software.amazon.cryptography.keystore.internaldafny.types.IKeyStoreClient
        ...
        out31_ = (d_75_keyStore_).GetActiveBranchKey(software.amazon.cryptography.keystore.internaldafny.types.GetActiveBranchKeyInput_GetActiveBranchKeyInput(Fixtures.default__.branchKeyId))
    ...
    def TestGetActiveKeyWrongLogicalKeyStoreName():
        d_78_kmsClient_: software.amazon.cryptography.services.kms.internaldafny.types.IKMSClient
        ...
        d_80_ddbClient_: software.amazon.cryptography.services.dynamodb.internaldafny.types.IDynamoDBClient
        ...
        d_82_kmsConfig_: software.amazon.cryptography.keystore.internaldafny.types.KMSConfiguration
        d_82_kmsConfig_ = software.amazon.cryptography.keystore.internaldafny.types.KMSConfiguration_kmsKeyArn(Fixtures.default__.keyArn)
        d_83_keyStoreConfig_: software.amazon.cryptography.keystore.internaldafny.types.KeyStoreConfig
        ...
        d_84_keyStore_: software.amazon.cryptography.keystore.internaldafny.types.IKeyStoreClient
        ...
        out35_ = (d_84_keyStore_).GetActiveBranchKey(software.amazon.cryptography.keystore.internaldafny.types.GetActiveBranchKeyInput_GetActiveBranchKeyInput(Fixtures.default__.branchKeyId))
    ...
    def TestGetActiveKeyWithNoClients():
        d_87_kmsConfig_: software.amazon.cryptography.keystore.internaldafny.types.KMSConfiguration
        d_87_kmsConfig_ = software.amazon.cryptography.keystore.internaldafny.types.KMSConfiguration_kmsKeyArn(Fixtures.default__.keyArn)
        d_88_keyStoreConfig_: software.amazon.cryptography.keystore.internaldafny.types.KeyStoreConfig
        d_88_keyStoreConfig_ = software.amazon.cryptography.keystore.internaldafny.types.KeyStoreConfig_KeyStoreConfig(Fixtures.default__.branchKeyStoreName, d_87_kmsConfig_, Fixtures.default__.logicalKeyStoreName, Wrappers.Option_None(), Wrappers.Option_None(), Wrappers.Option_None(), Wrappers.Option_None())
        d_89_keyStore_: software.amazon.cryptography.keystore.internaldafny.types.IKeyStoreClient
        ...
        d_91_activeResult_: software.amazon.cryptography.keystore.internaldafny.types.GetActiveBranchKeyOutput
        d_92_valueOrError1_: Wrappers.Result = Wrappers.Result.default(software.amazon.cryptography.keystore.internaldafny.types.GetActiveBranchKeyOutput.default())()
        out37_: Wrappers.Result
        out37_ = (d_89_keyStore_).GetActiveBranchKey(software.amazon.cryptography.keystore.internaldafny.types.GetActiveBranchKeyInput_GetActiveBranchKeyInput(Fixtures.default__.branchKeyId))
