...
class default__:
    ...
    def TestKmsRsaRoundtrip():
        d_572_mpl_: software_amazon_cryptography_materialproviders_internaldafny.MaterialProvidersClient
    ...
    def TestKmsRsaWithAsymmetricSignatureFails():
        d_596_mpl_: software_amazon_cryptography_materialproviders_internaldafny.MaterialProvidersClient
