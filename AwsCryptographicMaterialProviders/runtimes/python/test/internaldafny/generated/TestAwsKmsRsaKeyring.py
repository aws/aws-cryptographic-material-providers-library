...
class default__:
    ...
    def TestKmsRsaRoundtrip():
        d_572_mpl_: software.amazon.cryptography.materialproviders.internaldafny.types.IAwsCryptographicMaterialProvidersClient
        ...
        d_576_clientSupplier_: software.amazon.cryptography.materialproviders.internaldafny.types.IClientSupplier
        d_577_valueOrError2_: Wrappers.Result = None
        out234_: Wrappers.Result
        out234_ = (d_572_mpl_).CreateDefaultClientSupplier(software.amazon.cryptography.materialproviders.internaldafny.types.CreateDefaultClientSupplierInput_CreateDefaultClientSupplierInput())
        ...
        d_578_kmsClient_: software.amazon.cryptography.services.kms.internaldafny.types.IKMSClient
        d_579_valueOrError3_: Wrappers.Result = None
        out235_: Wrappers.Result
        out235_ = (d_576_clientSupplier_).GetClient(software.amazon.cryptography.materialproviders.internaldafny.types.GetClientInput_GetClientInput(_dafny.Seq("us-west-2")))
        ...
        d_580_kmsRsaKeyring_: software.amazon.cryptography.materialproviders.internaldafny.types.IKeyring
        d_581_valueOrError4_: Wrappers.Result = None
        out236_: Wrappers.Result
        out236_ = (d_572_mpl_).CreateAwsKmsRsaKeyring(software.amazon.cryptography.materialproviders.internaldafny.types.CreateAwsKmsRsaKeyringInput_CreateAwsKmsRsaKeyringInput(Wrappers.Option_Some(d_574_publicKey_), TestUtils.default__.KMS__RSA__PRIVATE__KEY__ARN, software.amazon.cryptography.services.kms.internaldafny.types.EncryptionAlgorithmSpec_RSAES__OAEP__SHA__1(), Wrappers.Option_Some(d_578_kmsClient_), Wrappers.Option_None()))
        ...
        d_583_algorithmSuiteId_: software.amazon.cryptography.materialproviders.internaldafny.types.AlgorithmSuiteId
        d_583_algorithmSuiteId_ = software.amazon.cryptography.materialproviders.internaldafny.types.AlgorithmSuiteId_ESDK(software.amazon.cryptography.materialproviders.internaldafny.types.ESDKAlgorithmSuiteId_ALG__AES__256__GCM__IV12__TAG16__NO__KDF())
        d_584_suite_: software.amazon.cryptography.materialproviders.internaldafny.types.AlgorithmSuiteInfo
        d_584_suite_ = AlgorithmSuites.default__.GetSuite(d_583_algorithmSuiteId_)
        d_585_encryptionMaterialsIn_: software.amazon.cryptography.materialproviders.internaldafny.types.EncryptionMaterials
        d_586_valueOrError5_: Wrappers.Result = None
        d_586_valueOrError5_ = (d_572_mpl_).InitializeEncryptionMaterials(software.amazon.cryptography.materialproviders.internaldafny.types.InitializeEncryptionMaterialsInput_InitializeEncryptionMaterialsInput(d_583_algorithmSuiteId_, d_582_encryptionContext_, _dafny.Seq([]), Wrappers.Option_None(), Wrappers.Option_None()))
        ...
        d_587_encryptionMaterialsOut_: software.amazon.cryptography.materialproviders.internaldafny.types.OnEncryptOutput
        d_588_valueOrError6_: Wrappers.Result = None
        out238_: Wrappers.Result
        out238_ = (d_580_kmsRsaKeyring_).OnEncrypt(software.amazon.cryptography.materialproviders.internaldafny.types.OnEncryptInput_OnEncryptInput(d_585_encryptionMaterialsIn_))
        ...
        d_591_edk_: software.amazon.cryptography.materialproviders.internaldafny.types.EncryptedDataKey
        d_591_edk_ = (((d_587_encryptionMaterialsOut_).materials).encryptedDataKeys)[0]
        d_592_decryptionMaterialsIn_: software.amazon.cryptography.materialproviders.internaldafny.types.DecryptionMaterials
        d_593_valueOrError8_: Wrappers.Result = None
        d_593_valueOrError8_ = (d_572_mpl_).InitializeDecryptionMaterials(software.amazon.cryptography.materialproviders.internaldafny.types.InitializeDecryptionMaterialsInput_InitializeDecryptionMaterialsInput(d_583_algorithmSuiteId_, d_582_encryptionContext_, _dafny.Seq([])))
        ...
        d_594_decryptionMaterialsOut_: software.amazon.cryptography.materialproviders.internaldafny.types.OnDecryptOutput
        d_595_valueOrError9_: Wrappers.Result = None
        out239_: Wrappers.Result
        out239_ = (d_580_kmsRsaKeyring_).OnDecrypt(software.amazon.cryptography.materialproviders.internaldafny.types.OnDecryptInput_OnDecryptInput(d_592_decryptionMaterialsIn_, _dafny.Seq([d_591_edk_])))
    ...
    def TestKmsRsaWithAsymmetricSignatureFails():
        d_596_mpl_: software.amazon.cryptography.materialproviders.internaldafny.types.IAwsCryptographicMaterialProvidersClient
        ...
        d_600_clientSupplier_: software.amazon.cryptography.materialproviders.internaldafny.types.IClientSupplier
        d_601_valueOrError2_: Wrappers.Result = None
        out241_: Wrappers.Result
        out241_ = (d_596_mpl_).CreateDefaultClientSupplier(software.amazon.cryptography.materialproviders.internaldafny.types.CreateDefaultClientSupplierInput_CreateDefaultClientSupplierInput())
        ...
        d_602_kmsClient_: software.amazon.cryptography.services.kms.internaldafny.types.IKMSClient
        d_603_valueOrError3_: Wrappers.Result = None
        out242_: Wrappers.Result
        out242_ = (d_600_clientSupplier_).GetClient(software.amazon.cryptography.materialproviders.internaldafny.types.GetClientInput_GetClientInput(_dafny.Seq("us-west-2")))
        ...
        d_604_kmsRsaKeyring_: software.amazon.cryptography.materialproviders.internaldafny.types.IKeyring
        d_605_valueOrError4_: Wrappers.Result = None
        out243_: Wrappers.Result
        out243_ = (d_596_mpl_).CreateAwsKmsRsaKeyring(software.amazon.cryptography.materialproviders.internaldafny.types.CreateAwsKmsRsaKeyringInput_CreateAwsKmsRsaKeyringInput(Wrappers.Option_Some(d_598_publicKey_), TestUtils.default__.KMS__RSA__PRIVATE__KEY__ARN, software.amazon.cryptography.services.kms.internaldafny.types.EncryptionAlgorithmSpec_RSAES__OAEP__SHA__1(), Wrappers.Option_Some(d_602_kmsClient_), Wrappers.Option_None()))
        ...
        d_606_algorithmSuiteId_: software.amazon.cryptography.materialproviders.internaldafny.types.AlgorithmSuiteId
        d_606_algorithmSuiteId_ = software.amazon.cryptography.materialproviders.internaldafny.types.AlgorithmSuiteId_DBE(software.amazon.cryptography.materialproviders.internaldafny.types.DBEAlgorithmSuiteId_ALG__AES__256__GCM__HKDF__SHA512__COMMIT__KEY__ECDSA__P384__SYMSIG__HMAC__SHA384())
        ...
        d_608_encryptionMaterialsIn_: software.amazon.cryptography.materialproviders.internaldafny.types.EncryptionMaterials
        d_609_valueOrError5_: Wrappers.Result = None
        d_609_valueOrError5_ = (d_596_mpl_).InitializeEncryptionMaterials(software.amazon.cryptography.materialproviders.internaldafny.types.InitializeEncryptionMaterialsInput_InitializeEncryptionMaterialsInput(d_606_algorithmSuiteId_, _dafny.Map({}), _dafny.Seq([]), Wrappers.Option_Some(_dafny.Seq([0, 0, 0, 0, 0])), Wrappers.Option_Some(_dafny.Seq([0, 0, 0, 0, 0]))))
        ...
        out244_ = (d_604_kmsRsaKeyring_).OnEncrypt(software.amazon.cryptography.materialproviders.internaldafny.types.OnEncryptInput_OnEncryptInput(d_608_encryptionMaterialsIn_))
        ...
        d_611_decryptionMaterialsIn_: software.amazon.cryptography.materialproviders.internaldafny.types.DecryptionMaterials
        d_612_valueOrError6_: Wrappers.Result = None
        d_612_valueOrError6_ = (d_596_mpl_).InitializeDecryptionMaterials(software.amazon.cryptography.materialproviders.internaldafny.types.InitializeDecryptionMaterialsInput_InitializeDecryptionMaterialsInput(d_606_algorithmSuiteId_, (d_608_encryptionMaterialsIn_).encryptionContext, _dafny.Seq([])))
        ...
        out245_ = (d_604_kmsRsaKeyring_).OnDecrypt(software.amazon.cryptography.materialproviders.internaldafny.types.OnDecryptInput_OnDecryptInput(d_611_decryptionMaterialsIn_, _dafny.Seq([])))
