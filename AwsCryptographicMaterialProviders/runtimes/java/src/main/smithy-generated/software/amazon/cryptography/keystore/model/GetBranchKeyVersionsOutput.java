...
public class GetBranchKeyVersionsOutput {
  ...
  /**
   * The list of decrypted branch key materials for recent versions.
   */
  ...
  /**
   * @return The list of decrypted branch key materials for recent versions.
   */
  ...
  public interface Builder {
    /**
     * @param branchKeyMaterials The list of decrypted branch key materials for recent versions.
     */
