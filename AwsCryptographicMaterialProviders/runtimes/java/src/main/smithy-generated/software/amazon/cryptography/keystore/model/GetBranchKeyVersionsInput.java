...
/**
 * Inputs for getting recent branch key versions.
 */
public class GetBranchKeyVersionsInput {

  /**
   * The identifier of the Branch Key to get recent versions for.
   */
  ...
  /**
   * @return The identifier of the Branch Key to get recent versions for.
   */
  ...
  /**
   * @return The maximum number of recent versions to retrieve.
   */
  ...
  public interface Builder {
    /**
     * @param branchKeyIdentifier The identifier of the Branch Key to get recent versions for.
     */
    ...
    /**
     * @param count The maximum number of recent versions to retrieve.
     */
