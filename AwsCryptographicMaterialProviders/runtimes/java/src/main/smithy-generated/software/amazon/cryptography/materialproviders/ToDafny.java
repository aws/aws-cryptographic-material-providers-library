...
public class ToDafny {
  ...
  public static CreateAwsKmsDiscoveryKeyringInput CreateAwsKmsDiscoveryKeyringInput(
    ...
    discoveryFilter = Objects.nonNull(nativeValue.discoveryFilter()) ?
        Option.create_Some(DiscoveryFilter._typeDescriptor(), ToDafny.DiscoveryFilter(nativeValue.discoveryFilter()))
  ...
  public static CreateAwsKmsDiscoveryMultiKeyringInput CreateAwsKmsDiscoveryMultiKeyringInput(
    ...
    clientSupplier = Objects.nonNull(nativeValue.clientSupplier()) ?
        Option.create_Some(TypeDescriptor.reference(software.amazon.cryptography.materialproviders.internaldafny.types.IClientSupplier.class), ToDafny.ClientSupplier(nativeValue.clientSupplier()))
        : Option.create_None(TypeDescriptor.reference(software.amazon.cryptography.materialproviders.internaldafny.types.IClientSupplier.class));
    Option<DafnySequence<? extends DafnySequence<? extends Character>>> grantTokens;
    grantTokens = (Objects.nonNull(nativeValue.grantTokens()) && nativeValue.grantTokens().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR)), ToDafny.GrantTokenList(nativeValue.grantTokens()))
        : Option.create_None(DafnySequence._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR)));
  ...
  public static CreateAwsKmsHierarchicalKeyringInput CreateAwsKmsHierarchicalKeyringInput(
    ...
    branchKeyId = Objects.nonNull(nativeValue.branchKeyId()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.branchKeyId()))
    ...
    branchKeyIdSupplier = Objects.nonNull(nativeValue.branchKeyIdSupplier()) ?
        Option.create_Some(TypeDescriptor.reference(software.amazon.cryptography.materialproviders.internaldafny.types.IBranchKeyIdSupplier.class), ToDafny.BranchKeyIdSupplier(nativeValue.branchKeyIdSupplier()))
        : Option.create_None(TypeDescriptor.reference(software.amazon.cryptography.materialproviders.internaldafny.types.IBranchKeyIdSupplier.class));
    ...
    cache = Objects.nonNull(nativeValue.cache()) ?
        Option.create_Some(CacheType._typeDescriptor(), ToDafny.CacheType(nativeValue.cache()))
  ...
  public static CreateAwsKmsMrkMultiKeyringInput CreateAwsKmsMrkMultiKeyringInput(
    ...
    generator = Objects.nonNull(nativeValue.generator()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.generator()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    ...
    kmsKeyIds = (Objects.nonNull(nativeValue.kmsKeyIds()) && nativeValue.kmsKeyIds().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR)), ToDafny.KmsKeyIdList(nativeValue.kmsKeyIds()))
        : Option.create_None(DafnySequence._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR)));
    Option<software.amazon.cryptography.materialproviders.internaldafny.types.IClientSupplier> clientSupplier;
    clientSupplier = Objects.nonNull(nativeValue.clientSupplier()) ?
        Option.create_Some(TypeDescriptor.reference(software.amazon.cryptography.materialproviders.internaldafny.types.IClientSupplier.class), ToDafny.ClientSupplier(nativeValue.clientSupplier()))
  ...
  public static CreateAwsKmsRsaKeyringInput CreateAwsKmsRsaKeyringInput(
    ...
    publicKey = Objects.nonNull(nativeValue.publicKey()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.BYTE), software.amazon.smithy.dafny.conversion.ToDafny.Simple.ByteSequence(nativeValue.publicKey()))
    ...
    kmsClient = Objects.nonNull(nativeValue.kmsClient()) ?
        Option.create_Some(TypeDescriptor.reference(IKMSClient.class), software.amazon.cryptography.services.kms.internaldafny.ToDafny.TrentService(nativeValue.kmsClient()))
  ...
  public static CreateMultiKeyringInput CreateMultiKeyringInput(
    ...
    generator = Objects.nonNull(nativeValue.generator()) ?
        Option.create_Some(TypeDescriptor.reference(software.amazon.cryptography.materialproviders.internaldafny.types.IKeyring.class), ToDafny.Keyring(nativeValue.generator()))
        : Option.create_None(TypeDescriptor.reference(software.amazon.cryptography.materialproviders.internaldafny.types.IKeyring.class));
  ...
  public static CreateRawRsaKeyringInput CreateRawRsaKeyringInput(
    ...
    privateKey = Objects.nonNull(nativeValue.privateKey()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.BYTE), software.amazon.smithy.dafny.conversion.ToDafny.Simple.ByteSequence(nativeValue.privateKey()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.BYTE));
  ...
  public static CreateRequiredEncryptionContextCMMInput CreateRequiredEncryptionContextCMMInput(
    ...
    underlyingCMM = Objects.nonNull(nativeValue.underlyingCMM()) ?
        Option.create_Some(TypeDescriptor.reference(software.amazon.cryptography.materialproviders.internaldafny.types.ICryptographicMaterialsManager.class), ToDafny.CryptographicMaterialsManager(nativeValue.underlyingCMM()))
        : Option.create_None(TypeDescriptor.reference(software.amazon.cryptography.materialproviders.internaldafny.types.ICryptographicMaterialsManager.class));
    ...
    keyring = Objects.nonNull(nativeValue.keyring()) ?
        Option.create_Some(TypeDescriptor.reference(software.amazon.cryptography.materialproviders.internaldafny.types.IKeyring.class), ToDafny.Keyring(nativeValue.keyring()))
        : Option.create_None(TypeDescriptor.reference(software.amazon.cryptography.materialproviders.internaldafny.types.IKeyring.class));
  ...
  public static DecryptionMaterials DecryptionMaterials(
    ...
    plaintextDataKey = Objects.nonNull(nativeValue.plaintextDataKey()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.BYTE), software.amazon.smithy.dafny.conversion.ToDafny.Simple.ByteSequence(nativeValue.plaintextDataKey()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.BYTE));
    Option<DafnySequence<? extends Byte>> verificationKey;
    verificationKey = Objects.nonNull(nativeValue.verificationKey()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.BYTE), software.amazon.smithy.dafny.conversion.ToDafny.Simple.ByteSequence(nativeValue.verificationKey()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.BYTE));
    Option<DafnySequence<? extends Byte>> symmetricSigningKey;
    symmetricSigningKey = Objects.nonNull(nativeValue.symmetricSigningKey()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.BYTE), software.amazon.smithy.dafny.conversion.ToDafny.Simple.ByteSequence(nativeValue.symmetricSigningKey()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.BYTE));
  ...
  public static DecryptMaterialsInput DecryptMaterialsInput(
    ...
    reproducedEncryptionContext = (Objects.nonNull(nativeValue.reproducedEncryptionContext()) && nativeValue.reproducedEncryptionContext().size() > 0) ?
        Option.create_Some(DafnyMap._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.BYTE), DafnySequence._typeDescriptor(TypeDescriptor.BYTE)), ToDafny.EncryptionContext(nativeValue.reproducedEncryptionContext()))
        : Option.create_None(DafnyMap._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.BYTE), DafnySequence._typeDescriptor(TypeDescriptor.BYTE)));
  ...
  public static EncryptionMaterials EncryptionMaterials(
    ...
    signingKey = Objects.nonNull(nativeValue.signingKey()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.BYTE), software.amazon.smithy.dafny.conversion.ToDafny.Simple.ByteSequence(nativeValue.signingKey()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.BYTE));
    ...
    symmetricSigningKeys = (Objects.nonNull(nativeValue.symmetricSigningKeys()) && nativeValue.symmetricSigningKeys().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.BYTE)), ToDafny.SymmetricSigningKeyList(nativeValue.symmetricSigningKeys()))
        : Option.create_None(DafnySequence._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.BYTE)));
  ...
  public static GetEncryptionMaterialsInput GetEncryptionMaterialsInput(
    ...
    algorithmSuiteId = Objects.nonNull(nativeValue.algorithmSuiteId()) ?
        Option.create_Some(AlgorithmSuiteId._typeDescriptor(), ToDafny.AlgorithmSuiteId(nativeValue.algorithmSuiteId()))
    ...
    maxPlaintextLength = Objects.nonNull(nativeValue.maxPlaintextLength()) ?
        Option.create_Some(TypeDescriptor.LONG, (nativeValue.maxPlaintextLength()))
        : Option.create_None(TypeDescriptor.LONG);
    ...
    requiredEncryptionContextKeys = (Objects.nonNull(nativeValue.requiredEncryptionContextKeys()) && nativeValue.requiredEncryptionContextKeys().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.BYTE)), ToDafny.EncryptionContextKeys(nativeValue.requiredEncryptionContextKeys()))
        : Option.create_None(DafnySequence._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.BYTE)));
  ...
  public static MultiThreadedCache MultiThreadedCache(
    ...
    entryPruningTailSize = Objects.nonNull(nativeValue.entryPruningTailSize()) ?
        Option.create_Some(TypeDescriptor.INT, (nativeValue.entryPruningTailSize()))
