...
public class KeyStoreAdminException extends RuntimeException {
  ...
  static class BuilderImpl implements Builder {
    ...
    protected BuilderImpl(KeyStoreAdminException model) {
    ...
    public KeyStoreAdminException build() {
      if (Objects.isNull(this.message())) {
        throw new IllegalArgumentException(
          "Missing value for required field `message`"
        );
      }
      return new KeyStoreAdminException(this);
    }
  }
}
