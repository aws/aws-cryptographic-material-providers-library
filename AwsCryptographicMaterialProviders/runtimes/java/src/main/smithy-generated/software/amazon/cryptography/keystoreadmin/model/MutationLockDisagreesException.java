...
/**
 * Mutation Lock does not agree with the provided Branch Key Properities.
 */
public class MutationLockDisagreesException extends RuntimeException {

  protected MutationLockDisagreesException(BuilderImpl builder) {
  ...
  public interface Builder {
    ...
    MutationLockDisagreesException build();
  }
  ...
  static class BuilderImpl implements Builder {
    ...
    protected BuilderImpl(MutationLockDisagreesException model) {
    ...
    public MutationLockDisagreesException build() {
      if (Objects.isNull(this.message())) {
        throw new IllegalArgumentException(
          "Missing value for required field `message`"
        );
      }
      return new MutationLockDisagreesException(this);
    }
  }
}
