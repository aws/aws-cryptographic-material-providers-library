 ...
 */
public class MutationCommitmentConditionFailed extends RuntimeException {

  protected MutationCommitmentConditionFailed(BuilderImpl builder) {
  ...
  public interface Builder {
    ...
    MutationCommitmentConditionFailed build();
  }
  ...
  static class BuilderImpl implements Builder {
    ...
    protected BuilderImpl(MutationCommitmentConditionFailed model) {
    ...
    public MutationCommitmentConditionFailed build() {
      if (Objects.isNull(this.message())) {
        throw new IllegalArgumentException(
          "Missing value for required field `message`"
        );
      }
      return new MutationCommitmentConditionFailed(this);
    }
  }
}
