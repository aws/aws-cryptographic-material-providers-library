...
public class WriteNewVersionInput {
  ...
  protected WriteNewVersionInput(BuilderImpl builder) {
  ...
  static class BuilderImpl implements Builder {
    ...
    protected BuilderImpl(WriteNewVersionInput model) {
    ...
    public WriteNewVersionInput build() {
      ...
      return new WriteNewVersionInput(this);
    }
  }
}
