...
public class GetActiveOutput {

  private final EncryptedHierarchicalKey Item;

  protected GetActiveOutput(BuilderImpl builder) {
  ...
  static class BuilderImpl implements Builder {
    ...
    protected BuilderImpl(GetActiveOutput model) {
