...
public class KeyStorageException extends RuntimeException {
  ...
  protected KeyStorageException(BuilderImpl builder) {
  ...
  static class BuilderImpl implements Builder {
    ...
    protected BuilderImpl(KeyStorageException model) {
    ...
    public KeyStorageException build() {
      if (Objects.isNull(this.message())) {
        throw new IllegalArgumentException(
          "Missing value for required field `message`"
        );
      }
      return new KeyStorageException(this);
    }
  }
}
