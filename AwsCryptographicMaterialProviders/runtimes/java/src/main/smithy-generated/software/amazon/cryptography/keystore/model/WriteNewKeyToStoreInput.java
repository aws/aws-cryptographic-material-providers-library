...
public class WriteNewKeyToStoreInput {
  ...
  protected WriteNewKeyToStoreInput(BuilderImpl builder) {
  ...
  static class BuilderImpl implements Builder {
    ...
    protected BuilderImpl(WriteNewKeyToStoreInput model) {
    ...
    public WriteNewKeyToStoreInput build() {
      ...
      return new WriteNewKeyToStoreInput(this);
    }
  }
}
