...
public class MutationLockInvalidException extends RuntimeException {
  ...
  protected MutationLockInvalidException(BuilderImpl builder) {
  ...
  public interface Builder {
    ...
    MutationLockInvalidException build();
  }
  ...
  static class BuilderImpl implements Builder {
    ...
    protected BuilderImpl(MutationLockInvalidException model) {
    ...
    public MutationLockInvalidException build() {
      if (Objects.isNull(this.message())) {
        throw new IllegalArgumentException(
          "Missing value for required field `message`"
        );
      }
      return new MutationLockInvalidException(this);
    }
  }
}
