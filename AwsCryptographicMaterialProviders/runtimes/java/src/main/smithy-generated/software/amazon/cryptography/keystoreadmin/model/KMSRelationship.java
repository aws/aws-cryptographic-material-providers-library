...
public class KMSRelationship {
   ...
   *          </ul>
   */
  private final KmsClient ReEncrypt;

  protected KMSRelationship(BuilderImpl builder) {
    this.ReEncrypt = builder.ReEncrypt();
  }

  /**
   * @return <fullname>Key Management Service</fullname>
   *          <p>Key Management Service (KMS) is an encryption and key management web service. This guide describes
   *       the KMS operations that you can call programmatically. For general information about KMS,
   *       see the <a href="https://docs.aws.amazon.com/kms/latest/developerguide/">
   *                <i>Key Management Service Developer Guide</i>
  ...
  public interface Builder {
    /**
     * @param ReEncrypt <fullname>Key Management Service</fullname>
     *          <p>Key Management Service (KMS) is an encryption and key management web service. This guide describes
     *       the KMS operations that you can call programmatically. For general information about KMS,
     *       see the <a href="https://docs.aws.amazon.com/kms/latest/developerguide/">
     *                <i>Key Management Service Developer Guide</i>
     ...
     *          </ul>
     */
    Builder ReEncrypt(KmsClient ReEncrypt);
    ...
    KMSRelationship build();
  }

  static class BuilderImpl implements Builder {

    protected KmsClient ReEncrypt;

    protected BuilderImpl() {}

    protected BuilderImpl(KMSRelationship model) {
      this.ReEncrypt = model.ReEncrypt();
    }

    public Builder ReEncrypt(KmsClient ReEncrypt) {
    ...
    public KMSRelationship build() {
      if (!onlyOneNonNull()) {
        throw new IllegalArgumentException(
          "`KMSRelationship` is a Union. A Union MUST have one and only one value set."
        );
      }
      return new KMSRelationship(this);
    }

    private boolean onlyOneNonNull() {
      Object[] allValues = { this.ReEncrypt };
