...
public class EncryptedKeyStoreException extends RuntimeException {

  protected EncryptedKeyStoreException(BuilderImpl builder) {
  ...
  public interface Builder {
    ...
    EncryptedKeyStoreException build();
  }
  ...
  static class BuilderImpl implements Builder {
    ...
    protected BuilderImpl(EncryptedKeyStoreException model) {
    ...
    public EncryptedKeyStoreException build() {
      if (Objects.isNull(this.message())) {
        throw new IllegalArgumentException(
          "Missing value for required field `message`"
        );
      }
      return new EncryptedKeyStoreException(this);
    }
  }
}
