...
public class StaticSenderStaticRecipientInput {
  ...
  protected StaticSenderStaticRecipientInput(BuilderImpl builder) {
  ...
  static class BuilderImpl implements Builder {
    ...
    protected BuilderImpl(StaticSenderStaticRecipientInput model) {
    ...
    public StaticSenderStaticRecipientInput build() {
      ...
      return new StaticSenderStaticRecipientInput(this);
    }
  }
}
