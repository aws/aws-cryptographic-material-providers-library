...
public class MutationConflictException extends RuntimeException {
  ...
  protected MutationConflictException(BuilderImpl builder) {
  ...
  public interface Builder {
    ...
    MutationConflictException build();
  }
  ...
  static class BuilderImpl implements Builder {
    ...
    protected BuilderImpl(MutationConflictException model) {
    ...
    public MutationConflictException build() {
      if (Objects.isNull(this.message())) {
        throw new IllegalArgumentException(
          "Missing value for required field `message`"
        );
      }
      return new MutationConflictException(this);
    }
  }
}
