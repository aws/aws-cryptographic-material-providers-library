...
public class __default {
  ...
  public static Wrappers_Compile.Result<dafny.DafnySequence<? extends Character>, software.amazon.cryptography.materialproviders.internaldafny.types.Error> IncorrectDataKeysExpectedValues(dafny.DafnySequence<? extends software.amazon.cryptography.materialproviders.internaldafny.types.EncryptedDataKey> encryptedDataKeys, software.amazon.cryptography.materialproviders.internaldafny.types.AlgorithmSuiteInfo material, dafny.DafnySequence<? extends Character> errMsg)
  {
    TAIL_CALL_START: while (true) {
      if ((java.math.BigInteger.valueOf((encryptedDataKeys).length())).signum() == 0) {
        ...
        software.amazon.cryptography.materialproviders.internaldafny.types.EncryptedDataKey _0_encryptedDataKey = ((software.amazon.cryptography.materialproviders.internaldafny.types.EncryptedDataKey)(java.lang.Object)((encryptedDataKeys).select(dafny.Helpers.toInt((java.math.BigInteger.ZERO)))));
        ...
        if ((_1_valueOrError0).IsFailure(dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR), software.amazon.cryptography.materialproviders.internaldafny.types.Error._typeDescriptor())) {
          ...
          if ((_4_valueOrError1).IsFailure(dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR), software.amazon.cryptography.materialproviders.internaldafny.types.Error._typeDescriptor())) {
            ...
            if (!(_3_extractedKeyProviderId).equals(dafny.DafnySequence.asString("aws-kms-hierarchy"))) {
              dafny.DafnySequence<? extends software.amazon.cryptography.materialproviders.internaldafny.types.EncryptedDataKey> _in0 = (encryptedDataKeys).drop(java.math.BigInteger.ONE);
              ...
              if ((_7_valueOrError2).IsFailure(dafny.DafnySequence.<java.lang.Byte>_typeDescriptor(BoundedInts_Compile.uint8._typeDescriptor()), software.amazon.cryptography.materialproviders.internaldafny.types.Error._typeDescriptor())) {
                ...
                java.math.BigInteger _9_EDK__CIPHERTEXT__BRANCH__KEY__VERSION__INDEX = (__default.SALT__LENGTH()).add(__default.IV__LENGTH());
                java.math.BigInteger _10_EDK__CIPHERTEXT__VERSION__INDEX = (_9_EDK__CIPHERTEXT__BRANCH__KEY__VERSION__INDEX).add(__default.VERSION__LENGTH());
                Wrappers_Compile.Outcome<software.amazon.cryptography.materialproviders.internaldafny.types.Error> _11_valueOrError3 = Wrappers_Compile.__default.<software.amazon.cryptography.materialproviders.internaldafny.types.Error>Need(software.amazon.cryptography.materialproviders.internaldafny.types.Error._typeDescriptor(), (_9_EDK__CIPHERTEXT__BRANCH__KEY__VERSION__INDEX).compareTo(_10_EDK__CIPHERTEXT__VERSION__INDEX) < 0, software.amazon.cryptography.materialproviders.internaldafny.types.Error.create_AwsCryptographicMaterialProvidersException(dafny.DafnySequence.asString("Wrong branch key version index.")));
                if ((_11_valueOrError3).IsFailure(software.amazon.cryptography.materialproviders.internaldafny.types.Error._typeDescriptor())) {
                  ...
                  Wrappers_Compile.Outcome<software.amazon.cryptography.materialproviders.internaldafny.types.Error> _12_valueOrError4 = Wrappers_Compile.__default.<software.amazon.cryptography.materialproviders.internaldafny.types.Error>Need(software.amazon.cryptography.materialproviders.internaldafny.types.Error._typeDescriptor(), (java.math.BigInteger.valueOf((_8_providerWrappedMaterial).length())).compareTo(_10_EDK__CIPHERTEXT__VERSION__INDEX) >= 0, software.amazon.cryptography.materialproviders.internaldafny.types.Error.create_AwsCryptographicMaterialProvidersException(dafny.DafnySequence.asString("Incorrect ciphertext structure.")));
                  if ((_12_valueOrError4).IsFailure(software.amazon.cryptography.materialproviders.internaldafny.types.Error._typeDescriptor())) {
                    ...
                    dafny.DafnySequence<? extends java.lang.Byte> _13_branchKeyVersionUuid = (_8_providerWrappedMaterial).subsequence(dafny.Helpers.toInt((_9_EDK__CIPHERTEXT__BRANCH__KEY__VERSION__INDEX)), dafny.Helpers.toInt((_10_EDK__CIPHERTEXT__VERSION__INDEX)));
                    ...
                    if ((_14_valueOrError5).IsFailure(dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR), software.amazon.cryptography.materialproviders.internaldafny.types.Error._typeDescriptor())) {
                      ...
                      dafny.DafnySequence<? extends software.amazon.cryptography.materialproviders.internaldafny.types.EncryptedDataKey> _in3 = (encryptedDataKeys).drop(java.math.BigInteger.ONE);
  ...
  public static java.math.BigInteger SALT__LENGTH()
  {
    return java.math.BigInteger.valueOf(16L);
  }
  public static java.math.BigInteger IV__LENGTH()
  {
    return java.math.BigInteger.valueOf(12L);
  }
  public static java.math.BigInteger VERSION__LENGTH()
  {
    return java.math.BigInteger.valueOf(16L);
  }
