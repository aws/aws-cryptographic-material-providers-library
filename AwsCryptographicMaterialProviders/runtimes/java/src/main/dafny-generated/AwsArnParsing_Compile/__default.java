...
public class __default {
  ...
  public static Wrappers_Compile.Result<AwsResource, dafny.DafnySequence<? extends Character>> ParseAwsKmsResources(dafny.DafnySequence<? extends Character> identifier) {
    dafny.DafnySequence<? extends dafny.DafnySequence<? extends Character>> _0_info = StandardLibrary_Compile.__default.<Character>Split(dafny.TypeDescriptor.CHAR, identifier, '/');
    Wrappers_Compile.Outcome<dafny.DafnySequence<? extends Character>> _1_valueOrError0 = Wrappers_Compile.__default.<dafny.DafnySequence<? extends Character>>Need(dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR), (java.math.BigInteger.valueOf((_0_info).length())).compareTo(java.math.BigInteger.ONE) > 0, dafny.DafnySequence.<Character>concatenate(dafny.DafnySequence.asString("Malformed resource: "), identifier));
    if ((_1_valueOrError0).IsFailure(dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR))) {
      ...
      dafny.DafnySequence<? extends Character> _2_resourceType = ((dafny.DafnySequence<? extends Character>)(java.lang.Object)((_0_info).select(dafny.Helpers.toInt((java.math.BigInteger.ZERO)))));
      dafny.DafnySequence<? extends Character> _3_value = StandardLibrary_Compile.__default.<Character>Join(dafny.TypeDescriptor.CHAR, (_0_info).drop(java.math.BigInteger.ONE), dafny.DafnySequence.asString("/"));
  ...
  public static Wrappers_Compile.Result<AwsArn, dafny.DafnySequence<? extends Character>> ParseAwsKmsArn(dafny.DafnySequence<? extends Character> identifier) {
    ...
    Wrappers_Compile.Outcome<dafny.DafnySequence<? extends Character>> _1_valueOrError0 = Wrappers_Compile.__default.<dafny.DafnySequence<? extends Character>>Need(dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR), java.util.Objects.equals(java.math.BigInteger.valueOf(6L), java.math.BigInteger.valueOf((_0_components).length())), dafny.DafnySequence.<Character>concatenate(dafny.DafnySequence.asString("Malformed arn: "), identifier));
    if ((_1_valueOrError0).IsFailure(dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR))) {
      ...
      Wrappers_Compile.Result<AwsResource, dafny.DafnySequence<? extends Character>> _2_valueOrError1 = __default.ParseAwsKmsResources(((dafny.DafnySequence<? extends Character>)(java.lang.Object)((_0_components).select(dafny.Helpers.toInt((java.math.BigInteger.valueOf(5L)))))));
      if ((_2_valueOrError1).IsFailure(AwsKmsResource._typeDescriptor(), dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR))) {
        ...
        AwsArn _4_arn = AwsArnParsing_Compile.AwsArn.create(((dafny.DafnySequence<? extends Character>)(java.lang.Object)((_0_components).select(dafny.Helpers.toInt((java.math.BigInteger.ZERO))))), ((dafny.DafnySequence<? extends Character>)(java.lang.Object)((_0_components).select(dafny.Helpers.toInt((java.math.BigInteger.ONE))))), ((dafny.DafnySequence<? extends Character>)(java.lang.Object)((_0_components).select(dafny.Helpers.toInt((java.math.BigInteger.valueOf(2L)))))), ((dafny.DafnySequence<? extends Character>)(java.lang.Object)((_0_components).select(dafny.Helpers.toInt((java.math.BigInteger.valueOf(3L)))))), ((dafny.DafnySequence<? extends Character>)(java.lang.Object)((_0_components).select(dafny.Helpers.toInt((java.math.BigInteger.valueOf(4L)))))), _3_resource);
  ...
  public static Wrappers_Compile.Result<AwsArn, dafny.DafnySequence<? extends Character>> ParseAmazonDynamodbTableArn(dafny.DafnySequence<? extends Character> identifier) {
    ...
    if ((_1_valueOrError0).IsFailure(dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR))) {
      ...
      Wrappers_Compile.Result<AwsResource, dafny.DafnySequence<? extends Character>> _2_valueOrError1 = __default.ParseAmazonDynamodbResources(((dafny.DafnySequence<? extends Character>)(java.lang.Object)((_0_components).select(dafny.Helpers.toInt((java.math.BigInteger.valueOf(5L)))))));
  ...
  public static Wrappers_Compile.Result<AwsKmsIdentifier, dafny.DafnySequence<? extends Character>> ParseAwsKmsIdentifier(dafny.DafnySequence<? extends Character> identifier) {
    if ((dafny.DafnySequence.asString("arn:")).isPrefixOf(identifier)) {
      ...
      if ((_0_valueOrError0).IsFailure(AwsKmsArn._typeDescriptor(), dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR))) {
        ...
        return Wrappers_Compile.Result.<AwsKmsIdentifier, dafny.DafnySequence<? extends Character>>create_Success(AwsKmsIdentifier._typeDescriptor(), dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR), AwsArnParsing_Compile.AwsKmsIdentifier.create_AwsKmsArnIdentifier(_1_arn));
      }
    } else {
      ...
      if ((_2_valueOrError1).IsFailure(AwsKmsResource._typeDescriptor(), dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR))) {
        ...
        return Wrappers_Compile.Result.<AwsKmsIdentifier, dafny.DafnySequence<? extends Character>>create_Success(AwsKmsIdentifier._typeDescriptor(), dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR), AwsArnParsing_Compile.AwsKmsIdentifier.create_AwsKmsRawResourceIdentifier(_3_r));
      }
    }
  }
  ...
  public static Wrappers_Compile.Result<AwsKmsIdentifier, dafny.DafnySequence<? extends Character>> IsAwsKmsIdentifierString(dafny.DafnySequence<? extends Character> s) {
    ...
    if ((_0_valueOrError0).IsFailure(dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR))) {
      ...
      Wrappers_Compile.Outcome<dafny.DafnySequence<? extends Character>> _1_valueOrError1 = Wrappers_Compile.__default.<dafny.DafnySequence<? extends Character>>Need(dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR), ((java.math.BigInteger.valueOf((s).length())).signum() == 1) && ((java.math.BigInteger.valueOf((s).length())).compareTo(__default.MAX__AWS__KMS__IDENTIFIER__LENGTH()) <= 0), dafny.DafnySequence.asString("Identifier exceeds maximum length."));
