...
public class AwsArn {
  ...
  private static final AwsArn theDefault = AwsArn.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR), dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR), dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR), dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR), dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR), AwsResource.Default());
  ...
  public boolean Valid() {
    return (((((((this).dtor_arnLiteral()).equals(dafny.DafnySequence.asString("arn"))) && ((((long) ((this).dtor_partition()).cardinalityInt()) == 0 ? 0 : 1) == 1)) && ((((long) ((this).dtor_service()).cardinalityInt()) == 0 ? 0 : 1) == 1)) && ((((long) ((this).dtor_region()).cardinalityInt()) == 0 ? 0 : 1) == 1)) && ((((long) ((this).dtor_account()).cardinalityInt()) == 0 ? 0 : 1) == 1)) && (((this).dtor_resource()).Valid());
  }
