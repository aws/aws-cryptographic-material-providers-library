...
public class AwsResource {
  ...
  private static final AwsResource theDefault = AwsResource.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR), dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR));
  ...
  public boolean Valid() {
    return (true) && ((((long) ((this).dtor_value()).cardinalityInt()) == 0 ? 0 : 1) == 1);
  }
