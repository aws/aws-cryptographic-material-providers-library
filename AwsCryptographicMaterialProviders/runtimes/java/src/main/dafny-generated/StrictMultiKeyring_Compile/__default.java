...
public class __default {
  ...
  public static Wrappers_Compile.Result<MultiKeyring_Compile.MultiKeyring, software.amazon.cryptography.materialproviders.internaldafny.types.Error> StrictMultiKeyring(Wrappers_Compile.Option<dafny.DafnySequence<? extends Character>> generator, Wrappers_Compile.Option<dafny.DafnySequence<? extends dafny.DafnySequence<? extends Character>>> awsKmsKeys, software.amazon.cryptography.materialproviders.internaldafny.types.IClientSupplier clientSupplier, Wrappers_Compile.Option<dafny.DafnySequence<? extends dafny.DafnySequence<? extends Character>>> grantTokens)
  {
    ...
    if (_source2.is_None()) {
      ...
      java.math.BigInteger _hi0 = java.math.BigInteger.valueOf((_16_childIdentifiers).length());
      for (java.math.BigInteger _17_index = java.math.BigInteger.ZERO; _17_index.compareTo(_hi0) < 0; _17_index = _17_index.add(java.math.BigInteger.ONE)) {
        dafny.DafnySequence<? extends Character> _18_childIdentifier;
        _18_childIdentifier = ((dafny.DafnySequence<? extends Character>)(java.lang.Object)((_16_childIdentifiers).select(dafny.Helpers.toInt((_17_index)))));
    ...
    _25_valueOrError5 = Wrappers_Compile.__default.<software.amazon.cryptography.materialproviders.internaldafny.types.Error>Need(software.amazon.cryptography.materialproviders.internaldafny.types.Error._typeDescriptor(), ((_5_generatorKeyring).is_Some()) || ((java.math.BigInteger.valueOf((_14_children).length())).signum() == 1), software.amazon.cryptography.materialproviders.internaldafny.types.Error.create_AwsCryptographicMaterialProvidersException(dafny.DafnySequence.asString("generatorKeyring or child Keryings needed to create a multi keyring")));
