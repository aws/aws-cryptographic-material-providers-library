...
public class __default {
  ...
  public static Wrappers_Compile.Result<MultiKeyring_Compile.MultiKeyring, software.amazon.cryptography.materialproviders.internaldafny.types.Error> MrkAwareStrictMultiKeyring(Wrappers_Compile.Option<dafny.DafnySequence<? extends Character>> generator, Wrappers_Compile.Option<dafny.DafnySequence<? extends dafny.DafnySequence<? extends Character>>> awsKmsKeys, software.amazon.cryptography.materialproviders.internaldafny.types.IClientSupplier clientSupplier, Wrappers_Compile.Option<dafny.DafnySequence<? extends dafny.DafnySequence<? extends Character>>> grantTokens)
  {
    ...
    if (_source2.is_None()) {
      ...
      long _hi0 = (long) (_17_childIdentifiers).cardinalityInt();
      for (long _18_index = (long) 0L; java.lang.Long.compareUnsigned(_18_index, _hi0) < 0; _18_index++) {
        dafny.DafnySequence<? extends Character> _19_childIdentifier;
        _19_childIdentifier = ((dafny.DafnySequence<? extends Character>)(java.lang.Object)((_17_childIdentifiers).select(dafny.Helpers.unsignedToInt(_18_index))));
    ...
    _26_valueOrError6 = Wrappers_Compile.__default.<software.amazon.cryptography.materialproviders.internaldafny.types.Error>Need(software.amazon.cryptography.materialproviders.internaldafny.types.Error._typeDescriptor(), ((_6_generatorKeyring).is_Some()) || ((((long) (_15_children).cardinalityInt()) == 0 ? 0 : 1) == 1), software.amazon.cryptography.materialproviders.internaldafny.types.Error.create_AwsCryptographicMaterialProvidersException(dafny.DafnySequence.asString("generatorKeyring or child Keyrings needed to create a multi keyring")));
