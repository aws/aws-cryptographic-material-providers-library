...
public class __default {
  ...
  public static Wrappers_Compile.Result<software.amazon.cryptography.materialproviders.internaldafny.types.IKeyring, software.amazon.cryptography.materialproviders.internaldafny.types.Error> CreateMultiKeyring(Config config, software.amazon.cryptography.materialproviders.internaldafny.types.CreateMultiKeyringInput input)
  {
    ...
    _0_valueOrError0 = Wrappers_Compile.__default.<software.amazon.cryptography.materialproviders.internaldafny.types.Error>Need(software.amazon.cryptography.materialproviders.internaldafny.types.Error._typeDescriptor(), (((input).dtor_generator()).is_Some()) || ((java.math.BigInteger.valueOf(((input).dtor_childKeyrings()).length())).signum() == 1), software.amazon.cryptography.materialproviders.internaldafny.types.Error.create_AwsCryptographicMaterialProvidersException(dafny.DafnySequence.asString("Must include a generator keyring and/or at least one child keyring")));
  ...
  public static Wrappers_Compile.Result<software.amazon.cryptography.materialproviders.internaldafny.types.IKeyring, software.amazon.cryptography.materialproviders.internaldafny.types.Error> CreateRawAesKeyring(Config config, software.amazon.cryptography.materialproviders.internaldafny.types.CreateRawAesKeyringInput input)
  {
    ...
    _6_valueOrError2 = Wrappers_Compile.__default.<software.amazon.cryptography.materialproviders.internaldafny.types.Error>Need(software.amazon.cryptography.materialproviders.internaldafny.types.Error._typeDescriptor(), ((java.util.Objects.equals(java.math.BigInteger.valueOf(((input).dtor_wrappingKey()).length()), java.math.BigInteger.valueOf(16L))) || (java.util.Objects.equals(java.math.BigInteger.valueOf(((input).dtor_wrappingKey()).length()), java.math.BigInteger.valueOf(24L)))) || (java.util.Objects.equals(java.math.BigInteger.valueOf(((input).dtor_wrappingKey()).length()), java.math.BigInteger.valueOf(32L))), software.amazon.cryptography.materialproviders.internaldafny.types.Error.create_AwsCryptographicMaterialProvidersException(dafny.DafnySequence.asString("Invalid wrapping key length")));
    if ((_6_valueOrError2).IsFailure(software.amazon.cryptography.materialproviders.internaldafny.types.Error._typeDescriptor())) {
      output = (_6_valueOrError2).<software.amazon.cryptography.materialproviders.internaldafny.types.IKeyring>PropagateFailure(software.amazon.cryptography.materialproviders.internaldafny.types.Error._typeDescriptor(), ((dafny.TypeDescriptor<software.amazon.cryptography.materialproviders.internaldafny.types.IKeyring>)(java.lang.Object)dafny.TypeDescriptor.reference(software.amazon.cryptography.materialproviders.internaldafny.types.IKeyring.class)));
      return output;
    }
    ...
    _7_valueOrError3 = Wrappers_Compile.__default.<software.amazon.cryptography.materialproviders.internaldafny.types.Error>Need(software.amazon.cryptography.materialproviders.internaldafny.types.Error._typeDescriptor(), java.util.Objects.equals(java.math.BigInteger.valueOf(((input).dtor_wrappingKey()).length()), java.math.BigInteger.valueOf((_1_wrappingAlg).dtor_keyLength())), software.amazon.cryptography.materialproviders.internaldafny.types.Error.create_AwsCryptographicMaterialProvidersException(dafny.DafnySequence.asString("Wrapping key length does not match specified wrapping algorithm")));
    if ((_7_valueOrError3).IsFailure(software.amazon.cryptography.materialproviders.internaldafny.types.Error._typeDescriptor())) {
      output = (_7_valueOrError3).<software.amazon.cryptography.materialproviders.internaldafny.types.IKeyring>PropagateFailure(software.amazon.cryptography.materialproviders.internaldafny.types.Error._typeDescriptor(), ((dafny.TypeDescriptor<software.amazon.cryptography.materialproviders.internaldafny.types.IKeyring>)(java.lang.Object)dafny.TypeDescriptor.reference(software.amazon.cryptography.materialproviders.internaldafny.types.IKeyring.class)));
      return output;
    }
    RawAESKeyring_Compile.RawAESKeyring _8_keyring;
  ...
  public static Wrappers_Compile.Result<software.amazon.cryptography.materialproviders.internaldafny.types.ICryptographicMaterialsCache, software.amazon.cryptography.materialproviders.internaldafny.types.Error> CreateCryptographicMaterialsCache(Config config, software.amazon.cryptography.materialproviders.internaldafny.types.CreateCryptographicMaterialsCacheInput input)
  {
    ...
    if(true) {
      ...
      if (_source0.is_Default()) {
        ...
        _nw2.__ctor(java.math.BigInteger.ZERO, java.math.BigInteger.ONE);
        _9_cmc = _nw2;
        ...
        _nw3.__ctor(java.math.BigInteger.valueOf((_11_c).dtor_entryCapacity()), java.math.BigInteger.valueOf((__default.OptionalCountingNumber((_11_c).dtor_entryPruningTailSize())).UnwrapOr(software.amazon.cryptography.materialproviders.internaldafny.types.CountingNumber._typeDescriptor(), 1)));
        _12_cmc = _nw3;
        ...
        _nw4.__ctor(java.math.BigInteger.valueOf((_14_c).dtor_entryCapacity()), java.math.BigInteger.valueOf((__default.OptionalCountingNumber((_14_c).dtor_entryPruningTailSize())).UnwrapOr(software.amazon.cryptography.materialproviders.internaldafny.types.CountingNumber._typeDescriptor(), 1)));
        _15_cmc = _nw4;
