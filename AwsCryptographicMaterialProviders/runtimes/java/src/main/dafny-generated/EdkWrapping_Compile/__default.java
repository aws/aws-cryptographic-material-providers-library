  ...
  public static <__T> Wrappers_Compile.Result<WrapEdkMaterialOutput<__T>, software.amazon.cryptography.materialproviders.internaldafny.types.Error> WrapEdkMaterial(dafny.TypeDescriptor<__T> _td___T, software.amazon.cryptography.materialproviders.internaldafny.types.EncryptionMaterials encryptionMaterials, MaterialWrapping_Compile.WrapMaterial<__T> wrap, MaterialWrapping_Compile.GenerateAndWrapMaterial<__T> generateAndWrap)
  {
    ...
    if(true) {
      ...
      if ((((encryptionMaterials).dtor_plaintextDataKey()).is_Some()) && ((((encryptionMaterials).dtor_algorithmSuite()).dtor_edkWrapping()).is_DIRECT__KEY__WRAPPING())) {
        ...
        _out0 = (wrap).Invoke(MaterialWrapping_Compile.WrapInput.create(((encryptionMaterials).dtor_plaintextDataKey()).dtor_value(), (encryptionMaterials).dtor_algorithmSuite(), (encryptionMaterials).dtor_encryptionContext(), CanonicalEncryptionContext_Compile.__default.EncryptionContextToAAD((encryptionMaterials).dtor_encryptionContext())));
        ...
        _out2 = (generateAndWrap).Invoke(MaterialWrapping_Compile.GenerateAndWrapInput.create((encryptionMaterials).dtor_algorithmSuite(), (encryptionMaterials).dtor_encryptionContext(), CanonicalEncryptionContext_Compile.__default.EncryptionContextToAAD((encryptionMaterials).dtor_encryptionContext())));
        ...
        ret = Wrappers_Compile.Result.<WrapEdkMaterialOutput<__T>, software.amazon.cryptography.materialproviders.internaldafny.types.Error>create_Success(WrapEdkMaterialOutput.<__T>_typeDescriptor(_td___T), software.amazon.cryptography.materialproviders.internaldafny.types.Error._typeDescriptor(), WrapEdkMaterialOutput.<__T>create_GenerateAndWrapEdkMaterialOutput(_td___T, (_6_directOutput).dtor_plaintextMaterial(), (_6_directOutput).dtor_wrappedMaterial(), Wrappers_Compile.Option.<dafny.DafnySequence<? extends java.lang.Byte>>create_None(dafny.DafnySequence.<java.lang.Byte>_typeDescriptor(BoundedInts_Compile.uint8._typeDescriptor())), (_6_directOutput).dtor_wrapInfo()));
        return ret;
        ...
        ret = Wrappers_Compile.Result.<WrapEdkMaterialOutput<__T>, software.amazon.cryptography.materialproviders.internaldafny.types.Error>create_Success(WrapEdkMaterialOutput.<__T>_typeDescriptor(_td___T), software.amazon.cryptography.materialproviders.internaldafny.types.Error._typeDescriptor(), WrapEdkMaterialOutput.<__T>create_GenerateAndWrapEdkMaterialOutput(_td___T, (_9_intermediateOutput).dtor_plaintextDataKey(), (_9_intermediateOutput).dtor_wrappedMaterial(), Wrappers_Compile.Option.<dafny.DafnySequence<? extends java.lang.Byte>>create_Some(dafny.DafnySequence.<java.lang.Byte>_typeDescriptor(BoundedInts_Compile.uint8._typeDescriptor()), (_9_intermediateOutput).dtor_symmetricSigningKey()), (_9_intermediateOutput).dtor_wrapInfo()));
        return ret;
      } else {
      }
    }
  ...
  public static <__T> Wrappers_Compile.Result<UnwrapEdkMaterialOutput<__T>, software.amazon.cryptography.materialproviders.internaldafny.types.Error> UnwrapEdkMaterial(dafny.TypeDescriptor<__T> _td___T, dafny.DafnySequence<? extends java.lang.Byte> wrappedMaterial, software.amazon.cryptography.materialproviders.internaldafny.types.DecryptionMaterials decryptionMaterials, MaterialWrapping_Compile.UnwrapMaterial<__T> unwrap)
  {
    ...
    if(true) {
      ...
      if ((((decryptionMaterials).dtor_algorithmSuite()).dtor_edkWrapping()).is_DIRECT__KEY__WRAPPING()) {
        ...
        _out0 = (unwrap).Invoke(MaterialWrapping_Compile.UnwrapInput.create(wrappedMaterial, (decryptionMaterials).dtor_algorithmSuite(), (decryptionMaterials).dtor_encryptionContext(), CanonicalEncryptionContext_Compile.__default.EncryptionContextToAAD((decryptionMaterials).dtor_encryptionContext())));
        _1_valueOrError1 = _out0;
        ...
        ret = Wrappers_Compile.Result.<UnwrapEdkMaterialOutput<__T>, software.amazon.cryptography.materialproviders.internaldafny.types.Error>create_Success(UnwrapEdkMaterialOutput.<__T>_typeDescriptor(_td___T), software.amazon.cryptography.materialproviders.internaldafny.types.Error._typeDescriptor(), UnwrapEdkMaterialOutput.<__T>create(_td___T, (_2_directOutput).dtor_unwrappedMaterial(), Wrappers_Compile.Option.<dafny.DafnySequence<? extends java.lang.Byte>>create_None(dafny.DafnySequence.<java.lang.Byte>_typeDescriptor(BoundedInts_Compile.uint8._typeDescriptor())), (_2_directOutput).dtor_unwrapInfo()));
        return ret;
        ...
        ret = Wrappers_Compile.Result.<UnwrapEdkMaterialOutput<__T>, software.amazon.cryptography.materialproviders.internaldafny.types.Error>create_Success(UnwrapEdkMaterialOutput.<__T>_typeDescriptor(_td___T), software.amazon.cryptography.materialproviders.internaldafny.types.Error._typeDescriptor(), UnwrapEdkMaterialOutput.<__T>create(_td___T, (_5_intermediateOutput).dtor_plaintextDataKey(), Wrappers_Compile.Option.<dafny.DafnySequence<? extends java.lang.Byte>>create_Some(dafny.DafnySequence.<java.lang.Byte>_typeDescriptor(BoundedInts_Compile.uint8._typeDescriptor()), (_5_intermediateOutput).dtor_symmetricSigningKey()), (_5_intermediateOutput).dtor_unwrapInfo()));
        return ret;
      } else {
      }
    }
