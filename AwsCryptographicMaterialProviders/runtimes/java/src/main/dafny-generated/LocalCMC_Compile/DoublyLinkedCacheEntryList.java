...
public class DoublyLinkedCacheEntryList {
  ...
  public void __ctor()
  {
    (this).head = LocalCMC_Compile.Ref.<CacheEntry>create_Null(((dafny.TypeDescriptor<CacheEntry>)(java.lang.Object)dafny.TypeDescriptor.reference(CacheEntry.class)));
    (this).tail = LocalCMC_Compile.Ref.<CacheEntry>create_Null(((dafny.TypeDescriptor<CacheEntry>)(java.lang.Object)dafny.TypeDescriptor.reference(CacheEntry.class)));
  }
  ...
  public void pushCell(CacheEntry toPush)
  {
    ...
    _0_cRef = LocalCMC_Compile.Ref.<CacheEntry>create_Ptr(((dafny.TypeDescriptor<CacheEntry>)(java.lang.Object)dafny.TypeDescriptor.reference(CacheEntry.class)), toPush);
    if ((this.head).is_Ptr()) {
  ...
  public void moveToFront(CacheEntry c)
  {
    if (((this.head).dtor_deref()) != (Object)  (c)) {
      ...
      _0_toPush = LocalCMC_Compile.Ref.<CacheEntry>create_Ptr(((dafny.TypeDescriptor<CacheEntry>)(java.lang.Object)dafny.TypeDescriptor.reference(CacheEntry.class)), c);
      (this).remove(c);
      if ((this.head).is_Ptr()) {
        CacheEntry _obj0 = (this.head).dtor_deref();
