...
public class StormTracker {
  ...
  public void __ctor(software.amazon.cryptography.materialproviders.internaldafny.types.StormTrackingCache cache)
  {
    ...
    _nw0.__ctor(java.math.BigInteger.valueOf((cache).dtor_entryCapacity()), java.math.BigInteger.valueOf(((cache).dtor_entryPruningTailSize()).UnwrapOr(software.amazon.cryptography.materialproviders.internaldafny.types.CountingNumber._typeDescriptor(), 1)));
    (this).wrapped = _nw0;
  ...
  public void PruneInFlight(long now)
  {
    ...
    _1_keys = _out0;
    java.math.BigInteger _hi0 = java.math.BigInteger.valueOf((_1_keys).length());
    for (java.math.BigInteger _2_i = java.math.BigInteger.ZERO; _2_i.compareTo(_hi0) < 0; _2_i = _2_i.add(java.math.BigInteger.ONE)) {
      long _3_v;
      _3_v = (this.inFlight).Select(((dafny.DafnySequence<? extends java.lang.Byte>)(java.lang.Object)((_1_keys).select(dafny.Helpers.toInt((_2_i))))));
      if ((now) >= ((this).AddLong(_3_v, this.inFlightTTL))) {
        (this.inFlight).Remove(((dafny.DafnySequence<? extends java.lang.Byte>)(java.lang.Object)((_1_keys).select(dafny.Helpers.toInt((_2_i))))));
      }
    }
  }
