...
public class DecryptMaterialsOutput {
  ...
  private static final DecryptMaterialsOutput theDefault = software.amazon.cryptography.materialproviders.internaldafny.types.DecryptMaterialsOutput.create(DecryptionMaterials.Default());
