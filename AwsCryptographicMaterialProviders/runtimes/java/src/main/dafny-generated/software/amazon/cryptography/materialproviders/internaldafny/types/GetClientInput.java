...
public class GetClientInput {
  ...
  private static final GetClientInput theDefault = software.amazon.cryptography.materialproviders.internaldafny.types.GetClientInput.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR));
