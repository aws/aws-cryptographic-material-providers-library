...
public class EncryptedDataKey {
  ...
  private static final EncryptedDataKey theDefault = software.amazon.cryptography.materialproviders.internaldafny.types.EncryptedDataKey.create(UTF8.ValidUTF8Bytes.defaultValue(), dafny.DafnySequence.<java.lang.Byte> empty(BoundedInts_Compile.uint8._typeDescriptor()), dafny.DafnySequence.<java.lang.Byte> empty(BoundedInts_Compile.uint8._typeDescriptor()));
