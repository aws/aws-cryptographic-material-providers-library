...
public class PutCacheEntryInput {
  ...
  private static final PutCacheEntryInput theDefault = software.amazon.cryptography.materialproviders.internaldafny.types.PutCacheEntryInput.create(dafny.DafnySequence.<java.lang.Byte> empty(BoundedInts_Compile.uint8._typeDescriptor()), Materials.Default(), 0L, 0L, Wrappers_Compile.Option.<java.lang.Integer>Default(PositiveInteger._typeDescriptor()), Wrappers_Compile.Option.<java.lang.Integer>Default(PositiveInteger._typeDescriptor()));
