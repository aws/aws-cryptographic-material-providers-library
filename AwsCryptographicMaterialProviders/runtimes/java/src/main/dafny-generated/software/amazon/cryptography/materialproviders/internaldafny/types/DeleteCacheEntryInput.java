...
public class DeleteCacheEntryInput {
  ...
  private static final DeleteCacheEntryInput theDefault = DeleteCacheEntryInput.create(dafny.DafnySequence.<java.lang.Byte> empty(BoundedInts_Compile.uint8._typeDescriptor()));
