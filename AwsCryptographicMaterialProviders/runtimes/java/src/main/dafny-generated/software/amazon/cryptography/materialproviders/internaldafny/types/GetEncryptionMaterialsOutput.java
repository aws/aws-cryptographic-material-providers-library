...
public class GetEncryptionMaterialsOutput {
  ...
  private static final GetEncryptionMaterialsOutput theDefault = software.amazon.cryptography.materialproviders.internaldafny.types.GetEncryptionMaterialsOutput.create(EncryptionMaterials.Default());
