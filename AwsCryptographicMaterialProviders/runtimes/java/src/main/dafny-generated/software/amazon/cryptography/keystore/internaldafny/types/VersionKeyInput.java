...
public class VersionKeyInput {
  ...
  private static final VersionKeyInput theDefault = software.amazon.cryptography.keystore.internaldafny.types.VersionKeyInput.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR));
