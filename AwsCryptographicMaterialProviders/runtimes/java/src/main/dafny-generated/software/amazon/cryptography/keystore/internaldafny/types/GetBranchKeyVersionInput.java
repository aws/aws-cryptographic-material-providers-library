...
public class GetBranchKeyVersionInput {
  ...
  private static final GetBranchKeyVersionInput theDefault = GetBranchKeyVersionInput.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR), dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR));
