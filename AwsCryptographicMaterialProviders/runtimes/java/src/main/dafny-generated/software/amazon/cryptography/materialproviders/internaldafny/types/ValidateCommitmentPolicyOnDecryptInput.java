...
public class ValidateCommitmentPolicyOnDecryptInput {
  ...
  private static final ValidateCommitmentPolicyOnDecryptInput theDefault = software.amazon.cryptography.materialproviders.internaldafny.types.ValidateCommitmentPolicyOnDecryptInput.create(AlgorithmSuiteId.Default(), CommitmentPolicy.Default());
