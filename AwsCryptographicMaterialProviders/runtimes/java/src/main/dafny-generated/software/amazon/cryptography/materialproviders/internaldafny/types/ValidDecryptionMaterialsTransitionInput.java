...
public class ValidDecryptionMaterialsTransitionInput {
  ...
  private static final ValidDecryptionMaterialsTransitionInput theDefault = ValidDecryptionMaterialsTransitionInput.create(DecryptionMaterials.Default(), DecryptionMaterials.Default());
