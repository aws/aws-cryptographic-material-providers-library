...
public class DiscoveryFilter {
  ...
  private static final DiscoveryFilter theDefault = DiscoveryFilter.create(dafny.DafnySequence.<dafny.DafnySequence<? extends Character>> empty(dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR)), dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR));
