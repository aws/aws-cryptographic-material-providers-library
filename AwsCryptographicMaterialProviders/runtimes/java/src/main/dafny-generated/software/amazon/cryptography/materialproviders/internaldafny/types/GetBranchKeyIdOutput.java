...
public class GetBranchKeyIdOutput {
  ...
  private static final GetBranchKeyIdOutput theDefault = software.amazon.cryptography.materialproviders.internaldafny.types.GetBranchKeyIdOutput.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR));
