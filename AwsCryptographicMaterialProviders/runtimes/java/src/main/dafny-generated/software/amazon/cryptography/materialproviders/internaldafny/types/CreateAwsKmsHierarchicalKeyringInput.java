...
public class CreateAwsKmsHierarchicalKeyringInput {
  ...
  private static final CreateAwsKmsHierarchicalKeyringInput theDefault = software.amazon.cryptography.materialproviders.internaldafny.types.CreateAwsKmsHierarchicalKeyringInput.create(Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR)), Wrappers_Compile.Option.<IBranchKeyIdSupplier>Default(((dafny.TypeDescriptor<IBranchKeyIdSupplier>)(java.lang.Object)dafny.TypeDescriptor.reference(IBranchKeyIdSupplier.class))), null, 0L, Wrappers_Compile.Option.<CacheType>Default(CacheType._typeDescriptor()), Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR)));
