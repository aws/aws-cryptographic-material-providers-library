...
public class BranchKeyMaterials {
  ...
  private static final BranchKeyMaterials theDefault = software.amazon.cryptography.keystore.internaldafny.types.BranchKeyMaterials.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR), UTF8.ValidUTF8Bytes.defaultValue(), dafny.DafnyMap.<dafny.DafnySequence<? extends java.lang.Byte>,dafny.DafnySequence<? extends java.lang.Byte>> empty(), dafny.DafnySequence.<java.lang.Byte> empty(BoundedInts_Compile.uint8._typeDescriptor()));
