...
public class GetActiveBranchKeyInput {
  ...
  private static final GetActiveBranchKeyInput theDefault = software.amazon.cryptography.keystore.internaldafny.types.GetActiveBranchKeyInput.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR));
