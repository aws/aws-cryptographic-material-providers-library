...
public class ValidateCommitmentPolicyOnEncryptInput {
  ...
  private static final ValidateCommitmentPolicyOnEncryptInput theDefault = ValidateCommitmentPolicyOnEncryptInput.create(AlgorithmSuiteId.Default(), CommitmentPolicy.Default());
