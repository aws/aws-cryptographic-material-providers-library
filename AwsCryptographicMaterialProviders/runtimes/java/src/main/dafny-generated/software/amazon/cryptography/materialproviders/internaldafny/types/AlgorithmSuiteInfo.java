...
public class AlgorithmSuiteInfo {
  ...
  private static final AlgorithmSuiteInfo theDefault = software.amazon.cryptography.materialproviders.internaldafny.types.AlgorithmSuiteInfo.create(AlgorithmSuiteId.Default(), dafny.DafnySequence.<java.lang.Byte> empty(BoundedInts_Compile.uint8._typeDescriptor()), 0, Encrypt.Default(), DerivationAlgorithm.Default(), DerivationAlgorithm.Default(), SignatureAlgorithm.Default(), SymmetricSignatureAlgorithm.Default(), EdkWrappingAlgorithm.Default());
