...
public class UpdateUsageMetadataInput {
  ...
  private static final UpdateUsageMetadataInput theDefault = software.amazon.cryptography.materialproviders.internaldafny.types.UpdateUsageMetadataInput.create(dafny.DafnySequence.<java.lang.Byte> empty(BoundedInts_Compile.uint8._typeDescriptor()), 0);
