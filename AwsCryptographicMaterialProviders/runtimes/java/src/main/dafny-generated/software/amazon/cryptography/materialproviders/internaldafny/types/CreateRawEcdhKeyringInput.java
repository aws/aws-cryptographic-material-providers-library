...
public class CreateRawEcdhKeyringInput {
  ...
  private static final CreateRawEcdhKeyringInput theDefault = CreateRawEcdhKeyringInput.create(RawEcdhStaticConfigurations.Default(), software.amazon.cryptography.primitives.internaldafny.types.ECDHCurveSpec.Default());
