...
public abstract class Error {
  ...
  private static final Error theDefault = software.amazon.cryptography.keystore.internaldafny.types.Error.create_KeyStoreException(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR));
