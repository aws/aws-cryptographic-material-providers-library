...
public abstract class EdkWrappingAlgorithm {
  ...
  private static final EdkWrappingAlgorithm theDefault = software.amazon.cryptography.materialproviders.internaldafny.types.EdkWrappingAlgorithm.create_DIRECT__KEY__WRAPPING(DIRECT__KEY__WRAPPING.Default());
