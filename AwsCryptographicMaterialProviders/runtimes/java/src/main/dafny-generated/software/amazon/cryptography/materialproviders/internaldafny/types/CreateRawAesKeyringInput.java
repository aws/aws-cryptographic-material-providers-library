...
public class CreateRawAesKeyringInput {
  ...
  private static final CreateRawAesKeyringInput theDefault = CreateRawAesKeyringInput.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR), dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR), dafny.DafnySequence.<java.lang.Byte> empty(BoundedInts_Compile.uint8._typeDescriptor()), AesWrappingAlg.Default());
