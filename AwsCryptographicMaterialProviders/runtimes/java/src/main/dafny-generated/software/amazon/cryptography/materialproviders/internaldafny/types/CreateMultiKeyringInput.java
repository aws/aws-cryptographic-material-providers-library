...
public class CreateMultiKeyringInput {
  ...
  private static final CreateMultiKeyringInput theDefault = software.amazon.cryptography.materialproviders.internaldafny.types.CreateMultiKeyringInput.create(Wrappers_Compile.Option.<IKeyring>Default(((dafny.TypeDescriptor<IKeyring>)(java.lang.Object)dafny.TypeDescriptor.reference(IKeyring.class))), dafny.DafnySequence.<IKeyring> empty(((dafny.TypeDescriptor<IKeyring>)(java.lang.Object)dafny.TypeDescriptor.reference(IKeyring.class))));
