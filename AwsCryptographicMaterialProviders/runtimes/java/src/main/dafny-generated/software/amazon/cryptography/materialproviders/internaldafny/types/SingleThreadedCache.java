...
public class SingleThreadedCache {
  ...
  private static final SingleThreadedCache theDefault = SingleThreadedCache.create(0, Wrappers_Compile.Option.<java.lang.Integer>Default(CountingNumber._typeDescriptor()));
