...
public class MRDiscovery {
  ...
  private static final MRDiscovery theDefault = software.amazon.cryptography.keystore.internaldafny.types.MRDiscovery.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR));
