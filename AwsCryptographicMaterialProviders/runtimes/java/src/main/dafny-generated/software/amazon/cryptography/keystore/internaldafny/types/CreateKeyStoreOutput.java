...
public class CreateKeyStoreOutput {
  ...
  private static final CreateKeyStoreOutput theDefault = software.amazon.cryptography.keystore.internaldafny.types.CreateKeyStoreOutput.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR));
