...
public abstract class Error {
  ...
  private static final Error theDefault = Error.create_AwsCryptographicMaterialProvidersException(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR));
