...
public class EphemeralPrivateKeyToStaticPublicKeyInput {
  ...
  private static final EphemeralPrivateKeyToStaticPublicKeyInput theDefault = EphemeralPrivateKeyToStaticPublicKeyInput.create(dafny.DafnySequence.<java.lang.Byte> empty(BoundedInts_Compile.uint8._typeDescriptor()));
