...
public class CreateAwsKmsEcdhKeyringInput {
  ...
  private static final CreateAwsKmsEcdhKeyringInput theDefault = software.amazon.cryptography.materialproviders.internaldafny.types.CreateAwsKmsEcdhKeyringInput.create(KmsEcdhStaticConfigurations.Default(), software.amazon.cryptography.primitives.internaldafny.types.ECDHCurveSpec.Default(), null, Wrappers_Compile.Option.<dafny.DafnySequence<? extends dafny.DafnySequence<? extends Character>>>Default(dafny.DafnySequence.<dafny.DafnySequence<? extends Character>>_typeDescriptor(dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR))));
