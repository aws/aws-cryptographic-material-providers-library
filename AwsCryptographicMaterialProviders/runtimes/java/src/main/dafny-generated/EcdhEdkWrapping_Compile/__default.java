...
public class __default {
  ...
  {
    return dafny.DafnySequence.<java.lang.Byte>concatenate(dafny.DafnySequence.<java.lang.Byte>concatenate(dafny.DafnySequence.<java.lang.Byte>concatenate(dafny.DafnySequence.<java.lang.Byte>concatenate(dafny.DafnySequence.<java.lang.Byte>concatenate(dafny.DafnySequence.<java.lang.Byte>concatenate(dafny.DafnySequence.<java.lang.Byte>concatenate(dafny.DafnySequence.<java.lang.Byte>concatenate(dafny.DafnySequence.<java.lang.Byte>concatenate(dafny.DafnySequence.<java.lang.Byte>concatenate(dafny.DafnySequence.<java.lang.Byte>concatenate(ecdhKeyDerivationUtf8, Constants_Compile.__default.ECDH__KDF__DELIMITER()), curveSpecUtf8), Constants_Compile.__default.ECDH__KDF__DELIMITER()), Constants_Compile.__default.ECDH__KDF__PRF__NAME()), Constants_Compile.__default.ECDH__KDF__DELIMITER()), senderPublicKey), recipientPublicKey), Constants_Compile.__default.ECDH__KDF__DELIMITER()), keyringVersion), Constants_Compile.__default.ECDH__KDF__DELIMITER()), canonicalizedEC);
  }
