...
public class EcdhUnwrap implements MaterialWrapping_Compile.UnwrapMaterial<EcdhUnwrapInfo>, Actions_Compile.ActionWithResult<MaterialWrapping_Compile.UnwrapInput, MaterialWrapping_Compile.UnwrapOutput<EcdhUnwrapInfo>, software.amazon.cryptography.materialproviders.internaldafny.types.Error>, Actions_Compile.Action<MaterialWrapping_Compile.UnwrapInput, Wrappers_Compile.Result<MaterialWrapping_Compile.UnwrapOutput<EcdhUnwrapInfo>, software.amazon.cryptography.materialproviders.internaldafny.types.Error>> {
  ...
  public Wrappers_Compile.Result<MaterialWrapping_Compile.UnwrapOutput<EcdhUnwrapInfo>, software.amazon.cryptography.materialproviders.internaldafny.types.Error> Invoke(MaterialWrapping_Compile.UnwrapInput input)
  {
    ...
    _3_valueOrError0 = Wrappers_Compile.__default.<software.amazon.cryptography.materialproviders.internaldafny.types.Error>Need(software.amazon.cryptography.materialproviders.internaldafny.types.Error._typeDescriptor(), (java.math.BigInteger.valueOf((_1_wrappedMaterial).length())).compareTo(Constants_Compile.__default.CIPHERTEXT__WRAPPED__MATERIAL__INDEX()) > 0, __default.E(dafny.DafnySequence.asString("Recieved ciphertext is shorter than expected.")));
    ...
    java.math.BigInteger _4_KeyLength = java.math.BigInteger.ZERO;
    _4_KeyLength = java.math.BigInteger.valueOf(AlgorithmSuites_Compile.__default.GetEncryptKeyLength(_0_suite));
    ...
    _5_valueOrError1 = Wrappers_Compile.__default.<software.amazon.cryptography.materialproviders.internaldafny.types.Error>Need(software.amazon.cryptography.materialproviders.internaldafny.types.Error._typeDescriptor(), (java.math.BigInteger.valueOf((_1_wrappedMaterial).length())).compareTo((Constants_Compile.__default.ECDH__WRAPPED__KEY__MATERIAL__INDEX()).add(_4_KeyLength)) > 0, software.amazon.cryptography.materialproviders.internaldafny.types.Error.create_AwsCryptographicMaterialProvidersException(dafny.DafnySequence.asString("Received EDK Ciphertext of incorrect length.")));
    ...
    _6_kdfNonce = (_1_wrappedMaterial).subsequence(dafny.Helpers.toInt((java.math.BigInteger.ZERO)), dafny.Helpers.toInt((Constants_Compile.__default.ECDH__COMMITMENT__KEY__INDEX())));
    ...
    _9_commitmentKey = (_1_wrappedMaterial).subsequence(dafny.Helpers.toInt((Constants_Compile.__default.ECDH__COMMITMENT__KEY__INDEX())), dafny.Helpers.toInt((Constants_Compile.__default.ECDH__WRAPPED__KEY__MATERIAL__INDEX())));
    dafny.DafnySequence<? extends java.lang.Byte> _10_wrappedKey;
    _10_wrappedKey = (_1_wrappedMaterial).subsequence(dafny.Helpers.toInt((Constants_Compile.__default.ECDH__WRAPPED__KEY__MATERIAL__INDEX())), dafny.Helpers.toInt(((Constants_Compile.__default.ECDH__WRAPPED__KEY__MATERIAL__INDEX()).add(_4_KeyLength))));
    dafny.DafnySequence<? extends java.lang.Byte> _11_authTag;
    _11_authTag = (_1_wrappedMaterial).drop((Constants_Compile.__default.ECDH__WRAPPED__KEY__MATERIAL__INDEX()).add(_4_KeyLength));
    ...
    _19_calculatedCommitmentKey = (_18_derivedKeyingMaterial).subsequence(dafny.Helpers.toInt((java.math.BigInteger.ZERO)), dafny.Helpers.toInt((java.math.BigInteger.valueOf(32L))));
    dafny.DafnySequence<? extends java.lang.Byte> _20_sharedKeyingMaterial;
    _20_sharedKeyingMaterial = (_18_derivedKeyingMaterial).drop(java.math.BigInteger.valueOf(32L));
    ...
    _21_valueOrError5 = Wrappers_Compile.__default.<software.amazon.cryptography.materialproviders.internaldafny.types.Error>Need(software.amazon.cryptography.materialproviders.internaldafny.types.Error._typeDescriptor(), java.util.Objects.equals(java.math.BigInteger.valueOf((_19_calculatedCommitmentKey).length()), java.math.BigInteger.valueOf((_9_commitmentKey).length())), __default.E(dafny.DafnySequence.asString("Calculated commitment key length does NOT match expected commitment key length")));
    ...
    _28_valueOrError8 = Wrappers_Compile.__default.<software.amazon.cryptography.materialproviders.internaldafny.types.Error>Need(software.amazon.cryptography.materialproviders.internaldafny.types.Error._typeDescriptor(), java.util.Objects.equals(java.math.BigInteger.valueOf((_27_unwrappedPdk).length()), java.math.BigInteger.valueOf(AlgorithmSuites_Compile.__default.GetEncryptKeyLength((input).dtor_algorithmSuite()))), __default.E(dafny.DafnySequence.asString("Invalid Key Length")));
    ...
    _29_output = MaterialWrapping_Compile.UnwrapOutput.<EcdhUnwrapInfo>create(EcdhUnwrapInfo._typeDescriptor(), _27_unwrappedPdk, EcdhEdkWrapping_Compile.EcdhUnwrapInfo.create());
  ...
  public boolean commitmentKeyCheck(dafny.DafnySequence<? extends java.lang.Byte> calculatedCommitmentKey, dafny.DafnySequence<? extends java.lang.Byte> serializedCommitmentKey)
  {
    ...
    if(true) {
      byte _0_diff_q;
      _0_diff_q = (byte) 0;
      java.math.BigInteger _hi0 = java.math.BigInteger.valueOf((serializedCommitmentKey).length());
      for (java.math.BigInteger _1_i = java.math.BigInteger.ZERO; _1_i.compareTo(_hi0) < 0; _1_i = _1_i.add(java.math.BigInteger.ONE)) {
        _0_diff_q = (byte) (byte) ((byte)((_0_diff_q) | ((byte) (byte) ((byte)(((((byte)(java.lang.Object)((calculatedCommitmentKey).select(dafny.Helpers.toInt((_1_i))))))) ^ ((((byte)(java.lang.Object)((serializedCommitmentKey).select(dafny.Helpers.toInt((_1_i))))))))))));
      }
