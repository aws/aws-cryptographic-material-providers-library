...
public class DecryptSingleEncryptedDataKey implements Actions_Compile.ActionWithResult<software.amazon.cryptography.materialproviders.internaldafny.types.EncryptedDataKey, software.amazon.cryptography.materialproviders.internaldafny.types.DecryptionMaterials, software.amazon.cryptography.materialproviders.internaldafny.types.Error>, Actions_Compile.Action<software.amazon.cryptography.materialproviders.internaldafny.types.EncryptedDataKey, Wrappers_Compile.Result<software.amazon.cryptography.materialproviders.internaldafny.types.DecryptionMaterials, software.amazon.cryptography.materialproviders.internaldafny.types.Error>> {
  ...
  public Wrappers_Compile.Result<software.amazon.cryptography.materialproviders.internaldafny.types.DecryptionMaterials, software.amazon.cryptography.materialproviders.internaldafny.types.Error> Invoke(software.amazon.cryptography.materialproviders.internaldafny.types.EncryptedDataKey edk)
  {
    ...
    AwsKmsKeyring_Compile.KmsUnwrapKeyMaterial _0_kmsUnwrap;
    ...
    _0_kmsUnwrap = _nw0;
    Wrappers_Compile.Result<EdkWrapping_Compile.UnwrapEdkMaterialOutput<AwsKmsKeyring_Compile.KmsUnwrapInfo>, software.amazon.cryptography.materialproviders.internaldafny.types.Error> _1_unwrapOutputRes;
    ...
    _out0 = EdkWrapping_Compile.__default.<AwsKmsKeyring_Compile.KmsUnwrapInfo>UnwrapEdkMaterial(AwsKmsKeyring_Compile.KmsUnwrapInfo._typeDescriptor(), (edk).dtor_ciphertext(), (this).materials(), _0_kmsUnwrap);
    _1_unwrapOutputRes = _out0;
    Wrappers_Compile.Result<EdkWrapping_Compile.UnwrapEdkMaterialOutput<AwsKmsKeyring_Compile.KmsUnwrapInfo>, software.amazon.cryptography.materialproviders.internaldafny.types.Error> _2_valueOrError0 = Wrappers_Compile.Result.<EdkWrapping_Compile.UnwrapEdkMaterialOutput<AwsKmsKeyring_Compile.KmsUnwrapInfo>, software.amazon.cryptography.materialproviders.internaldafny.types.Error>Default(EdkWrapping_Compile.UnwrapEdkMaterialOutput.<AwsKmsKeyring_Compile.KmsUnwrapInfo>_typeDescriptor(AwsKmsKeyring_Compile.KmsUnwrapInfo._typeDescriptor()), software.amazon.cryptography.materialproviders.internaldafny.types.Error._typeDescriptor(), EdkWrapping_Compile.UnwrapEdkMaterialOutput.<AwsKmsKeyring_Compile.KmsUnwrapInfo>Default(AwsKmsKeyring_Compile.KmsUnwrapInfo._typeDescriptor(), AwsKmsKeyring_Compile.KmsUnwrapInfo.Default()));
    _2_valueOrError0 = _1_unwrapOutputRes;
    if ((_2_valueOrError0).IsFailure(EdkWrapping_Compile.UnwrapEdkMaterialOutput.<AwsKmsKeyring_Compile.KmsUnwrapInfo>_typeDescriptor(AwsKmsKeyring_Compile.KmsUnwrapInfo._typeDescriptor()), software.amazon.cryptography.materialproviders.internaldafny.types.Error._typeDescriptor())) {
      res = (_2_valueOrError0).<software.amazon.cryptography.materialproviders.internaldafny.types.DecryptionMaterials>PropagateFailure(EdkWrapping_Compile.UnwrapEdkMaterialOutput.<AwsKmsKeyring_Compile.KmsUnwrapInfo>_typeDescriptor(AwsKmsKeyring_Compile.KmsUnwrapInfo._typeDescriptor()), software.amazon.cryptography.materialproviders.internaldafny.types.Error._typeDescriptor(), Materials_Compile.SealedDecryptionMaterials._typeDescriptor());
      return res;
    }
    EdkWrapping_Compile.UnwrapEdkMaterialOutput<AwsKmsKeyring_Compile.KmsUnwrapInfo> _3_unwrapOutput;
    _3_unwrapOutput = (_2_valueOrError0).Extract(EdkWrapping_Compile.UnwrapEdkMaterialOutput.<AwsKmsKeyring_Compile.KmsUnwrapInfo>_typeDescriptor(AwsKmsKeyring_Compile.KmsUnwrapInfo._typeDescriptor()), software.amazon.cryptography.materialproviders.internaldafny.types.Error._typeDescriptor());
