...
// Dafny class AwsKmsMrkKeyring compiled into Java
package AwsKmsMrkKeyring_Compile;

@SuppressWarnings({"unchecked", "deprecation"})
public class AwsKmsMrkKeyring implements Keyring_Compile.VerifiableInterface, software.amazon.cryptography.materialproviders.internaldafny.types.IKeyring {
  ...
  public Wrappers_Compile.Result<software.amazon.cryptography.materialproviders.internaldafny.types.OnEncryptOutput, software.amazon.cryptography.materialproviders.internaldafny.types.Error> OnEncrypt_k(software.amazon.cryptography.materialproviders.internaldafny.types.OnEncryptInput input)
  {
    ...
    if(true) {
      ...
      AwsKmsKeyring_Compile.KmsGenerateAndWrapKeyMaterial _4_kmsGenerateAndWrap;
      ...
      AwsKmsKeyring_Compile.KmsWrapKeyMaterial _5_kmsWrap;
      ...
      _5_kmsWrap = _nw1;
      Wrappers_Compile.Result<EdkWrapping_Compile.WrapEdkMaterialOutput<AwsKmsKeyring_Compile.KmsWrapInfo>, software.amazon.cryptography.materialproviders.internaldafny.types.Error> _6_valueOrError1 = Wrappers_Compile.Result.<EdkWrapping_Compile.WrapEdkMaterialOutput<AwsKmsKeyring_Compile.KmsWrapInfo>, software.amazon.cryptography.materialproviders.internaldafny.types.Error>Default(EdkWrapping_Compile.WrapEdkMaterialOutput.<AwsKmsKeyring_Compile.KmsWrapInfo>_typeDescriptor(AwsKmsKeyring_Compile.KmsWrapInfo._typeDescriptor()), software.amazon.cryptography.materialproviders.internaldafny.types.Error._typeDescriptor(), EdkWrapping_Compile.WrapEdkMaterialOutput.<AwsKmsKeyring_Compile.KmsWrapInfo>Default(AwsKmsKeyring_Compile.KmsWrapInfo._typeDescriptor(), AwsKmsKeyring_Compile.KmsWrapInfo.Default()));
      Wrappers_Compile.Result<EdkWrapping_Compile.WrapEdkMaterialOutput<AwsKmsKeyring_Compile.KmsWrapInfo>, software.amazon.cryptography.materialproviders.internaldafny.types.Error> _out0;
      _out0 = EdkWrapping_Compile.__default.<AwsKmsKeyring_Compile.KmsWrapInfo>WrapEdkMaterial(AwsKmsKeyring_Compile.KmsWrapInfo._typeDescriptor(), _0_materials, _5_kmsWrap, _4_kmsGenerateAndWrap);
      _6_valueOrError1 = _out0;
      if ((_6_valueOrError1).IsFailure(EdkWrapping_Compile.WrapEdkMaterialOutput.<AwsKmsKeyring_Compile.KmsWrapInfo>_typeDescriptor(AwsKmsKeyring_Compile.KmsWrapInfo._typeDescriptor()), software.amazon.cryptography.materialproviders.internaldafny.types.Error._typeDescriptor())) {
        output = (_6_valueOrError1).<software.amazon.cryptography.materialproviders.internaldafny.types.OnEncryptOutput>PropagateFailure(EdkWrapping_Compile.WrapEdkMaterialOutput.<AwsKmsKeyring_Compile.KmsWrapInfo>_typeDescriptor(AwsKmsKeyring_Compile.KmsWrapInfo._typeDescriptor()), software.amazon.cryptography.materialproviders.internaldafny.types.Error._typeDescriptor(), software.amazon.cryptography.materialproviders.internaldafny.types.OnEncryptOutput._typeDescriptor());
        return output;
      }
      EdkWrapping_Compile.WrapEdkMaterialOutput<AwsKmsKeyring_Compile.KmsWrapInfo> _7_wrapOutput;
      _7_wrapOutput = (_6_valueOrError1).Extract(EdkWrapping_Compile.WrapEdkMaterialOutput.<AwsKmsKeyring_Compile.KmsWrapInfo>_typeDescriptor(AwsKmsKeyring_Compile.KmsWrapInfo._typeDescriptor()), software.amazon.cryptography.materialproviders.internaldafny.types.Error._typeDescriptor());
      ...
      _12_valueOrError3 = Wrappers_Compile.__default.<software.amazon.cryptography.materialproviders.internaldafny.types.Error>Need(software.amazon.cryptography.materialproviders.internaldafny.types.Error._typeDescriptor(), java.lang.Long.compareUnsigned((long) (_11_providerInfo).cardinalityInt(), (StandardLibrary_mUInt_Compile.__default.UINT16__LIMIT()).longValue()) < 0, software.amazon.cryptography.materialproviders.internaldafny.types.Error.create_AwsCryptographicMaterialProvidersException(dafny.DafnySequence.asString("Invalid response from AWS KMS GenerateDataKey: Key ID too long.")));
      ...
      if ((_7_wrapOutput).is_GenerateAndWrapEdkMaterialOutput()) {
        ...
        if ((_14_valueOrError4).IsFailure(software.amazon.cryptography.materialproviders.internaldafny.types.EncryptionMaterials._typeDescriptor(), software.amazon.cryptography.materialproviders.internaldafny.types.Error._typeDescriptor())) {
          output = (_14_valueOrError4).<software.amazon.cryptography.materialproviders.internaldafny.types.OnEncryptOutput>PropagateFailure(software.amazon.cryptography.materialproviders.internaldafny.types.EncryptionMaterials._typeDescriptor(), software.amazon.cryptography.materialproviders.internaldafny.types.Error._typeDescriptor(), software.amazon.cryptography.materialproviders.internaldafny.types.OnEncryptOutput._typeDescriptor());
          return output;
        }
        ...
        if ((_16_valueOrError5).IsFailure(software.amazon.cryptography.materialproviders.internaldafny.types.EncryptionMaterials._typeDescriptor(), software.amazon.cryptography.materialproviders.internaldafny.types.Error._typeDescriptor())) {
          output = (_16_valueOrError5).<software.amazon.cryptography.materialproviders.internaldafny.types.OnEncryptOutput>PropagateFailure(software.amazon.cryptography.materialproviders.internaldafny.types.EncryptionMaterials._typeDescriptor(), software.amazon.cryptography.materialproviders.internaldafny.types.Error._typeDescriptor(), software.amazon.cryptography.materialproviders.internaldafny.types.OnEncryptOutput._typeDescriptor());
          return output;
        }
  ...
  public Wrappers_Compile.Result<software.amazon.cryptography.materialproviders.internaldafny.types.OnDecryptOutput, software.amazon.cryptography.materialproviders.internaldafny.types.Error> OnDecrypt_k(software.amazon.cryptography.materialproviders.internaldafny.types.OnDecryptInput input)
  {
    ...
    if ((_3_valueOrError1).IsFailure(software.amazon.cryptography.materialproviders.internaldafny.types.Error._typeDescriptor())) {
      output = (_3_valueOrError1).<software.amazon.cryptography.materialproviders.internaldafny.types.OnDecryptOutput>PropagateFailure(software.amazon.cryptography.materialproviders.internaldafny.types.Error._typeDescriptor(), software.amazon.cryptography.materialproviders.internaldafny.types.OnDecryptOutput._typeDescriptor());
      return output;
    }
    AwsKmsUtils_Compile.OnDecryptMrkAwareEncryptedDataKeyFilter _4_filter;
    ...
    _nw0.__ctor((this).awsKmsArn(), Constants_Compile.__default.PROVIDER__ID());
    _4_filter = _nw0;
    ...
    DecryptSingleEncryptedDataKey _9_decryptClosure;
  ...
  private static final dafny.TypeDescriptor<AwsKmsMrkKeyring> _TYPE = dafny.TypeDescriptor.<AwsKmsMrkKeyring>referenceWithInitializer(AwsKmsMrkKeyring.class, () -> (AwsKmsMrkKeyring) null);
  public static dafny.TypeDescriptor<AwsKmsMrkKeyring> _typeDescriptor() {
    return (dafny.TypeDescriptor<AwsKmsMrkKeyring>) (dafny.TypeDescriptor<?>) _TYPE;
  }
  @Override
