...
public class KmsRsaUnwrapKeyMaterial implements MaterialWrapping_Compile.UnwrapMaterial<KmsRsaUnwrapInfo>, Actions_Compile.ActionWithResult<MaterialWrapping_Compile.UnwrapInput, MaterialWrapping_Compile.UnwrapOutput<KmsRsaUnwrapInfo>, software.amazon.cryptography.materialproviders.internaldafny.types.Error>, Actions_Compile.Action<MaterialWrapping_Compile.UnwrapInput, Wrappers_Compile.Result<MaterialWrapping_Compile.UnwrapOutput<KmsRsaUnwrapInfo>, software.amazon.cryptography.materialproviders.internaldafny.types.Error>> {
  ...
  public Wrappers_Compile.Result<MaterialWrapping_Compile.UnwrapOutput<KmsRsaUnwrapInfo>, software.amazon.cryptography.materialproviders.internaldafny.types.Error> Invoke(MaterialWrapping_Compile.UnwrapInput input)
  {
    ...
    _7_valueOrError3 = Wrappers_Compile.__default.<software.amazon.cryptography.materialproviders.internaldafny.types.Error>Need(software.amazon.cryptography.materialproviders.internaldafny.types.Error._typeDescriptor(), (((this).encryptionContextDigest()).isPrefixOf(((_5_decryptResponse).dtor_Plaintext()).dtor_value())) && (java.util.Objects.equals((java.math.BigInteger.valueOf(AlgorithmSuites_Compile.__default.GetEncryptKeyLength((input).dtor_algorithmSuite()))).add(java.math.BigInteger.valueOf(((this).encryptionContextDigest()).length())), java.math.BigInteger.valueOf((((_5_decryptResponse).dtor_Plaintext()).dtor_value()).length()))), software.amazon.cryptography.materialproviders.internaldafny.types.Error.create_AwsCryptographicMaterialProvidersException(dafny.DafnySequence.asString("Encryption context digest does not match expected value.")));
    ...
    _8_output = MaterialWrapping_Compile.UnwrapOutput.<KmsRsaUnwrapInfo>create(KmsRsaUnwrapInfo._typeDescriptor(), (((_5_decryptResponse).dtor_Plaintext()).dtor_value()).drop(java.math.BigInteger.valueOf(((this).encryptionContextDigest()).length())), AwsKmsRsaKeyring_Compile.KmsRsaUnwrapInfo.create());
