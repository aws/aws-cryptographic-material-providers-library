// Package Commitment
// Dafny module Commitment compiled into Go
...
func (_static *CompanionStruct_Default___) ValidateCommitmentPolicyOnEncrypt(algorithm m_AwsCryptographyMaterialProvidersTypes.AlgorithmSuiteId, commitmentPolicy m_AwsCryptographyMaterialProvidersTypes.CommitmentPolicy) m_Wrappers.Outcome {
	var _0_suite m_AwsCryptographyMaterialProvidersTypes.AlgorithmSuiteInfo = m_AlgorithmSuites.Companion_Default___.GetSuite(algorithm)
	_ = _0_suite
	if ((commitmentPolicy).Equals(m_AwsCryptographyMaterialProvidersTypes.Companion_CommitmentPolicy_.Create_ESDK_(m_AwsCryptographyMaterialProvidersTypes.Companion_ESDKCommitmentPolicy_.Create_FORBID__ENCRYPT__ALLOW__DECRYPT_()))) && (!(((_0_suite).Dtor_commitment()).Is_None())) {
		return m_Wrappers.Companion_Outcome_.Create_Fail_(m_AwsCryptographyMaterialProvidersTypes.Companion_Error_.Create_InvalidAlgorithmSuiteInfoOnEncrypt_(_dafny.SeqOfString("Configuration conflict. Commitment policy requires only non-committing algorithm suites")))
	} else if ((((commitmentPolicy).Equals(m_AwsCryptographyMaterialProvidersTypes.Companion_CommitmentPolicy_.Create_ESDK_(m_AwsCryptographyMaterialProvidersTypes.Companion_ESDKCommitmentPolicy_.Create_REQUIRE__ENCRYPT__ALLOW__DECRYPT_()))) || ((commitmentPolicy).Equals(m_AwsCryptographyMaterialProvidersTypes.Companion_CommitmentPolicy_.Create_ESDK_(m_AwsCryptographyMaterialProvidersTypes.Companion_ESDKCommitmentPolicy_.Create_REQUIRE__ENCRYPT__REQUIRE__DECRYPT_())))) || ((commitmentPolicy).Equals(m_AwsCryptographyMaterialProvidersTypes.Companion_CommitmentPolicy_.Create_DBE_(m_AwsCryptographyMaterialProvidersTypes.Companion_DBECommitmentPolicy_.Create_REQUIRE__ENCRYPT__REQUIRE__DECRYPT_())))) && (((_0_suite).Dtor_commitment()).Is_None()) {
		return m_Wrappers.Companion_Outcome_.Create_Fail_(m_AwsCryptographyMaterialProvidersTypes.Companion_Error_.Create_InvalidAlgorithmSuiteInfoOnEncrypt_(_dafny.SeqOfString("Configuration conflict. Commitment policy requires only committing algorithm suites")))
	} else {
		return m_Wrappers.Companion_Outcome_.Create_Pass_()
	}
}
func (_static *CompanionStruct_Default___) ValidateCommitmentPolicyOnDecrypt(algorithm m_AwsCryptographyMaterialProvidersTypes.AlgorithmSuiteId, commitmentPolicy m_AwsCryptographyMaterialProvidersTypes.CommitmentPolicy) m_Wrappers.Outcome {
	var _0_suite m_AwsCryptographyMaterialProvidersTypes.AlgorithmSuiteInfo = m_AlgorithmSuites.Companion_Default___.GetSuite(algorithm)
	_ = _0_suite
	if ((true) && (((commitmentPolicy).Equals(m_AwsCryptographyMaterialProvidersTypes.Companion_CommitmentPolicy_.Create_ESDK_(m_AwsCryptographyMaterialProvidersTypes.Companion_ESDKCommitmentPolicy_.Create_REQUIRE__ENCRYPT__REQUIRE__DECRYPT_()))) || ((commitmentPolicy).Equals(m_AwsCryptographyMaterialProvidersTypes.Companion_CommitmentPolicy_.Create_DBE_(m_AwsCryptographyMaterialProvidersTypes.Companion_DBECommitmentPolicy_.Create_REQUIRE__ENCRYPT__REQUIRE__DECRYPT_()))))) && (((_0_suite).Dtor_commitment()).Is_None()) {
		return m_Wrappers.Companion_Outcome_.Create_Fail_(m_AwsCryptographyMaterialProvidersTypes.Companion_Error_.Create_InvalidAlgorithmSuiteInfoOnDecrypt_(_dafny.SeqOfString("Configuration conflict. Commitment policy requires only committing algorithm suites")))
	} else {
		return m_Wrappers.Companion_Outcome_.Create_Pass_()
	}
}
