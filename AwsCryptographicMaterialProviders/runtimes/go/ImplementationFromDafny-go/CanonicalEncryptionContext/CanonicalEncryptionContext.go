// Package CanonicalEncryptionContext
// Dafny module CanonicalEncryptionContext compiled into Go
...
func (*Default__) String() string {
	return "CanonicalEncryptionContext.Default__"
}
	...
	if (_0_valueOrError0).IsFailure() {
		...
		if (_dafny.IntOfUint32((_1_keys).Cardinality())).Sign() == 0 {
			...
			var _2_KeyIntoPairBytes func(_dafny.Sequence) m_Wrappers.Result = (func(_3_encryptionContext _dafny.Map) func(_dafny.Sequence) m_Wrappers.Result {
				return func(_4_k _dafny.Sequence) m_Wrappers.Result {
					return func(_pat_let4_0 _dafny.Sequence) m_Wrappers.Result {
						return func(_5_v _dafny.Sequence) m_Wrappers.Result {
							return func(_pat_let5_0 m_Wrappers.Outcome) m_Wrappers.Result {
								return func(_6_valueOrError1 m_Wrappers.Outcome) m_Wrappers.Result {
									return (func() m_Wrappers.Result {
										if (_6_valueOrError1).IsFailure() {
											return (_6_valueOrError1).PropagateFailure()
										}
										return m_Wrappers.Companion_Result_.Create_Success_(_dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(m_StandardLibrary_UInt.Companion_Default___.UInt16ToSeq(uint16((_4_k).Cardinality())), _4_k), m_StandardLibrary_UInt.Companion_Default___.UInt16ToSeq(uint16((_5_v).Cardinality()))), _5_v))
									})()
								}(_pat_let5_0)
					...
					}((_3_encryptionContext).Get(_4_k).(_dafny.Sequence))
				}
			})(encryptionContext)
			...
			if (_7_valueOrError2).IsFailure() {
				...
				var _8_pairsBytes _dafny.Sequence = (_7_valueOrError2).Extract().(_dafny.Sequence)
				_ = _8_pairsBytes
				var _9_allBytes _dafny.Sequence = _dafny.Companion_Sequence_.Concatenate(m_StandardLibrary_UInt.Companion_Default___.UInt16ToSeq(uint16((_1_keys).Cardinality())), m_Seq.Companion_Default___.Flatten(_8_pairsBytes))
				_ = _9_allBytes
				return m_Wrappers.Companion_Result_.Create_Success_(_9_allBytes)
			}
		}
	}
}
