...
// Dafny module StormTrackingCMC compiled into Go
...
func (*Default__) String() string {
	return "StormTrackingCMC.Default__"
}
...
func (_static *CompanionStruct_Default___) CreateGetCacheEntrySuccess(output m_AwsCryptographyMaterialProvidersTypes.GetCacheEntryOutput) m_Wrappers.Result {
	return m_Wrappers.Companion_Result_.Create_Success_(output)
}
func (_static *CompanionStruct_Default___) CreateGetCacheEntryFailure(error_ m_AwsCryptographyMaterialProvidersTypes.Error) m_Wrappers.Result {
