// Package MrkAwareDiscoveryMultiKeyring
// Dafny module MrkAwareDiscoveryMultiKeyring compiled into Go
...
func (*Default__) String() string {
	return "MrkAwareDiscoveryMultiKeyring.Default__"
}
...
func (_static *CompanionStruct_Default___) MrkAwareDiscoveryMultiKeyring(regions _dafny.Sequence, discoveryFilter m_Wrappers.Option, clientSupplier m_AwsCryptographyMaterialProvidersTypes.IClientSupplier, grantTokens m_Wrappers.Option) m_Wrappers.Result {
	...
	_ = _0_valueOrError0
	_0_valueOrError0 = m_Wrappers.Companion_Default___.Need((_dafny.IntOfUint32((regions).Cardinality())).Sign() == 1, m_AwsCryptographyMaterialProvidersTypes.Companion_Error_.Create_AwsCryptographicMaterialProvidersException_(_dafny.SeqOfString("No regions passed.")))
	...
	_ = _1_valueOrError1
	_1_valueOrError1 = m_Wrappers.Companion_Default___.Need((m_Seq.Companion_Default___.IndexOfOption(regions, _dafny.SeqOfString(""))).Is_None(), m_AwsCryptographyMaterialProvidersTypes.Companion_Error_.Create_AwsCryptographicMaterialProvidersException_(_dafny.SeqOfString("Empty string is not a valid region.")))
	if (_1_valueOrError1).IsFailure() {
		output = (_1_valueOrError1).PropagateFailure()
		return output
	}
	var _2_children _dafny.Sequence
	_ = _2_children
	_2_children = _dafny.SeqOf()
	var _hi0 _dafny.Int = _dafny.IntOfUint32((regions).Cardinality())
	_ = _hi0
	for _3_i := _dafny.Zero; _3_i.Cmp(_hi0) < 0; _3_i = _3_i.Plus(_dafny.One) {
		var _4_region _dafny.Sequence
		_ = _4_region
		_4_region = (regions).Select((_3_i).Uint32()).(_dafny.Sequence)
		var _5_valueOrError2 m_Wrappers.Result = m_Wrappers.Result{}
		_ = _5_valueOrError2
		var _out0 m_Wrappers.Result
		_ = _out0
		_out0 = (clientSupplier).GetClient(m_AwsCryptographyMaterialProvidersTypes.Companion_GetClientInput_.Create_GetClientInput_(_4_region))
		_5_valueOrError2 = _out0
		if (_5_valueOrError2).IsFailure() {
			output = (_5_valueOrError2).PropagateFailure()
			return output
		}
		var _6_client m_ComAmazonawsKmsTypes.IKMSClient
		_ = _6_client
		_6_client = m_ComAmazonawsKmsTypes.Companion_IKMSClient_.CastTo_((_5_valueOrError2).Extract())
		var _7_keyring *m_AwsKmsMrkDiscoveryKeyring.AwsKmsMrkDiscoveryKeyring
		_ = _7_keyring
		...
		_ = _nw0
		_nw0.Ctor__(_6_client, _4_region, discoveryFilter, (grantTokens).UnwrapOr(_dafny.SeqOf()).(_dafny.Sequence))
		_7_keyring = _nw0
		_2_children = _dafny.Companion_Sequence_.Concatenate(_2_children, _dafny.SeqOf(_7_keyring))
	}
	var _8_keyring *m_MultiKeyring.MultiKeyring
	_ = _8_keyring
	var _nw1 *m_MultiKeyring.MultiKeyring = m_MultiKeyring.New_MultiKeyring_()
	_ = _nw1
	_nw1.Ctor__(m_Wrappers.Companion_Option_.Create_None_(), _2_children)
	_8_keyring = _nw1
