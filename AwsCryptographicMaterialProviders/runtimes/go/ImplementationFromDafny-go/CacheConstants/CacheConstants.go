...
// Dafny module CacheConstants compiled into Go
...
func (*Default__) String() string {
	return "CacheConstants.Default__"
}
...
func (_static *CompanionStruct_Default___) NULL__BYTE() _dafny.Sequence {
	return _dafny.SeqOf(uint8(0))
}
func (_static *CompanionStruct_Default___) RESOURCE__ID__CACHING__CMM() _dafny.Sequence {
	return _dafny.SeqOf(uint8(1))
}
func (_static *CompanionStruct_Default___) RESOURCE__ID__HIERARCHICAL__KEYRING() _dafny.Sequence {
	return _dafny.SeqOf(uint8(2))
}
func (_static *CompanionStruct_Default___) SCOPE__ID__ENCRYPT() _dafny.Sequence {
	return _dafny.SeqOf(uint8(1))
}
func (_static *CompanionStruct_Default___) SCOPE__ID__DECRYPT() _dafny.Sequence {
	return _dafny.SeqOf(uint8(2))
}
func (_static *CompanionStruct_Default___) SCOPE__ID__SEARCHABLE__ENCRYPTION() _dafny.Sequence {
	return _dafny.SeqOf(uint8(3))
}
