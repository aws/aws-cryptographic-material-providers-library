...
func Aws_cryptography_keyStoreAdmin_KeyManagementStrategy_AwsKmsReEncrypt_FromDafny(input interface{}) awscryptographykeystoresmithygeneratedtypes.AwsKms {
	return awscryptographykeystoresmithygeneratedtypes.AwsKms{GrantTokens: awscryptographykeystoresmithygenerated.Aws_cryptography_keyStore_AwsKms_grantTokens_FromDafny(input.(AwsCryptographyKeyStoreTypes.AwsKms).Dtor_grantTokens().UnwrapOr(nil)),
		KmsClient: awscryptographykeystoresmithygenerated.Aws_cryptography_keyStore_AwsKms_kmsClient_FromDafny(input.(AwsCryptographyKeyStoreTypes.AwsKms).Dtor_kmsClient().UnwrapOr(nil)),
	}
}
...
func Aws_cryptography_keyStoreAdmin_CreateKeyInput_EncryptionContext_FromDafny(input interface{}) map[string]string {
	...
	for i := dafny.Iterate(input.(dafny.Map).Items()); ; {
		...
		m[awscryptographykeystoresmithygenerated.Aws_cryptography_keyStore_EncryptionContext_key_FromDafny((*val.(dafny.Tuple).IndexInt(0)))] = awscryptographykeystoresmithygenerated.Aws_cryptography_keyStore_EncryptionContext_value_FromDafny((*val.(dafny.Tuple).IndexInt(1)))
	}
	return m
...
func Aws_cryptography_keyStoreAdmin_CreateKeyInput_KmsArn_FromDafny(input interface{}) awscryptographykeystoreadminsmithygeneratedtypes.KmsSymmetricKeyArn {
	...
	if (input.(AwsCryptographyKeyStoreAdminTypes.KmsSymmetricKeyArn)).Is_KmsMRKey() {

		union = &awscryptographykeystoreadminsmithygeneratedtypes.KmsSymmetricKeyArnMemberKmsMRKey{
			Value: (Aws_cryptography_keyStoreAdmin_KmsSymmetricKeyArn_KmsMRKey_FromDafny((input.(AwsCryptographyKeyStoreAdminTypes.KmsSymmetricKeyArn)).Dtor_KmsMRKey())),
		}
	}
...
func Aws_cryptography_keyStoreAdmin_KmsSymmetricKeyArn_KmsMRKey_FromDafny(input interface{}) awscryptographykeystoreadminsmithygeneratedtypes.KmsMRKey {
	return awscryptographykeystoreadminsmithygeneratedtypes.KmsMRKey{KeyArn: Aws_cryptography_keyStoreAdmin_KmsMRKey_KeyArn_FromDafny(input.(AwsCryptographyKeyStoreAdminTypes.KmsMRKey).Dtor_KeyArn()),
		Region: Aws_cryptography_keyStoreAdmin_KmsMRKey_Region_FromDafny(input.(AwsCryptographyKeyStoreAdminTypes.KmsMRKey).Dtor_Region()),
	}
}
func Aws_cryptography_keyStoreAdmin_KmsMRKey_KeyArn_FromDafny(input interface{}) string {
	return func() string {
...
func Aws_cryptography_keyStoreAdmin_KmsMRKey_Region_FromDafny(input interface{}) string {
	return func() string {
...
func Aws_cryptography_keyStoreAdmin_MutationDetails_Original_FromDafny(input interface{}) awscryptographykeystoreadminsmithygeneratedtypes.MutableBranchKeyContext {
	return awscryptographykeystoreadminsmithygeneratedtypes.MutableBranchKeyContext{KmsArn: Aws_cryptography_keyStoreAdmin_MutableBranchKeyContext_KmsArn_FromDafny(input.(AwsCryptographyKeyStoreAdminTypes.MutableBranchKeyContext).Dtor_KmsArn()),
		EncryptionContext: Aws_cryptography_keyStoreAdmin_MutableBranchKeyContext_EncryptionContext_FromDafny(input.(AwsCryptographyKeyStoreAdminTypes.MutableBranchKeyContext).Dtor_EncryptionContext()),
		HierarchyVersion:  Aws_cryptography_keyStoreAdmin_MutableBranchKeyContext_HierarchyVersion_FromDafny(input.(AwsCryptographyKeyStoreAdminTypes.MutableBranchKeyContext).Dtor_HierarchyVersion()),
	}
}
func Aws_cryptography_keyStoreAdmin_MutableBranchKeyContext_KmsArn_FromDafny(input interface{}) string {
	return func() string {
...
func Aws_cryptography_keyStoreAdmin_MutableBranchKeyContext_EncryptionContext_FromDafny(input interface{}) map[string]string {
	var m map[string]string = make(map[string]string)
	if input == nil {
		return nil
	}
	for i := dafny.Iterate(input.(dafny.Map).Items()); ; {
		...
		m[awscryptographykeystoresmithygenerated.Aws_cryptography_keyStore_EncryptionContextString_key_FromDafny((*val.(dafny.Tuple).IndexInt(0)))] = awscryptographykeystoresmithygenerated.Aws_cryptography_keyStore_EncryptionContextString_value_FromDafny((*val.(dafny.Tuple).IndexInt(1)))
	}
	return m

}
func Aws_cryptography_keyStoreAdmin_MutableBranchKeyContext_HierarchyVersion_FromDafny(input interface{}) awscryptographykeystoresmithygeneratedtypes.HierarchyVersion {
	return func() awscryptographykeystoresmithygeneratedtypes.HierarchyVersion {
		var u awscryptographykeystoresmithygeneratedtypes.HierarchyVersion
		inputEnum := input.(AwsCryptographyKeyStoreTypes.HierarchyVersion)
		index := -1
...
func Aws_cryptography_keyStoreAdmin_MutationDetails_Terminal_FromDafny(input interface{}) awscryptographykeystoreadminsmithygeneratedtypes.MutableBranchKeyContext {
	return awscryptographykeystoreadminsmithygeneratedtypes.MutableBranchKeyContext{KmsArn: Aws_cryptography_keyStoreAdmin_MutableBranchKeyContext_KmsArn_FromDafny(input.(AwsCryptographyKeyStoreAdminTypes.MutableBranchKeyContext).Dtor_KmsArn()),
		EncryptionContext: Aws_cryptography_keyStoreAdmin_MutableBranchKeyContext_EncryptionContext_FromDafny(input.(AwsCryptographyKeyStoreAdminTypes.MutableBranchKeyContext).Dtor_EncryptionContext()),
		HierarchyVersion:  Aws_cryptography_keyStoreAdmin_MutableBranchKeyContext_HierarchyVersion_FromDafny(input.(AwsCryptographyKeyStoreAdminTypes.MutableBranchKeyContext).Dtor_HierarchyVersion()),
	}
...
func Aws_cryptography_keyStoreAdmin_MutationDetails_Input_FromDafny(input interface{}) awscryptographykeystoreadminsmithygeneratedtypes.Mutations {
	return awscryptographykeystoreadminsmithygeneratedtypes.Mutations{TerminalKmsArn: Aws_cryptography_keyStoreAdmin_Mutations_TerminalKmsArn_FromDafny(input.(AwsCryptographyKeyStoreAdminTypes.Mutations).Dtor_TerminalKmsArn().UnwrapOr(nil)),
		...
		TerminalHierarchyVersion:  Aws_cryptography_keyStoreAdmin_Mutations_TerminalHierarchyVersion_FromDafny(input.(AwsCryptographyKeyStoreAdminTypes.Mutations).Dtor_TerminalHierarchyVersion().UnwrapOr(nil)),
	}
}
...
func Aws_cryptography_keyStoreAdmin_Mutations_TerminalHierarchyVersion_FromDafny(input interface{}) *awscryptographykeystoresmithygeneratedtypes.HierarchyVersion {
	return func() *awscryptographykeystoresmithygeneratedtypes.HierarchyVersion {
		var u awscryptographykeystoresmithygeneratedtypes.HierarchyVersion
		if input == nil {
			return nil
...
func Aws_cryptography_keyStoreAdmin_KeyStoreAdminConfig_storage_FromDafny(input interface{}) awscryptographykeystoresmithygeneratedtypes.Storage {
	...
	if (input.(AwsCryptographyKeyStoreTypes.Storage)).Is_ddb() {
		...
		union = &awscryptographykeystoresmithygeneratedtypes.StorageMemberddb{
			Value: (awscryptographykeystoresmithygenerated.Aws_cryptography_keyStore_Storage_ddb_FromDafny((input.(AwsCryptographyKeyStoreTypes.Storage)).Dtor_ddb())),
		}
	}
