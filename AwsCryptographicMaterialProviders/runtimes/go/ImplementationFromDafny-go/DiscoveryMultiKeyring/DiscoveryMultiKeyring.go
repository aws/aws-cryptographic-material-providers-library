// Package DiscoveryMultiKeyring
// Dafny module DiscoveryMultiKeyring compiled into Go
...
func (*Default__) String() string {
	return "DiscoveryMultiKeyring.Default__"
}
...
func (_static *CompanionStruct_Default___) DiscoveryMultiKeyring(regions _dafny.Sequence, discoveryFilter m_Wrappers.Option, clientSupplier m_AwsCryptographyMaterialProvidersTypes.IClientSupplier, grantTokens m_Wrappers.Option) m_Wrappers.Result {
	...
	for _3_i := _dafny.Zero; _3_i.Cmp(_hi0) < 0; _3_i = _3_i.Plus(_dafny.One) {
		...
		var _7_keyring *m_AwsKmsDiscoveryKeyring.AwsKmsDiscoveryKeyring
		_ = _7_keyring
		var _nw0 *m_AwsKmsDiscoveryKeyring.AwsKmsDiscoveryKeyring = m_AwsKmsDiscoveryKeyring.New_AwsKmsDiscoveryKeyring_()
		_ = _nw0
		_nw0.Ctor__(_6_client, discoveryFilter, (grantTokens).UnwrapOr(_dafny.SeqOf()).(_dafny.Sequence))
		_7_keyring = _nw0
