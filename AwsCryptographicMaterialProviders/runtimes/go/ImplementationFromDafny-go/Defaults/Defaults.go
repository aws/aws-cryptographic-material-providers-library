// Package Defaults
// Dafny module Defaults compiled into Go
...
func (_static *CompanionStruct_Default___) GetAlgorithmSuiteForCommitmentPolicy(commitmentPolicy m_AwsCryptographyMaterialProvidersTypes.CommitmentPolicy) m_AwsCryptographyMaterialProvidersTypes.AlgorithmSuiteId {
	var _source0 m_AwsCryptographyMaterialProvidersTypes.CommitmentPolicy = commitmentPolicy
	_ = _source0
	{
		if _source0.Is_ESDK() {
			var _0_c m_AwsCryptographyMaterialProvidersTypes.ESDKCommitmentPolicy = _source0.Get_().(m_AwsCryptographyMaterialProvidersTypes.CommitmentPolicy_ESDK).ESDK
			_ = _0_c
			var _source1 m_AwsCryptographyMaterialProvidersTypes.ESDKCommitmentPolicy = _0_c
			_ = _source1
			{
				if _source1.Is_FORBID__ENCRYPT__ALLOW__DECRYPT() {
					return m_AwsCryptographyMaterialProvidersTypes.Companion_AlgorithmSuiteId_.Create_ESDK_(m_AwsCryptographyMaterialProvidersTypes.Companion_ESDKAlgorithmSuiteId_.Create_ALG__AES__256__GCM__IV12__TAG16__HKDF__SHA384__ECDSA__P384_())
				}
			}
			{
				return m_AwsCryptographyMaterialProvidersTypes.Companion_AlgorithmSuiteId_.Create_ESDK_(m_AwsCryptographyMaterialProvidersTypes.Companion_ESDKAlgorithmSuiteId_.Create_ALG__AES__256__GCM__HKDF__SHA512__COMMIT__KEY__ECDSA__P384_())
			}
		}
	}
	{
