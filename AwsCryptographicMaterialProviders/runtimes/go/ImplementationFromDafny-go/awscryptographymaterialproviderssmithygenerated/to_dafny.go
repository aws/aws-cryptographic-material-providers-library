...
func Aws_cryptography_materialProviders_Materials_BeaconKey_ToDafny(input awscryptographykeystoresmithygeneratedtypes.BeaconKeyMaterials) Wrappers.Option {
	return func() Wrappers.Option {
		...
		return Wrappers.Companion_Option_.Create_Some_(AwsCryptographyKeyStoreTypes.Companion_BeaconKeyMaterials_.Create_BeaconKeyMaterials_(awscryptographykeystoresmithygenerated.Aws_cryptography_keyStore_BeaconKeyMaterials_beaconKeyIdentifier_ToDafny(input.BeaconKeyIdentifier), awscryptographykeystoresmithygenerated.Aws_cryptography_keyStore_BeaconKeyMaterials_encryptionContext_ToDafny(input.EncryptionContext), awscryptographykeystoresmithygenerated.Aws_cryptography_keyStore_BeaconKeyMaterials_beaconKey_ToDafny(input.BeaconKey), awscryptographykeystoresmithygenerated.Aws_cryptography_keyStore_BeaconKeyMaterials_hmacKeys_ToDafny(input.HmacKeys), awscryptographykeystoresmithygenerated.Aws_cryptography_keyStore_BeaconKeyMaterials_kmsArn_ToDafny(input.KmsArn), awscryptographykeystoresmithygenerated.Aws_cryptography_keyStore_BeaconKeyMaterials_createTime_ToDafny(input.CreateTime), awscryptographykeystoresmithygenerated.Aws_cryptography_keyStore_BeaconKeyMaterials_hierarchyVersion_ToDafny(input.HierarchyVersion)))
	}()
}
