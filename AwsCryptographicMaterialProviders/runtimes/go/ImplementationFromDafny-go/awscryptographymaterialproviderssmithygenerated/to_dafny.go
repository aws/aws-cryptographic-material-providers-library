...
func PositiveInteger_ToDafny(nativeInput int32) int32 {
	return func() int32 {
...
func DdbTableArn_ToDafny(nativeInput string) dafny.Sequence {
	return func() dafny.Sequence {

		return dafny.SeqOfChars([]dafny.Char(nativeInput)...)
	}()
