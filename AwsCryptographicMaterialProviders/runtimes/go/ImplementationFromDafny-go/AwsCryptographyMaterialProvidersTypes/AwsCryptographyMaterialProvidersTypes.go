...
func (CompanionStruct_StormTrackingCache_) Create_StormTrackingCache_(EntryCapacity int32, EntryPruningTailSize m_Wrappers.Option, GracePeriod int32, GraceInterval int32, FanOut int32, InFlightTTL int32, SleepMilli int32) StormTrackingCache {
	return StormTrackingCache{StormTrackingCache_StormTrackingCache{EntryCapacity, EntryPruningTailSize, GracePeriod, GraceInterval, FanOut, InFlightTTL, SleepMilli}}
}
...
func (CompanionStruct_StormTrackingCache_) Default() StormTrackingCache {
	return Companion_StormTrackingCache_.Create_StormTrackingCache_(int32(0), m_Wrappers.Companion_Option_.Default(), int32(0), int32(0), int32(0), int32(0), int32(0))
}
...
func (_this StormTrackingCache) String() string {
	...
	case StormTrackingCache_StormTrackingCache:
		{
			return "AwsCryptographyMaterialProvidersTypes.StormTrackingCache.StormTrackingCache" + "(" + _dafny.String(data.EntryCapacity) + ", " + _dafny.String(data.EntryPruningTailSize) + ", " + _dafny.String(data.GracePeriod) + ", " + _dafny.String(data.GraceInterval) + ", " + _dafny.String(data.FanOut) + ", " + _dafny.String(data.InFlightTTL) + ", " + _dafny.String(data.SleepMilli) + ")"
		}
	default:
		{
			return "<unexpected>"
	...
	case StormTrackingCache_StormTrackingCache:
		{
			...
			return ok && data1.EntryCapacity == data2.EntryCapacity && data1.EntryPruningTailSize.Equals(data2.EntryPruningTailSize) && data1.GracePeriod == data2.GracePeriod && data1.GraceInterval == data2.GraceInterval && data1.FanOut == data2.FanOut && data1.InFlightTTL == data2.InFlightTTL && data1.SleepMilli == data2.SleepMilli
		}
	default:
		{
			return false // unexpected
