// Package DefaultClientSupplier
// Dafny module DefaultClientSupplier compiled into Go
...
// Definition of class DefaultClientSupplier
type DefaultClientSupplier struct {
	dummy byte
}

func New_DefaultClientSupplier_() *DefaultClientSupplier {
	_this := DefaultClientSupplier{}

	return &_this
}

type CompanionStruct_DefaultClientSupplier_ struct {
}

var Companion_DefaultClientSupplier_ = CompanionStruct_DefaultClientSupplier_{}

func (_this *DefaultClientSupplier) Equals(other *DefaultClientSupplier) bool {
	return _this == other
}

func (_this *DefaultClientSupplier) EqualsGeneric(x interface{}) bool {
	other, ok := x.(*DefaultClientSupplier)
	return ok && _this.Equals(other)
}

func (*DefaultClientSupplier) String() string {
	return "DefaultClientSupplier.DefaultClientSupplier"
}

func Type_DefaultClientSupplier_() _dafny.TypeDescriptor {
	return type_DefaultClientSupplier_{}
}

type type_DefaultClientSupplier_ struct {
}

func (_this type_DefaultClientSupplier_) Default() interface{} {
	return (*DefaultClientSupplier)(nil)
}

func (_this type_DefaultClientSupplier_) String() string {
	return "DefaultClientSupplier.DefaultClientSupplier"
}
func (_this *DefaultClientSupplier) ParentTraits_() []*_dafny.TraitID {
	return [](*_dafny.TraitID){m_AwsCryptographyMaterialProvidersTypes.Companion_IClientSupplier_.TraitID_}
}

var _ m_AwsCryptographyMaterialProvidersTypes.IClientSupplier = &DefaultClientSupplier{}
var _ _dafny.TraitOffspring = &DefaultClientSupplier{}

func (_this *DefaultClientSupplier) GetClient(input m_AwsCryptographyMaterialProvidersTypes.GetClientInput) m_Wrappers.Result {
	var _out1 m_Wrappers.Result
	_ = _out1
	_out1 = m_AwsCryptographyMaterialProvidersTypes.Companion_IClientSupplier_.GetClient(_this, input)
	return _out1
}
func (_this *DefaultClientSupplier) Ctor__() {
	{
	}
}
func (_this *DefaultClientSupplier) GetClient_k(input m_AwsCryptographyMaterialProvidersTypes.GetClientInput) m_Wrappers.Result {
	{
		var output m_Wrappers.Result = m_Wrappers.Result{}
		_ = output
		var _0_maybeClient m_Wrappers.Result
		_ = _0_maybeClient
		var _out0 m_Wrappers.Result
		_ = _out0
		_out0 = m_Com_Amazonaws_Kms.Companion_Default___.KMSClientForRegion((input).Dtor_region())
		_0_maybeClient = _out0
		output = (_0_maybeClient).MapFailure(func(coer130 func(m_ComAmazonawsKmsTypes.Error) m_AwsCryptographyMaterialProvidersTypes.Error) func(interface{}) interface{} {
			return func(arg131 interface{}) interface{} {
				return coer130(arg131.(m_ComAmazonawsKmsTypes.Error))
			}
		}(func(_1_e m_ComAmazonawsKmsTypes.Error) m_AwsCryptographyMaterialProvidersTypes.Error {
			return m_AwsCryptographyMaterialProvidersTypes.Companion_Error_.Create_ComAmazonawsKms_(_1_e)
		}))
		return output
		return output
	}
...
// End of class DefaultClientSupplier
