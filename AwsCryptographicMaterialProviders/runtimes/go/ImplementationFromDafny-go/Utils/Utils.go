...
func (_static *CompanionStruct_Default___) GetPublicKey(curveSpec m_AwsCryptographyPrimitivesTypes.ECDHCurveSpec, privateKey m_AwsCryptographyPrimitivesTypes.ECCPrivateKey, crypto *m_AtomicPrimitives.AtomicPrimitivesClient) m_Wrappers.Result {
	...
	_ = _out0
	_out0 = (crypto).GetPublicKeyFromPrivateKey(m_AwsCryptographyPrimitivesTypes.Companion_GetPublicKeyFromPrivateKeyInput_.Create_GetPublicKeyFromPrivateKeyInput_(curveSpec, privateKey))
	_0_maybePublicKey = _out0
	var _1_valueOrError0 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(m_AwsCryptographyPrimitivesTypes.Companion_GetPublicKeyFromPrivateKeyOutput_.Default())
	_ = _1_valueOrError0
	_1_valueOrError0 = (_0_maybePublicKey).MapFailure(func(coer131 func(m_AwsCryptographyPrimitivesTypes.Error) m_AwsCryptographyMaterialProvidersTypes.Error) func(interface{}) interface{} {
		return func(arg132 interface{}) interface{} {
			return coer131(arg132.(m_AwsCryptographyPrimitivesTypes.Error))
		}
	...
	_ = _3_keyPairOutput
	_3_keyPairOutput = (_1_valueOrError0).Extract().(m_AwsCryptographyPrimitivesTypes.GetPublicKeyFromPrivateKeyOutput)
	res = m_Wrappers.Companion_Result_.Create_Success_((_3_keyPairOutput).Dtor_publicKey())
	return res
}
