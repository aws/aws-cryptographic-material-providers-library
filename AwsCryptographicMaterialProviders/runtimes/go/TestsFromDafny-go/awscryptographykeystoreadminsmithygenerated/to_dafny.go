...
func Aws_cryptography_keyStoreAdmin_CreateKeyInput_KmsArn_ToDafny(input awscryptographykeystoreadminsmithygeneratedtypes.KmsSymmetricKeyArn) AwsCryptographyKeyStoreAdminTypes.KmsSymmetricKeyArn {
	return func() AwsCryptographyKeyStoreAdminTypes.KmsSymmetricKeyArn {
		...
		case *awscryptographykeystoreadminsmithygeneratedtypes.KmsSymmetricKeyArnMemberKmsMRKey:
			var inputToConversion = Aws_cryptography_keyStoreAdmin_KmsSymmetricKeyArn_KmsMRKey_ToDafny(input.(*awscryptographykeystoreadminsmithygeneratedtypes.KmsSymmetricKeyArnMemberKmsMRKey).Value)
			return AwsCryptographyKeyStoreAdminTypes.CompanionStruct_KmsSymmetricKeyArn_{}.Create_KmsMRKey_(inputToConversion.UnwrapOr(nil).(AwsCryptographyKeyStoreAdminTypes.KmsMRKey))
...
func Aws_cryptography_keyStoreAdmin_KmsSymmetricKeyArn_KmsMRKey_ToDafny(input awscryptographykeystoreadminsmithygeneratedtypes.KmsMRKey) Wrappers.Option {
	return func() Wrappers.Option {

		return Wrappers.Companion_Option_.Create_Some_(AwsCryptographyKeyStoreAdminTypes.Companion_KmsMRKey_.Create_KmsMRKey_(Aws_cryptography_keyStoreAdmin_KmsMRKey_KeyArn_ToDafny(input.KeyArn), Aws_cryptography_keyStoreAdmin_KmsMRKey_Region_ToDafny(input.Region)))
	}()
}

func Aws_cryptography_keyStoreAdmin_KmsMRKey_KeyArn_ToDafny(input string) dafny.Sequence {
	return func() dafny.Sequence {
...
func Aws_cryptography_keyStoreAdmin_KmsMRKey_Region_ToDafny(input string) dafny.Sequence {
	return func() dafny.Sequence {
...
func Aws_cryptography_keyStoreAdmin_MutationDetails_Original_ToDafny(input awscryptographykeystoreadminsmithygeneratedtypes.MutableBranchKeyContext) AwsCryptographyKeyStoreAdminTypes.MutableBranchKeyContext {
	return func() AwsCryptographyKeyStoreAdminTypes.MutableBranchKeyContext {

		return AwsCryptographyKeyStoreAdminTypes.Companion_MutableBranchKeyContext_.Create_MutableBranchKeyContext_(Aws_cryptography_keyStoreAdmin_MutableBranchKeyContext_KmsArn_ToDafny(input.KmsArn), Aws_cryptography_keyStoreAdmin_MutableBranchKeyContext_EncryptionContext_ToDafny(input.EncryptionContext), Aws_cryptography_keyStoreAdmin_MutableBranchKeyContext_HierarchyVersion_ToDafny(input.HierarchyVersion))
	}()
}

func Aws_cryptography_keyStoreAdmin_MutableBranchKeyContext_KmsArn_ToDafny(input string) dafny.Sequence {
	return func() dafny.Sequence {
...
func Aws_cryptography_keyStoreAdmin_MutableBranchKeyContext_EncryptionContext_ToDafny(input map[string]string) dafny.Map {
...
func Aws_cryptography_keyStoreAdmin_MutableBranchKeyContext_HierarchyVersion_ToDafny(input awscryptographykeystoresmithygeneratedtypes.HierarchyVersion) AwsCryptographyKeyStoreTypes.HierarchyVersion {
	return func() AwsCryptographyKeyStoreTypes.HierarchyVersion {
...
func Aws_cryptography_keyStoreAdmin_MutationDetails_Terminal_ToDafny(input awscryptographykeystoreadminsmithygeneratedtypes.MutableBranchKeyContext) AwsCryptographyKeyStoreAdminTypes.MutableBranchKeyContext {
	return func() AwsCryptographyKeyStoreAdminTypes.MutableBranchKeyContext {
