// Package TestConfig
// Dafny module TestConfig compiled into Go
...
func (_static *CompanionStruct_Default___) TestInvalidKmsKeyArnConfig() {
	...
	if !(!((_0_valueOrError0).IsFailure())) {
		panic("dafny/AwsCryptographyKeyStore/test/TestConfig.dfy(19,21): " + (_0_valueOrError0).String())
	}
	...
	if !(!((_2_valueOrError1).IsFailure())) {
		panic("dafny/AwsCryptographyKeyStore/test/TestConfig.dfy(20,21): " + (_2_valueOrError1).String())
	}
	...
	_ = _4_kmsConfig
	_4_kmsConfig = m_AwsCryptographyKeyStoreTypes.Companion_KMSConfiguration_.Create_kmsKeyArn_(m_Fixtures.Companion_Default___.KeyId())
	...
	var _6_keyStore m_Wrappers.Result
	_ = _6_keyStore
	...
	if !((_6_keyStore).Is_Failure()) {
		panic("dafny/AwsCryptographyKeyStore/test/TestConfig.dfy(34,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
	var _source0 m_AwsCryptographyKeyStoreTypes.Error = (_6_keyStore).Dtor_error().(m_AwsCryptographyKeyStoreTypes.Error)
	_ = _source0
	{
		{
			if _source0.Is_KeyStoreException() {
				var _7_message _dafny.Sequence = _source0.Get_().(m_AwsCryptographyKeyStoreTypes.Error_KeyStoreException).Message
				_ = _7_message
				if !((_dafny.IntOfUint32((_7_message).Cardinality())).Cmp(_dafny.IntOfUint32((m_KeyStoreErrorMessages.Companion_Default___.KMS__CONFIG__KMS__ARN__INVALID()).Cardinality())) > 0) {
					panic("dafny/AwsCryptographyKeyStore/test/TestConfig.dfy(37,8): " + (_dafny.SeqOfString("expectation violation")).String())
				}
				if !(_dafny.Companion_Sequence_.Equal((_7_message).Take((_dafny.IntOfUint32((m_KeyStoreErrorMessages.Companion_Default___.KMS__CONFIG__KMS__ARN__INVALID()).Cardinality())).Uint32()), m_KeyStoreErrorMessages.Companion_Default___.KMS__CONFIG__KMS__ARN__INVALID())) {
					panic("dafny/AwsCryptographyKeyStore/test/TestConfig.dfy(38,8): " + (_dafny.SeqOfString("expectation violation")).String())
				}
				goto Lmatch0
			}
		}
		{
			if !(false) {
				panic("dafny/AwsCryptographyKeyStore/test/TestConfig.dfy(39,16): " + (_dafny.SeqOfString("Invalid KMS Key ARN should fail Key Store Construction")).String())
			}
		}
		goto Lmatch0
	}
...
func (_static *CompanionStruct_Default___) TestInvalidKmsKeyArnAliasConfig() {
	var _0_valueOrError0 m_Wrappers.Result = m_Wrappers.Result{}
	_ = _0_valueOrError0
	var _out0 m_Wrappers.Result
	_ = _out0
	...
	_0_valueOrError0 = _out0
	if !(!((_0_valueOrError0).IsFailure())) {
		panic("dafny/AwsCryptographyKeyStore/test/TestConfig.dfy(47,21): " + (_0_valueOrError0).String())
	}
	var _1_kmsClient m_ComAmazonawsKmsTypes.IKMSClient
	_ = _1_kmsClient
	_1_kmsClient = m_ComAmazonawsKmsTypes.Companion_IKMSClient_.CastTo_((_0_valueOrError0).Extract())
	...
	_2_valueOrError1 = _out1
	if !(!((_2_valueOrError1).IsFailure())) {
		panic("dafny/AwsCryptographyKeyStore/test/TestConfig.dfy(48,21): " + (_2_valueOrError1).String())
	}
	var _3_ddbClient m_ComAmazonawsDynamodbTypes.IDynamoDBClient
	_ = _3_ddbClient
	_3_ddbClient = m_ComAmazonawsDynamodbTypes.Companion_IDynamoDBClient_.CastTo_((_2_valueOrError1).Extract())
	var _4_kmsConfig m_AwsCryptographyKeyStoreTypes.KMSConfiguration
	_ = _4_kmsConfig
	_4_kmsConfig = m_AwsCryptographyKeyStoreTypes.Companion_KMSConfiguration_.Create_kmsKeyArn_(m_Fixtures.Companion_Default___.KmsKeyAlias())
	var _5_keyStoreConfig m_AwsCryptographyKeyStoreTypes.KeyStoreConfig
	_ = _5_keyStoreConfig
	_5_keyStoreConfig = m_AwsCryptographyKeyStoreTypes.Companion_KeyStoreConfig_.Create_KeyStoreConfig_(m_Fixtures.Companion_Default___.BranchKeyStoreName(), _4_kmsConfig, m_Fixtures.Companion_Default___.LogicalKeyStoreName(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_Some_(_3_ddbClient), m_Wrappers.Companion_Option_.Create_Some_(_1_kmsClient))
	var _6_keyStore m_Wrappers.Result
	...
	_6_keyStore = _out2
	if !((_6_keyStore).Is_Failure()) {
		panic("dafny/AwsCryptographyKeyStore/test/TestConfig.dfy(62,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
	var _source0 m_AwsCryptographyKeyStoreTypes.Error = (_6_keyStore).Dtor_error().(m_AwsCryptographyKeyStoreTypes.Error)
	_ = _source0
	{
		{
			if _source0.Is_KeyStoreException() {
				var _7_message _dafny.Sequence = _source0.Get_().(m_AwsCryptographyKeyStoreTypes.Error_KeyStoreException).Message
				_ = _7_message
				if !((_dafny.IntOfUint32((_7_message).Cardinality())).Cmp(_dafny.IntOfUint32((m_KeyStoreErrorMessages.Companion_Default___.ALIAS__NOT__ALLOWED()).Cardinality())) >= 0) {
					panic("dafny/AwsCryptographyKeyStore/test/TestConfig.dfy(65,8): " + (_dafny.SeqOfString("expectation violation")).String())
				}
				if !(_dafny.Companion_Sequence_.Equal((_7_message).Take((_dafny.IntOfUint32((m_KeyStoreErrorMessages.Companion_Default___.ALIAS__NOT__ALLOWED()).Cardinality())).Uint32()), m_KeyStoreErrorMessages.Companion_Default___.ALIAS__NOT__ALLOWED())) {
					panic("dafny/AwsCryptographyKeyStore/test/TestConfig.dfy(66,8): " + (_dafny.SeqOfString("expectation violation")).String())
				}
				goto Lmatch0
			}
		}
		{
			if !(false) {
				panic("dafny/AwsCryptographyKeyStore/test/TestConfig.dfy(67,16): " + (_dafny.SeqOfString("Alias should fail Key Store Construction")).String())
			}
		}
		goto Lmatch0
	}
...
func (_static *CompanionStruct_Default___) TestValidConfig() {
	var _0_valueOrError0 m_Wrappers.Result = m_Wrappers.Result{}
	_ = _0_valueOrError0
	var _out0 m_Wrappers.Result
	_ = _out0
	...
	_0_valueOrError0 = _out0
	if !(!((_0_valueOrError0).IsFailure())) {
		panic("dafny/AwsCryptographyKeyStore/test/TestConfig.dfy(73,21): " + (_0_valueOrError0).String())
	}
	var _1_kmsClient m_ComAmazonawsKmsTypes.IKMSClient
	_ = _1_kmsClient
	_1_kmsClient = m_ComAmazonawsKmsTypes.Companion_IKMSClient_.CastTo_((_0_valueOrError0).Extract())
	...
	_2_valueOrError1 = _out1
	if !(!((_2_valueOrError1).IsFailure())) {
		panic("dafny/AwsCryptographyKeyStore/test/TestConfig.dfy(74,21): " + (_2_valueOrError1).String())
	}
	var _3_ddbClient m_ComAmazonawsDynamodbTypes.IDynamoDBClient
	_ = _3_ddbClient
	_3_ddbClient = m_ComAmazonawsDynamodbTypes.Companion_IDynamoDBClient_.CastTo_((_2_valueOrError1).Extract())
	...
	if !((_6_keyStore).Is_Success()) {
		panic("dafny/AwsCryptographyKeyStore/test/TestConfig.dfy(88,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
	var _7_valueOrError2 m_Wrappers.Result = m_Wrappers.Result{}
	_ = _7_valueOrError2
	var _out3 m_Wrappers.Result
	_ = _out3
	_out3 = ((_6_keyStore).Dtor_value().(*m_KeyStore.KeyStoreClient)).GetKeyStoreInfo()
	_7_valueOrError2 = _out3
	if !(!((_7_valueOrError2).IsFailure())) {
		panic("dafny/AwsCryptographyKeyStore/test/TestConfig.dfy(90,16): " + (_7_valueOrError2).String())
	}
	var _8_conf m_AwsCryptographyKeyStoreTypes.GetKeyStoreInfoOutput
	_ = _8_conf
	_8_conf = (_7_valueOrError2).Extract().(m_AwsCryptographyKeyStoreTypes.GetKeyStoreInfoOutput)
	var _9_valueOrError3 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(_dafny.EmptySeq)
	_ = _9_valueOrError3
	_9_valueOrError3 = m_UUID.ToByteArray((_8_conf).Dtor_keyStoreId())
	if !(!((_9_valueOrError3).IsFailure())) {
		panic("dafny/AwsCryptographyKeyStore/test/TestConfig.dfy(95,22): " + (_9_valueOrError3).String())
	}
	var _10_idByteUUID _dafny.Sequence
	_ = _10_idByteUUID
	_10_idByteUUID = (_9_valueOrError3).Extract().(_dafny.Sequence)
	var _11_valueOrError4 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(_dafny.EmptySeq.SetString())
	_ = _11_valueOrError4
	_11_valueOrError4 = m_UUID.FromByteArray(_10_idByteUUID)
	if !(!((_11_valueOrError4).IsFailure())) {
		panic("dafny/AwsCryptographyKeyStore/test/TestConfig.dfy(96,23): " + (_11_valueOrError4).String())
	}
	var _12_idRoundTrip _dafny.Sequence
	_ = _12_idRoundTrip
	_12_idRoundTrip = (_11_valueOrError4).Extract().(_dafny.Sequence)
	if !(_dafny.Companion_Sequence_.Equal(_12_idRoundTrip, (_8_conf).Dtor_keyStoreId())) {
		panic("dafny/AwsCryptographyKeyStore/test/TestConfig.dfy(97,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
	if !(_dafny.Companion_Sequence_.Equal((_8_conf).Dtor_keyStoreName(), m_Fixtures.Companion_Default___.BranchKeyStoreName())) {
		panic("dafny/AwsCryptographyKeyStore/test/TestConfig.dfy(99,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
	if !(_dafny.Companion_Sequence_.Equal((_8_conf).Dtor_logicalKeyStoreName(), m_Fixtures.Companion_Default___.LogicalKeyStoreName())) {
		panic("dafny/AwsCryptographyKeyStore/test/TestConfig.dfy(100,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
	if !(((_8_conf).Dtor_kmsConfiguration()).Equals(_4_kmsConfig)) {
		panic("dafny/AwsCryptographyKeyStore/test/TestConfig.dfy(101,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
}
func (_static *CompanionStruct_Default___) TestValidConfigNoClients() {
	var _0_valueOrError0 m_Wrappers.Result = m_Wrappers.Result{}
	_ = _0_valueOrError0
	var _out0 m_Wrappers.Result
	_ = _out0
	...
	_0_valueOrError0 = _out0
	if !(!((_0_valueOrError0).IsFailure())) {
		panic("dafny/AwsCryptographyKeyStore/test/TestConfig.dfy(106,21): " + (_0_valueOrError0).String())
	}
	var _1_kmsClient m_ComAmazonawsKmsTypes.IKMSClient
	_ = _1_kmsClient
	_1_kmsClient = m_ComAmazonawsKmsTypes.Companion_IKMSClient_.CastTo_((_0_valueOrError0).Extract())
	...
	_2_valueOrError1 = _out1
	if !(!((_2_valueOrError1).IsFailure())) {
		panic("dafny/AwsCryptographyKeyStore/test/TestConfig.dfy(107,21): " + (_2_valueOrError1).String())
	}
	var _3_ddbClient m_ComAmazonawsDynamodbTypes.IDynamoDBClient
	_ = _3_ddbClient
	_3_ddbClient = m_ComAmazonawsDynamodbTypes.Companion_IDynamoDBClient_.CastTo_((_2_valueOrError1).Extract())
	...
	var _5_keyStoreConfig m_AwsCryptographyKeyStoreTypes.KeyStoreConfig
	_ = _5_keyStoreConfig
	_5_keyStoreConfig = m_AwsCryptographyKeyStoreTypes.Companion_KeyStoreConfig_.Create_KeyStoreConfig_(m_Fixtures.Companion_Default___.BranchKeyStoreName(), _4_kmsConfig, m_Fixtures.Companion_Default___.LogicalKeyStoreName(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_Some_(_3_ddbClient), m_Wrappers.Companion_Option_.Create_None_())
	var _6_keyStore m_Wrappers.Result
	_ = _6_keyStore
	var _out2 m_Wrappers.Result
	_ = _out2
	...
	_6_keyStore = _out2
	if !((_6_keyStore).Is_Success()) {
		panic("dafny/AwsCryptographyKeyStore/test/TestConfig.dfy(134,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
	_5_keyStoreConfig = m_AwsCryptographyKeyStoreTypes.Companion_KeyStoreConfig_.Create_KeyStoreConfig_(m_Fixtures.Companion_Default___.BranchKeyStoreName(), _4_kmsConfig, m_Fixtures.Companion_Default___.LogicalKeyStoreName(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_Some_(_1_kmsClient))
	var _out3 m_Wrappers.Result
	_ = _out3
	_out3 = m_KeyStore.Companion_Default___.KeyStore(_5_keyStoreConfig)
	_6_keyStore = _out3
	if !((_6_keyStore).Is_Success()) {
		panic("dafny/AwsCryptographyKeyStore/test/TestConfig.dfy(160,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
	_5_keyStoreConfig = m_AwsCryptographyKeyStoreTypes.Companion_KeyStoreConfig_.Create_KeyStoreConfig_(m_Fixtures.Companion_Default___.BranchKeyStoreName(), _4_kmsConfig, m_Fixtures.Companion_Default___.LogicalKeyStoreName(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_())
	var _out4 m_Wrappers.Result
	_ = _out4
	_out4 = m_KeyStore.Companion_Default___.KeyStore(_5_keyStoreConfig)
	_6_keyStore = _out4
	if !((_6_keyStore).Is_Success()) {
		panic("dafny/AwsCryptographyKeyStore/test/TestConfig.dfy(193,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
}
