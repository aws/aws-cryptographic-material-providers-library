// Package TestErrorMessages
// Dafny module TestErrorMessages compiled into Go
...
func (*Default__) String() string {
	return "TestErrorMessages.Default__"
}
...
func (_static *CompanionStruct_Default___) TestIncorrectRawDataKeys() {
	var _0_datakey _dafny.Sequence
	_ = _0_datakey
	_0_datakey = _dafny.SeqOfString("0")
	var _1_keyringName _dafny.Sequence
	_ = _1_keyringName
	_1_keyringName = _dafny.SeqOfString("RSAKeyring")
	var _2_keyProviderId _dafny.Sequence
	_ = _2_keyProviderId
	_2_keyProviderId = _dafny.SeqOfString("TestProvider")
	var _3_actualErrorMessage _dafny.Sequence
	_ = _3_actualErrorMessage
	_3_actualErrorMessage = m_ErrorMessages.Companion_Default___.IncorrectRawDataKeys(_0_datakey, _1_keyringName, _2_keyProviderId)
	var _4_ExpectErrorMessage _dafny.Sequence
	_ = _4_ExpectErrorMessage
	_4_ExpectErrorMessage = _dafny.SeqOfString("EncryptedDataKey 0 did not match RSAKeyring. Expected: keyProviderId: TestProvider.\n")
	if !(_dafny.Companion_Sequence_.Equal(_3_actualErrorMessage, _4_ExpectErrorMessage)) {
		panic("dafny/AwsCryptographicMaterialProviders/test/TestErrorMessages.dfy(22,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
}
func (_static *CompanionStruct_Default___) TestIncorrectDataKeys() {
	var _0_dummyKey _dafny.Sequence
	_ = _0_dummyKey
	_0_dummyKey = _dafny.SeqOf(m_AwsCryptographyMaterialProvidersTypes.Companion_EncryptedDataKey_.Create_EncryptedDataKey_(m_UTF8.Companion_Default___.EncodeAscii(_dafny.SeqOfString("aws-kms")), m_UTF8.Companion_Default___.EncodeAscii(_dafny.SeqOfString("keyproviderInfoA")), _dafny.SeqOf(uint8(1), uint8(2), uint8(3), uint8(4), uint8(5))), m_AwsCryptographyMaterialProvidersTypes.Companion_EncryptedDataKey_.Create_EncryptedDataKey_(m_UTF8.Companion_Default___.EncodeAscii(_dafny.SeqOfString("aws-kms-rsa")), m_UTF8.Companion_Default___.EncodeAscii(_dafny.SeqOfString("keyproviderInfoB")), _dafny.SeqOf(uint8(1), uint8(2), uint8(3), uint8(4), uint8(5))), m_AwsCryptographyMaterialProvidersTypes.Companion_EncryptedDataKey_.Create_EncryptedDataKey_(m_UTF8.Companion_Default___.EncodeAscii(_dafny.SeqOfString("aws-kms-hierarchy")), m_UTF8.Companion_Default___.EncodeAscii(_dafny.SeqOfString("keyproviderInfoC")), _dafny.SeqOf(uint8(64), uint8(92), uint8(115), uint8(7), uint8(85), uint8(121), uint8(112), uint8(79), uint8(69), uint8(12), uint8(82), uint8(25), uint8(67), uint8(34), uint8(11), uint8(66), uint8(93), uint8(45), uint8(40), uint8(23), uint8(90), uint8(61), uint8(16), uint8(28), uint8(59), uint8(114), uint8(52), uint8(122), uint8(50), uint8(23), uint8(11), uint8(101), uint8(48), uint8(53), uint8(30), uint8(120), uint8(51), uint8(74), uint8(77), uint8(53), uint8(57), uint8(99), uint8(53), uint8(13), uint8(30), uint8(21), uint8(109), uint8(85), uint8(15), uint8(86), uint8(47), uint8(84), uint8(91), uint8(85), uint8(87), uint8(60), uint8(4), uint8(56), uint8(67), uint8(74), uint8(29), uint8(87), uint8(85), uint8(106), uint8(8), uint8(82), uint8(63), uint8(114), uint8(100), uint8(110), uint8(68), uint8(58), uint8(83), uint8(24), uint8(111), uint8(41), uint8(21), uint8(91), uint8(122), uint8(61), uint8(118), uint8(37), uint8(72), uint8(38), uint8(67), uint8(2), uint8(17), uint8(61), uint8(17), uint8(121), uint8(7), uint8(90), uint8(117), uint8(49), uint8(30), uint8(20), uint8(89), uint8(68), uint8(33), uint8(111), uint8(107), uint8(5), uint8(120), uint8(20), uint8(95), uint8(78), uint8(70), uint8(2), uint8(49), uint8(84), uint8(39), uint8(50), uint8(40), uint8(40), uint8(115), uint8(114), uint8(76), uint8(18), uint8(103), uint8(84), uint8(34), uint8(123), uint8(1), uint8(125), uint8(61), uint8(33), uint8(13), uint8(18), uint8(81), uint8(24), uint8(53), uint8(53), uint8(26), uint8(60), uint8(52), uint8(85), uint8(81), uint8(96), uint8(85), uint8(72))))
	var _1_valueOrError0 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(_dafny.EmptySeq.SetString())
	_ = _1_valueOrError0
	_1_valueOrError0 = m_ErrorMessages.Companion_Default___.IncorrectDataKeys(_0_dummyKey, m_AlgorithmSuites.Companion_Default___.GetSuite(Companion_Default___.TEST__DBE__ALG__SUITE__ID()), _dafny.SeqOfString(""))
	if !(!((_1_valueOrError0).IsFailure())) {
		panic("dafny/AwsCryptographicMaterialProviders/test/TestErrorMessages.dfy(51,30): " + (_1_valueOrError0).String())
	}
	var _2_actualErrorMessage _dafny.Sequence
	_ = _2_actualErrorMessage
	_2_actualErrorMessage = (_1_valueOrError0).Extract().(_dafny.Sequence)
	var _3_ExpectErrorMessage _dafny.Sequence
	_ = _3_ExpectErrorMessage
	_3_ExpectErrorMessage = _dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.Companion_Sequence_.Concatenate(_dafny.SeqOfString("Unable to decrypt data key: No Encrypted Data Keys found to match. \n Expected: \n"), _dafny.SeqOfString("KeyProviderId: aws-kms, KeyProviderInfo: keyproviderInfoA\n")), _dafny.SeqOfString("KeyProviderId: aws-kms-rsa, KeyProviderInfo: keyproviderInfoB\n")), _dafny.SeqOfString("KeyProviderId: aws-kms-hierarchy, KeyProviderInfo: keyproviderInfoC, BranchKeyVersion: 155b7a3d-7625-4826-4302-113d1179075a\n"))
	if !(_dafny.Companion_Sequence_.Equal(_2_actualErrorMessage, _3_ExpectErrorMessage)) {
		panic("dafny/AwsCryptographicMaterialProviders/test/TestErrorMessages.dfy(56,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
}
