// Package TestDefaultClientProvider
// Dafny module TestDefaultClientProvider compiled into Go
...
func (*Default__) String() string {
	return "TestDefaultClientProvider.Default__"
}
...
func (_static *CompanionStruct_Default___) GetUsWestTwo() {
	...
	if !(!((_0_valueOrError0).IsFailure())) {
		panic("dafny/AwsCryptographicMaterialProviders/test/TestDefaultClientProvider.dfy(18,15): " + (_0_valueOrError0).String())
	}
	...
	if !(!((_2_valueOrError1).IsFailure())) {
		panic("dafny/AwsCryptographicMaterialProviders/test/TestDefaultClientProvider.dfy(20,26): " + (_2_valueOrError1).String())
	}
	...
	_ = _out2
	_out2 = (_3_clientSupplier).GetClient(m_AwsCryptographyMaterialProvidersTypes.Companion_GetClientInput_.Create_GetClientInput_(_dafny.SeqOfString("us-west-2")))
	_4_valueOrError2 = _out2
	if !(!((_4_valueOrError2).IsFailure())) {
		panic("dafny/AwsCryptographicMaterialProviders/test/TestDefaultClientProvider.dfy(22,18): " + (_4_valueOrError2).String())
	}
	var _5_client m_ComAmazonawsKmsTypes.IKMSClient
	_ = _5_client
	_5_client = m_ComAmazonawsKmsTypes.Companion_IKMSClient_.CastTo_((_4_valueOrError2).Extract())
	var _6_kmsRequest m_ComAmazonawsKmsTypes.GenerateDataKeyRequest
	_ = _6_kmsRequest
	_6_kmsRequest = m_ComAmazonawsKmsTypes.Companion_GenerateDataKeyRequest_.Create_GenerateDataKeyRequest_(m_TestUtils.Companion_Default___.SHARED__TEST__KEY__ARN(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_Some_(int32(24)), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_())
	var _7_valueOrError3 m_Wrappers.Result = m_Wrappers.Companion_Result_.Default(m_ComAmazonawsKmsTypes.Companion_GenerateDataKeyResponse_.Default())
	_ = _7_valueOrError3
	...
	if !(!((_7_valueOrError3).IsFailure())) {
		panic("dafny/AwsCryptographicMaterialProviders/test/TestDefaultClientProvider.dfy(36,20): " + (_7_valueOrError3).String())
	}
	var _8_kmsReply m_ComAmazonawsKmsTypes.GenerateDataKeyResponse
	_ = _8_kmsReply
	_8_kmsReply = (_7_valueOrError3).Extract().(m_ComAmazonawsKmsTypes.GenerateDataKeyResponse)
}
