// Package CleanupItems
// Dafny module CleanupItems compiled into Go
...
func (_static *CompanionStruct_Default___) DeleteVersion(branchKeyIdentifier _dafny.Sequence, branchKeyVersion _dafny.Sequence, ddbClient m_ComAmazonawsDynamodbTypes.IDynamoDBClient) {
	var _0___v0 m_Wrappers.Result
	_ = _0___v0
	var _out0 m_Wrappers.Result
	_ = _out0
	_out0 = (ddbClient).DeleteItem(m_ComAmazonawsDynamodbTypes.Companion_DeleteItemInput_.Create_DeleteItemInput_(m_Fixtures.Companion_Default___.BranchKeyStoreName(), _dafny.NewMapBuilder().ToMap().UpdateUnsafe(m_Structure.Companion_Default___.BRANCH__KEY__IDENTIFIER__FIELD(), m_ComAmazonawsDynamodbTypes.Companion_AttributeValue_.Create_S_(branchKeyIdentifier)).UpdateUnsafe(m_Structure.Companion_Default___.TYPE__FIELD(), m_ComAmazonawsDynamodbTypes.Companion_AttributeValue_.Create_S_(_dafny.Companion_Sequence_.Concatenate(m_Structure.Companion_Default___.BRANCH__KEY__TYPE__PREFIX(), branchKeyVersion))), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_()))
	_0___v0 = _out0
}
func (_static *CompanionStruct_Default___) DeleteActive(branchKeyIdentifier _dafny.Sequence, ddbClient m_ComAmazonawsDynamodbTypes.IDynamoDBClient) {
	var _0___v1 m_Wrappers.Result
	_ = _0___v1
	var _out0 m_Wrappers.Result
	_ = _out0
	...
	_0___v1 = _out0
	var _1___v2 m_Wrappers.Result
	_ = _1___v2
	var _out1 m_Wrappers.Result
	_ = _out1
	_out1 = (ddbClient).DeleteItem(m_ComAmazonawsDynamodbTypes.Companion_DeleteItemInput_.Create_DeleteItemInput_(m_Fixtures.Companion_Default___.BranchKeyStoreName(), _dafny.NewMapBuilder().ToMap().UpdateUnsafe(m_Structure.Companion_Default___.BRANCH__KEY__IDENTIFIER__FIELD(), m_ComAmazonawsDynamodbTypes.Companion_AttributeValue_.Create_S_(branchKeyIdentifier)).UpdateUnsafe(m_Structure.Companion_Default___.TYPE__FIELD(), m_ComAmazonawsDynamodbTypes.Companion_AttributeValue_.Create_S_(m_Structure.Companion_Default___.BEACON__KEY__TYPE__VALUE())), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_(), m_Wrappers.Companion_Option_.Create_None_()))
	_1___v2 = _out1
}
