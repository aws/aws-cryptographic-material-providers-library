// Package TestCreateKeyStore
// Dafny module TestCreateKeyStore compiled into Go
...
func (*Default__) String() string {
	return "TestCreateKeyStore.Default__"
}
...
func (_static *CompanionStruct_Default___) TestCreateKeyStore() {
	...
	if !(!((_0_valueOrError0).IsFailure())) {
		panic("dafny/AwsCryptographyKeyStore/test/TestCreateKeyStore.dfy(19,21): " + (_0_valueOrError0).String())
	}
	...
	if !(!((_2_valueOrError1).IsFailure())) {
		panic("dafny/AwsCryptographyKeyStore/test/TestCreateKeyStore.dfy(20,21): " + (_2_valueOrError1).String())
	}
	...
	if !(!((_6_valueOrError2).IsFailure())) {
		panic("dafny/AwsCryptographyKeyStore/test/TestCreateKeyStore.dfy(33,20): " + (_6_valueOrError2).String())
	}
	...
	_ = _out3
	_out3 = (_7_keyStore).CreateKeyStore(m_AwsCryptographyKeyStoreTypes.Companion_CreateKeyStoreInput_.Create_CreateKeyStoreInput_())
	_8_valueOrError3 = _out3
	if !(!((_8_valueOrError3).IsFailure())) {
		panic("dafny/AwsCryptographyKeyStore/test/TestCreateKeyStore.dfy(36,23): " + (_8_valueOrError3).String())
	}
	var _9_keyStoreArn m_AwsCryptographyKeyStoreTypes.CreateKeyStoreOutput
	_ = _9_keyStoreArn
	_9_keyStoreArn = (_8_valueOrError3).Extract().(m_AwsCryptographyKeyStoreTypes.CreateKeyStoreOutput)
	if !((m_AwsArnParsing.Companion_Default___.ParseAmazonDynamodbTableName((_9_keyStoreArn).Dtor_tableArn())).Is_Success()) {
		panic("dafny/AwsCryptographyKeyStore/test/TestCreateKeyStore.dfy(38,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
	if !(_dafny.Companion_Sequence_.Equal((m_AwsArnParsing.Companion_Default___.ParseAmazonDynamodbTableName((_9_keyStoreArn).Dtor_tableArn())).Dtor_value().(_dafny.Sequence), m_Fixtures.Companion_Default___.BranchKeyStoreName())) {
		panic("dafny/AwsCryptographyKeyStore/test/TestCreateKeyStore.dfy(39,4): " + (_dafny.SeqOfString("expectation violation")).String())
	}
}
