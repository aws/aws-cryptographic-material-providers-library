...
namespace AWS.Cryptography.KeyStore
{
  public static class TypeConversion
  {
    ...
    public static AWS.Cryptography.KeyStore.GetTableNameInput FromDafny_N3_aws__N12_cryptography__N8_keyStore__S17_GetTableNameInput(software.amazon.cryptography.keystore.internaldafny.types._IGetTableNameInput value)
    {
      software.amazon.cryptography.keystore.internaldafny.types.GetTableNameInput concrete = (software.amazon.cryptography.keystore.internaldafny.types.GetTableNameInput)value; AWS.Cryptography.KeyStore.GetTableNameInput converted = new AWS.Cryptography.KeyStore.GetTableNameInput(); return converted;
    }
    public static software.amazon.cryptography.keystore.internaldafny.types._IGetTableNameInput ToDafny_N3_aws__N12_cryptography__N8_keyStore__S17_GetTableNameInput(AWS.Cryptography.KeyStore.GetTableNameInput value)
    {
      value.Validate();

      return new software.amazon.cryptography.keystore.internaldafny.types.GetTableNameInput();
    }
    public static AWS.Cryptography.KeyStore.GetTableNameOutput FromDafny_N3_aws__N12_cryptography__N8_keyStore__S18_GetTableNameOutput(software.amazon.cryptography.keystore.internaldafny.types._IGetTableNameOutput value)
    {
      software.amazon.cryptography.keystore.internaldafny.types.GetTableNameOutput concrete = (software.amazon.cryptography.keystore.internaldafny.types.GetTableNameOutput)value; AWS.Cryptography.KeyStore.GetTableNameOutput converted = new AWS.Cryptography.KeyStore.GetTableNameOutput(); converted.Name = (string)FromDafny_N3_aws__N12_cryptography__N8_keyStore__S18_GetTableNameOutput__M4_Name(concrete._Name); return converted;
    }
    public static software.amazon.cryptography.keystore.internaldafny.types._IGetTableNameOutput ToDafny_N3_aws__N12_cryptography__N8_keyStore__S18_GetTableNameOutput(AWS.Cryptography.KeyStore.GetTableNameOutput value)
    {
      value.Validate();

      return new software.amazon.cryptography.keystore.internaldafny.types.GetTableNameOutput(ToDafny_N3_aws__N12_cryptography__N8_keyStore__S18_GetTableNameOutput__M4_Name(value.Name));
    }
    ...
    public static AWS.Cryptography.KeyStore.WriteNewBranchKeyVersionToKeystoreInput FromDafny_N3_aws__N12_cryptography__N8_keyStore__S39_WriteNewBranchKeyVersionToKeystoreInput(software.amazon.cryptography.keystore.internaldafny.types._IWriteNewBranchKeyVersionToKeystoreInput value)
    {
      software.amazon.cryptography.keystore.internaldafny.types.WriteNewBranchKeyVersionToKeystoreInput concrete = (software.amazon.cryptography.keystore.internaldafny.types.WriteNewBranchKeyVersionToKeystoreInput)value; AWS.Cryptography.KeyStore.WriteNewBranchKeyVersionToKeystoreInput converted = new AWS.Cryptography.KeyStore.WriteNewBranchKeyVersionToKeystoreInput(); converted.Active = (AWS.Cryptography.KeyStore.EncryptedHierarchicalKey)FromDafny_N3_aws__N12_cryptography__N8_keyStore__S39_WriteNewBranchKeyVersionToKeystoreInput__M6_Active(concrete._Active);
      converted.Version = (AWS.Cryptography.KeyStore.EncryptedHierarchicalKey)FromDafny_N3_aws__N12_cryptography__N8_keyStore__S39_WriteNewBranchKeyVersionToKeystoreInput__M7_Version(concrete._Version);
      converted.OldActive = (AWS.Cryptography.KeyStore.EncryptedHierarchicalKey)FromDafny_N3_aws__N12_cryptography__N8_keyStore__S39_WriteNewBranchKeyVersionToKeystoreInput__M9_oldActive(concrete._oldActive); return converted;
    }
    public static software.amazon.cryptography.keystore.internaldafny.types._IWriteNewBranchKeyVersionToKeystoreInput ToDafny_N3_aws__N12_cryptography__N8_keyStore__S39_WriteNewBranchKeyVersionToKeystoreInput(AWS.Cryptography.KeyStore.WriteNewBranchKeyVersionToKeystoreInput value)
    {
      value.Validate();

      return new software.amazon.cryptography.keystore.internaldafny.types.WriteNewBranchKeyVersionToKeystoreInput(ToDafny_N3_aws__N12_cryptography__N8_keyStore__S39_WriteNewBranchKeyVersionToKeystoreInput__M6_Active(value.Active), ToDafny_N3_aws__N12_cryptography__N8_keyStore__S39_WriteNewBranchKeyVersionToKeystoreInput__M7_Version(value.Version), ToDafny_N3_aws__N12_cryptography__N8_keyStore__S39_WriteNewBranchKeyVersionToKeystoreInput__M9_oldActive(value.OldActive));
    }
    public static AWS.Cryptography.KeyStore.WriteNewBranchKeyVersionToKeystoreOutput FromDafny_N3_aws__N12_cryptography__N8_keyStore__S40_WriteNewBranchKeyVersionToKeystoreOutput(software.amazon.cryptography.keystore.internaldafny.types._IWriteNewBranchKeyVersionToKeystoreOutput value)
    {
      software.amazon.cryptography.keystore.internaldafny.types.WriteNewBranchKeyVersionToKeystoreOutput concrete = (software.amazon.cryptography.keystore.internaldafny.types.WriteNewBranchKeyVersionToKeystoreOutput)value; AWS.Cryptography.KeyStore.WriteNewBranchKeyVersionToKeystoreOutput converted = new AWS.Cryptography.KeyStore.WriteNewBranchKeyVersionToKeystoreOutput(); return converted;
    }
    public static software.amazon.cryptography.keystore.internaldafny.types._IWriteNewBranchKeyVersionToKeystoreOutput ToDafny_N3_aws__N12_cryptography__N8_keyStore__S40_WriteNewBranchKeyVersionToKeystoreOutput(AWS.Cryptography.KeyStore.WriteNewBranchKeyVersionToKeystoreOutput value)
    {
      value.Validate();

      return new software.amazon.cryptography.keystore.internaldafny.types.WriteNewBranchKeyVersionToKeystoreOutput();
    }
    public static AWS.Cryptography.KeyStore.WriteNewKeyToStoreInput FromDafny_N3_aws__N12_cryptography__N8_keyStore__S23_WriteNewKeyToStoreInput(software.amazon.cryptography.keystore.internaldafny.types._IWriteNewKeyToStoreInput value)
    {
      software.amazon.cryptography.keystore.internaldafny.types.WriteNewKeyToStoreInput concrete = (software.amazon.cryptography.keystore.internaldafny.types.WriteNewKeyToStoreInput)value; AWS.Cryptography.KeyStore.WriteNewKeyToStoreInput converted = new AWS.Cryptography.KeyStore.WriteNewKeyToStoreInput(); converted.Active = (AWS.Cryptography.KeyStore.EncryptedHierarchicalKey)FromDafny_N3_aws__N12_cryptography__N8_keyStore__S23_WriteNewKeyToStoreInput__M6_Active(concrete._Active);
      converted.Version = (AWS.Cryptography.KeyStore.EncryptedHierarchicalKey)FromDafny_N3_aws__N12_cryptography__N8_keyStore__S23_WriteNewKeyToStoreInput__M7_Version(concrete._Version);
      converted.Beacon = (AWS.Cryptography.KeyStore.EncryptedHierarchicalKey)FromDafny_N3_aws__N12_cryptography__N8_keyStore__S23_WriteNewKeyToStoreInput__M6_Beacon(concrete._Beacon); return converted;
    }
    public static software.amazon.cryptography.keystore.internaldafny.types._IWriteNewKeyToStoreInput ToDafny_N3_aws__N12_cryptography__N8_keyStore__S23_WriteNewKeyToStoreInput(AWS.Cryptography.KeyStore.WriteNewKeyToStoreInput value)
    {
      value.Validate();

      return new software.amazon.cryptography.keystore.internaldafny.types.WriteNewKeyToStoreInput(ToDafny_N3_aws__N12_cryptography__N8_keyStore__S23_WriteNewKeyToStoreInput__M6_Active(value.Active), ToDafny_N3_aws__N12_cryptography__N8_keyStore__S23_WriteNewKeyToStoreInput__M7_Version(value.Version), ToDafny_N3_aws__N12_cryptography__N8_keyStore__S23_WriteNewKeyToStoreInput__M6_Beacon(value.Beacon));
    }
    public static AWS.Cryptography.KeyStore.WriteNewKeyToStoreOutput FromDafny_N3_aws__N12_cryptography__N8_keyStore__S24_WriteNewKeyToStoreOutput(software.amazon.cryptography.keystore.internaldafny.types._IWriteNewKeyToStoreOutput value)
    {
      software.amazon.cryptography.keystore.internaldafny.types.WriteNewKeyToStoreOutput concrete = (software.amazon.cryptography.keystore.internaldafny.types.WriteNewKeyToStoreOutput)value; AWS.Cryptography.KeyStore.WriteNewKeyToStoreOutput converted = new AWS.Cryptography.KeyStore.WriteNewKeyToStoreOutput(); return converted;
    }
    public static software.amazon.cryptography.keystore.internaldafny.types._IWriteNewKeyToStoreOutput ToDafny_N3_aws__N12_cryptography__N8_keyStore__S24_WriteNewKeyToStoreOutput(AWS.Cryptography.KeyStore.WriteNewKeyToStoreOutput value)
    {
      value.Validate();

      return new software.amazon.cryptography.keystore.internaldafny.types.WriteNewKeyToStoreOutput();
    }
    ...
    public static string FromDafny_N3_aws__N12_cryptography__N8_keyStore__S18_GetTableNameOutput__M4_Name(Dafny.ISequence<byte> value)
    {
      return FromDafny_N3_aws__N12_cryptography__N8_keyStore__S9_Utf8Bytes(value);
    }
    public static Dafny.ISequence<byte> ToDafny_N3_aws__N12_cryptography__N8_keyStore__S18_GetTableNameOutput__M4_Name(string value)
    {
    ...
    public static AWS.Cryptography.KeyStore.EncryptedHierarchicalKey FromDafny_N3_aws__N12_cryptography__N8_keyStore__S39_WriteNewBranchKeyVersionToKeystoreInput__M6_Active(software.amazon.cryptography.keystore.internaldafny.types._IEncryptedHierarchicalKey value)
    {
      return FromDafny_N3_aws__N12_cryptography__N8_keyStore__S24_EncryptedHierarchicalKey(value);
    }
    public static software.amazon.cryptography.keystore.internaldafny.types._IEncryptedHierarchicalKey ToDafny_N3_aws__N12_cryptography__N8_keyStore__S39_WriteNewBranchKeyVersionToKeystoreInput__M6_Active(AWS.Cryptography.KeyStore.EncryptedHierarchicalKey value)
    {
      return ToDafny_N3_aws__N12_cryptography__N8_keyStore__S24_EncryptedHierarchicalKey(value);
    }
    public static AWS.Cryptography.KeyStore.EncryptedHierarchicalKey FromDafny_N3_aws__N12_cryptography__N8_keyStore__S39_WriteNewBranchKeyVersionToKeystoreInput__M7_Version(software.amazon.cryptography.keystore.internaldafny.types._IEncryptedHierarchicalKey value)
    {
      return FromDafny_N3_aws__N12_cryptography__N8_keyStore__S24_EncryptedHierarchicalKey(value);
    }
    public static software.amazon.cryptography.keystore.internaldafny.types._IEncryptedHierarchicalKey ToDafny_N3_aws__N12_cryptography__N8_keyStore__S39_WriteNewBranchKeyVersionToKeystoreInput__M7_Version(AWS.Cryptography.KeyStore.EncryptedHierarchicalKey value)
    {
      return ToDafny_N3_aws__N12_cryptography__N8_keyStore__S24_EncryptedHierarchicalKey(value);
    }
    public static AWS.Cryptography.KeyStore.EncryptedHierarchicalKey FromDafny_N3_aws__N12_cryptography__N8_keyStore__S39_WriteNewBranchKeyVersionToKeystoreInput__M9_oldActive(software.amazon.cryptography.keystore.internaldafny.types._IEncryptedHierarchicalKey value)
    {
      return FromDafny_N3_aws__N12_cryptography__N8_keyStore__S24_EncryptedHierarchicalKey(value);
    }
    public static software.amazon.cryptography.keystore.internaldafny.types._IEncryptedHierarchicalKey ToDafny_N3_aws__N12_cryptography__N8_keyStore__S39_WriteNewBranchKeyVersionToKeystoreInput__M9_oldActive(AWS.Cryptography.KeyStore.EncryptedHierarchicalKey value)
    {
      return ToDafny_N3_aws__N12_cryptography__N8_keyStore__S24_EncryptedHierarchicalKey(value);
    }
    public static AWS.Cryptography.KeyStore.EncryptedHierarchicalKey FromDafny_N3_aws__N12_cryptography__N8_keyStore__S23_WriteNewKeyToStoreInput__M6_Active(software.amazon.cryptography.keystore.internaldafny.types._IEncryptedHierarchicalKey value)
    {
      return FromDafny_N3_aws__N12_cryptography__N8_keyStore__S24_EncryptedHierarchicalKey(value);
    }
    public static software.amazon.cryptography.keystore.internaldafny.types._IEncryptedHierarchicalKey ToDafny_N3_aws__N12_cryptography__N8_keyStore__S23_WriteNewKeyToStoreInput__M6_Active(AWS.Cryptography.KeyStore.EncryptedHierarchicalKey value)
    {
      return ToDafny_N3_aws__N12_cryptography__N8_keyStore__S24_EncryptedHierarchicalKey(value);
    }
    public static AWS.Cryptography.KeyStore.EncryptedHierarchicalKey FromDafny_N3_aws__N12_cryptography__N8_keyStore__S23_WriteNewKeyToStoreInput__M7_Version(software.amazon.cryptography.keystore.internaldafny.types._IEncryptedHierarchicalKey value)
    {
      return FromDafny_N3_aws__N12_cryptography__N8_keyStore__S24_EncryptedHierarchicalKey(value);
    }
    public static software.amazon.cryptography.keystore.internaldafny.types._IEncryptedHierarchicalKey ToDafny_N3_aws__N12_cryptography__N8_keyStore__S23_WriteNewKeyToStoreInput__M7_Version(AWS.Cryptography.KeyStore.EncryptedHierarchicalKey value)
    {
      return ToDafny_N3_aws__N12_cryptography__N8_keyStore__S24_EncryptedHierarchicalKey(value);
    }
    public static AWS.Cryptography.KeyStore.EncryptedHierarchicalKey FromDafny_N3_aws__N12_cryptography__N8_keyStore__S23_WriteNewKeyToStoreInput__M6_Beacon(software.amazon.cryptography.keystore.internaldafny.types._IEncryptedHierarchicalKey value)
    {
      return FromDafny_N3_aws__N12_cryptography__N8_keyStore__S24_EncryptedHierarchicalKey(value);
    }
    public static software.amazon.cryptography.keystore.internaldafny.types._IEncryptedHierarchicalKey ToDafny_N3_aws__N12_cryptography__N8_keyStore__S23_WriteNewKeyToStoreInput__M6_Beacon(AWS.Cryptography.KeyStore.EncryptedHierarchicalKey value)
    {
      return ToDafny_N3_aws__N12_cryptography__N8_keyStore__S24_EncryptedHierarchicalKey(value);
    }
