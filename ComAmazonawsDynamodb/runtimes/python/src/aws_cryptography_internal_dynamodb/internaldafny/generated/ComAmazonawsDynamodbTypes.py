...
class BatchStatementError:
    @classmethod
    def default(cls, ):
        return lambda: BatchStatementError_BatchStatementError(Wrappers.Option.default()(), Wrappers.Option.default()(), Wrappers.Option.default()())
    def __ne__(self, __o: object) -> bool:
        return not self.__eq__(__o)
    @property
...
class BatchStatementError_BatchStatementError(BatchStatementError, NamedTuple('BatchStatementError', [('Code', Any), ('Message', Any), ('Item', Any)])):
    def __dafnystr__(self) -> str:
        return f'ComAmazonawsDynamodbTypes.BatchStatementError.BatchStatementError({_dafny.string_of(self.Code)}, {_dafny.string_of(self.Message)}, {_dafny.string_of(self.Item)})'
    def __eq__(self, __o: object) -> bool:
        return isinstance(__o, BatchStatementError_BatchStatementError) and self.Code == __o.Code and self.Message == __o.Message and self.Item == __o.Item
    def __hash__(self) -> int:
        return super().__hash__()
...
class BatchStatementRequest:
    @classmethod
    def default(cls, ):
        return lambda: BatchStatementRequest_BatchStatementRequest(_dafny.Seq(""), Wrappers.Option.default()(), Wrappers.Option.default()(), Wrappers.Option.default()())
    def __ne__(self, __o: object) -> bool:
        return not self.__eq__(__o)
    @property
...
class BatchStatementRequest_BatchStatementRequest(BatchStatementRequest, NamedTuple('BatchStatementRequest', [('Statement', Any), ('Parameters', Any), ('ConsistentRead', Any), ('ReturnValuesOnConditionCheckFailure', Any)])):
    def __dafnystr__(self) -> str:
        return f'ComAmazonawsDynamodbTypes.BatchStatementRequest.BatchStatementRequest({_dafny.string_of(self.Statement)}, {_dafny.string_of(self.Parameters)}, {_dafny.string_of(self.ConsistentRead)}, {_dafny.string_of(self.ReturnValuesOnConditionCheckFailure)})'
    def __eq__(self, __o: object) -> bool:
        return isinstance(__o, BatchStatementRequest_BatchStatementRequest) and self.Statement == __o.Statement and self.Parameters == __o.Parameters and self.ConsistentRead == __o.ConsistentRead and self.ReturnValuesOnConditionCheckFailure == __o.ReturnValuesOnConditionCheckFailure
    def __hash__(self) -> int:
        return super().__hash__()
...
class DeleteItemInput:
    @classmethod
    def default(cls, ):
        return lambda: DeleteItemInput_DeleteItemInput(_dafny.Seq(""), _dafny.Map({}), Wrappers.Option.default()(), Wrappers.Option.default()(), Wrappers.Option.default()(), Wrappers.Option.default()(), Wrappers.Option.default()(), Wrappers.Option.default()(), Wrappers.Option.default()(), Wrappers.Option.default()(), Wrappers.Option.default()())
    def __ne__(self, __o: object) -> bool:
        return not self.__eq__(__o)
    @property
...
class DeleteItemInput_DeleteItemInput(DeleteItemInput, NamedTuple('DeleteItemInput', [('TableName', Any), ('Key', Any), ('Expected', Any), ('ConditionalOperator', Any), ('ReturnValues', Any), ('ReturnConsumedCapacity', Any), ('ReturnItemCollectionMetrics', Any), ('ConditionExpression', Any), ('ExpressionAttributeNames', Any), ('ExpressionAttributeValues', Any), ('ReturnValuesOnConditionCheckFailure', Any)])):
    def __dafnystr__(self) -> str:
...
class ExecuteStatementInput:
    @classmethod
    def default(cls, ):
        return lambda: ExecuteStatementInput_ExecuteStatementInput(_dafny.Seq(""), Wrappers.Option.default()(), Wrappers.Option.default()(), Wrappers.Option.default()(), Wrappers.Option.default()(), Wrappers.Option.default()(), Wrappers.Option.default()())
    def __ne__(self, __o: object) -> bool:
        return not self.__eq__(__o)
    @property
...
class ExecuteStatementInput_ExecuteStatementInput(ExecuteStatementInput, NamedTuple('ExecuteStatementInput', [('Statement', Any), ('Parameters', Any), ('ConsistentRead', Any), ('NextToken', Any), ('ReturnConsumedCapacity', Any), ('Limit', Any), ('ReturnValuesOnConditionCheckFailure', Any)])):
    def __dafnystr__(self) -> str:
        return f'ComAmazonawsDynamodbTypes.ExecuteStatementInput.ExecuteStatementInput({_dafny.string_of(self.Statement)}, {_dafny.string_of(self.Parameters)}, {_dafny.string_of(self.ConsistentRead)}, {_dafny.string_of(self.NextToken)}, {_dafny.string_of(self.ReturnConsumedCapacity)}, {_dafny.string_of(self.Limit)}, {_dafny.string_of(self.ReturnValuesOnConditionCheckFailure)})'
    def __eq__(self, __o: object) -> bool:
        return isinstance(__o, ExecuteStatementInput_ExecuteStatementInput) and self.Statement == __o.Statement and self.Parameters == __o.Parameters and self.ConsistentRead == __o.ConsistentRead and self.NextToken == __o.NextToken and self.ReturnConsumedCapacity == __o.ReturnConsumedCapacity and self.Limit == __o.Limit and self.ReturnValuesOnConditionCheckFailure == __o.ReturnValuesOnConditionCheckFailure
    def __hash__(self) -> int:
        return super().__hash__()
...
class ParameterizedStatement:
    @classmethod
    def default(cls, ):
        return lambda: ParameterizedStatement_ParameterizedStatement(_dafny.Seq(""), Wrappers.Option.default()(), Wrappers.Option.default()())
    def __ne__(self, __o: object) -> bool:
        return not self.__eq__(__o)
    @property
...
class ParameterizedStatement_ParameterizedStatement(ParameterizedStatement, NamedTuple('ParameterizedStatement', [('Statement', Any), ('Parameters', Any), ('ReturnValuesOnConditionCheckFailure', Any)])):
    def __dafnystr__(self) -> str:
        return f'ComAmazonawsDynamodbTypes.ParameterizedStatement.ParameterizedStatement({_dafny.string_of(self.Statement)}, {_dafny.string_of(self.Parameters)}, {_dafny.string_of(self.ReturnValuesOnConditionCheckFailure)})'
    def __eq__(self, __o: object) -> bool:
        return isinstance(__o, ParameterizedStatement_ParameterizedStatement) and self.Statement == __o.Statement and self.Parameters == __o.Parameters and self.ReturnValuesOnConditionCheckFailure == __o.ReturnValuesOnConditionCheckFailure
    def __hash__(self) -> int:
        return super().__hash__()
...
class PutItemInput:
    @classmethod
    def default(cls, ):
        return lambda: PutItemInput_PutItemInput(_dafny.Seq(""), _dafny.Map({}), Wrappers.Option.default()(), Wrappers.Option.default()(), Wrappers.Option.default()(), Wrappers.Option.default()(), Wrappers.Option.default()(), Wrappers.Option.default()(), Wrappers.Option.default()(), Wrappers.Option.default()(), Wrappers.Option.default()())
    def __ne__(self, __o: object) -> bool:
        return not self.__eq__(__o)
    @property
...
class PutItemInput_PutItemInput(PutItemInput, NamedTuple('PutItemInput', [('TableName', Any), ('Item', Any), ('Expected', Any), ('ReturnValues', Any), ('ReturnConsumedCapacity', Any), ('ReturnItemCollectionMetrics', Any), ('ConditionalOperator', Any), ('ConditionExpression', Any), ('ExpressionAttributeNames', Any), ('ExpressionAttributeValues', Any), ('ReturnValuesOnConditionCheckFailure', Any)])):
    def __dafnystr__(self) -> str:
        return f'ComAmazonawsDynamodbTypes.PutItemInput.PutItemInput({_dafny.string_of(self.TableName)}, {_dafny.string_of(self.Item)}, {_dafny.string_of(self.Expected)}, {_dafny.string_of(self.ReturnValues)}, {_dafny.string_of(self.ReturnConsumedCapacity)}, {_dafny.string_of(self.ReturnItemCollectionMetrics)}, {_dafny.string_of(self.ConditionalOperator)}, {_dafny.string_of(self.ConditionExpression)}, {_dafny.string_of(self.ExpressionAttributeNames)}, {_dafny.string_of(self.ExpressionAttributeValues)}, {_dafny.string_of(self.ReturnValuesOnConditionCheckFailure)})'
    def __eq__(self, __o: object) -> bool:
...
class UpdateItemInput:
    @classmethod
    def default(cls, ):
        return lambda: UpdateItemInput_UpdateItemInput(_dafny.Seq(""), _dafny.Map({}), Wrappers.Option.default()(), Wrappers.Option.default()(), Wrappers.Option.default()(), Wrappers.Option.default()(), Wrappers.Option.default()(), Wrappers.Option.default()(), Wrappers.Option.default()(), Wrappers.Option.default()(), Wrappers.Option.default()(), Wrappers.Option.default()(), Wrappers.Option.default()())
    def __ne__(self, __o: object) -> bool:
        return not self.__eq__(__o)
    @property
