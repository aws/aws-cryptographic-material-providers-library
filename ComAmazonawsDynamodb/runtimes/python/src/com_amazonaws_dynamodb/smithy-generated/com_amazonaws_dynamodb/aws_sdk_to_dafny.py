...
import module_
import smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny
...
def AwsSdkToDafny_com_amazonaws_dynamodb_TransactionCanceledException(input):
    return Error_TransactionCanceledException(
        Message=Seq(input["Message"]),
        CancellationReasons=Seq([smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_CancellationReason(list_element) for list_element in input["CancellationReasons"]]),
    )

def AwsSdkToDafny_com_amazonaws_dynamodb_CancellationReason(input):
    return DafnyCancellationReason(
        Item=Option_Some(Map({Seq(key): smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in input["Item"].items() })) if "Item" in input.keys() else Option_None(),
...
def AwsSdkToDafny_com_amazonaws_dynamodb_AttributeValue(input):
    if "S" in input.keys():
        ...
        AttributeValue_union_value = AttributeValue_M(Map({Seq(key): smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in input["M"].items() }))
    elif "L" in input.keys():
        AttributeValue_union_value = AttributeValue_L(Seq([smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AttributeValue(list_element) for list_element in input["L"]]))
...
def AwsSdkToDafny_com_amazonaws_dynamodb_BatchExecuteStatementInput(input):
    return DafnyBatchExecuteStatementInput(
        Statements=Seq([smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_BatchStatementRequest(list_element) for list_element in input["Statements"]]),
        ReturnConsumedCapacity=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ReturnConsumedCapacity(input["ReturnConsumedCapacity"])) if "ReturnConsumedCapacity" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_BatchStatementRequest(input):
    return DafnyBatchStatementRequest(
        ...
        Parameters=Option_Some(Seq([smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AttributeValue(list_element) for list_element in input["Parameters"]])) if "Parameters" in input.keys() else Option_None(),
...
def AwsSdkToDafny_com_amazonaws_dynamodb_BatchExecuteStatementOutput(input):
    return DafnyBatchExecuteStatementOutput(
        Responses=Option_Some(Seq([smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_BatchStatementResponse(list_element) for list_element in input["Responses"]])) if "Responses" in input.keys() else Option_None(),
        ConsumedCapacity=Option_Some(Seq([smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ConsumedCapacity(list_element) for list_element in input["ConsumedCapacity"]])) if "ConsumedCapacity" in input.keys() else Option_None(),
    )

def AwsSdkToDafny_com_amazonaws_dynamodb_BatchStatementResponse(input):
    return DafnyBatchStatementResponse(
        Error=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_BatchStatementError(input["Error"])) if "Error" in input.keys() else Option_None(),
...
def AwsSdkToDafny_com_amazonaws_dynamodb_BatchStatementError(input):
    return DafnyBatchStatementError(
        Code=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_BatchStatementErrorCodeEnum(input["Code"])) if "Code" in input.keys() else Option_None(),
        Message=Option_Some(Seq(input["Message"])) if "Message" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_ConsumedCapacity(input):
    return DafnyConsumedCapacity(
        ...
        Table=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_Capacity(input["Table"])) if "Table" in input.keys() else Option_None(),
        LocalSecondaryIndexes=Option_Some(Map({Seq(key): smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_Capacity(value) for (key, value) in input["LocalSecondaryIndexes"].items() })) if "LocalSecondaryIndexes" in input.keys() else Option_None(),
        GlobalSecondaryIndexes=Option_Some(Map({Seq(key): smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_Capacity(value) for (key, value) in input["GlobalSecondaryIndexes"].items() })) if "GlobalSecondaryIndexes" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_BatchGetItemInput(input):
    return DafnyBatchGetItemInput(
        RequestItems=Map({Seq(key): smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_KeysAndAttributes(value) for (key, value) in input["RequestItems"].items() }),
        ReturnConsumedCapacity=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ReturnConsumedCapacity(input["ReturnConsumedCapacity"])) if "ReturnConsumedCapacity" in input.keys() else Option_None(),
    )

def AwsSdkToDafny_com_amazonaws_dynamodb_KeysAndAttributes(input):
    return DafnyKeysAndAttributes(
        Keys=Seq([Map({Seq(key): smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in list_element.items() }) for list_element in input["Keys"]]),
...
def AwsSdkToDafny_com_amazonaws_dynamodb_BatchGetItemOutput(input):
    return DafnyBatchGetItemOutput(
        Responses=Option_Some(Map({Seq(key): Seq([Map({Seq(key): smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in list_element.items() }) for list_element in value]) for (key, value) in input["Responses"].items() })) if "Responses" in input.keys() else Option_None(),
        UnprocessedKeys=Option_Some(Map({Seq(key): smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_KeysAndAttributes(value) for (key, value) in input["UnprocessedKeys"].items() })) if "UnprocessedKeys" in input.keys() else Option_None(),
        ConsumedCapacity=Option_Some(Seq([smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ConsumedCapacity(list_element) for list_element in input["ConsumedCapacity"]])) if "ConsumedCapacity" in input.keys() else Option_None(),
    )

def AwsSdkToDafny_com_amazonaws_dynamodb_BatchWriteItemInput(input):
    return DafnyBatchWriteItemInput(
        RequestItems=Map({Seq(key): Seq([smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_WriteRequest(list_element) for list_element in value]) for (key, value) in input["RequestItems"].items() }),
        ReturnConsumedCapacity=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ReturnConsumedCapacity(input["ReturnConsumedCapacity"])) if "ReturnConsumedCapacity" in input.keys() else Option_None(),
        ReturnItemCollectionMetrics=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ReturnItemCollectionMetrics(input["ReturnItemCollectionMetrics"])) if "ReturnItemCollectionMetrics" in input.keys() else Option_None(),
    )

def AwsSdkToDafny_com_amazonaws_dynamodb_WriteRequest(input):
    return DafnyWriteRequest(
        PutRequest=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_PutRequest(input["PutRequest"])) if "PutRequest" in input.keys() else Option_None(),
        DeleteRequest=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_DeleteRequest(input["DeleteRequest"])) if "DeleteRequest" in input.keys() else Option_None(),
    )

def AwsSdkToDafny_com_amazonaws_dynamodb_PutRequest(input):
    return DafnyPutRequest(
        Item=Map({Seq(key): smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in input["Item"].items() }),
    )

def AwsSdkToDafny_com_amazonaws_dynamodb_DeleteRequest(input):
    return DafnyDeleteRequest(
        Key=Map({Seq(key): smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in input["Key"].items() }),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_BatchWriteItemOutput(input):
    return DafnyBatchWriteItemOutput(
        UnprocessedItems=Option_Some(Map({Seq(key): Seq([smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_WriteRequest(list_element) for list_element in value]) for (key, value) in input["UnprocessedItems"].items() })) if "UnprocessedItems" in input.keys() else Option_None(),
        ItemCollectionMetrics=Option_Some(Map({Seq(key): Seq([smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ItemCollectionMetrics(list_element) for list_element in value]) for (key, value) in input["ItemCollectionMetrics"].items() })) if "ItemCollectionMetrics" in input.keys() else Option_None(),
        ConsumedCapacity=Option_Some(Seq([smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ConsumedCapacity(list_element) for list_element in input["ConsumedCapacity"]])) if "ConsumedCapacity" in input.keys() else Option_None(),
    )

def AwsSdkToDafny_com_amazonaws_dynamodb_ItemCollectionMetrics(input):
    return DafnyItemCollectionMetrics(
        ItemCollectionKey=Option_Some(Map({Seq(key): smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in input["ItemCollectionKey"].items() })) if "ItemCollectionKey" in input.keys() else Option_None(),
...
def AwsSdkToDafny_com_amazonaws_dynamodb_CreateBackupOutput(input):
    return DafnyCreateBackupOutput(
        BackupDetails=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_BackupDetails(input["BackupDetails"])) if "BackupDetails" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_BackupDetails(input):
    return DafnyBackupDetails(
        ...
        BackupStatus=smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_BackupStatus(input["BackupStatus"]),
        BackupType=smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_BackupType(input["BackupType"]),
...
def AwsSdkToDafny_com_amazonaws_dynamodb_CreateGlobalTableInput(input):
    return DafnyCreateGlobalTableInput(
        ...
        ReplicationGroup=Seq([smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_Replica(list_element) for list_element in input["ReplicationGroup"]]),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_CreateGlobalTableOutput(input):
    return DafnyCreateGlobalTableOutput(
        GlobalTableDescription=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_GlobalTableDescription(input["GlobalTableDescription"])) if "GlobalTableDescription" in input.keys() else Option_None(),
    )

def AwsSdkToDafny_com_amazonaws_dynamodb_GlobalTableDescription(input):
    return DafnyGlobalTableDescription(
        ReplicationGroup=Option_Some(Seq([smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ReplicaDescription(list_element) for list_element in input["ReplicationGroup"]])) if "ReplicationGroup" in input.keys() else Option_None(),
        ...
        GlobalTableStatus=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_GlobalTableStatus(input["GlobalTableStatus"])) if "GlobalTableStatus" in input.keys() else Option_None(),
...
def AwsSdkToDafny_com_amazonaws_dynamodb_ReplicaDescription(input):
    return DafnyReplicaDescription(
        RegionName=Option_Some(Seq(input["RegionName"])) if "RegionName" in input.keys() else Option_None(),
        ReplicaStatus=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ReplicaStatus(input["ReplicaStatus"])) if "ReplicaStatus" in input.keys() else Option_None(),
        ...
        ProvisionedThroughputOverride=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ProvisionedThroughputOverride(input["ProvisionedThroughputOverride"])) if "ProvisionedThroughputOverride" in input.keys() else Option_None(),
        GlobalSecondaryIndexes=Option_Some(Seq([smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ReplicaGlobalSecondaryIndexDescription(list_element) for list_element in input["GlobalSecondaryIndexes"]])) if "GlobalSecondaryIndexes" in input.keys() else Option_None(),
        ...
        ReplicaTableClassSummary=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_TableClassSummary(input["ReplicaTableClassSummary"])) if "ReplicaTableClassSummary" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_TableClassSummary(input):
    return DafnyTableClassSummary(
        TableClass=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_TableClass(input["TableClass"])) if "TableClass" in input.keys() else Option_None(),
...
def AwsSdkToDafny_com_amazonaws_dynamodb_CreateTableInput(input):
    return DafnyCreateTableInput(
        AttributeDefinitions=Seq([smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AttributeDefinition(list_element) for list_element in input["AttributeDefinitions"]]),
        TableName=Seq(input["TableName"]),
        KeySchema=Seq([smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_KeySchemaElement(list_element) for list_element in input["KeySchema"]]),
        LocalSecondaryIndexes=Option_Some(Seq([smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_LocalSecondaryIndex(list_element) for list_element in input["LocalSecondaryIndexes"]])) if "LocalSecondaryIndexes" in input.keys() else Option_None(),
        GlobalSecondaryIndexes=Option_Some(Seq([smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_GlobalSecondaryIndex(list_element) for list_element in input["GlobalSecondaryIndexes"]])) if "GlobalSecondaryIndexes" in input.keys() else Option_None(),
        BillingMode=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_BillingMode(input["BillingMode"])) if "BillingMode" in input.keys() else Option_None(),
        ProvisionedThroughput=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ProvisionedThroughput(input["ProvisionedThroughput"])) if "ProvisionedThroughput" in input.keys() else Option_None(),
        StreamSpecification=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_StreamSpecification(input["StreamSpecification"])) if "StreamSpecification" in input.keys() else Option_None(),
        SSESpecification=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_SSESpecification(input["SSESpecification"])) if "SSESpecification" in input.keys() else Option_None(),
        Tags=Option_Some(Seq([smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_Tag(list_element) for list_element in input["Tags"]])) if "Tags" in input.keys() else Option_None(),
        TableClass=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_TableClass(input["TableClass"])) if "TableClass" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_AttributeDefinition(input):
    return DafnyAttributeDefinition(
        ...
        AttributeType=smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ScalarAttributeType(input["AttributeType"]),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_KeySchemaElement(input):
    return DafnyKeySchemaElement(
        AttributeName=Seq(input["AttributeName"]),
        KeyType=smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_KeyType(input["KeyType"]),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_LocalSecondaryIndex(input):
    return DafnyLocalSecondaryIndex(
        ...
        KeySchema=Seq([smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_KeySchemaElement(list_element) for list_element in input["KeySchema"]]),
        Projection=smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_Projection(input["Projection"]),
    )

def AwsSdkToDafny_com_amazonaws_dynamodb_Projection(input):
    return DafnyProjection(
        ProjectionType=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ProjectionType(input["ProjectionType"])) if "ProjectionType" in input.keys() else Option_None(),
...
def AwsSdkToDafny_com_amazonaws_dynamodb_StreamSpecification(input):
    return DafnyStreamSpecification(
        ...
        StreamViewType=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_StreamViewType(input["StreamViewType"])) if "StreamViewType" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_SSESpecification(input):
    return DafnySSESpecification(
        ...
        SSEType=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_SSEType(input["SSEType"])) if "SSEType" in input.keys() else Option_None(),
        KMSMasterKeyId=Option_Some(Seq(input["KMSMasterKeyId"])) if "KMSMasterKeyId" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_CreateTableOutput(input):
    return DafnyCreateTableOutput(
        TableDescription=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_TableDescription(input["TableDescription"])) if "TableDescription" in input.keys() else Option_None(),
    )

def AwsSdkToDafny_com_amazonaws_dynamodb_TableDescription(input):
    return DafnyTableDescription(
        AttributeDefinitions=Option_Some(Seq([smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AttributeDefinition(list_element) for list_element in input["AttributeDefinitions"]])) if "AttributeDefinitions" in input.keys() else Option_None(),
        TableName=Option_Some(Seq(input["TableName"])) if "TableName" in input.keys() else Option_None(),
        KeySchema=Option_Some(Seq([smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_KeySchemaElement(list_element) for list_element in input["KeySchema"]])) if "KeySchema" in input.keys() else Option_None(),
        TableStatus=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_TableStatus(input["TableStatus"])) if "TableStatus" in input.keys() else Option_None(),
        CreationDateTime=Option_Some(TypeError("TimestampShape not supported")) if "CreationDateTime" in input.keys() else Option_None(),
        ProvisionedThroughput=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ProvisionedThroughputDescription(input["ProvisionedThroughput"])) if "ProvisionedThroughput" in input.keys() else Option_None(),
        ...
        BillingModeSummary=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_BillingModeSummary(input["BillingModeSummary"])) if "BillingModeSummary" in input.keys() else Option_None(),
        LocalSecondaryIndexes=Option_Some(Seq([smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_LocalSecondaryIndexDescription(list_element) for list_element in input["LocalSecondaryIndexes"]])) if "LocalSecondaryIndexes" in input.keys() else Option_None(),
        GlobalSecondaryIndexes=Option_Some(Seq([smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_GlobalSecondaryIndexDescription(list_element) for list_element in input["GlobalSecondaryIndexes"]])) if "GlobalSecondaryIndexes" in input.keys() else Option_None(),
        StreamSpecification=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_StreamSpecification(input["StreamSpecification"])) if "StreamSpecification" in input.keys() else Option_None(),
        ...
        Replicas=Option_Some(Seq([smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ReplicaDescription(list_element) for list_element in input["Replicas"]])) if "Replicas" in input.keys() else Option_None(),
        RestoreSummary=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_RestoreSummary(input["RestoreSummary"])) if "RestoreSummary" in input.keys() else Option_None(),
        SSEDescription=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_SSEDescription(input["SSEDescription"])) if "SSEDescription" in input.keys() else Option_None(),
        ArchivalSummary=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ArchivalSummary(input["ArchivalSummary"])) if "ArchivalSummary" in input.keys() else Option_None(),
        TableClassSummary=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_TableClassSummary(input["TableClassSummary"])) if "TableClassSummary" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_LocalSecondaryIndexDescription(input):
    return DafnyLocalSecondaryIndexDescription(
        IndexName=Option_Some(Seq(input["IndexName"])) if "IndexName" in input.keys() else Option_None(),
        KeySchema=Option_Some(Seq([smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_KeySchemaElement(list_element) for list_element in input["KeySchema"]])) if "KeySchema" in input.keys() else Option_None(),
        Projection=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_Projection(input["Projection"])) if "Projection" in input.keys() else Option_None(),
...
def AwsSdkToDafny_com_amazonaws_dynamodb_GlobalSecondaryIndexDescription(input):
    return DafnyGlobalSecondaryIndexDescription(
        ...
        KeySchema=Option_Some(Seq([smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_KeySchemaElement(list_element) for list_element in input["KeySchema"]])) if "KeySchema" in input.keys() else Option_None(),
        Projection=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_Projection(input["Projection"])) if "Projection" in input.keys() else Option_None(),
        IndexStatus=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_IndexStatus(input["IndexStatus"])) if "IndexStatus" in input.keys() else Option_None(),
...
def AwsSdkToDafny_com_amazonaws_dynamodb_SSEDescription(input):
    return DafnySSEDescription(
        Status=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_SSEStatus(input["Status"])) if "Status" in input.keys() else Option_None(),
        SSEType=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_SSEType(input["SSEType"])) if "SSEType" in input.keys() else Option_None(),
...
def AwsSdkToDafny_com_amazonaws_dynamodb_DeleteBackupOutput(input):
    return DafnyDeleteBackupOutput(
        BackupDescription=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_BackupDescription(input["BackupDescription"])) if "BackupDescription" in input.keys() else Option_None(),
    )

def AwsSdkToDafny_com_amazonaws_dynamodb_BackupDescription(input):
    return DafnyBackupDescription(
        BackupDetails=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_BackupDetails(input["BackupDetails"])) if "BackupDetails" in input.keys() else Option_None(),
        SourceTableDetails=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_SourceTableDetails(input["SourceTableDetails"])) if "SourceTableDetails" in input.keys() else Option_None(),
        SourceTableFeatureDetails=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_SourceTableFeatureDetails(input["SourceTableFeatureDetails"])) if "SourceTableFeatureDetails" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_SourceTableDetails(input):
    return DafnySourceTableDetails(
        ...
        ProvisionedThroughput=smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ProvisionedThroughput(input["ProvisionedThroughput"]),
        ItemCount=Option_Some(input["ItemCount"]) if "ItemCount" in input.keys() else Option_None(),
        BillingMode=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_BillingMode(input["BillingMode"])) if "BillingMode" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_SourceTableFeatureDetails(input):
    return DafnySourceTableFeatureDetails(
        LocalSecondaryIndexes=Option_Some(Seq([smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_LocalSecondaryIndexInfo(list_element) for list_element in input["LocalSecondaryIndexes"]])) if "LocalSecondaryIndexes" in input.keys() else Option_None(),
        GlobalSecondaryIndexes=Option_Some(Seq([smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_GlobalSecondaryIndexInfo(list_element) for list_element in input["GlobalSecondaryIndexes"]])) if "GlobalSecondaryIndexes" in input.keys() else Option_None(),
        StreamDescription=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_StreamSpecification(input["StreamDescription"])) if "StreamDescription" in input.keys() else Option_None(),
        TimeToLiveDescription=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_TimeToLiveDescription(input["TimeToLiveDescription"])) if "TimeToLiveDescription" in input.keys() else Option_None(),
        SSEDescription=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_SSEDescription(input["SSEDescription"])) if "SSEDescription" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_TimeToLiveDescription(input):
    return DafnyTimeToLiveDescription(
        TimeToLiveStatus=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_TimeToLiveStatus(input["TimeToLiveStatus"])) if "TimeToLiveStatus" in input.keys() else Option_None(),
...
def AwsSdkToDafny_com_amazonaws_dynamodb_DeleteItemInput(input):
    return DafnyDeleteItemInput(
        TableName=Seq(input["TableName"]),
        Key=Map({Seq(key): smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in input["Key"].items() }),
        Expected=Option_Some(Map({Seq(key): smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ExpectedAttributeValue(value) for (key, value) in input["Expected"].items() })) if "Expected" in input.keys() else Option_None(),
        ConditionalOperator=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ConditionalOperator(input["ConditionalOperator"])) if "ConditionalOperator" in input.keys() else Option_None(),
        ReturnValues=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ReturnValue(input["ReturnValues"])) if "ReturnValues" in input.keys() else Option_None(),
        ReturnConsumedCapacity=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ReturnConsumedCapacity(input["ReturnConsumedCapacity"])) if "ReturnConsumedCapacity" in input.keys() else Option_None(),
        ReturnItemCollectionMetrics=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ReturnItemCollectionMetrics(input["ReturnItemCollectionMetrics"])) if "ReturnItemCollectionMetrics" in input.keys() else Option_None(),
        ConditionExpression=Option_Some(Seq(input["ConditionExpression"])) if "ConditionExpression" in input.keys() else Option_None(),
        ExpressionAttributeNames=Option_Some(Map({Seq(key): Seq(value) for (key, value) in input["ExpressionAttributeNames"].items() })) if "ExpressionAttributeNames" in input.keys() else Option_None(),
        ExpressionAttributeValues=Option_Some(Map({Seq(key): smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in input["ExpressionAttributeValues"].items() })) if "ExpressionAttributeValues" in input.keys() else Option_None(),
    )

def AwsSdkToDafny_com_amazonaws_dynamodb_ExpectedAttributeValue(input):
    return DafnyExpectedAttributeValue(
        Value=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AttributeValue(input["Value"])) if "Value" in input.keys() else Option_None(),
        Exists=Option_Some(input["Exists"]) if "Exists" in input.keys() else Option_None(),
        ComparisonOperator=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ComparisonOperator(input["ComparisonOperator"])) if "ComparisonOperator" in input.keys() else Option_None(),
        AttributeValueList=Option_Some(Seq([smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AttributeValue(list_element) for list_element in input["AttributeValueList"]])) if "AttributeValueList" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_DeleteItemOutput(input):
    return DafnyDeleteItemOutput(
        Attributes=Option_Some(Map({Seq(key): smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in input["Attributes"].items() })) if "Attributes" in input.keys() else Option_None(),
        ConsumedCapacity=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ConsumedCapacity(input["ConsumedCapacity"])) if "ConsumedCapacity" in input.keys() else Option_None(),
        ItemCollectionMetrics=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ItemCollectionMetrics(input["ItemCollectionMetrics"])) if "ItemCollectionMetrics" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_DescribeContinuousBackupsOutput(input):
    return DafnyDescribeContinuousBackupsOutput(
        ContinuousBackupsDescription=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ContinuousBackupsDescription(input["ContinuousBackupsDescription"])) if "ContinuousBackupsDescription" in input.keys() else Option_None(),
    )

def AwsSdkToDafny_com_amazonaws_dynamodb_ContinuousBackupsDescription(input):
    return DafnyContinuousBackupsDescription(
        ContinuousBackupsStatus=smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ContinuousBackupsStatus(input["ContinuousBackupsStatus"]),
        PointInTimeRecoveryDescription=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_PointInTimeRecoveryDescription(input["PointInTimeRecoveryDescription"])) if "PointInTimeRecoveryDescription" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_PointInTimeRecoveryDescription(input):
    return DafnyPointInTimeRecoveryDescription(
        PointInTimeRecoveryStatus=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_PointInTimeRecoveryStatus(input["PointInTimeRecoveryStatus"])) if "PointInTimeRecoveryStatus" in input.keys() else Option_None(),
...
def AwsSdkToDafny_com_amazonaws_dynamodb_DescribeContributorInsightsOutput(input):
    return DafnyDescribeContributorInsightsOutput(
        ...
        ContributorInsightsStatus=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ContributorInsightsStatus(input["ContributorInsightsStatus"])) if "ContributorInsightsStatus" in input.keys() else Option_None(),
        LastUpdateDateTime=Option_Some(TypeError("TimestampShape not supported")) if "LastUpdateDateTime" in input.keys() else Option_None(),
        FailureException=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_FailureException(input["FailureException"])) if "FailureException" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_DescribeEndpointsResponse(input):
    return DafnyDescribeEndpointsResponse(
        Endpoints=Seq([smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_Endpoint(list_element) for list_element in input["Endpoints"]]),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_DescribeExportOutput(input):
    return DafnyDescribeExportOutput(
        ExportDescription=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ExportDescription(input["ExportDescription"])) if "ExportDescription" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_ExportDescription(input):
    return DafnyExportDescription(
        ...
        ExportStatus=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ExportStatus(input["ExportStatus"])) if "ExportStatus" in input.keys() else Option_None(),
        ...
        S3SseAlgorithm=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_S3SseAlgorithm(input["S3SseAlgorithm"])) if "S3SseAlgorithm" in input.keys() else Option_None(),
        ...
        ExportFormat=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ExportFormat(input["ExportFormat"])) if "ExportFormat" in input.keys() else Option_None(),
...
def AwsSdkToDafny_com_amazonaws_dynamodb_DescribeGlobalTableSettingsOutput(input):
    return DafnyDescribeGlobalTableSettingsOutput(
        GlobalTableName=Option_Some(Seq(input["GlobalTableName"])) if "GlobalTableName" in input.keys() else Option_None(),
        ReplicaSettings=Option_Some(Seq([smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ReplicaSettingsDescription(list_element) for list_element in input["ReplicaSettings"]])) if "ReplicaSettings" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_ReplicaSettingsDescription(input):
    return DafnyReplicaSettingsDescription(
        ...
        ReplicaStatus=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ReplicaStatus(input["ReplicaStatus"])) if "ReplicaStatus" in input.keys() else Option_None(),
        ReplicaBillingModeSummary=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_BillingModeSummary(input["ReplicaBillingModeSummary"])) if "ReplicaBillingModeSummary" in input.keys() else Option_None(),
...
def AwsSdkToDafny_com_amazonaws_dynamodb_AutoScalingSettingsDescription(input):
    return DafnyAutoScalingSettingsDescription(
        ...
        ScalingPolicies=Option_Some(Seq([smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AutoScalingPolicyDescription(list_element) for list_element in input["ScalingPolicies"]])) if "ScalingPolicies" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_DescribeImportOutput(input):
    return DafnyDescribeImportOutput(
        ImportTableDescription=smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ImportTableDescription(input["ImportTableDescription"]),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_ImportTableDescription(input):
    return DafnyImportTableDescription(
        ...
        ImportStatus=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ImportStatus(input["ImportStatus"])) if "ImportStatus" in input.keys() else Option_None(),
        TableArn=Option_Some(Seq(input["TableArn"])) if "TableArn" in input.keys() else Option_None(),
        TableId=Option_Some(Seq(input["TableId"])) if "TableId" in input.keys() else Option_None(),
        ClientToken=Option_Some(Seq(input["ClientToken"])) if "ClientToken" in input.keys() else Option_None(),
        S3BucketSource=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_S3BucketSource(input["S3BucketSource"])) if "S3BucketSource" in input.keys() else Option_None(),
        ...
        InputFormat=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_InputFormat(input["InputFormat"])) if "InputFormat" in input.keys() else Option_None(),
        InputFormatOptions=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_InputFormatOptions(input["InputFormatOptions"])) if "InputFormatOptions" in input.keys() else Option_None(),
        InputCompressionType=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_InputCompressionType(input["InputCompressionType"])) if "InputCompressionType" in input.keys() else Option_None(),
        TableCreationParameters=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_TableCreationParameters(input["TableCreationParameters"])) if "TableCreationParameters" in input.keys() else Option_None(),
        StartTime=Option_Some(TypeError("TimestampShape not supported")) if "StartTime" in input.keys() else Option_None(),
        EndTime=Option_Some(TypeError("TimestampShape not supported")) if "EndTime" in input.keys() else Option_None(),
...
def AwsSdkToDafny_com_amazonaws_dynamodb_InputFormatOptions(input):
    return DafnyInputFormatOptions(
        Csv=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_CsvOptions(input["Csv"])) if "Csv" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_DescribeKinesisStreamingDestinationOutput(input):
    return DafnyDescribeKinesisStreamingDestinationOutput(
        TableName=Option_Some(Seq(input["TableName"])) if "TableName" in input.keys() else Option_None(),
        KinesisDataStreamDestinations=Option_Some(Seq([smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_KinesisDataStreamDestination(list_element) for list_element in input["KinesisDataStreamDestinations"]])) if "KinesisDataStreamDestinations" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_KinesisDataStreamDestination(input):
    return DafnyKinesisDataStreamDestination(
        ...
        DestinationStatus=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_DestinationStatus(input["DestinationStatus"])) if "DestinationStatus" in input.keys() else Option_None(),
...
def AwsSdkToDafny_com_amazonaws_dynamodb_DescribeTableOutput(input):
    return DafnyDescribeTableOutput(
        Table=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_TableDescription(input["Table"])) if "Table" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_DescribeTableReplicaAutoScalingOutput(input):
    return DafnyDescribeTableReplicaAutoScalingOutput(
        TableAutoScalingDescription=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_TableAutoScalingDescription(input["TableAutoScalingDescription"])) if "TableAutoScalingDescription" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_TableAutoScalingDescription(input):
    return DafnyTableAutoScalingDescription(
        TableName=Option_Some(Seq(input["TableName"])) if "TableName" in input.keys() else Option_None(),
        TableStatus=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_TableStatus(input["TableStatus"])) if "TableStatus" in input.keys() else Option_None(),
        Replicas=Option_Some(Seq([smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ReplicaAutoScalingDescription(list_element) for list_element in input["Replicas"]])) if "Replicas" in input.keys() else Option_None(),
    )

def AwsSdkToDafny_com_amazonaws_dynamodb_ReplicaAutoScalingDescription(input):
    return DafnyReplicaAutoScalingDescription(
        RegionName=Option_Some(Seq(input["RegionName"])) if "RegionName" in input.keys() else Option_None(),
        GlobalSecondaryIndexes=Option_Some(Seq([smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ReplicaGlobalSecondaryIndexAutoScalingDescription(list_element) for list_element in input["GlobalSecondaryIndexes"]])) if "GlobalSecondaryIndexes" in input.keys() else Option_None(),
        ReplicaProvisionedReadCapacityAutoScalingSettings=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AutoScalingSettingsDescription(input["ReplicaProvisionedReadCapacityAutoScalingSettings"])) if "ReplicaProvisionedReadCapacityAutoScalingSettings" in input.keys() else Option_None(),
        ReplicaProvisionedWriteCapacityAutoScalingSettings=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AutoScalingSettingsDescription(input["ReplicaProvisionedWriteCapacityAutoScalingSettings"])) if "ReplicaProvisionedWriteCapacityAutoScalingSettings" in input.keys() else Option_None(),
        ReplicaStatus=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ReplicaStatus(input["ReplicaStatus"])) if "ReplicaStatus" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_ExecuteStatementOutput(input):
    return DafnyExecuteStatementOutput(
        Items=Option_Some(Seq([Map({Seq(key): smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in list_element.items() }) for list_element in input["Items"]])) if "Items" in input.keys() else Option_None(),
        NextToken=Option_Some(Seq(input["NextToken"])) if "NextToken" in input.keys() else Option_None(),
        ConsumedCapacity=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ConsumedCapacity(input["ConsumedCapacity"])) if "ConsumedCapacity" in input.keys() else Option_None(),
        LastEvaluatedKey=Option_Some(Map({Seq(key): smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in input["LastEvaluatedKey"].items() })) if "LastEvaluatedKey" in input.keys() else Option_None(),
    )

def AwsSdkToDafny_com_amazonaws_dynamodb_ExecuteTransactionInput(input):
    return DafnyExecuteTransactionInput(
        TransactStatements=Seq([smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ParameterizedStatement(list_element) for list_element in input["TransactStatements"]]),
...
def AwsSdkToDafny_com_amazonaws_dynamodb_ExecuteTransactionOutput(input):
    return DafnyExecuteTransactionOutput(
        Responses=Option_Some(Seq([smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ItemResponse(list_element) for list_element in input["Responses"]])) if "Responses" in input.keys() else Option_None(),
        ConsumedCapacity=Option_Some(Seq([smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ConsumedCapacity(list_element) for list_element in input["ConsumedCapacity"]])) if "ConsumedCapacity" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_ImportTableInput(input):
    return DafnyImportTableInput(
        ClientToken=Option_Some(Seq(input["ClientToken"])) if "ClientToken" in input.keys() else Option_None(),
        S3BucketSource=smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_S3BucketSource(input["S3BucketSource"]),
        InputFormat=smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_InputFormat(input["InputFormat"]),
        InputFormatOptions=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_InputFormatOptions(input["InputFormatOptions"])) if "InputFormatOptions" in input.keys() else Option_None(),
        InputCompressionType=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_InputCompressionType(input["InputCompressionType"])) if "InputCompressionType" in input.keys() else Option_None(),
        TableCreationParameters=smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_TableCreationParameters(input["TableCreationParameters"]),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_ListBackupsInput(input):
    return DafnyListBackupsInput(
        ...
        BackupType=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_BackupTypeFilter(input["BackupType"])) if "BackupType" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_ListBackupsOutput(input):
    return DafnyListBackupsOutput(
        BackupSummaries=Option_Some(Seq([smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_BackupSummary(list_element) for list_element in input["BackupSummaries"]])) if "BackupSummaries" in input.keys() else Option_None(),
...
def AwsSdkToDafny_com_amazonaws_dynamodb_BackupSummary(input):
    return DafnyBackupSummary(
        ...
        BackupExpiryDateTime=Option_Some(TypeError("TimestampShape not supported")) if "BackupExpiryDateTime" in input.keys() else Option_None(),
        BackupStatus=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_BackupStatus(input["BackupStatus"])) if "BackupStatus" in input.keys() else Option_None(),
        BackupType=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_BackupType(input["BackupType"])) if "BackupType" in input.keys() else Option_None(),
        BackupSizeBytes=Option_Some(input["BackupSizeBytes"]) if "BackupSizeBytes" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_ListContributorInsightsOutput(input):
    return DafnyListContributorInsightsOutput(
        ContributorInsightsSummaries=Option_Some(Seq([smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ContributorInsightsSummary(list_element) for list_element in input["ContributorInsightsSummaries"]])) if "ContributorInsightsSummaries" in input.keys() else Option_None(),
        NextToken=Option_Some(Seq(input["NextToken"])) if "NextToken" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_ListExportsOutput(input):
    return DafnyListExportsOutput(
        ExportSummaries=Option_Some(Seq([smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ExportSummary(list_element) for list_element in input["ExportSummaries"]])) if "ExportSummaries" in input.keys() else Option_None(),
        NextToken=Option_Some(Seq(input["NextToken"])) if "NextToken" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_ListGlobalTablesOutput(input):
    return DafnyListGlobalTablesOutput(
        GlobalTables=Option_Some(Seq([smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_GlobalTable(list_element) for list_element in input["GlobalTables"]])) if "GlobalTables" in input.keys() else Option_None(),
...
def AwsSdkToDafny_com_amazonaws_dynamodb_GlobalTable(input):
    return DafnyGlobalTable(
        GlobalTableName=Option_Some(Seq(input["GlobalTableName"])) if "GlobalTableName" in input.keys() else Option_None(),
        ReplicationGroup=Option_Some(Seq([smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_Replica(list_element) for list_element in input["ReplicationGroup"]])) if "ReplicationGroup" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_ListImportsOutput(input):
    return DafnyListImportsOutput(
        ImportSummaryList=Option_Some(Seq([smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ImportSummary(list_element) for list_element in input["ImportSummaryList"]])) if "ImportSummaryList" in input.keys() else Option_None(),
        NextToken=Option_Some(Seq(input["NextToken"])) if "NextToken" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_QueryInput(input):
    return DafnyQueryInput(
        TableName=Seq(input["TableName"]),
        IndexName=Option_Some(Seq(input["IndexName"])) if "IndexName" in input.keys() else Option_None(),
        Select=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_Select(input["Select"])) if "Select" in input.keys() else Option_None(),
        AttributesToGet=Option_Some(Seq([Seq(list_element) for list_element in input["AttributesToGet"]])) if "AttributesToGet" in input.keys() else Option_None(),
        Limit=Option_Some(input["Limit"]) if "Limit" in input.keys() else Option_None(),
        ConsistentRead=Option_Some(input["ConsistentRead"]) if "ConsistentRead" in input.keys() else Option_None(),
        KeyConditions=Option_Some(Map({Seq(key): smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_Condition(value) for (key, value) in input["KeyConditions"].items() })) if "KeyConditions" in input.keys() else Option_None(),
        QueryFilter=Option_Some(Map({Seq(key): smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_Condition(value) for (key, value) in input["QueryFilter"].items() })) if "QueryFilter" in input.keys() else Option_None(),
        ConditionalOperator=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ConditionalOperator(input["ConditionalOperator"])) if "ConditionalOperator" in input.keys() else Option_None(),
        ScanIndexForward=Option_Some(input["ScanIndexForward"]) if "ScanIndexForward" in input.keys() else Option_None(),
        ExclusiveStartKey=Option_Some(Map({Seq(key): smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in input["ExclusiveStartKey"].items() })) if "ExclusiveStartKey" in input.keys() else Option_None(),
        ReturnConsumedCapacity=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ReturnConsumedCapacity(input["ReturnConsumedCapacity"])) if "ReturnConsumedCapacity" in input.keys() else Option_None(),
        ProjectionExpression=Option_Some(Seq(input["ProjectionExpression"])) if "ProjectionExpression" in input.keys() else Option_None(),
...
def AwsSdkToDafny_com_amazonaws_dynamodb_Condition(input):
    return DafnyCondition(
        AttributeValueList=Option_Some(Seq([smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AttributeValue(list_element) for list_element in input["AttributeValueList"]])) if "AttributeValueList" in input.keys() else Option_None(),
        ComparisonOperator=smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ComparisonOperator(input["ComparisonOperator"]),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_RestoreTableFromBackupInput(input):
    return DafnyRestoreTableFromBackupInput(
        ...
        BackupArn=Seq(input["BackupArn"]),
        BillingModeOverride=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_BillingMode(input["BillingModeOverride"])) if "BillingModeOverride" in input.keys() else Option_None(),
        GlobalSecondaryIndexOverride=Option_Some(Seq([smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_GlobalSecondaryIndex(list_element) for list_element in input["GlobalSecondaryIndexOverride"]])) if "GlobalSecondaryIndexOverride" in input.keys() else Option_None(),
        LocalSecondaryIndexOverride=Option_Some(Seq([smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_LocalSecondaryIndex(list_element) for list_element in input["LocalSecondaryIndexOverride"]])) if "LocalSecondaryIndexOverride" in input.keys() else Option_None(),
        ProvisionedThroughputOverride=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ProvisionedThroughput(input["ProvisionedThroughputOverride"])) if "ProvisionedThroughputOverride" in input.keys() else Option_None(),
        SSESpecificationOverride=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_SSESpecification(input["SSESpecificationOverride"])) if "SSESpecificationOverride" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_ScanInput(input):
    return DafnyScanInput(
        ...
        Limit=Option_Some(input["Limit"]) if "Limit" in input.keys() else Option_None(),
        Select=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_Select(input["Select"])) if "Select" in input.keys() else Option_None(),
        ScanFilter=Option_Some(Map({Seq(key): smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_Condition(value) for (key, value) in input["ScanFilter"].items() })) if "ScanFilter" in input.keys() else Option_None(),
        ConditionalOperator=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ConditionalOperator(input["ConditionalOperator"])) if "ConditionalOperator" in input.keys() else Option_None(),
        ExclusiveStartKey=Option_Some(Map({Seq(key): smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in input["ExclusiveStartKey"].items() })) if "ExclusiveStartKey" in input.keys() else Option_None(),
        ReturnConsumedCapacity=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ReturnConsumedCapacity(input["ReturnConsumedCapacity"])) if "ReturnConsumedCapacity" in input.keys() else Option_None(),
...
def AwsSdkToDafny_com_amazonaws_dynamodb_TagResourceInput(input):
    return DafnyTagResourceInput(
        ResourceArn=Seq(input["ResourceArn"]),
        Tags=Seq([smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_Tag(list_element) for list_element in input["Tags"]]),
    )

def AwsSdkToDafny_com_amazonaws_dynamodb_TransactGetItemsInput(input):
    return DafnyTransactGetItemsInput(
        TransactItems=Seq([smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_TransactGetItem(list_element) for list_element in input["TransactItems"]]),
        ReturnConsumedCapacity=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ReturnConsumedCapacity(input["ReturnConsumedCapacity"])) if "ReturnConsumedCapacity" in input.keys() else Option_None(),
    )

def AwsSdkToDafny_com_amazonaws_dynamodb_TransactGetItem(input):
    return DafnyTransactGetItem(
        Get=smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_Get(input["Get"]),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_TransactWriteItemsInput(input):
    return DafnyTransactWriteItemsInput(
        TransactItems=Seq([smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_TransactWriteItem(list_element) for list_element in input["TransactItems"]]),
        ReturnConsumedCapacity=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ReturnConsumedCapacity(input["ReturnConsumedCapacity"])) if "ReturnConsumedCapacity" in input.keys() else Option_None(),
        ReturnItemCollectionMetrics=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ReturnItemCollectionMetrics(input["ReturnItemCollectionMetrics"])) if "ReturnItemCollectionMetrics" in input.keys() else Option_None(),
        ClientRequestToken=Option_Some(Seq(input["ClientRequestToken"])) if "ClientRequestToken" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_TransactWriteItem(input):
    return DafnyTransactWriteItem(
        ConditionCheck=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ConditionCheck(input["ConditionCheck"])) if "ConditionCheck" in input.keys() else Option_None(),
        Put=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_Put(input["Put"])) if "Put" in input.keys() else Option_None(),
        Delete=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_Delete(input["Delete"])) if "Delete" in input.keys() else Option_None(),
        Update=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_Update(input["Update"])) if "Update" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_ConditionCheck(input):
    return DafnyConditionCheck(
        ...
        ExpressionAttributeNames=Option_Some(Map({Seq(key): Seq(value) for (key, value) in input["ExpressionAttributeNames"].items() })) if "ExpressionAttributeNames" in input.keys() else Option_None(),
        ExpressionAttributeValues=Option_Some(Map({Seq(key): smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in input["ExpressionAttributeValues"].items() })) if "ExpressionAttributeValues" in input.keys() else Option_None(),
        ReturnValuesOnConditionCheckFailure=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ReturnValuesOnConditionCheckFailure(input["ReturnValuesOnConditionCheckFailure"])) if "ReturnValuesOnConditionCheckFailure" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_UpdateContinuousBackupsInput(input):
    return DafnyUpdateContinuousBackupsInput(
        TableName=Seq(input["TableName"]),
        PointInTimeRecoverySpecification=smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_PointInTimeRecoverySpecification(input["PointInTimeRecoverySpecification"]),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_UpdateContributorInsightsInput(input):
    return DafnyUpdateContributorInsightsInput(
        TableName=Seq(input["TableName"]),
        IndexName=Option_Some(Seq(input["IndexName"])) if "IndexName" in input.keys() else Option_None(),
        ContributorInsightsAction=smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ContributorInsightsAction(input["ContributorInsightsAction"]),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_UpdateGlobalTableInput(input):
    return DafnyUpdateGlobalTableInput(
        GlobalTableName=Seq(input["GlobalTableName"]),
        ReplicaUpdates=Seq([smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ReplicaUpdate(list_element) for list_element in input["ReplicaUpdates"]]),
    )

def AwsSdkToDafny_com_amazonaws_dynamodb_ReplicaUpdate(input):
    return DafnyReplicaUpdate(
        Create=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_CreateReplicaAction(input["Create"])) if "Create" in input.keys() else Option_None(),
        Delete=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_DeleteReplicaAction(input["Delete"])) if "Delete" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_UpdateGlobalTableSettingsInput(input):
    return DafnyUpdateGlobalTableSettingsInput(
        GlobalTableName=Seq(input["GlobalTableName"]),
        GlobalTableBillingMode=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_BillingMode(input["GlobalTableBillingMode"])) if "GlobalTableBillingMode" in input.keys() else Option_None(),
...
def AwsSdkToDafny_com_amazonaws_dynamodb_AutoScalingSettingsUpdate(input):
    return DafnyAutoScalingSettingsUpdate(
        ...
        AutoScalingDisabled=Option_Some(input["AutoScalingDisabled"]) if "AutoScalingDisabled" in input.keys() else Option_None(),
        AutoScalingRoleArn=Option_Some(Seq(input["AutoScalingRoleArn"])) if "AutoScalingRoleArn" in input.keys() else Option_None(),
        ScalingPolicyUpdate=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AutoScalingPolicyUpdate(input["ScalingPolicyUpdate"])) if "ScalingPolicyUpdate" in input.keys() else Option_None(),
    )

def AwsSdkToDafny_com_amazonaws_dynamodb_AutoScalingPolicyUpdate(input):
    return DafnyAutoScalingPolicyUpdate(
        PolicyName=Option_Some(Seq(input["PolicyName"])) if "PolicyName" in input.keys() else Option_None(),
        TargetTrackingScalingPolicyConfiguration=smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AutoScalingTargetTrackingScalingPolicyConfigurationUpdate(input["TargetTrackingScalingPolicyConfiguration"]),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_ReplicaSettingsUpdate(input):
    return DafnyReplicaSettingsUpdate(
        ...
        ReplicaGlobalSecondaryIndexSettingsUpdate=Option_Some(Seq([smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ReplicaGlobalSecondaryIndexSettingsUpdate(list_element) for list_element in input["ReplicaGlobalSecondaryIndexSettingsUpdate"]])) if "ReplicaGlobalSecondaryIndexSettingsUpdate" in input.keys() else Option_None(),
        ReplicaTableClass=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_TableClass(input["ReplicaTableClass"])) if "ReplicaTableClass" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_UpdateItemInput(input):
    return DafnyUpdateItemInput(
        TableName=Seq(input["TableName"]),
        Key=Map({Seq(key): smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in input["Key"].items() }),
        AttributeUpdates=Option_Some(Map({Seq(key): smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AttributeValueUpdate(value) for (key, value) in input["AttributeUpdates"].items() })) if "AttributeUpdates" in input.keys() else Option_None(),
        Expected=Option_Some(Map({Seq(key): smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ExpectedAttributeValue(value) for (key, value) in input["Expected"].items() })) if "Expected" in input.keys() else Option_None(),
        ConditionalOperator=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ConditionalOperator(input["ConditionalOperator"])) if "ConditionalOperator" in input.keys() else Option_None(),
        ReturnValues=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ReturnValue(input["ReturnValues"])) if "ReturnValues" in input.keys() else Option_None(),
        ReturnConsumedCapacity=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ReturnConsumedCapacity(input["ReturnConsumedCapacity"])) if "ReturnConsumedCapacity" in input.keys() else Option_None(),
...
def AwsSdkToDafny_com_amazonaws_dynamodb_AttributeValueUpdate(input):
    return DafnyAttributeValueUpdate(
        Value=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AttributeValue(input["Value"])) if "Value" in input.keys() else Option_None(),
        Action=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AttributeAction(input["Action"])) if "Action" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_UpdateTableInput(input):
    return DafnyUpdateTableInput(
        ...
        BillingMode=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_BillingMode(input["BillingMode"])) if "BillingMode" in input.keys() else Option_None(),
        ProvisionedThroughput=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ProvisionedThroughput(input["ProvisionedThroughput"])) if "ProvisionedThroughput" in input.keys() else Option_None(),
        GlobalSecondaryIndexUpdates=Option_Some(Seq([smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_GlobalSecondaryIndexUpdate(list_element) for list_element in input["GlobalSecondaryIndexUpdates"]])) if "GlobalSecondaryIndexUpdates" in input.keys() else Option_None(),
        StreamSpecification=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_StreamSpecification(input["StreamSpecification"])) if "StreamSpecification" in input.keys() else Option_None(),
        SSESpecification=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_SSESpecification(input["SSESpecification"])) if "SSESpecification" in input.keys() else Option_None(),
        ReplicaUpdates=Option_Some(Seq([smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ReplicationGroupUpdate(list_element) for list_element in input["ReplicaUpdates"]])) if "ReplicaUpdates" in input.keys() else Option_None(),
        TableClass=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_TableClass(input["TableClass"])) if "TableClass" in input.keys() else Option_None(),
    )

def AwsSdkToDafny_com_amazonaws_dynamodb_GlobalSecondaryIndexUpdate(input):
    return DafnyGlobalSecondaryIndexUpdate(
        Update=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_UpdateGlobalSecondaryIndexAction(input["Update"])) if "Update" in input.keys() else Option_None(),
        Create=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_CreateGlobalSecondaryIndexAction(input["Create"])) if "Create" in input.keys() else Option_None(),
        Delete=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_DeleteGlobalSecondaryIndexAction(input["Delete"])) if "Delete" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_ReplicationGroupUpdate(input):
    return DafnyReplicationGroupUpdate(
        Create=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_CreateReplicationGroupMemberAction(input["Create"])) if "Create" in input.keys() else Option_None(),
        Update=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_UpdateReplicationGroupMemberAction(input["Update"])) if "Update" in input.keys() else Option_None(),
        Delete=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_DeleteReplicationGroupMemberAction(input["Delete"])) if "Delete" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_CreateReplicationGroupMemberAction(input):
    return DafnyCreateReplicationGroupMemberAction(
        ...
        KMSMasterKeyId=Option_Some(Seq(input["KMSMasterKeyId"])) if "KMSMasterKeyId" in input.keys() else Option_None(),
        ProvisionedThroughputOverride=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ProvisionedThroughputOverride(input["ProvisionedThroughputOverride"])) if "ProvisionedThroughputOverride" in input.keys() else Option_None(),
        GlobalSecondaryIndexes=Option_Some(Seq([smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ReplicaGlobalSecondaryIndex(list_element) for list_element in input["GlobalSecondaryIndexes"]])) if "GlobalSecondaryIndexes" in input.keys() else Option_None(),
        TableClassOverride=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_TableClass(input["TableClassOverride"])) if "TableClassOverride" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_UpdateTableReplicaAutoScalingInput(input):
    return DafnyUpdateTableReplicaAutoScalingInput(
        GlobalSecondaryIndexUpdates=Option_Some(Seq([smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_GlobalSecondaryIndexAutoScalingUpdate(list_element) for list_element in input["GlobalSecondaryIndexUpdates"]])) if "GlobalSecondaryIndexUpdates" in input.keys() else Option_None(),
        TableName=Seq(input["TableName"]),
        ProvisionedWriteCapacityAutoScalingUpdate=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AutoScalingSettingsUpdate(input["ProvisionedWriteCapacityAutoScalingUpdate"])) if "ProvisionedWriteCapacityAutoScalingUpdate" in input.keys() else Option_None(),
        ReplicaUpdates=Option_Some(Seq([smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ReplicaAutoScalingUpdate(list_element) for list_element in input["ReplicaUpdates"]])) if "ReplicaUpdates" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_ReplicaGlobalSecondaryIndexAutoScalingUpdate(input):
    return DafnyReplicaGlobalSecondaryIndexAutoScalingUpdate(
        IndexName=Option_Some(Seq(input["IndexName"])) if "IndexName" in input.keys() else Option_None(),
        ProvisionedReadCapacityAutoScalingUpdate=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_AutoScalingSettingsUpdate(input["ProvisionedReadCapacityAutoScalingUpdate"])) if "ProvisionedReadCapacityAutoScalingUpdate" in input.keys() else Option_None(),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_UpdateTimeToLiveInput(input):
    return DafnyUpdateTimeToLiveInput(
        TableName=Seq(input["TableName"]),
        TimeToLiveSpecification=smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_TimeToLiveSpecification(input["TimeToLiveSpecification"]),
    )
...
def AwsSdkToDafny_com_amazonaws_dynamodb_UpdateTimeToLiveOutput(input):
    return DafnyUpdateTimeToLiveOutput(
        TimeToLiveSpecification=Option_Some(smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_TimeToLiveSpecification(input["TimeToLiveSpecification"])) if "TimeToLiveSpecification" in input.keys() else Option_None(),
    )
