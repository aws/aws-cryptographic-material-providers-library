...
import module_
import smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_CancellationReason(input):
    ...
    if input.Item.is_Some:
        output["Item"] = {key.VerbatimString(False): smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in input.Item.value.items }
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_AttributeValue(input):
    ...
    if isinstance(input, AttributeValue_S):
        ...
        AttributeValue_union_value = {"M": {key.VerbatimString(False): smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in input.M.items }}
    elif isinstance(input, AttributeValue_L):
        AttributeValue_union_value = {"L": [smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_AttributeValue(list_element) for list_element in input.L]}
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_TransactionCanceledException(input):
    ...
    if input.CancellationReasons.is_Some:
        output["CancellationReasons"] = [smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_CancellationReason(list_element) for list_element in input.CancellationReasons.value]
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_BatchStatementRequest(input):
    ...
    if input.Parameters.is_Some:
        output["Parameters"] = [smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_AttributeValue(list_element) for list_element in input.Parameters.value]
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_BatchExecuteStatementInput(input):
    output = {}
    output["Statements"] = [smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_BatchStatementRequest(list_element) for list_element in input.Statements]
    if input.ReturnConsumedCapacity.is_Some:
        output["ReturnConsumedCapacity"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ReturnConsumedCapacity(input.ReturnConsumedCapacity.value)
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_BatchStatementResponse(input):
    ...
    if input.Error.is_Some:
        output["Error"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_BatchStatementError(input.Error.value)
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_BatchStatementError(input):
    output = {}
    if input.Code.is_Some:
        output["Code"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_BatchStatementErrorCodeEnum(input.Code.value)
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_ConsumedCapacity(input):
    ...
    if input.Table.is_Some:
        output["Table"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_Capacity(input.Table.value)

    if input.LocalSecondaryIndexes.is_Some:
        output["LocalSecondaryIndexes"] = {key.VerbatimString(False): smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_Capacity(value) for (key, value) in input.LocalSecondaryIndexes.value.items }

    if input.GlobalSecondaryIndexes.is_Some:
        output["GlobalSecondaryIndexes"] = {key.VerbatimString(False): smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_Capacity(value) for (key, value) in input.GlobalSecondaryIndexes.value.items }
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_BatchExecuteStatementOutput(input):
    ...
    if input.Responses.is_Some:
        output["Responses"] = [smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_BatchStatementResponse(list_element) for list_element in input.Responses.value]

    if input.ConsumedCapacity.is_Some:
        output["ConsumedCapacity"] = [smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ConsumedCapacity(list_element) for list_element in input.ConsumedCapacity.value]

    return output

def DafnyToAwsSdk_com_amazonaws_dynamodb_KeysAndAttributes(input):
    output = {}
    output["Keys"] = [{key.VerbatimString(False): smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in list_element.items } for list_element in input.Keys]
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_BatchGetItemInput(input):
    output = {}
    output["RequestItems"] = {key.VerbatimString(False): smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_KeysAndAttributes(value) for (key, value) in input.RequestItems.items }
    if input.ReturnConsumedCapacity.is_Some:
        output["ReturnConsumedCapacity"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ReturnConsumedCapacity(input.ReturnConsumedCapacity.value)
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_BatchGetItemOutput(input):
    output = {}
    if input.Responses.is_Some:
        output["Responses"] = {key.VerbatimString(False): [{key.VerbatimString(False): smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in list_element.items } for list_element in value] for (key, value) in input.Responses.value.items }

    if input.UnprocessedKeys.is_Some:
        output["UnprocessedKeys"] = {key.VerbatimString(False): smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_KeysAndAttributes(value) for (key, value) in input.UnprocessedKeys.value.items }
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_WriteRequest(input):
    ...
    if input.PutRequest.is_Some:
        output["PutRequest"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_PutRequest(input.PutRequest.value)

    if input.DeleteRequest.is_Some:
        output["DeleteRequest"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_DeleteRequest(input.DeleteRequest.value)

    return output

def DafnyToAwsSdk_com_amazonaws_dynamodb_PutRequest(input):
    output = {}
    output["Item"] = {key.VerbatimString(False): smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in input.Item.items }
    return output

def DafnyToAwsSdk_com_amazonaws_dynamodb_DeleteRequest(input):
    output = {}
    output["Key"] = {key.VerbatimString(False): smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in input.Key.items }
    return output
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_BatchWriteItemInput(input):
    output = {}
    output["RequestItems"] = {key.VerbatimString(False): [smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_WriteRequest(list_element) for list_element in value] for (key, value) in input.RequestItems.items }
    if input.ReturnConsumedCapacity.is_Some:
        output["ReturnConsumedCapacity"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ReturnConsumedCapacity(input.ReturnConsumedCapacity.value)

    if input.ReturnItemCollectionMetrics.is_Some:
        output["ReturnItemCollectionMetrics"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ReturnItemCollectionMetrics(input.ReturnItemCollectionMetrics.value)
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_ItemCollectionMetrics(input):
    ...
    if input.ItemCollectionKey.is_Some:
        output["ItemCollectionKey"] = {key.VerbatimString(False): smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in input.ItemCollectionKey.value.items }
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_BatchWriteItemOutput(input):
    ...
    if input.UnprocessedItems.is_Some:
        output["UnprocessedItems"] = {key.VerbatimString(False): [smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_WriteRequest(list_element) for list_element in value] for (key, value) in input.UnprocessedItems.value.items }

    if input.ItemCollectionMetrics.is_Some:
        output["ItemCollectionMetrics"] = {key.VerbatimString(False): [smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ItemCollectionMetrics(list_element) for list_element in value] for (key, value) in input.ItemCollectionMetrics.value.items }
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_BackupDetails(input):
    ...
    output["BackupStatus"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_BackupStatus(input.BackupStatus)
    output["BackupType"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_BackupType(input.BackupType)
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_CreateBackupOutput(input):
    ...
    if input.BackupDetails.is_Some:
        output["BackupDetails"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_BackupDetails(input.BackupDetails.value)
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_CreateGlobalTableInput(input):
    ...
    output["ReplicationGroup"] = [smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_Replica(list_element) for list_element in input.ReplicationGroup]
    return output

def DafnyToAwsSdk_com_amazonaws_dynamodb_GlobalTableDescription(input):
    output = {}
    if input.ReplicationGroup.is_Some:
        output["ReplicationGroup"] = [smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ReplicaDescription(list_element) for list_element in input.ReplicationGroup.value]
    ...
    if input.GlobalTableStatus.is_Some:
        output["GlobalTableStatus"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_GlobalTableStatus(input.GlobalTableStatus.value)
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_ReplicaDescription(input):
    ...
    if input.ReplicaStatus.is_Some:
        output["ReplicaStatus"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ReplicaStatus(input.ReplicaStatus.value)
    ...
    if input.ProvisionedThroughputOverride.is_Some:
        output["ProvisionedThroughputOverride"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ProvisionedThroughputOverride(input.ProvisionedThroughputOverride.value)

    if input.GlobalSecondaryIndexes.is_Some:
        output["GlobalSecondaryIndexes"] = [smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ReplicaGlobalSecondaryIndexDescription(list_element) for list_element in input.GlobalSecondaryIndexes.value]
    ...
    if input.ReplicaTableClassSummary.is_Some:
        output["ReplicaTableClassSummary"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_TableClassSummary(input.ReplicaTableClassSummary.value)
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_TableClassSummary(input):
    ...
    if input.TableClass.is_Some:
        output["TableClass"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_TableClass(input.TableClass.value)
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_CreateGlobalTableOutput(input):
    ...
    if input.GlobalTableDescription.is_Some:
        output["GlobalTableDescription"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_GlobalTableDescription(input.GlobalTableDescription.value)
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_AttributeDefinition(input):
    ...
    output["AttributeType"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ScalarAttributeType(input.AttributeType)
    return output
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_KeySchemaElement(input):
    output = {}
    output["AttributeName"] = input.AttributeName.VerbatimString(False)
    output["KeyType"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_KeyType(input.KeyType)
    return output
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_LocalSecondaryIndex(input):
    ...
    output["KeySchema"] = [smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_KeySchemaElement(list_element) for list_element in input.KeySchema]
    output["Projection"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_Projection(input.Projection)
    return output

def DafnyToAwsSdk_com_amazonaws_dynamodb_Projection(input):
    output = {}
    if input.ProjectionType.is_Some:
        output["ProjectionType"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ProjectionType(input.ProjectionType.value)
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_GlobalSecondaryIndex(input):
    ...
    if input.ProvisionedThroughput.is_Some:
        output["ProvisionedThroughput"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ProvisionedThroughput(input.ProvisionedThroughput.value)
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_StreamSpecification(input):
    ...
    if input.StreamViewType.is_Some:
        output["StreamViewType"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_StreamViewType(input.StreamViewType.value)
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_SSESpecification(input):
    ...
    if input.SSEType.is_Some:
        output["SSEType"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_SSEType(input.SSEType.value)
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_CreateTableInput(input):
    output = {}
    output["AttributeDefinitions"] = [smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_AttributeDefinition(list_element) for list_element in input.AttributeDefinitions]
    output["TableName"] = input.TableName.VerbatimString(False)
    output["KeySchema"] = [smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_KeySchemaElement(list_element) for list_element in input.KeySchema]
    if input.LocalSecondaryIndexes.is_Some:
        output["LocalSecondaryIndexes"] = [smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_LocalSecondaryIndex(list_element) for list_element in input.LocalSecondaryIndexes.value]

    if input.GlobalSecondaryIndexes.is_Some:
        output["GlobalSecondaryIndexes"] = [smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_GlobalSecondaryIndex(list_element) for list_element in input.GlobalSecondaryIndexes.value]

    if input.BillingMode.is_Some:
        output["BillingMode"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_BillingMode(input.BillingMode.value)

    if input.ProvisionedThroughput.is_Some:
        output["ProvisionedThroughput"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ProvisionedThroughput(input.ProvisionedThroughput.value)

    if input.StreamSpecification.is_Some:
        output["StreamSpecification"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_StreamSpecification(input.StreamSpecification.value)

    if input.SSESpecification.is_Some:
        output["SSESpecification"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_SSESpecification(input.SSESpecification.value)

    if input.Tags.is_Some:
        output["Tags"] = [smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_Tag(list_element) for list_element in input.Tags.value]
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_TableDescription(input):
    ...
    if input.AttributeDefinitions.is_Some:
        output["AttributeDefinitions"] = [smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_AttributeDefinition(list_element) for list_element in input.AttributeDefinitions.value]

    if input.TableName.is_Some:
        output["TableName"] = input.TableName.value.VerbatimString(False)

    if input.KeySchema.is_Some:
        output["KeySchema"] = [smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_KeySchemaElement(list_element) for list_element in input.KeySchema.value]

    if input.TableStatus.is_Some:
        output["TableStatus"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_TableStatus(input.TableStatus.value)

    if input.CreationDateTime.is_Some:
        output["CreationDateTime"] = TypeError("TimestampShape not supported")

    if input.ProvisionedThroughput.is_Some:
        output["ProvisionedThroughput"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ProvisionedThroughputDescription(input.ProvisionedThroughput.value)
    ...
    if input.BillingModeSummary.is_Some:
        output["BillingModeSummary"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_BillingModeSummary(input.BillingModeSummary.value)

    if input.LocalSecondaryIndexes.is_Some:
        output["LocalSecondaryIndexes"] = [smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_LocalSecondaryIndexDescription(list_element) for list_element in input.LocalSecondaryIndexes.value]

    if input.GlobalSecondaryIndexes.is_Some:
        output["GlobalSecondaryIndexes"] = [smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_GlobalSecondaryIndexDescription(list_element) for list_element in input.GlobalSecondaryIndexes.value]
    ...
    if input.Replicas.is_Some:
        output["Replicas"] = [smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ReplicaDescription(list_element) for list_element in input.Replicas.value]

    if input.RestoreSummary.is_Some:
        output["RestoreSummary"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_RestoreSummary(input.RestoreSummary.value)

    if input.SSEDescription.is_Some:
        output["SSEDescription"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_SSEDescription(input.SSEDescription.value)

    if input.ArchivalSummary.is_Some:
        output["ArchivalSummary"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ArchivalSummary(input.ArchivalSummary.value)

    if input.TableClassSummary.is_Some:
        output["TableClassSummary"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_TableClassSummary(input.TableClassSummary.value)
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_LocalSecondaryIndexDescription(input):
    ...
    if input.Projection.is_Some:
        output["Projection"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_Projection(input.Projection.value)
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_GlobalSecondaryIndexDescription(input):
    ...
    if input.IndexStatus.is_Some:
        output["IndexStatus"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_IndexStatus(input.IndexStatus.value)
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_SSEDescription(input):
    ...
    if input.Status.is_Some:
        output["Status"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_SSEStatus(input.Status.value)
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_CreateTableOutput(input):
    ...
    if input.TableDescription.is_Some:
        output["TableDescription"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_TableDescription(input.TableDescription.value)
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_BackupDescription(input):
    ...
    if input.SourceTableDetails.is_Some:
        output["SourceTableDetails"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_SourceTableDetails(input.SourceTableDetails.value)

    if input.SourceTableFeatureDetails.is_Some:
        output["SourceTableFeatureDetails"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_SourceTableFeatureDetails(input.SourceTableFeatureDetails.value)
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_SourceTableDetails(input):
    ...
    output["ProvisionedThroughput"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ProvisionedThroughput(input.ProvisionedThroughput)
    if input.ItemCount.is_Some:
        output["ItemCount"] = input.ItemCount.value
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_SourceTableFeatureDetails(input):
    output = {}
    if input.LocalSecondaryIndexes.is_Some:
        output["LocalSecondaryIndexes"] = [smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_LocalSecondaryIndexInfo(list_element) for list_element in input.LocalSecondaryIndexes.value]

    if input.GlobalSecondaryIndexes.is_Some:
        output["GlobalSecondaryIndexes"] = [smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_GlobalSecondaryIndexInfo(list_element) for list_element in input.GlobalSecondaryIndexes.value]

    if input.StreamDescription.is_Some:
        output["StreamDescription"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_StreamSpecification(input.StreamDescription.value)

    if input.TimeToLiveDescription.is_Some:
        output["TimeToLiveDescription"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_TimeToLiveDescription(input.TimeToLiveDescription.value)
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_TimeToLiveDescription(input):
    ...
    if input.TimeToLiveStatus.is_Some:
        output["TimeToLiveStatus"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_TimeToLiveStatus(input.TimeToLiveStatus.value)
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_DeleteBackupOutput(input):
    ...
    if input.BackupDescription.is_Some:
        output["BackupDescription"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_BackupDescription(input.BackupDescription.value)
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_ExpectedAttributeValue(input):
    ...
    if input.Value.is_Some:
        output["Value"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_AttributeValue(input.Value.value)

    if input.Exists.is_Some:
        output["Exists"] = input.Exists.value

    if input.ComparisonOperator.is_Some:
        output["ComparisonOperator"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ComparisonOperator(input.ComparisonOperator.value)

    if input.AttributeValueList.is_Some:
        output["AttributeValueList"] = [smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_AttributeValue(list_element) for list_element in input.AttributeValueList.value]
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_DeleteItemInput(input):
    ...
    if input.Expected.is_Some:
        output["Expected"] = {key.VerbatimString(False): smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ExpectedAttributeValue(value) for (key, value) in input.Expected.value.items }

    if input.ConditionalOperator.is_Some:
        output["ConditionalOperator"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ConditionalOperator(input.ConditionalOperator.value)

    if input.ReturnValues.is_Some:
        output["ReturnValues"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ReturnValue(input.ReturnValues.value)
    ...
    if input.ExpressionAttributeValues.is_Some:
        output["ExpressionAttributeValues"] = {key.VerbatimString(False): smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in input.ExpressionAttributeValues.value.items }
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_DeleteItemOutput(input):
    ...
    if input.Attributes.is_Some:
        output["Attributes"] = {key.VerbatimString(False): smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in input.Attributes.value.items }

    if input.ConsumedCapacity.is_Some:
        output["ConsumedCapacity"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ConsumedCapacity(input.ConsumedCapacity.value)

    if input.ItemCollectionMetrics.is_Some:
        output["ItemCollectionMetrics"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ItemCollectionMetrics(input.ItemCollectionMetrics.value)
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_ContinuousBackupsDescription(input):
    output = {}
    output["ContinuousBackupsStatus"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ContinuousBackupsStatus(input.ContinuousBackupsStatus)
    if input.PointInTimeRecoveryDescription.is_Some:
        output["PointInTimeRecoveryDescription"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_PointInTimeRecoveryDescription(input.PointInTimeRecoveryDescription.value)
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_PointInTimeRecoveryDescription(input):
    ...
    if input.PointInTimeRecoveryStatus.is_Some:
        output["PointInTimeRecoveryStatus"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_PointInTimeRecoveryStatus(input.PointInTimeRecoveryStatus.value)
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_DescribeContinuousBackupsOutput(input):
    ...
    if input.ContinuousBackupsDescription.is_Some:
        output["ContinuousBackupsDescription"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ContinuousBackupsDescription(input.ContinuousBackupsDescription.value)
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_DescribeContributorInsightsOutput(input):
    ...
    if input.ContributorInsightsStatus.is_Some:
        output["ContributorInsightsStatus"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ContributorInsightsStatus(input.ContributorInsightsStatus.value)

    if input.LastUpdateDateTime.is_Some:
        output["LastUpdateDateTime"] = TypeError("TimestampShape not supported")

    if input.FailureException.is_Some:
        output["FailureException"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_FailureException(input.FailureException.value)
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_DescribeEndpointsResponse(input):
    output = {}
    output["Endpoints"] = [smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_Endpoint(list_element) for list_element in input.Endpoints]
    return output
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_ExportDescription(input):
    ...
    if input.ExportStatus.is_Some:
        output["ExportStatus"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ExportStatus(input.ExportStatus.value)
    ...
    if input.S3SseAlgorithm.is_Some:
        output["S3SseAlgorithm"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_S3SseAlgorithm(input.S3SseAlgorithm.value)
    ...
    if input.ExportFormat.is_Some:
        output["ExportFormat"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ExportFormat(input.ExportFormat.value)
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_DescribeExportOutput(input):
    ...
    if input.ExportDescription.is_Some:
        output["ExportDescription"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ExportDescription(input.ExportDescription.value)
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_ReplicaSettingsDescription(input):
    ...
    if input.ReplicaBillingModeSummary.is_Some:
        output["ReplicaBillingModeSummary"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_BillingModeSummary(input.ReplicaBillingModeSummary.value)
    ...
    if input.ReplicaProvisionedReadCapacityAutoScalingSettings.is_Some:
        output["ReplicaProvisionedReadCapacityAutoScalingSettings"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_AutoScalingSettingsDescription(input.ReplicaProvisionedReadCapacityAutoScalingSettings.value)
    ...
    if input.ReplicaProvisionedWriteCapacityAutoScalingSettings.is_Some:
        output["ReplicaProvisionedWriteCapacityAutoScalingSettings"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_AutoScalingSettingsDescription(input.ReplicaProvisionedWriteCapacityAutoScalingSettings.value)

    if input.ReplicaGlobalSecondaryIndexSettings.is_Some:
        output["ReplicaGlobalSecondaryIndexSettings"] = [smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ReplicaGlobalSecondaryIndexSettingsDescription(list_element) for list_element in input.ReplicaGlobalSecondaryIndexSettings.value]
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_AutoScalingSettingsDescription(input):
    ...
    if input.ScalingPolicies.is_Some:
        output["ScalingPolicies"] = [smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_AutoScalingPolicyDescription(list_element) for list_element in input.ScalingPolicies.value]
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_ReplicaGlobalSecondaryIndexSettingsDescription(input):
    ...
    if input.ProvisionedReadCapacityAutoScalingSettings.is_Some:
        output["ProvisionedReadCapacityAutoScalingSettings"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_AutoScalingSettingsDescription(input.ProvisionedReadCapacityAutoScalingSettings.value)
    ...
    if input.ProvisionedWriteCapacityAutoScalingSettings.is_Some:
        output["ProvisionedWriteCapacityAutoScalingSettings"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_AutoScalingSettingsDescription(input.ProvisionedWriteCapacityAutoScalingSettings.value)
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_AutoScalingPolicyDescription(input):
    ...
    if input.TargetTrackingScalingPolicyConfiguration.is_Some:
        output["TargetTrackingScalingPolicyConfiguration"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_AutoScalingTargetTrackingScalingPolicyConfigurationDescription(input.TargetTrackingScalingPolicyConfiguration.value)
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_DescribeGlobalTableSettingsOutput(input):
    ...
    if input.ReplicaSettings.is_Some:
        output["ReplicaSettings"] = [smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ReplicaSettingsDescription(list_element) for list_element in input.ReplicaSettings.value]
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_ImportTableDescription(input):
    ...
    if input.ImportStatus.is_Some:
        output["ImportStatus"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ImportStatus(input.ImportStatus.value)
    ...
    if input.S3BucketSource.is_Some:
        output["S3BucketSource"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_S3BucketSource(input.S3BucketSource.value)
    ...
    if input.InputFormat.is_Some:
        output["InputFormat"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_InputFormat(input.InputFormat.value)

    if input.InputFormatOptions.is_Some:
        output["InputFormatOptions"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_InputFormatOptions(input.InputFormatOptions.value)

    if input.InputCompressionType.is_Some:
        output["InputCompressionType"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_InputCompressionType(input.InputCompressionType.value)

    if input.TableCreationParameters.is_Some:
        output["TableCreationParameters"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_TableCreationParameters(input.TableCreationParameters.value)
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_InputFormatOptions(input):
    ...
    if input.Csv.is_Some:
        output["Csv"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_CsvOptions(input.Csv.value)
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_DescribeImportOutput(input):
    output = {}
    output["ImportTableDescription"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ImportTableDescription(input.ImportTableDescription)
    return output
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_KinesisDataStreamDestination(input):
    ...
    if input.DestinationStatus.is_Some:
        output["DestinationStatus"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_DestinationStatus(input.DestinationStatus.value)
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_DescribeKinesisStreamingDestinationOutput(input):
    ...
    if input.KinesisDataStreamDestinations.is_Some:
        output["KinesisDataStreamDestinations"] = [smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_KinesisDataStreamDestination(list_element) for list_element in input.KinesisDataStreamDestinations.value]
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_DescribeTableOutput(input):
    output = {}
    if input.Table.is_Some:
        output["Table"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_TableDescription(input.Table.value)
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_TableAutoScalingDescription(input):
    ...
    if input.Replicas.is_Some:
        output["Replicas"] = [smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ReplicaAutoScalingDescription(list_element) for list_element in input.Replicas.value]
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_ReplicaAutoScalingDescription(input):
    ...
    if input.GlobalSecondaryIndexes.is_Some:
        output["GlobalSecondaryIndexes"] = [smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ReplicaGlobalSecondaryIndexAutoScalingDescription(list_element) for list_element in input.GlobalSecondaryIndexes.value]
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_DescribeTableReplicaAutoScalingOutput(input):
    ...
    if input.TableAutoScalingDescription.is_Some:
        output["TableAutoScalingDescription"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_TableAutoScalingDescription(input.TableAutoScalingDescription.value)
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_ExecuteStatementOutput(input):
    ...
    if input.Items.is_Some:
        output["Items"] = [{key.VerbatimString(False): smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in list_element.items } for list_element in input.Items.value]
    ...
    if input.LastEvaluatedKey.is_Some:
        output["LastEvaluatedKey"] = {key.VerbatimString(False): smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in input.LastEvaluatedKey.value.items }
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_ExecuteTransactionInput(input):
    output = {}
    output["TransactStatements"] = [smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ParameterizedStatement(list_element) for list_element in input.TransactStatements]
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_ExecuteTransactionOutput(input):
    output = {}
    if input.Responses.is_Some:
        output["Responses"] = [smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ItemResponse(list_element) for list_element in input.Responses.value]
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_ImportTableInput(input):
    ...
    output["S3BucketSource"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_S3BucketSource(input.S3BucketSource)
    output["InputFormat"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_InputFormat(input.InputFormat)
    if input.InputFormatOptions.is_Some:
        output["InputFormatOptions"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_InputFormatOptions(input.InputFormatOptions.value)
    ...
    output["TableCreationParameters"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_TableCreationParameters(input.TableCreationParameters)
    return output
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_ListBackupsInput(input):
    ...
    if input.BackupType.is_Some:
        output["BackupType"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_BackupTypeFilter(input.BackupType.value)
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_BackupSummary(input):
    ...
    if input.BackupStatus.is_Some:
        output["BackupStatus"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_BackupStatus(input.BackupStatus.value)

    if input.BackupType.is_Some:
        output["BackupType"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_BackupType(input.BackupType.value)
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_ListBackupsOutput(input):
    ...
    if input.BackupSummaries.is_Some:
        output["BackupSummaries"] = [smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_BackupSummary(list_element) for list_element in input.BackupSummaries.value]
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_ListContributorInsightsOutput(input):
    ...
    if input.ContributorInsightsSummaries.is_Some:
        output["ContributorInsightsSummaries"] = [smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ContributorInsightsSummary(list_element) for list_element in input.ContributorInsightsSummaries.value]
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_ListExportsOutput(input):
    ...
    if input.ExportSummaries.is_Some:
        output["ExportSummaries"] = [smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ExportSummary(list_element) for list_element in input.ExportSummaries.value]
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_GlobalTable(input):
    ...
    if input.ReplicationGroup.is_Some:
        output["ReplicationGroup"] = [smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_Replica(list_element) for list_element in input.ReplicationGroup.value]
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_ListGlobalTablesOutput(input):
    ...
    if input.GlobalTables.is_Some:
        output["GlobalTables"] = [smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_GlobalTable(list_element) for list_element in input.GlobalTables.value]
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_ListImportsOutput(input):
    ...
    if input.ImportSummaryList.is_Some:
        output["ImportSummaryList"] = [smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ImportSummary(list_element) for list_element in input.ImportSummaryList.value]
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_Condition(input):
    ...
    output["ComparisonOperator"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ComparisonOperator(input.ComparisonOperator)
    return output
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_QueryInput(input):
    ...
    if input.Select.is_Some:
        output["Select"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_Select(input.Select.value)
    ...
    if input.KeyConditions.is_Some:
        output["KeyConditions"] = {key.VerbatimString(False): smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_Condition(value) for (key, value) in input.KeyConditions.value.items }

    if input.QueryFilter.is_Some:
        output["QueryFilter"] = {key.VerbatimString(False): smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_Condition(value) for (key, value) in input.QueryFilter.value.items }
    ...
    if input.ExclusiveStartKey.is_Some:
        output["ExclusiveStartKey"] = {key.VerbatimString(False): smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in input.ExclusiveStartKey.value.items }
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_RestoreTableFromBackupInput(input):
    ...
    if input.BillingModeOverride.is_Some:
        output["BillingModeOverride"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_BillingMode(input.BillingModeOverride.value)

    if input.GlobalSecondaryIndexOverride.is_Some:
        output["GlobalSecondaryIndexOverride"] = [smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_GlobalSecondaryIndex(list_element) for list_element in input.GlobalSecondaryIndexOverride.value]

    if input.LocalSecondaryIndexOverride.is_Some:
        output["LocalSecondaryIndexOverride"] = [smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_LocalSecondaryIndex(list_element) for list_element in input.LocalSecondaryIndexOverride.value]

    if input.ProvisionedThroughputOverride.is_Some:
        output["ProvisionedThroughputOverride"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ProvisionedThroughput(input.ProvisionedThroughputOverride.value)

    if input.SSESpecificationOverride.is_Some:
        output["SSESpecificationOverride"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_SSESpecification(input.SSESpecificationOverride.value)
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_ScanInput(input):
    ...
    if input.ScanFilter.is_Some:
        output["ScanFilter"] = {key.VerbatimString(False): smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_Condition(value) for (key, value) in input.ScanFilter.value.items }
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_TagResourceInput(input):
    output = {}
    output["ResourceArn"] = input.ResourceArn.VerbatimString(False)
    output["Tags"] = [smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_Tag(list_element) for list_element in input.Tags]
    return output

def DafnyToAwsSdk_com_amazonaws_dynamodb_TransactGetItem(input):
    output = {}
    output["Get"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_Get(input.Get)
    return output
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_TransactGetItemsInput(input):
    output = {}
    output["TransactItems"] = [smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_TransactGetItem(list_element) for list_element in input.TransactItems]
    if input.ReturnConsumedCapacity.is_Some:
        output["ReturnConsumedCapacity"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ReturnConsumedCapacity(input.ReturnConsumedCapacity.value)
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_TransactWriteItem(input):
    ...
    if input.ConditionCheck.is_Some:
        output["ConditionCheck"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ConditionCheck(input.ConditionCheck.value)

    if input.Put.is_Some:
        output["Put"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_Put(input.Put.value)

    if input.Delete.is_Some:
        output["Delete"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_Delete(input.Delete.value)

    if input.Update.is_Some:
        output["Update"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_Update(input.Update.value)
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_ConditionCheck(input):
    ...
    if input.ReturnValuesOnConditionCheckFailure.is_Some:
        output["ReturnValuesOnConditionCheckFailure"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ReturnValuesOnConditionCheckFailure(input.ReturnValuesOnConditionCheckFailure.value)
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_TransactWriteItemsInput(input):
    output = {}
    output["TransactItems"] = [smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_TransactWriteItem(list_element) for list_element in input.TransactItems]
    if input.ReturnConsumedCapacity.is_Some:
        output["ReturnConsumedCapacity"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ReturnConsumedCapacity(input.ReturnConsumedCapacity.value)
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_UpdateContinuousBackupsInput(input):
    output = {}
    output["TableName"] = input.TableName.VerbatimString(False)
    output["PointInTimeRecoverySpecification"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_PointInTimeRecoverySpecification(input.PointInTimeRecoverySpecification)
    return output
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_UpdateContributorInsightsInput(input):
    ...
    output["ContributorInsightsAction"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ContributorInsightsAction(input.ContributorInsightsAction)
    return output
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_ReplicaUpdate(input):
    ...
    if input.Create.is_Some:
        output["Create"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_CreateReplicaAction(input.Create.value)

    if input.Delete.is_Some:
        output["Delete"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_DeleteReplicaAction(input.Delete.value)
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_UpdateGlobalTableInput(input):
    output = {}
    output["GlobalTableName"] = input.GlobalTableName.VerbatimString(False)
    output["ReplicaUpdates"] = [smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ReplicaUpdate(list_element) for list_element in input.ReplicaUpdates]
    return output
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_AutoScalingSettingsUpdate(input):
    ...
    if input.ScalingPolicyUpdate.is_Some:
        output["ScalingPolicyUpdate"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_AutoScalingPolicyUpdate(input.ScalingPolicyUpdate.value)
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_AutoScalingPolicyUpdate(input):
    ...
    output["TargetTrackingScalingPolicyConfiguration"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_AutoScalingTargetTrackingScalingPolicyConfigurationUpdate(input.TargetTrackingScalingPolicyConfiguration)
    return output
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_GlobalTableGlobalSecondaryIndexSettingsUpdate(input):
    ...
    if input.ProvisionedWriteCapacityAutoScalingSettingsUpdate.is_Some:
        output["ProvisionedWriteCapacityAutoScalingSettingsUpdate"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_AutoScalingSettingsUpdate(input.ProvisionedWriteCapacityAutoScalingSettingsUpdate.value)
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_ReplicaSettingsUpdate(input):
    ...
    if input.ReplicaProvisionedReadCapacityAutoScalingSettingsUpdate.is_Some:
        output["ReplicaProvisionedReadCapacityAutoScalingSettingsUpdate"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_AutoScalingSettingsUpdate(input.ReplicaProvisionedReadCapacityAutoScalingSettingsUpdate.value)

    if input.ReplicaGlobalSecondaryIndexSettingsUpdate.is_Some:
        output["ReplicaGlobalSecondaryIndexSettingsUpdate"] = [smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ReplicaGlobalSecondaryIndexSettingsUpdate(list_element) for list_element in input.ReplicaGlobalSecondaryIndexSettingsUpdate.value]

    if input.ReplicaTableClass.is_Some:
        output["ReplicaTableClass"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_TableClass(input.ReplicaTableClass.value)
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_ReplicaGlobalSecondaryIndexSettingsUpdate(input):
    ...
    if input.ProvisionedReadCapacityAutoScalingSettingsUpdate.is_Some:
        output["ProvisionedReadCapacityAutoScalingSettingsUpdate"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_AutoScalingSettingsUpdate(input.ProvisionedReadCapacityAutoScalingSettingsUpdate.value)
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_UpdateGlobalTableSettingsInput(input):
    ...
    if input.GlobalTableBillingMode.is_Some:
        output["GlobalTableBillingMode"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_BillingMode(input.GlobalTableBillingMode.value)
    ...
    if input.GlobalTableProvisionedWriteCapacityAutoScalingSettingsUpdate.is_Some:
        output["GlobalTableProvisionedWriteCapacityAutoScalingSettingsUpdate"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_AutoScalingSettingsUpdate(input.GlobalTableProvisionedWriteCapacityAutoScalingSettingsUpdate.value)

    if input.GlobalTableGlobalSecondaryIndexSettingsUpdate.is_Some:
        output["GlobalTableGlobalSecondaryIndexSettingsUpdate"] = [smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_GlobalTableGlobalSecondaryIndexSettingsUpdate(list_element) for list_element in input.GlobalTableGlobalSecondaryIndexSettingsUpdate.value]

    if input.ReplicaSettingsUpdate.is_Some:
        output["ReplicaSettingsUpdate"] = [smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ReplicaSettingsUpdate(list_element) for list_element in input.ReplicaSettingsUpdate.value]
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_AttributeValueUpdate(input):
    ...
    if input.Action.is_Some:
        output["Action"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_AttributeAction(input.Action.value)
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_UpdateItemInput(input):
    ...
    if input.AttributeUpdates.is_Some:
        output["AttributeUpdates"] = {key.VerbatimString(False): smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_AttributeValueUpdate(value) for (key, value) in input.AttributeUpdates.value.items }
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_GlobalSecondaryIndexUpdate(input):
    output = {}
    if input.Update.is_Some:
        output["Update"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_UpdateGlobalSecondaryIndexAction(input.Update.value)

    if input.Create.is_Some:
        output["Create"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_CreateGlobalSecondaryIndexAction(input.Create.value)

    if input.Delete.is_Some:
        output["Delete"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_DeleteGlobalSecondaryIndexAction(input.Delete.value)
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_ReplicationGroupUpdate(input):
    output = {}
    if input.Create.is_Some:
        output["Create"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_CreateReplicationGroupMemberAction(input.Create.value)

    if input.Update.is_Some:
        output["Update"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_UpdateReplicationGroupMemberAction(input.Update.value)

    if input.Delete.is_Some:
        output["Delete"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_DeleteReplicationGroupMemberAction(input.Delete.value)
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_CreateReplicationGroupMemberAction(input):
    ...
    if input.GlobalSecondaryIndexes.is_Some:
        output["GlobalSecondaryIndexes"] = [smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ReplicaGlobalSecondaryIndex(list_element) for list_element in input.GlobalSecondaryIndexes.value]

    if input.TableClassOverride.is_Some:
        output["TableClassOverride"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_TableClass(input.TableClassOverride.value)
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_UpdateTableInput(input):
    ...
    if input.GlobalSecondaryIndexUpdates.is_Some:
        output["GlobalSecondaryIndexUpdates"] = [smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_GlobalSecondaryIndexUpdate(list_element) for list_element in input.GlobalSecondaryIndexUpdates.value]
    ...
    if input.ReplicaUpdates.is_Some:
        output["ReplicaUpdates"] = [smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ReplicationGroupUpdate(list_element) for list_element in input.ReplicaUpdates.value]
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_GlobalSecondaryIndexAutoScalingUpdate(input):
    ...
    if input.ProvisionedWriteCapacityAutoScalingUpdate.is_Some:
        output["ProvisionedWriteCapacityAutoScalingUpdate"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_AutoScalingSettingsUpdate(input.ProvisionedWriteCapacityAutoScalingUpdate.value)
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_ReplicaAutoScalingUpdate(input):
    ...
    if input.ReplicaGlobalSecondaryIndexUpdates.is_Some:
        output["ReplicaGlobalSecondaryIndexUpdates"] = [smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ReplicaGlobalSecondaryIndexAutoScalingUpdate(list_element) for list_element in input.ReplicaGlobalSecondaryIndexUpdates.value]

    if input.ReplicaProvisionedReadCapacityAutoScalingUpdate.is_Some:
        output["ReplicaProvisionedReadCapacityAutoScalingUpdate"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_AutoScalingSettingsUpdate(input.ReplicaProvisionedReadCapacityAutoScalingUpdate.value)
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_ReplicaGlobalSecondaryIndexAutoScalingUpdate(input):
    ...
    if input.ProvisionedReadCapacityAutoScalingUpdate.is_Some:
        output["ProvisionedReadCapacityAutoScalingUpdate"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_AutoScalingSettingsUpdate(input.ProvisionedReadCapacityAutoScalingUpdate.value)
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_UpdateTableReplicaAutoScalingInput(input):
    output = {}
    if input.GlobalSecondaryIndexUpdates.is_Some:
        output["GlobalSecondaryIndexUpdates"] = [smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_GlobalSecondaryIndexAutoScalingUpdate(list_element) for list_element in input.GlobalSecondaryIndexUpdates.value]
    ...
    if input.ReplicaUpdates.is_Some:
        output["ReplicaUpdates"] = [smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ReplicaAutoScalingUpdate(list_element) for list_element in input.ReplicaUpdates.value]
...
def DafnyToAwsSdk_com_amazonaws_dynamodb_UpdateTimeToLiveInput(input):
    output = {}
    output["TableName"] = input.TableName.VerbatimString(False)
    output["TimeToLiveSpecification"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_TimeToLiveSpecification(input.TimeToLiveSpecification)
    return output

def DafnyToAwsSdk_com_amazonaws_dynamodb_UpdateTimeToLiveOutput(input):
    output = {}
    if input.TimeToLiveSpecification.is_Some:
        output["TimeToLiveSpecification"] = smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_TimeToLiveSpecification(input.TimeToLiveSpecification.value)
