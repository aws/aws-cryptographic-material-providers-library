...
def sdk_error_to_dafny_error(e: ClientError):
    ...
    if e.response['Error']['Code'] == 'BackupInUseException':
        return com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_BackupInUseException(e.response)

    elif e.response['Error']['Code'] == 'BackupNotFoundException':
        return com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_BackupNotFoundException(e.response)

    elif e.response['Error']['Code'] == 'ConditionalCheckFailedException':
        return com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ConditionalCheckFailedException(e.response)

    elif e.response['Error']['Code'] == 'ContinuousBackupsUnavailableException':
        return com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ContinuousBackupsUnavailableException(e.response)

    elif e.response['Error']['Code'] == 'DuplicateItemException':
        return com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_DuplicateItemException(e.response)

    elif e.response['Error']['Code'] == 'ExportConflictException':
        return com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ExportConflictException(e.response)

    elif e.response['Error']['Code'] == 'ExportNotFoundException':
        return com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ExportNotFoundException(e.response)

    elif e.response['Error']['Code'] == 'GlobalTableAlreadyExistsException':
        return com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_GlobalTableAlreadyExistsException(e.response)

    elif e.response['Error']['Code'] == 'GlobalTableNotFoundException':
        return com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_GlobalTableNotFoundException(e.response)

    elif e.response['Error']['Code'] == 'IdempotentParameterMismatchException':
        return com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_IdempotentParameterMismatchException(e.response)

    elif e.response['Error']['Code'] == 'ImportConflictException':
        return com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ImportConflictException(e.response)

    elif e.response['Error']['Code'] == 'ImportNotFoundException':
        return com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ImportNotFoundException(e.response)

    elif e.response['Error']['Code'] == 'IndexNotFoundException':
        return com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_IndexNotFoundException(e.response)

    elif e.response['Error']['Code'] == 'InternalServerError':
        return com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_InternalServerError(e.response)

    elif e.response['Error']['Code'] == 'InvalidEndpointException':
        return com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_InvalidEndpointException(e.response)

    elif e.response['Error']['Code'] == 'InvalidExportTimeException':
        return com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_InvalidExportTimeException(e.response)

    elif e.response['Error']['Code'] == 'InvalidRestoreTimeException':
        return com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_InvalidRestoreTimeException(e.response)

    elif e.response['Error']['Code'] == 'ItemCollectionSizeLimitExceededException':
        return com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ItemCollectionSizeLimitExceededException(e.response)

    elif e.response['Error']['Code'] == 'LimitExceededException':
        return com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_LimitExceededException(e.response)

    elif e.response['Error']['Code'] == 'PointInTimeRecoveryUnavailableException':
        return com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_PointInTimeRecoveryUnavailableException(e.response)

    elif e.response['Error']['Code'] == 'ProvisionedThroughputExceededException':
        return com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ProvisionedThroughputExceededException(e.response)

    elif e.response['Error']['Code'] == 'ReplicaAlreadyExistsException':
        return com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ReplicaAlreadyExistsException(e.response)

    elif e.response['Error']['Code'] == 'ReplicaNotFoundException':
        return com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ReplicaNotFoundException(e.response)

    elif e.response['Error']['Code'] == 'RequestLimitExceeded':
        return com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_RequestLimitExceeded(e.response)

    elif e.response['Error']['Code'] == 'ResourceInUseException':
        return com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ResourceInUseException(e.response)

    elif e.response['Error']['Code'] == 'ResourceNotFoundException':
        return com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_ResourceNotFoundException(e.response)

    elif e.response['Error']['Code'] == 'TableAlreadyExistsException':
        return com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_TableAlreadyExistsException(e.response)

    elif e.response['Error']['Code'] == 'TableInUseException':
        return com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_TableInUseException(e.response)

    elif e.response['Error']['Code'] == 'TableNotFoundException':
        return com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_TableNotFoundException(e.response)

    elif e.response['Error']['Code'] == 'TransactionCanceledException':
        return com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_TransactionCanceledException(e.response)

    elif e.response['Error']['Code'] == 'TransactionConflictException':
        return com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_TransactionConflictException(e.response)

    elif e.response['Error']['Code'] == 'TransactionInProgressException':
        return com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.AwsSdkToDafny_com_amazonaws_dynamodb_TransactionInProgressException(e.response)
...
class DynamoDBClientShim:
    ...
    def BatchExecuteStatement(self, input: DafnyBatchExecuteStatementInput) -> DafnyBatchExecuteStatementOutput:
        boto_request_dict = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_BatchExecuteStatementInput(input)
        try:
    ...
    def BatchGetItem(self, input: DafnyBatchGetItemInput) -> DafnyBatchGetItemOutput:
        boto_request_dict = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_BatchGetItemInput(input)
        try:
    ...
    def BatchWriteItem(self, input: DafnyBatchWriteItemInput) -> DafnyBatchWriteItemOutput:
        boto_request_dict = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_BatchWriteItemInput(input)
        try:
    ...
    def CreateBackup(self, input: DafnyCreateBackupInput) -> DafnyCreateBackupOutput:
        boto_request_dict = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_CreateBackupInput(input)
        try:
    ...
    def CreateGlobalTable(self, input: DafnyCreateGlobalTableInput) -> DafnyCreateGlobalTableOutput:
        boto_request_dict = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_CreateGlobalTableInput(input)
        try:
    ...
    def CreateTable(self, input: DafnyCreateTableInput) -> DafnyCreateTableOutput:
        boto_request_dict = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_CreateTableInput(input)
        try:
    ...
    def DeleteBackup(self, input: DafnyDeleteBackupInput) -> DafnyDeleteBackupOutput:
        boto_request_dict = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_DeleteBackupInput(input)
        try:
    ...
    def DeleteItem(self, input: DafnyDeleteItemInput) -> DafnyDeleteItemOutput:
        boto_request_dict = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_DeleteItemInput(input)
        try:
    ...
    def DeleteTable(self, input: DafnyDeleteTableInput) -> DafnyDeleteTableOutput:
        boto_request_dict = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_DeleteTableInput(input)
        try:
    ...
    def DescribeBackup(self, input: DafnyDescribeBackupInput) -> DafnyDescribeBackupOutput:
        boto_request_dict = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_DescribeBackupInput(input)
        try:
    ...
    def DescribeContinuousBackups(self, input: DafnyDescribeContinuousBackupsInput) -> DafnyDescribeContinuousBackupsOutput:
        boto_request_dict = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_DescribeContinuousBackupsInput(input)
        try:
    ...
    def DescribeContributorInsights(self, input: DafnyDescribeContributorInsightsInput) -> DafnyDescribeContributorInsightsOutput:
        boto_request_dict = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_DescribeContributorInsightsInput(input)
        try:
    ...
    def DescribeEndpoints(self, input: DafnyDescribeEndpointsRequest) -> DafnyDescribeEndpointsResponse:
        boto_request_dict = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_DescribeEndpointsRequest(input)
        try:
    ...
    def DescribeExport(self, input: DafnyDescribeExportInput) -> DafnyDescribeExportOutput:
        boto_request_dict = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_DescribeExportInput(input)
        try:
    ...
    def DescribeGlobalTable(self, input: DafnyDescribeGlobalTableInput) -> DafnyDescribeGlobalTableOutput:
        boto_request_dict = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_DescribeGlobalTableInput(input)
        try:
    ...
    def DescribeGlobalTableSettings(self, input: DafnyDescribeGlobalTableSettingsInput) -> DafnyDescribeGlobalTableSettingsOutput:
        boto_request_dict = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_DescribeGlobalTableSettingsInput(input)
        try:
    ...
    def DescribeImport(self, input: DafnyDescribeImportInput) -> DafnyDescribeImportOutput:
        boto_request_dict = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_DescribeImportInput(input)
        try:
    ...
    def DescribeKinesisStreamingDestination(self, input: DafnyDescribeKinesisStreamingDestinationInput) -> DafnyDescribeKinesisStreamingDestinationOutput:
        boto_request_dict = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_DescribeKinesisStreamingDestinationInput(input)
        try:
    ...
    def DescribeLimits(self, input: DafnyDescribeLimitsInput) -> DafnyDescribeLimitsOutput:
        boto_request_dict = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_DescribeLimitsInput(input)
        try:
    ...
    def DescribeTable(self, input: DafnyDescribeTableInput) -> DafnyDescribeTableOutput:
        boto_request_dict = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_DescribeTableInput(input)
        try:
    ...
    def DescribeTableReplicaAutoScaling(self, input: DafnyDescribeTableReplicaAutoScalingInput) -> DafnyDescribeTableReplicaAutoScalingOutput:
        boto_request_dict = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_DescribeTableReplicaAutoScalingInput(input)
        try:
    ...
    def DescribeTimeToLive(self, input: DafnyDescribeTimeToLiveInput) -> DafnyDescribeTimeToLiveOutput:
        boto_request_dict = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_DescribeTimeToLiveInput(input)
        try:
    ...
    def DisableKinesisStreamingDestination(self, input: DafnyDisableKinesisStreamingDestinationInput) -> DafnyDisableKinesisStreamingDestinationOutput:
        boto_request_dict = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_DisableKinesisStreamingDestinationInput(input)
        try:
    ...
    def EnableKinesisStreamingDestination(self, input: DafnyEnableKinesisStreamingDestinationInput) -> DafnyEnableKinesisStreamingDestinationOutput:
        boto_request_dict = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_EnableKinesisStreamingDestinationInput(input)
        try:
    ...
    def ExecuteStatement(self, input: DafnyExecuteStatementInput) -> DafnyExecuteStatementOutput:
        boto_request_dict = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ExecuteStatementInput(input)
        try:
    ...
    def ExecuteTransaction(self, input: DafnyExecuteTransactionInput) -> DafnyExecuteTransactionOutput:
        boto_request_dict = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ExecuteTransactionInput(input)
        try:
    ...
    def ExportTableToPointInTime(self, input: DafnyExportTableToPointInTimeInput) -> DafnyExportTableToPointInTimeOutput:
        boto_request_dict = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ExportTableToPointInTimeInput(input)
        try:
    ...
    def ImportTable(self, input: DafnyImportTableInput) -> DafnyImportTableOutput:
        boto_request_dict = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ImportTableInput(input)
        try:
    ...
    def ListBackups(self, input: DafnyListBackupsInput) -> DafnyListBackupsOutput:
        boto_request_dict = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ListBackupsInput(input)
        try:
    ...
    def ListContributorInsights(self, input: DafnyListContributorInsightsInput) -> DafnyListContributorInsightsOutput:
        boto_request_dict = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ListContributorInsightsInput(input)
        try:
    ...
    def ListExports(self, input: DafnyListExportsInput) -> DafnyListExportsOutput:
        boto_request_dict = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ListExportsInput(input)
        try:
    ...
    def ListGlobalTables(self, input: DafnyListGlobalTablesInput) -> DafnyListGlobalTablesOutput:
        boto_request_dict = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ListGlobalTablesInput(input)
        try:
    ...
    def ListImports(self, input: DafnyListImportsInput) -> DafnyListImportsOutput:
        boto_request_dict = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ListImportsInput(input)
        try:
    ...
    def ListTables(self, input: DafnyListTablesInput) -> DafnyListTablesOutput:
        boto_request_dict = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ListTablesInput(input)
        try:
    ...
    def ListTagsOfResource(self, input: DafnyListTagsOfResourceInput) -> DafnyListTagsOfResourceOutput:
        boto_request_dict = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ListTagsOfResourceInput(input)
        try:
    ...
    def PutItem(self, input: DafnyPutItemInput) -> DafnyPutItemOutput:
        boto_request_dict = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_PutItemInput(input)
        try:
    ...
    def Query(self, input: DafnyQueryInput) -> DafnyQueryOutput:
        boto_request_dict = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_QueryInput(input)
        try:
    ...
    def RestoreTableFromBackup(self, input: DafnyRestoreTableFromBackupInput) -> DafnyRestoreTableFromBackupOutput:
        boto_request_dict = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_RestoreTableFromBackupInput(input)
        try:
    ...
    def RestoreTableToPointInTime(self, input: DafnyRestoreTableToPointInTimeInput) -> DafnyRestoreTableToPointInTimeOutput:
        boto_request_dict = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_RestoreTableToPointInTimeInput(input)
        try:
    ...
    def Scan(self, input: DafnyScanInput) -> DafnyScanOutput:
        boto_request_dict = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_ScanInput(input)
        try:
    ...
    def TagResource(self, input: DafnyTagResourceInput) -> None:
        boto_request_dict = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_TagResourceInput(input)
        try:
    ...
    def TransactGetItems(self, input: DafnyTransactGetItemsInput) -> DafnyTransactGetItemsOutput:
        boto_request_dict = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_TransactGetItemsInput(input)
        try:
    ...
    def TransactWriteItems(self, input: DafnyTransactWriteItemsInput) -> DafnyTransactWriteItemsOutput:
        boto_request_dict = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_TransactWriteItemsInput(input)
        try:
    ...
    def UntagResource(self, input: DafnyUntagResourceInput) -> None:
        boto_request_dict = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_UntagResourceInput(input)
        try:
    ...
    def UpdateContinuousBackups(self, input: DafnyUpdateContinuousBackupsInput) -> DafnyUpdateContinuousBackupsOutput:
        boto_request_dict = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_UpdateContinuousBackupsInput(input)
        try:
    ...
    def UpdateContributorInsights(self, input: DafnyUpdateContributorInsightsInput) -> DafnyUpdateContributorInsightsOutput:
        boto_request_dict = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_UpdateContributorInsightsInput(input)
        try:
    ...
    def UpdateGlobalTable(self, input: DafnyUpdateGlobalTableInput) -> DafnyUpdateGlobalTableOutput:
        boto_request_dict = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_UpdateGlobalTableInput(input)
        try:
    ...
    def UpdateGlobalTableSettings(self, input: DafnyUpdateGlobalTableSettingsInput) -> DafnyUpdateGlobalTableSettingsOutput:
        boto_request_dict = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_UpdateGlobalTableSettingsInput(input)
        try:
    ...
    def UpdateItem(self, input: DafnyUpdateItemInput) -> DafnyUpdateItemOutput:
        boto_request_dict = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_UpdateItemInput(input)
        try:
    ...
    def UpdateTable(self, input: DafnyUpdateTableInput) -> DafnyUpdateTableOutput:
        boto_request_dict = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_UpdateTableInput(input)
        try:
    ...
    def UpdateTableReplicaAutoScaling(self, input: DafnyUpdateTableReplicaAutoScalingInput) -> DafnyUpdateTableReplicaAutoScalingOutput:
        boto_request_dict = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_UpdateTableReplicaAutoScalingInput(input)
        try:
    ...
    def UpdateTimeToLive(self, input: DafnyUpdateTimeToLiveInput) -> DafnyUpdateTimeToLiveOutput:
        boto_request_dict = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.DafnyToAwsSdk_com_amazonaws_dynamodb_UpdateTimeToLiveInput(input)
        try:
