...
def com_amazonaws_dynamodb_CancellationReason(dafny_input):
    ...
    if dafny_input.Item.is_Some:
        output["Item"] = {key.VerbatimString(False): com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in dafny_input.Item.value.items }
...
def com_amazonaws_dynamodb_AttributeValue(dafny_input):
    ...
    if isinstance(dafny_input, AttributeValue_S):
        ...
        AttributeValue_union_value = {"SS": [list_element.VerbatimString(False) for list_element in dafny_input.SS]}
    elif isinstance(dafny_input, AttributeValue_NS):
        AttributeValue_union_value = {"NS": [list_element.VerbatimString(False) for list_element in dafny_input.NS]}
        ...
        AttributeValue_union_value = {"M": {key.VerbatimString(False): com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in dafny_input.M.items }}
    elif isinstance(dafny_input, AttributeValue_L):
        AttributeValue_union_value = {"L": [com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_AttributeValue(list_element) for list_element in dafny_input.L]}
...
def com_amazonaws_dynamodb_TransactionCanceledException(dafny_input):
    ...
    if dafny_input.CancellationReasons.is_Some:
        output["CancellationReasons"] = [com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_CancellationReason(list_element) for list_element in dafny_input.CancellationReasons.value]
...
def com_amazonaws_dynamodb_BatchStatementRequest(dafny_input):
    ...
    if dafny_input.Parameters.is_Some:
        output["Parameters"] = [com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_AttributeValue(list_element) for list_element in dafny_input.Parameters.value]
...
def com_amazonaws_dynamodb_BatchExecuteStatementInput(dafny_input):
    output = {}
    output["Statements"] = [com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_BatchStatementRequest(list_element) for list_element in dafny_input.Statements]
    if dafny_input.ReturnConsumedCapacity.is_Some:
        output["ReturnConsumedCapacity"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_ReturnConsumedCapacity(dafny_input.ReturnConsumedCapacity.value)
...
def com_amazonaws_dynamodb_BatchStatementResponse(dafny_input):
    ...
    if dafny_input.Error.is_Some:
        output["Error"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_BatchStatementError(dafny_input.Error.value)
...
def com_amazonaws_dynamodb_BatchStatementError(dafny_input):
    output = {}
    if dafny_input.Code.is_Some:
        output["Code"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_BatchStatementErrorCodeEnum(dafny_input.Code.value)
...
def com_amazonaws_dynamodb_ConsumedCapacity(dafny_input):
    ...
    if dafny_input.Table.is_Some:
        output["Table"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_Capacity(dafny_input.Table.value)

    if dafny_input.LocalSecondaryIndexes.is_Some:
        output["LocalSecondaryIndexes"] = {key.VerbatimString(False): com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_Capacity(value) for (key, value) in dafny_input.LocalSecondaryIndexes.value.items }

    if dafny_input.GlobalSecondaryIndexes.is_Some:
        output["GlobalSecondaryIndexes"] = {key.VerbatimString(False): com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_Capacity(value) for (key, value) in dafny_input.GlobalSecondaryIndexes.value.items }
...
def com_amazonaws_dynamodb_BatchExecuteStatementOutput(dafny_input):
    ...
    if dafny_input.Responses.is_Some:
        output["Responses"] = [com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_BatchStatementResponse(list_element) for list_element in dafny_input.Responses.value]

    if dafny_input.ConsumedCapacity.is_Some:
        output["ConsumedCapacity"] = [com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_ConsumedCapacity(list_element) for list_element in dafny_input.ConsumedCapacity.value]

    return output

def com_amazonaws_dynamodb_KeysAndAttributes(dafny_input):
    output = {}
    output["Keys"] = [{key.VerbatimString(False): com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in list_element.items } for list_element in dafny_input.Keys]
    if dafny_input.AttributesToGet.is_Some:
        output["AttributesToGet"] = [list_element.VerbatimString(False) for list_element in dafny_input.AttributesToGet.value]

    if dafny_input.ConsistentRead.is_Some:
        output["ConsistentRead"] = dafny_input.ConsistentRead.value

    if dafny_input.ProjectionExpression.is_Some:
        output["ProjectionExpression"] = dafny_input.ProjectionExpression.value.VerbatimString(False)

    if dafny_input.ExpressionAttributeNames.is_Some:
        output["ExpressionAttributeNames"] = {key.VerbatimString(False): value.VerbatimString(False) for (key, value) in dafny_input.ExpressionAttributeNames.value.items }

    return output

def com_amazonaws_dynamodb_BatchGetItemInput(dafny_input):
    output = {}
    output["RequestItems"] = {key.VerbatimString(False): com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_KeysAndAttributes(value) for (key, value) in dafny_input.RequestItems.items }
    if dafny_input.ReturnConsumedCapacity.is_Some:
        output["ReturnConsumedCapacity"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_ReturnConsumedCapacity(dafny_input.ReturnConsumedCapacity.value)
...
def com_amazonaws_dynamodb_BatchGetItemOutput(dafny_input):
    ...
    if dafny_input.UnprocessedKeys.is_Some:
        output["UnprocessedKeys"] = {key.VerbatimString(False): com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_KeysAndAttributes(value) for (key, value) in dafny_input.UnprocessedKeys.value.items }
...
def com_amazonaws_dynamodb_WriteRequest(dafny_input):
    ...
    if dafny_input.PutRequest.is_Some:
        output["PutRequest"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_PutRequest(dafny_input.PutRequest.value)

    if dafny_input.DeleteRequest.is_Some:
        output["DeleteRequest"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_DeleteRequest(dafny_input.DeleteRequest.value)

    return output

def com_amazonaws_dynamodb_PutRequest(dafny_input):
    output = {}
    output["Item"] = {key.VerbatimString(False): com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in dafny_input.Item.items }
    return output

def com_amazonaws_dynamodb_DeleteRequest(dafny_input):
    output = {}
    output["Key"] = {key.VerbatimString(False): com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in dafny_input.Key.items }
    return output
...
def com_amazonaws_dynamodb_BatchWriteItemInput(dafny_input):
    output = {}
    output["RequestItems"] = {key.VerbatimString(False): [com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_WriteRequest(list_element) for list_element in value] for (key, value) in dafny_input.RequestItems.items }
    if dafny_input.ReturnConsumedCapacity.is_Some:
        output["ReturnConsumedCapacity"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_ReturnConsumedCapacity(dafny_input.ReturnConsumedCapacity.value)

    if dafny_input.ReturnItemCollectionMetrics.is_Some:
        output["ReturnItemCollectionMetrics"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_ReturnItemCollectionMetrics(dafny_input.ReturnItemCollectionMetrics.value)
...
def com_amazonaws_dynamodb_ItemCollectionMetrics(dafny_input):
    ...
    if dafny_input.ItemCollectionKey.is_Some:
        output["ItemCollectionKey"] = {key.VerbatimString(False): com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in dafny_input.ItemCollectionKey.value.items }
...
def com_amazonaws_dynamodb_BatchWriteItemOutput(dafny_input):
    ...
    if dafny_input.UnprocessedItems.is_Some:
        output["UnprocessedItems"] = {key.VerbatimString(False): [com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_WriteRequest(list_element) for list_element in value] for (key, value) in dafny_input.UnprocessedItems.value.items }

    if dafny_input.ItemCollectionMetrics.is_Some:
        output["ItemCollectionMetrics"] = {key.VerbatimString(False): [com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_ItemCollectionMetrics(list_element) for list_element in value] for (key, value) in dafny_input.ItemCollectionMetrics.value.items }
...
def com_amazonaws_dynamodb_BackupDetails(dafny_input):
    ...
    output["BackupStatus"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_BackupStatus(dafny_input.BackupStatus)
    output["BackupType"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_BackupType(dafny_input.BackupType)
...
def com_amazonaws_dynamodb_CreateBackupOutput(dafny_input):
    ...
    if dafny_input.BackupDetails.is_Some:
        output["BackupDetails"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_BackupDetails(dafny_input.BackupDetails.value)
...
def com_amazonaws_dynamodb_CreateGlobalTableInput(dafny_input):
    ...
    output["ReplicationGroup"] = [com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_Replica(list_element) for list_element in dafny_input.ReplicationGroup]
    return output

def com_amazonaws_dynamodb_GlobalTableDescription(dafny_input):
    output = {}
    if dafny_input.ReplicationGroup.is_Some:
        output["ReplicationGroup"] = [com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_ReplicaDescription(list_element) for list_element in dafny_input.ReplicationGroup.value]

    if dafny_input.GlobalTableArn.is_Some:
        output["GlobalTableArn"] = dafny_input.GlobalTableArn.value.VerbatimString(False)
    ...
    if dafny_input.GlobalTableStatus.is_Some:
        output["GlobalTableStatus"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_GlobalTableStatus(dafny_input.GlobalTableStatus.value)

    if dafny_input.GlobalTableName.is_Some:
        output["GlobalTableName"] = dafny_input.GlobalTableName.value.VerbatimString(False)
...
def com_amazonaws_dynamodb_ReplicaDescription(dafny_input):
    ...
    if dafny_input.ReplicaStatus.is_Some:
        output["ReplicaStatus"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_ReplicaStatus(dafny_input.ReplicaStatus.value)

    if dafny_input.ReplicaStatusDescription.is_Some:
        output["ReplicaStatusDescription"] = dafny_input.ReplicaStatusDescription.value.VerbatimString(False)

    if dafny_input.ReplicaStatusPercentProgress.is_Some:
        output["ReplicaStatusPercentProgress"] = dafny_input.ReplicaStatusPercentProgress.value.VerbatimString(False)

    if dafny_input.KMSMasterKeyId.is_Some:
        output["KMSMasterKeyId"] = dafny_input.KMSMasterKeyId.value.VerbatimString(False)

    if dafny_input.ProvisionedThroughputOverride.is_Some:
        output["ProvisionedThroughputOverride"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_ProvisionedThroughputOverride(dafny_input.ProvisionedThroughputOverride.value)

    if dafny_input.GlobalSecondaryIndexes.is_Some:
        output["GlobalSecondaryIndexes"] = [com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_ReplicaGlobalSecondaryIndexDescription(list_element) for list_element in dafny_input.GlobalSecondaryIndexes.value]
    ...
    if dafny_input.ReplicaTableClassSummary.is_Some:
        output["ReplicaTableClassSummary"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_TableClassSummary(dafny_input.ReplicaTableClassSummary.value)
...
def com_amazonaws_dynamodb_TableClassSummary(dafny_input):
    ...
    if dafny_input.TableClass.is_Some:
        output["TableClass"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_TableClass(dafny_input.TableClass.value)
...
def com_amazonaws_dynamodb_CreateGlobalTableOutput(dafny_input):
    ...
    if dafny_input.GlobalTableDescription.is_Some:
        output["GlobalTableDescription"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_GlobalTableDescription(dafny_input.GlobalTableDescription.value)
...
def com_amazonaws_dynamodb_AttributeDefinition(dafny_input):
    ...
    output["AttributeType"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_ScalarAttributeType(dafny_input.AttributeType)
    return output
...
def com_amazonaws_dynamodb_KeySchemaElement(dafny_input):
    output = {}
    output["AttributeName"] = dafny_input.AttributeName.VerbatimString(False)
    output["KeyType"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_KeyType(dafny_input.KeyType)
    return output
...
def com_amazonaws_dynamodb_LocalSecondaryIndex(dafny_input):
    ...
    output["KeySchema"] = [com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_KeySchemaElement(list_element) for list_element in dafny_input.KeySchema]
    output["Projection"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_Projection(dafny_input.Projection)
    return output

def com_amazonaws_dynamodb_Projection(dafny_input):
    output = {}
    if dafny_input.ProjectionType.is_Some:
        output["ProjectionType"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_ProjectionType(dafny_input.ProjectionType.value)

    if dafny_input.NonKeyAttributes.is_Some:
        output["NonKeyAttributes"] = [list_element.VerbatimString(False) for list_element in dafny_input.NonKeyAttributes.value]
...
def com_amazonaws_dynamodb_GlobalSecondaryIndex(dafny_input):
    ...
    if dafny_input.ProvisionedThroughput.is_Some:
        output["ProvisionedThroughput"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_ProvisionedThroughput(dafny_input.ProvisionedThroughput.value)
...
def com_amazonaws_dynamodb_StreamSpecification(dafny_input):
    ...
    if dafny_input.StreamViewType.is_Some:
        output["StreamViewType"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_StreamViewType(dafny_input.StreamViewType.value)
...
def com_amazonaws_dynamodb_SSESpecification(dafny_input):
    ...
    if dafny_input.SSEType.is_Some:
        output["SSEType"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_SSEType(dafny_input.SSEType.value)
...
def com_amazonaws_dynamodb_CreateTableInput(dafny_input):
    output = {}
    output["AttributeDefinitions"] = [com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_AttributeDefinition(list_element) for list_element in dafny_input.AttributeDefinitions]
    output["TableName"] = dafny_input.TableName.VerbatimString(False)
    output["KeySchema"] = [com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_KeySchemaElement(list_element) for list_element in dafny_input.KeySchema]
    if dafny_input.LocalSecondaryIndexes.is_Some:
        output["LocalSecondaryIndexes"] = [com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_LocalSecondaryIndex(list_element) for list_element in dafny_input.LocalSecondaryIndexes.value]

    if dafny_input.GlobalSecondaryIndexes.is_Some:
        output["GlobalSecondaryIndexes"] = [com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_GlobalSecondaryIndex(list_element) for list_element in dafny_input.GlobalSecondaryIndexes.value]

    if dafny_input.BillingMode.is_Some:
        output["BillingMode"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_BillingMode(dafny_input.BillingMode.value)

    if dafny_input.ProvisionedThroughput.is_Some:
        output["ProvisionedThroughput"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_ProvisionedThroughput(dafny_input.ProvisionedThroughput.value)

    if dafny_input.StreamSpecification.is_Some:
        output["StreamSpecification"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_StreamSpecification(dafny_input.StreamSpecification.value)

    if dafny_input.SSESpecification.is_Some:
        output["SSESpecification"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_SSESpecification(dafny_input.SSESpecification.value)

    if dafny_input.Tags.is_Some:
        output["Tags"] = [com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_Tag(list_element) for list_element in dafny_input.Tags.value]
...
def com_amazonaws_dynamodb_TableDescription(dafny_input):
    ...
    if dafny_input.AttributeDefinitions.is_Some:
        output["AttributeDefinitions"] = [com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_AttributeDefinition(list_element) for list_element in dafny_input.AttributeDefinitions.value]

    if dafny_input.TableName.is_Some:
        output["TableName"] = dafny_input.TableName.value.VerbatimString(False)

    if dafny_input.KeySchema.is_Some:
        output["KeySchema"] = [com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_KeySchemaElement(list_element) for list_element in dafny_input.KeySchema.value]

    if dafny_input.TableStatus.is_Some:
        output["TableStatus"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_TableStatus(dafny_input.TableStatus.value)

    if dafny_input.CreationDateTime.is_Some:
        output["CreationDateTime"] = TypeError("TimestampShape not supported")

    if dafny_input.ProvisionedThroughput.is_Some:
        output["ProvisionedThroughput"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_ProvisionedThroughputDescription(dafny_input.ProvisionedThroughput.value)
    ...
    if dafny_input.BillingModeSummary.is_Some:
        output["BillingModeSummary"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_BillingModeSummary(dafny_input.BillingModeSummary.value)

    if dafny_input.LocalSecondaryIndexes.is_Some:
        output["LocalSecondaryIndexes"] = [com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_LocalSecondaryIndexDescription(list_element) for list_element in dafny_input.LocalSecondaryIndexes.value]

    if dafny_input.GlobalSecondaryIndexes.is_Some:
        output["GlobalSecondaryIndexes"] = [com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_GlobalSecondaryIndexDescription(list_element) for list_element in dafny_input.GlobalSecondaryIndexes.value]

    if dafny_input.StreamSpecification.is_Some:
        output["StreamSpecification"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_StreamSpecification(dafny_input.StreamSpecification.value)

    if dafny_input.LatestStreamLabel.is_Some:
        output["LatestStreamLabel"] = dafny_input.LatestStreamLabel.value.VerbatimString(False)

    if dafny_input.LatestStreamArn.is_Some:
        output["LatestStreamArn"] = dafny_input.LatestStreamArn.value.VerbatimString(False)

    if dafny_input.GlobalTableVersion.is_Some:
        output["GlobalTableVersion"] = dafny_input.GlobalTableVersion.value.VerbatimString(False)

    if dafny_input.Replicas.is_Some:
        output["Replicas"] = [com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_ReplicaDescription(list_element) for list_element in dafny_input.Replicas.value]

    if dafny_input.RestoreSummary.is_Some:
        output["RestoreSummary"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_RestoreSummary(dafny_input.RestoreSummary.value)

    if dafny_input.SSEDescription.is_Some:
        output["SSEDescription"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_SSEDescription(dafny_input.SSEDescription.value)

    if dafny_input.ArchivalSummary.is_Some:
        output["ArchivalSummary"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_ArchivalSummary(dafny_input.ArchivalSummary.value)

    if dafny_input.TableClassSummary.is_Some:
        output["TableClassSummary"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_TableClassSummary(dafny_input.TableClassSummary.value)
...
def com_amazonaws_dynamodb_LocalSecondaryIndexDescription(dafny_input):
    ...
    if dafny_input.Projection.is_Some:
        output["Projection"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_Projection(dafny_input.Projection.value)
...
def com_amazonaws_dynamodb_GlobalSecondaryIndexDescription(dafny_input):
    ...
    if dafny_input.IndexStatus.is_Some:
        output["IndexStatus"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_IndexStatus(dafny_input.IndexStatus.value)
...
def com_amazonaws_dynamodb_RestoreSummary(dafny_input):
    ...
    if dafny_input.SourceBackupArn.is_Some:
        output["SourceBackupArn"] = dafny_input.SourceBackupArn.value.VerbatimString(False)

    if dafny_input.SourceTableArn.is_Some:
        output["SourceTableArn"] = dafny_input.SourceTableArn.value.VerbatimString(False)
...
def com_amazonaws_dynamodb_SSEDescription(dafny_input):
    ...
    if dafny_input.Status.is_Some:
        output["Status"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_SSEStatus(dafny_input.Status.value)

    if dafny_input.SSEType.is_Some:
        output["SSEType"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_SSEType(dafny_input.SSEType.value)

    if dafny_input.KMSMasterKeyArn.is_Some:
        output["KMSMasterKeyArn"] = dafny_input.KMSMasterKeyArn.value.VerbatimString(False)
...
def com_amazonaws_dynamodb_ArchivalSummary(dafny_input):
    ...
    if dafny_input.ArchivalReason.is_Some:
        output["ArchivalReason"] = dafny_input.ArchivalReason.value.VerbatimString(False)

    if dafny_input.ArchivalBackupArn.is_Some:
        output["ArchivalBackupArn"] = dafny_input.ArchivalBackupArn.value.VerbatimString(False)
...
def com_amazonaws_dynamodb_CreateTableOutput(dafny_input):
    ...
    if dafny_input.TableDescription.is_Some:
        output["TableDescription"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_TableDescription(dafny_input.TableDescription.value)
...
def com_amazonaws_dynamodb_BackupDescription(dafny_input):
    ...
    if dafny_input.SourceTableDetails.is_Some:
        output["SourceTableDetails"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_SourceTableDetails(dafny_input.SourceTableDetails.value)

    if dafny_input.SourceTableFeatureDetails.is_Some:
        output["SourceTableFeatureDetails"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_SourceTableFeatureDetails(dafny_input.SourceTableFeatureDetails.value)
...
def com_amazonaws_dynamodb_SourceTableDetails(dafny_input):
    ...
    output["ProvisionedThroughput"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_ProvisionedThroughput(dafny_input.ProvisionedThroughput)
    if dafny_input.ItemCount.is_Some:
        output["ItemCount"] = dafny_input.ItemCount.value
...
def com_amazonaws_dynamodb_SourceTableFeatureDetails(dafny_input):
    output = {}
    if dafny_input.LocalSecondaryIndexes.is_Some:
        output["LocalSecondaryIndexes"] = [com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_LocalSecondaryIndexInfo(list_element) for list_element in dafny_input.LocalSecondaryIndexes.value]

    if dafny_input.GlobalSecondaryIndexes.is_Some:
        output["GlobalSecondaryIndexes"] = [com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_GlobalSecondaryIndexInfo(list_element) for list_element in dafny_input.GlobalSecondaryIndexes.value]

    if dafny_input.StreamDescription.is_Some:
        output["StreamDescription"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_StreamSpecification(dafny_input.StreamDescription.value)

    if dafny_input.TimeToLiveDescription.is_Some:
        output["TimeToLiveDescription"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_TimeToLiveDescription(dafny_input.TimeToLiveDescription.value)
...
def com_amazonaws_dynamodb_TimeToLiveDescription(dafny_input):
    ...
    if dafny_input.TimeToLiveStatus.is_Some:
        output["TimeToLiveStatus"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_TimeToLiveStatus(dafny_input.TimeToLiveStatus.value)
...
def com_amazonaws_dynamodb_DeleteBackupOutput(dafny_input):
    ...
    if dafny_input.BackupDescription.is_Some:
        output["BackupDescription"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_BackupDescription(dafny_input.BackupDescription.value)
...
def com_amazonaws_dynamodb_ExpectedAttributeValue(dafny_input):
    ...
    if dafny_input.Value.is_Some:
        output["Value"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_AttributeValue(dafny_input.Value.value)

    if dafny_input.Exists.is_Some:
        output["Exists"] = dafny_input.Exists.value

    if dafny_input.ComparisonOperator.is_Some:
        output["ComparisonOperator"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_ComparisonOperator(dafny_input.ComparisonOperator.value)

    if dafny_input.AttributeValueList.is_Some:
        output["AttributeValueList"] = [com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_AttributeValue(list_element) for list_element in dafny_input.AttributeValueList.value]
...
def com_amazonaws_dynamodb_DeleteItemInput(dafny_input):
    ...
    if dafny_input.Expected.is_Some:
        output["Expected"] = {key.VerbatimString(False): com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_ExpectedAttributeValue(value) for (key, value) in dafny_input.Expected.value.items }

    if dafny_input.ConditionalOperator.is_Some:
        output["ConditionalOperator"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_ConditionalOperator(dafny_input.ConditionalOperator.value)

    if dafny_input.ReturnValues.is_Some:
        output["ReturnValues"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_ReturnValue(dafny_input.ReturnValues.value)
    ...
    if dafny_input.ConditionExpression.is_Some:
        output["ConditionExpression"] = dafny_input.ConditionExpression.value.VerbatimString(False)

    if dafny_input.ExpressionAttributeNames.is_Some:
        output["ExpressionAttributeNames"] = {key.VerbatimString(False): value.VerbatimString(False) for (key, value) in dafny_input.ExpressionAttributeNames.value.items }

    if dafny_input.ExpressionAttributeValues.is_Some:
        output["ExpressionAttributeValues"] = {key.VerbatimString(False): com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in dafny_input.ExpressionAttributeValues.value.items }
...
def com_amazonaws_dynamodb_DeleteItemOutput(dafny_input):
    ...
    if dafny_input.Attributes.is_Some:
        output["Attributes"] = {key.VerbatimString(False): com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in dafny_input.Attributes.value.items }

    if dafny_input.ConsumedCapacity.is_Some:
        output["ConsumedCapacity"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_ConsumedCapacity(dafny_input.ConsumedCapacity.value)

    if dafny_input.ItemCollectionMetrics.is_Some:
        output["ItemCollectionMetrics"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_ItemCollectionMetrics(dafny_input.ItemCollectionMetrics.value)
...
def com_amazonaws_dynamodb_ContinuousBackupsDescription(dafny_input):
    output = {}
    output["ContinuousBackupsStatus"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_ContinuousBackupsStatus(dafny_input.ContinuousBackupsStatus)
    if dafny_input.PointInTimeRecoveryDescription.is_Some:
        output["PointInTimeRecoveryDescription"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_PointInTimeRecoveryDescription(dafny_input.PointInTimeRecoveryDescription.value)
...
def com_amazonaws_dynamodb_PointInTimeRecoveryDescription(dafny_input):
    ...
    if dafny_input.PointInTimeRecoveryStatus.is_Some:
        output["PointInTimeRecoveryStatus"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_PointInTimeRecoveryStatus(dafny_input.PointInTimeRecoveryStatus.value)
...
def com_amazonaws_dynamodb_DescribeContinuousBackupsOutput(dafny_input):
    ...
    if dafny_input.ContinuousBackupsDescription.is_Some:
        output["ContinuousBackupsDescription"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_ContinuousBackupsDescription(dafny_input.ContinuousBackupsDescription.value)
...
def com_amazonaws_dynamodb_FailureException(dafny_input):
    ...
    if dafny_input.ExceptionDescription.is_Some:
        output["ExceptionDescription"] = dafny_input.ExceptionDescription.value.VerbatimString(False)
...
def com_amazonaws_dynamodb_DescribeContributorInsightsOutput(dafny_input):
    ...
    if dafny_input.ContributorInsightsRuleList.is_Some:
        output["ContributorInsightsRuleList"] = [list_element.VerbatimString(False) for list_element in dafny_input.ContributorInsightsRuleList.value]

    if dafny_input.ContributorInsightsStatus.is_Some:
        output["ContributorInsightsStatus"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_ContributorInsightsStatus(dafny_input.ContributorInsightsStatus.value)

    if dafny_input.LastUpdateDateTime.is_Some:
        output["LastUpdateDateTime"] = TypeError("TimestampShape not supported")

    if dafny_input.FailureException.is_Some:
        output["FailureException"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_FailureException(dafny_input.FailureException.value)
...
def com_amazonaws_dynamodb_DescribeEndpointsResponse(dafny_input):
    output = {}
    output["Endpoints"] = [com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_Endpoint(list_element) for list_element in dafny_input.Endpoints]
    return output
...
def com_amazonaws_dynamodb_ExportDescription(dafny_input):
    ...
    if dafny_input.ExportStatus.is_Some:
        output["ExportStatus"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_ExportStatus(dafny_input.ExportStatus.value)
    ...
    if dafny_input.ExportManifest.is_Some:
        output["ExportManifest"] = dafny_input.ExportManifest.value.VerbatimString(False)
    ...
    if dafny_input.S3SseAlgorithm.is_Some:
        output["S3SseAlgorithm"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_S3SseAlgorithm(dafny_input.S3SseAlgorithm.value)
    ...
    if dafny_input.FailureMessage.is_Some:
        output["FailureMessage"] = dafny_input.FailureMessage.value.VerbatimString(False)

    if dafny_input.ExportFormat.is_Some:
        output["ExportFormat"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_ExportFormat(dafny_input.ExportFormat.value)
...
def com_amazonaws_dynamodb_DescribeExportOutput(dafny_input):
    ...
    if dafny_input.ExportDescription.is_Some:
        output["ExportDescription"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_ExportDescription(dafny_input.ExportDescription.value)
...
def com_amazonaws_dynamodb_ReplicaSettingsDescription(dafny_input):
    ...
    if dafny_input.ReplicaBillingModeSummary.is_Some:
        output["ReplicaBillingModeSummary"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_BillingModeSummary(dafny_input.ReplicaBillingModeSummary.value)
    ...
    if dafny_input.ReplicaProvisionedReadCapacityAutoScalingSettings.is_Some:
        output["ReplicaProvisionedReadCapacityAutoScalingSettings"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_AutoScalingSettingsDescription(dafny_input.ReplicaProvisionedReadCapacityAutoScalingSettings.value)
    ...
    if dafny_input.ReplicaProvisionedWriteCapacityAutoScalingSettings.is_Some:
        output["ReplicaProvisionedWriteCapacityAutoScalingSettings"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_AutoScalingSettingsDescription(dafny_input.ReplicaProvisionedWriteCapacityAutoScalingSettings.value)

    if dafny_input.ReplicaGlobalSecondaryIndexSettings.is_Some:
        output["ReplicaGlobalSecondaryIndexSettings"] = [com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_ReplicaGlobalSecondaryIndexSettingsDescription(list_element) for list_element in dafny_input.ReplicaGlobalSecondaryIndexSettings.value]
...
def com_amazonaws_dynamodb_AutoScalingSettingsDescription(dafny_input):
    ...
    if dafny_input.AutoScalingRoleArn.is_Some:
        output["AutoScalingRoleArn"] = dafny_input.AutoScalingRoleArn.value.VerbatimString(False)

    if dafny_input.ScalingPolicies.is_Some:
        output["ScalingPolicies"] = [com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_AutoScalingPolicyDescription(list_element) for list_element in dafny_input.ScalingPolicies.value]
...
def com_amazonaws_dynamodb_ReplicaGlobalSecondaryIndexSettingsDescription(dafny_input):
    ...
    if dafny_input.ProvisionedReadCapacityAutoScalingSettings.is_Some:
        output["ProvisionedReadCapacityAutoScalingSettings"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_AutoScalingSettingsDescription(dafny_input.ProvisionedReadCapacityAutoScalingSettings.value)
    ...
    if dafny_input.ProvisionedWriteCapacityAutoScalingSettings.is_Some:
        output["ProvisionedWriteCapacityAutoScalingSettings"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_AutoScalingSettingsDescription(dafny_input.ProvisionedWriteCapacityAutoScalingSettings.value)
...
def com_amazonaws_dynamodb_AutoScalingPolicyDescription(dafny_input):
    ...
    if dafny_input.TargetTrackingScalingPolicyConfiguration.is_Some:
        output["TargetTrackingScalingPolicyConfiguration"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_AutoScalingTargetTrackingScalingPolicyConfigurationDescription(dafny_input.TargetTrackingScalingPolicyConfiguration.value)
...
def com_amazonaws_dynamodb_DescribeGlobalTableSettingsOutput(dafny_input):
    ...
    if dafny_input.ReplicaSettings.is_Some:
        output["ReplicaSettings"] = [com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_ReplicaSettingsDescription(list_element) for list_element in dafny_input.ReplicaSettings.value]
...
def com_amazonaws_dynamodb_ImportTableDescription(dafny_input):
    ...
    if dafny_input.ImportStatus.is_Some:
        output["ImportStatus"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_ImportStatus(dafny_input.ImportStatus.value)
    ...
    if dafny_input.S3BucketSource.is_Some:
        output["S3BucketSource"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_S3BucketSource(dafny_input.S3BucketSource.value)
    ...
    if dafny_input.CloudWatchLogGroupArn.is_Some:
        output["CloudWatchLogGroupArn"] = dafny_input.CloudWatchLogGroupArn.value.VerbatimString(False)

    if dafny_input.InputFormat.is_Some:
        output["InputFormat"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_InputFormat(dafny_input.InputFormat.value)

    if dafny_input.InputFormatOptions.is_Some:
        output["InputFormatOptions"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_InputFormatOptions(dafny_input.InputFormatOptions.value)

    if dafny_input.InputCompressionType.is_Some:
        output["InputCompressionType"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_InputCompressionType(dafny_input.InputCompressionType.value)

    if dafny_input.TableCreationParameters.is_Some:
        output["TableCreationParameters"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_TableCreationParameters(dafny_input.TableCreationParameters.value)
...
def com_amazonaws_dynamodb_InputFormatOptions(dafny_input):
    ...
    if dafny_input.Csv.is_Some:
        output["Csv"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_CsvOptions(dafny_input.Csv.value)
...
def com_amazonaws_dynamodb_CsvOptions(dafny_input):
    ...
    if dafny_input.HeaderList.is_Some:
        output["HeaderList"] = [list_element.VerbatimString(False) for list_element in dafny_input.HeaderList.value]

    return output

def com_amazonaws_dynamodb_DescribeImportOutput(dafny_input):
    output = {}
    output["ImportTableDescription"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_ImportTableDescription(dafny_input.ImportTableDescription)
    return output
...
def com_amazonaws_dynamodb_KinesisDataStreamDestination(dafny_input):
    ...
    if dafny_input.DestinationStatus.is_Some:
        output["DestinationStatus"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_DestinationStatus(dafny_input.DestinationStatus.value)

    if dafny_input.DestinationStatusDescription.is_Some:
        output["DestinationStatusDescription"] = dafny_input.DestinationStatusDescription.value.VerbatimString(False)
...
def com_amazonaws_dynamodb_DescribeKinesisStreamingDestinationOutput(dafny_input):
    ...
    if dafny_input.KinesisDataStreamDestinations.is_Some:
        output["KinesisDataStreamDestinations"] = [com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_KinesisDataStreamDestination(list_element) for list_element in dafny_input.KinesisDataStreamDestinations.value]
...
def com_amazonaws_dynamodb_DescribeTableOutput(dafny_input):
    output = {}
    if dafny_input.Table.is_Some:
        output["Table"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_TableDescription(dafny_input.Table.value)
...
def com_amazonaws_dynamodb_TableAutoScalingDescription(dafny_input):
    ...
    if dafny_input.Replicas.is_Some:
        output["Replicas"] = [com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_ReplicaAutoScalingDescription(list_element) for list_element in dafny_input.Replicas.value]
...
def com_amazonaws_dynamodb_ReplicaAutoScalingDescription(dafny_input):
    ...
    if dafny_input.GlobalSecondaryIndexes.is_Some:
        output["GlobalSecondaryIndexes"] = [com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_ReplicaGlobalSecondaryIndexAutoScalingDescription(list_element) for list_element in dafny_input.GlobalSecondaryIndexes.value]
...
def com_amazonaws_dynamodb_DescribeTableReplicaAutoScalingOutput(dafny_input):
    ...
    if dafny_input.TableAutoScalingDescription.is_Some:
        output["TableAutoScalingDescription"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_TableAutoScalingDescription(dafny_input.TableAutoScalingDescription.value)
...
def com_amazonaws_dynamodb_ExecuteStatementOutput(dafny_input):
    ...
    if dafny_input.Items.is_Some:
        output["Items"] = [{key.VerbatimString(False): com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in list_element.items } for list_element in dafny_input.Items.value]
    ...
    if dafny_input.LastEvaluatedKey.is_Some:
        output["LastEvaluatedKey"] = {key.VerbatimString(False): com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in dafny_input.LastEvaluatedKey.value.items }
...
def com_amazonaws_dynamodb_ExecuteTransactionInput(dafny_input):
    output = {}
    output["TransactStatements"] = [com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_ParameterizedStatement(list_element) for list_element in dafny_input.TransactStatements]
    if dafny_input.ClientRequestToken.is_Some:
        output["ClientRequestToken"] = dafny_input.ClientRequestToken.value.VerbatimString(False)
...
def com_amazonaws_dynamodb_ExecuteTransactionOutput(dafny_input):
    output = {}
    if dafny_input.Responses.is_Some:
        output["Responses"] = [com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_ItemResponse(list_element) for list_element in dafny_input.Responses.value]
...
def com_amazonaws_dynamodb_ImportTableInput(dafny_input):
    ...
    output["S3BucketSource"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_S3BucketSource(dafny_input.S3BucketSource)
    output["InputFormat"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_InputFormat(dafny_input.InputFormat)
    if dafny_input.InputFormatOptions.is_Some:
        output["InputFormatOptions"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_InputFormatOptions(dafny_input.InputFormatOptions.value)
    ...
    output["TableCreationParameters"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_TableCreationParameters(dafny_input.TableCreationParameters)
    return output
...
def com_amazonaws_dynamodb_ListBackupsInput(dafny_input):
    ...
    if dafny_input.ExclusiveStartBackupArn.is_Some:
        output["ExclusiveStartBackupArn"] = dafny_input.ExclusiveStartBackupArn.value.VerbatimString(False)

    if dafny_input.BackupType.is_Some:
        output["BackupType"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_BackupTypeFilter(dafny_input.BackupType.value)
...
def com_amazonaws_dynamodb_BackupSummary(dafny_input):
    ...
    if dafny_input.BackupStatus.is_Some:
        output["BackupStatus"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_BackupStatus(dafny_input.BackupStatus.value)

    if dafny_input.BackupType.is_Some:
        output["BackupType"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_BackupType(dafny_input.BackupType.value)
...
def com_amazonaws_dynamodb_ListBackupsOutput(dafny_input):
    ...
    if dafny_input.BackupSummaries.is_Some:
        output["BackupSummaries"] = [com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_BackupSummary(list_element) for list_element in dafny_input.BackupSummaries.value]

    if dafny_input.LastEvaluatedBackupArn.is_Some:
        output["LastEvaluatedBackupArn"] = dafny_input.LastEvaluatedBackupArn.value.VerbatimString(False)
...
def com_amazonaws_dynamodb_ListContributorInsightsOutput(dafny_input):
    ...
    if dafny_input.ContributorInsightsSummaries.is_Some:
        output["ContributorInsightsSummaries"] = [com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_ContributorInsightsSummary(list_element) for list_element in dafny_input.ContributorInsightsSummaries.value]
...
def com_amazonaws_dynamodb_ListExportsOutput(dafny_input):
    ...
    if dafny_input.ExportSummaries.is_Some:
        output["ExportSummaries"] = [com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_ExportSummary(list_element) for list_element in dafny_input.ExportSummaries.value]
...
def com_amazonaws_dynamodb_ListGlobalTablesInput(dafny_input):
    ...
    if dafny_input.ExclusiveStartGlobalTableName.is_Some:
        output["ExclusiveStartGlobalTableName"] = dafny_input.ExclusiveStartGlobalTableName.value.VerbatimString(False)
...
def com_amazonaws_dynamodb_GlobalTable(dafny_input):
    ...
    if dafny_input.ReplicationGroup.is_Some:
        output["ReplicationGroup"] = [com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_Replica(list_element) for list_element in dafny_input.ReplicationGroup.value]
...
def com_amazonaws_dynamodb_ListGlobalTablesOutput(dafny_input):
    ...
    if dafny_input.GlobalTables.is_Some:
        output["GlobalTables"] = [com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_GlobalTable(list_element) for list_element in dafny_input.GlobalTables.value]

    if dafny_input.LastEvaluatedGlobalTableName.is_Some:
        output["LastEvaluatedGlobalTableName"] = dafny_input.LastEvaluatedGlobalTableName.value.VerbatimString(False)
...
def com_amazonaws_dynamodb_ListImportsOutput(dafny_input):
    ...
    if dafny_input.ImportSummaryList.is_Some:
        output["ImportSummaryList"] = [com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_ImportSummary(list_element) for list_element in dafny_input.ImportSummaryList.value]
...
def com_amazonaws_dynamodb_ListTablesInput(dafny_input):
    ...
    if dafny_input.ExclusiveStartTableName.is_Some:
        output["ExclusiveStartTableName"] = dafny_input.ExclusiveStartTableName.value.VerbatimString(False)
...
def com_amazonaws_dynamodb_ListTablesOutput(dafny_input):
    ...
    if dafny_input.TableNames.is_Some:
        output["TableNames"] = [list_element.VerbatimString(False) for list_element in dafny_input.TableNames.value]

    if dafny_input.LastEvaluatedTableName.is_Some:
        output["LastEvaluatedTableName"] = dafny_input.LastEvaluatedTableName.value.VerbatimString(False)
...
def com_amazonaws_dynamodb_Condition(dafny_input):
    ...
    output["ComparisonOperator"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_ComparisonOperator(dafny_input.ComparisonOperator)
    return output
...
def com_amazonaws_dynamodb_QueryInput(dafny_input):
    ...
    if dafny_input.Select.is_Some:
        output["Select"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_Select(dafny_input.Select.value)
    ...
    if dafny_input.KeyConditions.is_Some:
        output["KeyConditions"] = {key.VerbatimString(False): com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_Condition(value) for (key, value) in dafny_input.KeyConditions.value.items }

    if dafny_input.QueryFilter.is_Some:
        output["QueryFilter"] = {key.VerbatimString(False): com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_Condition(value) for (key, value) in dafny_input.QueryFilter.value.items }
    ...
    if dafny_input.ExclusiveStartKey.is_Some:
        output["ExclusiveStartKey"] = {key.VerbatimString(False): com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in dafny_input.ExclusiveStartKey.value.items }
    ...
    if dafny_input.FilterExpression.is_Some:
        output["FilterExpression"] = dafny_input.FilterExpression.value.VerbatimString(False)

    if dafny_input.KeyConditionExpression.is_Some:
        output["KeyConditionExpression"] = dafny_input.KeyConditionExpression.value.VerbatimString(False)
...
def com_amazonaws_dynamodb_RestoreTableFromBackupInput(dafny_input):
    ...
    if dafny_input.BillingModeOverride.is_Some:
        output["BillingModeOverride"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_BillingMode(dafny_input.BillingModeOverride.value)

    if dafny_input.GlobalSecondaryIndexOverride.is_Some:
        output["GlobalSecondaryIndexOverride"] = [com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_GlobalSecondaryIndex(list_element) for list_element in dafny_input.GlobalSecondaryIndexOverride.value]

    if dafny_input.LocalSecondaryIndexOverride.is_Some:
        output["LocalSecondaryIndexOverride"] = [com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_LocalSecondaryIndex(list_element) for list_element in dafny_input.LocalSecondaryIndexOverride.value]

    if dafny_input.ProvisionedThroughputOverride.is_Some:
        output["ProvisionedThroughputOverride"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_ProvisionedThroughput(dafny_input.ProvisionedThroughputOverride.value)

    if dafny_input.SSESpecificationOverride.is_Some:
        output["SSESpecificationOverride"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_SSESpecification(dafny_input.SSESpecificationOverride.value)
...
def com_amazonaws_dynamodb_RestoreTableToPointInTimeInput(dafny_input):
    ...
    if dafny_input.SourceTableName.is_Some:
        output["SourceTableName"] = dafny_input.SourceTableName.value.VerbatimString(False)
...
def com_amazonaws_dynamodb_ScanInput(dafny_input):
    ...
    if dafny_input.ScanFilter.is_Some:
        output["ScanFilter"] = {key.VerbatimString(False): com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_Condition(value) for (key, value) in dafny_input.ScanFilter.value.items }
...
def com_amazonaws_dynamodb_TagResourceInput(dafny_input):
    output = {}
    output["ResourceArn"] = dafny_input.ResourceArn.VerbatimString(False)
    output["Tags"] = [com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_Tag(list_element) for list_element in dafny_input.Tags]
    return output

def com_amazonaws_dynamodb_TransactGetItem(dafny_input):
    output = {}
    output["Get"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_Get(dafny_input.Get)
    return output
...
def com_amazonaws_dynamodb_TransactGetItemsInput(dafny_input):
    output = {}
    output["TransactItems"] = [com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_TransactGetItem(list_element) for list_element in dafny_input.TransactItems]
    if dafny_input.ReturnConsumedCapacity.is_Some:
        output["ReturnConsumedCapacity"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_ReturnConsumedCapacity(dafny_input.ReturnConsumedCapacity.value)
...
def com_amazonaws_dynamodb_TransactWriteItem(dafny_input):
    ...
    if dafny_input.ConditionCheck.is_Some:
        output["ConditionCheck"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_ConditionCheck(dafny_input.ConditionCheck.value)

    if dafny_input.Put.is_Some:
        output["Put"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_Put(dafny_input.Put.value)

    if dafny_input.Delete.is_Some:
        output["Delete"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_Delete(dafny_input.Delete.value)

    if dafny_input.Update.is_Some:
        output["Update"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_Update(dafny_input.Update.value)
...
def com_amazonaws_dynamodb_ConditionCheck(dafny_input):
    ...
    output["Key"] = {key.VerbatimString(False): com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in dafny_input.Key.items }
    output["TableName"] = dafny_input.TableName.VerbatimString(False)
    output["ConditionExpression"] = dafny_input.ConditionExpression.VerbatimString(False)
    if dafny_input.ExpressionAttributeNames.is_Some:
        output["ExpressionAttributeNames"] = {key.VerbatimString(False): value.VerbatimString(False) for (key, value) in dafny_input.ExpressionAttributeNames.value.items }
    ...
    if dafny_input.ReturnValuesOnConditionCheckFailure.is_Some:
        output["ReturnValuesOnConditionCheckFailure"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_ReturnValuesOnConditionCheckFailure(dafny_input.ReturnValuesOnConditionCheckFailure.value)
...
def com_amazonaws_dynamodb_TransactWriteItemsInput(dafny_input):
    output = {}
    output["TransactItems"] = [com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_TransactWriteItem(list_element) for list_element in dafny_input.TransactItems]
    if dafny_input.ReturnConsumedCapacity.is_Some:
        output["ReturnConsumedCapacity"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_ReturnConsumedCapacity(dafny_input.ReturnConsumedCapacity.value)
...
def com_amazonaws_dynamodb_UpdateContinuousBackupsInput(dafny_input):
    output = {}
    output["TableName"] = dafny_input.TableName.VerbatimString(False)
    output["PointInTimeRecoverySpecification"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_PointInTimeRecoverySpecification(dafny_input.PointInTimeRecoverySpecification)
    return output
...
def com_amazonaws_dynamodb_UpdateContributorInsightsInput(dafny_input):
    ...
    output["ContributorInsightsAction"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_ContributorInsightsAction(dafny_input.ContributorInsightsAction)
    return output
...
def com_amazonaws_dynamodb_ReplicaUpdate(dafny_input):
    ...
    if dafny_input.Create.is_Some:
        output["Create"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_CreateReplicaAction(dafny_input.Create.value)

    if dafny_input.Delete.is_Some:
        output["Delete"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_DeleteReplicaAction(dafny_input.Delete.value)
...
def com_amazonaws_dynamodb_UpdateGlobalTableInput(dafny_input):
    output = {}
    output["GlobalTableName"] = dafny_input.GlobalTableName.VerbatimString(False)
    output["ReplicaUpdates"] = [com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_ReplicaUpdate(list_element) for list_element in dafny_input.ReplicaUpdates]
    return output
...
def com_amazonaws_dynamodb_AutoScalingSettingsUpdate(dafny_input):
    ...
    if dafny_input.ScalingPolicyUpdate.is_Some:
        output["ScalingPolicyUpdate"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_AutoScalingPolicyUpdate(dafny_input.ScalingPolicyUpdate.value)
...
def com_amazonaws_dynamodb_AutoScalingPolicyUpdate(dafny_input):
    ...
    output["TargetTrackingScalingPolicyConfiguration"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_AutoScalingTargetTrackingScalingPolicyConfigurationUpdate(dafny_input.TargetTrackingScalingPolicyConfiguration)
    return output
...
def com_amazonaws_dynamodb_GlobalTableGlobalSecondaryIndexSettingsUpdate(dafny_input):
    ...
    if dafny_input.ProvisionedWriteCapacityAutoScalingSettingsUpdate.is_Some:
        output["ProvisionedWriteCapacityAutoScalingSettingsUpdate"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_AutoScalingSettingsUpdate(dafny_input.ProvisionedWriteCapacityAutoScalingSettingsUpdate.value)
...
def com_amazonaws_dynamodb_ReplicaSettingsUpdate(dafny_input):
    ...
    if dafny_input.ReplicaProvisionedReadCapacityAutoScalingSettingsUpdate.is_Some:
        output["ReplicaProvisionedReadCapacityAutoScalingSettingsUpdate"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_AutoScalingSettingsUpdate(dafny_input.ReplicaProvisionedReadCapacityAutoScalingSettingsUpdate.value)

    if dafny_input.ReplicaGlobalSecondaryIndexSettingsUpdate.is_Some:
        output["ReplicaGlobalSecondaryIndexSettingsUpdate"] = [com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_ReplicaGlobalSecondaryIndexSettingsUpdate(list_element) for list_element in dafny_input.ReplicaGlobalSecondaryIndexSettingsUpdate.value]

    if dafny_input.ReplicaTableClass.is_Some:
        output["ReplicaTableClass"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_TableClass(dafny_input.ReplicaTableClass.value)
...
def com_amazonaws_dynamodb_ReplicaGlobalSecondaryIndexSettingsUpdate(dafny_input):
    ...
    if dafny_input.ProvisionedReadCapacityAutoScalingSettingsUpdate.is_Some:
        output["ProvisionedReadCapacityAutoScalingSettingsUpdate"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_AutoScalingSettingsUpdate(dafny_input.ProvisionedReadCapacityAutoScalingSettingsUpdate.value)
...
def com_amazonaws_dynamodb_UpdateGlobalTableSettingsInput(dafny_input):
    ...
    if dafny_input.GlobalTableBillingMode.is_Some:
        output["GlobalTableBillingMode"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_BillingMode(dafny_input.GlobalTableBillingMode.value)
    ...
    if dafny_input.GlobalTableProvisionedWriteCapacityAutoScalingSettingsUpdate.is_Some:
        output["GlobalTableProvisionedWriteCapacityAutoScalingSettingsUpdate"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_AutoScalingSettingsUpdate(dafny_input.GlobalTableProvisionedWriteCapacityAutoScalingSettingsUpdate.value)

    if dafny_input.GlobalTableGlobalSecondaryIndexSettingsUpdate.is_Some:
        output["GlobalTableGlobalSecondaryIndexSettingsUpdate"] = [com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_GlobalTableGlobalSecondaryIndexSettingsUpdate(list_element) for list_element in dafny_input.GlobalTableGlobalSecondaryIndexSettingsUpdate.value]

    if dafny_input.ReplicaSettingsUpdate.is_Some:
        output["ReplicaSettingsUpdate"] = [com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_ReplicaSettingsUpdate(list_element) for list_element in dafny_input.ReplicaSettingsUpdate.value]
...
def com_amazonaws_dynamodb_AttributeValueUpdate(dafny_input):
    ...
    if dafny_input.Action.is_Some:
        output["Action"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_AttributeAction(dafny_input.Action.value)
...
def com_amazonaws_dynamodb_UpdateItemInput(dafny_input):
    ...
    if dafny_input.AttributeUpdates.is_Some:
        output["AttributeUpdates"] = {key.VerbatimString(False): com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_AttributeValueUpdate(value) for (key, value) in dafny_input.AttributeUpdates.value.items }
    ...
    if dafny_input.UpdateExpression.is_Some:
        output["UpdateExpression"] = dafny_input.UpdateExpression.value.VerbatimString(False)
...
def com_amazonaws_dynamodb_GlobalSecondaryIndexUpdate(dafny_input):
    output = {}
    if dafny_input.Update.is_Some:
        output["Update"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_UpdateGlobalSecondaryIndexAction(dafny_input.Update.value)

    if dafny_input.Create.is_Some:
        output["Create"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_CreateGlobalSecondaryIndexAction(dafny_input.Create.value)

    if dafny_input.Delete.is_Some:
        output["Delete"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_DeleteGlobalSecondaryIndexAction(dafny_input.Delete.value)
...
def com_amazonaws_dynamodb_ReplicationGroupUpdate(dafny_input):
    output = {}
    if dafny_input.Create.is_Some:
        output["Create"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_CreateReplicationGroupMemberAction(dafny_input.Create.value)

    if dafny_input.Update.is_Some:
        output["Update"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_UpdateReplicationGroupMemberAction(dafny_input.Update.value)

    if dafny_input.Delete.is_Some:
        output["Delete"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_DeleteReplicationGroupMemberAction(dafny_input.Delete.value)
...
def com_amazonaws_dynamodb_CreateReplicationGroupMemberAction(dafny_input):
    ...
    if dafny_input.GlobalSecondaryIndexes.is_Some:
        output["GlobalSecondaryIndexes"] = [com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_ReplicaGlobalSecondaryIndex(list_element) for list_element in dafny_input.GlobalSecondaryIndexes.value]

    if dafny_input.TableClassOverride.is_Some:
        output["TableClassOverride"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_TableClass(dafny_input.TableClassOverride.value)
...
def com_amazonaws_dynamodb_UpdateTableInput(dafny_input):
    ...
    if dafny_input.GlobalSecondaryIndexUpdates.is_Some:
        output["GlobalSecondaryIndexUpdates"] = [com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_GlobalSecondaryIndexUpdate(list_element) for list_element in dafny_input.GlobalSecondaryIndexUpdates.value]
    ...
    if dafny_input.ReplicaUpdates.is_Some:
        output["ReplicaUpdates"] = [com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_ReplicationGroupUpdate(list_element) for list_element in dafny_input.ReplicaUpdates.value]
...
def com_amazonaws_dynamodb_GlobalSecondaryIndexAutoScalingUpdate(dafny_input):
    ...
    if dafny_input.ProvisionedWriteCapacityAutoScalingUpdate.is_Some:
        output["ProvisionedWriteCapacityAutoScalingUpdate"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_AutoScalingSettingsUpdate(dafny_input.ProvisionedWriteCapacityAutoScalingUpdate.value)
...
def com_amazonaws_dynamodb_ReplicaAutoScalingUpdate(dafny_input):
    ...
    if dafny_input.ReplicaGlobalSecondaryIndexUpdates.is_Some:
        output["ReplicaGlobalSecondaryIndexUpdates"] = [com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_ReplicaGlobalSecondaryIndexAutoScalingUpdate(list_element) for list_element in dafny_input.ReplicaGlobalSecondaryIndexUpdates.value]

    if dafny_input.ReplicaProvisionedReadCapacityAutoScalingUpdate.is_Some:
        output["ReplicaProvisionedReadCapacityAutoScalingUpdate"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_AutoScalingSettingsUpdate(dafny_input.ReplicaProvisionedReadCapacityAutoScalingUpdate.value)
...
def com_amazonaws_dynamodb_ReplicaGlobalSecondaryIndexAutoScalingUpdate(dafny_input):
    ...
    if dafny_input.ProvisionedReadCapacityAutoScalingUpdate.is_Some:
        output["ProvisionedReadCapacityAutoScalingUpdate"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_AutoScalingSettingsUpdate(dafny_input.ProvisionedReadCapacityAutoScalingUpdate.value)
...
def com_amazonaws_dynamodb_UpdateTableReplicaAutoScalingInput(dafny_input):
    output = {}
    if dafny_input.GlobalSecondaryIndexUpdates.is_Some:
        output["GlobalSecondaryIndexUpdates"] = [com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_GlobalSecondaryIndexAutoScalingUpdate(list_element) for list_element in dafny_input.GlobalSecondaryIndexUpdates.value]
    ...
    if dafny_input.ReplicaUpdates.is_Some:
        output["ReplicaUpdates"] = [com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_ReplicaAutoScalingUpdate(list_element) for list_element in dafny_input.ReplicaUpdates.value]
...
def com_amazonaws_dynamodb_UpdateTimeToLiveInput(dafny_input):
    output = {}
    output["TableName"] = dafny_input.TableName.VerbatimString(False)
    output["TimeToLiveSpecification"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_TimeToLiveSpecification(dafny_input.TimeToLiveSpecification)
    return output

def com_amazonaws_dynamodb_UpdateTimeToLiveOutput(dafny_input):
    output = {}
    if dafny_input.TimeToLiveSpecification.is_Some:
        output["TimeToLiveSpecification"] = com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.dafny_to_aws_sdk.com_amazonaws_dynamodb_TimeToLiveSpecification(dafny_input.TimeToLiveSpecification.value)
