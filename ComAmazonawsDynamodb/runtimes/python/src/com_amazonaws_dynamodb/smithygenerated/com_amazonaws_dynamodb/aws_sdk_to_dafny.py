...
def com_amazonaws_dynamodb_TransactionCanceledException(native_input):
    return Error_TransactionCanceledException(
        Message=Seq(native_input['Error']["Message"]),
        CancellationReasons=Seq([com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_CancellationReason(list_element) for list_element in native_input["CancellationReasons"]]),
    )

def com_amazonaws_dynamodb_CancellationReason(native_input):
    return DafnyCancellationReason(
        Item=Option_Some(Map({Seq(key): com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in native_input["Item"].items() })) if "Item" in native_input.keys() else Option_None(),
        Code=Option_Some(Seq(native_input["Code"])) if "Code" in native_input.keys() else Option_None(),
        Message=Option_Some(Seq(native_input["Message"])) if "Message" in native_input.keys() else Option_None(),
    )
...
def com_amazonaws_dynamodb_AttributeValue(native_input):
    if "S" in native_input.keys():
        ...
        AttributeValue_union_value = AttributeValue_SS(Seq([Seq(list_element) for list_element in native_input["SS"]]))
    elif "NS" in native_input.keys():
        AttributeValue_union_value = AttributeValue_NS(Seq([Seq(list_element) for list_element in native_input["NS"]]))
        ...
        AttributeValue_union_value = AttributeValue_M(Map({Seq(key): com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in native_input["M"].items() }))
    elif "L" in native_input.keys():
        AttributeValue_union_value = AttributeValue_L(Seq([com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_AttributeValue(list_element) for list_element in native_input["L"]]))
...
def com_amazonaws_dynamodb_BatchExecuteStatementInput(native_input):
    return DafnyBatchExecuteStatementInput(
        Statements=Seq([com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_BatchStatementRequest(list_element) for list_element in native_input["Statements"]]),
        ReturnConsumedCapacity=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ReturnConsumedCapacity(native_input["ReturnConsumedCapacity"])) if "ReturnConsumedCapacity" in native_input.keys() else Option_None(),
    )
...
def com_amazonaws_dynamodb_BatchStatementRequest(native_input):
    return DafnyBatchStatementRequest(
        ...
        Parameters=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_AttributeValue(list_element) for list_element in native_input["Parameters"]])) if "Parameters" in native_input.keys() else Option_None(),
...
def com_amazonaws_dynamodb_BatchExecuteStatementOutput(native_input):
    return DafnyBatchExecuteStatementOutput(
        Responses=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_BatchStatementResponse(list_element) for list_element in native_input["Responses"]])) if "Responses" in native_input.keys() else Option_None(),
        ConsumedCapacity=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ConsumedCapacity(list_element) for list_element in native_input["ConsumedCapacity"]])) if "ConsumedCapacity" in native_input.keys() else Option_None(),
    )

def com_amazonaws_dynamodb_BatchStatementResponse(native_input):
    return DafnyBatchStatementResponse(
        Error=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_BatchStatementError(native_input["Error"])) if "Error" in native_input.keys() else Option_None(),
        TableName=Option_Some(Seq(native_input["TableName"])) if "TableName" in native_input.keys() else Option_None(),
        Item=Option_Some(Map({Seq(key): com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in native_input["Item"].items() })) if "Item" in native_input.keys() else Option_None(),
    )

def com_amazonaws_dynamodb_BatchStatementError(native_input):
    return DafnyBatchStatementError(
        Code=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_BatchStatementErrorCodeEnum(native_input["Code"])) if "Code" in native_input.keys() else Option_None(),
        Message=Option_Some(Seq(native_input["Message"])) if "Message" in native_input.keys() else Option_None(),
    )
...
def com_amazonaws_dynamodb_ConsumedCapacity(native_input):
    return DafnyConsumedCapacity(
        ...
        Table=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_Capacity(native_input["Table"])) if "Table" in native_input.keys() else Option_None(),
        LocalSecondaryIndexes=Option_Some(Map({Seq(key): com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_Capacity(value) for (key, value) in native_input["LocalSecondaryIndexes"].items() })) if "LocalSecondaryIndexes" in native_input.keys() else Option_None(),
        GlobalSecondaryIndexes=Option_Some(Map({Seq(key): com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_Capacity(value) for (key, value) in native_input["GlobalSecondaryIndexes"].items() })) if "GlobalSecondaryIndexes" in native_input.keys() else Option_None(),
    )
...
def com_amazonaws_dynamodb_BatchGetItemInput(native_input):
    return DafnyBatchGetItemInput(
        RequestItems=Map({Seq(key): com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_KeysAndAttributes(value) for (key, value) in native_input["RequestItems"].items() }),
        ReturnConsumedCapacity=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ReturnConsumedCapacity(native_input["ReturnConsumedCapacity"])) if "ReturnConsumedCapacity" in native_input.keys() else Option_None(),
    )

def com_amazonaws_dynamodb_KeysAndAttributes(native_input):
    return DafnyKeysAndAttributes(
        Keys=Seq([Map({Seq(key): com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in list_element.items() }) for list_element in native_input["Keys"]]),
        AttributesToGet=Option_Some(Seq([Seq(list_element) for list_element in native_input["AttributesToGet"]])) if "AttributesToGet" in native_input.keys() else Option_None(),
        ConsistentRead=Option_Some(native_input["ConsistentRead"]) if "ConsistentRead" in native_input.keys() else Option_None(),
        ProjectionExpression=Option_Some(Seq(native_input["ProjectionExpression"])) if "ProjectionExpression" in native_input.keys() else Option_None(),
        ExpressionAttributeNames=Option_Some(Map({Seq(key): Seq(value) for (key, value) in native_input["ExpressionAttributeNames"].items() })) if "ExpressionAttributeNames" in native_input.keys() else Option_None(),
    )
...
def com_amazonaws_dynamodb_BatchGetItemOutput(native_input):
    return DafnyBatchGetItemOutput(
        ...
        UnprocessedKeys=Option_Some(Map({Seq(key): com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_KeysAndAttributes(value) for (key, value) in native_input["UnprocessedKeys"].items() })) if "UnprocessedKeys" in native_input.keys() else Option_None(),
        ConsumedCapacity=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ConsumedCapacity(list_element) for list_element in native_input["ConsumedCapacity"]])) if "ConsumedCapacity" in native_input.keys() else Option_None(),
    )

def com_amazonaws_dynamodb_BatchWriteItemInput(native_input):
    return DafnyBatchWriteItemInput(
        RequestItems=Map({Seq(key): Seq([com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_WriteRequest(list_element) for list_element in value]) for (key, value) in native_input["RequestItems"].items() }),
        ReturnConsumedCapacity=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ReturnConsumedCapacity(native_input["ReturnConsumedCapacity"])) if "ReturnConsumedCapacity" in native_input.keys() else Option_None(),
        ReturnItemCollectionMetrics=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ReturnItemCollectionMetrics(native_input["ReturnItemCollectionMetrics"])) if "ReturnItemCollectionMetrics" in native_input.keys() else Option_None(),
    )

def com_amazonaws_dynamodb_WriteRequest(native_input):
    return DafnyWriteRequest(
        PutRequest=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_PutRequest(native_input["PutRequest"])) if "PutRequest" in native_input.keys() else Option_None(),
        DeleteRequest=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_DeleteRequest(native_input["DeleteRequest"])) if "DeleteRequest" in native_input.keys() else Option_None(),
    )

def com_amazonaws_dynamodb_PutRequest(native_input):
    return DafnyPutRequest(
        Item=Map({Seq(key): com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in native_input["Item"].items() }),
    )

def com_amazonaws_dynamodb_DeleteRequest(native_input):
    return DafnyDeleteRequest(
        Key=Map({Seq(key): com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in native_input["Key"].items() }),
    )
...
def com_amazonaws_dynamodb_ItemCollectionMetrics(native_input):
    return DafnyItemCollectionMetrics(
        ItemCollectionKey=Option_Some(Map({Seq(key): com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in native_input["ItemCollectionKey"].items() })) if "ItemCollectionKey" in native_input.keys() else Option_None(),
...
def com_amazonaws_dynamodb_CreateBackupOutput(native_input):
    return DafnyCreateBackupOutput(
        BackupDetails=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_BackupDetails(native_input["BackupDetails"])) if "BackupDetails" in native_input.keys() else Option_None(),
    )
...
def com_amazonaws_dynamodb_BackupDetails(native_input):
    return DafnyBackupDetails(
        ...
        BackupStatus=com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_BackupStatus(native_input["BackupStatus"]),
        BackupType=com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_BackupType(native_input["BackupType"]),
        BackupCreationDateTime=TypeError("TimestampShape not supported"),
        BackupExpiryDateTime=Option_Some(TypeError("TimestampShape not supported")) if "BackupExpiryDateTime" in native_input.keys() else Option_None(),
    )
...
def com_amazonaws_dynamodb_CreateGlobalTableInput(native_input):
    return DafnyCreateGlobalTableInput(
        ...
        ReplicationGroup=Seq([com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_Replica(list_element) for list_element in native_input["ReplicationGroup"]]),
    )

def com_amazonaws_dynamodb_Replica(native_input):
    return DafnyReplica(
        RegionName=Option_Some(Seq(native_input["RegionName"])) if "RegionName" in native_input.keys() else Option_None(),
    )

def com_amazonaws_dynamodb_CreateGlobalTableOutput(native_input):
    return DafnyCreateGlobalTableOutput(
        GlobalTableDescription=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_GlobalTableDescription(native_input["GlobalTableDescription"])) if "GlobalTableDescription" in native_input.keys() else Option_None(),
    )

def com_amazonaws_dynamodb_GlobalTableDescription(native_input):
    return DafnyGlobalTableDescription(
        ReplicationGroup=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ReplicaDescription(list_element) for list_element in native_input["ReplicationGroup"]])) if "ReplicationGroup" in native_input.keys() else Option_None(),
        GlobalTableArn=Option_Some(Seq(native_input["GlobalTableArn"])) if "GlobalTableArn" in native_input.keys() else Option_None(),
        CreationDateTime=Option_Some(TypeError("TimestampShape not supported")) if "CreationDateTime" in native_input.keys() else Option_None(),
        GlobalTableStatus=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_GlobalTableStatus(native_input["GlobalTableStatus"])) if "GlobalTableStatus" in native_input.keys() else Option_None(),
        GlobalTableName=Option_Some(Seq(native_input["GlobalTableName"])) if "GlobalTableName" in native_input.keys() else Option_None(),
    )

def com_amazonaws_dynamodb_ReplicaDescription(native_input):
    return DafnyReplicaDescription(
        RegionName=Option_Some(Seq(native_input["RegionName"])) if "RegionName" in native_input.keys() else Option_None(),
        ReplicaStatus=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ReplicaStatus(native_input["ReplicaStatus"])) if "ReplicaStatus" in native_input.keys() else Option_None(),
        ReplicaStatusDescription=Option_Some(Seq(native_input["ReplicaStatusDescription"])) if "ReplicaStatusDescription" in native_input.keys() else Option_None(),
        ReplicaStatusPercentProgress=Option_Some(Seq(native_input["ReplicaStatusPercentProgress"])) if "ReplicaStatusPercentProgress" in native_input.keys() else Option_None(),
        KMSMasterKeyId=Option_Some(Seq(native_input["KMSMasterKeyId"])) if "KMSMasterKeyId" in native_input.keys() else Option_None(),
        ProvisionedThroughputOverride=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ProvisionedThroughputOverride(native_input["ProvisionedThroughputOverride"])) if "ProvisionedThroughputOverride" in native_input.keys() else Option_None(),
        ...
        ReplicaInaccessibleDateTime=Option_Some(TypeError("TimestampShape not supported")) if "ReplicaInaccessibleDateTime" in native_input.keys() else Option_None(),
        ReplicaTableClassSummary=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_TableClassSummary(native_input["ReplicaTableClassSummary"])) if "ReplicaTableClassSummary" in native_input.keys() else Option_None(),
    )
...
def com_amazonaws_dynamodb_ReplicaGlobalSecondaryIndexDescription(native_input):
    return DafnyReplicaGlobalSecondaryIndexDescription(
        IndexName=Option_Some(Seq(native_input["IndexName"])) if "IndexName" in native_input.keys() else Option_None(),
        ProvisionedThroughputOverride=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ProvisionedThroughputOverride(native_input["ProvisionedThroughputOverride"])) if "ProvisionedThroughputOverride" in native_input.keys() else Option_None(),
    )

def com_amazonaws_dynamodb_TableClassSummary(native_input):
    return DafnyTableClassSummary(
        TableClass=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_TableClass(native_input["TableClass"])) if "TableClass" in native_input.keys() else Option_None(),
        LastUpdateDateTime=Option_Some(TypeError("TimestampShape not supported")) if "LastUpdateDateTime" in native_input.keys() else Option_None(),
    )
...
def com_amazonaws_dynamodb_CreateTableInput(native_input):
    return DafnyCreateTableInput(
        AttributeDefinitions=Seq([com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_AttributeDefinition(list_element) for list_element in native_input["AttributeDefinitions"]]),
        TableName=Seq(native_input["TableName"]),
        KeySchema=Seq([com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_KeySchemaElement(list_element) for list_element in native_input["KeySchema"]]),
        LocalSecondaryIndexes=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_LocalSecondaryIndex(list_element) for list_element in native_input["LocalSecondaryIndexes"]])) if "LocalSecondaryIndexes" in native_input.keys() else Option_None(),
        GlobalSecondaryIndexes=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_GlobalSecondaryIndex(list_element) for list_element in native_input["GlobalSecondaryIndexes"]])) if "GlobalSecondaryIndexes" in native_input.keys() else Option_None(),
        BillingMode=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_BillingMode(native_input["BillingMode"])) if "BillingMode" in native_input.keys() else Option_None(),
        ProvisionedThroughput=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ProvisionedThroughput(native_input["ProvisionedThroughput"])) if "ProvisionedThroughput" in native_input.keys() else Option_None(),
        StreamSpecification=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_StreamSpecification(native_input["StreamSpecification"])) if "StreamSpecification" in native_input.keys() else Option_None(),
        SSESpecification=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_SSESpecification(native_input["SSESpecification"])) if "SSESpecification" in native_input.keys() else Option_None(),
        Tags=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_Tag(list_element) for list_element in native_input["Tags"]])) if "Tags" in native_input.keys() else Option_None(),
        TableClass=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_TableClass(native_input["TableClass"])) if "TableClass" in native_input.keys() else Option_None(),
    )
...
def com_amazonaws_dynamodb_AttributeDefinition(native_input):
    return DafnyAttributeDefinition(
        ...
        AttributeType=com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ScalarAttributeType(native_input["AttributeType"]),
    )
...
def com_amazonaws_dynamodb_KeySchemaElement(native_input):
    return DafnyKeySchemaElement(
        AttributeName=Seq(native_input["AttributeName"]),
        KeyType=com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_KeyType(native_input["KeyType"]),
    )
...
def com_amazonaws_dynamodb_LocalSecondaryIndex(native_input):
    return DafnyLocalSecondaryIndex(
        ...
        KeySchema=Seq([com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_KeySchemaElement(list_element) for list_element in native_input["KeySchema"]]),
        Projection=com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_Projection(native_input["Projection"]),
    )

def com_amazonaws_dynamodb_Projection(native_input):
    return DafnyProjection(
        ProjectionType=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ProjectionType(native_input["ProjectionType"])) if "ProjectionType" in native_input.keys() else Option_None(),
        NonKeyAttributes=Option_Some(Seq([Seq(list_element) for list_element in native_input["NonKeyAttributes"]])) if "NonKeyAttributes" in native_input.keys() else Option_None(),
    )
...
def com_amazonaws_dynamodb_StreamSpecification(native_input):
    return DafnyStreamSpecification(
        ...
        StreamViewType=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_StreamViewType(native_input["StreamViewType"])) if "StreamViewType" in native_input.keys() else Option_None(),
    )
...
def com_amazonaws_dynamodb_SSESpecification(native_input):
    return DafnySSESpecification(
        ...
        SSEType=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_SSEType(native_input["SSEType"])) if "SSEType" in native_input.keys() else Option_None(),
        KMSMasterKeyId=Option_Some(Seq(native_input["KMSMasterKeyId"])) if "KMSMasterKeyId" in native_input.keys() else Option_None(),
    )
...
def com_amazonaws_dynamodb_CreateTableOutput(native_input):
    return DafnyCreateTableOutput(
        TableDescription=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_TableDescription(native_input["TableDescription"])) if "TableDescription" in native_input.keys() else Option_None(),
    )

def com_amazonaws_dynamodb_TableDescription(native_input):
    return DafnyTableDescription(
        AttributeDefinitions=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_AttributeDefinition(list_element) for list_element in native_input["AttributeDefinitions"]])) if "AttributeDefinitions" in native_input.keys() else Option_None(),
        TableName=Option_Some(Seq(native_input["TableName"])) if "TableName" in native_input.keys() else Option_None(),
        KeySchema=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_KeySchemaElement(list_element) for list_element in native_input["KeySchema"]])) if "KeySchema" in native_input.keys() else Option_None(),
        TableStatus=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_TableStatus(native_input["TableStatus"])) if "TableStatus" in native_input.keys() else Option_None(),
        CreationDateTime=Option_Some(TypeError("TimestampShape not supported")) if "CreationDateTime" in native_input.keys() else Option_None(),
        ProvisionedThroughput=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ProvisionedThroughputDescription(native_input["ProvisionedThroughput"])) if "ProvisionedThroughput" in native_input.keys() else Option_None(),
        ...
        TableArn=Option_Some(Seq(native_input["TableArn"])) if "TableArn" in native_input.keys() else Option_None(),
        TableId=Option_Some(Seq(native_input["TableId"])) if "TableId" in native_input.keys() else Option_None(),
        BillingModeSummary=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_BillingModeSummary(native_input["BillingModeSummary"])) if "BillingModeSummary" in native_input.keys() else Option_None(),
        ...
        StreamSpecification=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_StreamSpecification(native_input["StreamSpecification"])) if "StreamSpecification" in native_input.keys() else Option_None(),
        LatestStreamLabel=Option_Some(Seq(native_input["LatestStreamLabel"])) if "LatestStreamLabel" in native_input.keys() else Option_None(),
        LatestStreamArn=Option_Some(Seq(native_input["LatestStreamArn"])) if "LatestStreamArn" in native_input.keys() else Option_None(),
        GlobalTableVersion=Option_Some(Seq(native_input["GlobalTableVersion"])) if "GlobalTableVersion" in native_input.keys() else Option_None(),
        Replicas=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ReplicaDescription(list_element) for list_element in native_input["Replicas"]])) if "Replicas" in native_input.keys() else Option_None(),
        RestoreSummary=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_RestoreSummary(native_input["RestoreSummary"])) if "RestoreSummary" in native_input.keys() else Option_None(),
        SSEDescription=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_SSEDescription(native_input["SSEDescription"])) if "SSEDescription" in native_input.keys() else Option_None(),
        ArchivalSummary=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ArchivalSummary(native_input["ArchivalSummary"])) if "ArchivalSummary" in native_input.keys() else Option_None(),
        TableClassSummary=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_TableClassSummary(native_input["TableClassSummary"])) if "TableClassSummary" in native_input.keys() else Option_None(),
    )
...
def com_amazonaws_dynamodb_ProvisionedThroughputDescription(native_input):
    return DafnyProvisionedThroughputDescription(
        LastIncreaseDateTime=Option_Some(TypeError("TimestampShape not supported")) if "LastIncreaseDateTime" in native_input.keys() else Option_None(),
        LastDecreaseDateTime=Option_Some(TypeError("TimestampShape not supported")) if "LastDecreaseDateTime" in native_input.keys() else Option_None(),
...
def com_amazonaws_dynamodb_BillingModeSummary(native_input):
    return DafnyBillingModeSummary(
        BillingMode=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_BillingMode(native_input["BillingMode"])) if "BillingMode" in native_input.keys() else Option_None(),
        LastUpdateToPayPerRequestDateTime=Option_Some(TypeError("TimestampShape not supported")) if "LastUpdateToPayPerRequestDateTime" in native_input.keys() else Option_None(),
    )
...
def com_amazonaws_dynamodb_LocalSecondaryIndexDescription(native_input):
    return DafnyLocalSecondaryIndexDescription(
        IndexName=Option_Some(Seq(native_input["IndexName"])) if "IndexName" in native_input.keys() else Option_None(),
        KeySchema=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_KeySchemaElement(list_element) for list_element in native_input["KeySchema"]])) if "KeySchema" in native_input.keys() else Option_None(),
        Projection=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_Projection(native_input["Projection"])) if "Projection" in native_input.keys() else Option_None(),
        IndexSizeBytes=Option_Some(native_input["IndexSizeBytes"]) if "IndexSizeBytes" in native_input.keys() else Option_None(),
        ItemCount=Option_Some(native_input["ItemCount"]) if "ItemCount" in native_input.keys() else Option_None(),
        IndexArn=Option_Some(Seq(native_input["IndexArn"])) if "IndexArn" in native_input.keys() else Option_None(),
    )
...
def com_amazonaws_dynamodb_GlobalSecondaryIndexDescription(native_input):
    return DafnyGlobalSecondaryIndexDescription(
        ...
        KeySchema=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_KeySchemaElement(list_element) for list_element in native_input["KeySchema"]])) if "KeySchema" in native_input.keys() else Option_None(),
        Projection=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_Projection(native_input["Projection"])) if "Projection" in native_input.keys() else Option_None(),
        IndexStatus=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_IndexStatus(native_input["IndexStatus"])) if "IndexStatus" in native_input.keys() else Option_None(),
...
def com_amazonaws_dynamodb_RestoreSummary(native_input):
    return DafnyRestoreSummary(
        SourceBackupArn=Option_Some(Seq(native_input["SourceBackupArn"])) if "SourceBackupArn" in native_input.keys() else Option_None(),
        SourceTableArn=Option_Some(Seq(native_input["SourceTableArn"])) if "SourceTableArn" in native_input.keys() else Option_None(),
...
def com_amazonaws_dynamodb_SSEDescription(native_input):
    return DafnySSEDescription(
        Status=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_SSEStatus(native_input["Status"])) if "Status" in native_input.keys() else Option_None(),
        SSEType=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_SSEType(native_input["SSEType"])) if "SSEType" in native_input.keys() else Option_None(),
        KMSMasterKeyArn=Option_Some(Seq(native_input["KMSMasterKeyArn"])) if "KMSMasterKeyArn" in native_input.keys() else Option_None(),
        InaccessibleEncryptionDateTime=Option_Some(TypeError("TimestampShape not supported")) if "InaccessibleEncryptionDateTime" in native_input.keys() else Option_None(),
    )

def com_amazonaws_dynamodb_ArchivalSummary(native_input):
    return DafnyArchivalSummary(
        ArchivalDateTime=Option_Some(TypeError("TimestampShape not supported")) if "ArchivalDateTime" in native_input.keys() else Option_None(),
        ArchivalReason=Option_Some(Seq(native_input["ArchivalReason"])) if "ArchivalReason" in native_input.keys() else Option_None(),
        ArchivalBackupArn=Option_Some(Seq(native_input["ArchivalBackupArn"])) if "ArchivalBackupArn" in native_input.keys() else Option_None(),
    )
...
def com_amazonaws_dynamodb_DeleteBackupOutput(native_input):
    return DafnyDeleteBackupOutput(
        BackupDescription=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_BackupDescription(native_input["BackupDescription"])) if "BackupDescription" in native_input.keys() else Option_None(),
    )

def com_amazonaws_dynamodb_BackupDescription(native_input):
    return DafnyBackupDescription(
        BackupDetails=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_BackupDetails(native_input["BackupDetails"])) if "BackupDetails" in native_input.keys() else Option_None(),
        SourceTableDetails=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_SourceTableDetails(native_input["SourceTableDetails"])) if "SourceTableDetails" in native_input.keys() else Option_None(),
        SourceTableFeatureDetails=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_SourceTableFeatureDetails(native_input["SourceTableFeatureDetails"])) if "SourceTableFeatureDetails" in native_input.keys() else Option_None(),
    )
...
def com_amazonaws_dynamodb_SourceTableDetails(native_input):
    return DafnySourceTableDetails(
        ...
        ProvisionedThroughput=com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ProvisionedThroughput(native_input["ProvisionedThroughput"]),
        ItemCount=Option_Some(native_input["ItemCount"]) if "ItemCount" in native_input.keys() else Option_None(),
        BillingMode=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_BillingMode(native_input["BillingMode"])) if "BillingMode" in native_input.keys() else Option_None(),
    )
...
def com_amazonaws_dynamodb_SourceTableFeatureDetails(native_input):
    return DafnySourceTableFeatureDetails(
        LocalSecondaryIndexes=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_LocalSecondaryIndexInfo(list_element) for list_element in native_input["LocalSecondaryIndexes"]])) if "LocalSecondaryIndexes" in native_input.keys() else Option_None(),
        GlobalSecondaryIndexes=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_GlobalSecondaryIndexInfo(list_element) for list_element in native_input["GlobalSecondaryIndexes"]])) if "GlobalSecondaryIndexes" in native_input.keys() else Option_None(),
        StreamDescription=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_StreamSpecification(native_input["StreamDescription"])) if "StreamDescription" in native_input.keys() else Option_None(),
        TimeToLiveDescription=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_TimeToLiveDescription(native_input["TimeToLiveDescription"])) if "TimeToLiveDescription" in native_input.keys() else Option_None(),
        SSEDescription=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_SSEDescription(native_input["SSEDescription"])) if "SSEDescription" in native_input.keys() else Option_None(),
    )
...
def com_amazonaws_dynamodb_TimeToLiveDescription(native_input):
    return DafnyTimeToLiveDescription(
        TimeToLiveStatus=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_TimeToLiveStatus(native_input["TimeToLiveStatus"])) if "TimeToLiveStatus" in native_input.keys() else Option_None(),
        AttributeName=Option_Some(Seq(native_input["AttributeName"])) if "AttributeName" in native_input.keys() else Option_None(),
    )
...
def com_amazonaws_dynamodb_DeleteItemInput(native_input):
    return DafnyDeleteItemInput(
        TableName=Seq(native_input["TableName"]),
        Key=Map({Seq(key): com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in native_input["Key"].items() }),
        Expected=Option_Some(Map({Seq(key): com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ExpectedAttributeValue(value) for (key, value) in native_input["Expected"].items() })) if "Expected" in native_input.keys() else Option_None(),
        ConditionalOperator=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ConditionalOperator(native_input["ConditionalOperator"])) if "ConditionalOperator" in native_input.keys() else Option_None(),
        ReturnValues=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ReturnValue(native_input["ReturnValues"])) if "ReturnValues" in native_input.keys() else Option_None(),
        ReturnConsumedCapacity=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ReturnConsumedCapacity(native_input["ReturnConsumedCapacity"])) if "ReturnConsumedCapacity" in native_input.keys() else Option_None(),
        ReturnItemCollectionMetrics=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ReturnItemCollectionMetrics(native_input["ReturnItemCollectionMetrics"])) if "ReturnItemCollectionMetrics" in native_input.keys() else Option_None(),
        ConditionExpression=Option_Some(Seq(native_input["ConditionExpression"])) if "ConditionExpression" in native_input.keys() else Option_None(),
        ExpressionAttributeNames=Option_Some(Map({Seq(key): Seq(value) for (key, value) in native_input["ExpressionAttributeNames"].items() })) if "ExpressionAttributeNames" in native_input.keys() else Option_None(),
...
def com_amazonaws_dynamodb_ExpectedAttributeValue(native_input):
    return DafnyExpectedAttributeValue(
        Value=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_AttributeValue(native_input["Value"])) if "Value" in native_input.keys() else Option_None(),
        Exists=Option_Some(native_input["Exists"]) if "Exists" in native_input.keys() else Option_None(),
        ComparisonOperator=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ComparisonOperator(native_input["ComparisonOperator"])) if "ComparisonOperator" in native_input.keys() else Option_None(),
        AttributeValueList=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_AttributeValue(list_element) for list_element in native_input["AttributeValueList"]])) if "AttributeValueList" in native_input.keys() else Option_None(),
    )
...
def com_amazonaws_dynamodb_DeleteItemOutput(native_input):
    return DafnyDeleteItemOutput(
        Attributes=Option_Some(Map({Seq(key): com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in native_input["Attributes"].items() })) if "Attributes" in native_input.keys() else Option_None(),
        ConsumedCapacity=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ConsumedCapacity(native_input["ConsumedCapacity"])) if "ConsumedCapacity" in native_input.keys() else Option_None(),
        ItemCollectionMetrics=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ItemCollectionMetrics(native_input["ItemCollectionMetrics"])) if "ItemCollectionMetrics" in native_input.keys() else Option_None(),
    )
...
def com_amazonaws_dynamodb_DescribeContinuousBackupsOutput(native_input):
    return DafnyDescribeContinuousBackupsOutput(
        ContinuousBackupsDescription=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ContinuousBackupsDescription(native_input["ContinuousBackupsDescription"])) if "ContinuousBackupsDescription" in native_input.keys() else Option_None(),
    )

def com_amazonaws_dynamodb_ContinuousBackupsDescription(native_input):
    return DafnyContinuousBackupsDescription(
        ContinuousBackupsStatus=com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ContinuousBackupsStatus(native_input["ContinuousBackupsStatus"]),
        PointInTimeRecoveryDescription=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_PointInTimeRecoveryDescription(native_input["PointInTimeRecoveryDescription"])) if "PointInTimeRecoveryDescription" in native_input.keys() else Option_None(),
    )
...
def com_amazonaws_dynamodb_PointInTimeRecoveryDescription(native_input):
    return DafnyPointInTimeRecoveryDescription(
        PointInTimeRecoveryStatus=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_PointInTimeRecoveryStatus(native_input["PointInTimeRecoveryStatus"])) if "PointInTimeRecoveryStatus" in native_input.keys() else Option_None(),
        EarliestRestorableDateTime=Option_Some(TypeError("TimestampShape not supported")) if "EarliestRestorableDateTime" in native_input.keys() else Option_None(),
        LatestRestorableDateTime=Option_Some(TypeError("TimestampShape not supported")) if "LatestRestorableDateTime" in native_input.keys() else Option_None(),
    )
...
def com_amazonaws_dynamodb_DescribeContributorInsightsOutput(native_input):
    return DafnyDescribeContributorInsightsOutput(
        TableName=Option_Some(Seq(native_input["TableName"])) if "TableName" in native_input.keys() else Option_None(),
        IndexName=Option_Some(Seq(native_input["IndexName"])) if "IndexName" in native_input.keys() else Option_None(),
        ContributorInsightsRuleList=Option_Some(Seq([Seq(list_element) for list_element in native_input["ContributorInsightsRuleList"]])) if "ContributorInsightsRuleList" in native_input.keys() else Option_None(),
        ContributorInsightsStatus=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ContributorInsightsStatus(native_input["ContributorInsightsStatus"])) if "ContributorInsightsStatus" in native_input.keys() else Option_None(),
        LastUpdateDateTime=Option_Some(TypeError("TimestampShape not supported")) if "LastUpdateDateTime" in native_input.keys() else Option_None(),
        FailureException=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_FailureException(native_input["FailureException"])) if "FailureException" in native_input.keys() else Option_None(),
    )
...
def com_amazonaws_dynamodb_FailureException(native_input):
    return DafnyFailureException(
        ExceptionName=Option_Some(Seq(native_input["ExceptionName"])) if "ExceptionName" in native_input.keys() else Option_None(),
        ExceptionDescription=Option_Some(Seq(native_input["ExceptionDescription"])) if "ExceptionDescription" in native_input.keys() else Option_None(),
    )
...
def com_amazonaws_dynamodb_DescribeEndpointsResponse(native_input):
    return DafnyDescribeEndpointsResponse(
        Endpoints=Seq([com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_Endpoint(list_element) for list_element in native_input["Endpoints"]]),
    )
...
def com_amazonaws_dynamodb_DescribeExportOutput(native_input):
    return DafnyDescribeExportOutput(
        ExportDescription=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ExportDescription(native_input["ExportDescription"])) if "ExportDescription" in native_input.keys() else Option_None(),
    )

def com_amazonaws_dynamodb_ExportDescription(native_input):
    return DafnyExportDescription(
        ExportArn=Option_Some(Seq(native_input["ExportArn"])) if "ExportArn" in native_input.keys() else Option_None(),
        ExportStatus=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ExportStatus(native_input["ExportStatus"])) if "ExportStatus" in native_input.keys() else Option_None(),
        StartTime=Option_Some(TypeError("TimestampShape not supported")) if "StartTime" in native_input.keys() else Option_None(),
        EndTime=Option_Some(TypeError("TimestampShape not supported")) if "EndTime" in native_input.keys() else Option_None(),
        ExportManifest=Option_Some(Seq(native_input["ExportManifest"])) if "ExportManifest" in native_input.keys() else Option_None(),
        TableArn=Option_Some(Seq(native_input["TableArn"])) if "TableArn" in native_input.keys() else Option_None(),
        TableId=Option_Some(Seq(native_input["TableId"])) if "TableId" in native_input.keys() else Option_None(),
        ExportTime=Option_Some(TypeError("TimestampShape not supported")) if "ExportTime" in native_input.keys() else Option_None(),
        ClientToken=Option_Some(Seq(native_input["ClientToken"])) if "ClientToken" in native_input.keys() else Option_None(),
        S3Bucket=Option_Some(Seq(native_input["S3Bucket"])) if "S3Bucket" in native_input.keys() else Option_None(),
        S3BucketOwner=Option_Some(Seq(native_input["S3BucketOwner"])) if "S3BucketOwner" in native_input.keys() else Option_None(),
        S3Prefix=Option_Some(Seq(native_input["S3Prefix"])) if "S3Prefix" in native_input.keys() else Option_None(),
        S3SseAlgorithm=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_S3SseAlgorithm(native_input["S3SseAlgorithm"])) if "S3SseAlgorithm" in native_input.keys() else Option_None(),
        S3SseKmsKeyId=Option_Some(Seq(native_input["S3SseKmsKeyId"])) if "S3SseKmsKeyId" in native_input.keys() else Option_None(),
        FailureCode=Option_Some(Seq(native_input["FailureCode"])) if "FailureCode" in native_input.keys() else Option_None(),
        FailureMessage=Option_Some(Seq(native_input["FailureMessage"])) if "FailureMessage" in native_input.keys() else Option_None(),
        ExportFormat=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ExportFormat(native_input["ExportFormat"])) if "ExportFormat" in native_input.keys() else Option_None(),
...
def com_amazonaws_dynamodb_DescribeGlobalTableSettingsOutput(native_input):
    return DafnyDescribeGlobalTableSettingsOutput(
        GlobalTableName=Option_Some(Seq(native_input["GlobalTableName"])) if "GlobalTableName" in native_input.keys() else Option_None(),
        ReplicaSettings=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ReplicaSettingsDescription(list_element) for list_element in native_input["ReplicaSettings"]])) if "ReplicaSettings" in native_input.keys() else Option_None(),
    )
...
def com_amazonaws_dynamodb_ReplicaSettingsDescription(native_input):
    return DafnyReplicaSettingsDescription(
        ...
        ReplicaStatus=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ReplicaStatus(native_input["ReplicaStatus"])) if "ReplicaStatus" in native_input.keys() else Option_None(),
        ReplicaBillingModeSummary=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_BillingModeSummary(native_input["ReplicaBillingModeSummary"])) if "ReplicaBillingModeSummary" in native_input.keys() else Option_None(),
...
def com_amazonaws_dynamodb_AutoScalingSettingsDescription(native_input):
    return DafnyAutoScalingSettingsDescription(
        ...
        AutoScalingRoleArn=Option_Some(Seq(native_input["AutoScalingRoleArn"])) if "AutoScalingRoleArn" in native_input.keys() else Option_None(),
        ScalingPolicies=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_AutoScalingPolicyDescription(list_element) for list_element in native_input["ScalingPolicies"]])) if "ScalingPolicies" in native_input.keys() else Option_None(),
    )
...
def com_amazonaws_dynamodb_AutoScalingPolicyDescription(native_input):
    return DafnyAutoScalingPolicyDescription(
        PolicyName=Option_Some(Seq(native_input["PolicyName"])) if "PolicyName" in native_input.keys() else Option_None(),
...
def com_amazonaws_dynamodb_DescribeImportOutput(native_input):
    return DafnyDescribeImportOutput(
        ImportTableDescription=com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ImportTableDescription(native_input["ImportTableDescription"]),
    )

def com_amazonaws_dynamodb_ImportTableDescription(native_input):
    return DafnyImportTableDescription(
        ImportArn=Option_Some(Seq(native_input["ImportArn"])) if "ImportArn" in native_input.keys() else Option_None(),
        ImportStatus=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ImportStatus(native_input["ImportStatus"])) if "ImportStatus" in native_input.keys() else Option_None(),
        TableArn=Option_Some(Seq(native_input["TableArn"])) if "TableArn" in native_input.keys() else Option_None(),
        TableId=Option_Some(Seq(native_input["TableId"])) if "TableId" in native_input.keys() else Option_None(),
        ClientToken=Option_Some(Seq(native_input["ClientToken"])) if "ClientToken" in native_input.keys() else Option_None(),
        S3BucketSource=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_S3BucketSource(native_input["S3BucketSource"])) if "S3BucketSource" in native_input.keys() else Option_None(),
        ErrorCount=Option_Some(native_input["ErrorCount"]) if "ErrorCount" in native_input.keys() else Option_None(),
        CloudWatchLogGroupArn=Option_Some(Seq(native_input["CloudWatchLogGroupArn"])) if "CloudWatchLogGroupArn" in native_input.keys() else Option_None(),
        InputFormat=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_InputFormat(native_input["InputFormat"])) if "InputFormat" in native_input.keys() else Option_None(),
        InputFormatOptions=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_InputFormatOptions(native_input["InputFormatOptions"])) if "InputFormatOptions" in native_input.keys() else Option_None(),
        InputCompressionType=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_InputCompressionType(native_input["InputCompressionType"])) if "InputCompressionType" in native_input.keys() else Option_None(),
        TableCreationParameters=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_TableCreationParameters(native_input["TableCreationParameters"])) if "TableCreationParameters" in native_input.keys() else Option_None(),
        StartTime=Option_Some(TypeError("TimestampShape not supported")) if "StartTime" in native_input.keys() else Option_None(),
        EndTime=Option_Some(TypeError("TimestampShape not supported")) if "EndTime" in native_input.keys() else Option_None(),
...
def com_amazonaws_dynamodb_S3BucketSource(native_input):
    return DafnyS3BucketSource(
        ...
        S3KeyPrefix=Option_Some(Seq(native_input["S3KeyPrefix"])) if "S3KeyPrefix" in native_input.keys() else Option_None(),
    )
...
def com_amazonaws_dynamodb_InputFormatOptions(native_input):
    return DafnyInputFormatOptions(
        Csv=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_CsvOptions(native_input["Csv"])) if "Csv" in native_input.keys() else Option_None(),
    )
...
def com_amazonaws_dynamodb_CsvOptions(native_input):
    return DafnyCsvOptions(
        Delimiter=Option_Some(Seq(native_input["Delimiter"])) if "Delimiter" in native_input.keys() else Option_None(),
        HeaderList=Option_Some(Seq([Seq(list_element) for list_element in native_input["HeaderList"]])) if "HeaderList" in native_input.keys() else Option_None(),
    )
...
def com_amazonaws_dynamodb_KinesisDataStreamDestination(native_input):
    return DafnyKinesisDataStreamDestination(
        StreamArn=Option_Some(Seq(native_input["StreamArn"])) if "StreamArn" in native_input.keys() else Option_None(),
        DestinationStatus=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_DestinationStatus(native_input["DestinationStatus"])) if "DestinationStatus" in native_input.keys() else Option_None(),
        DestinationStatusDescription=Option_Some(Seq(native_input["DestinationStatusDescription"])) if "DestinationStatusDescription" in native_input.keys() else Option_None(),
    )
...
def com_amazonaws_dynamodb_DescribeTableOutput(native_input):
    return DafnyDescribeTableOutput(
        Table=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_TableDescription(native_input["Table"])) if "Table" in native_input.keys() else Option_None(),
    )
...
def com_amazonaws_dynamodb_DescribeTableReplicaAutoScalingOutput(native_input):
    return DafnyDescribeTableReplicaAutoScalingOutput(
        TableAutoScalingDescription=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_TableAutoScalingDescription(native_input["TableAutoScalingDescription"])) if "TableAutoScalingDescription" in native_input.keys() else Option_None(),
    )
...
def com_amazonaws_dynamodb_TableAutoScalingDescription(native_input):
    return DafnyTableAutoScalingDescription(
        TableName=Option_Some(Seq(native_input["TableName"])) if "TableName" in native_input.keys() else Option_None(),
        TableStatus=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_TableStatus(native_input["TableStatus"])) if "TableStatus" in native_input.keys() else Option_None(),
        Replicas=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ReplicaAutoScalingDescription(list_element) for list_element in native_input["Replicas"]])) if "Replicas" in native_input.keys() else Option_None(),
    )
...
def com_amazonaws_dynamodb_ExecuteStatementInput(native_input):
    return DafnyExecuteStatementInput(
        ...
        Parameters=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_AttributeValue(list_element) for list_element in native_input["Parameters"]])) if "Parameters" in native_input.keys() else Option_None(),
        ConsistentRead=Option_Some(native_input["ConsistentRead"]) if "ConsistentRead" in native_input.keys() else Option_None(),
        NextToken=Option_Some(Seq(native_input["NextToken"])) if "NextToken" in native_input.keys() else Option_None(),
        ReturnConsumedCapacity=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ReturnConsumedCapacity(native_input["ReturnConsumedCapacity"])) if "ReturnConsumedCapacity" in native_input.keys() else Option_None(),
...
def com_amazonaws_dynamodb_ExecuteStatementOutput(native_input):
    return DafnyExecuteStatementOutput(
        Items=Option_Some(Seq([Map({Seq(key): com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in list_element.items() }) for list_element in native_input["Items"]])) if "Items" in native_input.keys() else Option_None(),
        NextToken=Option_Some(Seq(native_input["NextToken"])) if "NextToken" in native_input.keys() else Option_None(),
        ConsumedCapacity=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ConsumedCapacity(native_input["ConsumedCapacity"])) if "ConsumedCapacity" in native_input.keys() else Option_None(),
        LastEvaluatedKey=Option_Some(Map({Seq(key): com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in native_input["LastEvaluatedKey"].items() })) if "LastEvaluatedKey" in native_input.keys() else Option_None(),
    )

def com_amazonaws_dynamodb_ExecuteTransactionInput(native_input):
    return DafnyExecuteTransactionInput(
        TransactStatements=Seq([com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ParameterizedStatement(list_element) for list_element in native_input["TransactStatements"]]),
        ClientRequestToken=Option_Some(Seq(native_input["ClientRequestToken"])) if "ClientRequestToken" in native_input.keys() else Option_None(),
        ReturnConsumedCapacity=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ReturnConsumedCapacity(native_input["ReturnConsumedCapacity"])) if "ReturnConsumedCapacity" in native_input.keys() else Option_None(),
    )
...
def com_amazonaws_dynamodb_ExecuteTransactionOutput(native_input):
    return DafnyExecuteTransactionOutput(
        Responses=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ItemResponse(list_element) for list_element in native_input["Responses"]])) if "Responses" in native_input.keys() else Option_None(),
        ConsumedCapacity=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ConsumedCapacity(list_element) for list_element in native_input["ConsumedCapacity"]])) if "ConsumedCapacity" in native_input.keys() else Option_None(),
    )
...
def com_amazonaws_dynamodb_ImportTableInput(native_input):
    return DafnyImportTableInput(
        ClientToken=Option_Some(Seq(native_input["ClientToken"])) if "ClientToken" in native_input.keys() else Option_None(),
        S3BucketSource=com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_S3BucketSource(native_input["S3BucketSource"]),
        InputFormat=com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_InputFormat(native_input["InputFormat"]),
        InputFormatOptions=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_InputFormatOptions(native_input["InputFormatOptions"])) if "InputFormatOptions" in native_input.keys() else Option_None(),
        InputCompressionType=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_InputCompressionType(native_input["InputCompressionType"])) if "InputCompressionType" in native_input.keys() else Option_None(),
        TableCreationParameters=com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_TableCreationParameters(native_input["TableCreationParameters"]),
    )
...
def com_amazonaws_dynamodb_ListBackupsInput(native_input):
    return DafnyListBackupsInput(
        TableName=Option_Some(Seq(native_input["TableName"])) if "TableName" in native_input.keys() else Option_None(),
        Limit=Option_Some(native_input["Limit"]) if "Limit" in native_input.keys() else Option_None(),
        TimeRangeLowerBound=Option_Some(TypeError("TimestampShape not supported")) if "TimeRangeLowerBound" in native_input.keys() else Option_None(),
        TimeRangeUpperBound=Option_Some(TypeError("TimestampShape not supported")) if "TimeRangeUpperBound" in native_input.keys() else Option_None(),
        ExclusiveStartBackupArn=Option_Some(Seq(native_input["ExclusiveStartBackupArn"])) if "ExclusiveStartBackupArn" in native_input.keys() else Option_None(),
        BackupType=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_BackupTypeFilter(native_input["BackupType"])) if "BackupType" in native_input.keys() else Option_None(),
    )
...
def com_amazonaws_dynamodb_ListBackupsOutput(native_input):
    return DafnyListBackupsOutput(
        BackupSummaries=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_BackupSummary(list_element) for list_element in native_input["BackupSummaries"]])) if "BackupSummaries" in native_input.keys() else Option_None(),
        LastEvaluatedBackupArn=Option_Some(Seq(native_input["LastEvaluatedBackupArn"])) if "LastEvaluatedBackupArn" in native_input.keys() else Option_None(),
    )
...
def com_amazonaws_dynamodb_BackupSummary(native_input):
    return DafnyBackupSummary(
        ...
        TableId=Option_Some(Seq(native_input["TableId"])) if "TableId" in native_input.keys() else Option_None(),
        TableArn=Option_Some(Seq(native_input["TableArn"])) if "TableArn" in native_input.keys() else Option_None(),
        BackupArn=Option_Some(Seq(native_input["BackupArn"])) if "BackupArn" in native_input.keys() else Option_None(),
        BackupName=Option_Some(Seq(native_input["BackupName"])) if "BackupName" in native_input.keys() else Option_None(),
        BackupCreationDateTime=Option_Some(TypeError("TimestampShape not supported")) if "BackupCreationDateTime" in native_input.keys() else Option_None(),
        BackupExpiryDateTime=Option_Some(TypeError("TimestampShape not supported")) if "BackupExpiryDateTime" in native_input.keys() else Option_None(),
        BackupStatus=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_BackupStatus(native_input["BackupStatus"])) if "BackupStatus" in native_input.keys() else Option_None(),
        BackupType=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_BackupType(native_input["BackupType"])) if "BackupType" in native_input.keys() else Option_None(),
        BackupSizeBytes=Option_Some(native_input["BackupSizeBytes"]) if "BackupSizeBytes" in native_input.keys() else Option_None(),
    )
...
def com_amazonaws_dynamodb_ListExportsOutput(native_input):
    return DafnyListExportsOutput(
        ExportSummaries=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ExportSummary(list_element) for list_element in native_input["ExportSummaries"]])) if "ExportSummaries" in native_input.keys() else Option_None(),
        NextToken=Option_Some(Seq(native_input["NextToken"])) if "NextToken" in native_input.keys() else Option_None(),
    )
...
def com_amazonaws_dynamodb_ListGlobalTablesInput(native_input):
    return DafnyListGlobalTablesInput(
        ExclusiveStartGlobalTableName=Option_Some(Seq(native_input["ExclusiveStartGlobalTableName"])) if "ExclusiveStartGlobalTableName" in native_input.keys() else Option_None(),
        Limit=Option_Some(native_input["Limit"]) if "Limit" in native_input.keys() else Option_None(),
        RegionName=Option_Some(Seq(native_input["RegionName"])) if "RegionName" in native_input.keys() else Option_None(),
    )
...
def com_amazonaws_dynamodb_ListGlobalTablesOutput(native_input):
    return DafnyListGlobalTablesOutput(
        GlobalTables=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_GlobalTable(list_element) for list_element in native_input["GlobalTables"]])) if "GlobalTables" in native_input.keys() else Option_None(),
        LastEvaluatedGlobalTableName=Option_Some(Seq(native_input["LastEvaluatedGlobalTableName"])) if "LastEvaluatedGlobalTableName" in native_input.keys() else Option_None(),
    )

def com_amazonaws_dynamodb_GlobalTable(native_input):
    return DafnyGlobalTable(
        GlobalTableName=Option_Some(Seq(native_input["GlobalTableName"])) if "GlobalTableName" in native_input.keys() else Option_None(),
        ReplicationGroup=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_Replica(list_element) for list_element in native_input["ReplicationGroup"]])) if "ReplicationGroup" in native_input.keys() else Option_None(),
    )
...
def com_amazonaws_dynamodb_ListImportsOutput(native_input):
    return DafnyListImportsOutput(
        ImportSummaryList=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ImportSummary(list_element) for list_element in native_input["ImportSummaryList"]])) if "ImportSummaryList" in native_input.keys() else Option_None(),
        NextToken=Option_Some(Seq(native_input["NextToken"])) if "NextToken" in native_input.keys() else Option_None(),
    )
...
def com_amazonaws_dynamodb_ListTablesInput(native_input):
    return DafnyListTablesInput(
        ExclusiveStartTableName=Option_Some(Seq(native_input["ExclusiveStartTableName"])) if "ExclusiveStartTableName" in native_input.keys() else Option_None(),
        Limit=Option_Some(native_input["Limit"]) if "Limit" in native_input.keys() else Option_None(),
    )

def com_amazonaws_dynamodb_ListTablesOutput(native_input):
    return DafnyListTablesOutput(
        TableNames=Option_Some(Seq([Seq(list_element) for list_element in native_input["TableNames"]])) if "TableNames" in native_input.keys() else Option_None(),
        LastEvaluatedTableName=Option_Some(Seq(native_input["LastEvaluatedTableName"])) if "LastEvaluatedTableName" in native_input.keys() else Option_None(),
    )
...
def com_amazonaws_dynamodb_QueryInput(native_input):
    return DafnyQueryInput(
        TableName=Seq(native_input["TableName"]),
        IndexName=Option_Some(Seq(native_input["IndexName"])) if "IndexName" in native_input.keys() else Option_None(),
        Select=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_Select(native_input["Select"])) if "Select" in native_input.keys() else Option_None(),
        AttributesToGet=Option_Some(Seq([Seq(list_element) for list_element in native_input["AttributesToGet"]])) if "AttributesToGet" in native_input.keys() else Option_None(),
        Limit=Option_Some(native_input["Limit"]) if "Limit" in native_input.keys() else Option_None(),
        ConsistentRead=Option_Some(native_input["ConsistentRead"]) if "ConsistentRead" in native_input.keys() else Option_None(),
        KeyConditions=Option_Some(Map({Seq(key): com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_Condition(value) for (key, value) in native_input["KeyConditions"].items() })) if "KeyConditions" in native_input.keys() else Option_None(),
        QueryFilter=Option_Some(Map({Seq(key): com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_Condition(value) for (key, value) in native_input["QueryFilter"].items() })) if "QueryFilter" in native_input.keys() else Option_None(),
        ConditionalOperator=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ConditionalOperator(native_input["ConditionalOperator"])) if "ConditionalOperator" in native_input.keys() else Option_None(),
        ScanIndexForward=Option_Some(native_input["ScanIndexForward"]) if "ScanIndexForward" in native_input.keys() else Option_None(),
        ExclusiveStartKey=Option_Some(Map({Seq(key): com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in native_input["ExclusiveStartKey"].items() })) if "ExclusiveStartKey" in native_input.keys() else Option_None(),
        ReturnConsumedCapacity=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ReturnConsumedCapacity(native_input["ReturnConsumedCapacity"])) if "ReturnConsumedCapacity" in native_input.keys() else Option_None(),
        ProjectionExpression=Option_Some(Seq(native_input["ProjectionExpression"])) if "ProjectionExpression" in native_input.keys() else Option_None(),
        FilterExpression=Option_Some(Seq(native_input["FilterExpression"])) if "FilterExpression" in native_input.keys() else Option_None(),
        KeyConditionExpression=Option_Some(Seq(native_input["KeyConditionExpression"])) if "KeyConditionExpression" in native_input.keys() else Option_None(),
        ExpressionAttributeNames=Option_Some(Map({Seq(key): Seq(value) for (key, value) in native_input["ExpressionAttributeNames"].items() })) if "ExpressionAttributeNames" in native_input.keys() else Option_None(),
        ExpressionAttributeValues=Option_Some(Map({Seq(key): com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in native_input["ExpressionAttributeValues"].items() })) if "ExpressionAttributeValues" in native_input.keys() else Option_None(),
    )
...
def com_amazonaws_dynamodb_Condition(native_input):
    return DafnyCondition(
        AttributeValueList=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_AttributeValue(list_element) for list_element in native_input["AttributeValueList"]])) if "AttributeValueList" in native_input.keys() else Option_None(),
        ComparisonOperator=com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ComparisonOperator(native_input["ComparisonOperator"]),
    )
...
def com_amazonaws_dynamodb_RestoreTableFromBackupInput(native_input):
    return DafnyRestoreTableFromBackupInput(
        ...
        BackupArn=Seq(native_input["BackupArn"]),
        BillingModeOverride=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_BillingMode(native_input["BillingModeOverride"])) if "BillingModeOverride" in native_input.keys() else Option_None(),
        ...
        ProvisionedThroughputOverride=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ProvisionedThroughput(native_input["ProvisionedThroughputOverride"])) if "ProvisionedThroughputOverride" in native_input.keys() else Option_None(),
        SSESpecificationOverride=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_SSESpecification(native_input["SSESpecificationOverride"])) if "SSESpecificationOverride" in native_input.keys() else Option_None(),
    )
...
def com_amazonaws_dynamodb_RestoreTableToPointInTimeInput(native_input):
    return DafnyRestoreTableToPointInTimeInput(
        SourceTableArn=Option_Some(Seq(native_input["SourceTableArn"])) if "SourceTableArn" in native_input.keys() else Option_None(),
        SourceTableName=Option_Some(Seq(native_input["SourceTableName"])) if "SourceTableName" in native_input.keys() else Option_None(),
        TargetTableName=Seq(native_input["TargetTableName"]),
        ...
        RestoreDateTime=Option_Some(TypeError("TimestampShape not supported")) if "RestoreDateTime" in native_input.keys() else Option_None(),
        BillingModeOverride=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_BillingMode(native_input["BillingModeOverride"])) if "BillingModeOverride" in native_input.keys() else Option_None(),
        GlobalSecondaryIndexOverride=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_GlobalSecondaryIndex(list_element) for list_element in native_input["GlobalSecondaryIndexOverride"]])) if "GlobalSecondaryIndexOverride" in native_input.keys() else Option_None(),
        LocalSecondaryIndexOverride=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_LocalSecondaryIndex(list_element) for list_element in native_input["LocalSecondaryIndexOverride"]])) if "LocalSecondaryIndexOverride" in native_input.keys() else Option_None(),
        ProvisionedThroughputOverride=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ProvisionedThroughput(native_input["ProvisionedThroughputOverride"])) if "ProvisionedThroughputOverride" in native_input.keys() else Option_None(),
...
def com_amazonaws_dynamodb_ScanInput(native_input):
    return DafnyScanInput(
        ...
        Limit=Option_Some(native_input["Limit"]) if "Limit" in native_input.keys() else Option_None(),
        Select=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_Select(native_input["Select"])) if "Select" in native_input.keys() else Option_None(),
        ScanFilter=Option_Some(Map({Seq(key): com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_Condition(value) for (key, value) in native_input["ScanFilter"].items() })) if "ScanFilter" in native_input.keys() else Option_None(),
        ConditionalOperator=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ConditionalOperator(native_input["ConditionalOperator"])) if "ConditionalOperator" in native_input.keys() else Option_None(),
        ExclusiveStartKey=Option_Some(Map({Seq(key): com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in native_input["ExclusiveStartKey"].items() })) if "ExclusiveStartKey" in native_input.keys() else Option_None(),
        ReturnConsumedCapacity=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ReturnConsumedCapacity(native_input["ReturnConsumedCapacity"])) if "ReturnConsumedCapacity" in native_input.keys() else Option_None(),
...
def com_amazonaws_dynamodb_TagResourceInput(native_input):
    return DafnyTagResourceInput(
        ResourceArn=Seq(native_input["ResourceArn"]),
        Tags=Seq([com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_Tag(list_element) for list_element in native_input["Tags"]]),
    )

def com_amazonaws_dynamodb_TransactGetItemsInput(native_input):
    return DafnyTransactGetItemsInput(
        TransactItems=Seq([com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_TransactGetItem(list_element) for list_element in native_input["TransactItems"]]),
        ReturnConsumedCapacity=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ReturnConsumedCapacity(native_input["ReturnConsumedCapacity"])) if "ReturnConsumedCapacity" in native_input.keys() else Option_None(),
    )

def com_amazonaws_dynamodb_TransactGetItem(native_input):
    return DafnyTransactGetItem(
        Get=com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_Get(native_input["Get"]),
    )
...
def com_amazonaws_dynamodb_TransactWriteItemsInput(native_input):
    return DafnyTransactWriteItemsInput(
        TransactItems=Seq([com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_TransactWriteItem(list_element) for list_element in native_input["TransactItems"]]),
        ReturnConsumedCapacity=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ReturnConsumedCapacity(native_input["ReturnConsumedCapacity"])) if "ReturnConsumedCapacity" in native_input.keys() else Option_None(),
        ReturnItemCollectionMetrics=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ReturnItemCollectionMetrics(native_input["ReturnItemCollectionMetrics"])) if "ReturnItemCollectionMetrics" in native_input.keys() else Option_None(),
        ClientRequestToken=Option_Some(Seq(native_input["ClientRequestToken"])) if "ClientRequestToken" in native_input.keys() else Option_None(),
    )
...
def com_amazonaws_dynamodb_TransactWriteItem(native_input):
    return DafnyTransactWriteItem(
        ConditionCheck=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ConditionCheck(native_input["ConditionCheck"])) if "ConditionCheck" in native_input.keys() else Option_None(),
        Put=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_Put(native_input["Put"])) if "Put" in native_input.keys() else Option_None(),
        Delete=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_Delete(native_input["Delete"])) if "Delete" in native_input.keys() else Option_None(),
        Update=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_Update(native_input["Update"])) if "Update" in native_input.keys() else Option_None(),
    )
...
def com_amazonaws_dynamodb_UpdateContinuousBackupsInput(native_input):
    return DafnyUpdateContinuousBackupsInput(
        TableName=Seq(native_input["TableName"]),
        PointInTimeRecoverySpecification=com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_PointInTimeRecoverySpecification(native_input["PointInTimeRecoverySpecification"]),
    )
...
def com_amazonaws_dynamodb_UpdateContributorInsightsInput(native_input):
    return DafnyUpdateContributorInsightsInput(
        TableName=Seq(native_input["TableName"]),
        IndexName=Option_Some(Seq(native_input["IndexName"])) if "IndexName" in native_input.keys() else Option_None(),
        ContributorInsightsAction=com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ContributorInsightsAction(native_input["ContributorInsightsAction"]),
    )
...
def com_amazonaws_dynamodb_UpdateGlobalTableInput(native_input):
    return DafnyUpdateGlobalTableInput(
        GlobalTableName=Seq(native_input["GlobalTableName"]),
        ReplicaUpdates=Seq([com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ReplicaUpdate(list_element) for list_element in native_input["ReplicaUpdates"]]),
    )

def com_amazonaws_dynamodb_ReplicaUpdate(native_input):
    return DafnyReplicaUpdate(
        Create=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_CreateReplicaAction(native_input["Create"])) if "Create" in native_input.keys() else Option_None(),
        Delete=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_DeleteReplicaAction(native_input["Delete"])) if "Delete" in native_input.keys() else Option_None(),
    )
...
def com_amazonaws_dynamodb_UpdateGlobalTableSettingsInput(native_input):
    return DafnyUpdateGlobalTableSettingsInput(
        GlobalTableName=Seq(native_input["GlobalTableName"]),
        GlobalTableBillingMode=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_BillingMode(native_input["GlobalTableBillingMode"])) if "GlobalTableBillingMode" in native_input.keys() else Option_None(),
        ...
        ReplicaSettingsUpdate=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ReplicaSettingsUpdate(list_element) for list_element in native_input["ReplicaSettingsUpdate"]])) if "ReplicaSettingsUpdate" in native_input.keys() else Option_None(),
    )
...
def com_amazonaws_dynamodb_AutoScalingSettingsUpdate(native_input):
    return DafnyAutoScalingSettingsUpdate(
        ...
        AutoScalingDisabled=Option_Some(native_input["AutoScalingDisabled"]) if "AutoScalingDisabled" in native_input.keys() else Option_None(),
        AutoScalingRoleArn=Option_Some(Seq(native_input["AutoScalingRoleArn"])) if "AutoScalingRoleArn" in native_input.keys() else Option_None(),
        ScalingPolicyUpdate=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_AutoScalingPolicyUpdate(native_input["ScalingPolicyUpdate"])) if "ScalingPolicyUpdate" in native_input.keys() else Option_None(),
    )

def com_amazonaws_dynamodb_AutoScalingPolicyUpdate(native_input):
    return DafnyAutoScalingPolicyUpdate(
        PolicyName=Option_Some(Seq(native_input["PolicyName"])) if "PolicyName" in native_input.keys() else Option_None(),
        TargetTrackingScalingPolicyConfiguration=com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_AutoScalingTargetTrackingScalingPolicyConfigurationUpdate(native_input["TargetTrackingScalingPolicyConfiguration"]),
    )
...
def com_amazonaws_dynamodb_ReplicaSettingsUpdate(native_input):
    return DafnyReplicaSettingsUpdate(
        ...
        ReplicaTableClass=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_TableClass(native_input["ReplicaTableClass"])) if "ReplicaTableClass" in native_input.keys() else Option_None(),
    )
...
def com_amazonaws_dynamodb_UpdateItemInput(native_input):
    return DafnyUpdateItemInput(
        TableName=Seq(native_input["TableName"]),
        Key=Map({Seq(key): com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in native_input["Key"].items() }),
        AttributeUpdates=Option_Some(Map({Seq(key): com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_AttributeValueUpdate(value) for (key, value) in native_input["AttributeUpdates"].items() })) if "AttributeUpdates" in native_input.keys() else Option_None(),
        Expected=Option_Some(Map({Seq(key): com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ExpectedAttributeValue(value) for (key, value) in native_input["Expected"].items() })) if "Expected" in native_input.keys() else Option_None(),
        ConditionalOperator=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ConditionalOperator(native_input["ConditionalOperator"])) if "ConditionalOperator" in native_input.keys() else Option_None(),
        ReturnValues=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ReturnValue(native_input["ReturnValues"])) if "ReturnValues" in native_input.keys() else Option_None(),
        ReturnConsumedCapacity=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ReturnConsumedCapacity(native_input["ReturnConsumedCapacity"])) if "ReturnConsumedCapacity" in native_input.keys() else Option_None(),
        ReturnItemCollectionMetrics=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ReturnItemCollectionMetrics(native_input["ReturnItemCollectionMetrics"])) if "ReturnItemCollectionMetrics" in native_input.keys() else Option_None(),
        UpdateExpression=Option_Some(Seq(native_input["UpdateExpression"])) if "UpdateExpression" in native_input.keys() else Option_None(),
        ConditionExpression=Option_Some(Seq(native_input["ConditionExpression"])) if "ConditionExpression" in native_input.keys() else Option_None(),
        ExpressionAttributeNames=Option_Some(Map({Seq(key): Seq(value) for (key, value) in native_input["ExpressionAttributeNames"].items() })) if "ExpressionAttributeNames" in native_input.keys() else Option_None(),
        ExpressionAttributeValues=Option_Some(Map({Seq(key): com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_AttributeValue(value) for (key, value) in native_input["ExpressionAttributeValues"].items() })) if "ExpressionAttributeValues" in native_input.keys() else Option_None(),
    )
...
def com_amazonaws_dynamodb_AttributeValueUpdate(native_input):
    return DafnyAttributeValueUpdate(
        Value=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_AttributeValue(native_input["Value"])) if "Value" in native_input.keys() else Option_None(),
        Action=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_AttributeAction(native_input["Action"])) if "Action" in native_input.keys() else Option_None(),
    )
...
def com_amazonaws_dynamodb_UpdateTableInput(native_input):
    return DafnyUpdateTableInput(
        ...
        StreamSpecification=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_StreamSpecification(native_input["StreamSpecification"])) if "StreamSpecification" in native_input.keys() else Option_None(),
        SSESpecification=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_SSESpecification(native_input["SSESpecification"])) if "SSESpecification" in native_input.keys() else Option_None(),
        ReplicaUpdates=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ReplicationGroupUpdate(list_element) for list_element in native_input["ReplicaUpdates"]])) if "ReplicaUpdates" in native_input.keys() else Option_None(),
        TableClass=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_TableClass(native_input["TableClass"])) if "TableClass" in native_input.keys() else Option_None(),
    )

def com_amazonaws_dynamodb_GlobalSecondaryIndexUpdate(native_input):
    return DafnyGlobalSecondaryIndexUpdate(
        Update=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_UpdateGlobalSecondaryIndexAction(native_input["Update"])) if "Update" in native_input.keys() else Option_None(),
        Create=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_CreateGlobalSecondaryIndexAction(native_input["Create"])) if "Create" in native_input.keys() else Option_None(),
        Delete=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_DeleteGlobalSecondaryIndexAction(native_input["Delete"])) if "Delete" in native_input.keys() else Option_None(),
    )
...
def com_amazonaws_dynamodb_ReplicationGroupUpdate(native_input):
    return DafnyReplicationGroupUpdate(
        Create=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_CreateReplicationGroupMemberAction(native_input["Create"])) if "Create" in native_input.keys() else Option_None(),
        Update=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_UpdateReplicationGroupMemberAction(native_input["Update"])) if "Update" in native_input.keys() else Option_None(),
        Delete=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_DeleteReplicationGroupMemberAction(native_input["Delete"])) if "Delete" in native_input.keys() else Option_None(),
    )
...
def com_amazonaws_dynamodb_CreateReplicationGroupMemberAction(native_input):
    return DafnyCreateReplicationGroupMemberAction(
        ...
        TableClassOverride=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_TableClass(native_input["TableClassOverride"])) if "TableClassOverride" in native_input.keys() else Option_None(),
    )
...
def com_amazonaws_dynamodb_UpdateTableReplicaAutoScalingInput(native_input):
    return DafnyUpdateTableReplicaAutoScalingInput(
        ...
        ReplicaUpdates=Option_Some(Seq([com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_ReplicaAutoScalingUpdate(list_element) for list_element in native_input["ReplicaUpdates"]])) if "ReplicaUpdates" in native_input.keys() else Option_None(),
    )
...
def com_amazonaws_dynamodb_UpdateTimeToLiveInput(native_input):
    return DafnyUpdateTimeToLiveInput(
        TableName=Seq(native_input["TableName"]),
        TimeToLiveSpecification=com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_TimeToLiveSpecification(native_input["TimeToLiveSpecification"]),
    )
...
def com_amazonaws_dynamodb_UpdateTimeToLiveOutput(native_input):
    return DafnyUpdateTimeToLiveOutput(
        TimeToLiveSpecification=Option_Some(com_amazonaws_dynamodb.smithygenerated.com_amazonaws_dynamodb.aws_sdk_to_dafny.com_amazonaws_dynamodb_TimeToLiveSpecification(native_input["TimeToLiveSpecification"])) if "TimeToLiveSpecification" in native_input.keys() else Option_None(),
    )
