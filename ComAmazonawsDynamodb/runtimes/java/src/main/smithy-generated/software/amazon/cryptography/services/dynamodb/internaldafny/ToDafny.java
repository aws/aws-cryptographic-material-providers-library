...
public class ToDafny {
  public static ArchivalSummary ArchivalSummary(
    ...
    archivalDateTime = Objects.nonNull(nativeValue.archivalDateTime()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.archivalDateTime()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    Option<DafnySequence<? extends Character>> archivalReason;
    archivalReason = Objects.nonNull(nativeValue.archivalReason()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.archivalReason()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    Option<DafnySequence<? extends Character>> archivalBackupArn;
    archivalBackupArn = Objects.nonNull(nativeValue.archivalBackupArn()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.archivalBackupArn()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
  ...
  public static AttributeValueUpdate AttributeValueUpdate(
    ...
    value = Objects.nonNull(nativeValue.value()) ?
        Option.create_Some(AttributeValue._typeDescriptor(), ToDafny.AttributeValue(nativeValue.value()))
        : Option.create_None(AttributeValue._typeDescriptor());
    Option<AttributeAction> action;
    action = Objects.nonNull(nativeValue.action()) ?
        Option.create_Some(AttributeAction._typeDescriptor(), ToDafny.AttributeAction(nativeValue.action()))
  ...
  public static AutoScalingPolicyDescription AutoScalingPolicyDescription(
    ...
    policyName = Objects.nonNull(nativeValue.policyName()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.policyName()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    ...
    targetTrackingScalingPolicyConfiguration = Objects.nonNull(nativeValue.targetTrackingScalingPolicyConfiguration()) ?
        Option.create_Some(AutoScalingTargetTrackingScalingPolicyConfigurationDescription._typeDescriptor(), ToDafny.AutoScalingTargetTrackingScalingPolicyConfigurationDescription(nativeValue.targetTrackingScalingPolicyConfiguration()))
        : Option.create_None(AutoScalingTargetTrackingScalingPolicyConfigurationDescription._typeDescriptor());
  ...
  public static AutoScalingSettingsDescription AutoScalingSettingsDescription(
    ...
    autoScalingDisabled = Objects.nonNull(nativeValue.autoScalingDisabled()) ?
        Option.create_Some(TypeDescriptor.BOOLEAN, (nativeValue.autoScalingDisabled()))
    ...
    autoScalingRoleArn = Objects.nonNull(nativeValue.autoScalingRoleArn()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.autoScalingRoleArn()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    ...
    scalingPolicies = (Objects.nonNull(nativeValue.scalingPolicies()) && nativeValue.scalingPolicies().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(AutoScalingPolicyDescription._typeDescriptor()), ToDafny.AutoScalingPolicyDescriptionList(nativeValue.scalingPolicies()))
        : Option.create_None(DafnySequence._typeDescriptor(AutoScalingPolicyDescription._typeDescriptor()));
  ...
  public static AutoScalingSettingsUpdate AutoScalingSettingsUpdate(
    ...
    scalingPolicyUpdate = Objects.nonNull(nativeValue.scalingPolicyUpdate()) ?
        Option.create_Some(AutoScalingPolicyUpdate._typeDescriptor(), ToDafny.AutoScalingPolicyUpdate(nativeValue.scalingPolicyUpdate()))
  ...
  public static AutoScalingTargetTrackingScalingPolicyConfigurationDescription AutoScalingTargetTrackingScalingPolicyConfigurationDescription(
    ...
    disableScaleIn = Objects.nonNull(nativeValue.disableScaleIn()) ?
        Option.create_Some(TypeDescriptor.BOOLEAN, (nativeValue.disableScaleIn()))
        : Option.create_None(TypeDescriptor.BOOLEAN);
    ...
    scaleOutCooldown = Objects.nonNull(nativeValue.scaleOutCooldown()) ?
        Option.create_Some(TypeDescriptor.INT, (nativeValue.scaleOutCooldown()))
        : Option.create_None(TypeDescriptor.INT);
  ...
  public static BackupDescription BackupDescription(
    ...
    sourceTableDetails = Objects.nonNull(nativeValue.sourceTableDetails()) ?
        Option.create_Some(SourceTableDetails._typeDescriptor(), ToDafny.SourceTableDetails(nativeValue.sourceTableDetails()))
    ...
    sourceTableFeatureDetails = Objects.nonNull(nativeValue.sourceTableFeatureDetails()) ?
        Option.create_Some(SourceTableFeatureDetails._typeDescriptor(), ToDafny.SourceTableFeatureDetails(nativeValue.sourceTableFeatureDetails()))
  ...
  public static BackupDetails BackupDetails(
    ...
    backupSizeBytes = Objects.nonNull(nativeValue.backupSizeBytes()) ?
        Option.create_Some(TypeDescriptor.LONG, (nativeValue.backupSizeBytes()))
        : Option.create_None(TypeDescriptor.LONG);
    ...
    backupExpiryDateTime = Objects.nonNull(nativeValue.backupExpiryDateTime()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.backupExpiryDateTime()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
  ...
  public static BackupSummary BackupSummary(
    ...
    tableName = Objects.nonNull(nativeValue.tableName()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.tableName()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    Option<DafnySequence<? extends Character>> tableId;
    tableId = Objects.nonNull(nativeValue.tableId()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.tableId()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    Option<DafnySequence<? extends Character>> tableArn;
    tableArn = Objects.nonNull(nativeValue.tableArn()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.tableArn()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    Option<DafnySequence<? extends Character>> backupArn;
    backupArn = Objects.nonNull(nativeValue.backupArn()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.backupArn()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    Option<DafnySequence<? extends Character>> backupName;
    backupName = Objects.nonNull(nativeValue.backupName()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.backupName()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    ...
    backupCreationDateTime = Objects.nonNull(nativeValue.backupCreationDateTime()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.backupCreationDateTime()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    Option<DafnySequence<? extends Character>> backupExpiryDateTime;
    backupExpiryDateTime = Objects.nonNull(nativeValue.backupExpiryDateTime()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.backupExpiryDateTime()))
    ...
    backupStatus = Objects.nonNull(nativeValue.backupStatus()) ?
        Option.create_Some(BackupStatus._typeDescriptor(), ToDafny.BackupStatus(nativeValue.backupStatus()))
    ...
    backupType = Objects.nonNull(nativeValue.backupType()) ?
        Option.create_Some(BackupType._typeDescriptor(), ToDafny.BackupType(nativeValue.backupType()))
  ...
  public static BatchExecuteStatementInput BatchExecuteStatementInput(
    ...
    returnConsumedCapacity = Objects.nonNull(nativeValue.returnConsumedCapacity()) ?
        Option.create_Some(ReturnConsumedCapacity._typeDescriptor(), ToDafny.ReturnConsumedCapacity(nativeValue.returnConsumedCapacity()))
  ...
  public static BatchExecuteStatementOutput BatchExecuteStatementOutput(
    ...
    responses = (Objects.nonNull(nativeValue.responses()) && nativeValue.responses().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(BatchStatementResponse._typeDescriptor()), ToDafny.PartiQLBatchResponse(nativeValue.responses()))
        : Option.create_None(DafnySequence._typeDescriptor(BatchStatementResponse._typeDescriptor()));
    ...
    consumedCapacity = (Objects.nonNull(nativeValue.consumedCapacity()) && nativeValue.consumedCapacity().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(ConsumedCapacity._typeDescriptor()), ToDafny.ConsumedCapacityMultiple(nativeValue.consumedCapacity()))
        : Option.create_None(DafnySequence._typeDescriptor(ConsumedCapacity._typeDescriptor()));
  ...
  public static BatchGetItemOutput BatchGetItemOutput(BatchGetItemResponse nativeValue) {
    ...
    responses = (Objects.nonNull(nativeValue.responses()) && nativeValue.responses().size() > 0) ?
        Option.create_Some(DafnyMap._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), DafnySequence._typeDescriptor(TypeDescriptor.referenceWithInitializer(dafny.DafnyMap.class, () -> dafny.DafnyMap.<dafny.DafnySequence<? extends Character>,AttributeValue> empty()))), ToDafny.BatchGetResponseMap(nativeValue.responses()))
        : Option.create_None(DafnyMap._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), DafnySequence._typeDescriptor(TypeDescriptor.referenceWithInitializer(dafny.DafnyMap.class, () -> dafny.DafnyMap.<dafny.DafnySequence<? extends Character>,AttributeValue> empty()))));
    ...
    unprocessedKeys = (Objects.nonNull(nativeValue.unprocessedKeys()) && nativeValue.unprocessedKeys().size() > 0) ?
        Option.create_Some(DafnyMap._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), KeysAndAttributes._typeDescriptor()), ToDafny.BatchGetRequestMap(nativeValue.unprocessedKeys()))
        : Option.create_None(DafnyMap._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), KeysAndAttributes._typeDescriptor()));
    Option<DafnySequence<? extends ConsumedCapacity>> consumedCapacity;
    consumedCapacity = (Objects.nonNull(nativeValue.consumedCapacity()) && nativeValue.consumedCapacity().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(ConsumedCapacity._typeDescriptor()), ToDafny.ConsumedCapacityMultiple(nativeValue.consumedCapacity()))
        : Option.create_None(DafnySequence._typeDescriptor(ConsumedCapacity._typeDescriptor()));
  ...
  public static BatchStatementError BatchStatementError(
    ...
    code = Objects.nonNull(nativeValue.code()) ?
        Option.create_Some(BatchStatementErrorCodeEnum._typeDescriptor(), ToDafny.BatchStatementErrorCodeEnum(nativeValue.code()))
    ...
    message = Objects.nonNull(nativeValue.message()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.message()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
  ...
  public static BatchStatementRequest BatchStatementRequest(
    ...
    parameters = (Objects.nonNull(nativeValue.parameters()) && nativeValue.parameters().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(AttributeValue._typeDescriptor()), ToDafny.PreparedStatementParameters(nativeValue.parameters()))
        : Option.create_None(DafnySequence._typeDescriptor(AttributeValue._typeDescriptor()));
    Option<Boolean> consistentRead;
    consistentRead = Objects.nonNull(nativeValue.consistentRead()) ?
        Option.create_Some(TypeDescriptor.BOOLEAN, (nativeValue.consistentRead()))
        : Option.create_None(TypeDescriptor.BOOLEAN);
  ...
  public static BatchStatementResponse BatchStatementResponse(
    ...
    error = Objects.nonNull(nativeValue.error()) ?
        Option.create_Some(BatchStatementError._typeDescriptor(), ToDafny.BatchStatementError(nativeValue.error()))
    ...
    item = (Objects.nonNull(nativeValue.item()) && nativeValue.item().size() > 0) ?
        Option.create_Some(TypeDescriptor.referenceWithInitializer(dafny.DafnyMap.class, () -> dafny.DafnyMap.<dafny.DafnySequence<? extends Character>,AttributeValue> empty()), ToDafny.AttributeMap(nativeValue.item()))
        : Option.create_None(TypeDescriptor.referenceWithInitializer(dafny.DafnyMap.class, () -> dafny.DafnyMap.<dafny.DafnySequence<? extends Character>,AttributeValue> empty()));
  ...
  public static BatchWriteItemInput BatchWriteItemInput(BatchWriteItemRequest nativeValue) {
    ...
    returnItemCollectionMetrics = Objects.nonNull(nativeValue.returnItemCollectionMetrics()) ?
        Option.create_Some(ReturnItemCollectionMetrics._typeDescriptor(), ToDafny.ReturnItemCollectionMetrics(nativeValue.returnItemCollectionMetrics()))
  ...
  public static BatchWriteItemOutput BatchWriteItemOutput(BatchWriteItemResponse nativeValue) {
    ...
    unprocessedItems = (Objects.nonNull(nativeValue.unprocessedItems()) && nativeValue.unprocessedItems().size() > 0) ?
        Option.create_Some(DafnyMap._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), DafnySequence._typeDescriptor(WriteRequest._typeDescriptor())), ToDafny.BatchWriteItemRequestMap(nativeValue.unprocessedItems()))
        : Option.create_None(DafnyMap._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), DafnySequence._typeDescriptor(WriteRequest._typeDescriptor())));
    ...
    itemCollectionMetrics = (Objects.nonNull(nativeValue.itemCollectionMetrics()) && nativeValue.itemCollectionMetrics().size() > 0) ?
        Option.create_Some(DafnyMap._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), DafnySequence._typeDescriptor(ItemCollectionMetrics._typeDescriptor())), ToDafny.ItemCollectionMetricsPerTable(nativeValue.itemCollectionMetrics()))
        : Option.create_None(DafnyMap._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), DafnySequence._typeDescriptor(ItemCollectionMetrics._typeDescriptor())));
    Option<DafnySequence<? extends ConsumedCapacity>> consumedCapacity;
    consumedCapacity = (Objects.nonNull(nativeValue.consumedCapacity()) && nativeValue.consumedCapacity().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(ConsumedCapacity._typeDescriptor()), ToDafny.ConsumedCapacityMultiple(nativeValue.consumedCapacity()))
        : Option.create_None(DafnySequence._typeDescriptor(ConsumedCapacity._typeDescriptor()));
  ...
  public static BillingModeSummary BillingModeSummary(
    ...
    billingMode = Objects.nonNull(nativeValue.billingMode()) ?
        Option.create_Some(BillingMode._typeDescriptor(), ToDafny.BillingMode(nativeValue.billingMode()))
    ...
    lastUpdateToPayPerRequestDateTime = Objects.nonNull(nativeValue.lastUpdateToPayPerRequestDateTime()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.lastUpdateToPayPerRequestDateTime()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
  ...
  public static CancellationReason CancellationReason(
    ...
    code = Objects.nonNull(nativeValue.code()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.code()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    Option<DafnySequence<? extends Character>> message;
    message = Objects.nonNull(nativeValue.message()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.message()))
  ...
  public static Capacity Capacity(
    ...
    readCapacityUnits = Objects.nonNull(nativeValue.readCapacityUnits()) ?
        Option.create_Some(ConsumedCapacityUnits._typeDescriptor(), software.amazon.smithy.dafny.conversion.ToDafny.Simple.Double(nativeValue.readCapacityUnits()))
    ...
    writeCapacityUnits = Objects.nonNull(nativeValue.writeCapacityUnits()) ?
        Option.create_Some(ConsumedCapacityUnits._typeDescriptor(), software.amazon.smithy.dafny.conversion.ToDafny.Simple.Double(nativeValue.writeCapacityUnits()))
        : Option.create_None(ConsumedCapacityUnits._typeDescriptor());
    Option<DafnySequence<? extends Byte>> capacityUnits;
    capacityUnits = Objects.nonNull(nativeValue.capacityUnits()) ?
        Option.create_Some(ConsumedCapacityUnits._typeDescriptor(), software.amazon.smithy.dafny.conversion.ToDafny.Simple.Double(nativeValue.capacityUnits()))
        : Option.create_None(ConsumedCapacityUnits._typeDescriptor());
  ...
  public static Condition Condition(
    ...
    attributeValueList = (Objects.nonNull(nativeValue.attributeValueList()) && nativeValue.attributeValueList().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(AttributeValue._typeDescriptor()), ToDafny.AttributeValueList(nativeValue.attributeValueList()))
        : Option.create_None(DafnySequence._typeDescriptor(AttributeValue._typeDescriptor()));
  ...
  public static ConditionCheck ConditionCheck(
    ...
    expressionAttributeNames = (Objects.nonNull(nativeValue.expressionAttributeNames()) && nativeValue.expressionAttributeNames().size() > 0) ?
        Option.create_Some(DafnyMap._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), DafnySequence._typeDescriptor(TypeDescriptor.CHAR)), ToDafny.ExpressionAttributeNameMap(nativeValue.expressionAttributeNames()))
        : Option.create_None(DafnyMap._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), DafnySequence._typeDescriptor(TypeDescriptor.CHAR)));
    ...
    expressionAttributeValues = (Objects.nonNull(nativeValue.expressionAttributeValues()) && nativeValue.expressionAttributeValues().size() > 0) ?
        Option.create_Some(DafnyMap._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), AttributeValue._typeDescriptor()), ToDafny.ExpressionAttributeValueMap(nativeValue.expressionAttributeValues()))
        : Option.create_None(DafnyMap._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), AttributeValue._typeDescriptor()));
    ...
    returnValuesOnConditionCheckFailure = Objects.nonNull(nativeValue.returnValuesOnConditionCheckFailure()) ?
        Option.create_Some(ReturnValuesOnConditionCheckFailure._typeDescriptor(), ToDafny.ReturnValuesOnConditionCheckFailure(nativeValue.returnValuesOnConditionCheckFailure()))
        : Option.create_None(ReturnValuesOnConditionCheckFailure._typeDescriptor());
  ...
  public static ConsumedCapacity ConsumedCapacity(
    ...
    table = Objects.nonNull(nativeValue.table()) ?
        Option.create_Some(Capacity._typeDescriptor(), ToDafny.Capacity(nativeValue.table()))
    ...
    localSecondaryIndexes = (Objects.nonNull(nativeValue.localSecondaryIndexes()) && nativeValue.localSecondaryIndexes().size() > 0) ?
        Option.create_Some(DafnyMap._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), Capacity._typeDescriptor()), ToDafny.SecondaryIndexesCapacityMap(nativeValue.localSecondaryIndexes()))
        : Option.create_None(DafnyMap._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), Capacity._typeDescriptor()));
    ...
    globalSecondaryIndexes = (Objects.nonNull(nativeValue.globalSecondaryIndexes()) && nativeValue.globalSecondaryIndexes().size() > 0) ?
        Option.create_Some(DafnyMap._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), Capacity._typeDescriptor()), ToDafny.SecondaryIndexesCapacityMap(nativeValue.globalSecondaryIndexes()))
        : Option.create_None(DafnyMap._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), Capacity._typeDescriptor()));
  ...
  public static ContinuousBackupsDescription ContinuousBackupsDescription(
    ...
    pointInTimeRecoveryDescription = Objects.nonNull(nativeValue.pointInTimeRecoveryDescription()) ?
        Option.create_Some(PointInTimeRecoveryDescription._typeDescriptor(), ToDafny.PointInTimeRecoveryDescription(nativeValue.pointInTimeRecoveryDescription()))
  ...
  public static ContributorInsightsSummary ContributorInsightsSummary(
    ...
    indexName = Objects.nonNull(nativeValue.indexName()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.indexName()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    ...
    contributorInsightsStatus = Objects.nonNull(nativeValue.contributorInsightsStatus()) ?
        Option.create_Some(ContributorInsightsStatus._typeDescriptor(), ToDafny.ContributorInsightsStatus(nativeValue.contributorInsightsStatus()))
  ...
  public static CreateGlobalSecondaryIndexAction CreateGlobalSecondaryIndexAction(
    ...
    provisionedThroughput = Objects.nonNull(nativeValue.provisionedThroughput()) ?
        Option.create_Some(ProvisionedThroughput._typeDescriptor(), ToDafny.ProvisionedThroughput(nativeValue.provisionedThroughput()))
  ...
  public static CreateGlobalTableOutput CreateGlobalTableOutput(
    ...
    globalTableDescription = Objects.nonNull(nativeValue.globalTableDescription()) ?
        Option.create_Some(GlobalTableDescription._typeDescriptor(), ToDafny.GlobalTableDescription(nativeValue.globalTableDescription()))
  ...
  public static CreateReplicationGroupMemberAction CreateReplicationGroupMemberAction(
    ...
    kMSMasterKeyId = Objects.nonNull(nativeValue.kmsMasterKeyId()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.kmsMasterKeyId()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    ...
    provisionedThroughputOverride = Objects.nonNull(nativeValue.provisionedThroughputOverride()) ?
        Option.create_Some(ProvisionedThroughputOverride._typeDescriptor(), ToDafny.ProvisionedThroughputOverride(nativeValue.provisionedThroughputOverride()))
    ...
    globalSecondaryIndexes = (Objects.nonNull(nativeValue.globalSecondaryIndexes()) && nativeValue.globalSecondaryIndexes().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(ReplicaGlobalSecondaryIndex._typeDescriptor()), ToDafny.ReplicaGlobalSecondaryIndexList(nativeValue.globalSecondaryIndexes()))
        : Option.create_None(DafnySequence._typeDescriptor(ReplicaGlobalSecondaryIndex._typeDescriptor()));
  ...
  public static CreateTableInput CreateTableInput(CreateTableRequest nativeValue) {
    ...
    localSecondaryIndexes = (Objects.nonNull(nativeValue.localSecondaryIndexes()) && nativeValue.localSecondaryIndexes().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(LocalSecondaryIndex._typeDescriptor()), ToDafny.LocalSecondaryIndexList(nativeValue.localSecondaryIndexes()))
        : Option.create_None(DafnySequence._typeDescriptor(LocalSecondaryIndex._typeDescriptor()));
    Option<DafnySequence<? extends GlobalSecondaryIndex>> globalSecondaryIndexes;
    globalSecondaryIndexes = (Objects.nonNull(nativeValue.globalSecondaryIndexes()) && nativeValue.globalSecondaryIndexes().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(GlobalSecondaryIndex._typeDescriptor()), ToDafny.GlobalSecondaryIndexList(nativeValue.globalSecondaryIndexes()))
        : Option.create_None(DafnySequence._typeDescriptor(GlobalSecondaryIndex._typeDescriptor()));
    Option<BillingMode> billingMode;
    billingMode = Objects.nonNull(nativeValue.billingMode()) ?
        Option.create_Some(BillingMode._typeDescriptor(), ToDafny.BillingMode(nativeValue.billingMode()))
        : Option.create_None(BillingMode._typeDescriptor());
    ...
    tags = (Objects.nonNull(nativeValue.tags()) && nativeValue.tags().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(Tag._typeDescriptor()), ToDafny.TagList(nativeValue.tags()))
        : Option.create_None(DafnySequence._typeDescriptor(Tag._typeDescriptor()));
    Option<TableClass> tableClass;
    tableClass = Objects.nonNull(nativeValue.tableClass()) ?
        Option.create_Some(TableClass._typeDescriptor(), ToDafny.TableClass(nativeValue.tableClass()))
        : Option.create_None(TableClass._typeDescriptor());
  ...
  public static CreateTableOutput CreateTableOutput(CreateTableResponse nativeValue) {
    ...
    tableDescription = Objects.nonNull(nativeValue.tableDescription()) ?
        Option.create_Some(TableDescription._typeDescriptor(), ToDafny.TableDescription(nativeValue.tableDescription()))
  ...
  public static CsvOptions CsvOptions(
    ...
    delimiter = Objects.nonNull(nativeValue.delimiter()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.delimiter()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    ...
    headerList = (Objects.nonNull(nativeValue.headerList()) && nativeValue.headerList().size() > 0) ?
        ...
        : Option.create_None(DafnySequence._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR)));
  ...
  public static Delete Delete(software.amazon.awssdk.services.dynamodb.model.Delete nativeValue) {
    ...
    conditionExpression = Objects.nonNull(nativeValue.conditionExpression()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.conditionExpression()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    Option<DafnyMap<? extends DafnySequence<? extends Character>, ? extends DafnySequence<? extends Character>>> expressionAttributeNames;
    expressionAttributeNames = (Objects.nonNull(nativeValue.expressionAttributeNames()) && nativeValue.expressionAttributeNames().size() > 0) ?
        Option.create_Some(DafnyMap._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), DafnySequence._typeDescriptor(TypeDescriptor.CHAR)), ToDafny.ExpressionAttributeNameMap(nativeValue.expressionAttributeNames()))
  ...
  public static DeleteBackupOutput DeleteBackupOutput(DeleteBackupResponse nativeValue) {
    ...
    backupDescription = Objects.nonNull(nativeValue.backupDescription()) ?
        Option.create_Some(BackupDescription._typeDescriptor(), ToDafny.BackupDescription(nativeValue.backupDescription()))
  ...
  public static DeleteItemInput DeleteItemInput(DeleteItemRequest nativeValue) {
    ...
    expected = (Objects.nonNull(nativeValue.expected()) && nativeValue.expected().size() > 0) ?
        Option.create_Some(DafnyMap._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), ExpectedAttributeValue._typeDescriptor()), ToDafny.ExpectedAttributeMap(nativeValue.expected()))
        : Option.create_None(DafnyMap._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), ExpectedAttributeValue._typeDescriptor()));
    Option<ConditionalOperator> conditionalOperator;
    conditionalOperator = Objects.nonNull(nativeValue.conditionalOperator()) ?
        Option.create_Some(ConditionalOperator._typeDescriptor(), ToDafny.ConditionalOperator(nativeValue.conditionalOperator()))
    ...
    returnValues = Objects.nonNull(nativeValue.returnValues()) ?
        Option.create_Some(ReturnValue._typeDescriptor(), ToDafny.ReturnValue(nativeValue.returnValues()))
  ...
  public static DeleteItemOutput DeleteItemOutput(DeleteItemResponse nativeValue) {
    ...
    attributes = (Objects.nonNull(nativeValue.attributes()) && nativeValue.attributes().size() > 0) ?
        Option.create_Some(TypeDescriptor.referenceWithInitializer(dafny.DafnyMap.class, () -> dafny.DafnyMap.<dafny.DafnySequence<? extends Character>,AttributeValue> empty()), ToDafny.AttributeMap(nativeValue.attributes()))
        : Option.create_None(TypeDescriptor.referenceWithInitializer(dafny.DafnyMap.class, () -> dafny.DafnyMap.<dafny.DafnySequence<? extends Character>,AttributeValue> empty()));
    Option<ConsumedCapacity> consumedCapacity;
    consumedCapacity = Objects.nonNull(nativeValue.consumedCapacity()) ?
        Option.create_Some(ConsumedCapacity._typeDescriptor(), ToDafny.ConsumedCapacity(nativeValue.consumedCapacity()))
    ...
    itemCollectionMetrics = Objects.nonNull(nativeValue.itemCollectionMetrics()) ?
        Option.create_Some(ItemCollectionMetrics._typeDescriptor(), ToDafny.ItemCollectionMetrics(nativeValue.itemCollectionMetrics()))
  ...
  public static DescribeContinuousBackupsOutput DescribeContinuousBackupsOutput(
    ...
    continuousBackupsDescription = Objects.nonNull(nativeValue.continuousBackupsDescription()) ?
        Option.create_Some(ContinuousBackupsDescription._typeDescriptor(), ToDafny.ContinuousBackupsDescription(nativeValue.continuousBackupsDescription()))
  ...
  public static DescribeContributorInsightsOutput DescribeContributorInsightsOutput(
    ...
    contributorInsightsRuleList = (Objects.nonNull(nativeValue.contributorInsightsRuleList()) && nativeValue.contributorInsightsRuleList().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR)), ToDafny.ContributorInsightsRuleList(nativeValue.contributorInsightsRuleList()))
        : Option.create_None(DafnySequence._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR)));
    Option<ContributorInsightsStatus> contributorInsightsStatus;
    contributorInsightsStatus = Objects.nonNull(nativeValue.contributorInsightsStatus()) ?
        Option.create_Some(ContributorInsightsStatus._typeDescriptor(), ToDafny.ContributorInsightsStatus(nativeValue.contributorInsightsStatus()))
    ...
    lastUpdateDateTime = Objects.nonNull(nativeValue.lastUpdateDateTime()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.lastUpdateDateTime()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    Option<FailureException> failureException;
    failureException = Objects.nonNull(nativeValue.failureException()) ?
        Option.create_Some(FailureException._typeDescriptor(), ToDafny.FailureException(nativeValue.failureException()))
  ...
  public static DescribeExportOutput DescribeExportOutput(DescribeExportResponse nativeValue) {
    ...
    exportDescription = Objects.nonNull(nativeValue.exportDescription()) ?
        Option.create_Some(ExportDescription._typeDescriptor(), ToDafny.ExportDescription(nativeValue.exportDescription()))
  ...
  public static DescribeGlobalTableSettingsOutput DescribeGlobalTableSettingsOutput(
    ...
    globalTableName = Objects.nonNull(nativeValue.globalTableName()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.globalTableName()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    ...
    replicaSettings = (Objects.nonNull(nativeValue.replicaSettings()) && nativeValue.replicaSettings().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(ReplicaSettingsDescription._typeDescriptor()), ToDafny.ReplicaSettingsDescriptionList(nativeValue.replicaSettings()))
        : Option.create_None(DafnySequence._typeDescriptor(ReplicaSettingsDescription._typeDescriptor()));
  ...
  public static DescribeKinesisStreamingDestinationOutput DescribeKinesisStreamingDestinationOutput(
    ...
    kinesisDataStreamDestinations = (Objects.nonNull(nativeValue.kinesisDataStreamDestinations()) && nativeValue.kinesisDataStreamDestinations().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(KinesisDataStreamDestination._typeDescriptor()), ToDafny.KinesisDataStreamDestinations(nativeValue.kinesisDataStreamDestinations()))
        : Option.create_None(DafnySequence._typeDescriptor(KinesisDataStreamDestination._typeDescriptor()));
  ...
  public static DescribeLimitsOutput DescribeLimitsOutput(DescribeLimitsResponse nativeValue) {
    ...
    accountMaxReadCapacityUnits = Objects.nonNull(nativeValue.accountMaxReadCapacityUnits()) ?
        Option.create_Some(TypeDescriptor.LONG, (nativeValue.accountMaxReadCapacityUnits()))
        : Option.create_None(TypeDescriptor.LONG);
  ...
  public static DescribeTableOutput DescribeTableOutput(DescribeTableResponse nativeValue) {
    ...
    table = Objects.nonNull(nativeValue.table()) ?
        Option.create_Some(TableDescription._typeDescriptor(), ToDafny.TableDescription(nativeValue.table()))
        : Option.create_None(TableDescription._typeDescriptor());
  ...
  public static DescribeTableReplicaAutoScalingOutput DescribeTableReplicaAutoScalingOutput(
    ...
    tableAutoScalingDescription = Objects.nonNull(nativeValue.tableAutoScalingDescription()) ?
        Option.create_Some(TableAutoScalingDescription._typeDescriptor(), ToDafny.TableAutoScalingDescription(nativeValue.tableAutoScalingDescription()))
  ...
  public static DisableKinesisStreamingDestinationOutput DisableKinesisStreamingDestinationOutput(
    ...
    streamArn = Objects.nonNull(nativeValue.streamArn()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.streamArn()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    Option<DestinationStatus> destinationStatus;
    destinationStatus = Objects.nonNull(nativeValue.destinationStatus()) ?
        Option.create_Some(DestinationStatus._typeDescriptor(), ToDafny.DestinationStatus(nativeValue.destinationStatus()))
  ...
  public static ExecuteStatementInput ExecuteStatementInput(ExecuteStatementRequest nativeValue) {
    ...
    nextToken = Objects.nonNull(nativeValue.nextToken()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.nextToken()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    Option<ReturnConsumedCapacity> returnConsumedCapacity;
    returnConsumedCapacity = Objects.nonNull(nativeValue.returnConsumedCapacity()) ?
        Option.create_Some(ReturnConsumedCapacity._typeDescriptor(), ToDafny.ReturnConsumedCapacity(nativeValue.returnConsumedCapacity()))
  ...
  public static ExecuteStatementOutput ExecuteStatementOutput(
    ...
    items = (Objects.nonNull(nativeValue.items()) && nativeValue.items().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.referenceWithInitializer(dafny.DafnyMap.class, () -> dafny.DafnyMap.<dafny.DafnySequence<? extends Character>,AttributeValue> empty())), ToDafny.ItemList(nativeValue.items()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.referenceWithInitializer(dafny.DafnyMap.class, () -> dafny.DafnyMap.<dafny.DafnySequence<? extends Character>,AttributeValue> empty())));
    Option<DafnySequence<? extends Character>> nextToken;
    nextToken = Objects.nonNull(nativeValue.nextToken()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.nextToken()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    ...
    lastEvaluatedKey = (Objects.nonNull(nativeValue.lastEvaluatedKey()) && nativeValue.lastEvaluatedKey().size() > 0) ?
        Option.create_Some(TypeDescriptor.referenceWithInitializer(dafny.DafnyMap.class, () -> dafny.DafnyMap.<dafny.DafnySequence<? extends Character>,AttributeValue> empty()), ToDafny.Key(nativeValue.lastEvaluatedKey()))
        : Option.create_None(TypeDescriptor.referenceWithInitializer(dafny.DafnyMap.class, () -> dafny.DafnyMap.<dafny.DafnySequence<? extends Character>,AttributeValue> empty()));
  ...
  public static ExecuteTransactionInput ExecuteTransactionInput(
    ...
    clientRequestToken = Objects.nonNull(nativeValue.clientRequestToken()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.clientRequestToken()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    Option<ReturnConsumedCapacity> returnConsumedCapacity;
    returnConsumedCapacity = Objects.nonNull(nativeValue.returnConsumedCapacity()) ?
        Option.create_Some(ReturnConsumedCapacity._typeDescriptor(), ToDafny.ReturnConsumedCapacity(nativeValue.returnConsumedCapacity()))
  ...
  public static ExecuteTransactionOutput ExecuteTransactionOutput(
    ...
    responses = (Objects.nonNull(nativeValue.responses()) && nativeValue.responses().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(ItemResponse._typeDescriptor()), ToDafny.ItemResponseList(nativeValue.responses()))
        : Option.create_None(DafnySequence._typeDescriptor(ItemResponse._typeDescriptor()));
    Option<DafnySequence<? extends ConsumedCapacity>> consumedCapacity;
    consumedCapacity = (Objects.nonNull(nativeValue.consumedCapacity()) && nativeValue.consumedCapacity().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(ConsumedCapacity._typeDescriptor()), ToDafny.ConsumedCapacityMultiple(nativeValue.consumedCapacity()))
        : Option.create_None(DafnySequence._typeDescriptor(ConsumedCapacity._typeDescriptor()));
  ...
  public static ExpectedAttributeValue ExpectedAttributeValue(
    ...
    comparisonOperator = Objects.nonNull(nativeValue.comparisonOperator()) ?
        Option.create_Some(ComparisonOperator._typeDescriptor(), ToDafny.ComparisonOperator(nativeValue.comparisonOperator()))
  ...
  public static ExportDescription ExportDescription(
    ...
    exportArn = Objects.nonNull(nativeValue.exportArn()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.exportArn()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    Option<ExportStatus> exportStatus;
    exportStatus = Objects.nonNull(nativeValue.exportStatus()) ?
        Option.create_Some(ExportStatus._typeDescriptor(), ToDafny.ExportStatus(nativeValue.exportStatus()))
    ...
    startTime = Objects.nonNull(nativeValue.startTime()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.startTime()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    Option<DafnySequence<? extends Character>> endTime;
    endTime = Objects.nonNull(nativeValue.endTime()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.endTime()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    Option<DafnySequence<? extends Character>> exportManifest;
    exportManifest = Objects.nonNull(nativeValue.exportManifest()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.exportManifest()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    Option<DafnySequence<? extends Character>> tableArn;
    tableArn = Objects.nonNull(nativeValue.tableArn()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.tableArn()))
    ...
    exportTime = Objects.nonNull(nativeValue.exportTime()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.exportTime()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    Option<DafnySequence<? extends Character>> clientToken;
    clientToken = Objects.nonNull(nativeValue.clientToken()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.clientToken()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    Option<DafnySequence<? extends Character>> s3Bucket;
    s3Bucket = Objects.nonNull(nativeValue.s3Bucket()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.s3Bucket()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    Option<DafnySequence<? extends Character>> s3BucketOwner;
    s3BucketOwner = Objects.nonNull(nativeValue.s3BucketOwner()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.s3BucketOwner()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    Option<DafnySequence<? extends Character>> s3Prefix;
    s3Prefix = Objects.nonNull(nativeValue.s3Prefix()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.s3Prefix()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    Option<S3SseAlgorithm> s3SseAlgorithm;
    s3SseAlgorithm = Objects.nonNull(nativeValue.s3SseAlgorithm()) ?
        Option.create_Some(S3SseAlgorithm._typeDescriptor(), ToDafny.S3SseAlgorithm(nativeValue.s3SseAlgorithm()))
    ...
    s3SseKmsKeyId = Objects.nonNull(nativeValue.s3SseKmsKeyId()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.s3SseKmsKeyId()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    Option<DafnySequence<? extends Character>> failureCode;
    failureCode = Objects.nonNull(nativeValue.failureCode()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.failureCode()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    Option<DafnySequence<? extends Character>> failureMessage;
    failureMessage = Objects.nonNull(nativeValue.failureMessage()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.failureMessage()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    ...
    billedSizeBytes = Objects.nonNull(nativeValue.billedSizeBytes()) ?
        Option.create_Some(TypeDescriptor.LONG, (nativeValue.billedSizeBytes()))
        : Option.create_None(TypeDescriptor.LONG);
  ...
  public static FailureException FailureException(
    ...
    exceptionName = Objects.nonNull(nativeValue.exceptionName()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.exceptionName()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    ...
    exceptionDescription = Objects.nonNull(nativeValue.exceptionDescription()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.exceptionDescription()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
  ...
  public static Get Get(software.amazon.awssdk.services.dynamodb.model.Get nativeValue) {
    ...
    projectionExpression = Objects.nonNull(nativeValue.projectionExpression()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.projectionExpression()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    Option<DafnyMap<? extends DafnySequence<? extends Character>, ? extends DafnySequence<? extends Character>>> expressionAttributeNames;
    expressionAttributeNames = (Objects.nonNull(nativeValue.expressionAttributeNames()) && nativeValue.expressionAttributeNames().size() > 0) ?
        Option.create_Some(DafnyMap._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), DafnySequence._typeDescriptor(TypeDescriptor.CHAR)), ToDafny.ExpressionAttributeNameMap(nativeValue.expressionAttributeNames()))
  ...
  public static GetItemInput GetItemInput(GetItemRequest nativeValue) {
    ...
    attributesToGet = (Objects.nonNull(nativeValue.attributesToGet()) && nativeValue.attributesToGet().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR)), ToDafny.AttributeNameList(nativeValue.attributesToGet()))
        : Option.create_None(DafnySequence._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR)));
    Option<Boolean> consistentRead;
    consistentRead = Objects.nonNull(nativeValue.consistentRead()) ?
        Option.create_Some(TypeDescriptor.BOOLEAN, (nativeValue.consistentRead()))
  ...
  public static GlobalSecondaryIndexAutoScalingUpdate GlobalSecondaryIndexAutoScalingUpdate(
    ...
    provisionedWriteCapacityAutoScalingUpdate = Objects.nonNull(nativeValue.provisionedWriteCapacityAutoScalingUpdate()) ?
        Option.create_Some(AutoScalingSettingsUpdate._typeDescriptor(), ToDafny.AutoScalingSettingsUpdate(nativeValue.provisionedWriteCapacityAutoScalingUpdate()))
  ...
  public static GlobalSecondaryIndexDescription GlobalSecondaryIndexDescription(
    ...
    keySchema = (Objects.nonNull(nativeValue.keySchema()) && nativeValue.keySchema().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(KeySchemaElement._typeDescriptor()), ToDafny.KeySchema(nativeValue.keySchema()))
        : Option.create_None(DafnySequence._typeDescriptor(KeySchemaElement._typeDescriptor()));
    Option<Projection> projection;
    projection = Objects.nonNull(nativeValue.projection()) ?
        Option.create_Some(Projection._typeDescriptor(), ToDafny.Projection(nativeValue.projection()))
    ...
    indexStatus = Objects.nonNull(nativeValue.indexStatus()) ?
        Option.create_Some(IndexStatus._typeDescriptor(), ToDafny.IndexStatus(nativeValue.indexStatus()))
    ...
    backfilling = Objects.nonNull(nativeValue.backfilling()) ?
        Option.create_Some(TypeDescriptor.BOOLEAN, (nativeValue.backfilling()))
        : Option.create_None(TypeDescriptor.BOOLEAN);
    Option<ProvisionedThroughputDescription> provisionedThroughput;
    provisionedThroughput = Objects.nonNull(nativeValue.provisionedThroughput()) ?
        Option.create_Some(ProvisionedThroughputDescription._typeDescriptor(), ToDafny.ProvisionedThroughputDescription(nativeValue.provisionedThroughput()))
        : Option.create_None(ProvisionedThroughputDescription._typeDescriptor());
    Option<Long> indexSizeBytes;
    indexSizeBytes = Objects.nonNull(nativeValue.indexSizeBytes()) ?
        Option.create_Some(TypeDescriptor.LONG, (nativeValue.indexSizeBytes()))
        : Option.create_None(TypeDescriptor.LONG);
    Option<Long> itemCount;
    itemCount = Objects.nonNull(nativeValue.itemCount()) ?
        Option.create_Some(TypeDescriptor.LONG, (nativeValue.itemCount()))
    ...
    indexArn = Objects.nonNull(nativeValue.indexArn()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.indexArn()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
  ...
  public static GlobalSecondaryIndexUpdate GlobalSecondaryIndexUpdate(
    ...
    update = Objects.nonNull(nativeValue.update()) ?
        Option.create_Some(UpdateGlobalSecondaryIndexAction._typeDescriptor(), ToDafny.UpdateGlobalSecondaryIndexAction(nativeValue.update()))
        : Option.create_None(UpdateGlobalSecondaryIndexAction._typeDescriptor());
    Option<CreateGlobalSecondaryIndexAction> create;
    create = Objects.nonNull(nativeValue.create()) ?
        Option.create_Some(CreateGlobalSecondaryIndexAction._typeDescriptor(), ToDafny.CreateGlobalSecondaryIndexAction(nativeValue.create()))
        : Option.create_None(CreateGlobalSecondaryIndexAction._typeDescriptor());
    Option<DeleteGlobalSecondaryIndexAction> delete;
    delete = Objects.nonNull(nativeValue.delete()) ?
        Option.create_Some(DeleteGlobalSecondaryIndexAction._typeDescriptor(), ToDafny.DeleteGlobalSecondaryIndexAction(nativeValue.delete()))
        : Option.create_None(DeleteGlobalSecondaryIndexAction._typeDescriptor());
  ...
  public static GlobalTable GlobalTable(
    ...
    replicationGroup = (Objects.nonNull(nativeValue.replicationGroup()) && nativeValue.replicationGroup().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(Replica._typeDescriptor()), ToDafny.ReplicaList(nativeValue.replicationGroup()))
        : Option.create_None(DafnySequence._typeDescriptor(Replica._typeDescriptor()));
  ...
  public static GlobalTableDescription GlobalTableDescription(
    ...
    replicationGroup = (Objects.nonNull(nativeValue.replicationGroup()) && nativeValue.replicationGroup().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(ReplicaDescription._typeDescriptor()), ToDafny.ReplicaDescriptionList(nativeValue.replicationGroup()))
        : Option.create_None(DafnySequence._typeDescriptor(ReplicaDescription._typeDescriptor()));
    Option<DafnySequence<? extends Character>> globalTableArn;
    globalTableArn = Objects.nonNull(nativeValue.globalTableArn()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.globalTableArn()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    Option<DafnySequence<? extends Character>> creationDateTime;
    creationDateTime = Objects.nonNull(nativeValue.creationDateTime()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.creationDateTime()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    Option<GlobalTableStatus> globalTableStatus;
    globalTableStatus = Objects.nonNull(nativeValue.globalTableStatus()) ?
        Option.create_Some(GlobalTableStatus._typeDescriptor(), ToDafny.GlobalTableStatus(nativeValue.globalTableStatus()))
  ...
  public static GlobalTableGlobalSecondaryIndexSettingsUpdate GlobalTableGlobalSecondaryIndexSettingsUpdate(
    ...
    provisionedWriteCapacityAutoScalingSettingsUpdate = Objects.nonNull(nativeValue.provisionedWriteCapacityAutoScalingSettingsUpdate()) ?
        Option.create_Some(AutoScalingSettingsUpdate._typeDescriptor(), ToDafny.AutoScalingSettingsUpdate(nativeValue.provisionedWriteCapacityAutoScalingSettingsUpdate()))
        : Option.create_None(AutoScalingSettingsUpdate._typeDescriptor());
  ...
  public static ImportSummary ImportSummary(
    ...
    importArn = Objects.nonNull(nativeValue.importArn()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.importArn()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    Option<ImportStatus> importStatus;
    importStatus = Objects.nonNull(nativeValue.importStatus()) ?
        Option.create_Some(ImportStatus._typeDescriptor(), ToDafny.ImportStatus(nativeValue.importStatus()))
    ...
    s3BucketSource = Objects.nonNull(nativeValue.s3BucketSource()) ?
        Option.create_Some(S3BucketSource._typeDescriptor(), ToDafny.S3BucketSource(nativeValue.s3BucketSource()))
    ...
    cloudWatchLogGroupArn = Objects.nonNull(nativeValue.cloudWatchLogGroupArn()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.cloudWatchLogGroupArn()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    Option<InputFormat> inputFormat;
    inputFormat = Objects.nonNull(nativeValue.inputFormat()) ?
        Option.create_Some(InputFormat._typeDescriptor(), ToDafny.InputFormat(nativeValue.inputFormat()))
  ...
  public static ImportTableDescription ImportTableDescription(
    ...
    inputFormatOptions = Objects.nonNull(nativeValue.inputFormatOptions()) ?
        Option.create_Some(InputFormatOptions._typeDescriptor(), ToDafny.InputFormatOptions(nativeValue.inputFormatOptions()))
    ...
    inputCompressionType = Objects.nonNull(nativeValue.inputCompressionType()) ?
        Option.create_Some(InputCompressionType._typeDescriptor(), ToDafny.InputCompressionType(nativeValue.inputCompressionType()))
    ...
    processedSizeBytes = Objects.nonNull(nativeValue.processedSizeBytes()) ?
        Option.create_Some(TypeDescriptor.LONG, (nativeValue.processedSizeBytes()))
        : Option.create_None(TypeDescriptor.LONG);
    Option<Long> processedItemCount;
    processedItemCount = Objects.nonNull(nativeValue.processedItemCount()) ?
        Option.create_Some(TypeDescriptor.LONG, (nativeValue.processedItemCount()))
        : Option.create_None(TypeDescriptor.LONG);
    Option<Long> importedItemCount;
    importedItemCount = Objects.nonNull(nativeValue.importedItemCount()) ?
        Option.create_Some(TypeDescriptor.LONG, (nativeValue.importedItemCount()))
        : Option.create_None(TypeDescriptor.LONG);
    Option<DafnySequence<? extends Character>> failureCode;
    failureCode = Objects.nonNull(nativeValue.failureCode()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.failureCode()))
  ...
  public static InputFormatOptions InputFormatOptions(
    ...
    csv = Objects.nonNull(nativeValue.csv()) ?
        Option.create_Some(CsvOptions._typeDescriptor(), ToDafny.CsvOptions(nativeValue.csv()))
  ...
  public static ItemCollectionMetrics ItemCollectionMetrics(
    ...
    itemCollectionKey = (Objects.nonNull(nativeValue.itemCollectionKey()) && nativeValue.itemCollectionKey().size() > 0) ?
        Option.create_Some(DafnyMap._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), AttributeValue._typeDescriptor()), ToDafny.ItemCollectionKeyAttributeMap(nativeValue.itemCollectionKey()))
        : Option.create_None(DafnyMap._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), AttributeValue._typeDescriptor()));
    ...
    sizeEstimateRangeGB = (Objects.nonNull(nativeValue.sizeEstimateRangeGB()) && nativeValue.sizeEstimateRangeGB().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(ItemCollectionSizeEstimateBound._typeDescriptor()), ToDafny.ItemCollectionSizeEstimateRange(nativeValue.sizeEstimateRangeGB()))
        : Option.create_None(DafnySequence._typeDescriptor(ItemCollectionSizeEstimateBound._typeDescriptor()));
  ...
  public static KinesisDataStreamDestination KinesisDataStreamDestination(
    ...
    destinationStatusDescription = Objects.nonNull(nativeValue.destinationStatusDescription()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.destinationStatusDescription()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
  ...
  public static ListBackupsInput ListBackupsInput(ListBackupsRequest nativeValue) {
    ...
    timeRangeLowerBound = Objects.nonNull(nativeValue.timeRangeLowerBound()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.timeRangeLowerBound()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    ...
    timeRangeUpperBound = Objects.nonNull(nativeValue.timeRangeUpperBound()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.timeRangeUpperBound()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    ...
    exclusiveStartBackupArn = Objects.nonNull(nativeValue.exclusiveStartBackupArn()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.exclusiveStartBackupArn()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    Option<BackupTypeFilter> backupType;
    backupType = Objects.nonNull(nativeValue.backupType()) ?
        Option.create_Some(BackupTypeFilter._typeDescriptor(), ToDafny.BackupTypeFilter(nativeValue.backupType()))
  ...
  public static ListBackupsOutput ListBackupsOutput(ListBackupsResponse nativeValue) {
    ...
    backupSummaries = (Objects.nonNull(nativeValue.backupSummaries()) && nativeValue.backupSummaries().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(BackupSummary._typeDescriptor()), ToDafny.BackupSummaries(nativeValue.backupSummaries()))
        : Option.create_None(DafnySequence._typeDescriptor(BackupSummary._typeDescriptor()));
    ...
    lastEvaluatedBackupArn = Objects.nonNull(nativeValue.lastEvaluatedBackupArn()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.lastEvaluatedBackupArn()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
  ...
  public static ListContributorInsightsOutput ListContributorInsightsOutput(
    ...
    contributorInsightsSummaries = (Objects.nonNull(nativeValue.contributorInsightsSummaries()) && nativeValue.contributorInsightsSummaries().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(ContributorInsightsSummary._typeDescriptor()), ToDafny.ContributorInsightsSummaries(nativeValue.contributorInsightsSummaries()))
        : Option.create_None(DafnySequence._typeDescriptor(ContributorInsightsSummary._typeDescriptor()));
    Option<DafnySequence<? extends Character>> nextToken;
    nextToken = Objects.nonNull(nativeValue.nextToken()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.nextToken()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
  ...
  public static ListExportsOutput ListExportsOutput(ListExportsResponse nativeValue) {
    ...
    exportSummaries = (Objects.nonNull(nativeValue.exportSummaries()) && nativeValue.exportSummaries().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(ExportSummary._typeDescriptor()), ToDafny.ExportSummaries(nativeValue.exportSummaries()))
        : Option.create_None(DafnySequence._typeDescriptor(ExportSummary._typeDescriptor()));
    Option<DafnySequence<? extends Character>> nextToken;
    nextToken = Objects.nonNull(nativeValue.nextToken()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.nextToken()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
  ...
  public static ListGlobalTablesInput ListGlobalTablesInput(ListGlobalTablesRequest nativeValue) {
    ...
    exclusiveStartGlobalTableName = Objects.nonNull(nativeValue.exclusiveStartGlobalTableName()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.exclusiveStartGlobalTableName()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    Option<Integer> limit;
    limit = Objects.nonNull(nativeValue.limit()) ?
        Option.create_Some(TypeDescriptor.INT, (nativeValue.limit()))
    ...
    regionName = Objects.nonNull(nativeValue.regionName()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.regionName()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
  ...
  public static ListGlobalTablesOutput ListGlobalTablesOutput(
    ...
    globalTables = (Objects.nonNull(nativeValue.globalTables()) && nativeValue.globalTables().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(GlobalTable._typeDescriptor()), ToDafny.GlobalTableList(nativeValue.globalTables()))
        : Option.create_None(DafnySequence._typeDescriptor(GlobalTable._typeDescriptor()));
    ...
    lastEvaluatedGlobalTableName = Objects.nonNull(nativeValue.lastEvaluatedGlobalTableName()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.lastEvaluatedGlobalTableName()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
  ...
  public static ListImportsOutput ListImportsOutput(ListImportsResponse nativeValue) {
    ...
    importSummaryList = (Objects.nonNull(nativeValue.importSummaryList()) && nativeValue.importSummaryList().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(ImportSummary._typeDescriptor()), ToDafny.ImportSummaryList(nativeValue.importSummaryList()))
        : Option.create_None(DafnySequence._typeDescriptor(ImportSummary._typeDescriptor()));
    Option<DafnySequence<? extends Character>> nextToken;
    nextToken = Objects.nonNull(nativeValue.nextToken()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.nextToken()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
  ...
  public static ListTablesInput ListTablesInput(ListTablesRequest nativeValue) {
    ...
    exclusiveStartTableName = Objects.nonNull(nativeValue.exclusiveStartTableName()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.exclusiveStartTableName()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    Option<Integer> limit;
    limit = Objects.nonNull(nativeValue.limit()) ?
        Option.create_Some(TypeDescriptor.INT, (nativeValue.limit()))
  ...
  public static ListTablesOutput ListTablesOutput(ListTablesResponse nativeValue) {
    ...
    tableNames = (Objects.nonNull(nativeValue.tableNames()) && nativeValue.tableNames().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR)), ToDafny.TableNameList(nativeValue.tableNames()))
        : Option.create_None(DafnySequence._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR)));
    ...
    lastEvaluatedTableName = Objects.nonNull(nativeValue.lastEvaluatedTableName()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.lastEvaluatedTableName()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
  ...
  public static PointInTimeRecoveryDescription PointInTimeRecoveryDescription(
    ...
    earliestRestorableDateTime = Objects.nonNull(nativeValue.earliestRestorableDateTime()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.earliestRestorableDateTime()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    ...
    latestRestorableDateTime = Objects.nonNull(nativeValue.latestRestorableDateTime()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.latestRestorableDateTime()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
  ...
  public static Projection Projection(
    ...
    projectionType = Objects.nonNull(nativeValue.projectionType()) ?
        Option.create_Some(ProjectionType._typeDescriptor(), ToDafny.ProjectionType(nativeValue.projectionType()))
    ...
    nonKeyAttributes = (Objects.nonNull(nativeValue.nonKeyAttributes()) && nativeValue.nonKeyAttributes().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR)), ToDafny.NonKeyAttributeNameList(nativeValue.nonKeyAttributes()))
        : Option.create_None(DafnySequence._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR)));
  ...
  public static ProvisionedThroughputDescription ProvisionedThroughputDescription(
    ...
    lastIncreaseDateTime = Objects.nonNull(nativeValue.lastIncreaseDateTime()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.lastIncreaseDateTime()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    ...
    lastDecreaseDateTime = Objects.nonNull(nativeValue.lastDecreaseDateTime()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.lastDecreaseDateTime()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    Option<Long> numberOfDecreasesToday;
    numberOfDecreasesToday = Objects.nonNull(nativeValue.numberOfDecreasesToday()) ?
        Option.create_Some(TypeDescriptor.LONG, (nativeValue.numberOfDecreasesToday()))
        : Option.create_None(TypeDescriptor.LONG);
    Option<Long> readCapacityUnits;
    readCapacityUnits = Objects.nonNull(nativeValue.readCapacityUnits()) ?
        Option.create_Some(TypeDescriptor.LONG, (nativeValue.readCapacityUnits()))
        : Option.create_None(TypeDescriptor.LONG);
    Option<Long> writeCapacityUnits;
    writeCapacityUnits = Objects.nonNull(nativeValue.writeCapacityUnits()) ?
        Option.create_Some(TypeDescriptor.LONG, (nativeValue.writeCapacityUnits()))
        : Option.create_None(TypeDescriptor.LONG);
  ...
  public static QueryInput QueryInput(QueryRequest nativeValue) {
    ...
    select = Objects.nonNull(nativeValue.select()) ?
        Option.create_Some(Select._typeDescriptor(), ToDafny.Select(nativeValue.select()))
    ...
    keyConditions = (Objects.nonNull(nativeValue.keyConditions()) && nativeValue.keyConditions().size() > 0) ?
        Option.create_Some(DafnyMap._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), Condition._typeDescriptor()), ToDafny.KeyConditions(nativeValue.keyConditions()))
        : Option.create_None(DafnyMap._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), Condition._typeDescriptor()));
    ...
    queryFilter = (Objects.nonNull(nativeValue.queryFilter()) && nativeValue.queryFilter().size() > 0) ?
        Option.create_Some(DafnyMap._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), Condition._typeDescriptor()), ToDafny.FilterConditionMap(nativeValue.queryFilter()))
        : Option.create_None(DafnyMap._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), Condition._typeDescriptor()));
    Option<ConditionalOperator> conditionalOperator;
    conditionalOperator = Objects.nonNull(nativeValue.conditionalOperator()) ?
        Option.create_Some(ConditionalOperator._typeDescriptor(), ToDafny.ConditionalOperator(nativeValue.conditionalOperator()))
    ...
    scanIndexForward = Objects.nonNull(nativeValue.scanIndexForward()) ?
        Option.create_Some(TypeDescriptor.BOOLEAN, (nativeValue.scanIndexForward()))
        : Option.create_None(TypeDescriptor.BOOLEAN);
    ...
    exclusiveStartKey = (Objects.nonNull(nativeValue.exclusiveStartKey()) && nativeValue.exclusiveStartKey().size() > 0) ?
        Option.create_Some(TypeDescriptor.referenceWithInitializer(dafny.DafnyMap.class, () -> dafny.DafnyMap.<dafny.DafnySequence<? extends Character>,AttributeValue> empty()), ToDafny.Key(nativeValue.exclusiveStartKey()))
        : Option.create_None(TypeDescriptor.referenceWithInitializer(dafny.DafnyMap.class, () -> dafny.DafnyMap.<dafny.DafnySequence<? extends Character>,AttributeValue> empty()));
    Option<ReturnConsumedCapacity> returnConsumedCapacity;
    returnConsumedCapacity = Objects.nonNull(nativeValue.returnConsumedCapacity()) ?
        Option.create_Some(ReturnConsumedCapacity._typeDescriptor(), ToDafny.ReturnConsumedCapacity(nativeValue.returnConsumedCapacity()))
    ...
    filterExpression = Objects.nonNull(nativeValue.filterExpression()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.filterExpression()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    ...
    keyConditionExpression = Objects.nonNull(nativeValue.keyConditionExpression()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.keyConditionExpression()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    Option<DafnyMap<? extends DafnySequence<? extends Character>, ? extends DafnySequence<? extends Character>>> expressionAttributeNames;
    expressionAttributeNames = (Objects.nonNull(nativeValue.expressionAttributeNames()) && nativeValue.expressionAttributeNames().size() > 0) ?
        Option.create_Some(DafnyMap._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), DafnySequence._typeDescriptor(TypeDescriptor.CHAR)), ToDafny.ExpressionAttributeNameMap(nativeValue.expressionAttributeNames()))
  ...
  public static ReplicaAutoScalingDescription ReplicaAutoScalingDescription(
    ...
    globalSecondaryIndexes = (Objects.nonNull(nativeValue.globalSecondaryIndexes()) && nativeValue.globalSecondaryIndexes().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(ReplicaGlobalSecondaryIndexAutoScalingDescription._typeDescriptor()), ToDafny.ReplicaGlobalSecondaryIndexAutoScalingDescriptionList(nativeValue.globalSecondaryIndexes()))
        : Option.create_None(DafnySequence._typeDescriptor(ReplicaGlobalSecondaryIndexAutoScalingDescription._typeDescriptor()));
    ...
    replicaProvisionedReadCapacityAutoScalingSettings = Objects.nonNull(nativeValue.replicaProvisionedReadCapacityAutoScalingSettings()) ?
        Option.create_Some(AutoScalingSettingsDescription._typeDescriptor(), ToDafny.AutoScalingSettingsDescription(nativeValue.replicaProvisionedReadCapacityAutoScalingSettings()))
    ...
    replicaProvisionedWriteCapacityAutoScalingSettings = Objects.nonNull(nativeValue.replicaProvisionedWriteCapacityAutoScalingSettings()) ?
        Option.create_Some(AutoScalingSettingsDescription._typeDescriptor(), ToDafny.AutoScalingSettingsDescription(nativeValue.replicaProvisionedWriteCapacityAutoScalingSettings()))
        : Option.create_None(AutoScalingSettingsDescription._typeDescriptor());
    Option<ReplicaStatus> replicaStatus;
    replicaStatus = Objects.nonNull(nativeValue.replicaStatus()) ?
        Option.create_Some(ReplicaStatus._typeDescriptor(), ToDafny.ReplicaStatus(nativeValue.replicaStatus()))
  ...
  public static ReplicaAutoScalingUpdate ReplicaAutoScalingUpdate(
    ...
    replicaGlobalSecondaryIndexUpdates = (Objects.nonNull(nativeValue.replicaGlobalSecondaryIndexUpdates()) && nativeValue.replicaGlobalSecondaryIndexUpdates().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(ReplicaGlobalSecondaryIndexAutoScalingUpdate._typeDescriptor()), ToDafny.ReplicaGlobalSecondaryIndexAutoScalingUpdateList(nativeValue.replicaGlobalSecondaryIndexUpdates()))
        : Option.create_None(DafnySequence._typeDescriptor(ReplicaGlobalSecondaryIndexAutoScalingUpdate._typeDescriptor()));
    ...
    replicaProvisionedReadCapacityAutoScalingUpdate = Objects.nonNull(nativeValue.replicaProvisionedReadCapacityAutoScalingUpdate()) ?
        Option.create_Some(AutoScalingSettingsUpdate._typeDescriptor(), ToDafny.AutoScalingSettingsUpdate(nativeValue.replicaProvisionedReadCapacityAutoScalingUpdate()))
        : Option.create_None(AutoScalingSettingsUpdate._typeDescriptor());
  ...
  public static ReplicaDescription ReplicaDescription(
    ...
    replicaStatusDescription = Objects.nonNull(nativeValue.replicaStatusDescription()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.replicaStatusDescription()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    ...
    replicaStatusPercentProgress = Objects.nonNull(nativeValue.replicaStatusPercentProgress()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.replicaStatusPercentProgress()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    Option<DafnySequence<? extends Character>> kMSMasterKeyId;
    kMSMasterKeyId = Objects.nonNull(nativeValue.kmsMasterKeyId()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.kmsMasterKeyId()))
    ...
    globalSecondaryIndexes = (Objects.nonNull(nativeValue.globalSecondaryIndexes()) && nativeValue.globalSecondaryIndexes().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(ReplicaGlobalSecondaryIndexDescription._typeDescriptor()), ToDafny.ReplicaGlobalSecondaryIndexDescriptionList(nativeValue.globalSecondaryIndexes()))
        : Option.create_None(DafnySequence._typeDescriptor(ReplicaGlobalSecondaryIndexDescription._typeDescriptor()));
    ...
    replicaInaccessibleDateTime = Objects.nonNull(nativeValue.replicaInaccessibleDateTime()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.replicaInaccessibleDateTime()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    ...
    replicaTableClassSummary = Objects.nonNull(nativeValue.replicaTableClassSummary()) ?
        Option.create_Some(TableClassSummary._typeDescriptor(), ToDafny.TableClassSummary(nativeValue.replicaTableClassSummary()))
  ...
  public static ReplicaGlobalSecondaryIndexAutoScalingDescription ReplicaGlobalSecondaryIndexAutoScalingDescription(
    ...
    provisionedReadCapacityAutoScalingSettings = Objects.nonNull(nativeValue.provisionedReadCapacityAutoScalingSettings()) ?
        Option.create_Some(AutoScalingSettingsDescription._typeDescriptor(), ToDafny.AutoScalingSettingsDescription(nativeValue.provisionedReadCapacityAutoScalingSettings()))
        : Option.create_None(AutoScalingSettingsDescription._typeDescriptor());
    ...
    provisionedWriteCapacityAutoScalingSettings = Objects.nonNull(nativeValue.provisionedWriteCapacityAutoScalingSettings()) ?
        Option.create_Some(AutoScalingSettingsDescription._typeDescriptor(), ToDafny.AutoScalingSettingsDescription(nativeValue.provisionedWriteCapacityAutoScalingSettings()))
        : Option.create_None(AutoScalingSettingsDescription._typeDescriptor());
  ...
  public static ReplicaGlobalSecondaryIndexAutoScalingUpdate ReplicaGlobalSecondaryIndexAutoScalingUpdate(
    ...
    provisionedReadCapacityAutoScalingUpdate = Objects.nonNull(nativeValue.provisionedReadCapacityAutoScalingUpdate()) ?
        Option.create_Some(AutoScalingSettingsUpdate._typeDescriptor(), ToDafny.AutoScalingSettingsUpdate(nativeValue.provisionedReadCapacityAutoScalingUpdate()))
        : Option.create_None(AutoScalingSettingsUpdate._typeDescriptor());
  ...
  public static ReplicaGlobalSecondaryIndexSettingsDescription ReplicaGlobalSecondaryIndexSettingsDescription(
    ...
    provisionedReadCapacityUnits = Objects.nonNull(nativeValue.provisionedReadCapacityUnits()) ?
        Option.create_Some(TypeDescriptor.LONG, (nativeValue.provisionedReadCapacityUnits()))
        : Option.create_None(TypeDescriptor.LONG);
    Option<AutoScalingSettingsDescription> provisionedReadCapacityAutoScalingSettings;
    provisionedReadCapacityAutoScalingSettings = Objects.nonNull(nativeValue.provisionedReadCapacityAutoScalingSettings()) ?
        Option.create_Some(AutoScalingSettingsDescription._typeDescriptor(), ToDafny.AutoScalingSettingsDescription(nativeValue.provisionedReadCapacityAutoScalingSettings()))
  ...
  public static ReplicaGlobalSecondaryIndexSettingsUpdate ReplicaGlobalSecondaryIndexSettingsUpdate(
    ...
    provisionedReadCapacityAutoScalingSettingsUpdate = Objects.nonNull(nativeValue.provisionedReadCapacityAutoScalingSettingsUpdate()) ?
        Option.create_Some(AutoScalingSettingsUpdate._typeDescriptor(), ToDafny.AutoScalingSettingsUpdate(nativeValue.provisionedReadCapacityAutoScalingSettingsUpdate()))
        : Option.create_None(AutoScalingSettingsUpdate._typeDescriptor());
  ...
  public static ReplicaSettingsDescription ReplicaSettingsDescription(
    ...
    replicaBillingModeSummary = Objects.nonNull(nativeValue.replicaBillingModeSummary()) ?
        Option.create_Some(BillingModeSummary._typeDescriptor(), ToDafny.BillingModeSummary(nativeValue.replicaBillingModeSummary()))
    ...
    replicaProvisionedReadCapacityUnits = Objects.nonNull(nativeValue.replicaProvisionedReadCapacityUnits()) ?
        Option.create_Some(TypeDescriptor.LONG, (nativeValue.replicaProvisionedReadCapacityUnits()))
        : Option.create_None(TypeDescriptor.LONG);
    Option<AutoScalingSettingsDescription> replicaProvisionedReadCapacityAutoScalingSettings;
    replicaProvisionedReadCapacityAutoScalingSettings = Objects.nonNull(nativeValue.replicaProvisionedReadCapacityAutoScalingSettings()) ?
        Option.create_Some(AutoScalingSettingsDescription._typeDescriptor(), ToDafny.AutoScalingSettingsDescription(nativeValue.replicaProvisionedReadCapacityAutoScalingSettings()))
    ...
    replicaProvisionedWriteCapacityUnits = Objects.nonNull(nativeValue.replicaProvisionedWriteCapacityUnits()) ?
        Option.create_Some(TypeDescriptor.LONG, (nativeValue.replicaProvisionedWriteCapacityUnits()))
        : Option.create_None(TypeDescriptor.LONG);
    Option<AutoScalingSettingsDescription> replicaProvisionedWriteCapacityAutoScalingSettings;
    replicaProvisionedWriteCapacityAutoScalingSettings = Objects.nonNull(nativeValue.replicaProvisionedWriteCapacityAutoScalingSettings()) ?
        Option.create_Some(AutoScalingSettingsDescription._typeDescriptor(), ToDafny.AutoScalingSettingsDescription(nativeValue.replicaProvisionedWriteCapacityAutoScalingSettings()))
    ...
    replicaGlobalSecondaryIndexSettings = (Objects.nonNull(nativeValue.replicaGlobalSecondaryIndexSettings()) && nativeValue.replicaGlobalSecondaryIndexSettings().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(ReplicaGlobalSecondaryIndexSettingsDescription._typeDescriptor()), ToDafny.ReplicaGlobalSecondaryIndexSettingsDescriptionList(nativeValue.replicaGlobalSecondaryIndexSettings()))
        : Option.create_None(DafnySequence._typeDescriptor(ReplicaGlobalSecondaryIndexSettingsDescription._typeDescriptor()));
    Option<TableClassSummary> replicaTableClassSummary;
    replicaTableClassSummary = Objects.nonNull(nativeValue.replicaTableClassSummary()) ?
        Option.create_Some(TableClassSummary._typeDescriptor(), ToDafny.TableClassSummary(nativeValue.replicaTableClassSummary()))
        : Option.create_None(TableClassSummary._typeDescriptor());
  ...
  public static ReplicaSettingsUpdate ReplicaSettingsUpdate(
    ...
    replicaProvisionedReadCapacityAutoScalingSettingsUpdate = Objects.nonNull(nativeValue.replicaProvisionedReadCapacityAutoScalingSettingsUpdate()) ?
        Option.create_Some(AutoScalingSettingsUpdate._typeDescriptor(), ToDafny.AutoScalingSettingsUpdate(nativeValue.replicaProvisionedReadCapacityAutoScalingSettingsUpdate()))
        : Option.create_None(AutoScalingSettingsUpdate._typeDescriptor());
    ...
    replicaGlobalSecondaryIndexSettingsUpdate = (Objects.nonNull(nativeValue.replicaGlobalSecondaryIndexSettingsUpdate()) && nativeValue.replicaGlobalSecondaryIndexSettingsUpdate().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(ReplicaGlobalSecondaryIndexSettingsUpdate._typeDescriptor()), ToDafny.ReplicaGlobalSecondaryIndexSettingsUpdateList(nativeValue.replicaGlobalSecondaryIndexSettingsUpdate()))
        : Option.create_None(DafnySequence._typeDescriptor(ReplicaGlobalSecondaryIndexSettingsUpdate._typeDescriptor()));
    Option<TableClass> replicaTableClass;
    replicaTableClass = Objects.nonNull(nativeValue.replicaTableClass()) ?
        Option.create_Some(TableClass._typeDescriptor(), ToDafny.TableClass(nativeValue.replicaTableClass()))
        : Option.create_None(TableClass._typeDescriptor());
  ...
  public static ReplicationGroupUpdate ReplicationGroupUpdate(
    ...
    create = Objects.nonNull(nativeValue.create()) ?
        Option.create_Some(CreateReplicationGroupMemberAction._typeDescriptor(), ToDafny.CreateReplicationGroupMemberAction(nativeValue.create()))
        : Option.create_None(CreateReplicationGroupMemberAction._typeDescriptor());
    Option<UpdateReplicationGroupMemberAction> update;
    update = Objects.nonNull(nativeValue.update()) ?
        Option.create_Some(UpdateReplicationGroupMemberAction._typeDescriptor(), ToDafny.UpdateReplicationGroupMemberAction(nativeValue.update()))
        : Option.create_None(UpdateReplicationGroupMemberAction._typeDescriptor());
    Option<DeleteReplicationGroupMemberAction> delete;
    delete = Objects.nonNull(nativeValue.delete()) ?
        Option.create_Some(DeleteReplicationGroupMemberAction._typeDescriptor(), ToDafny.DeleteReplicationGroupMemberAction(nativeValue.delete()))
        : Option.create_None(DeleteReplicationGroupMemberAction._typeDescriptor());
  ...
  public static ReplicaUpdate ReplicaUpdate(
    ...
    create = Objects.nonNull(nativeValue.create()) ?
        Option.create_Some(CreateReplicaAction._typeDescriptor(), ToDafny.CreateReplicaAction(nativeValue.create()))
        : Option.create_None(CreateReplicaAction._typeDescriptor());
    Option<DeleteReplicaAction> delete;
    delete = Objects.nonNull(nativeValue.delete()) ?
        Option.create_Some(DeleteReplicaAction._typeDescriptor(), ToDafny.DeleteReplicaAction(nativeValue.delete()))
  ...
  public static RestoreSummary RestoreSummary(
    ...
    sourceBackupArn = Objects.nonNull(nativeValue.sourceBackupArn()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.sourceBackupArn()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    Option<DafnySequence<? extends Character>> sourceTableArn;
    sourceTableArn = Objects.nonNull(nativeValue.sourceTableArn()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.sourceTableArn()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
  ...
  public static RestoreTableFromBackupInput RestoreTableFromBackupInput(
    ...
    billingModeOverride = Objects.nonNull(nativeValue.billingModeOverride()) ?
        Option.create_Some(BillingMode._typeDescriptor(), ToDafny.BillingMode(nativeValue.billingModeOverride()))
        : Option.create_None(BillingMode._typeDescriptor());
    ...
    globalSecondaryIndexOverride = (Objects.nonNull(nativeValue.globalSecondaryIndexOverride()) && nativeValue.globalSecondaryIndexOverride().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(GlobalSecondaryIndex._typeDescriptor()), ToDafny.GlobalSecondaryIndexList(nativeValue.globalSecondaryIndexOverride()))
        : Option.create_None(DafnySequence._typeDescriptor(GlobalSecondaryIndex._typeDescriptor()));
    ...
    localSecondaryIndexOverride = (Objects.nonNull(nativeValue.localSecondaryIndexOverride()) && nativeValue.localSecondaryIndexOverride().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(LocalSecondaryIndex._typeDescriptor()), ToDafny.LocalSecondaryIndexList(nativeValue.localSecondaryIndexOverride()))
        : Option.create_None(DafnySequence._typeDescriptor(LocalSecondaryIndex._typeDescriptor()));
    Option<ProvisionedThroughput> provisionedThroughputOverride;
    provisionedThroughputOverride = Objects.nonNull(nativeValue.provisionedThroughputOverride()) ?
        Option.create_Some(ProvisionedThroughput._typeDescriptor(), ToDafny.ProvisionedThroughput(nativeValue.provisionedThroughputOverride()))
        : Option.create_None(ProvisionedThroughput._typeDescriptor());
    ...
    sSESpecificationOverride = Objects.nonNull(nativeValue.sseSpecificationOverride()) ?
        Option.create_Some(SSESpecification._typeDescriptor(), ToDafny.SSESpecification(nativeValue.sseSpecificationOverride()))
        : Option.create_None(SSESpecification._typeDescriptor());
  ...
  public static RestoreTableToPointInTimeInput RestoreTableToPointInTimeInput(
    ...
    sourceTableName = Objects.nonNull(nativeValue.sourceTableName()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.sourceTableName()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    DafnySequence<? extends Character> targetTableName;
    targetTableName = software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.targetTableName());
    Option<Boolean> useLatestRestorableTime;
    useLatestRestorableTime = Objects.nonNull(nativeValue.useLatestRestorableTime()) ?
        Option.create_Some(TypeDescriptor.BOOLEAN, (nativeValue.useLatestRestorableTime()))
        : Option.create_None(TypeDescriptor.BOOLEAN);
    Option<DafnySequence<? extends Character>> restoreDateTime;
    restoreDateTime = Objects.nonNull(nativeValue.restoreDateTime()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.restoreDateTime()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    Option<BillingMode> billingModeOverride;
    billingModeOverride = Objects.nonNull(nativeValue.billingModeOverride()) ?
        Option.create_Some(BillingMode._typeDescriptor(), ToDafny.BillingMode(nativeValue.billingModeOverride()))
  ...
  public static S3BucketSource S3BucketSource(
    ...
    s3KeyPrefix = Objects.nonNull(nativeValue.s3KeyPrefix()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.s3KeyPrefix()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
  ...
  public static ScanInput ScanInput(ScanRequest nativeValue) {
    ...
    scanFilter = (Objects.nonNull(nativeValue.scanFilter()) && nativeValue.scanFilter().size() > 0) ?
        Option.create_Some(DafnyMap._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), Condition._typeDescriptor()), ToDafny.FilterConditionMap(nativeValue.scanFilter()))
        : Option.create_None(DafnyMap._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), Condition._typeDescriptor()));
    Option<ConditionalOperator> conditionalOperator;
    conditionalOperator = Objects.nonNull(nativeValue.conditionalOperator()) ?
        Option.create_Some(ConditionalOperator._typeDescriptor(), ToDafny.ConditionalOperator(nativeValue.conditionalOperator()))
  ...
  public static SourceTableDetails SourceTableDetails(
    ...
    tableSizeBytes = Objects.nonNull(nativeValue.tableSizeBytes()) ?
        Option.create_Some(TypeDescriptor.LONG, (nativeValue.tableSizeBytes()))
        : Option.create_None(TypeDescriptor.LONG);
    DafnySequence<? extends KeySchemaElement> keySchema;
    keySchema = ToDafny.KeySchema(nativeValue.keySchema());
  ...
  public static SourceTableFeatureDetails SourceTableFeatureDetails(
    ...
    localSecondaryIndexes = (Objects.nonNull(nativeValue.localSecondaryIndexes()) && nativeValue.localSecondaryIndexes().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(LocalSecondaryIndexInfo._typeDescriptor()), ToDafny.LocalSecondaryIndexes(nativeValue.localSecondaryIndexes()))
        : Option.create_None(DafnySequence._typeDescriptor(LocalSecondaryIndexInfo._typeDescriptor()));
    Option<DafnySequence<? extends GlobalSecondaryIndexInfo>> globalSecondaryIndexes;
    globalSecondaryIndexes = (Objects.nonNull(nativeValue.globalSecondaryIndexes()) && nativeValue.globalSecondaryIndexes().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(GlobalSecondaryIndexInfo._typeDescriptor()), ToDafny.GlobalSecondaryIndexes(nativeValue.globalSecondaryIndexes()))
        : Option.create_None(DafnySequence._typeDescriptor(GlobalSecondaryIndexInfo._typeDescriptor()));
    ...
    sSEDescription = Objects.nonNull(nativeValue.sseDescription()) ?
        Option.create_Some(SSEDescription._typeDescriptor(), ToDafny.SSEDescription(nativeValue.sseDescription()))
  ...
  public static SSEDescription SSEDescription(
    ...
    status = Objects.nonNull(nativeValue.status()) ?
        Option.create_Some(SSEStatus._typeDescriptor(), ToDafny.SSEStatus(nativeValue.status()))
        : Option.create_None(SSEStatus._typeDescriptor());
    Option<SSEType> sSEType;
    sSEType = Objects.nonNull(nativeValue.sseType()) ?
        Option.create_Some(SSEType._typeDescriptor(), ToDafny.SSEType(nativeValue.sseType()))
    ...
    kMSMasterKeyArn = Objects.nonNull(nativeValue.kmsMasterKeyArn()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.kmsMasterKeyArn()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    ...
    inaccessibleEncryptionDateTime = Objects.nonNull(nativeValue.inaccessibleEncryptionDateTime()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.inaccessibleEncryptionDateTime()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
  ...
  public static StreamSpecification StreamSpecification(
    ...
    streamViewType = Objects.nonNull(nativeValue.streamViewType()) ?
        Option.create_Some(StreamViewType._typeDescriptor(), ToDafny.StreamViewType(nativeValue.streamViewType()))
  ...
  public static TableAutoScalingDescription TableAutoScalingDescription(
    ...
    tableStatus = Objects.nonNull(nativeValue.tableStatus()) ?
        Option.create_Some(TableStatus._typeDescriptor(), ToDafny.TableStatus(nativeValue.tableStatus()))
    ...
    replicas = (Objects.nonNull(nativeValue.replicas()) && nativeValue.replicas().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(ReplicaAutoScalingDescription._typeDescriptor()), ToDafny.ReplicaAutoScalingDescriptionList(nativeValue.replicas()))
        : Option.create_None(DafnySequence._typeDescriptor(ReplicaAutoScalingDescription._typeDescriptor()));
  ...
  public static TableDescription TableDescription(
    ...
    attributeDefinitions = (Objects.nonNull(nativeValue.attributeDefinitions()) && nativeValue.attributeDefinitions().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(AttributeDefinition._typeDescriptor()), ToDafny.AttributeDefinitions(nativeValue.attributeDefinitions()))
        : Option.create_None(DafnySequence._typeDescriptor(AttributeDefinition._typeDescriptor()));
    Option<DafnySequence<? extends Character>> tableName;
    tableName = Objects.nonNull(nativeValue.tableName()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.tableName()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    ...
    billingModeSummary = Objects.nonNull(nativeValue.billingModeSummary()) ?
        Option.create_Some(BillingModeSummary._typeDescriptor(), ToDafny.BillingModeSummary(nativeValue.billingModeSummary()))
        : Option.create_None(BillingModeSummary._typeDescriptor());
    Option<DafnySequence<? extends LocalSecondaryIndexDescription>> localSecondaryIndexes;
    localSecondaryIndexes = (Objects.nonNull(nativeValue.localSecondaryIndexes()) && nativeValue.localSecondaryIndexes().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(LocalSecondaryIndexDescription._typeDescriptor()), ToDafny.LocalSecondaryIndexDescriptionList(nativeValue.localSecondaryIndexes()))
        : Option.create_None(DafnySequence._typeDescriptor(LocalSecondaryIndexDescription._typeDescriptor()));
    Option<DafnySequence<? extends GlobalSecondaryIndexDescription>> globalSecondaryIndexes;
    globalSecondaryIndexes = (Objects.nonNull(nativeValue.globalSecondaryIndexes()) && nativeValue.globalSecondaryIndexes().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(GlobalSecondaryIndexDescription._typeDescriptor()), ToDafny.GlobalSecondaryIndexDescriptionList(nativeValue.globalSecondaryIndexes()))
        : Option.create_None(DafnySequence._typeDescriptor(GlobalSecondaryIndexDescription._typeDescriptor()));
    Option<StreamSpecification> streamSpecification;
    streamSpecification = Objects.nonNull(nativeValue.streamSpecification()) ?
        Option.create_Some(StreamSpecification._typeDescriptor(), ToDafny.StreamSpecification(nativeValue.streamSpecification()))
        : Option.create_None(StreamSpecification._typeDescriptor());
    ...
    latestStreamLabel = Objects.nonNull(nativeValue.latestStreamLabel()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.latestStreamLabel()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    Option<DafnySequence<? extends Character>> latestStreamArn;
    latestStreamArn = Objects.nonNull(nativeValue.latestStreamArn()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.latestStreamArn()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    ...
    globalTableVersion = Objects.nonNull(nativeValue.globalTableVersion()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.globalTableVersion()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    Option<DafnySequence<? extends ReplicaDescription>> replicas;
    replicas = (Objects.nonNull(nativeValue.replicas()) && nativeValue.replicas().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(ReplicaDescription._typeDescriptor()), ToDafny.ReplicaDescriptionList(nativeValue.replicas()))
        : Option.create_None(DafnySequence._typeDescriptor(ReplicaDescription._typeDescriptor()));
    ...
    archivalSummary = Objects.nonNull(nativeValue.archivalSummary()) ?
        Option.create_Some(ArchivalSummary._typeDescriptor(), ToDafny.ArchivalSummary(nativeValue.archivalSummary()))
    ...
    tableClassSummary = Objects.nonNull(nativeValue.tableClassSummary()) ?
        Option.create_Some(TableClassSummary._typeDescriptor(), ToDafny.TableClassSummary(nativeValue.tableClassSummary()))
        : Option.create_None(TableClassSummary._typeDescriptor());
  ...
  public static TimeToLiveDescription TimeToLiveDescription(
    ...
    timeToLiveStatus = Objects.nonNull(nativeValue.timeToLiveStatus()) ?
        Option.create_Some(TimeToLiveStatus._typeDescriptor(), ToDafny.TimeToLiveStatus(nativeValue.timeToLiveStatus()))
    ...
    attributeName = Objects.nonNull(nativeValue.attributeName()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.attributeName()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
  ...
  public static TransactWriteItem TransactWriteItem(
    ...
    conditionCheck = Objects.nonNull(nativeValue.conditionCheck()) ?
        Option.create_Some(ConditionCheck._typeDescriptor(), ToDafny.ConditionCheck(nativeValue.conditionCheck()))
        : Option.create_None(ConditionCheck._typeDescriptor());
    Option<Put> put;
    put = Objects.nonNull(nativeValue.put()) ?
        Option.create_Some(Put._typeDescriptor(), ToDafny.Put(nativeValue.put()))
    ...
    update = Objects.nonNull(nativeValue.update()) ?
        Option.create_Some(Update._typeDescriptor(), ToDafny.Update(nativeValue.update()))
  ...
  public static UpdateGlobalTableSettingsInput UpdateGlobalTableSettingsInput(
    ...
    globalTableBillingMode = Objects.nonNull(nativeValue.globalTableBillingMode()) ?
        Option.create_Some(BillingMode._typeDescriptor(), ToDafny.BillingMode(nativeValue.globalTableBillingMode()))
        : Option.create_None(BillingMode._typeDescriptor());
    ...
    globalTableProvisionedWriteCapacityAutoScalingSettingsUpdate = Objects.nonNull(nativeValue.globalTableProvisionedWriteCapacityAutoScalingSettingsUpdate()) ?
        Option.create_Some(AutoScalingSettingsUpdate._typeDescriptor(), ToDafny.AutoScalingSettingsUpdate(nativeValue.globalTableProvisionedWriteCapacityAutoScalingSettingsUpdate()))
        : Option.create_None(AutoScalingSettingsUpdate._typeDescriptor());
    ...
    globalTableGlobalSecondaryIndexSettingsUpdate = (Objects.nonNull(nativeValue.globalTableGlobalSecondaryIndexSettingsUpdate()) && nativeValue.globalTableGlobalSecondaryIndexSettingsUpdate().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(GlobalTableGlobalSecondaryIndexSettingsUpdate._typeDescriptor()), ToDafny.GlobalTableGlobalSecondaryIndexSettingsUpdateList(nativeValue.globalTableGlobalSecondaryIndexSettingsUpdate()))
        : Option.create_None(DafnySequence._typeDescriptor(GlobalTableGlobalSecondaryIndexSettingsUpdate._typeDescriptor()));
    ...
    replicaSettingsUpdate = (Objects.nonNull(nativeValue.replicaSettingsUpdate()) && nativeValue.replicaSettingsUpdate().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(ReplicaSettingsUpdate._typeDescriptor()), ToDafny.ReplicaSettingsUpdateList(nativeValue.replicaSettingsUpdate()))
        : Option.create_None(DafnySequence._typeDescriptor(ReplicaSettingsUpdate._typeDescriptor()));
  ...
  public static UpdateItemInput UpdateItemInput(UpdateItemRequest nativeValue) {
    ...
    attributeUpdates = (Objects.nonNull(nativeValue.attributeUpdates()) && nativeValue.attributeUpdates().size() > 0) ?
        Option.create_Some(DafnyMap._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), AttributeValueUpdate._typeDescriptor()), ToDafny.AttributeUpdates(nativeValue.attributeUpdates()))
        : Option.create_None(DafnyMap._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), AttributeValueUpdate._typeDescriptor()));
    Option<DafnyMap<? extends DafnySequence<? extends Character>, ? extends ExpectedAttributeValue>> expected;
    expected = (Objects.nonNull(nativeValue.expected()) && nativeValue.expected().size() > 0) ?
        Option.create_Some(DafnyMap._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), ExpectedAttributeValue._typeDescriptor()), ToDafny.ExpectedAttributeMap(nativeValue.expected()))
        : Option.create_None(DafnyMap._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), ExpectedAttributeValue._typeDescriptor()));
    ...
    updateExpression = Objects.nonNull(nativeValue.updateExpression()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.updateExpression()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
    Option<DafnySequence<? extends Character>> conditionExpression;
    conditionExpression = Objects.nonNull(nativeValue.conditionExpression()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.conditionExpression()))
  ...
  public static UpdateTableInput UpdateTableInput(UpdateTableRequest nativeValue) {
    ...
    globalSecondaryIndexUpdates = (Objects.nonNull(nativeValue.globalSecondaryIndexUpdates()) && nativeValue.globalSecondaryIndexUpdates().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(GlobalSecondaryIndexUpdate._typeDescriptor()), ToDafny.GlobalSecondaryIndexUpdateList(nativeValue.globalSecondaryIndexUpdates()))
        : Option.create_None(DafnySequence._typeDescriptor(GlobalSecondaryIndexUpdate._typeDescriptor()));
    Option<StreamSpecification> streamSpecification;
    streamSpecification = Objects.nonNull(nativeValue.streamSpecification()) ?
        Option.create_Some(StreamSpecification._typeDescriptor(), ToDafny.StreamSpecification(nativeValue.streamSpecification()))
        : Option.create_None(StreamSpecification._typeDescriptor());
    ...
    replicaUpdates = (Objects.nonNull(nativeValue.replicaUpdates()) && nativeValue.replicaUpdates().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(ReplicationGroupUpdate._typeDescriptor()), ToDafny.ReplicationGroupUpdateList(nativeValue.replicaUpdates()))
        : Option.create_None(DafnySequence._typeDescriptor(ReplicationGroupUpdate._typeDescriptor()));
    Option<TableClass> tableClass;
    tableClass = Objects.nonNull(nativeValue.tableClass()) ?
        Option.create_Some(TableClass._typeDescriptor(), ToDafny.TableClass(nativeValue.tableClass()))
        : Option.create_None(TableClass._typeDescriptor());
  ...
  public static UpdateTableReplicaAutoScalingInput UpdateTableReplicaAutoScalingInput(
    ...
    globalSecondaryIndexUpdates = (Objects.nonNull(nativeValue.globalSecondaryIndexUpdates()) && nativeValue.globalSecondaryIndexUpdates().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(GlobalSecondaryIndexAutoScalingUpdate._typeDescriptor()), ToDafny.GlobalSecondaryIndexAutoScalingUpdateList(nativeValue.globalSecondaryIndexUpdates()))
        : Option.create_None(DafnySequence._typeDescriptor(GlobalSecondaryIndexAutoScalingUpdate._typeDescriptor()));
    DafnySequence<? extends Character> tableName;
    tableName = software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.tableName());
    Option<AutoScalingSettingsUpdate> provisionedWriteCapacityAutoScalingUpdate;
    provisionedWriteCapacityAutoScalingUpdate = Objects.nonNull(nativeValue.provisionedWriteCapacityAutoScalingUpdate()) ?
    ...
    replicaUpdates = (Objects.nonNull(nativeValue.replicaUpdates()) && nativeValue.replicaUpdates().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(ReplicaAutoScalingUpdate._typeDescriptor()), ToDafny.ReplicaAutoScalingUpdateList(nativeValue.replicaUpdates()))
        : Option.create_None(DafnySequence._typeDescriptor(ReplicaAutoScalingUpdate._typeDescriptor()));
  ...
  public static UpdateTimeToLiveOutput UpdateTimeToLiveOutput(
    ...
    timeToLiveSpecification = Objects.nonNull(nativeValue.timeToLiveSpecification()) ?
        Option.create_Some(TimeToLiveSpecification._typeDescriptor(), ToDafny.TimeToLiveSpecification(nativeValue.timeToLiveSpecification()))
  ...
  public static WriteRequest WriteRequest(
    ...
    putRequest = Objects.nonNull(nativeValue.putRequest()) ?
        Option.create_Some(PutRequest._typeDescriptor(), ToDafny.PutRequest(nativeValue.putRequest()))
    ...
    deleteRequest = Objects.nonNull(nativeValue.deleteRequest()) ?
        Option.create_Some(DeleteRequest._typeDescriptor(), ToDafny.DeleteRequest(nativeValue.deleteRequest()))
  ...
  public static Error Error(BackupInUseException nativeValue) {
    ...
    message = Objects.nonNull(nativeValue.getMessage()) ?
        Option.create_Some(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.getMessage()))
        : Option.create_None(DafnySequence._typeDescriptor(TypeDescriptor.CHAR));
  ...
  public static Error Error(TransactionCanceledException nativeValue) {
    ...
    cancellationReasons = (Objects.nonNull(nativeValue.cancellationReasons()) && nativeValue.cancellationReasons().size() > 0) ?
        Option.create_Some(DafnySequence._typeDescriptor(CancellationReason._typeDescriptor()), ToDafny.CancellationReasonList(nativeValue.cancellationReasons()))
        : Option.create_None(DafnySequence._typeDescriptor(CancellationReason._typeDescriptor()));
