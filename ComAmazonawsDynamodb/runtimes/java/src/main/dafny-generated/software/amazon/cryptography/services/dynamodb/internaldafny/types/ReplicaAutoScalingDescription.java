...
public class ReplicaAutoScalingDescription {
  ...
  private static final ReplicaAutoScalingDescription theDefault = software.amazon.cryptography.services.dynamodb.internaldafny.types.ReplicaAutoScalingDescription.create(Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR)), Wrappers_Compile.Option.<dafny.DafnySequence<? extends ReplicaGlobalSecondaryIndexAutoScalingDescription>>Default(dafny.DafnySequence.<ReplicaGlobalSecondaryIndexAutoScalingDescription>_typeDescriptor(ReplicaGlobalSecondaryIndexAutoScalingDescription._typeDescriptor())), Wrappers_Compile.Option.<AutoScalingSettingsDescription>Default(AutoScalingSettingsDescription._typeDescriptor()), Wrappers_Compile.Option.<AutoScalingSettingsDescription>Default(AutoScalingSettingsDescription._typeDescriptor()), Wrappers_Compile.Option.<ReplicaStatus>Default(ReplicaStatus._typeDescriptor()));
