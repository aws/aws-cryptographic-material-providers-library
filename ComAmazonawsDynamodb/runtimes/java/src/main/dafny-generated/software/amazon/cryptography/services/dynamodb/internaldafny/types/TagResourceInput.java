...
public class TagResourceInput {
  ...
  private static final TagResourceInput theDefault = TagResourceInput.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR), dafny.DafnySequence.<Tag> empty(Tag._typeDescriptor()));
