...
public class WriteRequest {
  ...
  private static final WriteRequest theDefault = WriteRequest.create(Wrappers_Compile.Option.<PutRequest>Default(PutRequest._typeDescriptor()), Wrappers_Compile.Option.<DeleteRequest>Default(DeleteRequest._typeDescriptor()));
