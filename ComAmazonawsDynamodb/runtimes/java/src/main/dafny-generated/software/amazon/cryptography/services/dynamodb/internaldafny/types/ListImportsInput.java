...
public class ListImportsInput {
  ...
  private static final ListImportsInput theDefault = software.amazon.cryptography.services.dynamodb.internaldafny.types.ListImportsInput.create(Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(TableArn._typeDescriptor()), Wrappers_Compile.Option.<java.lang.Integer>Default(ListImportsMaxLimit._typeDescriptor()), Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(ImportNextToken._typeDescriptor()));
