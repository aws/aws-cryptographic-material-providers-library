...
public class LocalSecondaryIndexInfo {
  ...
  private static final LocalSecondaryIndexInfo theDefault = software.amazon.cryptography.services.dynamodb.internaldafny.types.LocalSecondaryIndexInfo.create(Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(IndexName._typeDescriptor()), Wrappers_Compile.Option.<dafny.DafnySequence<? extends KeySchemaElement>>Default(KeySchema._typeDescriptor()), Wrappers_Compile.Option.<Projection>Default(Projection._typeDescriptor()));
