...
public class UpdateKinesisStreamingConfiguration {
  ...
  private static final UpdateKinesisStreamingConfiguration theDefault = UpdateKinesisStreamingConfiguration.create(Wrappers_Compile.Option.<ApproximateCreationDateTimePrecision>Default(ApproximateCreationDateTimePrecision._typeDescriptor()));
