...
public class LocalSecondaryIndex {
  ...
  private static final LocalSecondaryIndex theDefault = LocalSecondaryIndex.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR), dafny.DafnySequence.<KeySchemaElement> empty(KeySchemaElement._typeDescriptor()), Projection.Default());
