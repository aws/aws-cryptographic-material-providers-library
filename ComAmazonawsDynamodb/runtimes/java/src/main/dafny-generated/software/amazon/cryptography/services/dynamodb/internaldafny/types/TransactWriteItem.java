...
public class TransactWriteItem {
  ...
  private static final TransactWriteItem theDefault = software.amazon.cryptography.services.dynamodb.internaldafny.types.TransactWriteItem.create(Wrappers_Compile.Option.<ConditionCheck>Default(ConditionCheck._typeDescriptor()), Wrappers_Compile.Option.<Put>Default(Put._typeDescriptor()), Wrappers_Compile.Option.<Delete>Default(Delete._typeDescriptor()), Wrappers_Compile.Option.<Update>Default(Update._typeDescriptor()));
