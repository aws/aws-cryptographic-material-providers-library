...
public class ExpectedAttributeValue {
  ...
  private static final ExpectedAttributeValue theDefault = software.amazon.cryptography.services.dynamodb.internaldafny.types.ExpectedAttributeValue.create(Wrappers_Compile.Option.<AttributeValue>Default(AttributeValue._typeDescriptor()), Wrappers_Compile.Option.<Boolean>Default(dafny.TypeDescriptor.BOOLEAN), Wrappers_Compile.Option.<ComparisonOperator>Default(ComparisonOperator._typeDescriptor()), Wrappers_Compile.Option.<dafny.DafnySequence<? extends AttributeValue>>Default(dafny.DafnySequence.<AttributeValue>_typeDescriptor(AttributeValue._typeDescriptor())));
