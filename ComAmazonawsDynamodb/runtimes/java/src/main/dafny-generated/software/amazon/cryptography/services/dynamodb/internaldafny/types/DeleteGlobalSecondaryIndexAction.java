...
public class DeleteGlobalSecondaryIndexAction {
  ...
  private static final DeleteGlobalSecondaryIndexAction theDefault = software.amazon.cryptography.services.dynamodb.internaldafny.types.DeleteGlobalSecondaryIndexAction.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR));
