...
public class DescribeKinesisStreamingDestinationOutput {
  ...
  private static final DescribeKinesisStreamingDestinationOutput theDefault = software.amazon.cryptography.services.dynamodb.internaldafny.types.DescribeKinesisStreamingDestinationOutput.create(Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(TableName._typeDescriptor()), Wrappers_Compile.Option.<dafny.DafnySequence<? extends KinesisDataStreamDestination>>Default(dafny.DafnySequence.<KinesisDataStreamDestination>_typeDescriptor(KinesisDataStreamDestination._typeDescriptor())));
