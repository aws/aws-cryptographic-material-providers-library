...
public class GlobalSecondaryIndexUpdate {
  ...
  private static final GlobalSecondaryIndexUpdate theDefault = GlobalSecondaryIndexUpdate.create(Wrappers_Compile.Option.<UpdateGlobalSecondaryIndexAction>Default(UpdateGlobalSecondaryIndexAction._typeDescriptor()), Wrappers_Compile.Option.<CreateGlobalSecondaryIndexAction>Default(CreateGlobalSecondaryIndexAction._typeDescriptor()), Wrappers_Compile.Option.<DeleteGlobalSecondaryIndexAction>Default(DeleteGlobalSecondaryIndexAction._typeDescriptor()));
