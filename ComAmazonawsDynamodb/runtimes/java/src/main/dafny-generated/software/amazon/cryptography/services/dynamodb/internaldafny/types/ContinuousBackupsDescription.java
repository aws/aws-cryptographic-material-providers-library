...
public class ContinuousBackupsDescription {
  ...
  private static final ContinuousBackupsDescription theDefault = ContinuousBackupsDescription.create(ContinuousBackupsStatus.Default(), Wrappers_Compile.Option.<PointInTimeRecoveryDescription>Default(PointInTimeRecoveryDescription._typeDescriptor()));
