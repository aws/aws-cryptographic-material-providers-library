...
public class ListGlobalTablesOutput {
  ...
  private static final ListGlobalTablesOutput theDefault = software.amazon.cryptography.services.dynamodb.internaldafny.types.ListGlobalTablesOutput.create(Wrappers_Compile.Option.<dafny.DafnySequence<? extends GlobalTable>>Default(dafny.DafnySequence.<GlobalTable>_typeDescriptor(GlobalTable._typeDescriptor())), Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(TableName._typeDescriptor()));
