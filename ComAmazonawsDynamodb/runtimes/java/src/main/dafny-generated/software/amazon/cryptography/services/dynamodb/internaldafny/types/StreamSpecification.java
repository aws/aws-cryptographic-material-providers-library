...
public class StreamSpecification {
  ...
  private static final StreamSpecification theDefault = StreamSpecification.create(false, Wrappers_Compile.Option.<StreamViewType>Default(StreamViewType._typeDescriptor()));
