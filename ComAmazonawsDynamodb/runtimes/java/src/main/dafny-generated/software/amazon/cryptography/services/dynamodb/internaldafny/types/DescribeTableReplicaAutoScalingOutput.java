...
public class DescribeTableReplicaAutoScalingOutput {
  ...
  private static final DescribeTableReplicaAutoScalingOutput theDefault = software.amazon.cryptography.services.dynamodb.internaldafny.types.DescribeTableReplicaAutoScalingOutput.create(Wrappers_Compile.Option.<TableAutoScalingDescription>Default(TableAutoScalingDescription._typeDescriptor()));
