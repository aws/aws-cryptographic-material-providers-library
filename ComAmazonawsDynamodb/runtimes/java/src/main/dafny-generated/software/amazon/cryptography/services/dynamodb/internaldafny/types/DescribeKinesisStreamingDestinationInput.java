...
public class DescribeKinesisStreamingDestinationInput {
  ...
  private static final DescribeKinesisStreamingDestinationInput theDefault = DescribeKinesisStreamingDestinationInput.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR));
