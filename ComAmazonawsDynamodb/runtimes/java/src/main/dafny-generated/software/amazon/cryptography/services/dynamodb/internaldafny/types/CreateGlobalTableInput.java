...
public class CreateGlobalTableInput {
  ...
  private static final CreateGlobalTableInput theDefault = CreateGlobalTableInput.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR), dafny.DafnySequence.<Replica> empty(Replica._typeDescriptor()));
