...
public class DescribeTimeToLiveInput {
  ...
  private static final DescribeTimeToLiveInput theDefault = software.amazon.cryptography.services.dynamodb.internaldafny.types.DescribeTimeToLiveInput.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR));
