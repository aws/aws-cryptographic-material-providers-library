...
public class PutResourcePolicyOutput {
  ...
  private static final PutResourcePolicyOutput theDefault = PutResourcePolicyOutput.create(Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(PolicyRevisionId._typeDescriptor()));
