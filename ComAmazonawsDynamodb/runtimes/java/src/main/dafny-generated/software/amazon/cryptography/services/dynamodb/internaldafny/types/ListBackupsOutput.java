...
public class ListBackupsOutput {
  ...
  private static final ListBackupsOutput theDefault = ListBackupsOutput.create(Wrappers_Compile.Option.<dafny.DafnySequence<? extends BackupSummary>>Default(dafny.DafnySequence.<BackupSummary>_typeDescriptor(BackupSummary._typeDescriptor())), Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(BackupArn._typeDescriptor()));
