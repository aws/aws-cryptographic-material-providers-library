...
public class BackupDescription {
  ...
  private static final BackupDescription theDefault = BackupDescription.create(Wrappers_Compile.Option.<BackupDetails>Default(BackupDetails._typeDescriptor()), Wrappers_Compile.Option.<SourceTableDetails>Default(SourceTableDetails._typeDescriptor()), Wrappers_Compile.Option.<SourceTableFeatureDetails>Default(SourceTableFeatureDetails._typeDescriptor()));
