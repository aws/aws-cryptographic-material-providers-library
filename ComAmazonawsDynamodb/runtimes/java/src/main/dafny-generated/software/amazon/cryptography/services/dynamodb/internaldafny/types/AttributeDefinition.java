...
public class AttributeDefinition {
  ...
  private static final AttributeDefinition theDefault = AttributeDefinition.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR), ScalarAttributeType.Default());
