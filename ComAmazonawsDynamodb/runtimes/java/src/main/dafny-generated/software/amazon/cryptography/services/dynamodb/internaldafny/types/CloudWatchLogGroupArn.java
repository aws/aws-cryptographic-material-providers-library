...
// Dafny class CloudWatchLogGroupArn compiled into Java
package software.amazon.cryptography.services.dynamodb.internaldafny.types;

@SuppressWarnings({"unchecked", "deprecation"})
public class CloudWatchLogGroupArn {
  public CloudWatchLogGroupArn() {
  }
  public static boolean _Is(dafny.DafnySequence<? extends Character> __source) {
    ...
    return __default.IsValid__CloudWatchLogGroupArn(_13_x);
  }
