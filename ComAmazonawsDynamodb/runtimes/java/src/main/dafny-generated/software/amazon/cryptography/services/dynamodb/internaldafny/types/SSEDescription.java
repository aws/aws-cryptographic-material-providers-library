...
public class SSEDescription {
  ...
  private static final SSEDescription theDefault = SSEDescription.create(Wrappers_Compile.Option.<SSEStatus>Default(SSEStatus._typeDescriptor()), Wrappers_Compile.Option.<SSEType>Default(SSEType._typeDescriptor()), Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR)), Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR)));
