...
public class ProvisionedThroughputDescription {
  ...
  private static final ProvisionedThroughputDescription theDefault = ProvisionedThroughputDescription.create(Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR)), Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR)), Wrappers_Compile.Option.<java.lang.Long>Default(PositiveLongObject._typeDescriptor()), Wrappers_Compile.Option.<java.lang.Long>Default(NonNegativeLongObject._typeDescriptor()), Wrappers_Compile.Option.<java.lang.Long>Default(NonNegativeLongObject._typeDescriptor()));
