...
public class UpdateKinesisStreamingDestinationInput {
  ...
  private static final UpdateKinesisStreamingDestinationInput theDefault = UpdateKinesisStreamingDestinationInput.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR), dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR), Wrappers_Compile.Option.<UpdateKinesisStreamingConfiguration>Default(UpdateKinesisStreamingConfiguration._typeDescriptor()));
