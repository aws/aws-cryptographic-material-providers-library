...
public class RestoreTableToPointInTimeOutput {
  ...
  private static final RestoreTableToPointInTimeOutput theDefault = software.amazon.cryptography.services.dynamodb.internaldafny.types.RestoreTableToPointInTimeOutput.create(Wrappers_Compile.Option.<TableDescription>Default(TableDescription._typeDescriptor()));
