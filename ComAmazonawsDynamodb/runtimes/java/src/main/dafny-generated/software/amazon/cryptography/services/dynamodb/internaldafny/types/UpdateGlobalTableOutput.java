...
public class UpdateGlobalTableOutput {
  ...
  private static final UpdateGlobalTableOutput theDefault = UpdateGlobalTableOutput.create(Wrappers_Compile.Option.<GlobalTableDescription>Default(GlobalTableDescription._typeDescriptor()));
