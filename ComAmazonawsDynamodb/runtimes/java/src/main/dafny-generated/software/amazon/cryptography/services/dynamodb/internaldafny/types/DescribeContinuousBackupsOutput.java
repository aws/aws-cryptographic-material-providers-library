...
public class DescribeContinuousBackupsOutput {
  ...
  private static final DescribeContinuousBackupsOutput theDefault = DescribeContinuousBackupsOutput.create(Wrappers_Compile.Option.<ContinuousBackupsDescription>Default(ContinuousBackupsDescription._typeDescriptor()));
