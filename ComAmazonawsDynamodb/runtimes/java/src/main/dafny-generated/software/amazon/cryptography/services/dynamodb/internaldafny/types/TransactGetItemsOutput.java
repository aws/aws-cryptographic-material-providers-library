...
public class TransactGetItemsOutput {
  ...
  private static final TransactGetItemsOutput theDefault = TransactGetItemsOutput.create(Wrappers_Compile.Option.<dafny.DafnySequence<? extends ConsumedCapacity>>Default(dafny.DafnySequence.<ConsumedCapacity>_typeDescriptor(ConsumedCapacity._typeDescriptor())), Wrappers_Compile.Option.<dafny.DafnySequence<? extends ItemResponse>>Default(ItemResponseList._typeDescriptor()));
