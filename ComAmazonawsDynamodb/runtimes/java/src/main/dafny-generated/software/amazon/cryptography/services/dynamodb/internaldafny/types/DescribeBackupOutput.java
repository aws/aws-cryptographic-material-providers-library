...
public class DescribeBackupOutput {
  ...
  private static final DescribeBackupOutput theDefault = software.amazon.cryptography.services.dynamodb.internaldafny.types.DescribeBackupOutput.create(Wrappers_Compile.Option.<BackupDescription>Default(BackupDescription._typeDescriptor()));
