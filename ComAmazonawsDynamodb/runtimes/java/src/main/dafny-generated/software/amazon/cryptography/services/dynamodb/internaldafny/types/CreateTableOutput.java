...
public class CreateTableOutput {
  ...
  private static final CreateTableOutput theDefault = CreateTableOutput.create(Wrappers_Compile.Option.<TableDescription>Default(TableDescription._typeDescriptor()));
