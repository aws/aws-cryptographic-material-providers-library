...
public class DescribeTableOutput {
  ...
  private static final DescribeTableOutput theDefault = DescribeTableOutput.create(Wrappers_Compile.Option.<TableDescription>Default(TableDescription._typeDescriptor()));
