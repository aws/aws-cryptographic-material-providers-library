...
// Dafny class TimeToLiveAttributeName compiled into Java
package software.amazon.cryptography.services.dynamodb.internaldafny.types;

@SuppressWarnings({"unchecked", "deprecation"})
public class TimeToLiveAttributeName {
  public TimeToLiveAttributeName() {
  }
  public static boolean _Is(dafny.DafnySequence<? extends Character> __source) {
    dafny.DafnySequence<? extends Character> _46_x = __source;
    return __default.IsValid__TimeToLiveAttributeName(_46_x);
  }
