...
public class CsvOptions {
  ...
  private static final CsvOptions theDefault = CsvOptions.create(Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(CsvDelimiter._typeDescriptor()), Wrappers_Compile.Option.<dafny.DafnySequence<? extends dafny.DafnySequence<? extends Character>>>Default(CsvHeaderList._typeDescriptor()));
