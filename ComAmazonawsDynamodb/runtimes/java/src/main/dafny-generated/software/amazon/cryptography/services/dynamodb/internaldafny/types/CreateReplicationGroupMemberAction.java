...
// Dafny class CreateReplicationGroupMemberAction compiled into Java
...
public class CreateReplicationGroupMemberAction {
  ...
  public boolean equals(Object other) {
    ...
    CreateReplicationGroupMemberAction o = (CreateReplicationGroupMemberAction)other;
  ...
  public String toString() {
    ...
    s.append("ComAmazonawsDynamodbTypes.CreateReplicationGroupMemberAction.CreateReplicationGroupMemberAction");
    s.append("(");
  ...
  private static final dafny.TypeDescriptor<CreateReplicationGroupMemberAction> _TYPE = dafny.TypeDescriptor.<CreateReplicationGroupMemberAction>referenceWithInitializer(CreateReplicationGroupMemberAction.class, () -> CreateReplicationGroupMemberAction.Default());
  public static dafny.TypeDescriptor<CreateReplicationGroupMemberAction> _typeDescriptor() {
    return (dafny.TypeDescriptor<CreateReplicationGroupMemberAction>) (dafny.TypeDescriptor<?>) _TYPE;
  }

  private static final CreateReplicationGroupMemberAction theDefault = software.amazon.cryptography.services.dynamodb.internaldafny.types.CreateReplicationGroupMemberAction.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR), Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR)), Wrappers_Compile.Option.<ProvisionedThroughputOverride>Default(ProvisionedThroughputOverride._typeDescriptor()), Wrappers_Compile.Option.<OnDemandThroughputOverride>Default(OnDemandThroughputOverride._typeDescriptor()), Wrappers_Compile.Option.<dafny.DafnySequence<? extends ReplicaGlobalSecondaryIndex>>Default(ReplicaGlobalSecondaryIndexList._typeDescriptor()), Wrappers_Compile.Option.<TableClass>Default(TableClass._typeDescriptor()));
  ...
  public static CreateReplicationGroupMemberAction create(dafny.DafnySequence<? extends Character> RegionName, Wrappers_Compile.Option<dafny.DafnySequence<? extends Character>> KMSMasterKeyId, Wrappers_Compile.Option<ProvisionedThroughputOverride> ProvisionedThroughputOverride, Wrappers_Compile.Option<OnDemandThroughputOverride> OnDemandThroughputOverride, Wrappers_Compile.Option<dafny.DafnySequence<? extends ReplicaGlobalSecondaryIndex>> GlobalSecondaryIndexes, Wrappers_Compile.Option<TableClass> TableClassOverride) {
    return new CreateReplicationGroupMemberAction(RegionName, KMSMasterKeyId, ProvisionedThroughputOverride, OnDemandThroughputOverride, GlobalSecondaryIndexes, TableClassOverride);
  }
  public static CreateReplicationGroupMemberAction create_CreateReplicationGroupMemberAction(dafny.DafnySequence<? extends Character> RegionName, Wrappers_Compile.Option<dafny.DafnySequence<? extends Character>> KMSMasterKeyId, Wrappers_Compile.Option<ProvisionedThroughputOverride> ProvisionedThroughputOverride, Wrappers_Compile.Option<OnDemandThroughputOverride> OnDemandThroughputOverride, Wrappers_Compile.Option<dafny.DafnySequence<? extends ReplicaGlobalSecondaryIndex>> GlobalSecondaryIndexes, Wrappers_Compile.Option<TableClass> TableClassOverride) {
  ...
  public boolean is_CreateReplicationGroupMemberAction() { return true; }
