...
// Dafny class UpdateItemInput compiled into Java
...
public class UpdateItemInput {
  ...
  public Wrappers_Compile.Option<dafny.DafnyMap<? extends dafny.DafnySequence<? extends Character>, ? extends AttributeValueUpdate>> _AttributeUpdates;
  ...
  public Wrappers_Compile.Option<dafny.DafnySequence<? extends Character>> _UpdateExpression;
  ...
  public UpdateItemInput (dafny.DafnySequence<? extends Character> TableName, dafny.DafnyMap<? extends dafny.DafnySequence<? extends Character>, ? extends AttributeValue> Key, Wrappers_Compile.Option<dafny.DafnyMap<? extends dafny.DafnySequence<? extends Character>, ? extends AttributeValueUpdate>> AttributeUpdates, Wrappers_Compile.Option<dafny.DafnyMap<? extends dafny.DafnySequence<? extends Character>, ? extends ExpectedAttributeValue>> Expected, Wrappers_Compile.Option<ConditionalOperator> ConditionalOperator, Wrappers_Compile.Option<ReturnValue> ReturnValues, Wrappers_Compile.Option<ReturnConsumedCapacity> ReturnConsumedCapacity, Wrappers_Compile.Option<ReturnItemCollectionMetrics> ReturnItemCollectionMetrics, Wrappers_Compile.Option<dafny.DafnySequence<? extends Character>> UpdateExpression, Wrappers_Compile.Option<dafny.DafnySequence<? extends Character>> ConditionExpression, Wrappers_Compile.Option<dafny.DafnyMap<? extends dafny.DafnySequence<? extends Character>, ? extends dafny.DafnySequence<? extends Character>>> ExpressionAttributeNames, Wrappers_Compile.Option<dafny.DafnyMap<? extends dafny.DafnySequence<? extends Character>, ? extends AttributeValue>> ExpressionAttributeValues, Wrappers_Compile.Option<ReturnValuesOnConditionCheckFailure> ReturnValuesOnConditionCheckFailure) {
    this._TableName = TableName;
    this._Key = Key;
    this._AttributeUpdates = AttributeUpdates;
  ...
  public boolean equals(Object other) {
    ...
    UpdateItemInput o = (UpdateItemInput)other;
    return true && java.util.Objects.equals(this._TableName, o._TableName) && java.util.Objects.equals(this._Key, o._Key) && java.util.Objects.equals(this._AttributeUpdates, o._AttributeUpdates) && java.util.Objects.equals(this._Expected, o._Expected) && java.util.Objects.equals(this._ConditionalOperator, o._ConditionalOperator) && java.util.Objects.equals(this._ReturnValues, o._ReturnValues) && java.util.Objects.equals(this._ReturnConsumedCapacity, o._ReturnConsumedCapacity) && java.util.Objects.equals(this._ReturnItemCollectionMetrics, o._ReturnItemCollectionMetrics) && java.util.Objects.equals(this._UpdateExpression, o._UpdateExpression) && java.util.Objects.equals(this._ConditionExpression, o._ConditionExpression) && java.util.Objects.equals(this._ExpressionAttributeNames, o._ExpressionAttributeNames) && java.util.Objects.equals(this._ExpressionAttributeValues, o._ExpressionAttributeValues) && java.util.Objects.equals(this._ReturnValuesOnConditionCheckFailure, o._ReturnValuesOnConditionCheckFailure);
  }
  @Override
  public int hashCode() {
    long hash = 5381;
    ...
    hash = ((hash << 5) + hash) + java.util.Objects.hashCode(this._AttributeUpdates);
    ...
    hash = ((hash << 5) + hash) + java.util.Objects.hashCode(this._UpdateExpression);
  ...
  public String toString() {
    ...
    s.append("ComAmazonawsDynamodbTypes.UpdateItemInput.UpdateItemInput");
    s.append("(");
    s.append(dafny.Helpers.toString(this._TableName));
    s.append(", ");
    s.append(dafny.Helpers.toString(this._Key));
    s.append(", ");
    s.append(dafny.Helpers.toString(this._AttributeUpdates));
    s.append(", ");
    ...
    s.append(", ");
    s.append(dafny.Helpers.toString(this._UpdateExpression));
    s.append(", ");
  ...
  public static UpdateItemInput create(dafny.DafnySequence<? extends Character> TableName, dafny.DafnyMap<? extends dafny.DafnySequence<? extends Character>, ? extends AttributeValue> Key, Wrappers_Compile.Option<dafny.DafnyMap<? extends dafny.DafnySequence<? extends Character>, ? extends AttributeValueUpdate>> AttributeUpdates, Wrappers_Compile.Option<dafny.DafnyMap<? extends dafny.DafnySequence<? extends Character>, ? extends ExpectedAttributeValue>> Expected, Wrappers_Compile.Option<ConditionalOperator> ConditionalOperator, Wrappers_Compile.Option<ReturnValue> ReturnValues, Wrappers_Compile.Option<ReturnConsumedCapacity> ReturnConsumedCapacity, Wrappers_Compile.Option<ReturnItemCollectionMetrics> ReturnItemCollectionMetrics, Wrappers_Compile.Option<dafny.DafnySequence<? extends Character>> UpdateExpression, Wrappers_Compile.Option<dafny.DafnySequence<? extends Character>> ConditionExpression, Wrappers_Compile.Option<dafny.DafnyMap<? extends dafny.DafnySequence<? extends Character>, ? extends dafny.DafnySequence<? extends Character>>> ExpressionAttributeNames, Wrappers_Compile.Option<dafny.DafnyMap<? extends dafny.DafnySequence<? extends Character>, ? extends AttributeValue>> ExpressionAttributeValues, Wrappers_Compile.Option<ReturnValuesOnConditionCheckFailure> ReturnValuesOnConditionCheckFailure) {
    return new UpdateItemInput(TableName, Key, AttributeUpdates, Expected, ConditionalOperator, ReturnValues, ReturnConsumedCapacity, ReturnItemCollectionMetrics, UpdateExpression, ConditionExpression, ExpressionAttributeNames, ExpressionAttributeValues, ReturnValuesOnConditionCheckFailure);
  }
  public static UpdateItemInput create_UpdateItemInput(dafny.DafnySequence<? extends Character> TableName, dafny.DafnyMap<? extends dafny.DafnySequence<? extends Character>, ? extends AttributeValue> Key, Wrappers_Compile.Option<dafny.DafnyMap<? extends dafny.DafnySequence<? extends Character>, ? extends AttributeValueUpdate>> AttributeUpdates, Wrappers_Compile.Option<dafny.DafnyMap<? extends dafny.DafnySequence<? extends Character>, ? extends ExpectedAttributeValue>> Expected, Wrappers_Compile.Option<ConditionalOperator> ConditionalOperator, Wrappers_Compile.Option<ReturnValue> ReturnValues, Wrappers_Compile.Option<ReturnConsumedCapacity> ReturnConsumedCapacity, Wrappers_Compile.Option<ReturnItemCollectionMetrics> ReturnItemCollectionMetrics, Wrappers_Compile.Option<dafny.DafnySequence<? extends Character>> UpdateExpression, Wrappers_Compile.Option<dafny.DafnySequence<? extends Character>> ConditionExpression, Wrappers_Compile.Option<dafny.DafnyMap<? extends dafny.DafnySequence<? extends Character>, ? extends dafny.DafnySequence<? extends Character>>> ExpressionAttributeNames, Wrappers_Compile.Option<dafny.DafnyMap<? extends dafny.DafnySequence<? extends Character>, ? extends AttributeValue>> ExpressionAttributeValues, Wrappers_Compile.Option<ReturnValuesOnConditionCheckFailure> ReturnValuesOnConditionCheckFailure) {
    return create(TableName, Key, AttributeUpdates, Expected, ConditionalOperator, ReturnValues, ReturnConsumedCapacity, ReturnItemCollectionMetrics, UpdateExpression, ConditionExpression, ExpressionAttributeNames, ExpressionAttributeValues, ReturnValuesOnConditionCheckFailure);
  }
  public boolean is_UpdateItemInput() { return true; }
  ...
  public Wrappers_Compile.Option<dafny.DafnyMap<? extends dafny.DafnySequence<? extends Character>, ? extends AttributeValueUpdate>> dtor_AttributeUpdates() {
  ...
  public Wrappers_Compile.Option<dafny.DafnySequence<? extends Character>> dtor_UpdateExpression() {
