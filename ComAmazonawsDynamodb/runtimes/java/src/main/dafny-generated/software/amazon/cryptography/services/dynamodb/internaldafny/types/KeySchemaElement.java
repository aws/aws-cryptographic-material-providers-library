...
public class KeySchemaElement {
  ...
  private static final KeySchemaElement theDefault = KeySchemaElement.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR), KeyType.Default());
