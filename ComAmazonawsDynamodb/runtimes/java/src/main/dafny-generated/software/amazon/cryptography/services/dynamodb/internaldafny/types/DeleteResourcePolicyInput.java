...
public class DeleteResourcePolicyInput {
  ...
  private static final DeleteResourcePolicyInput theDefault = DeleteResourcePolicyInput.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR), Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(PolicyRevisionId._typeDescriptor()));
