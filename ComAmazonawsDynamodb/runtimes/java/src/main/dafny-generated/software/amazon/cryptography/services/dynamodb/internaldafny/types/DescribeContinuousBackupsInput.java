...
public class DescribeContinuousBackupsInput {
  ...
  private static final DescribeContinuousBackupsInput theDefault = software.amazon.cryptography.services.dynamodb.internaldafny.types.DescribeContinuousBackupsInput.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR));
