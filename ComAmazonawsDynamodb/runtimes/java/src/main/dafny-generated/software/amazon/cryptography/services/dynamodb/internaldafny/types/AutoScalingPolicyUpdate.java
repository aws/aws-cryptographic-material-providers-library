...
public class AutoScalingPolicyUpdate {
  ...
  private static final AutoScalingPolicyUpdate theDefault = software.amazon.cryptography.services.dynamodb.internaldafny.types.AutoScalingPolicyUpdate.create(Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(AutoScalingPolicyName._typeDescriptor()), AutoScalingTargetTrackingScalingPolicyConfigurationUpdate.Default());
