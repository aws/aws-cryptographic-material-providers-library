...
public class ReplicaUpdate {
  ...
  private static final ReplicaUpdate theDefault = ReplicaUpdate.create(Wrappers_Compile.Option.<CreateReplicaAction>Default(CreateReplicaAction._typeDescriptor()), Wrappers_Compile.Option.<DeleteReplicaAction>Default(DeleteReplicaAction._typeDescriptor()));
