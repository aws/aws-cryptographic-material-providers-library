...
public class UntagResourceInput {
  ...
  private static final UntagResourceInput theDefault = UntagResourceInput.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR), dafny.DafnySequence.<dafny.DafnySequence<? extends Character>> empty(TagKeyString._typeDescriptor()));
