...
public class DeleteBackupOutput {
  ...
  private static final DeleteBackupOutput theDefault = software.amazon.cryptography.services.dynamodb.internaldafny.types.DeleteBackupOutput.create(Wrappers_Compile.Option.<BackupDescription>Default(BackupDescription._typeDescriptor()));
