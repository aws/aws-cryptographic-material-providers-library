// Class PutItemOutput
// Dafny class PutItemOutput compiled into Java
...
public class PutItemOutput {
  ...
  public PutItemOutput (Wrappers_Compile.Option<dafny.DafnyMap<? extends dafny.DafnySequence<? extends Character>, ? extends AttributeValue>> Attributes, Wrappers_Compile.Option<ConsumedCapacity> ConsumedCapacity, Wrappers_Compile.Option<ItemCollectionMetrics> ItemCollectionMetrics) {
  ...
  public boolean equals(Object other) {
    ...
    PutItemOutput o = (PutItemOutput)other;
  ...
  public String toString() {
    ...
    s.append("ComAmazonawsDynamodbTypes.PutItemOutput.PutItemOutput");
    s.append("(");
  ...
  private static final dafny.TypeDescriptor<PutItemOutput> _TYPE = dafny.TypeDescriptor.<PutItemOutput>referenceWithInitializer(PutItemOutput.class, () -> PutItemOutput.Default());
  public static dafny.TypeDescriptor<PutItemOutput> _typeDescriptor() {
    return (dafny.TypeDescriptor<PutItemOutput>) (dafny.TypeDescriptor<?>) _TYPE;
  }

  private static final PutItemOutput theDefault = software.amazon.cryptography.services.dynamodb.internaldafny.types.PutItemOutput.create(Wrappers_Compile.Option.<dafny.DafnyMap<? extends dafny.DafnySequence<? extends Character>, ? extends AttributeValue>>Default(dafny.DafnyMap.<dafny.DafnySequence<? extends Character>, AttributeValue>_typeDescriptor(AttributeName._typeDescriptor(), AttributeValue._typeDescriptor())), Wrappers_Compile.Option.<ConsumedCapacity>Default(ConsumedCapacity._typeDescriptor()), Wrappers_Compile.Option.<ItemCollectionMetrics>Default(ItemCollectionMetrics._typeDescriptor()));
  public static PutItemOutput Default() {
    return theDefault;
  }
  public static PutItemOutput create(Wrappers_Compile.Option<dafny.DafnyMap<? extends dafny.DafnySequence<? extends Character>, ? extends AttributeValue>> Attributes, Wrappers_Compile.Option<ConsumedCapacity> ConsumedCapacity, Wrappers_Compile.Option<ItemCollectionMetrics> ItemCollectionMetrics) {
    return new PutItemOutput(Attributes, ConsumedCapacity, ItemCollectionMetrics);
  }
  public static PutItemOutput create_PutItemOutput(Wrappers_Compile.Option<dafny.DafnyMap<? extends dafny.DafnySequence<? extends Character>, ? extends AttributeValue>> Attributes, Wrappers_Compile.Option<ConsumedCapacity> ConsumedCapacity, Wrappers_Compile.Option<ItemCollectionMetrics> ItemCollectionMetrics) {
    return create(Attributes, ConsumedCapacity, ItemCollectionMetrics);
  }
  public boolean is_PutItemOutput() { return true; }
