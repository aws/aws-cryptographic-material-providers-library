...
public class DescribeExportOutput {
  ...
  private static final DescribeExportOutput theDefault = DescribeExportOutput.create(Wrappers_Compile.Option.<ExportDescription>Default(ExportDescription._typeDescriptor()));
