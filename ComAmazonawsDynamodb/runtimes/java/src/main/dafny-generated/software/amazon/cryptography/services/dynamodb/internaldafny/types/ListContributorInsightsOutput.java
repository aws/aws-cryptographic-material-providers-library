...
public class ListContributorInsightsOutput {
  ...
  private static final ListContributorInsightsOutput theDefault = ListContributorInsightsOutput.create(Wrappers_Compile.Option.<dafny.DafnySequence<? extends ContributorInsightsSummary>>Default(dafny.DafnySequence.<ContributorInsightsSummary>_typeDescriptor(ContributorInsightsSummary._typeDescriptor())), Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR)));
