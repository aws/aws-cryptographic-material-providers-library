...
public class ExecuteTransactionInput {
  ...
  private static final ExecuteTransactionInput theDefault = software.amazon.cryptography.services.dynamodb.internaldafny.types.ExecuteTransactionInput.create(dafny.DafnySequence.<ParameterizedStatement> empty(ParameterizedStatement._typeDescriptor()), Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(ClientRequestToken._typeDescriptor()), Wrappers_Compile.Option.<ReturnConsumedCapacity>Default(ReturnConsumedCapacity._typeDescriptor()));
