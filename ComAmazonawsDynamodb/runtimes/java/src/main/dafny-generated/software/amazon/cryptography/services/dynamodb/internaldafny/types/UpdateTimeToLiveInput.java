...
public class UpdateTimeToLiveInput {
  ...
  private static final UpdateTimeToLiveInput theDefault = software.amazon.cryptography.services.dynamodb.internaldafny.types.UpdateTimeToLiveInput.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR), TimeToLiveSpecification.Default());
