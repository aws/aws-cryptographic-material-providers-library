...
public class UpdateContinuousBackupsInput {
  ...
  private static final UpdateContinuousBackupsInput theDefault = UpdateContinuousBackupsInput.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR), PointInTimeRecoverySpecification.Default());
