...
public class DescribeGlobalTableInput {
  ...
  private static final DescribeGlobalTableInput theDefault = DescribeGlobalTableInput.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR));
