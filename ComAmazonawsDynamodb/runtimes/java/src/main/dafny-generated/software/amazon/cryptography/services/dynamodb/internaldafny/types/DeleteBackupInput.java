...
public class DeleteBackupInput {
  ...
  private static final DeleteBackupInput theDefault = software.amazon.cryptography.services.dynamodb.internaldafny.types.DeleteBackupInput.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR));
