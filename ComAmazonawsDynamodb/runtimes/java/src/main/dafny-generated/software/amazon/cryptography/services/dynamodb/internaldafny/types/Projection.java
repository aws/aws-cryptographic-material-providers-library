...
public class Projection {
  ...
  private static final Projection theDefault = software.amazon.cryptography.services.dynamodb.internaldafny.types.Projection.create(Wrappers_Compile.Option.<ProjectionType>Default(ProjectionType._typeDescriptor()), Wrappers_Compile.Option.<dafny.DafnySequence<? extends dafny.DafnySequence<? extends Character>>>Default(NonKeyAttributeNameList._typeDescriptor()));
