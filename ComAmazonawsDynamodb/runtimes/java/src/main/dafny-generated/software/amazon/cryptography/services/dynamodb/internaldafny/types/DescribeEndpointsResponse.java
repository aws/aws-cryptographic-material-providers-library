...
public class DescribeEndpointsResponse {
  ...
  private static final DescribeEndpointsResponse theDefault = DescribeEndpointsResponse.create(dafny.DafnySequence.<Endpoint> empty(Endpoint._typeDescriptor()));
