...
public class ReplicaGlobalSecondaryIndexAutoScalingUpdate {
  ...
  private static final ReplicaGlobalSecondaryIndexAutoScalingUpdate theDefault = ReplicaGlobalSecondaryIndexAutoScalingUpdate.create(Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(IndexName._typeDescriptor()), Wrappers_Compile.Option.<AutoScalingSettingsUpdate>Default(AutoScalingSettingsUpdate._typeDescriptor()));
