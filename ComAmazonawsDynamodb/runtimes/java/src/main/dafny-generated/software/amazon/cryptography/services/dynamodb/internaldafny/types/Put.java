// Class Put
// Dafny class Put compiled into Java
...
public class Put {
  ...
  public boolean equals(Object other) {
    ...
    Put o = (Put)other;
    return true && java.util.Objects.equals(this._Item, o._Item) && java.util.Objects.equals(this._TableName, o._TableName) && java.util.Objects.equals(this._ConditionExpression, o._ConditionExpression) && java.util.Objects.equals(this._ExpressionAttributeNames, o._ExpressionAttributeNames) && java.util.Objects.equals(this._ExpressionAttributeValues, o._ExpressionAttributeValues) && java.util.Objects.equals(this._ReturnValuesOnConditionCheckFailure, o._ReturnValuesOnConditionCheckFailure);
  }
  @Override
  public int hashCode() {
    long hash = 5381;
  ...
  public String toString() {
    ...
    s.append("ComAmazonawsDynamodbTypes.Put.Put");
    s.append("(");
  ...
  public static Put create_Put(dafny.DafnyMap<? extends dafny.DafnySequence<? extends Character>, ? extends AttributeValue> Item, dafny.DafnySequence<? extends Character> TableName, Wrappers_Compile.Option<dafny.DafnySequence<? extends Character>> ConditionExpression, Wrappers_Compile.Option<dafny.DafnyMap<? extends dafny.DafnySequence<? extends Character>, ? extends dafny.DafnySequence<? extends Character>>> ExpressionAttributeNames, Wrappers_Compile.Option<dafny.DafnyMap<? extends dafny.DafnySequence<? extends Character>, ? extends AttributeValue>> ExpressionAttributeValues, Wrappers_Compile.Option<ReturnValuesOnConditionCheckFailure> ReturnValuesOnConditionCheckFailure) {
    return create(Item, TableName, ConditionExpression, ExpressionAttributeNames, ExpressionAttributeValues, ReturnValuesOnConditionCheckFailure);
  }
  public boolean is_Put() { return true; }
