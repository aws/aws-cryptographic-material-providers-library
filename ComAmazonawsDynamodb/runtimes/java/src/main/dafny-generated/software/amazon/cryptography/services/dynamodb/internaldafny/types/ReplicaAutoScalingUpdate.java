...
public class ReplicaAutoScalingUpdate {
  ...
  private static final ReplicaAutoScalingUpdate theDefault = software.amazon.cryptography.services.dynamodb.internaldafny.types.ReplicaAutoScalingUpdate.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR), Wrappers_Compile.Option.<dafny.DafnySequence<? extends ReplicaGlobalSecondaryIndexAutoScalingUpdate>>Default(dafny.DafnySequence.<ReplicaGlobalSecondaryIndexAutoScalingUpdate>_typeDescriptor(ReplicaGlobalSecondaryIndexAutoScalingUpdate._typeDescriptor())), Wrappers_Compile.Option.<AutoScalingSettingsUpdate>Default(AutoScalingSettingsUpdate._typeDescriptor()));
