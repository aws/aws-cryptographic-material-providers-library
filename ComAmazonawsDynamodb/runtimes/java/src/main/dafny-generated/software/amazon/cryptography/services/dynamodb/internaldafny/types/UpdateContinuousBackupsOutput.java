...
public class UpdateContinuousBackupsOutput {
  ...
  private static final UpdateContinuousBackupsOutput theDefault = UpdateContinuousBackupsOutput.create(Wrappers_Compile.Option.<ContinuousBackupsDescription>Default(ContinuousBackupsDescription._typeDescriptor()));
