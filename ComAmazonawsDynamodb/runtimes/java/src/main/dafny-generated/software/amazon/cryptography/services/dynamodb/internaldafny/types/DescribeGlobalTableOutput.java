...
public class DescribeGlobalTableOutput {
  ...
  private static final DescribeGlobalTableOutput theDefault = software.amazon.cryptography.services.dynamodb.internaldafny.types.DescribeGlobalTableOutput.create(Wrappers_Compile.Option.<GlobalTableDescription>Default(GlobalTableDescription._typeDescriptor()));
