...
public class ListTablesInput {
  ...
  private static final ListTablesInput theDefault = ListTablesInput.create(Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(TableName._typeDescriptor()), Wrappers_Compile.Option.<java.lang.Integer>Default(ListTablesInputLimit._typeDescriptor()));
