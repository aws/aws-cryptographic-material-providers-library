...
public class AttributeValueUpdate {
  ...
  private static final AttributeValueUpdate theDefault = AttributeValueUpdate.create(Wrappers_Compile.Option.<AttributeValue>Default(AttributeValue._typeDescriptor()), Wrappers_Compile.Option.<AttributeAction>Default(AttributeAction._typeDescriptor()));
