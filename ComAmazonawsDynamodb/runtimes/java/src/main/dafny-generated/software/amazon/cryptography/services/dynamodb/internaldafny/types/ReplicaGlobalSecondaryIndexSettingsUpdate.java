...
public class ReplicaGlobalSecondaryIndexSettingsUpdate {
  ...
  private static final ReplicaGlobalSecondaryIndexSettingsUpdate theDefault = ReplicaGlobalSecondaryIndexSettingsUpdate.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR), Wrappers_Compile.Option.<java.lang.Long>Default(PositiveLongObject._typeDescriptor()), Wrappers_Compile.Option.<AutoScalingSettingsUpdate>Default(AutoScalingSettingsUpdate._typeDescriptor()));
