...
public class UpdateContributorInsightsInput {
  ...
  private static final UpdateContributorInsightsInput theDefault = UpdateContributorInsightsInput.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR), Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(IndexName._typeDescriptor()), ContributorInsightsAction.Default());
