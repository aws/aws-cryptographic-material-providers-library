...
public class ExportSummary {
  ...
  private static final ExportSummary theDefault = software.amazon.cryptography.services.dynamodb.internaldafny.types.ExportSummary.create(Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(ExportArn._typeDescriptor()), Wrappers_Compile.Option.<ExportStatus>Default(ExportStatus._typeDescriptor()), Wrappers_Compile.Option.<ExportType>Default(ExportType._typeDescriptor()));
