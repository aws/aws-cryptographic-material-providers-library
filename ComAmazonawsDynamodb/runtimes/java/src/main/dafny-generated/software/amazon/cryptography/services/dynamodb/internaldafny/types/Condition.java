...
public class Condition {
  ...
  private static final Condition theDefault = software.amazon.cryptography.services.dynamodb.internaldafny.types.Condition.create(Wrappers_Compile.Option.<dafny.DafnySequence<? extends AttributeValue>>Default(dafny.DafnySequence.<AttributeValue>_typeDescriptor(AttributeValue._typeDescriptor())), ComparisonOperator.Default());
