...
public class TimeToLiveSpecification {
  ...
  private static final TimeToLiveSpecification theDefault = software.amazon.cryptography.services.dynamodb.internaldafny.types.TimeToLiveSpecification.create(false, dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR));
