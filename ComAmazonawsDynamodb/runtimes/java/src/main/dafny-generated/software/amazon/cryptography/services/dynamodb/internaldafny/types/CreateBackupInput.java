...
public class CreateBackupInput {
  ...
  private static final CreateBackupInput theDefault = CreateBackupInput.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR), dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR));
