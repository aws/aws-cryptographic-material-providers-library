...
public class ExportTableToPointInTimeOutput {
  ...
  private static final ExportTableToPointInTimeOutput theDefault = ExportTableToPointInTimeOutput.create(Wrappers_Compile.Option.<ExportDescription>Default(ExportDescription._typeDescriptor()));
