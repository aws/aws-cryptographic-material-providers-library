...
public class CreateBackupOutput {
  ...
  private static final CreateBackupOutput theDefault = software.amazon.cryptography.services.dynamodb.internaldafny.types.CreateBackupOutput.create(Wrappers_Compile.Option.<BackupDetails>Default(BackupDetails._typeDescriptor()));
