...
public class DescribeTimeToLiveOutput {
  ...
  private static final DescribeTimeToLiveOutput theDefault = DescribeTimeToLiveOutput.create(Wrappers_Compile.Option.<TimeToLiveDescription>Default(TimeToLiveDescription._typeDescriptor()));
