...
public class UpdateTimeToLiveOutput {
  ...
  private static final UpdateTimeToLiveOutput theDefault = software.amazon.cryptography.services.dynamodb.internaldafny.types.UpdateTimeToLiveOutput.create(Wrappers_Compile.Option.<TimeToLiveSpecification>Default(TimeToLiveSpecification._typeDescriptor()));
