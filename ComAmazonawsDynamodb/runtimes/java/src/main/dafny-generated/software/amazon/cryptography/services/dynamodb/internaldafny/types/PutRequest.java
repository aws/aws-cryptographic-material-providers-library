...
public class PutRequest {
  ...
  private static final PutRequest theDefault = software.amazon.cryptography.services.dynamodb.internaldafny.types.PutRequest.create(dafny.DafnyMap.<dafny.DafnySequence<? extends Character>,AttributeValue> empty());
