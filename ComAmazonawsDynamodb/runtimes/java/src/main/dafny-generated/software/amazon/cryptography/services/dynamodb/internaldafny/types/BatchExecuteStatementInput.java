...
public class BatchExecuteStatementInput {
  ...
  private static final BatchExecuteStatementInput theDefault = software.amazon.cryptography.services.dynamodb.internaldafny.types.BatchExecuteStatementInput.create(dafny.DafnySequence.<BatchStatementRequest> empty(BatchStatementRequest._typeDescriptor()), Wrappers_Compile.Option.<ReturnConsumedCapacity>Default(ReturnConsumedCapacity._typeDescriptor()));
