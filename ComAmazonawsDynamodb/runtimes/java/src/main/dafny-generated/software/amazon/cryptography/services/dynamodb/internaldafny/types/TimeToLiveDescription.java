...
public class TimeToLiveDescription {
  ...
  private static final TimeToLiveDescription theDefault = TimeToLiveDescription.create(Wrappers_Compile.Option.<TimeToLiveStatus>Default(TimeToLiveStatus._typeDescriptor()), Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(TimeToLiveAttributeName._typeDescriptor()));
