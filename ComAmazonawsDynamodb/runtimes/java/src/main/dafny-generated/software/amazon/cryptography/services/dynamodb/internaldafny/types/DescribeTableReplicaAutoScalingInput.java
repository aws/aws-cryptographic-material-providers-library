...
public class DescribeTableReplicaAutoScalingInput {
  ...
  private static final DescribeTableReplicaAutoScalingInput theDefault = DescribeTableReplicaAutoScalingInput.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR));
