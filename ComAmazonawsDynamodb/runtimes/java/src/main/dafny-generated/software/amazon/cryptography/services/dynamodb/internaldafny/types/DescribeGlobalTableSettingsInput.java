...
public class DescribeGlobalTableSettingsInput {
  ...
  private static final DescribeGlobalTableSettingsInput theDefault = DescribeGlobalTableSettingsInput.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR));
