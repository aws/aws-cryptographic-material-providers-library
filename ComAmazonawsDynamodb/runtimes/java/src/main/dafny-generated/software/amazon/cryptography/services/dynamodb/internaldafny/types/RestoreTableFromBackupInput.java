...
public class RestoreTableFromBackupInput {
  ...
  private static final RestoreTableFromBackupInput theDefault = RestoreTableFromBackupInput.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR), dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR), Wrappers_Compile.Option.<BillingMode>Default(BillingMode._typeDescriptor()), Wrappers_Compile.Option.<dafny.DafnySequence<? extends GlobalSecondaryIndex>>Default(dafny.DafnySequence.<GlobalSecondaryIndex>_typeDescriptor(GlobalSecondaryIndex._typeDescriptor())), Wrappers_Compile.Option.<dafny.DafnySequence<? extends LocalSecondaryIndex>>Default(dafny.DafnySequence.<LocalSecondaryIndex>_typeDescriptor(LocalSecondaryIndex._typeDescriptor())), Wrappers_Compile.Option.<ProvisionedThroughput>Default(ProvisionedThroughput._typeDescriptor()), Wrappers_Compile.Option.<OnDemandThroughput>Default(OnDemandThroughput._typeDescriptor()), Wrappers_Compile.Option.<SSESpecification>Default(SSESpecification._typeDescriptor()));
