...
public class ParameterizedStatement {
  ...
  private static final ParameterizedStatement theDefault = ParameterizedStatement.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR), Wrappers_Compile.Option.<dafny.DafnySequence<? extends AttributeValue>>Default(PreparedStatementParameters._typeDescriptor()), Wrappers_Compile.Option.<ReturnValuesOnConditionCheckFailure>Default(ReturnValuesOnConditionCheckFailure._typeDescriptor()));
