...
public class GlobalTable {
  ...
  private static final GlobalTable theDefault = GlobalTable.create(Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(TableName._typeDescriptor()), Wrappers_Compile.Option.<dafny.DafnySequence<? extends Replica>>Default(dafny.DafnySequence.<Replica>_typeDescriptor(Replica._typeDescriptor())));
