// Class PutItemInput
// Dafny class PutItemInput compiled into Java
...
public class PutItemInput {
  ...
  public PutItemInput (dafny.DafnySequence<? extends Character> TableName, dafny.DafnyMap<? extends dafny.DafnySequence<? extends Character>, ? extends AttributeValue> Item, Wrappers_Compile.Option<dafny.DafnyMap<? extends dafny.DafnySequence<? extends Character>, ? extends ExpectedAttributeValue>> Expected, Wrappers_Compile.Option<ReturnValue> ReturnValues, Wrappers_Compile.Option<ReturnConsumedCapacity> ReturnConsumedCapacity, Wrappers_Compile.Option<ReturnItemCollectionMetrics> ReturnItemCollectionMetrics, Wrappers_Compile.Option<ConditionalOperator> ConditionalOperator, Wrappers_Compile.Option<dafny.DafnySequence<? extends Character>> ConditionExpression, Wrappers_Compile.Option<dafny.DafnyMap<? extends dafny.DafnySequence<? extends Character>, ? extends dafny.DafnySequence<? extends Character>>> ExpressionAttributeNames, Wrappers_Compile.Option<dafny.DafnyMap<? extends dafny.DafnySequence<? extends Character>, ? extends AttributeValue>> ExpressionAttributeValues, Wrappers_Compile.Option<ReturnValuesOnConditionCheckFailure> ReturnValuesOnConditionCheckFailure) {
  ...
  public boolean equals(Object other) {
    ...
    PutItemInput o = (PutItemInput)other;
    return true && java.util.Objects.equals(this._TableName, o._TableName) && java.util.Objects.equals(this._Item, o._Item) && java.util.Objects.equals(this._Expected, o._Expected) && java.util.Objects.equals(this._ReturnValues, o._ReturnValues) && java.util.Objects.equals(this._ReturnConsumedCapacity, o._ReturnConsumedCapacity) && java.util.Objects.equals(this._ReturnItemCollectionMetrics, o._ReturnItemCollectionMetrics) && java.util.Objects.equals(this._ConditionalOperator, o._ConditionalOperator) && java.util.Objects.equals(this._ConditionExpression, o._ConditionExpression) && java.util.Objects.equals(this._ExpressionAttributeNames, o._ExpressionAttributeNames) && java.util.Objects.equals(this._ExpressionAttributeValues, o._ExpressionAttributeValues) && java.util.Objects.equals(this._ReturnValuesOnConditionCheckFailure, o._ReturnValuesOnConditionCheckFailure);
  }
  @Override
  public int hashCode() {
    long hash = 5381;
  ...
  public String toString() {
    ...
    s.append("ComAmazonawsDynamodbTypes.PutItemInput.PutItemInput");
    s.append("(");
  ...
  private static final dafny.TypeDescriptor<PutItemInput> _TYPE = dafny.TypeDescriptor.<PutItemInput>referenceWithInitializer(PutItemInput.class, () -> PutItemInput.Default());
  public static dafny.TypeDescriptor<PutItemInput> _typeDescriptor() {
    return (dafny.TypeDescriptor<PutItemInput>) (dafny.TypeDescriptor<?>) _TYPE;
  }

  private static final PutItemInput theDefault = software.amazon.cryptography.services.dynamodb.internaldafny.types.PutItemInput.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR), dafny.DafnyMap.<dafny.DafnySequence<? extends Character>,AttributeValue> empty(), Wrappers_Compile.Option.<dafny.DafnyMap<? extends dafny.DafnySequence<? extends Character>, ? extends ExpectedAttributeValue>>Default(dafny.DafnyMap.<dafny.DafnySequence<? extends Character>, ExpectedAttributeValue>_typeDescriptor(AttributeName._typeDescriptor(), ExpectedAttributeValue._typeDescriptor())), Wrappers_Compile.Option.<ReturnValue>Default(ReturnValue._typeDescriptor()), Wrappers_Compile.Option.<ReturnConsumedCapacity>Default(ReturnConsumedCapacity._typeDescriptor()), Wrappers_Compile.Option.<ReturnItemCollectionMetrics>Default(ReturnItemCollectionMetrics._typeDescriptor()), Wrappers_Compile.Option.<ConditionalOperator>Default(ConditionalOperator._typeDescriptor()), Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR)), Wrappers_Compile.Option.<dafny.DafnyMap<? extends dafny.DafnySequence<? extends Character>, ? extends dafny.DafnySequence<? extends Character>>>Default(dafny.DafnyMap.<dafny.DafnySequence<? extends Character>, dafny.DafnySequence<? extends Character>>_typeDescriptor(dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR), AttributeName._typeDescriptor())), Wrappers_Compile.Option.<dafny.DafnyMap<? extends dafny.DafnySequence<? extends Character>, ? extends AttributeValue>>Default(dafny.DafnyMap.<dafny.DafnySequence<? extends Character>, AttributeValue>_typeDescriptor(dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR), AttributeValue._typeDescriptor())), Wrappers_Compile.Option.<ReturnValuesOnConditionCheckFailure>Default(ReturnValuesOnConditionCheckFailure._typeDescriptor()));
  public static PutItemInput Default() {
    return theDefault;
  }
  public static PutItemInput create(dafny.DafnySequence<? extends Character> TableName, dafny.DafnyMap<? extends dafny.DafnySequence<? extends Character>, ? extends AttributeValue> Item, Wrappers_Compile.Option<dafny.DafnyMap<? extends dafny.DafnySequence<? extends Character>, ? extends ExpectedAttributeValue>> Expected, Wrappers_Compile.Option<ReturnValue> ReturnValues, Wrappers_Compile.Option<ReturnConsumedCapacity> ReturnConsumedCapacity, Wrappers_Compile.Option<ReturnItemCollectionMetrics> ReturnItemCollectionMetrics, Wrappers_Compile.Option<ConditionalOperator> ConditionalOperator, Wrappers_Compile.Option<dafny.DafnySequence<? extends Character>> ConditionExpression, Wrappers_Compile.Option<dafny.DafnyMap<? extends dafny.DafnySequence<? extends Character>, ? extends dafny.DafnySequence<? extends Character>>> ExpressionAttributeNames, Wrappers_Compile.Option<dafny.DafnyMap<? extends dafny.DafnySequence<? extends Character>, ? extends AttributeValue>> ExpressionAttributeValues, Wrappers_Compile.Option<ReturnValuesOnConditionCheckFailure> ReturnValuesOnConditionCheckFailure) {
    return new PutItemInput(TableName, Item, Expected, ReturnValues, ReturnConsumedCapacity, ReturnItemCollectionMetrics, ConditionalOperator, ConditionExpression, ExpressionAttributeNames, ExpressionAttributeValues, ReturnValuesOnConditionCheckFailure);
  }
  public static PutItemInput create_PutItemInput(dafny.DafnySequence<? extends Character> TableName, dafny.DafnyMap<? extends dafny.DafnySequence<? extends Character>, ? extends AttributeValue> Item, Wrappers_Compile.Option<dafny.DafnyMap<? extends dafny.DafnySequence<? extends Character>, ? extends ExpectedAttributeValue>> Expected, Wrappers_Compile.Option<ReturnValue> ReturnValues, Wrappers_Compile.Option<ReturnConsumedCapacity> ReturnConsumedCapacity, Wrappers_Compile.Option<ReturnItemCollectionMetrics> ReturnItemCollectionMetrics, Wrappers_Compile.Option<ConditionalOperator> ConditionalOperator, Wrappers_Compile.Option<dafny.DafnySequence<? extends Character>> ConditionExpression, Wrappers_Compile.Option<dafny.DafnyMap<? extends dafny.DafnySequence<? extends Character>, ? extends dafny.DafnySequence<? extends Character>>> ExpressionAttributeNames, Wrappers_Compile.Option<dafny.DafnyMap<? extends dafny.DafnySequence<? extends Character>, ? extends AttributeValue>> ExpressionAttributeValues, Wrappers_Compile.Option<ReturnValuesOnConditionCheckFailure> ReturnValuesOnConditionCheckFailure) {
    return create(TableName, Item, Expected, ReturnValues, ReturnConsumedCapacity, ReturnItemCollectionMetrics, ConditionalOperator, ConditionExpression, ExpressionAttributeNames, ExpressionAttributeValues, ReturnValuesOnConditionCheckFailure);
  }
  public boolean is_PutItemInput() { return true; }
