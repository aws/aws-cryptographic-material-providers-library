...
public class ImportTableOutput {
  ...
  private static final ImportTableOutput theDefault = software.amazon.cryptography.services.dynamodb.internaldafny.types.ImportTableOutput.create(ImportTableDescription.Default());
