...
public class TableClassSummary {
  ...
  private static final TableClassSummary theDefault = TableClassSummary.create(Wrappers_Compile.Option.<TableClass>Default(TableClass._typeDescriptor()), Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR)));
