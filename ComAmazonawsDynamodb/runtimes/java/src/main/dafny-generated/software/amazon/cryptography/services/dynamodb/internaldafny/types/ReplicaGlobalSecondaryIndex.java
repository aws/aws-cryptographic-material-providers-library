...
public class ReplicaGlobalSecondaryIndex {
  ...
  private static final ReplicaGlobalSecondaryIndex theDefault = software.amazon.cryptography.services.dynamodb.internaldafny.types.ReplicaGlobalSecondaryIndex.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR), Wrappers_Compile.Option.<ProvisionedThroughputOverride>Default(ProvisionedThroughputOverride._typeDescriptor()), Wrappers_Compile.Option.<OnDemandThroughputOverride>Default(OnDemandThroughputOverride._typeDescriptor()));
