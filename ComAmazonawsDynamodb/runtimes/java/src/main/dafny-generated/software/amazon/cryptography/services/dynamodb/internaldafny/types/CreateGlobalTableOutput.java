...
public class CreateGlobalTableOutput {
  ...
  private static final CreateGlobalTableOutput theDefault = software.amazon.cryptography.services.dynamodb.internaldafny.types.CreateGlobalTableOutput.create(Wrappers_Compile.Option.<GlobalTableDescription>Default(GlobalTableDescription._typeDescriptor()));
