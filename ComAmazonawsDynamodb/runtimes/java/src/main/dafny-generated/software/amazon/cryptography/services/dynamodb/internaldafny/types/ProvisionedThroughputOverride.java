...
public class ProvisionedThroughputOverride {
  ...
  private static final ProvisionedThroughputOverride theDefault = software.amazon.cryptography.services.dynamodb.internaldafny.types.ProvisionedThroughputOverride.create(Wrappers_Compile.Option.<java.lang.Long>Default(PositiveLongObject._typeDescriptor()));
