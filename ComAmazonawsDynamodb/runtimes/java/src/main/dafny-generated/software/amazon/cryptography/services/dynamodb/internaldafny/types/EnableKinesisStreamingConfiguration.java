...
public class EnableKinesisStreamingConfiguration {
  ...
  private static final EnableKinesisStreamingConfiguration theDefault = software.amazon.cryptography.services.dynamodb.internaldafny.types.EnableKinesisStreamingConfiguration.create(Wrappers_Compile.Option.<ApproximateCreationDateTimePrecision>Default(ApproximateCreationDateTimePrecision._typeDescriptor()));
