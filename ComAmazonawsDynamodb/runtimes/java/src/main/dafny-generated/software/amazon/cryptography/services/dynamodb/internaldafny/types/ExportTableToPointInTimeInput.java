...
public class ExportTableToPointInTimeInput {
  ...
  private static final ExportTableToPointInTimeInput theDefault = ExportTableToPointInTimeInput.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR), Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR)), Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR)), dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR), Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR)), Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(S3Prefix._typeDescriptor()), Wrappers_Compile.Option.<S3SseAlgorithm>Default(S3SseAlgorithm._typeDescriptor()), Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(S3SseKmsKeyId._typeDescriptor()), Wrappers_Compile.Option.<ExportFormat>Default(ExportFormat._typeDescriptor()), Wrappers_Compile.Option.<ExportType>Default(ExportType._typeDescriptor()), Wrappers_Compile.Option.<IncrementalExportSpecification>Default(IncrementalExportSpecification._typeDescriptor()));
