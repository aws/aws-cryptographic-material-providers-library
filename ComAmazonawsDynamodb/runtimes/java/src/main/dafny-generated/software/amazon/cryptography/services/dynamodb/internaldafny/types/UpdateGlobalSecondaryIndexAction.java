...
public class UpdateGlobalSecondaryIndexAction {
  ...
  private static final UpdateGlobalSecondaryIndexAction theDefault = UpdateGlobalSecondaryIndexAction.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR), Wrappers_Compile.Option.<ProvisionedThroughput>Default(ProvisionedThroughput._typeDescriptor()), Wrappers_Compile.Option.<OnDemandThroughput>Default(OnDemandThroughput._typeDescriptor()));
