...
public class ListImportsOutput {
  ...
  private static final ListImportsOutput theDefault = ListImportsOutput.create(Wrappers_Compile.Option.<dafny.DafnySequence<? extends ImportSummary>>Default(dafny.DafnySequence.<ImportSummary>_typeDescriptor(ImportSummary._typeDescriptor())), Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(ImportNextToken._typeDescriptor()));
