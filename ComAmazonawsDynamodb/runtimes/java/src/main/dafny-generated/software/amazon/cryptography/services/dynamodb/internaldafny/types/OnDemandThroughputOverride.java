...
public class OnDemandThroughputOverride {
  ...
  private static final OnDemandThroughputOverride theDefault = OnDemandThroughputOverride.create(Wrappers_Compile.Option.<java.lang.Long>Default(BoundedInts_Compile.int64._typeDescriptor()));
