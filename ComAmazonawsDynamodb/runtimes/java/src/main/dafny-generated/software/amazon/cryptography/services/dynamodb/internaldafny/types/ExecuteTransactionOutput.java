...
public class ExecuteTransactionOutput {
  ...
  private static final ExecuteTransactionOutput theDefault = software.amazon.cryptography.services.dynamodb.internaldafny.types.ExecuteTransactionOutput.create(Wrappers_Compile.Option.<dafny.DafnySequence<? extends ItemResponse>>Default(ItemResponseList._typeDescriptor()), Wrappers_Compile.Option.<dafny.DafnySequence<? extends ConsumedCapacity>>Default(dafny.DafnySequence.<ConsumedCapacity>_typeDescriptor(ConsumedCapacity._typeDescriptor())));
