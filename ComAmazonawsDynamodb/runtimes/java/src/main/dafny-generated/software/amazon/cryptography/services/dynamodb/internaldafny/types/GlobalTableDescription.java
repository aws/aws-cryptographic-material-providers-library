...
public class GlobalTableDescription {
  ...
  private static final GlobalTableDescription theDefault = GlobalTableDescription.create(Wrappers_Compile.Option.<dafny.DafnySequence<? extends ReplicaDescription>>Default(dafny.DafnySequence.<ReplicaDescription>_typeDescriptor(ReplicaDescription._typeDescriptor())), Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR)), Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR)), Wrappers_Compile.Option.<GlobalTableStatus>Default(GlobalTableStatus._typeDescriptor()), Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(TableName._typeDescriptor()));
