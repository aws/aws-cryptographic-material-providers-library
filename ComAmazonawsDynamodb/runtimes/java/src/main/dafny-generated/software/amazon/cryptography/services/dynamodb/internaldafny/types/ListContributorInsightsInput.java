...
public class ListContributorInsightsInput {
  ...
  private static final ListContributorInsightsInput theDefault = software.amazon.cryptography.services.dynamodb.internaldafny.types.ListContributorInsightsInput.create(Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(TableArn._typeDescriptor()), Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR)), Wrappers_Compile.Option.<java.lang.Integer>Default(ListContributorInsightsLimit._typeDescriptor()));
