...
public class UpdateTableReplicaAutoScalingOutput {
  ...
  private static final UpdateTableReplicaAutoScalingOutput theDefault = software.amazon.cryptography.services.dynamodb.internaldafny.types.UpdateTableReplicaAutoScalingOutput.create(Wrappers_Compile.Option.<TableAutoScalingDescription>Default(TableAutoScalingDescription._typeDescriptor()));
