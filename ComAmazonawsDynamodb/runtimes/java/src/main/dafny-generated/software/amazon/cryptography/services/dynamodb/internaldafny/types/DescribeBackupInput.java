...
public class DescribeBackupInput {
  ...
  private static final DescribeBackupInput theDefault = software.amazon.cryptography.services.dynamodb.internaldafny.types.DescribeBackupInput.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR));
