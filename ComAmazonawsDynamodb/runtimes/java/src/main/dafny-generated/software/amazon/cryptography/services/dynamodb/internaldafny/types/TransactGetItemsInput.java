...
public class TransactGetItemsInput {
  ...
  private static final TransactGetItemsInput theDefault = software.amazon.cryptography.services.dynamodb.internaldafny.types.TransactGetItemsInput.create(dafny.DafnySequence.<TransactGetItem> empty(TransactGetItem._typeDescriptor()), Wrappers_Compile.Option.<ReturnConsumedCapacity>Default(ReturnConsumedCapacity._typeDescriptor()));
