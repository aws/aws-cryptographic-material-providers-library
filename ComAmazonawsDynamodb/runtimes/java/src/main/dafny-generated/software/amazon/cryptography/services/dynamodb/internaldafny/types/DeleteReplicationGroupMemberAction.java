...
public class DeleteReplicationGroupMemberAction {
  ...
  private static final DeleteReplicationGroupMemberAction theDefault = DeleteReplicationGroupMemberAction.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR));
