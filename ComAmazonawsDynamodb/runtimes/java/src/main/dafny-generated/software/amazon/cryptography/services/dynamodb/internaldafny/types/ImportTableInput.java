...
public class ImportTableInput {
  ...
  private static final ImportTableInput theDefault = ImportTableInput.create(Wrappers_Compile.Option.<dafny.DafnySequence<? extends Character>>Default(dafny.DafnySequence.<Character>_typeDescriptor(dafny.TypeDescriptor.CHAR)), S3BucketSource.Default(), InputFormat.Default(), Wrappers_Compile.Option.<InputFormatOptions>Default(InputFormatOptions._typeDescriptor()), Wrappers_Compile.Option.<InputCompressionType>Default(InputCompressionType._typeDescriptor()), TableCreationParameters.Default());
