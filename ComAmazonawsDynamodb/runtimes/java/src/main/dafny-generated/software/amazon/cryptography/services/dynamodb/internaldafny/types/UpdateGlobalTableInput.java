...
public class UpdateGlobalTableInput {
  ...
  private static final UpdateGlobalTableInput theDefault = software.amazon.cryptography.services.dynamodb.internaldafny.types.UpdateGlobalTableInput.create(dafny.DafnySequence.<Character> empty(dafny.TypeDescriptor.CHAR), dafny.DafnySequence.<ReplicaUpdate> empty(ReplicaUpdate._typeDescriptor()));
