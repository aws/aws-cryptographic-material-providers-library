...
public class MetricsPublishError extends RuntimeException {

  protected MetricsPublishError(BuilderImpl builder) {
  ...
  static class BuilderImpl implements Builder {
    ...
    protected BuilderImpl(MetricsPublishError model) {
    ...
    public MetricsPublishError build() {
      if (Objects.isNull(this.message())) {
        throw new IllegalArgumentException(
          "Missing value for required field `message`"
        );
      }
      return new MetricsPublishError(this);
    }
  }
}
