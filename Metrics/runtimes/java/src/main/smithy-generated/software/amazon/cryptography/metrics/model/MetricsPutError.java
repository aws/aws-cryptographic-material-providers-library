...
public class MetricsPutError extends RuntimeException {

  protected MetricsPutError(BuilderImpl builder) {
  ...
  static class BuilderImpl implements Builder {
    ...
    protected BuilderImpl(MetricsPutError model) {
    ...
    public MetricsPutError build() {
      if (Objects.isNull(this.message())) {
        throw new IllegalArgumentException(
          "Missing value for required field `message`"
        );
      }
      return new MetricsPutError(this);
    }
  }
}
