...
public class DafnyCallEvent<I, O> {
  ...
  public String toString() {
    ...
    s.append("AwsCryptographyMetricsTypes.DafnyCallEvent.DafnyCallEvent");
    s.append("(");
  ...
  public static <I, O> DafnyCallEvent<I, O> Default(dafny.TypeDescriptor<I> _td_I, dafny.TypeDescriptor<O> _td_O, I _default_I, O _default_O) {
    return software.amazon.cryptography.metrics.internaldafny.types.DafnyCallEvent.<I, O>create(_td_I, _td_O, _default_I, _default_O);
  }
  @Deprecated()
