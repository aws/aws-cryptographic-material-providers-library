...
public class MetricsServiceError extends RuntimeException {

  protected MetricsServiceError(BuilderImpl builder) {
  ...
  static class BuilderImpl implements Builder {
    ...
    protected BuilderImpl(MetricsServiceError model) {
    ...
    public MetricsServiceError build() {
      if (Objects.isNull(this.message())) {
        throw new IllegalArgumentException(
          "Missing value for required field `message`"
        );
      }
      return new MetricsServiceError(this);
    }
  }
}
