...
import software.amazon.cryptography.metrics.internaldafny.types.CreateLoggerOutput;
...
import software.amazon.cryptography.metrics.internaldafny.types.CreateTextLoggerInput;
import software.amazon.cryptography.metrics.internaldafny.types.CreateTextMetricsAgentInput;
...
import software.amazon.cryptography.metrics.internaldafny.types.PublishInput;
import software.amazon.cryptography.metrics.internaldafny.types.PublishOutput;
...
import software.amazon.cryptography.metrics.internaldafny.types.PutInput;
...
public class ToDafny {
  ...
  public static CreateLoggerOutput CreateLoggerOutput(
    software.amazon.cryptography.metrics.model.CreateLoggerOutput nativeValue
  ) {
    software.amazon.cryptography.metrics.internaldafny.types.ILogger logger;
    logger = ToDafny.Logger(nativeValue.logger());
  ...
  public static CreateTextLoggerInput CreateTextLoggerInput(
    software.amazon.cryptography.metrics.model.CreateTextLoggerInput nativeValue
  ) {
    Option<DafnySequence<? extends Character>> fileName;
    fileName =
      Objects.nonNull(nativeValue.fileName())
        ? Option.create_Some(
  ...
  public static CreateTextMetricsAgentInput CreateTextMetricsAgentInput(
    software.amazon.cryptography.metrics.model.CreateTextMetricsAgentInput nativeValue
  ) {
    DafnySequence<? extends Character> fileName;
    fileName =
      software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(
        nativeValue.fileName()
      );
  ...
  public static PublishInput PublishInput(
    software.amazon.cryptography.metrics.model.PublishInput nativeValue
  ) {
    return new PublishInput();
  }

  public static PublishOutput PublishOutput(
    software.amazon.cryptography.metrics.model.PublishOutput nativeValue
  ) {
  ...
  public static PutInput PutInput(
    software.amazon.cryptography.metrics.model.PutInput nativeValue
  ) {
    DafnySequence<? extends Character> message;
    message =
      software.amazon.smithy.dafny.conversion.ToDafny.Simple.CharacterSequence(
  ...
  public static software.amazon.cryptography.metrics.internaldafny.types.ILogger Logger(
    ILogger nativeValue
  ) {
    return Logger.wrap(nativeValue).impl();
  }
