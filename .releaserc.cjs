      ...
      "@semantic-release/release-notes-generator",
      {
        ...
        "presetConfig": {
          "types": [
            ...
            {"type": "chore(go)",     "section": "Maintenance -- Go" },
            {"type": "chore(rust)",   "section": "Maintenance -- Rust" },
            {"type": "docs(dafny)",  "section": "Maintenance -- Dafny"},
            {"type": "docs(java)",   "section": "Maintenance -- Java" },
            {"type": "docs(dotnet)", "section": "Maintenance -- DotNet" },
            {"type": "docs(python)", "section": "Maintenance -- Python" },
            {"type": "docs(go)",     "section": "Maintenance -- Go" },
            {"type": "docs(rust)",   "section": "Maintenance -- Rust" },
            {"type": "revert(dafny)",  "section": "Fixes -- Dafny" },
            {"type": "revert(java)",   "section": "Fixes -- Java" },
            {"type": "revert(dotnet)", "section": "Fixes -- DotNet" },
            {"type": "revert(python)", "section": "Fixes -- Python" },
